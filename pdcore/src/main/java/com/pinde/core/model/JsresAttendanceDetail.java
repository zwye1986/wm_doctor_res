...
public class JsresAttendanceDetail extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getAttendanceFlow() {
        return attendanceFlow;
    }

    public void setAttendanceFlow(String attendanceFlow) {
        this.attendanceFlow = attendanceFlow;
    }
    ...
    public void setAttendLocal(String attendLocal) {
        this.attendLocal = attendLocal;
    }
