...
public class ResDoctorKqLog extends TeachingActivitySpeakerExample.MybatisObject {
    private String recordFlow;

    private String kqRecordFlow;
    ...
    public String getKqRecordFlow() {
        return kqRecordFlow;
    }

    public void setKqRecordFlow(String kqRecordFlow) {
        this.kqRecordFlow = kqRecordFlow;
    }
