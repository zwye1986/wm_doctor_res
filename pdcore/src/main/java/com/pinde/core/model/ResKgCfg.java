...
public class ResKgCfg extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getLessOrGreater() {
        return lessOrGreater;
    }

    public void setLessOrGreater(String lessOrGreater) {
    ...
    public String getIntervalDays2() {
        return intervalDays2;
    }

    public void setIntervalDays2(String intervalDays2) {
        this.intervalDays2 = intervalDays2;
    }
}