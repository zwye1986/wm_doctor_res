...
public class SchExamArrangement extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getIsOpenResult() {
        return isOpenResult;
    }

    public void setIsOpenResult(String isOpenResult) {
        this.isOpenResult = isOpenResult;
    }
}