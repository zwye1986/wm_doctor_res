...
public class PortalInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getWestEaetType() {
        return westEaetType;
    }

    public void setWestEaetType(String westEaetType) {
        this.westEaetType = westEaetType;
    }
