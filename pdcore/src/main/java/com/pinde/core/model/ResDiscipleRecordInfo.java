...
public class ResDiscipleRecordInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public void setDiscipleDate(String discipleDate) {
        this.discipleDate = discipleDate;
    }
