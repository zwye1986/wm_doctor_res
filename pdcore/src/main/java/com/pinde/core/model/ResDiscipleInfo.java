...
public class ResDiscipleInfo extends TeachingActivitySpeakerExample.MybatisObject {
    private String discipleFlow;
    ...
    public String getDiscipleFlow() {
        return discipleFlow;
    }

    public void setDiscipleFlow(String discipleFlow) {
        this.discipleFlow = discipleFlow;
    }
