...
public class ResDiscipleTeacherInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getWorkSpeName() {
        return workSpeName;
    }

    public void setWorkSpeName(String workSpeName) {
        this.workSpeName = workSpeName;
    }
