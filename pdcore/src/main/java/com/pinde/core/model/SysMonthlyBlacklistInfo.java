...
public class SysMonthlyBlacklistInfo implements java.io.Serializable {
    ...
    public String getReasonYj() {
        return reasonYj;
    }

    public void setReasonYj(String reasonYj) {
        this.reasonYj = reasonYj;
    }
