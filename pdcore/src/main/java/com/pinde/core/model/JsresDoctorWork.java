...
public class JsresDoctorWork extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getYlzNum() {
        return ylzNum;
    }

    public void setYlzNum(String ylzNum) {
        this.ylzNum = ylzNum;
    }
