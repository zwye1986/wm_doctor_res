...
public class OscaSkillDocStation extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getHoukaoTime() {
        return houkaoTime;
    }

    public void setHoukaoTime(String houkaoTime) {
        this.houkaoTime = houkaoTime;
    }
