...
public class ResTypicalCases extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getVisitActionId() {
        return visitActionId;
    }

    public void setVisitActionId(String visitActionId) {
    ...
    public String getPreviousDiseaseHistory() {
        return previousDiseaseHistory;
    }

    public void setPreviousDiseaseHistory(String previousDiseaseHistory) {
        this.previousDiseaseHistory = previousDiseaseHistory;
    }
    ...
    public void setSyndromeDiagnosis(String syndromeDiagnosis) {
        this.syndromeDiagnosis = syndromeDiagnosis;
    }
