...
public class ResUserResumeLog extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String technologyQualificationDate;
    ...
    private String isGeneralOrderOrientation;
    ...
    public String getTechnologyQualificationDate() {
        return technologyQualificationDate;
    }

    public void setTechnologyQualificationDate(String technologyQualificationDate) {
        this.technologyQualificationDate = technologyQualificationDate;
    }
    ...
    public String getIsGeneralOrderOrientation() {
        return isGeneralOrderOrientation;
    }

    public void setIsGeneralOrderOrientation(String isGeneralOrderOrientation) {
        this.isGeneralOrderOrientation = isGeneralOrderOrientation;
    }
