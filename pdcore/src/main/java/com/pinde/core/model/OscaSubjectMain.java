...
public class OscaSubjectMain extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private Integer passPer;

    private String isResave;
    ...
    public Integer getPassPer() {
        return passPer;
    }

    public void setPassPer(Integer passPer) {
        this.passPer = passPer;
    }

    public String getIsResave() {
        return isResave;
    }

    public void setIsResave(String isResave) {
        this.isResave = isResave;
    }
