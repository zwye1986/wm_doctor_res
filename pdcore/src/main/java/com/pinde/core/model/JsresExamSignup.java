...
public class JsresExamSignup extends TeachingActivitySpeakerExample.MybatisObject {
    private String signupFlow;

    private String signupYear;

    private String signupTypeId;

    private String signupTypeName;
    ...
    public void setSignupTypeId(String signupTypeId) {
        this.signupTypeId = signupTypeId;
    }

    public String getSignupTypeName() {
        return signupTypeName;
    }

    public void setSignupTypeName(String signupTypeName) {
        this.signupTypeName = signupTypeName;
    }
