...
public class ResDoctorRecruit extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String completeCertNo;

    private String completeFileUrl;

    private String currDegreeCategoryId;

    private String currDegreeCategoryName;

    private String graduationYear;

    private String adminSwapFlag;
    ...
    private String changeSpeId;

    private String changeSpeName;

    private String returnBackFlag;

    private String returnBackRemark;

    private String isSend;

    private String isCertSend;
    ...
    private String auditionStatusName;

    private String auditionStatusId;

    private String isRetrain;

    private String jointOrgAudit;

    private String certificateFlow;

    private String orgAudit;

    private String provinceCertificateNo;

    private String provinceCertificateFlow;

    private String provinceCertificateStatus;

    private String provinceCertificateDate;
    ...
    public void setProveFileUrl(String proveFileUrl) {
        this.proveFileUrl = proveFileUrl;
    }

    public String getCompleteCertNo() {
        return completeCertNo;
    }

    public void setCompleteCertNo(String completeCertNo) {
        this.completeCertNo = completeCertNo;
    }
    ...
    public void setCompleteFileUrl(String completeFileUrl) {
        this.completeFileUrl = completeFileUrl;
    }

    public String getCurrDegreeCategoryId() {
        return currDegreeCategoryId;
    }

    public void setCurrDegreeCategoryId(String currDegreeCategoryId) {
        this.currDegreeCategoryId = currDegreeCategoryId;
    }

    public String getCurrDegreeCategoryName() {
        return currDegreeCategoryName;
    }

    public void setCurrDegreeCategoryName(String currDegreeCategoryName) {
        this.currDegreeCategoryName = currDegreeCategoryName;
    }
    ...
    public String getAdminSwapFlag() {
        return adminSwapFlag;
    }

    public void setAdminSwapFlag(String adminSwapFlag) {
        this.adminSwapFlag = adminSwapFlag;
    }
    ...
    public String getSpecialCertNo() {
        return specialCertNo;
    }

    public void setSpecialCertNo(String specialCertNo) {
        this.specialCertNo = specialCertNo;
    }

    public String getSpecialFileUrl() {
        return specialFileUrl;
    }

    public void setSpecialFileUrl(String specialFileUrl) {
        this.specialFileUrl = specialFileUrl;
    }
    ...
    public String getGraduationCertificateType() {
        return graduationCertificateType;
    }

    public void setGraduationCertificateType(String graduationCertificateType) {
        this.graduationCertificateType = graduationCertificateType;
    }

    public String getChangeSpeId() {
        return changeSpeId;
    }

    public void setChangeSpeId(String changeSpeId) {
        this.changeSpeId = changeSpeId;
    }

    public String getChangeSpeName() {
        return changeSpeName;
    }

    public void setChangeSpeName(String changeSpeName) {
        this.changeSpeName = changeSpeName;
    }

    public String getReturnBackFlag() {
        return returnBackFlag;
    }

    public void setReturnBackFlag(String returnBackFlag) {
        this.returnBackFlag = returnBackFlag;
    }

    public String getReturnBackRemark() {
        return returnBackRemark;
    }

    public void setReturnBackRemark(String returnBackRemark) {
        this.returnBackRemark = returnBackRemark;
    }
    ...
    public String getIsCertSend() {
        return isCertSend;
    }

    public void setIsCertSend(String isCertSend) {
        this.isCertSend = isCertSend;
    }
    ...
    public String getCertificateIssuingStatus() {
        return certificateIssuingStatus;
    }

    public void setCertificateIssuingStatus(String certificateIssuingStatus) {
        this.certificateIssuingStatus = certificateIssuingStatus;
    }
    ...
    public String getAuditionStatusName() {
        return auditionStatusName;
    }

    public void setAuditionStatusName(String auditionStatusName) {
        this.auditionStatusName = auditionStatusName;
    }

    public String getAuditionStatusId() {
        return auditionStatusId;
    }

    public void setAuditionStatusId(String auditionStatusId) {
        this.auditionStatusId = auditionStatusId;
    }

    public String getIsRetrain() {
        return isRetrain;
    }

    public void setIsRetrain(String isRetrain) {
        this.isRetrain = isRetrain;
    }

    public String getJointOrgAudit() {
        return jointOrgAudit;
    }

    public void setJointOrgAudit(String jointOrgAudit) {
        this.jointOrgAudit = jointOrgAudit;
    }

    public String getCertificateFlow() {
        return certificateFlow;
    }

    public void setCertificateFlow(String certificateFlow) {
    ...
    public void setOrgAudit(String orgAudit) {
        this.orgAudit = orgAudit;
    }

    public String getProvinceCertificateNo() {
        return provinceCertificateNo;
    }

    public void setProvinceCertificateNo(String provinceCertificateNo) {
        this.provinceCertificateNo = provinceCertificateNo;
    }

    public String getProvinceCertificateFlow() {
        return provinceCertificateFlow;
    }

    public void setProvinceCertificateFlow(String provinceCertificateFlow) {
        this.provinceCertificateFlow = provinceCertificateFlow;
    }

    public String getProvinceCertificateStatus() {
        return provinceCertificateStatus;
    }

    public void setProvinceCertificateStatus(String provinceCertificateStatus) {
        this.provinceCertificateStatus = provinceCertificateStatus;
    }

    public String getProvinceCertificateDate() {
        return provinceCertificateDate;
    }

    public void setProvinceCertificateDate(String provinceCertificateDate) {
        this.provinceCertificateDate = provinceCertificateDate;
    }
