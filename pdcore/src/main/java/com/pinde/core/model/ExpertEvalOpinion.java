...
public class ExpertEvalOpinion extends TeachingActivitySpeakerExample.MybatisObject {
    private String opinionFlow;
    ...
    public String getOpinionFlow() {
        return opinionFlow;
    }

    public void setOpinionFlow(String opinionFlow) {
        this.opinionFlow = opinionFlow;
    }
