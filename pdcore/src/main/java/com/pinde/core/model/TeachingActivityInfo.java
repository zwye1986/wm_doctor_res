...
public class TeachingActivityInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String manualEndStatus;

    private String manualEndTiem;
    ...
    public String getManualEndStatus() {
        return manualEndStatus;
    }

    public void setManualEndStatus(String manualEndStatus) {
        this.manualEndStatus = manualEndStatus;
    }

    public String getManualEndTiem() {
        return manualEndTiem;
    }

    public void setManualEndTiem(String manualEndTiem) {
        this.manualEndTiem = manualEndTiem;
    }
