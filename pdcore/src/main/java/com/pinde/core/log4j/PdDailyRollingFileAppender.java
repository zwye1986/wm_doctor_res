...
*/
public class PdDailyRollingFileAppender extends FileAppender {
	...
	public PdDailyRollingFileAppender() {
	}
	 ...
	 */
	public PdDailyRollingFileAppender(Layout layout, String filename,
...
class RollingCalendar extends GregorianCalendar {
	...
	int type = PdDailyRollingFileAppender.TOP_OF_TROUBLE;
	...
	public Date getNextCheckDate(Date now) {
		...
		switch (type) {
		case PdDailyRollingFileAppender.TOP_OF_MINUTE:
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.MINUTE, 1);
			break;
		case PdDailyRollingFileAppender.TOP_OF_HOUR:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.HOUR_OF_DAY, 1);
			break;
		case PdDailyRollingFileAppender.HALF_DAY:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case PdDailyRollingFileAppender.TOP_OF_DAY:
			this.set(Calendar.HOUR_OF_DAY, 0);
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case PdDailyRollingFileAppender.TOP_OF_WEEK:
			...
			break;
		case PdDailyRollingFileAppender.TOP_OF_MONTH:
