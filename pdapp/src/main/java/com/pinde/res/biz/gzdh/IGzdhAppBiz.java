...
public interface IGzdhAppBiz {
	...
	List<Map<String,Object>> getDeptStudents(String userName, String userFlow, String role);

	List<Map<String,Object>> getCycleStudents(String userName, String userFlow, String role, String isPermitOpen);

	List<Map<String,Object>> getDeptTeachers(String userName, String userFlow, String role, String teacherRole);
	List<Map<String,Object>> getDeptHeads(String userName, String userFlow, String role, String headRole);

	ResRingLetterUser getRingUser(String userFlow);

	PubFile readFile(String makingFile);

	List<Map<String,Object>> absenceUserList(String userName, String userFlow, String head);

	int checkIsDeptStudent(String resultFlow, String userFlow, String deptFlow);

	List<Map<String,Object>> getSpeUsers(String userName, String userFlow, String role, String baseRole);

	List<SysDept> getSysDeptList(String orgFlow);

	List<SysDept> getSpeDeptList(String userFlow);
	...
	String getResCfgCode(String key);
