...
import com.pinde.res.dao.sctcm120.ext.Sctcm120RestarinNoticeExtMapper;
...
public class Sctcm120LiveTrainingBizImpl implements ISctcm120LiveTrainingBiz {
    @Autowired
    private ResTrainingOpinionMapper trainingOpinionMapper;
    @Autowired
    private ResTarinNoticeMapper resTarinNoticeMapper;
    @Autowired
    private Sctcm120RestarinNoticeExtMapper resTarinNoticeExtMapper;
