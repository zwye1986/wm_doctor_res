...
public interface IGzzyStudentBiz {
	 ...
	 * @return
	 */
	List<Map<String, Object>> getExamItemsMiniCex(String doctorFlow);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getMarksForDept(String userFlow, String schDeptFlow, String examItemType);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getMarksForTec(String userFlow, String schDeptFlow, String examItemType);
	...
	Map<String,String> getPaperByStandardDeptId(String secID, String specialtyID, String examType);
