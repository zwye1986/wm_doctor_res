...
import com.pinde.res.biz.nfykdx.INfykdxStudentBiz;
...
import com.pinde.res.dao.zsey.ext.ZseyAppMapper;
...
public class ZseyAppBizImpl implements IZseyAppBiz {
	...
	@Resource
	private ResRingLetterUserMapper ringLetterUserMapper;
	@Resource
	...
	@Resource
	private INfykdxStudentBiz studentBiz;
	@Resource
	...
	@Resource
	private ZseyAppMapper zseyAppMapper;
	@Resource
	...
	//根据用户名获取用户信息
	@Override
	public ResRingLetterUser getRingUser(String userFlow)
	{
		return ringLetterUserMapper.selectByPrimaryKey(userFlow);
	}

	@Override
	public PubFile readFile(String makingFile) {
		return fileMapper.selectByPrimaryKey(makingFile);
	}

	@Override
	public List<Map<String, Object>> absenceUserList(String userName, String userFlow, String head) {
		return zseyAppMapper.absenceUserList(userName,userFlow,head);
	}

	@Override
	public int checkIsDeptStudent(String resultFlow, String userFlow, String deptFlow) {
		if(StringUtil.isBlank(resultFlow))
		{
			return 0;
		}
		return zseyAppMapper.checkIsDeptStudent(resultFlow,userFlow,deptFlow);
	}
...
//						List<Element> elements = root.elements();
	...
	public String editRec(String recFlow,
		...
		if(isNew){
			...
			rec.setRecForm(GlobalConstant.RES_ZSEY_DEFAULT_FORM);
...
//			example.setOrderByClause("SIGN_DATE");
			...
			if(signs==null || signs.isEmpty()){
				...
				//获取轮转信息
				SchArrangeResult result = studentBiz.searcheDocResult(null,deptFlow);
				if(result!=null){
	...
	@Override
	public List<SysDept> getSysDeptList(String orgFlow){
	...
	public List<Map<String, Object>> commReqOptionNameList(String userFlow,String deptFlow,String dataType,String catFlow) {
		...
		List<SchRotationDeptReq> reqList = reqMapper.selectByExample(reqExample);
	...
	public ResDoctorSchProcess readSchProcess(String processFlow) {
		...
		if(StringUtil.isNotBlank(processFlow)){
			process = this.processMapper.selectByPrimaryKey(processFlow);
		}
		return process;
	}
	...
	@Override
	public List<SysDept> getSpeDeptList(String userFlow) {
		return sysDeptExtMapper.getSpeDeptList(userFlow);
	}
	...
	@Override
	public List<Map<String, Object>> getDeptStudents(String userName,String userFlow, String role) {
		return zseyAppMapper.getDeptStudents(userName,userFlow,role);
	}

	@Override
	public List<Map<String, Object>> getCycleStudents(String userName,String userFlow, String role, String isPermitOpen) {
		return zseyAppMapper.getCycleStudents(userName,userFlow,role,isPermitOpen);
	}
	@Override
	public List<Map<String, Object>> getDeptTeachers(String userName,String userFlow, String role,String teacherRoleFlow) {
		return zseyAppMapper.getDeptTeachers(userName,userFlow,role,teacherRoleFlow);
	}
	@Override
	public List<Map<String, Object>> getDeptHeads(String userName,String userFlow, String role,String headRoleFlow) {
		return zseyAppMapper.getDeptHeads(userName,userFlow,role,headRoleFlow);
	}
	@Override
	public List<Map<String, Object>> getSpeUsers(String userName,String userFlow, String role,String baseRoleFlow) {
		return zseyAppMapper.getSpeUsers(userName,userFlow,role,baseRoleFlow);
	}
	@Autowired
