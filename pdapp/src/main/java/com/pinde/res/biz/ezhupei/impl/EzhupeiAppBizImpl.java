...
import com.pinde.res.dao.ezhupei.ext.EzhupeiLectureInfoExtMapper;
import com.pinde.res.dao.ezhupei.ext.EzhupeiResDoctorSchProcessExtMapper;
import com.pinde.res.dao.ezhupei.ext.EzhupeiSchDeptExtMapper;
...
public class EzhupeiAppBizImpl implements IEzhupeiAppBiz {
	...
	@Resource
	private EzhupeiResDoctorSchProcessExtMapper stdpProcessExtMapper;
	@Resource
	...
	@Autowired
	private EzhupeiSchDeptExtMapper schDeptExtMapper;
	@Resource
...
//			example.setOrderByClause("SIGN_DATE");
			...
			if(signs==null || signs.isEmpty()){
				...
				//获取轮转信息
				SchArrangeResult result = ezhupeiStudentBiz.searcheDocResult(null,deptFlow);
				if(result!=null){
	...
	@Autowired
	private EzhupeiLectureInfoExtMapper lectureInfoExtMapper;
	@Autowired
