...
public class NfyyAppBizImpl implements INfyyAppBiz{
	@Autowired
	...
	@Override
	public int updateUserPass(String userFlow, String newPassword) {
		return appMapper.updateUserPass( userFlow,  newPassword);
	}
