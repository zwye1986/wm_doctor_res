...
import com.pinde.res.dao.xnres.ext.*;
import com.pinde.res.enums.stdp.RegistryTypeEnum;
import com.pinde.res.enums.xnres.DiscipleStatusEnum;
...
public class XnresStudentBizImpl implements IXnresStudentBiz {
	
	@Resource
	private XnresSchArrangeResultExtMapper resultExtMapper;
	@Resource
	...
	@Resource
	private XnresSchRotationDeptExtMapper rotationDeptExtMapper;
	@Resource
...
//				JszyTrainCategoryEnum.ChineseMedicine.getId().equals(trainingType)||JszyTrainCategoryEnum.TCMGeneral.getId().equals(trainingType);
...
//		{
//			//获取所有缩减的调整科室
//			List<SchDoctorDept> doctorDeptList = appBiz.searchReductionDept(userFlow,rotationFlow,secondRotationFlow);
...
//							}
	...
	@Autowired
	private XnresDiscipleInfoExtMapper resDiscipleInfoExtMapper;
	@Autowired
	...
	@Autowired
	private XnresFollowTeacherRecordExtMapper resFollowTeacherRecordExtMapper;
	@Autowired
	...
	@Autowired
	private XnresAnnualAssessmentExtMapper assessmentExtMapper;
	...
	@Autowired
	private XnresGraduationAssessmentExtMapper graduationAssessmentExtMapper;
