...
public class GzdhTeacherBizImpl implements IGzdhTeacherBiz {
	...
	@Override
	public Integer getCountDocListByTeacher(Map<String,Object> paramMap){
		return docExtMapper.getCountDocListByTeacher(paramMap);
	}
	...
	public List<Map<String, String>> schDoctorSchProcessQuery(Map<String, Object> schArrangeResultMap) {
		return docExtMapper.zseySchDoctorSchProcessQuery(schArrangeResultMap);
	}
	@Override
	public List<Map<String, String>> teacherDocUserList(Map<String, Object> schArrangeResultMap) {
		return docExtMapper.teacherDocUserList(schArrangeResultMap);
	}

	@Override
	public List<Map<String, String>> schDoctorSchProcessInfoQuery(Map<String, Object> schArrangeResultMap) {
		return docExtMapper.zseySchDoctorSchProcessInfoQuery(schArrangeResultMap);
	}
	...
	public List<ResRec> getDocRecs(String processFlow, String userFlow, List<String> typeId) {
		...
		criteria.andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y)
				.andProcessFlowEqualTo(processFlow).andOperUserFlowEqualTo(userFlow);
	...
	public List<ResRec> searchRecByProcessAndRecType(String processFlow,String doctorFlow,String recType,String biaoJi) {
		...
		ResRecExample.Criteria criteria=	example.createCriteria();
		criteria.andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y)
				.andProcessFlowEqualTo(processFlow).andOperUserFlowEqualTo(doctorFlow)
