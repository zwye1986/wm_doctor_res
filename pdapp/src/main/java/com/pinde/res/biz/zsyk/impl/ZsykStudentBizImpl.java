...
public class ZsykStudentBizImpl implements IZsykStudentBiz {
	@Autowired
	private ZsykAppMapper appMapper;
	@Autowired
	private ZsykStudentMapper studentMapper;
	@Autowired
	private IZsykTeacherBiz hzyyTeacherBiz;
	...
	public String addEnteredDeptEdu(Map<String,Object> enteredDeptEdu) {
		...
		Map<String,String> user =  appMapper.readUser(userFlow);
	...
	public List<Map<String, Object>> getMarksForDept(String userFlow , String schDeptFlow) {
		String secId = studentMapper.selectSecId(schDeptFlow);
		return studentMapper.selectMarksForDept(userFlow, secId);
	}

	@Override
	public List<Map<String, Object>> getMarksForTec(String userFlow , String schDeptFlow) {
		String tecId = studentMapper.selectTecId(schDeptFlow);
		return studentMapper.selectMarksForTec(tecId, userFlow);
	}
