...
import com.pinde.res.dao.gzdh.ext.GzdhAppMapper;
...
public class GzdhAppBizImpl implements IGzdhAppBiz {
	...
	@Resource
	private GzdhAppMapper gzdhAppMapper;
	@Resource
	...
	public List<Map<String, Object>> absenceUserList(String userName, String userFlow, String head) {
		return gzdhAppMapper.absenceUserList(userName,userFlow,head);
	}
	...
	public int checkIsDeptStudent(String resultFlow, String userFlow, String deptFlow) {
		...
		return gzdhAppMapper.checkIsDeptStudent(resultFlow,userFlow,deptFlow);
	}
...
//						List<Element> elements = root.elements();
	...
	public String editRec(String recFlow,
		...
		if(isNew){
			...
			rec.setRecForm(GlobalConstant.RES_DGDH_DEFAULT_FORM);
