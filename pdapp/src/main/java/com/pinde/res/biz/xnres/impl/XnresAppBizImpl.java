...
import com.pinde.res.dao.xnres.ext.XnresResDoctorSchProcessExtMapper;
import com.pinde.res.dao.xnres.ext.XnresResLectureInfoExtMapper;
import com.pinde.res.dao.xnres.ext.XnresSchArrangeResultExtMapper;
import com.pinde.res.dao.xnres.ext.XnresSchDeptExtMapper;
import com.pinde.res.enums.xnres.ResAssessTypeEnum;
import com.pinde.res.enums.xnres.ResRecTypeEnum;
import com.pinde.res.enums.xnres.SigninTypeEnum;
...
public class XnresAppBizImpl implements IXnresAppBiz {
	...
	@Resource
	private XnresSchArrangeResultExtMapper stdpResultExtMapper;
	@Resource
	private XnresResDoctorSchProcessExtMapper stdpProcessExtMapper;
	@Resource
	...
	@Autowired
	private XnresSchDeptExtMapper schDeptExtMapper;
	@Autowired
...
//					}
	...
	public String editRec(String recFlow,
		...
		if(isNew){
			...
			rec.setRecForm(GlobalConstant.RES_JSZY_DEFAULT_FORM);
...
//			example.setOrderByClause("SIGN_DATE");
	...
	@Autowired
	private XnresResLectureInfoExtMapper lectureInfoExtMapper;
	@Autowired
