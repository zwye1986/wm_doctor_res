...
import com.pinde.res.dao.zsyk.ext.ZsykSecretaryMapper;
...
public class ZsykSecretarieBizImpl implements IZsykSecretarieBiz {
	@Autowired
	private IZsykAppBiz nfyyAppBiz;
	@Autowired
	private IZsykStudentBiz nfyyBiz;
	@Autowired
	private ZsykSecretaryMapper secretaryMapper;
