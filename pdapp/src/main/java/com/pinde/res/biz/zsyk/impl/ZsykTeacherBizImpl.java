...
import com.pinde.res.dao.zsyk.ext.ZsykTeacherMapper;
...
public class ZsykTeacherBizImpl implements IZsykTeacherBiz {
	@Autowired
	private IZsykAppBiz nfyyAppBiz;
	@Autowired
	private IZsykStudentBiz nfyyBiz;
	@Autowired
	private ZsykTeacherMapper teacherMapper;
    @Autowired
