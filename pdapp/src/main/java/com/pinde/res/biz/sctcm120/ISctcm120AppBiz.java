package com.pinde.res.biz.sctcm120;
...
public interface ISctcm120AppBiz {
	...
	List<SchDoctorAbsence> searchSchDoctorAbsenceByDoctorDept(String schDeptFlow, String userFlow);

	List<ResRec> getRecByRecsType(String processFlow, String recTypeId);

	List<SchRotationDeptReq> searchDeptReqByRel(String recordFlow, String recTypeId);

	List<ResDoctorSchProcess> getCurrentProcesses(String userFlow);

	List<ResDoctorSignin> searchDoctorSignin(ResDoctorSignin searchSignin);

	int addDoctorSignin(ResDoctorSignin qingpuDoctorSignin);

	ResOrgAddress readOrgAddress(String orgFlow);
	...
	ResDoctorSignin readSiginInfoByCode(String codeInfo);
