...
public interface IGzzySecretarieBiz {
	...
	void saveNewDayEval(String userFlow, String ucsid, HttpServletRequest request);

	String getFzMiniScore(String ucsid);

    List<Map<String, String>> selectDocCycTimes(String rUserID,String UCSID);

    List<Map<String, Object>> getMiniItemScore(String ucsid, String type);
}
