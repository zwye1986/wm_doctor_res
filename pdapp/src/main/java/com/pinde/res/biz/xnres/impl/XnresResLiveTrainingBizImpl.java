...
import com.pinde.res.biz.xnres.IXnresResLiveTrainingBiz;
import com.pinde.res.dao.xnres.ext.XnresResTarinNoticeExtMapper;
...
public class XnresResLiveTrainingBizImpl implements IXnresResLiveTrainingBiz {
    @Autowired
    private ResTrainingOpinionMapper trainingOpinionMapper;
    @Autowired
    private ResTarinNoticeMapper resTarinNoticeMapper;
    @Autowired
    private XnresResTarinNoticeExtMapper resTarinNoticeExtMapper;
