...
public interface BengyifyStudentMapper {
	...
	List<Map<String,Object>> getUserSignList(@Param("nowDay") String nowDay, @Param("userFlow") String userFlow);

	Map<String,Object> getDocNowDept(@Param("userFlow") String userFlow);
