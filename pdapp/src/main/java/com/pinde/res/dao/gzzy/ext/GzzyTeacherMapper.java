...
public interface GzzyTeacherMapper {
	...
	Map<String, Object> readOutMiniCexFz(@Param("doctorFlow") String doctorFlow);
	...
	Map<String,Object> readBaseInfo(@Param("doctorFlow") String doctorFlow, @Param("studentFlow") String studentFlow);
	Map<String,Object> readDailyInfo(@Param("doctorFlow") String doctorFlow);
	...
	String readKzrName(@Param("doctorFlow") String doctorFlow);

	void addDailyInfo(Map<String, Object> daily);

	void modDailyInfo(Map<String, Object> daily);

	List<Map<String,String>> isFzDept(@Param("ucsid") String ucsid);

	void addOutMiniCexFz(Map<String, Object> params);

	void modOutMiniCexFz(Map<String, Object> params);
}
