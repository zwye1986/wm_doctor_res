...
public interface HzyyTeacherMapper {
	...
	void updateOutSkill(@Param("skill_patientName") String skill_patientName, @Param("skill_no") String skill_no, @Param("skill_score") String skill_score, @Param("skill_time") String skill_time, @Param("skill_id") String skill_id, @Param("Skill_examinerOne") String Skill_examinerOne, @Param("Skill_examinerTwo") String Skill_examinerTwo);
	...
	void updateOutPatient(@Param("patient_name") String patient_name, @Param("patient_no") String patient_no, @Param("patient_score") String patient_score, @Param("patient_remark") String patient_remark, @Param("patient_id") String patient_id, @Param("patient_examinerOne") String patient_examinerOne, @Param("patient_examinerTwo") String patient_examinerTwo);

	void updatePatientItemScore(@Param("patient_id") String patient_id, @Param("index") String index, @Param("s") String s);

	void insertOutPatient(@Param("patient_name") String patient_name, @Param("patient_no") String patient_no, @Param("patient_score") String patient_score, @Param("patient_remark") String patient_remark, @Param("doctorFlow") String doctorFlow, @Param("userFlow") String userFlow, @Param("currDateTime2") String currDateTime2, @Param("patientTypeId") String patientTypeId, @Param("patientTypeName") String patientTypeName, @Param("patientId") String patientId, @Param("patient_examinerOne") String patient_examinerOne, @Param("patient_examinerTwo") String patient_examinerTwo);
	...
	Map<String,String> readAfterEva(@Param("ucsid") String ucsid);

	Map<String,String> getCycleOutInfo(@Param("ucsid") String ucsid);

	int getJxhd(@Param("doctorFlow") String doctorFlow);

	int updateAfterEvaluation( Map<String, String> params);

	int insertAfterEvaluation(Map<String, String> params);

	int updateOutSecBriefInfo(@Param("doctorFlow") String doctorFlow, @Param("userFlow") String userFlow);

	List<Map<String,String>> getFileList(@Param("attachGroupID") String attachGroupID);

	void deleteFileNotInFlows(@Param("attachGroupID") String attachGroupID, @Param("fileFlows") List<String> fileFlows);

	void setFileGroupIdByFlows(@Param("attachGroupID") String attachGroupID, @Param("fileFlows") List<String> fileFlows);

	int delFile(@Param("fileFlow") String fileFlow);

	Map<String,String> readFile(@Param("fileFlow") String fileFlow);

	Map<String,String> getOutSkillById(@Param("skill_id") String skill_id);

	String getMaxAttachId();


	void updateOutSkillAttachId(@Param("attachID") String attachID, @Param("skill_id") String skill_id);

	Map<String,String> getOutPatientById(@Param("patient_id") String patient_id);

	void updateOutPatientAttachId(@Param("attachID") String attachID, @Param("patient_id") String patient_id);
	...
	List<Map<String,String>> readPatientDeptList(@Param("dicItemID") String dicItemID, @Param("ucsid") String ucsid);
}
