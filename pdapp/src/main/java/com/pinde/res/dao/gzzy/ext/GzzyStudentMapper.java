...
public interface GzzyStudentMapper {
     ...
     * @return
	 */
	List<Map<String, Object>> selectMarksForDept(@Param("userFlow") String userFlow, @Param("secId") String secId, @Param("examItemType") String examItemType);
	 ...
	 * @return
	 */
	List<Map<String, Object>> selectMarksForTec(@Param("tecId") String tecId, @Param("userFlow") String userFlow, @Param("examItemType") String examItemType);
