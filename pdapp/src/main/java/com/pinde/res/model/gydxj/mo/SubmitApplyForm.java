package com.pinde.res.model.gydxj.mo;
...
public class SubmitApplyForm implements Serializable {
    ...
    private String swichmajorId;//转入的专业名称
    ...
    private String oldTutorName;//原导师姓名
    private String changeTutorName;//更换导师名（现学籍支持2个老师,可用"，"分隔的字符）
    private List<String> changeApplyUrlList;//附件上传地址集合
    ...
    public String getSwichmajorId() {
        return swichmajorId;
    }

    public void setSwichmajorId(String swichmajorId) {
        this.swichmajorId = swichmajorId;
    }
    ...
    public String getOldTutorName() {
        return oldTutorName;
    }

    public void setOldTutorName(String oldTutorName) {
        this.oldTutorName = oldTutorName;
    }

    public String getChangeTutorName() {
        return changeTutorName;
    }

    public void setChangeTutorName(String changeTutorName) {
        this.changeTutorName = changeTutorName;
    }

    public List<String> getChangeApplyUrlList() {
        return changeApplyUrlList;
    }

    public void setChangeApplyUrlList(List<String> changeApplyUrlList) {
        this.changeApplyUrlList = changeApplyUrlList;
    }
}
