...
public class BengyifyTestController {

private static Logger logger = LoggerFactory.getLogger(BengyifyTestController.class);
	...
	public String test(){
		return "res/bengyify/student/test";
	}
	...
	public String teachertest(){
		return "res/bengyify/teacher/test";
	}
