...
@Controller
@RequestMapping("/res/njmu2/admin")
public class Njmu2AdminController {
    private static Logger logger = LoggerFactory.getLogger(Njmu2AdminController.class);
    ...
    public String schDeptList(String orgFlow, HttpServletRequest request, Model model) {
        ...
        if (StringUtil.isEmpty(orgFlow)) {
            ...
            model.addAttribute("resultType", "基地编码为空");
            return "res/njmu2/admin/schDeptList";
        }
       List<SchDept> schDeptList = njmu2AppBiz.searchSchDeptList(orgFlow);
    ...
    public String orgList(String userFlow, HttpServletRequest request, Model model) {
        ...
        if (userinfo == null) {
            ...
            List<SysOrg> orgList = njmu2AppBiz.searchSysOrg();
            model.addAttribute("orgList", orgList);
        }
        return "/res/njmu2/admin/orgList";
    }
    /**
     * 科室轮转查询
     */
    ...
    public String docSchDept(String userFlow, String searchData,
        ...
        if (StringUtil.isEmpty(userFlow)) {
            model.addAttribute("resultId", "3030101");
            model.addAttribute("resultType", "用户标识符为空");
            return "res/njmu2/admin/schDept";
        }
        //验证用户是否存在
        SysUser userinfo = njmu2AppBiz.getUserByFlow(userFlow);
        if (userinfo == null) {
            ...
            if (StringUtil.isNotBlank(searchData)) {
                ...
                if (searchMap != null && !searchMap.isEmpty()) {
                    ...
                    String orgFlow = searchMap.get("orgFlow");
                    ...
                    if (StringUtil.isEmpty(orgFlow)) {
                        model.addAttribute("resultId", "30203010");
                    ...
                    model.addAttribute("orgList", orgList);
                    List<SchDept> schDeptList = njmu2AppBiz.searchSchDeptList(orgFlow);
                    arrResultList = njmu2AppBiz.searchArrangeResultByDateAndOrg(startDate, endDate, orgFlow,sessionNumber);
                    model.addAttribute("schDeptList", schDeptList);
    ...
    public String doctorSchDetail(String doctorFlow,      HttpServletRequest request, Model model) {
        ...
        return "res/njmu2/admin/doctorSchDetail";
    }
    ...
    public String trainDocList(String userFlow, String searchData, Integer pageIndex, Integer pageSize, HttpServletRequest request, Model model) {
        ...
        if (null == userinfo) {
            ...
            if (StringUtil.isNotBlank(searchData)) {
                ...
                doctorExt.setOrgFlow(searchMap.get("orgFlow"));
