...
@Controller
@RequestMapping("/res/ezhupei/student")
public class EzhupeiStudentController{
	private static Logger logger = LoggerFactory.getLogger(EzhupeiStudentController.class);
	...
	@Autowired
	private IEzhupeiLiveTrainingBiz resLiveTrainingBiz;
	...
	public String test(){
		return "res/ezhupei/student/test";
	}
	...
	public String deptList(String userFlow,String searchData, Integer pageIndex,Integer pageSize,HttpServletRequest request,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			return "res/ezhupei/student/deptList";
		}
		...
		List<Map<String,Object>> results = ezhupeiStudentBiz.searchResult(paramMap);
...
//					if(StringUtil.isNotBlank(schStartDate) && currDate.compareTo(schStartDate)>=0){
						if(RotationStatusEnum.Rounding.getId().equals(rotationStatus)){
							...
							int result = ezhupeiStudentBiz.updateProcess(process);
							if(result!=0){
		...
		//百分比算法
		Map<String,Object> deptPerMap = ezhupeiStudentBiz.getRegPer(0,userFlow);
	...
	public String funcList(String userFlow,String deptFlow,HttpServletRequest request,Model model){
		...
		if(StringUtil.isBlank(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/funcList";
		}
		...
		ResDoctorSchProcess process = ezhupeiStudentBiz.getProcessByResult(deptFlow);
		...
		if(process!=null){
			...
			//百分比算法
			Map<String,Object> perMap = ezhupeiStudentBiz.getRegPer(0, userFlow, deptFlow,null,null,true);
...
//				String docTestSwitch=appBiz.getCfgByCode("doc_test_switch_"+process.getOrgFlow()+"_"+process.getUserFlow());
	...
	public String inProcessInfo(String userFlow,String deptFlow,HttpServletRequest request,Model model){
		...
		if(StringUtil.isBlank(userFlow)){
			model.addAttribute("resultId", "3020201");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/inProcessInfo";
		}
		if(StringUtil.isEmpty(deptFlow)){
			model.addAttribute("resultId", "3020202");
			model.addAttribute("resultType", "科室标识符为空");
	...
	public String userCenter(String userFlow, HttpServletRequest request, HttpServletResponse response, Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/userCenter";
		}
		//验证用户是否存在
	...
	public String standardDeptList(String userFlow,String searchData,Integer pageIndex,Integer pageSize,HttpServletRequest request,Model model) throws ParseException {
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "3020201");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/standardDeptList";
		}
		...
		PageHelper.startPage(pageIndex, pageSize);
		List<Map<String,Object>> resultMaps = ezhupeiStudentBiz.getDoctorRotationDept(paramMap);
		...
		//按条件查询轮转数据
		List<Map<String,Object>> results = ezhupeiStudentBiz.searchResult(paramMap2);
		if(results!=null && !results.isEmpty()){
	...
	public String addRotationDept(
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/addRotationDept";
		}
		...
		List<SchArrangeResult> resultList = ezhupeiStudentBiz.checkResultDate(userFlow,schStartDate,schEndDate,null,doctor.getRotationFlow());
		...
		ezhupeiStudentBiz.editDoctorResult(userFlow,standardDeptFlow,schDeptFlow,schStartDate,schEndDate,teacherUserFlow,headUserFlow,null);
	...
	public String modRotationDept(
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/modRotationDept";
		}
		...
		List<SchArrangeResult> resultList = ezhupeiStudentBiz.checkResultDate(userFlow,schStartDate,schEndDate,deptFlow,doctor.getRotationFlow());
		if(resultList!=null && !resultList.isEmpty()){
		...
		ezhupeiStudentBiz.editDoctorResult(userFlow,standardDeptFlow,schDeptFlow,schStartDate,schEndDate,teacherUserFlow,headUserFlow,deptFlow);
	...
	public String deleteRotationDept(String userFlow,String deptFlow,HttpServletRequest request,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/deleteRotationDept";
		}
		...
		ezhupeiStudentBiz.delDoctorResult(deptFlow);
	...
	public String gradeDeptList(String userFlow,Integer pageIndex,Integer pageSize,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/gradeDeptList";
		}
		if(pageIndex==null){
	...
	public String allAfterDept(String userFlow,Integer pageIndex,Integer pageSize,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "30401");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/allAfterDept";
		}
		if(pageIndex==null){
			model.addAttribute("resultId", "30202");
			model.addAttribute("resultType", "当前页码为空");
	...
	public String getNewLectures(Model model,String userFlow,Integer pageIndex,Integer pageSize) {
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/getNewLectures";
		}
		if(pageIndex==null){
	...
	public String getHistoryLectures(Model model,String userFlow,Integer pageIndex,Integer pageSize) {
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "31801");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/getHistoryLectures";
		}
		if(pageIndex==null){
			model.addAttribute("resultId", "30905");
			model.addAttribute("resultType", "当前页码为空");
	...
	public synchronized String lectureRegist(String lectureFlow,String userFlow,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "31801");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/lectureRegist";
		}
	...
	public String evaluate(String lectureFlow,String  userFlow,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "31801");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/evaluate";
		}
		if(StringUtil.isEmpty(lectureFlow)){
			model.addAttribute("resultId", "32301");
			model.addAttribute("resultType", "讲座流水号为空");
	...
	public String suggestions(String userFlow,Integer pageIndex,Integer pageSize,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "31801");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/suggestions";
		}
		if(pageIndex==null){
			model.addAttribute("resultId", "30905");
			model.addAttribute("resultType", "当前页码为空");
	...
	public String getZhupeiNotices(String userFlow,Integer pageIndex,Integer pageSize,String noticeTitle,HttpServletRequest request,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			...
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/noticeList";
		}
		if(pageIndex==null){
			model.addAttribute("resultId", "30202");
			model.addAttribute("resultType", "当前页码为空");
		...
		String hostUrl=httpurl.substring(0,httpurl.indexOf(servletPath))+"/jsp/res/ezhupei/showNotice/no-pic.png";
	...
	public String zpNoticeDetail(String userFlow,String recordFlow,HttpServletRequest request,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "30201");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/zpNoticeDetail";
		}
		...
		String httpurl=httpRequest.getRequestURL().toString();
		String servletPath=httpRequest.getServletPath();
		String hostUrl=httpurl.substring(0,httpurl.indexOf(servletPath))+"/jsp/res/ezhupei/showNotice/showNoticeDetail.jsp?recordFlow="+recordFlow;
		String androidimgurl=httpurl.substring(0,httpurl.indexOf(servletPath))+"/jsp/res/ezhupei/showNotice/showNoticeDetail2.jsp?recordFlow="+recordFlow;
	...
	public String paperDataList(String userFlow,String type,Integer pageIndex,Integer pageSize,Model model){
		...
		if(StringUtil.isEmpty(userFlow)){
			model.addAttribute("resultId", "30201");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/paperDataList";
		}
		if(pageIndex==null){
			model.addAttribute("resultId", "30202");
			model.addAttribute("resultType", "当前页码为空");
		...
		if(type.equals("Paper")){
			List<JsresDoctorPaper> list=ezhupeiStudentBiz.readJsresDoctorPaperByDoctorFlow(userFlow);
			model.addAttribute("list",list);
		}
		if(type.equals("Part")){
			List<JsresDoctorParticipation> list=ezhupeiStudentBiz.readJsresDoctorJsresDoctorParticipationByDoctorFlow(userFlow);
			model.addAttribute("list",list);
	...
	public String addPaperOrPart(String userFlow,String type,String recordFlow,Model model){
		...
		if(StringUtil.isBlank(userFlow)){
			model.addAttribute("resultId", "3011101");
			model.addAttribute("resultType", "用户标识符为空");
			return "res/ezhupei/student/addPaperOrPart";
		}
		if(StringUtil.isBlank(type)){
			model.addAttribute("resultId", "3011101");
			model.addAttribute("resultType", "添加数据类型为空");
		...
		if(type.equals("Paper")&&StringUtil.isNotBlank(recordFlow)){
			JsresDoctorPaper paper=ezhupeiStudentBiz.readJsresDoctorPaperByFlow(recordFlow);
			model.addAttribute("resultData",paper);
		}
		if(type.equals("Part")&&StringUtil.isNotBlank(recordFlow)){
			JsresDoctorParticipation paper=ezhupeiStudentBiz.readJsresDoctorJsresDoctorParticipationByFlow(recordFlow);
			model.addAttribute("resultData",paper);
		}
		ResDoctor doctor=appBiz.readResDoctor(userFlow);
		model.addAttribute("doctor",doctor);
	...
	public String savePaperOrPart(String userFlow,String type,JsresDoctorPaper paper,JsresDoctorParticipation part,Model model){
		...
		if(type.equals("Paper")){
			...
			int count=ezhupeiStudentBiz.editJsresDoctorPaper(paper,user);
			if(count==0){
				model.addAttribute("resultId", "3011101");
				model.addAttribute("resultType", "保存失败");
			}
		...
		if(type.equals("Part")){
			...
			int count=ezhupeiStudentBiz.editJsresDoctorPart(part,user);
			if(count==0){
				model.addAttribute("resultId", "3011101");
				model.addAttribute("resultType", "保存失败");
			}
	...
	public String deleteData(String userFlow,String recordFlow,String type,
		...
		if(type.equals("Paper")){
			ezhupeiStudentBiz.deleteJsresDoctorPaperByFlow(recordFlow);
		}
		if(type.equals("Part")){
			ezhupeiStudentBiz.deleteJsresDoctorParticipationByFlow(recordFlow);
		}
		return "res/ezhupei/success";
	}
	/*=====================产品学员APP优化（首页） end===================*/
