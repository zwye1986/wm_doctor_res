...
//		if(doctor!=null){
//			return GlobalConstant.FLAG_Y.equals(jswjwBiz.getCfgCode("jswjw_"+doctor.getOrgFlow()+"_P001"));
//		}else {
//			return false;
//		}
        ...
        if (null != cfg && StringUtil.isNotBlank(cfg.getCfgValue()) && cfg.getCfgValue().equals(GlobalConstant.FLAG_N)) {
            ...
            if (null!=cfgTime && StringUtil.isNotBlank(cfgTime.getCfgValue())){
                ...
                if (results!=null && results.size()>0){
                    model.addAttribute("edit", GlobalConstant.FLAG_N);
...
//				if (!(GlobalConstant.FLAG_N.equals(isSendFlag) && (null == isJDZSGC || GlobalConstant.FLAG_N.equals(isJDZSGC)))) {//如果学校未开且基地专硕未开
//					f=true;
//				}
//			}
//			if(!f) {
...
//				if ((GlobalConstant.FLAG_Y.equals(isJDGC) && GlobalConstant.FLAG_Y.equals(isJDZSGC))) {
//					f=true;
//				}
//			}
...
//        param.put("deptFlow", user.getDeptFlow());
    ...
    public String addSubDept(String userFlow, String deptFlow, String sysDeptFlow, String headFlow, String teacherFlow, String subDeptName, String startDate, String endDate, Model model, String schMonth) throws ParseException {
        ...
        example.createCriteria().andSchStartDateBetween(startDate,endDate).andSchEndDateGreaterThanOrEqualTo(endDate).andTeacherUserFlowEqualTo(teacherFlow).andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y);
        ...
        example1.createCriteria().andSchEndDateBetween(startDate,endDate).andSchStartDateLessThanOrEqualTo(startDate).andTeacherUserFlowEqualTo(teacherFlow).andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y);
        ...
        example2.createCriteria().andSchStartDateLessThanOrEqualTo(startDate).andSchEndDateGreaterThanOrEqualTo(endDate).andTeacherUserFlowEqualTo(teacherFlow).andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y);
        ...
        example3.createCriteria().andSchStartDateBetween(startDate,endDate).andSchEndDateBetween(startDate,endDate).andTeacherUserFlowEqualTo(teacherFlow).andRecordStatusEqualTo(GlobalConstant.RECORD_STATUS_Y);
...
//		if(isChargeOrg(userFlow)){
        ...
        model.addAttribute("isChargeOrg", GlobalConstant.FLAG_Y.equals(jswjwBiz.getJsResCfgAppMenu(userFlow)));
...
//		System.err.println(form.getUploadFileData());
    ...
    public String userCenter(String userFlow, HttpServletRequest request, HttpServletResponse response, Model model) {
       ...
       /* String doctorExam = jswjwBiz.getJsResCfgCode("jsres_doctor_exam_" + userFlow);
        boolean isCkk = GlobalConstant.RECORD_STATUS_Y.equalsIgnoreCase(doctorExam);
...
//        boolean monthFirst = jswjwBiz.saveLoginLog(userinfo);
        ...
        model.addAttribute("tipFlag", GlobalConstant.FLAG_N);
        if (monthFirst) {
...
//            }
    ...
    public Object showCertificateImage(String recordFlow, HttpServletRequest request, HttpServletResponse response, Model model) {
        Map<String, Object> map = new HashMap<>();
        map.put("code", "0");
        ResDoctorRecruit recruit = jswjwStudentBiz.readRecruit(recordFlow);
        if (recruit != null) {
            map.put("code", "1");
...
//            String chargeRole = jswjwBiz.getCfgCode("res_charge_role_flow");
            ...
            if (isDoctor) {
                ResDoctorRecruit recruit = jswjwBiz.getNewRecruit(userFlow);
                if (null == recruit || !recruit.getAuditStatusId().equals("Passed") || !recruit.getConfirmFlag().equals(GlobalConstant.FLAG_Y)) {
                ...
                if (null != doctor) {
                    ...
                    if (!isRecruit.equals(GlobalConstant.FLAG_Y)) {
                        ...
                        if (doctor != null) {
                            ...
                            if (authCount > 0) {
                                model.addAttribute("authFlag", GlobalConstant.FLAG_Y);
                            } else {
                                model.addAttribute("authFlag", GlobalConstant.FLAG_N);
...
//                    return "res/jswjw/login";
                ...
                if (GlobalConstant.FLAG_Y.equals(orgGuoChent)) {
                    model.addAttribute("isChargeOrg", GlobalConstant.FLAG_Y);
                } else {
                    model.addAttribute("isChargeOrg", GlobalConstant.FLAG_N);
                }
...
//				biMap.put(dept.getRecordFlow(),doctorDeptDetail);
    ...
    public String main(Model model, String userFlow) {
        ...
        model.addAttribute("isAllowApply", isAllowApply);
//        model.addAttribute("isAllowApply", GlobalConstant.FLAG_Y);
...
//                    'OneYear' then '一年' 'TwoYear' then '两年' 'ThreeYear' then '三年'
    ...
    public String doRegister(ResDoctorRecruit recruit,String userFlow,String prevRecruitFlow, String prevCompleteFileUrl, String prevCompleteCertNo,Model model){
        model.addAttribute("resultId", "200");
...
//                    'OneYear' then '一年' 'TwoYear' then '两年' 'ThreeYear' then '三年'
    ...
    public String validate(Model model,String doctorFlow,String sessionNumber){
        ...
        if(null == doctor){
            ...
            model.addAttribute("isPass",GlobalConstant.FLAG_N);
            return "res/jswjw/success";
        }
        if(StringUtil.isNotBlank(doctorFlow) && StringUtil.isNotBlank(sessionNumber)){
            ...
            if(recruit!=null && (!recruits.isEmpty())){
                ...
                model.addAttribute("isPass",GlobalConstant.FLAG_Y);
                return "res/jswjw/success";
            }
        }
        model.addAttribute("isPass",GlobalConstant.FLAG_Y);
...
//                    'OneYear' then '一年' 'TwoYear' then '两年' 'ThreeYear' then '三年'
    ...
    public String checkOutTime(String userFlow, String processFlow, Model model) throws ParseException {
        ...
        //超时
        model.addAttribute("isOutTime", GlobalConstant.FLAG_N);
            ...
            if(null != resDoctorSchProcess && (StringUtil.isNotEmpty(resDoctorSchProcess.getOutDate()) || StringUtil.isNotEmpty(resDoctorSchProcess.getSchEndDate()))){
                ...
                if (StringUtil.isNotEmpty(isChargeOrg)) {
                    if(StringUtil.isNotEmpty(outDay) && !"-1".equals(outDay)){
                        ...
                        if(num > 0){
                            //超时
                            model.addAttribute("isOutTime", GlobalConstant.FLAG_Y);
                            //出科时间
