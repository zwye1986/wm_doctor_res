...
public class GzzyTestController {

private static Logger logger = LoggerFactory.getLogger(GzzyTestController.class);
	...
	public String test(){
		return "res/gzzyres/student/test";
	}
	...
	public String teachertest(){
		return "res/gzzyres/teacher/test";
	}
	...
	public String secretarietest(){
		return "res/gzzyres/secretarie/test";
	}
