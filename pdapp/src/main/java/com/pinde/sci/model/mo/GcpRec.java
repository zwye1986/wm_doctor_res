...
public class GcpRec extends MybatisObject {
    private String recFlow;

    private String projFlow;

    private String gcpStageId;
    ...
    public String getGcpStageId() {
        return gcpStageId;
    }

    public void setGcpStageId(String gcpStageId) {
        this.gcpStageId = gcpStageId;
    }

    public String getGcpStageName() {
        return gcpStageName;
    }

    public void setGcpStageName(String gcpStageName) {
        this.gcpStageName = gcpStageName;
    }
