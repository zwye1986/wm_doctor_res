...
public class ExpertEvalResult extends MybatisObject {
    ...
    public String getParentCfgFlow() {
        return parentCfgFlow;
    }

    public void setParentCfgFlow(String parentCfgFlow) {
        this.parentCfgFlow = parentCfgFlow;
    }
