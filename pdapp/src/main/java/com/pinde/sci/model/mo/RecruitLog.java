...
public class RecruitLog extends MybatisObject {
    ...
    public String getChangeUserFlow() {
        return changeUserFlow;
    }

    public void setChangeUserFlow(String changeUserFlow) {
        this.changeUserFlow = changeUserFlow;
    }
