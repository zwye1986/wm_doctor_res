...
public class GlobalConstant {
	...
	public static final String PARAM_FLAG_ZERO = "0";
	public static final String PARAM_FLAG_ONE = "1";
	public static final String PARAM_FLAG_TWO = "2";
	...
	//默认表单
	public static final String RES_DEFAULT_FORM = "njykdxsxs";
	public static final String RES_HBRES_DEFAULT_FORM = "hbszyysgfhpxglpt";
	public static final String RES_XNRES_DEFAULT_FORM = "hbszyysgfhpxglpt";
	public static final String RES_EZHUPEI_DEFAULT_FORM = "hbszyysgfhpxglpt";
	public static final String RES_ZSEY_DEFAULT_FORM = "zsey";
	public static final String RES_JSZY_DEFAULT_FORM = "jszy";
	public static final String RES_GZZYYY_DEFAULT_FORM = "gzzyyy";
	public static final String RES_SCTCM123_DEFAULT_FORM = "sczyfy";
	public static final String RES_RUIJIN_DEFAULT_FORM = "shrjyy";
	public static final String RES_DGDH_DEFAULT_FORM = "dgdhyy";
	public static final String RES_SHFX_DEFAULT_FORM = "shfx";
