...
<html>
<head>
<title>广州中医医院住院医师APP测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/gzzyyy'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/gzzyyy/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
						...
						<option value="joinExam" method="get" needDataType="N" <c:if test="${param.reqCode=='joinExam'}">selected</c:if> >5.0.7 开始考试(joinExam)post</option>
					...
					<a href="<s:url value='/res/gzzyyy/student/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/gzzyyy/teacher/test'/>">老师端测试工具</a>
					<script>
						function reload(){
