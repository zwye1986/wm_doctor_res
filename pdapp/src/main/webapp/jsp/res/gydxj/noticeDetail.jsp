...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			var url ="<s:url value='/res/gydxj/showNotice?infoFlow='/>"+recordFlow;
			$.ajax({
				type : "get",
				url : url,
				cache : false,
				success : function(resp) {
					...
					$.each(a , function(i , n){
						...
						$(this).after("<font color='blue'>"+fileName+"(附件请至电脑端下载查看！)</font>");
						$(this).remove();
					});
...
<div width="100%" height="100%" align="center" style="">
	<div height="auto" width="auto" align="center" style="font-size:30px;">
		<h2 id="title">
		</h2>
	</div>
	<div height="auto" width="auto" id="content" align="left" style="font-size:18px;">
	</div>
</div>
</body>
</html>