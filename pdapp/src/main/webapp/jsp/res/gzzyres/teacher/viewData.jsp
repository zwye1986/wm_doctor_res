<%@ page language="java" contentType="application/json; charset=UTF-8" pageEncoding="UTF-8"%>
{
    ...
    ,
	    ...
	    <c:if test='${funcFlow eq "0005"}'>
	     	<jsp:include page="viewData_0005.jsp"></jsp:include>
	    </c:if>
	    <c:if test='${funcFlow eq "0006"}'>
	    	<jsp:include page="viewData_0006.jsp"></jsp:include>
	    </c:if>
	    <c:if test='${funcFlow eq "0006_1"}'>
	    	<jsp:include page="viewData_0006_1.jsp"></jsp:include>
	    </c:if>
