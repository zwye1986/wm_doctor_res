...
<html>
<head>
<title>成都中医药大学测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/sctcm120'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/sctcm120/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/sctcm120/student/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/sctcm120/teacher/test'/>">老师端测试工具</a>
					<a href="<s:url value='/res/sctcm120/kzr/test'/>">科主任端测试工具</a>
					<script>
						function reload(){
