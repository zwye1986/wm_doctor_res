		...
		<c:forEach items="${list}" var="b" varStatus="s">
	     	{
				...
				"operId":
					<c:choose>
						...
						<c:when test="${(param.typeId  eq 'isEval' and b.isScan eq 'Y'and b.isScan2 eq 'Y' and empty b.evalScore2)||(b.isEffective eq 'Y' and empty b.evalScore2)}">
							"Evaluate",
						</c:when>
						<c:when test="${(param.typeId  eq 'isEval' and b.isScan eq 'Y'and b.isScan2 eq 'Y' and not empty b.evalScore2)||(b.isEffective eq 'Y' and not empty b.evalScore2)}">
							"ShowEvaluate",
						</c:when>
