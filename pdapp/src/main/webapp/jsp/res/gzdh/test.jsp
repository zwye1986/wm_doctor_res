...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/gzdh'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/gzdh/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/gzdh/student/test'/>">学生端测试工具</a>
					...
					<a href="<s:url value='/res/gzdh/km/test'/>">科秘端测试工具</a>
					<script>
						function reload(){
