		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>体格检查评分表（甲状腺体检）
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td rowspan="7">局部检查（60分）（甲状腺检查） </td>
						<td rowspan="2">视诊</td>
						<td>5</td>
						<td colspan="3">病人体位和医生站位正确</td>
					...
					<tr>
						<td>8</td>
						<td colspan="3">观察颈部有无异常隆起，嘱患者做吞咽动作，观察颈部有无有随吞咽上下活动的肿块</td>
					...
					<tr>
						<td rowspan="4">触诊</td>
						<td>15（正确完成一种方法得10分；了解2种方法加5分）</td>
						<td colspan="3">医生站位和检查手法正确1）检查者站在患者身后，拇指置于患者颈部，双手示、中、环指置于胸锁乳突肌中点内侧的气管两侧；中指在甲状腺表面轻轻滑动，了解甲状腺情况2）检查者坐在患者面前，双手拇指置于胸锁乳突肌中点的内侧气管的两侧，以一手指将气管推向对侧，另一手扣摸对侧甲状腺。</td>
					...
					<tr>
						<td>8</td>
						<td colspan="3">嘱患者做吞咽动作，了解有无随吞咽动作上下活动的肿块</td>
					...
					<tr>
						...
						<td><input name="part10" type="text" value="${formDataMap['part10']}" class="inputText ctrlInput validate[required,custom[number],max[8],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>8</td>
						<td colspan="3">检查颈部淋巴结：气罐区（颈前区）、胸锁乳突肌内侧深面（胸锁乳突肌区）、胸锁乳突肌外侧锁骨上凹（颈后区）有无肿大淋巴结
						</td>
						...
						<td><input name="part11" type="text" value="${formDataMap['part11']}" class="inputText ctrlInput validate[required,custom[number],max[8],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>听诊</td>
						<td>8</td>
						<td colspan="3">将听诊器置于甲状腺区仔细听有无血管杂音</td>
						...
						<td><input name="part12" type="text" value="${formDataMap['part12']}" class="inputText ctrlInput validate[required,custom[number],max[8],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>结果提问（5分）</td>
