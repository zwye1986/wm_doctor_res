      ...
      <div class="content">
        ...
        <form id="resRecForm" method="post">
   		...
   		<table class="basic" width="100%">
             <tr>
				<td style="width: 90px;"><span style="color: red;">*</span>活动形式：</td>
                <td>
                	<c:if test="${doctor}">
				...
				<td style="width: 90px;"><span style="color: red;">*</span>日期：</td>
                <td >
                	<c:if test="${doctor}">
			...
			<tr>
             	<td style="width: 90px;"><span style="color: red;">*</span>学时(小时)：</td>
                <td>
                	<c:if test="${doctor}">
	               		<select name="activity_period" style="width: 144px;" class="autoValue validate[required]">
	       					<option></option>
				...
				<td style="width: 90px;"><span style="color: red;">*</span>主讲人：</td>
                <td >
                	<c:if test="${doctor}">
			...
			<tr>
				<td style="width: 90px;"><span style="color: red;">*</span>内容：</td>
				<td colspan="3">
					<c:if test="${doctor}">
