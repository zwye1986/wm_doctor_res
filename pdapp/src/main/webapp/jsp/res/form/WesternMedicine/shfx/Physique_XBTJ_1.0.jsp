		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>体格检查评分表（胸部体检）
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td rowspan="11">胸部体格检查（60分）</td>
						<td rowspan="3">胸部视诊</td>
						<td>5</td>
						<td colspan="3">能指出胸部体表主要骨骼标志、主要垂直标志（锁骨中线）及主要自然凹陷</td>
					...
					<tr>
						<td>5</td>
						<td colspan="3">在视诊内容方面，能提到观察胸廓性状（桶状胸、扁平胸、肋间隙是否饱满、乳房是否对称等）</td>
					...
					<tr>
						<td>6</td>
						<td colspan="3">能答出视诊可观察：呼吸运动、呼吸频率、呼吸节律者</td>
					...
					<tr>
						<td rowspan="3">胸部触诊</td>
						<td>5</td>
						<td colspan="3">胸部（廓）扩张度双手触诊方法正确</td>
					...
					<tr>
						<td>5</td>
						<td colspan="3">能提到胸部触诊可触胸膜摩擦音，并能进行正确操作</td>
					...
					<tr>
						<td rowspan="3">胸部叩诊</td>
						<td>5</td>
						<td colspan="3">间接叩诊时手指动作、方法、顺序正确</td>
					...
					<tr>
						...
						<td><input name="part14" type="text" value="${formDataMap['part14']}" class="inputText ctrlInput validate[required,custom[number],max[6],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td rowspan="2">胸部听诊</td>
						<td>5</td>
						<td colspan="3">听诊方法、顺序正确</td>
					...
					<tr>
						<td>8</td>
						<td colspan="3">能表述听诊（肺部听诊）四种主要内容（正常呼吸音、异常呼吸音、啰音、胸膜摩擦音）</td>
