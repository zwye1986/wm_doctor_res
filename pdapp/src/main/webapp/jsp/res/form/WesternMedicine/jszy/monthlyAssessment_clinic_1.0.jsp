			...
			<label></label>
				...
				<table class="basic" width="100%" >
					...
					<tr>
						...
						<td style="text-align: center;">
							<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number]]" name="part06" type="text" readonly value="${formDataMap['part06']}" style="width: 150px;"/><br>
						</td>
					</tr>
           		  	<tr >
						<td colspan="5">
