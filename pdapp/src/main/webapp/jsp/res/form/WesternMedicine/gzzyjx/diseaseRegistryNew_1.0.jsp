			...
			<form id="diseaseForm" enctype="multipart/form-data" method="post">
				...
				<table class="basic" width="100%">
					<tr>
						...
						<td >
							<c:if test="${doctor}">
							<input style="width: 160px;" class="validate[required]" name="disease_mrNo" type="text" value="${formDataMap['disease_mrNo']}" style="margin-right: 0px"/>
							</c:if>
							<c:if test="${!doctor}">
						...
						<td >
							<c:if test="${doctor}">
							<input style="width: 160px;" class="validate[required]" name="disease_pName" type="text" value="${formDataMap['disease_pName']}" style="margin-right: 0px"/>
							</c:if>
							<c:if test="${!doctor}">
					...
					<tr>
						...
						<td >
							<c:if test="${doctor}">
							<input style="width: 160px;" class="validate[required]" name="disease_teacherName" type="text" value="${formDataMap['disease_teacherName']}" style="margin-right: 0px"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['disease_teacherName']}
							</c:if>
						</td>
						<td colspan="2"></td>
