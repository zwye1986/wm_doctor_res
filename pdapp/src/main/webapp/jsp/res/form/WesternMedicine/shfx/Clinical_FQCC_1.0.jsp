		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>腹腔穿刺术操作技能考核评分表
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td colspan="5">根据病情和需要可取平卧位、半卧位或稍左侧卧位，使病人舒适，以便能耐受较长手术时间</td>
						<td>4</td>
					...
					<tr>
						...
						<td colspan="5">定位：左下腹部脐与髂前上棘连线的中外 1/3 交点处，不易损伤腹壁动脉</td>
						<td>5</td>
					...
					<tr>
						<td colspan="5">①左手固定穿刺部位皮肤（2.5 分）②右手持针经麻醉处垂直刺入腹壁（2.5 分）③然后倾斜 45°-60°1-2cm 后在垂直刺于腹膜层后（2.5 分）④待感针峰抵抗感突然消失时，表示针头已穿过腹壁壁层（2.5分）</td>
						<td>10</td>
					...
					<tr>
						<td colspan="5">术后嘱病人静卧、告诉病人有不适立即通知医护人员</td>
						<td>2</td>
