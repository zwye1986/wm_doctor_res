		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>深静脉穿刺术操作技能考考核评分表
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td rowspan="3">病人及物品准备（21 分）</td>
						<td colspan="5">1、戴帽子、口罩；准备物品，清点物品是否齐全（5 分）</td>
						<td>5</td>
					...
					<tr>
						<td colspan="5">2、核对病人信息（3 分）；向病人解释滞留目的（5 分）消除紧张感（3 分）</td>
						<td>11</td>
						<td><input name="part01" type="text" value="${formDataMap['part01']}" class="inputText ctrlInput validate[required,custom[number],max[11],min[0]] scoreCount" style="width:90%; "  style="width: 80px;"/></td>
					</tr>
					<tr>
						<td colspan="5">3、根据选择穿刺部位，摆好体位。体位：根据不同的穿刺点，选择不同的体位，颈内及锁骨下静脉穿刺要求垫高肩背部，股静脉穿刺要求患者穿刺侧肢轻度外旋（5 分）</td>
						<td>5</td>
					...
					<tr>
						<td rowspan="3">消毒铺巾（16 分）</td>
						<td colspan="5">1、常规消毒术去皮肤 2 遍（5 分）；直径 15cm 逐步减少（3 分）</td>
						<td>8</td>
					...
					<tr>
						<td colspan="5">2、打开无菌静脉穿刺包，戴无菌手套（5 分）</td>
						<td>5</td>
					...
					<tr>
						<td colspan="5">3、铺无菌洞巾 3</td>
						<td>3</td>
						<td><input name="part05" type="text" value="${formDataMap['part05']}" class="inputText ctrlInput validate[required,custom[number],max[3],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td rowspan="7">穿刺、留置深静脉导管（36 分）</td>
						<td colspan="5">1、检查器械，包括：穿刺针是否通畅（2 分），并将肝素钠盐水充满导管（2分），抽取利多卡因局麻药（静脉导管包有助手打开，利多卡因安剖瓶有助手打开）（2 分）</td>
						<td>6</td>
					...
					<tr>
						<td colspan="5">2、局麻（是否有皮丘），局部浸润麻醉，进针后先回抽（是否回血）（3 分），然后在注射局麻药物，麻醉完毕，后按压少许（局麻过程中有无爱伤观念）（3 分）
						</td>
						<td>6</td>
					...
					<tr>
						<td colspan="5">3、试探血管，初学者或者无把握，可在局麻时试探血管位置（3 分）</td>
						<td>3</td>
					...
					<tr>
						<td colspan="5">4、穿刺针内少许肝素钠盐水，负压进针（2 分），待进入血管后，固定穿刺针（2 分），由助手传递导丝，进导丝时慢，如果不顺可拔出导丝后，适当调整穿刺针位置。（2 分）</td>
						<td>6</td>
					...
					<tr>
						<td colspan="5">5、导丝进入后，根据不同部位，选择导丝的深度，退穿刺针，注意导丝不要内穿刺针同时带出（4 分）
						</td>
						<td>4</td>
					...
					<tr>
						<td colspan="5">6、扩皮，扩皮时注意出血，有无意识减少出血，并注意不要将导丝带出（4分）
						</td>
						<td>4</td>
					...
					<tr>
						<td colspan="5">7、留置导管，根据穿刺部位不同选择导管深度（6 分）</td>
						<td>6</td>
						<td><input name="part12" type="text" value="${formDataMap['part12']}" class="inputText ctrlInput validate[required,custom[number],max[6],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td rowspan="4">穿刺结束（15分）</td>
						<td colspan="5">1、肝素钠盐水冲管并肝素帽封管</td>
						<td>3</td>
						<td><input name="part14" type="text" value="${formDataMap['part14']}" class="inputText ctrlInput validate[required,custom[number],max[3],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td colspan="5">2、固定导管，包括管道的蝶形夹（3 分）和缝合固定（3 分） </td>
						<td>6</td>
					...
					<tr>
						<td colspan="5">3、再次消毒穿刺部位，擦干皮肤，盖辅料（3 分）  </td>
						<td>3</td>
					...
					<tr>
						<td colspan="5">4、瞩患者注意事项，包括局部运动和皮肤卫生及不适及时通知医护人员（4分）</td>
						<td>4</td>
					...
					<tr>
						...
						<td colspan="5"></td>
						<td>7</td>
						<td><input name="part18" type="text" value="${formDataMap['part18']}" class="inputText ctrlInput validate[required,custom[number],max[7],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>人文关怀（5 分）</td>
						<td colspan="5">体现在整个操作过程中 </td>
						<td>5</td>
						<td><input name="part19" type="text" value="${formDataMap['part19']}" class="inputText ctrlInput validate[required,custom[number],max[5],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
				</table>
			</div>
		</form>
