...
<%--       	 			</c:if> --%>
        		...
        		<tr>
        			...
        			<td style="width: 12%;"><font color="red">*</font>操作日期:</td>
        			<td style="width: 21%;">
        				<c:if test="${doctor}">
        			...
        			<td>
        				<c:if test="${doctor}">
	        				<label><input class="validate[required] autoValue" type="radio" name="skill_status" <c:if test="${'1' eq formDataMap['skill_status_id']}">checked</c:if> value="1" onchange="check(this.value);"/>术者</label>&#12288;
	        				<label><input class="validate[required] autoValue" type="radio" name="skill_status"  <c:if test="${'0' eq formDataMap['skill_status_id']}">checked</c:if> value="0" onchange="check(this.value);"/>助手</label>
        				</c:if>
        				<c:if test="${!doctor}">
        					${formDataMap['skill_status']}
							<input type="hidden" name="skill_status" value="${formDataMap['skill_status_id']}"/>
							<input type="hidden" name="skill_status_name" value="${formDataMap['skill_status']}"/>
        				</c:if>
        			</td>
        			</tr>
			</table>
