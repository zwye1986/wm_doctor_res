		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>体格检查评分表（腹部体检）
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td rowspan="14">腹部体格检查（60分） </td>
						<td rowspan="3">腹部视诊</td>
						<td>4</td>
						<td colspan="3">腹部的体表标志及区分表述正确并能在腹部指点正确</td>
						...
						<td><input name="part06" type="text" value="${formDataMap['part06']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">视诊方法正确</td>
						...
						<td><input name="part07" type="text" value="${formDataMap['part07']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>5</td>
						<td colspan="3">能表述视诊主要内容（腹部外形、呼吸运动、腹壁静脉、胃肠型和蠕动波）</td>
					...
					<tr>
						<td rowspan="3">腹部听诊</td>
						<td>4</td>
						<td colspan="3">听诊顺序方法正确</td>
						...
						<td><input name="part09" type="text" value="${formDataMap['part09']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">能正确听诊并表述肠鸣音（正常、亢进、消失）</td>
						...
						<td><input name="part10" type="text" value="${formDataMap['part10']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">血管杂音（动脉性和静脉性）听着呢部位正确</td>
						...
						<td><input name="part11" type="text" value="${formDataMap['part11']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>

					<tr>
						<td rowspan="5">腹部叩诊</td>
						<td>4</td>
						<td colspan="3">叩诊手法、动作、力量、顺序正确</td>
						...
						<td><input name="part12" type="text" value="${formDataMap['part12']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>5</td>
						<td colspan="3">移动性浊音叩诊方法正确</td>
					...
					<tr>
						...
						<td><input name="part14" type="text" value="${formDataMap['part14']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">脊肋角叩击痛检查方法正确</td>
						...
						<td><input name="part15" type="text" value="${formDataMap['part15']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">肝浊音界叩诊方法正确</td>
						...
						<td><input name="part16" type="text" value="${formDataMap['part16']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td rowspan="3">腹部触诊</td>
						<td>4</td>
						<td colspan="3">触诊手法、顺序正确</td>
						...
						<td><input name="part17" type="text" value="${formDataMap['part17']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>6</td>
						<td colspan="3">肝脾触诊及测量方法正确</td>
						<td><input name="reason18" type="text" value="${formDataMap['reason18']}" class="inputText ctrlInput validate[required]" style="width:90%; "  style="width: 150px;"/></td>
						<td><input name="part18" type="text" value="${formDataMap['part18']}" class="inputText ctrlInput validate[required,custom[number],max[6],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">在下列项目中任选二项，操作方法正确（腹部肿块、液波震颤、振水音、压痛及反跳痛）</td>
						<td><input name="reason19" type="text" value="${formDataMap['reason19']}" class="inputText ctrlInput validate[required]" style="width:90%; "  style="width: 150px;"/></td>
						<td><input name="part19" type="text" value="${formDataMap['part19']}" class="inputText ctrlInput validate[required,custom[number],max[4],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
