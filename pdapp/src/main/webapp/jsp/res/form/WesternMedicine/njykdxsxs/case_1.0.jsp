      ...
      <div class="content">
        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
             ...
             <tr>
				<td style="width: 100px;"><font color="red">*</font>科室：</td>
                <td >
				...
				<td>
					<input style="width: 150px;" class="validate[required] " name="finishTime" type="text" value="${formDataMap['finishTime']}" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>
				</td>
			</tr>
			<tr>
             	<td style="width: 100px;"><font color="red">*</font>病名：</td>
                <td >
