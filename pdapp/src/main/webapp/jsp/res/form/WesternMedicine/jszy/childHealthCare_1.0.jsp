            ...
            <form id="editform" enctype="multipart/form-data" method="post">
                ...
                <table class="basic" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 120px;text-align: right;"><font color="red">*</font>母亲姓名：</td>
                        <td>
                            <c:if test="${!empty doctor}">
                                <input class="validate[required]" name="motherName" type="text" value="${formDataMap['motherName']}"
                                       style="width: 150px;"/>
                            </c:if>
                            <c:if test="${empty doctor}">
                                <label>${formDataMap['motherName']}</label>
                            </c:if>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <c:if test="${!empty doctor}">
                                <input class="validate[required]" name="childAge" type="text" value="${formDataMap['childAge']}"
                                       style="width: 150px;"/>
                            </c:if>
                            <c:if test="${empty doctor}">
                                <label>${formDataMap['childAge']}</label>
                            </c:if>
                        </td>
                    </tr>
                    <tr>
