        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
			...
			<tr>
				...
				<td>
					<input class="validate[required] "  readonly="readonly" value="${formDataMap['time'] }" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" name="time" type="text" value="${formDataMap['caseNo']}" style="width: 150px;margin-left: 5px;"/>
				</td>
			</tr>
			<tr>
				<td>
				实习主要内容:</td>
				<td>
				<textarea class="xltxtarea" name="content" style="height: 250px;">${formDataMap['content'] }</textarea>
				</td>
			</tr>
         </table>
			<p align="center">
