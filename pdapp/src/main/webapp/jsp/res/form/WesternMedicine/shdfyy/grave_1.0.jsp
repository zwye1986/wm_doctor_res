        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
			...
			<tr>
				...
				<td style="width: 30%;">
					<input class="validate[required] " name="prognosis" type="text" value="${formDataMap['prognosis']}" style="width: 150px;"/>
				</td>
				<td style="width: 20%;"><font color="red">*</font>上级医师：</td>
				<td style="width: 30%;">
					<input class="validate[required] " name="higherDoctor" type="text" value="${formDataMap['higherDoctor']}" style="width: 150px;"/>
				</td>
			</tr>
			<tr>
				<td style="width: 100px;"><font color="red">*</font>病历号：</td>
				<td>
					<input class="validate[required]" name="cardNo" type="text" value="${formDataMap['cardNo']}" style="width: 150px;"/>
				</td>
