...
$(function(){
	...
	<c:if test="${rec.auditStatusId eq recStatusEnumTeacherAuditY.id || !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR) || param.isRead}">
		$("#skillForm :input:not(:hidden,:button)").each(function(){
...
<!-- 	                		</div> -->
		      	 			<input id="viewContainer" type="text" value="${rec.itemName}" class="validate[required]" style="width: 100%;" readonly="readonly" onclick="viewReqs();" placeholder="点击选择子项"/>
