      ...
      <div class="content">
		...
		<input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
             ...
             <tr>
             	<td style="width: 150px;text-align: right"><font color="red">*</font>&#12288;技术操作及手术名称：</td>
               <td colspan="3">
                	<script>
	                	$(function(){
...
<!-- 	                		</div> -->
      	 			...
      	 			<div id="otherName" style="float: left;display: none;margin-left: 20px;height: 0px;overflow: visible;margin-top: -9px;">
	      	 			...
	      	 			<input type="text" name="regItem" value="${formDataMap['skillName']}" style="width: 150px;" class="validate[required]"/>
      	 			</div>
      	 			<c:if test="${rec.auditStatusId eq recStatusEnumTeacherAuditY.id || !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR) || param.isRead}">
             ...
             <tr>
             	...
             	<td style="width: 100px;text-align: right"><font color="red">*</font>&#12288;日期：</td>
                <td>
              ...
              <tr>
				  <td style="width: 100px;text-align: right"><font color="red">*</font>&#12288;助手：</td>
				  <td>
					  <select style="width: 154px;" class="validate[required]"  name="assistant">
						  <option value="第一助手" ${formDataMap['assistant'] eq '第一助手'?'selected':''}>第一助手</option>
						  <option value="第二助手" ${formDataMap['assistant'] eq '第二助手'?'selected':''}>第二助手</option>
					  </select>
				  </td>
             	<td style="width: 100px;text-align: right;min-width: 140px;"><font color="red">*</font>&#12288;住院号/检查号：</td>
                 <td>
                    <input style="width: 150px;" class="validate[required]" name="status" type="text" value="${formDataMap['status']}" />
				</td>
             </tr>
			<tr>
				<td style="width: 100px;text-align: right"><font color="red">*</font>&#12288;考核者：</td>
				<td colspan="3">
					<input style="width: 150px;" class="validate[required]" name=assessment type="text" value="${formDataMap['assessment']}" />
				</td>
			</tr>
              </table>
			<p align="center">
