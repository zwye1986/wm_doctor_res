      ...
      <div class="content">
        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
             ...
             <tr>
             	<td style="width: 20%;"><font color="red">*</font>科室：</td>
                <td style="width: 30%;">
                    <input class="validate[required] " name="dept" type="text" value="${formDataMap['dept']}" style="width: 150px;"/>
				</td>
				<td style="width: 20%;"><font color="red">*</font>病名：</td>
                <td style="width: 30%;">
                    <input class="validate[required] " name="name" type="text" value="${formDataMap['name']}" style="width: 150px;"/>
				</td>
			</tr>
			<tr>
				<td style="width: 100px;"><font color="red">*</font>病例号：</td>
				<td>
