...
function hideButton() {
	$("#documentForm").find('input,textarea').attr("readonly","readonly");
	$("#documentForm").find("select,:checkbox,:radio").attr("disabled", "disabled");
	$("#documentForm").find(":button,.opBtn").hide();
...
function saveForm(){
	...
	if($("#documentForm").validationEngine("validate")){
		jboxPost("<s:url value='/res/rec/saveRegistryForm'/>",$('#documentForm').serialize(),function(){
...
function printForm() {
    var url = "<s:url value='/res/rec/printInfo?recFlow=${rec.recFlow}&&recType=Ethics'/>";
		...
		<div class="content">
			<div class="title1 clearfix">
				<table class="basic" width="100%">
					<tr>
						<th colspan="5" style="text-align: left;">&#12288;医学文案</th>
					</tr>
					<tr >
      ...
      <div class="content">
        <div class="title1 clearfix">
				<table class="basic" width="100%" >
					...
					<tr>
					<td >
						<textarea class="xltxtarea" name="thematicReview" style="height: 500px;">${formDataMap['thematicReview']}</textarea>
					</td>
					</tr>
				</table>
				</div>
