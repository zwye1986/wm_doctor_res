...
<!-- 	                		</div> -->
        		...
        		<tr>
        			...
        			<td colspan="3" style="width: 30%;">
        				<c:if test="${doctor}">
        					<input style="width: 160px;" type="text" class="validate[required]" name="disease_pDate" value="${formDataMap['disease_pDate']}" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>
        				</c:if>
        				<c:if test="${!doctor}">
        		...
        		<tr>
        			<td><span style="color: red">*</span>&nbsp;病历号/病理号：</td>
        			<td>
        				<c:if test="${doctor}">
        			...
        			<tr>
	        			...
	        			<td style="width: 21%;">
	        			<c:if test="${doctor}">
	        				<label><input type="radio" name="disease_isCharge" <c:if test="${'1' eq formDataMap['disease_isCharge_id']}">checked</c:if> value="1" class="autoValue validate[required]"/>是</label>&#12288;
        			...
        			<td style="width: 13%;"><span style="color: red">*</span>&nbsp;是否抢救：</td>
	        			...
	        			<c:if test="${doctor}">
        					...
        					<label><input type="radio" name="disease_isRescue"  <c:if test="${'0' eq formDataMap['disease_isRescue_id']}">checked</c:if> value="0" onchange="check(this.value);" class="autoValue validate[required]"/>否</label>
        				</c:if>
        				<c:if test="${!doctor}">
