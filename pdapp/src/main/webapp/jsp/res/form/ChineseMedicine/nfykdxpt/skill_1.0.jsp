...
<!-- 	                		</div> -->
      	 			...
      	 			<c:if test="${param.roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
      	 				<div style="float: right; margin-right: 350px;">名称:
...
<%--       	 			</c:if> --%>
        		...
        		<tr>
        			...
        			<td>
        				<c:if test="${param.roleFlag==GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
	        				<select name="skillIdentity" style="width: 115px;">
	        					<option></option>
	        					<option value="操作者" <c:if test="${'操作者' eq formDataMap['skillIdentity']}">selected</c:if>>操作者</option>
	        					<option value="助手" <c:if test="${'助手' eq formDataMap['skillIdentity']}">selected</c:if>>助手</option>
	        					<option value="其他人员" <c:if test="${'其他人员' eq formDataMap['skillIdentity']}">selected</c:if>>其他人员</option>
	        				</select>
	        				<input type="hidden" name="skillIdentity" value="${formDataMap['skillIdentity']}"/>
	        			</c:if>
	        			<c:if test="${param.roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
	        				${formDataMap['skillIdentity']}
	        			</c:if>
        			</td>
        		</tr>	
        	</table>
