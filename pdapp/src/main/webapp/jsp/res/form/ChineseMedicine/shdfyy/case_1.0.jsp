        ...
        <form id="dblForm">
        	...
        	<table class="basic" width="100%" style="margin-top: 10px;">
        		<tr>
        			...
        			<td style="width: 30%;">
        			<c:if test="${doctor}">
        				<input class="validate[required]" type="text" style="width:140px;" name="mr_pName" value="${formDataMap['mr_pName']}"/>
        			</c:if>
        			<c:if test="${!doctor}">
        			...
        			<td style="width: 30%;">
        			<c:if test="${doctor}">
        				<input class="validate[required]" type="text" style="width: 140px;" name="mr_no" value="${formDataMap['mr_no']}"/>
        			</c:if>
        			<c:if test="${!doctor}">
        		...
        		<tr>
        			...
        			<td style="width:30%;">
        				<c:if test="${doctor}">
        					<input class="validate[required]" type="text" style="width: 140px;" name="disease_pName" value="${formDataMap['disease_pName']}"/>
        				</c:if>
        				<c:if test="${!doctor}">
