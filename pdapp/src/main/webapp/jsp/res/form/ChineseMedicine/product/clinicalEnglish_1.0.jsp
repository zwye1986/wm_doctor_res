			...
			<div class="title1 clearfix">
				<table class="basic" width="100%">
					...
					<tr >
						...
						&#12288;<input type="text" class="inputText" name="teachTime" value="<c:out value="${formDataMap['teachTime']}" default="讲座1次/2周"/>"
							style="text-align:center; width:100px; border-width: 0px; border-bottom-width: 1px;"/>
						&#12288;&#12288;<font style="font-weight: bold;">负责科室：</font><input type="text" class="inputText" name="chartDept" value="<c:out value="${formDataMap['chartDept']}" default="内科和外科"/>"
							style="text-align:center; width:120px; border-width: 0px; border-bottom-width: 1px;"/>&#12288;&#12288;
							<font style="font-weight: bold;">总完成时间：</font><input type="text" class="inputText" name="totalCompleteTime" value="<c:out value="${formDataMap['totalCompleteTime']}" default="贯穿内外科"/>"
