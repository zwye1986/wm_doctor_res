...
"datas":[
            ...
            },
            {
                ...
                "readonly":${isRead},
                "required":true,
                "value":${pdfn:toJsonString(info.studyTimeId)}
            },
            {
                "inputId":"doctorFlow",
                "label":"跟师规培学员标识符：",
            ...
            },
            {
                ...
                "readonly":true,
                "required":true,
                "value":${pdfn:toJsonString(empty info.studentSignTime?pdfn:getCurrDate(): pdfn:transDate(info.studentSignTime))}
            },
            {
                "inputId":"files",
                "label":"附件：",
                ...
                </c:if>
            {
                ...
                "readonly":true,
                "required":true,
                "value":${pdfn:toJsonString(empty pdfn:transDate(info.auditTime) ? pdfn:getCurrDate() : pdfn:transDate(info.auditTime))}
            }
            </c:if>
]