...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/hbres/kzr'/>/"+action;
		//"?_method="+method;
		if(method=="put"){
			method = "post"
		}
...
<body>
	<form name="appForm" action="/pdapp/res/hbres/kzr/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			...
			<option value="activityStuList" method="post" needDataType="N" <c:if test="${param.reqCode=='activityStuList'}">selected</c:if> >3.3.15 教学活动报名与扫码学员列表(activityStuList)post</option>
					...
					<a href="<s:url value='/res/hbres/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/hbres/teacher/test'/>">带教端测试工具</a>
		</div>
