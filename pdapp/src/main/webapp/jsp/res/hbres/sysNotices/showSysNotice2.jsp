...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			var url ="<s:url value='/res/hbres/showSysNotice?infoFlow='/>"+recordFlow;
			$.ajax({
				type : "get",
				url : url,
				cache : false,
...
<div width="auto" height="auto" align="center" style="">
	<div height="auto" width="auto" align="center" style="font-size:19px;">
		<h2 id="title">
		</h2>
	</div>
	<div height="auto" width="auto" id="content" align="left" style="font-size:28px;">
	</div>
</div>
</body>
</html>