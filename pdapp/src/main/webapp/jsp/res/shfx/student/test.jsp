...
<html>
<head>
<title>奉贤住院医师APP学生端测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/shfx/student'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/shfx/student/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			...
			<option value="saveDeptActivtiyEval" method="post" needDataType="N" <c:if test="${param.reqCode=='saveDeptActivtiyEval'}">selected</c:if> >3.3.17 保存科室活动评价(saveDeptActivtiyEval)post</option>
					...
					<a href="<s:url value='/res/shfx/test'/>">测试工具</a>
		</div>
