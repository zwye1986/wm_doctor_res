...
"scoreType":"subtract",
		...
		},
		{
			"inputId":"t6",
			"inputType":"title",
			"label":"腹部的体表标志及区分表述正确并能在腹部指点正确（4分）"
		},
		{
			"inputId":"part06",
			"inputType":"text",
...
"scoreType":"subtract",
		...
		},
		{
			"inputId":"t8",
			"inputType":"title",
			"label":"能表述视诊主要内容（腹部外形、呼吸运动、腹壁静脉、胃肠型和蠕动波）（5分）"
		},
		{
			"inputId":"part08",
			"inputType":"text",
...
"scoreType":"subtract",
		...
		},
		{
			...
			"label":"扣分理由",
			"readonly":${isAudit}, 		"required":true,
			"value":${pdfn:toJsonString(formDataMap.reason18)}
		},
		{
			"inputId":"t19",
			"inputType":"title",
			"label":"在下列项目中任选二项，操作方法正确（腹部肿块、液波震颤、振水音、压痛及反跳痛）（4分）"
		},
		{
			"inputId":"part19",
			"inputType":"text",
...
"scoreType":"subtract",
		...
		},
		{
			...
			"label":"扣分理由",
			"readonly":${isAudit}, 		"required":true,
			"value":${pdfn:toJsonString(formDataMap.reason19)}
		},
		{
			"inputId":"t20",
			"inputType":"title",
