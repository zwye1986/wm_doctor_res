...
<script type="text/javascript">
	function test() {
		...
		if(action=="login" || action=="version" || action=="notice" || action=="noticeCount"){
			...
			url = "<s:url value='/res/bengyify/student'/>/"+action+"?_method="+method;	
		}
...
<body>
	<form name="appForm" action="${ctxPath}/res/bengyify/student/remember" method="get">
	...
	<div id="saveSignIn" class="reqParam" style="display: none">
		<textarea style="width: 350px; height: 400px" readonly="readonly">userFlow=${userFlow}&local=${local}&remark=${remark}</textarea>
	</div>
</body>
</html>
