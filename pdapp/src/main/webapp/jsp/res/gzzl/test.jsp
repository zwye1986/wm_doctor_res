...
<html>
<head>
<title>广州肿瘤住院医师APP测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/gzzl'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/gzzl/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			...
			<option value="zpNoticeDetail" method="post" needDataType="N" <c:if test="${param.reqCode=='zpNoticeDetail'}">selected</c:if> >3.4.2最新指南详情(zpNoticeDetail)post</option>
					...
					<a href="<s:url value='/res/gzzl/student/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/gzzl/teacher/test'/>">老师端测试工具</a>
					<a href="<s:url value='/res/gzzl/kzr/test'/>">科主任端测试工具</a>
					<script>
						function reload(){
