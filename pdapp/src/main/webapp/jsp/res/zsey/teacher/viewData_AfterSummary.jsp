<%@ page language="java" contentType="aplication/json; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	"values":[
		...
		<c:set value="${pdfn:getCurrDate()}" var="curDate"></c:set>
		{
			...
			{
				"inputId":"teacherSiginName",
				"value":${pdfn:toJsonString(empty formDataMap.teacherSiginName?tea.userName: formDataMap.teacherSiginName)}
			}
			,
			{
				"inputId":"teacherSiginDate",
				"value":${pdfn:toJsonString(empty formDataMap.teacherSiginDate?curDate: formDataMap.teacherSiginDate)}
			}
		<c:if test="${!empty formDataMap.deptHeadAutograth}">
			,
			{
