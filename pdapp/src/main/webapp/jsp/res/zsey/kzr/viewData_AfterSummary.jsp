<%@ page language="java" contentType="aplication/json; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	"values":[
		...
		<c:set value="${pdfn:getCurrDate()}" var="curDate"></c:set>
		{
			...
			{
				"inputId":"headSiginName",
				"value":${pdfn:toJsonString(empty formDataMap.headSiginName?tea.userName:formDataMap.headSiginName)}
			}
			,
			{
				"inputId":"headSiginDate",
				"value":${pdfn:toJsonString(empty formDataMap.headSiginDate? curDate :formDataMap.headSiginDate)}
			}
	]