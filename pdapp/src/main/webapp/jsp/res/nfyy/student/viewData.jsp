...
{ 
	...
	<c:if test="${resultId eq '200' }">
		...
		<c:if test='${param.funcFlow eq "0005" || param.funcFlow eq "0006"}'>
		...
		<c:if test='${param.funcFlow eq "0008"}'>
		    <jsp:include page="viewData_0008.jsp"></jsp:include>
		</c:if>
		<c:if test='${param.funcFlow eq "0009"}'>
	    ...
	    <c:if test='${param.funcFlow eq "D005"}'>
