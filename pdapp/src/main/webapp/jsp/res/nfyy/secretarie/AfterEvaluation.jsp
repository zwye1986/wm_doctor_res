<%@ page language="java" contentType="application/json; charset=UTF-8" pageEncoding="UTF-8"%>
{
    ...
    "datas": [
            ...
            },
            {
                ...
                "required":false,
                "readonly":true,
                "value":${pdfn:toJsonString(dayEval.TecName)}
            },
            {
                "id": "evalScore",
                "name": "日常评价|得分：",
                ...
                "required":false,
                "readonly":true,
                "value":${pdfn:toJsonString(dayEvalScore)}
            },
            {
                "id": "totelScore",
                "name": "总分：",
            ...
            },
            {
                ...
                "required":true,
                "readonly":true,
                "value":${pdfn:toJsonString(evalScore)}
            },
            {
                "id": "SickLeaveDay",
                "name": "请假：",
                ...
                "required":true,
                "readonly":false,
                "value":${pdfn:toJsonString(auditData.SickLeaveDay)}
            },
            {
                "id": "AbsenteeismDay",
                "name": "脱岗：",
                ...
                "required":true,
                "readonly":false,
                "value":${pdfn:toJsonString(auditData.AbsenteeismDay)}
            },
            {
                "id": "TecComment",
                "name": "带教老师鉴定意见：",
