...
<html>
<head>
<title>上海中山医院APP学生端测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/shzs/student'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/shzs/student/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			...
			<option value="saveEvalInfo" method="post" needDataType="N" <c:if test="${param.reqCode=='saveEvalInfo'}">selected</c:if> >5.0.7 保存活动评价(saveEvalInfo)post</option>
					...
					<a href="<s:url value='/res/shzs/test'/>">测试工具</a>
		</div>
