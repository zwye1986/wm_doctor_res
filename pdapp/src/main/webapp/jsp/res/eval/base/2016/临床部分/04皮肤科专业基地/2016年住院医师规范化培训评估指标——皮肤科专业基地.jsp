...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——皮肤科专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——皮肤科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院的皮肤科专业基地应设有皮肤门诊、性病门诊和皮肤科病房，总床位数≥10张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:必备科室:门诊部、急诊科、内科、外科、妇产科、放射科、病理科、超声科，皮肤科实验室（只要求为皮肤科常用的项目，如真菌检查和性病检查等）</td>
		...
		3.皮肤性病科门诊<br/>
		4.皮肤科病房<br/>5.皮肤病理科、实验室及治疗室)、感染科、影像科、超声科
		  </td>
          <td class="left">科室齐全，得满分<br/>必选科室缺1个科室，不得分<br/>可选科室缺2个科室，不得分 </td>
          <td>3<input type="hidden" name="baseScore" value="3"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
