...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——神经内科专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——神经内科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">神经内科、神经内科ICU或急诊室、心血管内科、呼吸内科、内分泌科、神经外科、医学影像科、神经电生理室</td>
...
管床数＜2张，或未安排，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">门诊：总诊治数≥200人次<br/>急诊：总急诊数≥50人次</td>
...
4.对培训对象的操作进行总体评价（优、缺点点评） 2分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表4 <br/>≥90分得满分，≥80分得4分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
      ...
      <tbody>
        ...
        <tr class="td_group">
		  ...
		  备注：<br/>
			1.一级指标4项，二级指标10项，三级指标39项。三级指标中，核心指标15项、计67分，一般指标23项、计33分，共100分。<br/>
