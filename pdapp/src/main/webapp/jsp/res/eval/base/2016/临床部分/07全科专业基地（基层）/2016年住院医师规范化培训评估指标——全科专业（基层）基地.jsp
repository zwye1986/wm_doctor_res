...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——全科专业（基层）基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——全科专业（基层）基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td rowspan="7">1.1专业基地所在社区卫生服务机构条件</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:全科、预防保健科、中医科、康复科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">均有，得满分<br/>缺1个科室，不得分</td>
          <td>2<input type="hidden" name="baseScore" value="2"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="3">符合《住院医师规范化培训基地认定标准（试行）》及?住院医师规范化培训内容与标准(试行)》全科专业相关要求</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">有管理办法，且落实，得2分<br/>无或未落实，不得分</td>
          <td>2<input type="hidden" name="baseScore" value="2"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
          <td><textarea name="reason">${formDataMap['scores'][7]['reason']}</textarea></td>
        </tr>
        <tr class="td_group">
          <td class="left">1.2.2基层实践基地与专业基地有紧密联系</td>
          <td class="left">基层实践基地与临床基地有联合教学会议，送出带教医师参加师资培训、配合接受教学指导等</td>
          <td class="left">各项工作紧密联系，得满分<br/>无，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学专科及以上学历、主治医师及以上专业技术职务,并有３年及以上社区工作经历</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">有５名以上带教医师参加过省级及以师资培训,并获得师资培训证书</td>
          <td class="left">达到标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">达到要求，得满分<br/>≥规定数的80%，得3分<br/>＜80%，不得分<br/>无学员，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">4.1.1接诊质量★</td>
          <td class="left">主任或带教医师组织规范的教学查房，悉心指导培训对象</td>
          <td class="left">评分表见附表2<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分</td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">评分表见附表4<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分</td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">SOAP病历书写评分表见附表3<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分或无培训对象不得分 </td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表4，无学员，不得分<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分无培训对象不得分</td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
      ...
      <tbody>
        ...
        <tr class="td_group">
		  ...
		  备注：<br/>
			1.一级指标4项，二级指标10项，三级指标32项。三级指标中，核心指标14项、计71分，一般指标17项、计29分，共100分。<br/>
