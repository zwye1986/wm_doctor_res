...
<div data-role="page" id="pageone">
  ...
  <script>
    ...
    function sumScore()
    {
      ...
      $("#sumScore1").html(allScore1);
      $("#inputSumScore1").val(allScore1);
      $("#sumScore2").html(allScore2);
      $("#inputSumScore2").val(allScore2);
    }
        function submitData()
        {
            var scores=[];
            ...
            var allScore1=$("input[name='sumScore1']").val();
            var allScore2=$("input[name='sumScore2']").val();
            var data={};
            data.scores=scores;
            data.type="1";
            data.evalScore1=allScore1;
            data.evalScore2=allScore2;
