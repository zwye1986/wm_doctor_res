       ...
       <form id="noteInfoForm">
         ...
         <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
           ...
           <tr class="td_group">
             ...
             <td>
               <input class="inputText" style="width: 200px;" type="text" name="deptName" value="${formDataMap['deptName']}" data-role="none"/>
             </td>
           </tr>
           <tr class="td_group">
             <td class="right" >
             ...
             <td class="left">
               <input class="inputText" style="width: 200px;" type="text" name="title" value="${formDataMap['title']}" data-role="none"/>
             </td>
           </tr>
         </table>
         <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
	...
	<script>
        ...
        function submitData()
        {
            jboxPost("<s:url value='/res/eval/saveEvalResult2'/>",$("#noteInfoForm").serialize(),function(resp){
                if(resp=="保存成功！"){setTimeout(function(){$.DialogByZ.Alert({Title: "", Content: resp,BtnL:"确定", FunL: function(){androidRefresh.onRefreshFragment();location.reload(true);}});},500);
