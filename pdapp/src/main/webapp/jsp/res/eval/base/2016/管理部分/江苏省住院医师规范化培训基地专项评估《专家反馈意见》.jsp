  ...
  <div data-role="page" id="pageone">
   ...
   <div data-role="main" class="ui-content">
    <div style="margin-bottom: 20px;border:1px solid rgba(0,0,0,0.07);overflow:auto;">
      <form id="noteInfoForm">
        ...
        <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
          <tr class="td_group">
            <td class="left" style="vertical-align:middle;" colspan="2"><b>管理方面：</b></td>
          </tr>
          <tr class="td_group">
            <td class="left" colspan="2">
              <textarea name="administration" >${formDataMap['administration']}</textarea>
            </td>
          </tr>
          <tr class="td_group">
            <td class="left" style="vertical-align:middle;" colspan="2"><b>亮点：</b></td>
          </tr>
          <tr class="td_group">
            <td class="left" colspan="2">
              <textarea name="highlights">${formDataMap['highlights']}</textarea>
            </td>
          </tr>
          <tr class="td_group">
            <td class="left" style="vertical-align:middle;" colspan="2"><b>不足：</b></td>
          </tr>
          <tr class="td_group">
            <td class="left" colspan="2">
              <textarea name="insufficiency">${formDataMap['insufficiency']}</textarea>
            </td>
          </tr>
          <tr class="td_group">
            <td class="left" style="vertical-align:middle;" colspan="2"><b>建议：</b></td>
          </tr>
          <tr class="td_group">
            <td class="left" colspan="2">
              <textarea name="opinion">${formDataMap['opinion']}</textarea>
            </td>
          </tr>
          <tr class="td_group">
            <td class="left">
                专家姓名：<input class="inputText" type="text" name="siginName" value="${user.userName}" readonly  data-role="none"/>
            </td>
            <td class="right">
                评估日期：
                <input class="inputText" type="text" id="siginDate" name="siginDate" value="${pdfn:getCurrDate()}" readonly data-role="none"/>
            </td>
          </tr>
        <tr class="td_group">
			<td colspan="2">
	...
	<script>
		...
		function save()
		{
            $.DialogByZ.Confirm({Title: "", Content: "确认保存反馈意见？",FunL:function(){
                closeDialog();
                submitData();
            },FunR:closeDialog})
		}
