...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——外科（胸心外科方向）专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——外科（胸心外科方向）专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">胸外科≥300人次<br/>心血管外科≥200人次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">胸外科≥1000人次<br/>心血管外科≥1000人次</td>
          <td class="left">符合标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">胸外科≥60人次<br/>心血管外科≥30人次</td>
          <td class="left">符合标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》外科（胸心外科方向）专业细则要求</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">1.纤维胃镜、结肠镜、肝脏介入治疗设备、腹腔镜、胆道镜等<br/>
							...
							8.体外循环机<br/>
							9.麻醉机</td>
          <td class="left">符合要求（含协同单位），得满分<br/>缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">在协同亚专业（专科）轮转时间不超过12个月</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历,主治医师专业技术职务3年以上，从事胸心外科专业工作5年以上</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事胸心外科专业的医疗、科研和教学工作超过15年</td>
