...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——外科（神经外科方向）专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——外科（神经外科方向）专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">1.神经外科手术显微镜 <br/>2.呼吸机<br/>3.床旁多功能监护仪<br/>4.术中电生理监护仪（诱发电位、脑电图）5.颅内压监护仪<br/>6.头架、升降手术床、神经外科显微器械<br/>7.术中超声仪<br/>8.神经外科导航设备<br/>9.CUSA<br/>10.神经内镜系统<br/>11.功能和立体定性系统</td>
          <td class="left">缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
...
4.对培训对象的操作进行总体评价（优、缺点点评） 2分</td>
      ...
      <tbody>
        ...
        <tr class="td_group">
		  ...
		  备注：<br/>
			1.一级指标4项；二级指标10项；三级指标37项，核心指标15项，计67分，一般指标22项，共33分，共100分。<br/>
