...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——放射肿瘤科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院或三级肿瘤专科医院放射肿瘤科病床数≥30张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">肿瘤相关亚专业（专科）、放射科、超声医学科、核医学科、病理科、麻醉科、检验科、输血科、图书馆</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">普通内科：心血管内科、呼吸内科、消化内科、感染科、重症监护治疗室（ICU)、急诊科<br/>肿瘤基础：放射影像科、病理科、肿瘤内科、普通外科/肿瘤外科、放射治疗科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》放射肿瘤科专业细则要求 ，详见附件1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">直线加速器、后装治疗机、模拟定位机、三维计划治疗系统、质量控制和质量保证设备（晨检仪、水平尺、坐标纸、钢尺、电离室、剂量仪、二维探测器阵列、图像质量检测模体、胶片剂量计、温度计/气压计）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》放射肿瘤科细则要求)</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历,副主任医师或任主治医师专业技术职务3年以上，从事放射治疗专业10年以上</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业(专科)主任医师≥2人，副主任医师≥3人，主治医师≥5人；医学物理人员≥3人</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">开展规范的阅片会，至少1周1次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">按照专业基地培训对象临床操作和报告能够达到《住院医师规范化培训内容与标准（试行）》放射肿瘤科专业细则的要求</td>
          <td class="left">管床数、技能操作数达要求，得满分<br/>管床数、技能操作≥规定数的80%，得3分<br/>管床数、技能操作≥规定数的70%，得1分<br/>未安排独立管床或技能操作，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">教学查房评分表见附表2<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病历书写评分表见附表3<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分</td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表4<br/>≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>5<input type="hidden" name="baseScore" value="5"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
