...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——骨科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院骨科床位总数≥60张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》骨科专业细则要求，详见附表1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">1.纤维胃镜、结肠镜、肝脏介入治疗设备、腹腔镜、胆道镜等<br/>2.手术显微镜、关节镜、 C形臂<br/>3.支气管镜、胸腔镜、多导监护仪<br/>4.膀胱镜、电切镜、输尿管镜、经皮肾镜<br/>5.脑电图仪、层流手术间、神经外科手术用显微镜<br/>6.血液、生化、免疫、尿液检验设备<br/>7.氧饱和度监测仪、肺功能仪、呼吸机、指测血糖仪、输液泵、微量泵<br/>8.体外循环机<br/>9.麻醉机</td>
          <td class="left">缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
