...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——核医学科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">月检查≥1500例次，具体要求：<br/>单光子显像检查≥300例次<br/>正电子显像检查≥50例次<br/>体外分析检查≥500例次<br/>功能测定检查≥20例次<br/>放射性核素治疗≥5例次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">独立技能操作和诊断报告种类及数量达要求，得满分<br/>独立技能操作和诊断报告≥规定数的80%，得3分<br/>独立技能操作和诊断报告≥规定数的60%，得1分<br/>＜60%，或未安排独立操作及报告，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">教学读片评分表，见附件3<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分</td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">每个轮转科室均能按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">诊断报告书写考核评分表，见附件4<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分</td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表，见附件5<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
