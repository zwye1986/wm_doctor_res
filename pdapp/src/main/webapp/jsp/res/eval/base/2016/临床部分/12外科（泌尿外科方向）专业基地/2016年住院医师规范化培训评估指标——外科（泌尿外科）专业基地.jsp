...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——外科（泌尿外科）专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——外科（泌尿外科）专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:普通外科、骨科、泌尿外科、胸心外科、麻醉科、外科重症监护治疗室(SICU)、神经外科、医院门诊、急诊科、内科、中心手术室<br/>辅助科室：放射科、超声科、核医学科、病理科、检验医学科、输血科，外科实验室或中心实验室</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">符合要求（含协同单位），得2分<br/>缺1个科室，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》外科（泌尿外科方向）专业细则要求，详见附表1-1至1-6</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">X射线机、数字减影血管造影机、CT、MRI、放射治疗机可有，但不一定必须、彩色B超(带 Doppler等探头)</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事泌尿外科专业的医疗、科研和教学工作超过15年</td>
