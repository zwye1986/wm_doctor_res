...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——全科专业（临床）基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——全科专业（临床）基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:内科、外科、妇产科、儿科、急诊科、全科(或具有全科医疗功能的科室,如老年科、综合保健科等)、皮肤科、眼科、耳鼻喉科、精神科、感染疾病科、中医科、医学影像科、检验医学科、康复医学科等</td>
          <td class="left">缺1个科室，不得分（精神科可协同） </td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">内科、神经内科、外科、妇产科、儿科、急诊科、皮肤科、眼科、耳鼻喉科、精神科、中医科、康复医学科</td>
          <td class="left">科室齐全，得1分<br/>缺1个科室，不得分（精神科可协同） </td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">独立设置全科医学科牵头承担全科住培工作，与相关临床轮转科室密切协同，指导帮助基层实践基地加强带教能力建设，共同完成好培训任务。</td>
          <td class="left">独立科室，且全部落实，得满分<br/>有挂靠科室，且全部落实，得2分<br/>有科室，部分落实培训任务，得1分<br/>未设置，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="4">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》内科专业细则要求，详见附表1-1至1-8</td>
          <td class="left">符合要求（含协同单位），得满分<br/>疾病种类及数量≥规定数的90%，得2分<br/>疾病种类及数量≥规定数的80%，得1分<br/>疾病种类及数量＜规定数的80%，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">符合要求（含协同单位），得满分<br/>技能操作种类及数量≥规定数的90%，得2分<br/>技能操作种类及数量≥规定数的80%，得1分<br/>技能操作种类及数量＜规定数的80%，不得分</td>
          <td>2<input type="hidden" name="baseScore" value="2"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
          <td><textarea name="reason">${formDataMap['scores'][8]['reason']}</textarea></td>
        </tr>
        <tr class="td_group">
          <td class="left">1.1.10医院设备</td>
        ...
        <tr class="td_group">
          <td  rowspan="4">1.2协同单位</td>
          <td class="left">1.2.1有联合的基层实践基地★</td>
          <td class="left">联合的基层实践基地（社区卫生服务机构）符合培训要求，双方建立定点协作关系或双向转诊关系</td>
          <td class="left">满足要求，得满分<br/>无，不得分</td>
          <td>2<input type="hidden" name="baseScore" value="2"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">轮转科室不全的，须有协同的其他医疗机构共同完成各亚专业（专科）培训内容</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">协同科室轮转时间符合大纲要求</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          <td class="left">1.2.4专业基地与基层实践基地有紧密联系★</td>
          <td class="left">专业基地与基层实践基地有联合教学会议，开展师资培训、教学指导等</td>
          <td class="left">满足要求，得1分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">理论课授课教师具有医学本科及以上学历、副高及以上专业技术职务;临床教学带教医师应具有医学本科及以上学历、主治医师及以上专业技术职务</td>
          <td class="left">达到标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科））应有主任医师≥1人，副主任医师≥1人，主治医师≥2人</td>
          <td class="left">达到标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历,主任医师专业技术职务,从事本专业的医疗、科研和教学工作超过１５年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">培训基地有全科教研室，主要培训科室（内科、外科、神经内科、急诊科等）有培训小组</td>
          <td class="left">1项不符合条件，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">带教医师均参加过院级师资培训<br/>轮转科室至少1名带教医师参加过省级及以上师资培训</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">开展规范的教学查房，至少1周1次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">内科管床≥5张、神经内科管床3～5张(在带教医师指导下独立于其他培训对象管理床位)</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">内科、外科、儿科等主要科室门诊平均日接诊量≥20人次<br/>急诊平均日接诊量≥15人次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">教学查房评分表见附表1<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术</td>
...
4.对培训对象的操作的总体评价（优、缺点点评） 2分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表3<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
      ...
      <tbody>
        ...
        <tr class="td_group">
		  ...
		  备注：<br/>
			1.一级指标4项，二级指标10项，三级指标42项。三级指标中，核心指标17项、计69分，一般指标25项、计31分，共100分。<br/>
