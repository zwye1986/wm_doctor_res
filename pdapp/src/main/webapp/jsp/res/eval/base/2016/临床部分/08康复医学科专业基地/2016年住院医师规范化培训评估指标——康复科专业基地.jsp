...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——康复科专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——康复科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院康复科≥20张<br/>三级专科医院≥120张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">综合医院≥300人次<br/>专科医院≥600人次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">综合医院≥3000人次<br/>专科医院≥4000人次</td>
          <td class="left">符合标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">神经内科、神经外科、ICU、骨科或矫形外科、心血管内科、心胸外科、呼吸内科、儿科、放射影像学科、超声科，神经电生理、心肺运动试验室</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.5轮转部门</td>
          <td class="left">神经康复、骨科康复、内科康复、儿童康复、物理治疗室、作业治疗科、言语治疗科、假肢矫形器科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》康复科专业细则要求，详见附表1  -1至1-8</td>
        ...
        <tr class="td_group">
		  ...
		  <td class="left">心电图仪、心肺运动试验仪、步态分析仪、超声诊断仪</td>
		  <td class="left">缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历,从事康复医疗专业工作5年以上</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）有主任医师≥1人，副主任医师≥2人，主治医师≥2人</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">主任医师专业技术职务,从事康复专业的医疗、科研和教学工作超过10年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">管床数达到要求，得满分<br/>管床数≥5张，得2分<br/>管床数≥4张，得1分<br/>管床数＜4张，或未安排，不得分<br/>无学员，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">门诊：日接诊≥1人次</td>
          <td class="left">门急诊工作量达到要求，得满分<br/>无，不得分</td>
          <td>3<input type="hidden" name="baseScore" value="3"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
...
4.对培训对象的操作的总体评价（优、缺点点评） 2分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表3<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
