...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——急诊科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:预诊台、诊室（成人诊室、小儿诊室、妇产科诊室及特殊病人如精神病、囚犯等诊室）、抢救室、输液室、清创室、石膏室、急诊辅助科室（急诊药房、急诊检验科、急诊影像科）、急诊病房或观察室、急诊重症监护室、急诊手术室（可共享）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》急诊科专业细则要求，详见附件1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">管床数达到要求，得满分<br/>管床数≥3张，得2分<br/>管床数≥2张，得1分<br/>管床数＜2张，或未安排，不得分</td>
...
4.对培训对象的操作进行总体评价（优、缺点点评） 2分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病历书写评分表见附表4-1/4-2 <br/>≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>5<input type="hidden" name="baseScore" value="5"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表5-1-5-4<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
