...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——儿科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:门诊部、急诊科、影像科、病理科、检验科<br/>综合实验室：肺功能室、血检室、胃肠功能室、内分泌功能检查室</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">呼吸、消化、肾脏、心血管、泌尿、内分泌代谢、血液及肿瘤、新生儿、风湿免疫、神经、重症（ICU）、儿童保健、传染病和寄生虫、辅助科室（影像、心电图）、门诊、急诊</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》儿科专业细则要求。详见附表1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">CT、X射线机、脑电图机、心脏彩色超声心动图仪、纤维胃镜、纤维肠镜、纤维支气管镜、呼吸机、心脏脑复苏等急救设备。详见附表2</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">心电图机、暖箱、新生儿辐射式抢救台、蓝光箱、雾化吸入装置、血气分析仪、输液泵、监护仪、中心供氧接口或氧气筒、常用急救设备。详见附表2</td>
          <td class="left">缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准（试行）》儿科细则要求)</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科））应有主任医师≥1人，副主任医师≥2人，主治医师≥3人</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">开展规范的疑难病例讨论，至少每月1次</td>
          <td class="left">开展次数达标，且认真规范，得满分<br/>未达标或不规范，不得分</td>
          <td>2<input type="hidden" name="baseScore" value="2"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">门诊：日诊治数≥40人次<br/>急诊：日急诊数≥30人次</td>
...
4.对培训对象的操作进行总体评价（优、缺点点评） 2分</td>
      ...
      <tbody>
        ...
        <tr class="td_group">
		  ...
		  备注：<br/>
			1.一级指标4项，二级指标10项，三级指标39项。三级指标中，核心指标15项、计68分，一般指标24项、计32分，共100分。<br/>
