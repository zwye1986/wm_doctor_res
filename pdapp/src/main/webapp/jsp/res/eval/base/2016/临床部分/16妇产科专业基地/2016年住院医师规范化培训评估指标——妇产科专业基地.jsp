...
<div data-role="page" id="pageone">
  ...
  <h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——妇产科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院儿外科床位总数≥50张<br/>专科儿童医院儿外科≥200张</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.9医院设备</td><td>纤维胃镜、纤维肠镜、静脉肾盂造影设备、C形臂X射线机、CT、MRI、超声心动图仪、24小时动态心电图仪、SICU相关设备（包括呼吸机、心肺复苏急救设备等）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）应有主治医师以上人员≥7名，医学本科及以上学历，至少有3名不同研究方向的主任医师或副主任医师（包括产科、妇科内分泌和妇科肿瘤）。若专业基地培训对象数量超过3人，则主任医师+副主任医师人数应≥培训对象数。随着规培人数的增加，高级职称医师人数与培训对象数比例不应大于1:2。</td>
