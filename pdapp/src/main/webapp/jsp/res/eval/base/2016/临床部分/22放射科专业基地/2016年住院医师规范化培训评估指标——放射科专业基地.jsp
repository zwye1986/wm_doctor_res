...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——放射科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">普通X线检查≥200例次<br/>CT检查≥100例次<br/>磁共振≥50例次<br/>介入治疗≥5例次<br/>胃肠造影检查≥10例次</td>
          <td class="left">符合标准，得1分<br/>不达标准，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">放射科（含神经头颈、呼吸、循环、消化、泌尿生殖、骨关节及介入等亚专科）；超声科；核医学科</td>
          <td class="left">科室齐全，得2分,<br/>缺1个科室，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">500mA以上大型X射线机≥1台、CR或DR机≥2台、胃肠造影机≥1台、乳腺机≥1台、大型DSA机≥1台、多层螺旋CT机≥1台、高场强( 1.5T及以上场强)MR机≥1台<br/>具有PACS网络系统,可应用于教学</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">协同数量不应超过3个（放射诊断、放射介入分别按照1个协同单位计算）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">教学阅片评分表见附件2 <br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">阅片评分表见附表3<br/>≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分</td>
          <td>6<input type="hidden" name="baseScore" value="6"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
