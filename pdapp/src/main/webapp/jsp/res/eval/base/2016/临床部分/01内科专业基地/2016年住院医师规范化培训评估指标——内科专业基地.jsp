...
<%@include file="/jsp/common/doctype.jsp" %>
 ...
 <head>
   ...
   <title>2016年住院医师规范化培训评估指标——内科专业基地</title>
<style type="text/css">
	.th_group .left{
		text-align: left;
	}
...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="margin: 0;width: 100%;">2016年住院医师规范化培训评估指标——内科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院内科床位总数≥200张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">普通外科、神经内科、重症监护室、皮肤科、口腔科、麻醉科、医学影像科（含超声和核医学）、病理科、检验科（包括免疫室、细菌室、生化实验室）、输血科
		  <br/>相关诊断治疗室：①心电图室、心导管室②肺功能室、睡眠呼吸检测室、呼吸内镜室③消化内镜室、
		  胃肠动力实验室④血液实验室、内分泌实验室、风湿免疫实验室（可指医院中心实验室）⑤透析室⑥无菌层流病房</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">必选科室： 心血管内科(含心电图室)、肾脏内科、呼吸内科、血液内科、消化内科、内分泌科、感染科、神经内科、风湿免疫科、急诊科、内科门诊(内科各亚专业<b>为选修</b>)、重症监护病房<br/>
可选科室： 医学影像科(含超声科和核医学科)、皮肤科、老年病房、肿瘤内科(含放疗科)、基层实践</td>
          <td class="left">科室齐全，得满分<br/>必选科室缺1个，不得分<br/>可选科室缺2个，不得分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》内科专业细则要求，详见附表1-1至1-8</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">大型X射线机、数字血管造影设备（DSA）、CT、核磁共振、ECT、放射治疗机、彩色B超（带有Doppler探头）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">依据《住院医师规范化培训基地认定标准（试行）——内科专业基地细则》的要求，见附表2</td>
          <td class="left">缺1项，不得分</td>
          <td>1<input type="hidden" name="baseScore" value="1"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事内科专业的医疗、科研和教学工作超过15年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病房：日管床数≥4张(在带教医师指导下独立于其他培训对象管理床位)</td>
          <td class="left">管床数达到要求，得满分<br/>管床数≥4张，得2分<br/>管床数≥3张，得1分<br/>管床数＜3张，或未安排，不得分</td>
...
4.对培训对象的操作的总体评价（优、缺点点评） 2分</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病历书写评分表见附表4<br/>≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>5<input type="hidden" name="baseScore" value="5"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表5<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>7<input type="hidden" name="baseScore" value="7"/></td>
          <td><input type="number" name="score" value="" oninput="if(value.length>1)value=value.slice(0,1)"  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"/></td>
...
//                $("#dataTable tr").each(function(i){
//					var width=$(this).find("textarea[name='reason']").width();
//                    var style = document.defaultView.getComputedStyle( $(this).find("textarea[name='reason']")[0], null);
//                    var w=style.fontSize.substring(0,style.fontSize.length-2);
//                    console.log(w);
//                    if($(this).find("textarea[name='reason']").val()) {
//                        var vals = $(this).find("textarea[name='reason']").val();
//                        var fontSize = $(this).find("textarea[name='reason']").css("fontSize");
//                        var l=0;
...
//                        }
//                        var t = l / width;
//                        var c = (l % width == 0) ? (t) : (parseInt(t) + 1);
//                        if(c>2) {
//                            var h = 23;
//                            $(this).find("textarea[name='reason']").css("height", c*h);
//                        }
//                    }
//                });
		});
