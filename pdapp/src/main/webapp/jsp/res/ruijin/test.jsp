...
<html>
<head>
<title>瑞金云医医师APP测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/ruijin'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/ruijin/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/ruijin/student/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/ruijin/teacher/test'/>">老师端测试工具</a>
					<a href="<s:url value='/res/ruijin/kzr/test'/>">科主任端测试工具</a>
					<script>
						function reload(){
