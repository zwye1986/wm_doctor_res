...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/ruijin/kzr'/>/"+action;
		//"?_method="+method;
		if(method=="put"){
			method = "post"
		}
...
<body>
	<form name="appForm" action="/pdapp/res/ruijin/kzr/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/ruijin/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/ruijin/teacher/test'/>">带教端测试工具</a>
		</div>
