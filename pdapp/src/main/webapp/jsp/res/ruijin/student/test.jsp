...
<html>
<head>
<title>瑞金云医医师APP学生端测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/ruijin/student'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/ruijin/student/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			...
			<option value="saveEvalInfo" method="post" needDataType="N" <c:if test="${param.reqCode=='saveEvalInfo'}">selected</c:if> >5.0.7 保存活动评价(saveEvalInfo)post</option>
					...
					<a href="<s:url value='/res/ruijin/test'/>">测试工具</a>
		</div>
