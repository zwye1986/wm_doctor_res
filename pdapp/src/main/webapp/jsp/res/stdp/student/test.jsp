...
<html>
<head>
<title>南医大实习生APP学生端测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/stdp/student'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="/${ctxPath}/res/stdp/student/remember" method="get">
