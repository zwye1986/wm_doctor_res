<%@ page language="java" contentType="aplication/json; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			"items":[
				{
					"inputId":"attendance",
					"inputType":"text",
					"lable":"培训期间除享受国家法定的节假日(不含产假)外,事假每天扣除总学分1分（满分60分）",
	...
	"values":[
				...
				<c:choose>
					...
					<c:when test="${testTypeFlag}">
						<c:set var="theoreResult" value="${empty formDataMap['theoryAssessment'] ? (empty outScore.theoryScore ? '':outScore.theoryScore*0.25*1):formDataMap['theoryAssessment']}"/>
					</c:when>
				</c:choose>
				{
					"inputId":"theoryAssessment",
