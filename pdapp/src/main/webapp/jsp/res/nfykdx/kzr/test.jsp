...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/nfykdx/kzr'/>/"+action;
		//"?_method="+method;
		if(method=="put"){
			method = "post"
		}
...
<body>
	<form name="appForm" action="/pdapp/res/nfykdx/kzr/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/nfykdx/test'/>">学生端测试工具</a>
					<a href="<s:url value='/res/nfykdx/teacher/test'/>">带教端测试工具</a>
		</div>
