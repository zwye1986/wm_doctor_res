...
<html>
<head>
<title>南方医科大学住院医师APP学生端测试程序<%-- --http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath} --%></title>
...
<script type="text/javascript">
	function test() {
		...
		var url = "<s:url value='/res/nfykdx/student'/>/"+action+"?_method="+method;
...
<body>
	<form name="appForm" action="${ctxPath}/res/nfykdx/student/remember" method="get">
	<div style="width: 60%; float: left">
		<div style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px">
			学生端动作：	<select id="reqCode" name="reqCode" onchange="change(this.value);">
					...
					<a href="<s:url value='/res/nfykdx/test'/>">测试工具</a>
		</div>
