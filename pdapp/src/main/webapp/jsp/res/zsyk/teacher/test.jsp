...
<script type="text/javascript">
	function test() {
		...
		if(action=="login" || action=="version" || action=="notice" || action=="noticeCount"){
			url = "<s:url value='/res/zsyk'/>/"+action+"?_method="+method;	
		}else{
			url = "<s:url value='/res/zsyk/teacher'/>/"+action+"?_method="+method;	
		}
...
<body>
	<form name="appForm" action="${ctxPath}/res/zsyk/teacher/remember" method="get">
