...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			var url ="<s:url value='/res/jswjw/showCertificateImages?userFlow='/>"+userFlow;
			$.ajax({
				type : "get",
				url : url,
				cache : false,
				success : function(resp) {
					...
					if(list.length>0)
					{
						...
						{
							var id="testDiv"+i;
							var div="<div id='"+id+"' style='width: 588px;height: 0px;border: 0px solid;padding-top: 30px;' ></div>";
							$('#allDiv').append(div);
							var recordFlow=list[i].recruitFlow;
							showImage(id,recordFlow);
						}
		...
		function showImage(id,recordFlow)
		{
...
<body>
<div id="allDiv" style="width: auto;" align="center" onResize="Resize()" onLoad="Resize()">
