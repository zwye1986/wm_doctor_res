<%@ page language="java" contentType="aplication/json; charset=UTF-8" pageEncoding="UTF-8"%>
{
    ...
    "values": {
    	<c:if test="${param.recType eq 'mr' and not empty resultData}">
    	...
    	<c:if test="${param.recType eq 'disease' and not empty resultData}">
    	...
    	<c:if test="${param.recType eq 'skill' and not empty resultData}">
    	...
    	<c:if test="${param.recType eq 'operation' and not empty resultData}">
    	...
    	<c:if test="${param.recType eq 'activity' and not empty resultData}">

            "activity_date": ${pdfn:toJsonString(resultData.activity_date)},
            "activity_content": ${pdfn:toJsonString(resultData.activity_content)},
            "activity_address": ${pdfn:toJsonString(resultData.activity_address )},
    	...
    	<c:if test="${param.recType eq 'summary' and not empty resultData}">
