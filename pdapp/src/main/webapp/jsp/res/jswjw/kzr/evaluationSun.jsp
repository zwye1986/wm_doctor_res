...
<%--        },--%>
        ...
        },
        {
        ...
        },
         {
            ...
            <c:if test="${(roleFlag=='Seretary') }">
                "value":"${currUser.userName}/${resDoctorSchProcess.headUserName}"
            </c:if>
            <c:if test="${(roleFlag!='Seretary' and roleFlag!='Head') }">
                "value": "${formDataMap['directorName']}"
            </c:if>
        },
         {
            "inputId": "directorDate",
            "value": "${empty formDataMap['directorDate'] ? pdfn:getCurrDate():formDataMap['directorDate']}"
        },
        {
