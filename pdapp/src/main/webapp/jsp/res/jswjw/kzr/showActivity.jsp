...
,
    ...
    "inputs":[
        ...
        },
        {
            ...
            "readonly":${pdfn:toJsonString((activity.activityStatus eq 'audit' or empty activity.activityStatus) ? false:true)},
            "required":true,
            "isHidden": false,
...
<%--        },--%>
...

        {
            ...
            "inputType":"textarea",
            "readonly":true,
            "required":${pdfn:toJsonString(activity.activityStatus eq 'unpass' ? true:false)},
