	    ...
	    <c:forEach items="${catagoryDataList}" var="catagoryData" varStatus="status">
	        {
	            ...
	            "neededNum": ${pdfn:toJsonString(catagoryData['neededNum'])},
	            "finishedNum": ${pdfn:toJsonString(catagoryData['finishedNum'])},
	            "progress": ${pdfn:toJsonString(catagoryData['progress'])},
	            "note": ${pdfn:toJsonString(catagoryData['note'])},
	            "labelsNum": 3
	        }
