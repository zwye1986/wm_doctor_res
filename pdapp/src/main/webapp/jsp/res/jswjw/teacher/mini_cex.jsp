<%@ page language="java" contentType="aplication/json; charset=UTF-8" pageEncoding="UTF-8"%>
{
    ...
    ,
    "inputs": [
    		<jsp:include page="/jsp/res/jswjw/teacher/inputMini.jsp"></jsp:include>
    ],
    "values": [
              {
              ...
              {
                    "inputId": "studentType",
                    "value": <c:if test="${ not empty formDataMap['studentType']}"> "${formDataMap['studentType']}"</c:if>
                             <c:if test="${empty formDataMap['studentType']}"> "${doctor.doctorCategoryName}"</c:if>
              },
              {
                    "inputId": "teacherType",
