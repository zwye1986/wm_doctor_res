...
import com.pinde.sci.dao.dwjxres.EvaluationExtMapper;
...
public class ResDoctorEvaluationBizImpl implements IResDoctorEvaluationBiz {
    @Autowired
    ...
    @Autowired
    private EvaluationExtMapper evaluationExtMapper;
    ...
    @Override
    public List<StuUserExt> searchStuUserForDept(Map<String, Object> parMp) {
        return evaluationExtMapper.searchStuUserForDept(parMp);
    }
    @Override
    public List<StuUserExt> searchStuUserForTeacher(Map<String, Object> parMp) {
        return evaluationExtMapper.searchStuUserForTeacher(parMp);
    }
