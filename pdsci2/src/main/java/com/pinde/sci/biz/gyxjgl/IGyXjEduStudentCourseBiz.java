 ...
 * @author tiger
 */
public interface IGyXjEduStudentCourseBiz {
    ...
    //删除课程，无需判断课程容纳人数是否超额
    int emptyCourse(EduStudentCourse eduStudentCourse);
    /**
     * 查询学生选择的课程的详细信息
...
//    List<XjStudentCourseNumForm> studentCourseNumList(Map<String, Object> map);
    ...
    List<XjEduStudentCourseExt> searchStudentCourse(SysUser sysUser,EduUser eduUser,ResDoctor doctor,EduStudentCourse studentCourse,String scoreSum,String minDegreeGrade,String maxDegreeGrade,String courseTypeScore);
    ...
    //授课组对应选课的学生成绩一键通过
    int auditSelectGrade(String recordFlow,String auditStatusId);
    //查询授课组和课程关系
    ...
    //查询学生成绩（成绩打印）
    List<Map<String,Object>> queryGradeList(String userFlow);
    //教学进度审批表数据
