...
import com.pinde.sci.biz.czyyjxres.ICzScholarSchArrangeBiz;
...
public class ICzScholarSchArrangeBizImpl implements ICzScholarSchArrangeBiz {
    @Autowired
    ...
    public List<ScholarSchArrange> searchArrange(ScholarSchArrange arrange) {
        ...
        example.setOrderByClause("sch_start_date,sch_end_date");
    ...
    public int checkScholarDate(Map<String,Object> paramMap) {
        return resultExtMapper.checkScholarDate(paramMap);
    }

    @Override
    public int getArrangedNum(Map<String,Object> paramMap) {
        return resultExtMapper.getArrangedNum(paramMap);
    }
}
