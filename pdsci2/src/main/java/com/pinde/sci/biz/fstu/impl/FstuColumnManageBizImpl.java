...
import com.pinde.sci.dao.fstu.FstuColumnExtMapper;
...
public class FstuColumnManageBizImpl implements IFstuColumnManageBiz{

    @Autowired
    private InxColumnMapper inxColumnMapper;
    @Autowired
    private FstuColumnExtMapper fstuColumnExtMapper;
    ...
    public String getNextColumnId(String parentColumnId) {
        InxColumnExample example = new InxColumnExample();
        InxColumnExample.Criteria criteria = example.createCriteria();
...
//	}
    ...
    public List<InxColumn> searchInxColumnList(Map<String, Object> paramMap) {
        return fstuColumnExtMapper.searchInxColumnList(paramMap);
    }
