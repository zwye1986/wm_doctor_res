...
public class ResMonthlyReportBizImpl implements IResMonthlyReportBiz {
	@Autowired
	...
	@Override
	public List<SysMonthlyDoctorInfo> getMonthlyDoctorInfo(SysMonthlyDoctorInfo sysMonthlyDoctorInfo) {
