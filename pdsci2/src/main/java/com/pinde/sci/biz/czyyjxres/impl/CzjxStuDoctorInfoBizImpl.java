...
import com.pinde.sci.dao.czyyjxres.CzStuUserExtMapper;
...
public class CzjxStuDoctorInfoBizImpl implements ICzjxStuDoctorInfoBiz {
    @Autowired
    ...
    @Autowired
    private CzStuUserExtMapper czStuUserExtMapper;
    ...
    public int countAdmitedStuUsers(String year) {
        return czStuUserExtMapper.countAdmitedStuUsers(year);
    }
}
