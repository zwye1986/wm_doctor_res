...
import com.pinde.sci.dao.hbzy.HbzyResReductionExtMapper;
...
public class HbzyDoctorReductionBizImpl implements IJszyDoctorReductionBiz {

    @Autowired
    private ResDoctorReductionMapper reductionMapper;
    @Autowired
    private HbzyResReductionExtMapper resReductionExtMapper;
    @Autowired
