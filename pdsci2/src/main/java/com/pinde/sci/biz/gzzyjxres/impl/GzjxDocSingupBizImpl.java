...
public class GzjxDocSingupBizImpl implements IGzjxDocSingupBiz {
	@Autowired
	...
	public int returnInfo(String resumeFlow, String reason,String userFlow) {
		...
		if(count > 0){
			...
			this.msgBiz.sendSMS(user.getUserPhone(),"gzzyjxres10002",user.getUserName(),resume.getResumeFlow(),"STU_USER_RESUME");
		}
		StuAuditProcessExample example = new StuAuditProcessExample();
