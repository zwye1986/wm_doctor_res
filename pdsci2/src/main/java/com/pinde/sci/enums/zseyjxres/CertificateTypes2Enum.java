...
public enum CertificateTypes2Enum implements GeneralEnum<String> {
	...
	CertificateTypes2Enum(String id, String name) {
		this.id = id;
		this.name = name;
	}
	...
	public static String getNameById(String id) {
		return EnumUtil.getById(id, CertificateTypes2Enum.class).getName();
	}
}
