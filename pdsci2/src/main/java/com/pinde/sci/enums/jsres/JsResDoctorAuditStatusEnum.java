...
public enum JsResDoctorAuditStatusEnum implements GeneralEnum<String> {
...
//	GlobalPassed("GlobalPassed" , "省厅审核通过"),
	...
	JsResDoctorAuditStatusEnum(String id,String name) {
		this.id = id;
		this.name = name;
	}
	...
	public static String getNameById(String id) {
		return EnumUtil.getById(id, JsResDoctorAuditStatusEnum.class).getName();
	}
}
