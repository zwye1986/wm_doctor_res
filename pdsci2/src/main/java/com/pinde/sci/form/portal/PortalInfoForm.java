...
public class PortalInfoForm {
	...
	public PortalInfoForm() {}

	
	public PortalInfoForm(String columnId, String startIndex, String endIndex) {
	...
	public PortalInfoForm(String columnId, String infoTitle, String startIndex,
    ...
    public String getColumnIdLike() {
        return columnIdLike;
    }

    public void setColumnIdLike(String columnIdLike) {
        this.columnIdLike = columnIdLike;
    }
