...
public class ExtInfoForm implements Serializable{
	 ...
	 * 执业证末次注册时间
	 */
	private String cerLastRegisterDate;
...
//	}
	...
	public String getCerLastRegisterDate() {
		return cerLastRegisterDate;
	}

	public void setCerLastRegisterDate(String cerLastRegisterDate) {
		this.cerLastRegisterDate = cerLastRegisterDate;
	}
