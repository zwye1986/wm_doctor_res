...
public class WorkOrderAuditForm {
	...
	public String getAuditDeptFlow() {
		return auditDeptFlow;
	}

	public void setAuditDeptFlow(String auditDeptFlow) {
		this.auditDeptFlow = auditDeptFlow;
	}
