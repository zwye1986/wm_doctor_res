...
public class XjPollingTableForm {
    ...
    private String studentSourceAreaId;//生源地Id
    ...
    private String birthPlaceProvinceId;//生源地省id
    private String birthPlacePrefectureLevelCityId;//生源地地级市id
    private String birthPlaceCountyLevelCityId;//生源地县级市id
    ...
    public String getBirthPlacePrefectureLevelCityId() {
        return birthPlacePrefectureLevelCityId;
    }

    public void setBirthPlacePrefectureLevelCityId(String birthPlacePrefectureLevelCityId) {
        this.birthPlacePrefectureLevelCityId = birthPlacePrefectureLevelCityId;
    }

    public String getBirthPlaceCountyLevelCityId() {
        return birthPlaceCountyLevelCityId;
    }

    public void setBirthPlaceCountyLevelCityId(String birthPlaceCountyLevelCityId) {
        this.birthPlaceCountyLevelCityId = birthPlaceCountyLevelCityId;
    }
