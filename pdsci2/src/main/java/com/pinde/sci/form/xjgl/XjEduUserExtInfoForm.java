...
public class XjEduUserExtInfoForm {
    ...
    private String isArchivesComplete;//档案是否已到齐
    private String isFeeComplete;//学费是否已缴清
    //学业和学位授予信息
    ...
    public String getIsArchivesComplete() {
        return isArchivesComplete;
    }

    public void setIsArchivesComplete(String isArchivesComplete) {
        this.isArchivesComplete = isArchivesComplete;
    }

    public String getIsFeeComplete() {
        return isFeeComplete;
    }

    public void setIsFeeComplete(String isFeeComplete) {
        this.isFeeComplete = isFeeComplete;
    }
    ...
    public String getClassCertNo() {
        return classCertNo;
    }

    public void setClassCertNo(String classCertNo) {
        this.classCertNo = classCertNo;
    }
