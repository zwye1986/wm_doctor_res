...
public class ResIdctrlDetail extends MybatisObject {
    ...
    public String getIdctrlMainFlow() {
        return idctrlMainFlow;
    }

    public void setIdctrlMainFlow(String idctrlMainFlow) {
        this.idctrlMainFlow = idctrlMainFlow;
    }
