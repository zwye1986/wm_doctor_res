...
public class ResStandardDeptPer extends TeachingActivitySpeakerExample.MybatisObject {
    private String perFlow;
    ...
    public String getPerFlow() {
        return perFlow;
    }

    public void setPerFlow(String perFlow) {
