...
public class EduApprovalSub extends MybatisObject {
    ...
    private String isTestTeacher;

    private String isApprovalTeacher;
    ...
    public String getIsTestTeacher() {
        return isTestTeacher;
    }

    public void setIsTestTeacher(String isTestTeacher) {
        this.isTestTeacher = isTestTeacher;
    }

    public String getIsApprovalTeacher() {
        return isApprovalTeacher;
    }

    public void setIsApprovalTeacher(String isApprovalTeacher) {
        this.isApprovalTeacher = isApprovalTeacher;
    }
}