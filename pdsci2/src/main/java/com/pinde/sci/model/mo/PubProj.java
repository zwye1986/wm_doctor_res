...
public class PubProj implements java.io.Serializable {
    ...
    private String applyUserEmpnum;
    ...
    public String getApplyUserEmpnum() {
        return applyUserEmpnum;
    }

    public void setApplyUserEmpnum(String applyUserEmpnum) {
        this.applyUserEmpnum = applyUserEmpnum;
    }
    ...
    public String getIsEthicalFlag() {
        return isEthicalFlag;
    }

    public void setIsEthicalFlag(String isEthicalFlag) {
        this.isEthicalFlag = isEthicalFlag;
    }
