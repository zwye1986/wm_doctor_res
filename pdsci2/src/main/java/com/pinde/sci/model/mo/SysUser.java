...
public class SysUser extends MybatisObject {
    ...
    private String isOwnerStu;

    private String lcjnSpeId;

    private String lcjnSpeName;

    private String appLoginTime;

    private String webLoginTime;
    ...
    private String isOsca;

    private String accountNo;

    private String workCode;

    private String resTrainingSpeId;

    private String resTrainingSpeName;
    ...
    private String appLastLoginErrorTime;

    private String appLoginErrorCount;

    private String auditStatus;

    private String orgFlowGx;
    ...
    public String getIsOwnerStu() {
        return isOwnerStu;
    }

    public void setIsOwnerStu(String isOwnerStu) {
        this.isOwnerStu = isOwnerStu;
    }

    public String getLcjnSpeId() {
        return lcjnSpeId;
    }

    public void setLcjnSpeId(String lcjnSpeId) {
        this.lcjnSpeId = lcjnSpeId;
    }

    public String getLcjnSpeName() {
        return lcjnSpeName;
    }

    public void setLcjnSpeName(String lcjnSpeName) {
        this.lcjnSpeName = lcjnSpeName;
    }
    ...
    public String getWebLoginTime() {
        return webLoginTime;
    }

    public void setWebLoginTime(String webLoginTime) {
    ...
    public String getIsOsca() {
        return isOsca;
    }

    public void setIsOsca(String isOsca) {
        this.isOsca = isOsca;
    }
    ...
    public String getResTrainingSpeId() {
        return resTrainingSpeId;
    }

    public void setResTrainingSpeId(String resTrainingSpeId) {
        this.resTrainingSpeId = resTrainingSpeId;
    }

    public String getResTrainingSpeName() {
        return resTrainingSpeName;
    }

    public void setResTrainingSpeName(String resTrainingSpeName) {
        this.resTrainingSpeName = resTrainingSpeName;
    }
    ...
    public void setTipPassword(String tipPassword) {
    ...
    public void setBaseFlow(String baseFlow) {
    ...
    public void setVerifyCodeTime(String verifyCodeTime) {
    ...
    public void setChangePasswordTime(String changePasswordTime) {
    ...
    public String getAppLastLoginErrorTime() {
        return appLastLoginErrorTime;
    }

    public void setAppLastLoginErrorTime(String appLastLoginErrorTime) {
        this.appLastLoginErrorTime = appLastLoginErrorTime;
    }

    public String getAppLoginErrorCount() {
        return appLoginErrorCount;
    }

    public void setAppLoginErrorCount(String appLoginErrorCount) {
        this.appLoginErrorCount = appLoginErrorCount;
    }
    ...
    public String getOrgFlowGx() {
        return orgFlowGx;
    }

    public void setOrgFlowGx(String orgFlowGx) {
        this.orgFlowGx = orgFlowGx;
    }
