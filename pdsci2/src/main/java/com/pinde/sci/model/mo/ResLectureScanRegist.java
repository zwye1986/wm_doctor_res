...
public class ResLectureScanRegist extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getScan2Time() {
        return scan2Time;
    }

    public void setScan2Time(String scan2Time) {
        this.scan2Time = scan2Time;
    }
