...
public class ResInprocessInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public void setDeptBriefing(String deptBriefing) {
        this.deptBriefing = deptBriefing;
    }

    public String getDeptFramework() {
        return deptFramework;
    }

    public void setDeptFramework(String deptFramework) {
        this.deptFramework = deptFramework;
    }
