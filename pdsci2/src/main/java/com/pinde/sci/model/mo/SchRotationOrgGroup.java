...
public class SchRotationOrgGroup extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String oneSchMonth;

    private String twoSchMonth;

    private String threeSchMonth;
