...
public class OscaSkillDocScore extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getIsHaveFrom() {
        return isHaveFrom;
    }

    public void setIsHaveFrom(String isHaveFrom) {
        this.isHaveFrom = isHaveFrom;
    }
    ...
    public String getSiginImage() {
        return siginImage;
    }

    public void setSiginImage(String siginImage) {
        this.siginImage = siginImage;
    }
