...
public class ResBaseFund extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String amountOfIncome;

    private String amountOfExpenses;
    ...
    public String getAmountOfExpenses() {
        return amountOfExpenses;
    }

    public void setAmountOfExpenses(String amountOfExpenses) {
