...
public class OscaDoctorAssessment extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getSiginStatusId() {
        return siginStatusId;
    }

    public void setSiginStatusId(String siginStatusId) {
        this.siginStatusId = siginStatusId;
    }

    public String getSiginStatusName() {
        return siginStatusName;
    }
    ...
    public void setIsSavePass(String isSavePass) {
