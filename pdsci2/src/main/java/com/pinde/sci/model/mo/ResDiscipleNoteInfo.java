...
public class ResDiscipleNoteInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getStudyTimeNmae() {
        return studyTimeNmae;
    }

    public void setStudyTimeNmae(String studyTimeNmae) {
        this.studyTimeNmae = studyTimeNmae;
    }
