...
public class ResDoctor extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String workOrgLevelId;

    private String workOrgLevelName;
    ...
    private String graduationStatusId;
    ...
    private String discipleTeacherFlow;

    private String discipleTeacherName;

    private String graduationYear;

    private String secondSpeId;

    private String secondSpeName;

    private String companyType;

    private String isPartner;

    private String sourceProvincesId;

    private String sourceProvincesName;

    private String secondRotationFlow;

    private String secondRotationName;

    private String standardDeptName;

    private String standardDeptId;

    private String practPhysicianFlag;

    private String practPhysicianCertificateNo;
    ...
    private String oscaStudentSubmit;

    private String sczyRecriutBanch;

    private String selOneFlag;

    private String selTwoFlag;

    private String selThreeFlag;

    private String schOneFlag;

    private String schTwoFlag;

    private String schThreeFlag;

    private String selAllFlag;

    private String schAllFlag;

    private String isSchFlag;
    ...
    private String englishCertificateNumber;

    private String englishCertificateDate;

    private String englishGradeExamType;
    ...
    public String getDegreeCategoryId() {
        return degreeCategoryId;
    }

    public void setDegreeCategoryId(String degreeCategoryId) {
        this.degreeCategoryId = degreeCategoryId;
    }
    ...
    public String getWorkOrgLevelId() {
        return workOrgLevelId;
    }

    public void setWorkOrgLevelId(String workOrgLevelId) {
        this.workOrgLevelId = workOrgLevelId;
    }

    public String getWorkOrgLevelName() {
        return workOrgLevelName;
    }

    public void setWorkOrgLevelName(String workOrgLevelName) {
        this.workOrgLevelName = workOrgLevelName;
    }
    ...
    public void setIsYearGraduate(String isYearGraduate) {
        this.isYearGraduate = isYearGraduate;
    }
    ...
    public void setOrgNatureId(String orgNatureId) {
    ...
    public String getGraduationStatusId() {
        return graduationStatusId;
    }

    public void setGraduationStatusId(String graduationStatusId) {
        this.graduationStatusId = graduationStatusId;
    }
    ...
    public String getDiscipleTeacherFlow() {
        return discipleTeacherFlow;
    }

    public void setDiscipleTeacherFlow(String discipleTeacherFlow) {
        this.discipleTeacherFlow = discipleTeacherFlow;
    }

    public String getDiscipleTeacherName() {
        return discipleTeacherName;
    }

    public void setDiscipleTeacherName(String discipleTeacherName) {
        this.discipleTeacherName = discipleTeacherName;
    }
    ...
    public String getSecondSpeId() {
        return secondSpeId;
    }

    public void setSecondSpeId(String secondSpeId) {
        this.secondSpeId = secondSpeId;
    }
    ...
    public String getSourceProvincesId() {
        return sourceProvincesId;
    }

    public void setSourceProvincesId(String sourceProvincesId) {
        this.sourceProvincesId = sourceProvincesId;
    }

    public String getSourceProvincesName() {
        return sourceProvincesName;
    }

    public void setSourceProvincesName(String sourceProvincesName) {
        this.sourceProvincesName = sourceProvincesName;
    }

    public String getSecondRotationFlow() {
        return secondRotationFlow;
    }

    public void setSecondRotationFlow(String secondRotationFlow) {
        this.secondRotationFlow = secondRotationFlow;
    }

    public String getSecondRotationName() {
        return secondRotationName;
    }

    public void setSecondRotationName(String secondRotationName) {
        this.secondRotationName = secondRotationName;
    }
    ...
    public String getPractPhysicianFlag() {
        return practPhysicianFlag;
    }

    public void setPractPhysicianFlag(String practPhysicianFlag) {
        this.practPhysicianFlag = practPhysicianFlag;
    }

    public String getPractPhysicianCertificateNo() {
        return practPhysicianCertificateNo;
    }

    public void setPractPhysicianCertificateNo(String practPhysicianCertificateNo) {
        this.practPhysicianCertificateNo = practPhysicianCertificateNo;
    }
    ...
    public void setDepartMentFlow(String departMentFlow) {
        this.departMentFlow = departMentFlow;
    }
    ...
    public String getOscaStudentSubmit() {
        return oscaStudentSubmit;
    }

    public void setOscaStudentSubmit(String oscaStudentSubmit) {
        this.oscaStudentSubmit = oscaStudentSubmit;
    }

    public String getSczyRecriutBanch() {
        return sczyRecriutBanch;
    }

    public void setSczyRecriutBanch(String sczyRecriutBanch) {
        this.sczyRecriutBanch = sczyRecriutBanch;
    }

    public String getSelOneFlag() {
        return selOneFlag;
    }

    public void setSelOneFlag(String selOneFlag) {
        this.selOneFlag = selOneFlag;
    }

    public String getSelTwoFlag() {
        return selTwoFlag;
    }

    public void setSelTwoFlag(String selTwoFlag) {
        this.selTwoFlag = selTwoFlag;
    }

    public String getSelThreeFlag() {
        return selThreeFlag;
    }

    public void setSelThreeFlag(String selThreeFlag) {
        this.selThreeFlag = selThreeFlag;
    }

    public String getSchOneFlag() {
        return schOneFlag;
    }

    public void setSchOneFlag(String schOneFlag) {
        this.schOneFlag = schOneFlag;
    }

    public String getSchTwoFlag() {
        return schTwoFlag;
    }

    public void setSchTwoFlag(String schTwoFlag) {
        this.schTwoFlag = schTwoFlag;
    }

    public String getSchThreeFlag() {
        return schThreeFlag;
    }

    public void setSchThreeFlag(String schThreeFlag) {
        this.schThreeFlag = schThreeFlag;
    }
    ...
    public String getSchAllFlag() {
        return schAllFlag;
    }

    public void setSchAllFlag(String schAllFlag) {
        this.schAllFlag = schAllFlag;
    }

    public String getIsSchFlag() {
        return isSchFlag;
    }

    public void setIsSchFlag(String isSchFlag) {
        this.isSchFlag = isSchFlag;
    }
    ...
    public String getSecondOrgFlow() {
        return secondOrgFlow;
    }

    public void setSecondOrgFlow(String secondOrgFlow) {
        this.secondOrgFlow = secondOrgFlow;
    }
    ...
    public String getEnglishCertificateNumber() {
        return englishCertificateNumber;
    }

    public void setEnglishCertificateNumber(String englishCertificateNumber) {
        this.englishCertificateNumber = englishCertificateNumber;
    }

    public String getEnglishCertificateDate() {
        return englishCertificateDate;
    }

    public void setEnglishCertificateDate(String englishCertificateDate) {
        this.englishCertificateDate = englishCertificateDate;
    }

    public String getEnglishGradeExamType() {
        return englishGradeExamType;
    }

    public void setEnglishGradeExamType(String englishGradeExamType) {
        this.englishGradeExamType = englishGradeExamType;
    }
    ...
    public String getIsRecruitSend() {
        return isRecruitSend;
    }

    public void setIsRecruitSend(String isRecruitSend) {
        this.isRecruitSend = isRecruitSend;
    }
