...
public class ZseyHrKqMonth extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String kqDeptFlow;

    private String kqDeptName;

    private String kqUserCode;

    private String kqUserName;
    ...
    public String getKqDeptFlow() {
        return kqDeptFlow;
    }

    public void setKqDeptFlow(String kqDeptFlow) {
        this.kqDeptFlow = kqDeptFlow;
    }
    ...
    public String getKqUserCode() {
        return kqUserCode;
    }

    public void setKqUserCode(String kqUserCode) {
        this.kqUserCode = kqUserCode;
    }

    public String getKqUserName() {
        return kqUserName;
    }

    public void setKqUserName(String kqUserName) {
        this.kqUserName = kqUserName;
    }
