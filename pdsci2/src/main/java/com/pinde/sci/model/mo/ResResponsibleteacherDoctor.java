...
public class ResResponsibleteacherDoctor extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    private String responsibleteacherFlow;
    ...
    public String getResponsibleteacherFlow() {
        return responsibleteacherFlow;
    }

    public void setResponsibleteacherFlow(String responsibleteacherFlow) {
        this.responsibleteacherFlow = responsibleteacherFlow;
    }
