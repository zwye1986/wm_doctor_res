...
public class ResInprocessInfoMember extends MybatisObject {
    ...
    public String getInfoRecordFlow() {
        return infoRecordFlow;
    }

    public void setInfoRecordFlow(String infoRecordFlow) {
        this.infoRecordFlow = infoRecordFlow;
    }
