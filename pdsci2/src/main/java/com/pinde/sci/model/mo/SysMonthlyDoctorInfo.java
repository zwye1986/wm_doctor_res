...
public class SysMonthlyDoctorInfo extends TeachingActivitySpeakerExample.MybatisObject {
    private String smdiFlow;
    ...
    public String getSmdiFlow() {
        return smdiFlow;
    }

    public void setSmdiFlow(String smdiFlow) {
        this.smdiFlow = smdiFlow;
    }
