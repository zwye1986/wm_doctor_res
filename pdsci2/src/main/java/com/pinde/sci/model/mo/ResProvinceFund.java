...
public class ResProvinceFund extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getStopUsingDate() {
        return stopUsingDate;
    }

    public void setStopUsingDate(String stopUsingDate) {
