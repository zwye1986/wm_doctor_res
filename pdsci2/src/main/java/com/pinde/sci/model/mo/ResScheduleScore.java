...
public class ResScheduleScore extends MybatisObject {
    ...
    public void setScheduleFlow(String scheduleFlow) {
    ...
    public String getItemDetailed() {
        return itemDetailed;
    }

    public void setItemDetailed(String itemDetailed) {
