...
public class RecruitAdmitInfo extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getAdmitDemo() {
        return admitDemo;
    }

    public void setAdmitDemo(String admitDemo) {
        this.admitDemo = admitDemo;
    }
