...
public class FstuBook extends MybatisObject {
    ...
    public String getLastAuditAdvice() {
        return lastAuditAdvice;
    }

    public void setLastAuditAdvice(String lastAuditAdvice) {
        this.lastAuditAdvice = lastAuditAdvice;
    }
