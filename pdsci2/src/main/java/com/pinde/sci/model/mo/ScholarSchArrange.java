...
public class ScholarSchArrange extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getSecretaryFlow() {
        return secretaryFlow;
    }

    public void setSecretaryFlow(String secretaryFlow) {
        this.secretaryFlow = secretaryFlow;
    }
