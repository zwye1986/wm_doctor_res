...
public class InxInfo implements java.io.Serializable {
    ...
    private String backColumnId;

    private String backColumnName;
    ...
    public String getBackColumnId() {
        return backColumnId;
    }

    public void setBackColumnId(String backColumnId) {
        this.backColumnId = backColumnId;
    }

    public String getBackColumnName() {
        return backColumnName;
    }

    public void setBackColumnName(String backColumnName) {
        this.backColumnName = backColumnName;
    }
