...
public class ResDocotrDelayTeturn extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getPolicyUserFlow() {
        return policyUserFlow;
    }

    public void setPolicyUserFlow(String policyUserFlow) {
        this.policyUserFlow = policyUserFlow;
    }
    ...
    public void setPolicyUserName(String policyUserName) {
        this.policyUserName = policyUserName;
    }
    ...
    public void setDelayFilePath(String delayFilePath) {
        this.delayFilePath = delayFilePath;
    }
    ...
    public String getGlobalCheckFile() {
        return globalCheckFile;
    }
