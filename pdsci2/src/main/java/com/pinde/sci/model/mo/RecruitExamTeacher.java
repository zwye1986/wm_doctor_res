...
public class RecruitExamTeacher extends TeachingActivitySpeakerExample.MybatisObject {
    ...
    public String getTeaDemo() {
        return teaDemo;
    }

    public void setTeaDemo(String teaDemo) {
