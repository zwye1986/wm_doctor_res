...
public class ResEvaluationScore extends MybatisObject {
    ...
    public void setSpeReason(String speReason) {
        this.speReason = speReason;
    }
    ...
    public String getCoreIndicators() {
        return coreIndicators;
    }

    public void setCoreIndicators(String coreIndicators) {
