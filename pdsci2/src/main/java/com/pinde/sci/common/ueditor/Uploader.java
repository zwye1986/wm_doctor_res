...
//				.getRealPath(servletPath);
		String realPath = StringUtil.defaultString(InitConfig.getSysCfg("upload_base_dir"));
//		return new File(realPath).getParent() + "/" + path;
	 ...
	 * @return 从流中读取到的字符串
	 */
	private String getParameterValue(InputStream in) throws UnsupportedEncodingException {
