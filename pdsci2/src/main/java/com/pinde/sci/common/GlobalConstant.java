...
public class GlobalConstant {
    ...
    //中医西医标识
    public static final String Chinese = "C";//中医
    public static final String Western = "W";//西医//通过root配置
    ...
    public static final String RES_NOTICE_TYPE_ID = "LM05";
    public static final String RES_NOTICE_TYPE_NAME = "系统公告";
    public static final String RES_NOTICE_SYS_ID = "0b9e7ef396a24e129d09131bbd4f1ff4";//过程
    public static final String JX_NOTICE_SYS_ID = "e2f1f47808334ed3976b4bcf4cffb43e";//进修
    public static final String ZL_NOTICE_SYS_ID = "5927bbbfb154424e80154cf6d6f05892";//招录

    public static final String RES_NOTICE_TYPE1_ID = "LM01";
    public static final String RES_NOTICE_TYPE1_NAME = "新闻动态";
    public static final String RES_NOTICE_TYPE2_ID = "LM02";
    public static final String RES_NOTICE_TYPE2_NAME = "招生动态";
    public static final String RES_NOTICE_TYPE3_ID = "LM03";
    public static final String RES_NOTICE_TYPE3_NAME = "教学动态";
    public static final String RES_NOTICE_TYPE4_ID = "LM04";
    public static final String RES_NOTICE_TYPE4_NAME = "资料下载";
...
//	public static final String SRM_PROJ_PAGE_CONFIG_PATH = "srm/product/config";
    ...
    //广州医科大学系统默认密码
    public static final String GYD_INIT_PASSWORD = "gzykdx@yjs";
    ...
    //用户维护 财务部门
    public static final String USER_LIST_FINANCE = "finance";
    //用户维护 限本机构
    ...
    public static final String USER_LIST_ETHIC = "ethic";
    //用户维护 限本人
    ...
    // 显示项目列表的scope 无锡二院科主任
    public static final String PROJ_STATUS_SCOPE_WXEY_DIRECTOR = "director";

    public static final String PROJ_STATUS_SCOPE_LOCALSCH = "localSch";
    //当前用户
    ...
    public static final String PD_EXAM_SUPPPWD = "@exam2.njpdxx.com";
    ...
    public static final String STOP_USE_FAIL = "停用失败！";
    ...
    //邮箱被列入黑名单
    public static final String USER_EMAIL_IN_BLACK = "该邮箱已被列入黑名单！";
    //评分详情表中已有数据
    ...
    //基地管理员角色
    public static final String HOSPITAL_ROLE = "hospital";
    //学校管理员角色
    ...
    public static final String RES_ROLE_SCOPE_DISCIPLE = "disciple";//师承老师
    ...
    public static final String PD_ERP_SUPPPWD = "@pde.njpdxx.com";
    ...
    //判断USER是否位考官
    public static final String IS_EXAM_TEA_Y = "Y";
    public static final String IS_EXAM_TEA_N = "N";
    //湖北临床研究门户资讯roleFlow标识
    public static final String HBLCYJ_INFO_ROLE_FLOW = "hblcyj_info_role_flow";
    //发送短信模板
    public static final String JSZY_TEMPLATE = "516947";
    public static final String JSRES_TEMPLATE = "516946";
    public static final String HBRES_TEMPLATE = "516949";
    public static final String TJRES_TEMPLATE = "516954";
