...
import com.pinde.sci.biz.hbzy.IJszyResUserBlackBiz;
 ...
 */
@Controller
@RequestMapping("/hbzy/blackList")
public class HbzyResUserBlackListController extends GeneralController {
    @Autowired
    ...
    public String blackListInfo(JsresUserBalcklist jsresUserBalcklist, Model model, String sessionNumber,HttpServletRequest request, Integer currentPage,String seeFlag,String jointOrg) throws DocumentException {
    ...
    public ModelAndView addBlackList(){
        ModelAndView mav=new ModelAndView("hbzy/doctor/addBlackList");
        return mav;
    }
    /**
     * 保存黑名单
