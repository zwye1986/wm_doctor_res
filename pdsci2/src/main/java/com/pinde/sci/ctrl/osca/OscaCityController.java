...
//        model.addAttribute("speList",speList);
        ...
        paramMap5.put("isLocal", GlobalConstant.FLAG_N);
        ...
        paramMap6.put("isLocal", GlobalConstant.FLAG_N);
