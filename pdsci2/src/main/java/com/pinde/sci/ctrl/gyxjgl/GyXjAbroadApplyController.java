...
import com.pinde.sci.biz.gyxjgl.IGyAbroadApplyBiz;
import com.pinde.sci.common.GeneralController;
import com.pinde.sci.common.GlobalConstant;
import com.pinde.sci.common.GlobalContext;
import com.pinde.sci.enums.gyxjgl.AbroadCategoryEnum;
 ...
 */
@Controller
@RequestMapping("/gyxjgl/abroadApply")
public class GyXjAbroadApplyController extends GeneralController {

    @Autowired
    private IGyAbroadApplyBiz abroadApplyBiz;
    @Autowired
    ...
    public String abroadApplyList(String formType,String roleFlag,NygoAbroadApply abroadApply, Model model,Integer currentPage, HttpServletRequest request ){
        ...
        if("student".equals(roleFlag)){
            if("recordSheet".equals(formType)){ //备案登记表
                return "gyxjgl/internationalEdu/recordSheetList";
            }
            return "gyxjgl/internationalEdu/stuApplyLIst";
        }
        return "gyxjgl/internationalEdu/abroadStuList";
    }
    ...
    public String editAbroadApply(String recordFlow,String roleFlag,Model model){
        ...
        return "gyxjgl/internationalEdu/abroadApplication";
    }
    ...
    public String showInfo(String recordFlow,String roleFlag,Model model){
        ...
        model.addAttribute("roleFlag",roleFlag);
        return "gyxjgl/internationalEdu/showInfo";
    }
    ...
    public String showEditSheet(String recordFlow,String roleFlag,String formType,Model model){
        ...
        if("recordSheet".equals(formType)){
            return "gyxjgl/internationalEdu/recordSheet";
        }
        if("cost".equals(formType)){
            return "gyxjgl/internationalEdu/costSheet";
        }
        if("trip".equals(formType)){
            return "gyxjgl/internationalEdu/tripSheet";
        }
        if("return".equals(formType)){
            return "gyxjgl/internationalEdu/returnApplication";
        }
        return "gyxjgl/internationalEdu/recordSheet";
    }
    ...
    public String showUploadFile(String roleFlag, String recordFlow,Model model){
        ...
        model.addAttribute("recordFlow",recordFlow);
        model.addAttribute("roleFlag",roleFlag);
        return "gyxjgl/internationalEdu/uploadFiles";
    }
