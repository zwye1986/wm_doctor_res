...
/**
 * Created by www.0001.Ga on 2017-02-07.
 */
@Controller
@RequestMapping("/inx/jszysrm")
public class InxJszysrmController extends GeneralController{

    private static Logger logger = LoggerFactory.getLogger(InxJszysrmController.class);
    @Autowired
    ...
    public ModelAndView queryByColumnId(){
        ...
        mav.setViewName("inx/jszysrm/news");
        return mav;
    }
    ...
    public ModelAndView loadInfoList(String columnId, String isWithBlobs, Integer currentPage, HttpServletRequest request, Model model){
        ...
        mav.setViewName("inx/jszysrm/infoList");
        return mav;
    }
