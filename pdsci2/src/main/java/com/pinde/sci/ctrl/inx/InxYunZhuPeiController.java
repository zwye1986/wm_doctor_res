...
@Controller
@RequestMapping("/inx/yunZhuPei")
public class InxYunZhuPeiController extends GeneralController {

    private static Logger logger = LoggerFactory.getLogger(InxYunZhuPeiController.class);
    ...
    public String login(HttpServletRequest request, Model model,String userCode, String userPasswd, String verifyCode,String successLoginPage,String errorLoginPage) {
        ...
        if(StringUtil.isBlank(errorLoginPage)){
            errorLoginPage = "inx/yunZhuPei/login";
        }
        //默认登录成功界面
