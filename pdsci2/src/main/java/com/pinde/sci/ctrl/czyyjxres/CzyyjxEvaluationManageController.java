...
import com.pinde.sci.biz.czyyjxres.ICzjxResDoctorEvaluationBiz;
import com.pinde.sci.biz.czyyjxres.ICzjxStuDoctorInfoBiz;
...
import com.pinde.sci.model.czyyjxres.StuEvalCfgExt;
import com.pinde.sci.model.czyyjxres.StuEvalCfgItemExt;
import com.pinde.sci.model.czyyjxres.StuEvalCfgTitleExt;
...
@RequestMapping("/czyyjxres/evaluation")
@Controller
public class CzyyjxEvaluationManageController extends GeneralController {

    @Autowired
    private ICzjxResDoctorEvaluationBiz resDoctorEvaluationBiz;
    @Autowired
    ...
    public String evaluationMaintenance(Model model, String roleId) throws DocumentException {
        ...
        return "czyyjxres/evaluation/evaluationIndex";
    }
    ...
    public String evaluationSelect(Integer currentPage, Model model, StuFurtherStudyRegist stuFurtherStudyRegist, HttpServletRequest request) {
        return "czyyjxres/evaluation/evaluationTap";
    }
    ...
    public String evaluationQuery(Integer currentPage, Model model, String roleId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            return "czyyjxres/evaluation/secretary/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "czyyjxres/evaluation/teacher/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "czyyjxres/evaluation/doctor/evaluation4Query";
        }
        return null;
    }
    ...
    public String evaluationManage(Integer currentPage, Model model, String roleId, String evalStatueId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            model.addAttribute("evalMap", evalMap);
            return "czyyjxres/evaluation/secretary/evaluationList";
        } else if (StuRoleEnum.Teacher.getId().equals(roleId)) {
            ...
            model.addAttribute("infoList", stuUserResumes);
            model.addAttribute("evalMap", evalMap);
            return "czyyjxres/evaluation/teacher/evaluationList";
        } else if (StuRoleEnum.Doctor.getId().equals(roleId)) {
            if (StuRoleEnum.Teacher.getId().equals(kaoherenRoleId)) {
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "czyyjxres/evaluation/doctor/evaluationList";
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "czyyjxres/evaluation/doctor/evaluationList4secretary";
            }
        }
        return null;
    }
    ...
    public String showEvaluation(Model model, String roleId, String processFlow, String kaoherenRoleId) throws DocumentException {
        ...
        return "czyyjxres/evaluation/editEvalForm";
    }
