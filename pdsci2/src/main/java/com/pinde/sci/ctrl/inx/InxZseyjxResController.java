...
import com.pinde.sci.enums.zseyjxres.CertificateTypes2Enum;
...
@Controller
@RequestMapping("/inx/zseyjxres")
public class InxZseyjxResController extends GeneralController{
...
//			setSessionAttribute(GlobalConstant.CURRENT_ORG, orgBiz.readSysOrg(user.getOrgFlow()));
			...
			setSessionAttribute(GlobalConstant.CURRENT_ORG, orgBiz.readSysOrg(ZSEY_ORG_FLOW));
			setSessionAttribute(GlobalConstant.CURRENT_DEPT_LIST, deptBiz.searchDeptByOrg(ZSEY_ORG_FLOW));
...
//				return "/zseyjxres/doctor/loginError";
//			}
//
//			doctorBiz.editDoctor(doctor);
			...
			if(role!=null){
				...
				{
					return "redirect:/zseyjxres/teacher/home";
				}
			}
...
//				return "/zseyjxres/manage/home";
				...
				return successLoginPage;
			}else if(roleFlow.equals(InitConfig.getSysCfg("res_head_role_jx_flow"))){ //科主任
...
//		}
		...
		String cretTypeName = CertificateTypes2Enum.getNameById(cretTypeId);
		registerUser.setCretTypeName(cretTypeName);
		registerUser.setIsOwnerStu("P");
		registerUser.setOrgFlow(ZSEY_ORG_FLOW);
...
//		model.addAttribute("userEmail",userEmail);
		return "redirect:/inx/zseyjxres/sendEmail";
	}
...
//		model.addAttribute("userEmail" , user.getUserEmail());
		return "inx/zseyjxres/sendEmail";
	}
	...
	public String noticeList(Integer currentPage , Model model){
		...
		List<InxInfo> infos = this.noticeBiz.findNotice(info);
		model.addAttribute("infos",infos);
		return "inx/zseyjxres/morenotice";
	}

	@RequestMapping("/forgetpasswd")
	public String forgetpasswd(){
		return "inx/zseyjxres/forgetpasswd";
	}
	...
	public String resetpasswd(String actionId,Model model){
		...
		return "inx/zseyjxres/resetpasswd";
	}
	...
	public String uploadFile(String operType,Model model){
		...
		return "inx/zseyjxres/uploadFile";
	}
