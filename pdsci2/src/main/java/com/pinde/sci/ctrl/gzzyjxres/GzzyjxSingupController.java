...
@Controller
@RequestMapping("/gzzyjxres/singup")
public class GzzyjxSingupController extends GeneralController {
	private static Logger logger = LoggerFactory.getLogger(GzzyjxSingupController.class);
	...
	public String login(HttpServletRequest request,String userFlow,Model model){
		String errorLoginPage ="inx/gzzyjxres/login";
