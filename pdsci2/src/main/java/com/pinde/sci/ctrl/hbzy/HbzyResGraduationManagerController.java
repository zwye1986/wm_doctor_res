...
import com.pinde.sci.biz.hbzy.IJszyAuditLogBiz;
...
import com.pinde.sci.enums.hbzy.JszyBaseStatusEnum;
 ...
 */
@Controller
@RequestMapping("/hbzy/graduationManager")
public class HbzyResGraduationManagerController extends GeneralController {
    @Autowired
    ...
    public String showMain(Model model, String roleFlag, String pageType, String tabType) {
        ...
        return "hbzy/graduationManager/global/query/main";
    }
    ...
    public String list(Model model, Integer currentPage, HttpServletRequest request,
        ...
        return "hbzy/graduationManager/global/query/list";
    }
    ...
    public String showCertificate(String recordFlow, Model model, String roleId) {
        ResDoctorGraduationInfo resDoctorGraduationInfo = graduationBiz.findGraduationInfo(recordFlow);
        ...
        return "hbzy/graduationManager/info";
    }
    ...
    public void showCertificate2(String recordFlow, Model model, String roleId,HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String path = "/jsp/hbzy/graduationManager/zhengshumoban.docx";//模板
...
//            }
//        };
//        String template = "hbzy/zhengshumoban.html";
...
//        pubFileBiz.downFile(file, response);
    ...
    public String editInfo(String recordFlow, Model model) {
        ...
        return "hbzy/graduationManager/global/editInfo";
    }
