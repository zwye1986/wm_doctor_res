 ...
 */
@Controller
@RequestMapping("/hbzy/sysCfg")
public class HbzySysCfgController extends GeneralController {
    private static Logger logger= LoggerFactory.getLogger(HbzySysCfgController.class);
