...
@Controller
@RequestMapping("/inx/zseylcjn")
public class InxZseyLcjnController extends GeneralController{
	...
	public String login(HttpServletRequest request, Model model, String userCode, String userPasswd, String verifyCode, String successLoginPage, String errorLoginPage) {
		...
		if(StringUtil.isBlank(errorLoginPage)){
			errorLoginPage = "/inx/zseylcjn/index";
		}
		//默认登录成功界面
		...
		//住培带教角色同步到中二院临床预约系统中任课老师角色
		baseBiz.bindTeacherRole(user.getUserFlow());
		//加载系统权限
