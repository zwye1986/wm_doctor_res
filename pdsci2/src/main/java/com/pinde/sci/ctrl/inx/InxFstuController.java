...
@Controller
@RequestMapping("/inx/fstu")
public class InxFstuController extends GeneralController{
	
	private static Logger logger = LoggerFactory.getLogger(InxFstuController.class);
	@Autowired
	...
	public String login(String userCode, String userPasswd, String verifyCode,String successLoginPage,String errorLoginPage,String flag, HttpServletRequest request, Model model) {
	...
	public ModelAndView queryByColumnId(){
		...
		mav.setViewName("inx/fstu/notices");
		return mav;
	}
	...
	public ModelAndView loadInfoList(String columnId, String isWithBlobs, Integer currentPage, HttpServletRequest request, Model model){
		...
		mav.setViewName("inx/fstu/infoList");
		return mav;
	}
