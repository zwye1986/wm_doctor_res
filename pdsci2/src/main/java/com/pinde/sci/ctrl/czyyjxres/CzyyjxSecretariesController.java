...
import com.pinde.sci.form.czyyjxres.ExportStuUserInfo;
...
@Controller
@RequestMapping("/czyyjxres/secretaries")
public class CzyyjxSecretariesController extends GeneralController{
	...
	public String home( Model model){
		return "czyyjxres/secretaries/index";
	}
	...
	public String changeTea(Integer currentPage ,String batchFlow,String userName,String teaName,String isSecretart,String isQuery, Model model,HttpServletRequest request){
		...
		return "czyyjxres/secretaries/list";
	}
