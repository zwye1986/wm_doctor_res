...
@Controller
@RequestMapping("/hbzy/singup")
public class HbzySingupController extends GeneralController {
	private static Logger logger = LoggerFactory.getLogger(HbzySingupController.class);
...
//							"http://www.develop.com/";
	...
	public String login(HttpServletRequest request,String userFlow,Model model){
		String errorLoginPage ="inx/hbzy/login2";
