...
@Controller
@RequestMapping("/res/czAbsence")
public class CzyyResAbsenceController extends GeneralController {
    @Autowired
    private ICzjxDoctorAbsenceBiz doctorAbsenceBiz;
    @Autowired
    ...
    public String absenceList(@PathVariable String roleFlag,Integer currentPage, SchDoctorAbsence doctorAbsence, HttpServletRequest request, Model model){
        ...
        return "czyyjxres/doctor/intern/absenceList";
    }
...
//			List<ResDoctor> doctorList = resDoctorBiz.searchByDoc(doctor);
        ...
        return "czyyjxres/doctor/intern/editAbsence";
    }
