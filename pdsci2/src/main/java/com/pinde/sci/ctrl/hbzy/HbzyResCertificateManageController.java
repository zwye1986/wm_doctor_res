 ...
 */
@Controller
@RequestMapping("/hbzy/certificateManage")
public class HbzyResCertificateManageController extends GeneralController {
    @Autowired
    ...
    public String showMain(Model model, String roleFlag) {
        ...
        return "hbzy/global/certificateManage/main";
    }
    ...
    public String list(Model model, Integer currentPage, String roleFlag, HttpServletRequest request,
        ...
        return "hbzy/global/certificateManage/list";
    }
    ...
    public String showCertificate(String recruitFlow,Model model) {
        ...
        return "hbzy/global/showCertificate/info";
    }
