...
import com.pinde.sci.biz.hbzy.IJszyDoctorReductionBiz;
...
@Controller
@RequestMapping("/hbzy/reduction")
public class HbzyResReductionManageController extends GeneralController {
    ...
    public String main(Model model) {
        ...
        return "hbzy/reduction/recruitListTab";
    }
    ...
    public String getDoctorRecruit(String recruitFlow, String doctorFlow, Model model) {
        if (StringUtil.isNotBlank(recruitFlow)) {
            ...
            if (JszyResDoctorAuditStatusEnum.Passed.getId().equals(doctorRecruit.getAuditStatusId())) {
                ...
                if (JszyTrainCategoryEnum.TCMAssiGeneral.getId().equals(doctorRecruit.getCatSpeId())) {
                    ...
                    if("1".equals(doctorRecruit.getTrainYear())||"2".equals(doctorRecruit.getTrainYear())) {
                        model.addAttribute("isReductionEd", "Y");
                    }else{
                        model.addAttribute("isReductionEd", "N");
                    }
        ...
        return "hbzy/reduction/reductionInfo";
    }
    ...
    public String showUploadReductionFile(ResDoctorReduction resDoctorReduction, Model model) {
        ...
        return "hbzy/reduction/uploadFile";
    }
...
//        学员端减免多附件上传
    ...
    @ResponseBody
    public String reductionApply(String recordFlow) {
    ...
    public String delayManage(Integer currentPage, ResDoctor doctor, HttpServletRequest request, SysUser user4Search, ResDoctorReduction reduction4Search,
        ...
        //页面跳转控制
        if (GlobalConstant.USER_LIST_GLOBAL.equals(roleId)) {
            return "hbzy/reduction/reductionInfo4global";
        } else if (GlobalConstant.USER_LIST_LOCAL.equals(roleId)) {
            return "hbzy/reduction/reductionInfo4Local";
        }
        return "";
    }
    ...
    public String showCheckReductionInfo(String recordFlow, String roleId, Model model) {
        ...
        model.addAttribute("roleId", roleId);
        model.addAttribute("reduction", reduction);
        return "hbzy/reduction/checkReduction";
    }
