...
@Controller
@RequestMapping("/inx/studySubject")
public class InxStudySubjectController extends GeneralController {

    private static Logger logger = LoggerFactory.getLogger(InxStudySubjectController.class);
    ...
    public String login(HttpServletRequest request, Model model,String userCode, String userPasswd, String verifyCode,String successLoginPage,String errorLoginPage) {
        ...
        if(StringUtil.isBlank(errorLoginPage)){
            errorLoginPage = "inx/studySubject/login";
        }
        //默认登录成功界面
