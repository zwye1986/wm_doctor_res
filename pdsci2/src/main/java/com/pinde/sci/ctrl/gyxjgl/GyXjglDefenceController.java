...
import com.pinde.sci.biz.gyxjgl.IGyXjDefenceBiz;
...
@Controller
@RequestMapping("/gyxjgl/paper")
public class GyXjglDefenceController extends GeneralController {
    @Autowired
    private IGyXjDefenceBiz defenceBiz;
    @Autowired
    ...
    public String defenceApply(Integer currentPage, String isReplenish, HttpServletRequest request, Model model) {
        ...
        Map<String,Object> majorCredit = defenceBiz.searchMajorCredit(defence.getUserFlow());
        ...
        return "gyxjgl/defence/defenceApply";
    }
    ...
    public String editAccount(String recordFlow, String auditFlag, String role, String isReplenish, Model model) {
        ...
        if (GlobalConstant.FLAG_Y.equals(auditFlag)) {
            return "gyxjgl/defence/auditOption";
        }
        return "gyxjgl/defence/editDefence";
    }
    ...
    public String paperAudit(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        return "gyxjgl/defence/defenceAudit";
    }
    ...
    public String paperManage(Integer currentPage, String isReplenish, HttpServletRequest request, Model model) {
        ...
        Map<String, Object> baseInfo = defenceBiz.queryBaseInfo(user.getUserFlow());
        model.addAttribute("baseInfo", baseInfo);
        model.addAttribute("userFlow", user.getUserFlow());
        model.addAttribute("titleList", titleList);
        model.addAttribute("isReplenish", isReplenish);
        return "gyxjgl/defence/paperManage";
    }
    ...
    public String editTitle(String recordFlow, String defenceFlow, String isReplenish, Model model) {
        ...
        model.addAttribute("defence", defence);
        model.addAttribute("isReplenish", isReplenish);
        return "gyxjgl/defence/editTitle";
    }
     ...
     * 作为学位申请论文 操作
     */
    @RequestMapping(value = "/degreePaperOption")
    @ResponseBody
    public String degreePaperOption(String recordFlow) throws Exception {
        int result = defenceBiz.degreePaperOption(recordFlow);
        if (result > 0) {
            return GlobalConstant.SAVE_SUCCESSED;
        }
        return GlobalConstant.SAVE_FAIL;
    ...
    public String qualifyApply(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/qualifyApply";
    }
    ...
    public String defenceSchedule(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/defenceSchedule";
    }
    ...
    public String editSchedule(String recordFlow, Model model) {
        ...
        return "gyxjgl/defence/editSchedule";
    }
    ...
    public String defenceResult(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/defenceResult";
    }
    ...
    public String fwhAdvice(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/fwhAdvice";
    }
    ...
    public String schoolAdvice(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/schoolAdvice";
    }
    ...
    public String exportDate(String role, NydbDefenceApply defence, Integer currentPage, HttpServletRequest request, Model model) {
        ...
        List<NydbDefenceApply> defenceList = defenceBiz.queryDefenceList(defence);
        model.addAttribute("defenceList", defenceList);
        return "gyxjgl/defence/exportDate";
    }
    ...
    public void expUpDate(String role, NydbDefenceApply defence, HttpServletResponse response) throws Exception {
        Map<String,String> params = new HashMap<>();
        params.put("exportFlag",GlobalConstant.FLAG_Y);
        List<Map<String, Object>> recordList = defenceBiz.queryPaperTitleList(params);
        if (null != recordList && !recordList.isEmpty()) {
            for (Map<String, Object> apply : recordList) {
                //用于导出空字段信息
                apply.put("recordFlow","");
                if (null != apply.get("auditResultFlag")) {
                    apply.put("auditResultFlag",GlobalConstant.FLAG_Y.equals(apply.get("auditResultFlag").toString()) ? "通过" : GlobalConstant.FLAG_N.equals(apply.get("auditResultFlag").toString())?"不通过":"");
                }
                if (null != apply.get("defenceResultFlag")) {
                    apply.put("defenceResultFlag",GlobalConstant.FLAG_Y.equals(apply.get("defenceResultFlag").toString()) ? "通过" : GlobalConstant.FLAG_N.equals(apply.get("defenceResultFlag").toString())?"不通过":"");
                }
                if (null != apply.get("journalType")) {
                    String journalType = apply.get("journalType").toString();
                    if(journalType.equals("sci")){
                        journalType = "SCI";
                    }else if(journalType.equals("ei")){
                        journalType = "EI";
                    }else if(journalType.equals("zwhx")){
                        journalType = "中文核心";
                    }else if(journalType.equals("zwtjy")){
                        journalType = "中文统计源";
                    }else if(journalType.equals("qt")){
                        journalType = "其他";
                    }
                    apply.put("journalType",journalType);
                }
                if (null != apply.get("articleStatus")) {
                    String articleStatus = apply.get("articleStatus").toString();
                    if(articleStatus.equals("fb")){
                        articleStatus = "发表";
                    }else if(articleStatus.equals("ly")){
                        articleStatus = "录用";
                    }else if(articleStatus.equals("qt")){
                        articleStatus = "投稿";
                    }
                    apply.put("articleStatus",articleStatus);
                }
            }
        }
        String[] titles = new String[]{
    ...
    public String leadTo(String isReplenish) {
        return "gyxjgl/defence/importDefence";
    }
     ...
     * 建议缓授意见
     */
    @RequestMapping("/hsAdvice")
    public String hsAdvice(String recordFlow, Model model) {
        if(StringUtil.isNotBlank(recordFlow)){
            NydbDefenceApply defence = defenceBiz.queryDefenceByFlow(recordFlow);
            model.addAttribute("defence", defence);
        }
        return "gyxjgl/defence/hsAdvice";
    }
}
