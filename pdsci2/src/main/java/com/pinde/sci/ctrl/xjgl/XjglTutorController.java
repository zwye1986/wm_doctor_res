...
@Controller
@RequestMapping("/xjgl/tutor")
public class XjglTutorController extends GeneralController {
    @Autowired
    ...
    @ResponseBody
    public String fileUpload(String tutorFlow,MultipartFile image){
        if(image!=null && image.getSize() > 0){
            return tutorBiz.uploadFile(tutorFlow,image);
        }
        return GlobalConstant.UPLOAD_FAIL;
    }
    ...
    public String tutorApplication(Model model) {
        ...
        model.addAttribute("tutor",tutor);
        return "xjgl/tutor/tutorApplication";
    }
    ...
    public String searchDoctorList(NydsOfficialDoctor officialDoctor,Model model,Integer currentPage, HttpServletRequest request){
        ...
        SysOrg sysOrg=orgBiz.readSysOrgByName("南方医科大学");
    ...
    public String passedTutorList(NydsOfficialDoctor tutor,Integer currentPage,HttpServletRequest request, Model model,
        ...
        model.addAttribute("tutorList",tutorList);
        return "xjgl/tutor/passedTutorList";
    }
