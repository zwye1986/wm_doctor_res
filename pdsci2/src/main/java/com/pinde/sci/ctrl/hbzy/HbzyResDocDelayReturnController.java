 ...
 */
@Controller
@RequestMapping("/hbzy/delayReturn")
public class HbzyResDocDelayReturnController extends GeneralController {
    @Autowired
    ...
    public String delayTab(String roleId, Model model) {
        ...
        return "hbzy/delay/tab";
    }

    @RequestMapping(value = {"/delayManage"})
    public String delayManage(Integer currentPage, ResDoctor doctor, HttpServletRequest request,
...
//        paramMap.put("delayStatusIdList", delayStatusIdList);
        ...
        model.addAttribute("roleId", roleId);
        return "hbzy/delay/delayInfo4global";
    }

    @RequestMapping(value = {"/delayQuery4Local"})
    public String delayQuery4Local(Integer currentPage, ResDoctor doctor, HttpServletRequest request,
...
//        paramMap.put("delayStatusIdList", delayStatusIdList);
        ...
        //页面跳转控制
        return "hbzy/delay/delayInfo4Local";
    }
    ...
    public String showCheckdelayInfo(String recordFlow, String roleId, Model model) {
        ...
        return "hbzy/delay/checkDelayInfo";
    }
    ...
    public String backTrainTab(String roleId, Model model) {
        model.addAttribute("roleId", roleId);
        return "hbzy/backTrain/tab";
    }

    @RequestMapping(value = {"/backTrainManage"})
    public String backTrainManage(Integer currentPage, ResDoctor doctor, HttpServletRequest request,ResDocotrDelayTeturn backTrainDoc,
                                  Model model, @RequestParam(value = "statusFlag", required = false, defaultValue = "all") String statusFlag, String operType, String roleId) {
        //当前用户
        SysUser currentUser = GlobalContext.getCurrentUser();
        //当前机构
        ...
        model.addAttribute("operType", operType);
        model.addAttribute("roleId", roleId);
        return "hbzy/backTrain/backTrainInfo4global";
    }

    @RequestMapping(value = {"/backTrainQuery4Local"})
    public String backTrainQuery4Local(Integer currentPage, ResDoctor doctor, HttpServletRequest request,ResDocotrDelayTeturn backTrainDoc,
        ...
        //页面跳转控制
        return "hbzy/backTrain/backTrainInfo4Local";
    }
    ...
    public String showCheckBackTrainInfo(String recordFlow, String roleId, Model model) {
        ...
        return "hbzy/backTrain/checkBackTrainInfo";
    }
