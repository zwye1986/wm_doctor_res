...
import com.pinde.sci.biz.dwjxres.IResDoctorEvaluationBiz;
...
@Controller
public class DwjxEvaluationManageController extends GeneralController {

    @Autowired
    private IResDoctorEvaluationBiz resDoctorEvaluationBiz;
    @Autowired
    ...
    public String evaluationMaintenance(Model model, String roleId) throws DocumentException {
        ...
        return "dwjxres/evaluation/evaluationIndex";
    }
    ...
    public String evaluationSelect(Integer currentPage, Model model, StuFurtherStudyRegist stuFurtherStudyRegist, HttpServletRequest request) {
        return "dwjxres/evaluation/evaluationTap";
    }
    ...
    public String evaluationQuery(Integer currentPage, Model model, String roleId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            return "dwjxres/evaluation/secretary/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "dwjxres/evaluation/teacher/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "dwjxres/evaluation/doctor/evaluation4Query";
        }
        return null;
    }
    ...
    public String evaluationManage(Integer currentPage, Model model, String roleId, String evalStatueId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            model.addAttribute("evalMap", evalMap);
            return "dwjxres/evaluation/secretary/evaluationList";
        } else if (StuRoleEnum.Teacher.getId().equals(roleId)) {
            ...
            model.addAttribute("infoList", stuUserResumes);
            model.addAttribute("evalMap", evalMap);
            return "dwjxres/evaluation/teacher/evaluationList";
        } else if (StuRoleEnum.Doctor.getId().equals(roleId)) {
            if (StuRoleEnum.Teacher.getId().equals(kaoherenRoleId)) {
                ...
                //区分是否评价
                parMp.put("evalStatueId", evalStatueId);
                PageHelper.startPage(currentPage,  getPageSize(request));
                List<StuUserExt> stuUserLst = resDoctorEvaluationBiz.searchStuUserForTeacher(parMp);
                //对应批次号下的评价记录
                Map<String, ResDoctorSchProcessEval> evalMap = new HashMap<>();
                if (stuUserLst != null && stuUserLst.size() > 0) {
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "dwjxres/evaluation/doctor/evaluationList";
                ...
                parMp.put("evalStatueId", evalStatueId);
                PageHelper.startPage(currentPage,  getPageSize(request));
                List<StuUserExt> stuUserLst = resDoctorEvaluationBiz.searchStuUserForDept(parMp);
                //对应批次号下的评价记录
                Map<String, ResDoctorSchProcessEval> evalMap = new HashMap<>();
                if (stuUserLst != null && stuUserLst.size() > 0) {
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "dwjxres/evaluation/doctor/evaluationList4secretary";
            }
        }
        return null;
    }
    ...
    public String showEvaluation(Model model, String roleId, String processFlow, String kaoherenRoleId) throws DocumentException {
        ...
        return "dwjxres/evaluation/editEvalForm";
    }
