...
import com.pinde.sci.biz.zseyjxres.IZseyjxResDoctorEvaluationBiz;
...
import com.pinde.sci.model.zseyjxres.StuEvalCfgExt;
import com.pinde.sci.model.zseyjxres.StuEvalCfgItemExt;
import com.pinde.sci.model.zseyjxres.StuEvalCfgTitleExt;
...
@RequestMapping("/zseyjxres/evaluation")
@Controller
public class ZseyjxEvaluationManageController extends GeneralController {

    @Autowired
    private IZseyjxResDoctorEvaluationBiz resDoctorEvaluationBiz;
    @Autowired
    ...
    public String evaluationMaintenance(Model model, String roleId) throws DocumentException {
        ...
        return "zseyjxres/evaluation/evaluationIndex";
    }
    ...
    public String evaluationSelect(Integer currentPage, Model model, StuFurtherStudyRegist stuFurtherStudyRegist, HttpServletRequest request) {
        return "zseyjxres/evaluation/evaluationTap";
    }
    ...
    public String evaluationQuery(Integer currentPage, Model model, String roleId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            return "zseyjxres/evaluation/secretary/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "zseyjxres/evaluation/teacher/evaluation4Query";
            ...
            model.addAttribute("evalMap", evalMap);
            return "zseyjxres/evaluation/doctor/evaluation4Query";
        }
        return null;
    }
    ...
    public String evaluationManage(Integer currentPage, Model model, String roleId, String evalStatueId,
        ...
        if (StuRoleEnum.Secretary.getId().equals(roleId)) {
            ...
            model.addAttribute("evalMap", evalMap);
            return "zseyjxres/evaluation/secretary/evaluationList";
        } else if (StuRoleEnum.Teacher.getId().equals(roleId)) {
            ...
            model.addAttribute("infoList", stuUserResumes);
            model.addAttribute("evalMap", evalMap);
            return "zseyjxres/evaluation/teacher/evaluationList";
        } else if (StuRoleEnum.Doctor.getId().equals(roleId)) {
            if (StuRoleEnum.Teacher.getId().equals(kaoherenRoleId)) {
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "zseyjxres/evaluation/doctor/evaluationList";
                ...
                model.addAttribute("evalMap", evalMap);
                model.addAttribute("infoList", stuUserLst);
                return "zseyjxres/evaluation/doctor/evaluationList4secretary";
            }
        }
        return null;
    }
    ...
    public String showEvaluation(Model model, String roleId, String processFlow, String kaoherenRoleId) throws DocumentException {
        ...
        return "zseyjxres/evaluation/editEvalForm";
    }
