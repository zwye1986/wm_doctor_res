...
@Controller
@RequestMapping("/czyyjxres/singup")
public class CzyyjxSingupController extends GeneralController {
	private static Logger logger = LoggerFactory.getLogger(CzyyjxSingupController.class);
	...
	public String login(HttpServletRequest request,String userFlow,Model model){
		String errorLoginPage ="inx/czyyjxres/login";
