(function($) {
    ...
    $.selectSuggest = function(target, data, itemSelectFunction,selectId,loadSelectFunction,attrFunction) {
        var defaulOption = {
        ...
        var _initItems = function(items) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if(attrs)
                {
                    ...
                    {
                        suggestItem.attr(attrs[j].name, attrs[j].value);
                    }
                }
                suggestItem.css({
        ...
        $('#' + target).bind("blur",
            function() {
                ...
                var suggestContainerLeft = $('#' + target).position().left-1;
                var suggestContainerTop = $('#' + target).position().top+$('#' + target).outerHeight();
