...
<c:if test="${param.kindeditor=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/kindeditor/themes/default/default.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	<script type="text/javascript" src="<s:url value='/kindeditor/kindeditor-all.js'/>?v=${applicationScope.sysCfgMap['sys_version']}" charset="utf-8"></script>
	<script type="text/javascript" src="<s:url value='/kindeditor/lang/zh-CN.js'/>?v=${applicationScope.sysCfgMap['sys_version']}" charset="utf-8"></script>
</c:if>
