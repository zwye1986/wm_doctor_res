...
function save() {
	...
	jboxConfirm(msg,function(){
		var url = "<s:url value='/erp/crm/payPlan/auditBalance'/>";
...
<div class="content">
	<div class="title1 clearfix">
			<form id="balanceForm" >
				...
				<input name="planFlow" value="${balance.planFlow}" type="hidden">
