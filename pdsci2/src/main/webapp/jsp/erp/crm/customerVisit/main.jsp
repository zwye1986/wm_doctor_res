...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			...
			jboxPostLoad("payList" ,"<s:url value='/erp/crm/customerVisit/list'/>" ,$("#searchForm").serialize() , true);
		}
		...
		function customerVisit(customerFlow, customerName) {
			var w = $('.mainright').width();
			var h = $('.mainright').height();
			var url = "<s:url value='/erp/crm/customerVisit/customerInfo'/>?customerFlow=" + customerFlow;
			var iframe ="<iframe name='jbox-message-iframe' id='jbox-message-iframe' width='100%' height='"+h+"' marginheight='0' marginwidth='0' frameborder='0' scrolling='auto' src='"+url+"'></iframe>";
			jboxMessager(iframe,'客户【'+customerName+'】回访',w,h,null,false);
		}

		function add(customerFlow, customerName){
			jboxOpen("<s:url value='/erp/crm/customerVisit/add'/>?customerFlow="+customerFlow, "客户【"+customerName+"】回访",800,450);
		}
	</script>
</head>
<body>
