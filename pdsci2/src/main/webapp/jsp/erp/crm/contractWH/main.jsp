...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			jboxPostLoad("payList" ,"<s:url value='/erp/crm/contractWH/list'/>" ,$("#searchForm").serialize() , true);
		}
		...
		<form  id="searchForm" method="post">
			...
			<table class="basic searchTable" style="width:100%;margin-top: 10px;">
				...
				<tr>
					<td>
						<label>&#12288;合同状态：</label>
						<select class="xlselect" name="contractStatusId" id="contractStatusId" style="width:128px;">
							<option value="">请选择</option>
				...
				<tr>
					<td>
						...
						<c:if test="${type eq 'sh'}">
							<input type="checkbox" id="waitAudit" name="waitAudit" checked="checked" onchange="changeStatus();" value="${GlobalConstant.FLAG_Y }"><label for="waitAudit">&nbsp;待审核合同</label>
						</c:if>
						<input type="button" class="search"  onclick="search();" value="查&#12288;询">
						<c:if test="${type eq 'wh'}">
							<input type="button" class="search"  onclick="editContract('');" value="新&#12288;增">
						</c:if>
					</td>
				</tr>
			</table>
