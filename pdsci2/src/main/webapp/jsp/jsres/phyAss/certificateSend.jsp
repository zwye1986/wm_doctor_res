...
<script type="text/javascript">
	...
	function toPage(page) {
	 ...
	 function allSendCertificate() {
		 ...
		 jboxConfirm("是否确认发放证书？",function(){
			 var url = "<s:url value ='/jsres/phyAss/sendCertificate'/>?recordFlows="+recordFlowsStr;
	...
	function expertCertidicateSend() {
		var url = "<s:url value='/jsres/phyAss/expertCertidicateSend'/>";
		jboxTip("导出中…………");
	...
	<form id="searchForm">
		...
		<table class="searchTable">
			...
			<tr>
				...
				<td>
					<select name="sendCertificateId" id="sendCertificateId" class="select" style="width: 200px;">
						<option value="">全部</option>
			...
			<tr>
				<td id="func" colspan="8">
					...
					<input class="btn_green" style="margin-left: 0px;" type="button" value="批量发放" onclick="allSendCertificate();"/>&nbsp;
					<input class="btn_green" style="margin-left: 0px;" type="button" value="导&#12288;出" onclick="expertCertidicateSend();"/>
				</td>
			</tr>
		</table>
	</form>
