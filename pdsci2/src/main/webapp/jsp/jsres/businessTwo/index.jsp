...
<head>
    ...
    <script>
        ...
        function searchUserListNew() {
            jboxLoad("content","<s:url value='/jsres/businessTwo/studentChangeMain'/>",true);
        }

        function searchTeaListNew() {
            jboxLoad("content","<s:url value='/jsres/businessTwo/teachChangeMain'/>",true);
        }

        function searchHospitalListNew() {
            jboxLoad("content","<s:url value='/jsres/businessTwo/hospitalChangeMain'/>?checkStatusId=Passing",true);
        }

        function searchSchoolListNew() {
            jboxLoad("content","<s:url value='/jsres/businessTwo/schoolChangeMain'/>?checkStatusId=Passing",true);
        }
            ...
            <div class="body">
                <div class="container">
                    <div class="content_side">
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_management"></i>权限配置管理
                            </dt>
                            <dd class="menu_item"><a onclick="searchUserListNew();">学员权限配置</a></dd>
                            <dd class="menu_item"><a onclick="searchTeaListNew();">带教权限配置</a></dd>
                            <dd class="menu_item"><a onclick="searchHospitalListNew();">医院权限配置</a></dd>
                            <dd class="menu_item"><a onclick="searchSchoolListNew();">高校权限配置</a></dd>
                            <dt class="menu_title">
