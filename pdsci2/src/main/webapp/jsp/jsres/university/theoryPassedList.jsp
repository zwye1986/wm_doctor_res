...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/jsres/doctorTheoryScore/searchTheoryPassedForUni'/>?" + data + "&roleFlag=${roleFlag}", $("#searchForm").serialize(), false);
    }
...
//        }
    ...
    function exportExcel(){
        var url = "<s:url value='/jsres/doctorTheoryScore/exportTheoryPassedForUni'/>?roleFlag=${roleFlag}";
        jboxTip("导出中…………");
        jboxExp($("#searchForm"),url);
    }
</script>
<div class="main_hd">
    <h2 class="underline">结业合格人员查询</h2>
</div>
    ...
    <div class="div_search">
        <form id="searchForm" style="margin-left: -30px;">
            ...
            <c:if test="${sessionScope.userListScope!=GlobalConstant.RES_ROLE_SCOPE_SCHOOL}">
                ...
                <div class="searchCss">
                    结业考核年份：
                    <input type="text" id="graduationYear" name="graduationYear" value="${empty param.graduationYear?year:param.graduationYear}"
                           class="input" readonly="readonly" style="width: 100px;margin-left: 0px" onchange="changeSelectYear();"/>
                </div>
            </c:if>
            <div class="searchCss">
            ...
            <div class="searchCss">
                理论成绩年份：
                <input type="text" id="theroyScoreYear" name="theroyScoreYear" value="${param.theroyScoreYear}"
                       class="input" readonly="readonly" style="width: 100px;margin-left: 0px;"/>
                <%--<select id="theroyScoreYear" class="select" name="theroyScoreYear" style="width: 106px">--%>
                    <%--<option value=""/>--%>
                <%--</select>--%>
                <%--理论合格--%>
                <input type="text" hidden="hidden" name="isHege" value="1"/>
            </div>
            <div class="searchCss">
                技能成绩年份：
                <input type="text" id="skillScoreYear" name="skillScoreYear" value="${param.skillScoreYear}"
                       class="input" readonly="readonly" style="width: 100px;margin-left: 0px;"/>
                <%--<select id="skillScoreYear" class="select" name="skillScoreYear" style="width: 106px">--%>
                    <%--<option value=""/>--%>
                <%--</select>--%>
                <%--技能合格--%>
                <input type="text" hidden="hidden" name="skillIsHege" value="1"/>
            </div>
            <div class="searchCss">
