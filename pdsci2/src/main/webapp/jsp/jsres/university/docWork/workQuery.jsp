...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/jsres/base/docWorkingForUni'/>",$("#searchForm").serialize(),false);
	}
...
<div class="main_hd">
	<h2 class="underline">医师工作量查询<font color="red" style="font-size:12px">（数据统计截至当前日期前一天）</font></h2>
</div>
