...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/jsres/universityMgr/universityAppNotUseList'/>",$("#searchForm").serialize(),false);
	}
	...
	function exportExcel(){
		...
		var url = "<s:url value='/jsres/universityMgr/universityExportExcel'/>";
		jboxTip("导出中…………");
