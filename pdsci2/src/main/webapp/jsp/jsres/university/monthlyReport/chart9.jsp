...
<div class="item-left1" style="padding-top: 20px;box-sizing: border-box; width:auto;" id="chart9-2">
    <div>
        <div>${resultMap['activitySum']}<span>次</span></div>
        <div>本月活动总量</div>
    </div>
    <div class="clearfix" style="margin-top: 20px;">
        <div class="item-left1" style="width:auto;height: auto;">
            <div>Top1</div>
            <div>${resultMap['dept1FinalList'][0].ACTIVITYSUM}次</div>
            <div>${resultMap['dept1FinalList'][0].ORG_NAME}
        ...
        <div class="item-right1" style="padding-left: 20px;">
            <div>Bottom1</div>
            <div>${resultMap['dept2FinalList'][0].ACTIVITYSUM}次</div>
            <div>${resultMap['dept2FinalList'][0].ORG_NAME}
