...
<script>
    $(function(){
        jboxLoad("content1","<s:url value='/jsres/monthlyReportNew/chart12'/>?monthDate=${monthDate}",false);
    })
    function chart12(){
        jboxLoad("content1","<s:url value='/jsres/monthlyReportNew/chart12'/>?monthDate=${monthDate}",false);
    }
    function chart3(){
        jboxLoad("content1","<s:url value='/jsres/monthlyReportNew/chart3'/>?monthDate=${monthDate}&trainingTypeId=DoctorTrainingSpe",false);
    }
</script>
