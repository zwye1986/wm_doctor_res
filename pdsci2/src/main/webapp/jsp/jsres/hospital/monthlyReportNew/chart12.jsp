...
<head>
  ...
  <script>
      function hospitalDoctorsNum(){
          var url="<s:url value='/jsres/monthlyReportNew/hospitalDoctorsNum'/>?monthDate=${param.monthDate}";
          jboxLoad("content1",url,false);
      }
      function exportChart1(){
          var url="<s:url value='/jsres/monthlyReportNew/exportChart1'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportChart2(){
          var url="<s:url value='/jsres/monthlyReportNew/exportChart2'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportDifference(obj){
          ...
          var url="<s:url value='/jsres/monthlyReportNew/exportDifference'/>?monthDate=${param.monthDate}&sessionNumber="+sessionNumber;
          window.open(url);
      }
      function exportReturn(){
          var url="<s:url value='/jsres/monthlyReportNew/exportReturn'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportDelay(){
          var url="<s:url value='/jsres/monthlyReportNew/exportDelay'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportBaseChange(){
          var url="<s:url value='/jsres/monthlyReportNew/exportBaseChange'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportSpeChange(){
          var url="<s:url value='/jsres/monthlyReportNew/exportSpeChange'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      function exportStatusChange(){
          var url="<s:url value='/jsres/monthlyReportNew/exportStatusChange'/>?monthDate=${param.monthDate}";
          window.open(url);
      }
      $("#tab a").on({
          mouseover:function(){
