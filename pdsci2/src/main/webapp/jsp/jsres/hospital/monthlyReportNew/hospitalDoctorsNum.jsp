...
<body>
  ...
  <script>
    ...
    function toPage(page) {
        ...
        var url="<s:url value='/jsres/monthlyReportNew/hospitalDoctorsNum'/>?monthDate=${param.monthDate}&currentPage="
      ...
      function exportHospitalDoctorsNum(){
          var sessionNumber = $("#sessionNumber").val();
          var orgFlow = $("#orgFlow").val();
          var url="<s:url value='/jsres/monthlyReportNew/exportHospitalDoctorsNum'/>?monthDate=${param.monthDate}"
      ...
      function exportHospitalDoctorsDetail(){
          var sessionNumber = $("#sessionNumber").val();
          var orgFlow = $("#orgFlow").val();
          var url="<s:url value='/jsres/monthlyReportNew/exportHospitalDoctorsDetail'/>?monthDate=${param.monthDate}"
              +"&sessionNumber="+sessionNumber+"&orgFlow="+orgFlow;
          window.open(url);
      }
  </script>
