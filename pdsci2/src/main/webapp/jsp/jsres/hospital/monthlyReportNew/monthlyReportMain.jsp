...
<script>
    $(function(){
        jboxLoad("content0","<s:url value='/jsres/monthlyReportNew/content0'/>?monthDate=${currentMonth}",false);
    })

    function content0(obj){
        var text = $(obj).text();
        var monthDate = text.substr(0,4)+"-"+text.substr(5,2);
        jboxLoad("content0","<s:url value='/jsres/monthlyReportNew/content0'/>?monthDate="+monthDate,false);
    }
</script>
</head>
<body>
