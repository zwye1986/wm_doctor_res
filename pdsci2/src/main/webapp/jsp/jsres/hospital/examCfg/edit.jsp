...
<script type="text/javascript">
	$(document).ready(function(){
        if(!"${ment.sessionNumber}"){
            $('#sessionNumber').attr("readonly",false);
            $('#sessionNumber').datetimepicker({
                startView: 4,
                maxView: 4,
                minView:4,
                format: 'yyyy',
			...
			<table border="0" cellpadding="0" cellspacing="0" class="base_info">
				<tbody>
					<tr>
						...
						<td style="width:15%;">
							<select style="width: 106px;margin-left: 4px;    margin-bottom: 0;" name="trainingSpeId" id="trainingSpeId"class="validate[required] select" onchange="changeSpeName(this)">
								<option value="">请选择</option>
							</select>
						</td>
						<th style="width:10%;"><font color="red">*</font>年&#12288;&#12288;级：</th>
						<td style="width:15%;">
							<input style="width: 100px;" type="text" id="sessionNumber" name="sessionNumber" value="${ment.sessionNumber }" class="validate[required] input" readonly="readonly"/>
						</td>
					</tr>
					<tr>
