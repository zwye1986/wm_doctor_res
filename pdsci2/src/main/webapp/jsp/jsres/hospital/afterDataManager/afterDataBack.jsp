...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/jsres/afterDataManager/afterDataBackList'/>?roleFlag=${roleFlag}&baseFlag=${param.baseFlag}",$("#searchForm").serialize(),true);
	}
...
<div>
	...
	<form id="searchForm">
		...
		<table class="searchTable" style="width: 100%;border-collapse:separate; border-spacing:0px 10px;">
			...
			<tr>
				<td colspan="8">
					&#12288;&#12288;2、恢复使用【出科数据删除】功能删除的学员某个排班记录
				</td>
			</tr>
			<tr>
				<td colspan="8">
					&#12288;&#12288;3、恢复使用【出科数据删除】功能删除某个排班记录的【出科考核表,临床操作技能评估（DOPS）量化表,迷你临床演练评估（Mini-CEX）量化表】
				</td>
			</tr>
		</table>
	</form>
