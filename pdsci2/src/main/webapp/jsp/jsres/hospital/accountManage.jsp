...
<%--                <tr>--%>
<%--                    <td>姓&#12288;名:</td>--%>
<%--                    <td><input type="text" class="input" name="userName" value="${param.userName}"--%>
<%--                               style="width:100px; margin:0px"/></td>--%>
<%--                    <td>手机号码：</td>--%>
<%--                    <td><input type="text" class="input" name="userPhone" value="${param.userPhone}"--%>
<%--                               style="width:100px; margin:0px"/>&#12288;--%>
<%--                    </td>--%>
<%--                    <td>证件号码：</td>--%>
<%--                    <td><input type="text" class="input" name="idNo" value="${param.idNo}"--%>
<%--                               style="width:100px;margin: 0 0"/>&#12288;--%>
<%--                    </td>--%>
<%--                    <td>注册帐号：</td>--%>
<%--                    <td><input type="text" class="input" name="userCode" value="${param.userCode}"--%>
<%--                               style="width:160px;"/>&#12288;--%>
<%--                    </td>--%>
<%--                </tr>--%>
<%--                <tr>--%>
...
<%--                    <td colspan="1"><input class="btn_green" type="button" onclick="toPage(1)" value="查&#12288;询"/>--%>
<%--                    </td>--%>
<%--                    <td colspan="1"><input class="btn_green" type="button" onclick="batchUnlock()" value="批量解锁"/>--%>
<%--                    </td>--%>
