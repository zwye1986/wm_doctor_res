   ...
   <%-- <link href="https://cdn.bootcss.com/bootstrap-table/1.11.1/bootstrap-table.css" rel="stylesheet">
    ...
    <script>
        ...
        function  toPage(page,search) {
            ...
            jboxStartLoading();
            jboxPostLoad("doctorListZi","<s:url value='/jsres/manage/appNotUseList'/>",$("#myOrgForm").serialize(),false);
        }
        function exportOutCheck() {
            ...
            var url = "<s:url value='/jsres/manage/exportExcelAppuse'/>";
            jboxTip("导出中…………");
        ...
        function single(index,value) {
            if($("input[name=check"+index+"]").is(':checked')){
                sessionStorage.setItem('check'+value,value);
            }else{
                sessionStorage.removeItem('check'+value);
            }
        }
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left;width: 21%">时间：
                                <input type="text" class="input" name="monthDate" id="ym1" onchange="datechange(this)"  value="${param.monthDate}" onClick="WdatePicker({dateFmt:'yyyy-MM',isShowClear:false,onpicked:function(dp){$dp.$('ym1').blur();}})" readonly="readonly"/>
                            </td>
