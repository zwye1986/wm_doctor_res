...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/jsres/doctorRecruit/schedulingAuditListAcc'/>", $("#searchForm").serialize(), false);
    }

    function toImport() {
        jboxOpen("<s:url value='/jsres/doctorRecruit/importSchedulingAuditExcelAcc'/>", "导入信息", 500, 220);
    }
    function checkTime() {
