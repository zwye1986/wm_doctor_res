...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,6);" itemId="7" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,12);" itemId="8" name="first" class="input"
        ...
        <tr style="height:32px">
            <th>骨髓增殖性肿瘤( 真性红细胞增多症、原发性骨髓纤维化、原发性血小板增多症)</th>
            <th colspan="2">有</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
