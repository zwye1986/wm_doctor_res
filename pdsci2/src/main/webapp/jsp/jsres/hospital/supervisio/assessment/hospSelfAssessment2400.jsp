            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (Number(allScore) >= 80 && Number(res) >= 13) {
                        assessmentResult = "合格";
                    } else if ((70 <= Number(allScore) && Number(allScore) < 80) && (10 <= Number(res) && Number(res)<= 12)) {
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——核医学科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td>
                高活性实验室、负荷试验室、核医学专科门诊诊室、放射性废物处理和排放系统、阅片室（PACS系统、图像分析和报告工作站、集体阅片系统）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                核医学科、放射科、超声科、病理科、肿瘤科、神经科、呼吸科、心内科、消化科、泌尿科、内分泌科、血液科、急诊科
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》核医学科专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_01',' 附件1');">附件1</a>
                ）
            </td>
            <td>
                现场查看
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,2,0);" itemId="4" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="5"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                符合《住院医师规范化培训基地标准（2022年版）》核医学科专业基地细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_02',' 附件2');">附件2</a>
                ）
            </td>
            <td>
                现场查看
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,5,0);" itemId="6"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                协同数量不应超过3个；协同培训的科室（含亚专业）不超过3个；在协同培训单位的轮转时间累计不超过6个月
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            <td rowspan="8">2.师资条件<br>（15分）</td>
            <td rowspan="5">2.1师资情况</td>
            <td>
                2.1.1指导医师与住院医师比例
            </td>
            <td>
                每名指导医师同时带教本专业住院医师不超过2名
            </td>
            <td>
                1.现场查看<br>
                2.访谈指导医师和住院医师
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主治医师专业技术职务3年及以上，从事核医学专业医疗、教学工作3年及以上
            </td>
            <td rowspan="3">
                检查人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章
            </td>
            <td>
                符合标准，得1分<br>
                有1名指导医师不符合要求，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师≥5人，各亚专业（专科）主任医师≥1人，副主任医师≥1人，主治医师≥3人
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事核医学专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                为每名住院医师配置1名固定的责任指导医师作为导师，负责住院医师在培训期间的全程指导
            </td>
            <td>
                1.现场查看<br>
                2.访谈责任导师和住院医师
        ...
        <tr style="height:50px">
            ...
            <td>
                指导医师上岗前需参加院级师资上岗培训，培训率100%，持有效期内师资证上岗，并不断接受教学能力提升的继续教育。近5年内，每个专业基地负责人、教学主任、教学秘书和每个轮转科室1名以上骨干指导医师经过省级及以上的师资培训
            </td>
            <td>
                1.现场查看<br>
                2.访谈指导医师
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="13" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="14" name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="15">3.过程管理<br>（35分）</td>
            <td rowspan="5">3.1培训制度与落实</td>
            <td>
                3.1.1专业基地负责人
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="17" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="18" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="19" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>3.2.1培训容量及招收★</td>
            <td>
                容量测算科学合理，完成招收任务，且在培住院医师≥6名，不能超容量招收
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
            ...
            <td>
                招收在容量测算数内，完成招收任务，且在培住院医师≥6名，得2分<br>
                容量测算科学合理，近三年未完成招收任务，但在培住院医师≥6名，得1分<br>
                在培住院医师＜6名，或超容量招收，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                1.按指南要求规范组织实施入专业基地教育，得2分；未组织或组织实施不规范，不得分<br>
                2.按指南要求规范组织实施入轮转科室教育，得2分；未组织或组织实施不规范，不得分
            </td>

            <td style="text-align: center;">4</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="22"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.3.5临床文献研读</td>
            <td>
                3年培训期间，阅读相关专业外语书刊和教科书；阅读公开发表的专业文献并完成文摘总结或读书报告6篇以上，培训期间至少完成文献综述、临床病例总结各2篇
            </td>
            <td>
                完成篇数达标，且认真规范，得2分<br>
                完成篇数达标，但不认真规范，得1分<br>
                未完成或不达标，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>3.5.1培训工作量★</td>
            <td>
                轮转期间每名住院医师每个工作日至少完成单光子显像诊断报告15份，或正电子显像诊断报告2份；<br>
                每周至少完成体外分析检查20例、功能测定检查1例、核素治疗1例、医疗仪器操作(含单光子和正电子显像)15例、图像处理(含图像融合与重建等)15例
            </td>
            <td>
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈各类住院医师各1～2名
            </td>
            <td>
                独立技能操作和诊断报告种类及数量达要求，得满分<br>
                独立技能操作和诊断报告≥规定数的80%，得3分<br>
                独立技能操作和诊断报告≥规定数的60%，得1分<br>
                ＜60%，或未安排独立操作及报告，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="30"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="7">4.质量控制<br>（35分）</td>
            <td rowspan="3">4.1指导教师教学质量</td>
            <td>4.1.1教学阅片质量★</td>
            <td>
                能够针对住院医师开展规范的临床教学阅片会，悉心指导住院医师
            </td>
            <td>
                随机抽查1～2名指导医师临床教学阅片
            </td>
            <td>
                教学读片评分表，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_03',' 附件3');">附件3</a>
                <br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,6,0);" itemId="31"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.1.2小讲课质量★</td>
            <td>
                能够针对住院医师开展规范的临床小讲课，悉心指导住院医师
            </td>
            <td>
                查看住院医师临床小讲课相关过程资料，如需求调查记录、课程表、签到表、课件、课后效果评价记录等
            </td>
            <td>
                临床小讲课评分表，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_04',' 附件4');">附件4</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,6,0);" itemId="32"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.1.3技能操作带教质量★</td>
            <td>
                能够针对住院医师开展规范的临床技能操作，悉心指导住院医师
            </td>
            <td>
                查看住院医师临床技能操作相关过程资料，如需求调查记录、课程表、签到表、课件、课后效果评价记录等
            </td>
            <td>
                临床技能操作带教质量评分表，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_05',' 附件5');">附件5</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao5" onchange="saveScore4Expert(this,6,0);" itemId="33"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="4">4.2住院医师学习效果</td>
            <td>4.2.1报告书写★</td>
            <td>
                考察住院医师的如下能力：影像诊断相关信息的提取分析及临床思维能力；书面表达能力，规范影像诊断报告书写
            </td>
            <td>
                随机抽查1～2名住院医师，在PACS中抽取既往书写的影像诊断报告1份，同时抽取当日的影像检查1例并进行现场报告书写
            </td>
            <td>
                诊断报告书写考核评分表，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_06',' 附件6');">附件6</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao6" onchange="saveScore4Expert(this,6,0);" itemId="34" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2400_07',' 附件7');">附件7</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao7" onchange="saveScore4Expert(this,6);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加结业理论考核的通过率≥近三年全国本专业住院医师首次参加结业理论考核平均通过率，得3分；低于近三年全国本专业住院医师首次参加结业理论考核平均通过率，每降低1个百分点，扣1分，扣完为止<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="37" name="local" class="input"
            ...
            <td colspan="10">
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="38" name="reason"
                              placeholder="存在问题请详细填写。" style="width: 100%;height: 100px;"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1一级指标4项，二级指标11项，三级指标37项。三级指标中，核心指标16项、计60分，一般指标21项、计40分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥13个<br>
        基本合格：70分≤评估分值＜80分，且10个≤核心指标达标数≤12个<br>
        限期整改(黄牌)：60分≤评估分值＜70分；或基本条件合格，6个≤核心指标达标数≤9个；或在培住院医师总数近3年达不到专业基地最小培训容量要求的；未制定轮转计划或未严格落实的；结业理论考核通过率处于全省末位者。<br>
