...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">口腔病理科住院医师临床实践能力考核评分表</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            <th rowspan="3">镜下描述</th>
            <td colspan="2">组织结构描述正确</td>
            <td style="text-align: center">5</td>
            <td rowspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="1" name="first" class="input" type="text" value="${scoreMap['1']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['1']}
                </c:if>
        ...
        <tr style="height:32px">
            <td colspan="2">病变描述无遗漏</td>
            <td style="text-align: center">10</td>
        </tr>
        <tr style="height:32px">
            <td colspan="2">叙述符合诊断要求</td>
            <td style="text-align: center">5</td>
        </tr>

        <tr style="height:32px">
            <th rowspan="4">病理诊断</th>
            <td colspan="2">诊断方向正确</td>
            <td style="text-align: center">10</td>
            <td rowspan="4" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,50);" itemId="2" name="first" class="input" type="text" value="${scoreMap['2']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['2']}
                </c:if>
        ...
        <tr style="height:32px">
            <td colspan="2">诊断经过叙述清晰、有条理，且无遗漏</td>
            <td style="text-align: center">10</td>
        </tr>
        <tr style="height:32px">
            <td colspan="2">诊断正确</td>
            <td style="text-align: center">20</td>
        </tr>
        <tr style="height:32px">
            <td colspan="2">鉴别诊断</td>
            <td style="text-align: center">10</td>
        </tr>

        <tr style="height:32px">
            <th rowspan="3">辅助检查</th>
            <td colspan="2">特殊染色符合病例要求</td>
            <td style="text-align: center">5</td>
            <td rowspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="3" name="first" class="input" type="text" value="${scoreMap['3']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['3']}
                </c:if>
        ...
        <tr style="height:32px">
            <td colspan="2">免疫组化符合病例要求</td>
            <td style="text-align: center">10</td>
        </tr>
        <tr style="height:32px">
            <td colspan="2">其他检查符合病例要求</td>
            <td style="text-align: center">5</td>
        </tr>

        <tr style="height:32px">
            <th>基础知识</th>
            <td colspan="2">全面掌握病变相关基础知识</td>
            <td style="text-align: center">10</td>
