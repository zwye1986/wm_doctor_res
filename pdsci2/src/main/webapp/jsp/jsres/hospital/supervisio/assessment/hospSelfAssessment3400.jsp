...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔颌面影像科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="2" itemName="年检查例数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="2" itemName="年检查例数" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="3" itemName="日检查例数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="3" itemName="日检查例数" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                牙体牙髓科、牙周科、儿童口腔科、口<br>
                腔预防科、口腔颌面外科、口腔修复科<br>
                、口腔正畸科、口腔种植科、口腔病理<br>
                科
            </td>
            <td width="20%">
        ...
        <tr style="height:50px">
            ...
            <td>
                牙体牙髓科、口腔颌面外科、牙周科、<br>
                口腔修复科、口腔颌面影像科、口腔预<br>
                防科、医学影像科、口腔颌面外科病房<br>
                、口腔病理科、口腔急诊、口腔颌面影<br>
                像科、机动
            </td>
            <td width="20%">
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                ...
                训内容与标准（2022年版）》口腔颌面<br>
                影像科培训细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3400_01',' 附件1');">附件1
                </a>）
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3,0);" itemId="7" itemName="技能操作种类及数量" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                具有口腔医学本科及以上学历，主治医<br>
                师及以上专业技术职务，从事口腔颌面<br>
                影像专业临床、教学工作5年及以上，并<br>
                符合总则中规定的指导医师条件。
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师≥3名，具有高级专业<br>
                技术职务人员≥30%，高级专业技术职务<br>
                人员≥2名，正高级专业技术职务人员≥<br>
                1名
            </td>
            <td>
                达到标准，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3400_02',' 附件2');">附件2</a>
                    <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                临床病例分析考核评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3400_03',' 附件3');">附件3</a>
                    <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3400_04',' 附件4');">附件4</a>
                    <br>
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标40项。三级指标中，核心指标18项、计65分，一般指标22项、计35分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。
        <br> 合格：评估分值≥80分，且核心指标达标数≥14个 <br>
