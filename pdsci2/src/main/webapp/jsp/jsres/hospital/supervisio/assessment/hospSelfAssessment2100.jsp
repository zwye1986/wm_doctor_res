...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——检验医学科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="11">1.基本条件<br>（15分）</td>
            <td rowspan="10">1.1专业基地相关医疗和设备条件</td>
            <td>
                1.1.1总床位数
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                检验医学亚专业设置，包括临床血液体液学专业、临床生物化学专业、临床免疫学专业、临床微生物学专业、临床细胞分子遗传学专业
            </td>
            <td>
                现场查看
            </td>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="4" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》检验医学科专业培训细则的要求(详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_01',' 附件1');">附件1</a>
                和
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_02',' 附件2');">附件2</a>)
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao1" onchange="saveScore4Expert(this,2,0);" itemId="6"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,3,0);" itemId="7" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                满足《住院医师规范化培训基地标准(2022年版)》检验医学科专业基地细则的要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_03',' 附件3');">附件3</a>）
            </td>
            <td>
                现场查看
            </td>
            <td>
                符合要求（不含协同单位相关数据），得2分<br>
                ≥规定数量的85%，得1分<br>
                ＜规定数量的85%，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,2,0);" itemId="8" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                满足《住院医师规范化培训基地标准（2022年版）》检验医学科专业基地细则的要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_04',' 附件4');">附件4</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,1);" itemId="9" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                应有示教室、数字投影设备、中英文电子期刊全文数据库和检索平台
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="12" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历，主治医师（或主管技师）专业技术职务3年及以上，从事检验医学科工作5年及以上，并从事所指导相关亚专业一定时间，如临床血液体液专业4年及以上、生化免疫专业3年及以上、微生物专业5年及以上、临床细胞分子遗传学专业3年及以上
            </td>
            <td rowspan="3">
        ...
        <tr style="height:50px">
            ...
            <td>
                专业基地应保有在职指导医师 6名及以上，其中主任医师、副主任医师专业技术职务达10%以上
            </td>
            <td>
                符合标准，得1分<br>
                只要有1个亚专业不达标，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历，主任医师专业技术职务，从事检验医学科工作10年以上；具有充足的教学及管理时间，具有教学经历
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                评价方案全面，原始记录详实，有落实、评价结果分析运用、改进，得3分<br>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="23"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.1.6轮转管理★</td>
            <td>
                有轮转管理文件，包括轮转计划、实施、评价考核、轮转记录等等内容
            </td>
            <td>
                有，且严格落实，得3分<br>
                有，未严格落实，得2分<br>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="26"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                1.有实施细则，得1分<br>
                2.考核内容齐全，并体现专业特点和岗位胜任力、分层递进，得2分<br>
                3.考核形式规范，资料齐全，有专业基地教学小组审核和组长签字，得1分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>3.5.1管理床位数</td>
            <td>
                病房工作期间每名住院医师日管理床位数2～5张；管理患者数量：心内科≥13例，消化内科≥13例，呼吸内科≥10例，肾内科≥10例，内分泌科≥10例，血液内科≥7例
            </td>
            <td>
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈各类住院医师各1～2名
            </td>
            <td>
                管理床位数（或管理患者数）达标，且认真规范，得2分<br>
                数量达标，但不认真规范，得1分<br>
                不达标，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="8">4.培训质量<br>（35分）</td>
            <td rowspan="3">4.1指导医师教学质量</td>
            <td>4.1.1教学阅片质量★</td>
            <td>
                应制订教学阅片计划；教案撰写与审核（尤其是首次主持教学阅片的指导医师）；实施程序； 接受上级管理部门的督导评估（应有评价表和评分表）
            </td>
            <td>
                随机抽查1～2名指导医师的带教情况，查看其教学质量
            </td>
            <td>
                教学阅片评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_05',' 附件5');">附件5</a>
                <br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao5" onchange="saveScore4Expert(this,6,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.1.2教学病例讨论质量</td>
            <td>
                应制订教学病例讨论计划；教案撰写与审核；实施程序；接受上级管理部门的督导评估（应有评价表和评分表）
            </td>
            <td>
                随机抽查1～2名指导医师的带教情况，查看课表、教案、评分表等实施情况
            </td>
            <td>
                有计划、教案、评分表和评价表，且严格落实，得3分<br>
                有计划、教案、评分表和评价表，未严格落实，得2分<br>
                有计划、教案，无评分表和评价表，得1分<br>
                有计划、教案，无评分表和评价表，且未严格落实，得0.5分<br>
                无相应教学活动，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                随机抽查1～2名指导医师指导住院医师的记录
            </td>
            <td>
                1.住院医师操作前进行有效的交流，得1分<br>
                2.住院医师操作中出现错误，应予以及时纠正，得2分<br>
                3.住院医师操作结束后提问，得1分<br>
                4.对住院医师的操作采用合适的反馈方式进行总体评价，如有必要进行适当示范，得1分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>4.2.1报告审核★</td>
            <td>
                住院医师应在指导医师指导下进行报告单的审核
            </td>
            <td>
                随机抽查1～2名住院医师，在Lis中抽取既往审核的报告单3～5份，同时抽取当日报告单3～5份进行现场审核
            </td>
            <td>
                审核报告正确率≥95%，得4分<br>
                90%≤审核报告正确率＜95%，得3分<br>
                80%≤审核报告正确率＜90%，得2分<br>
                审核报告正确率＜80%或未审核报告单，不得分
            </td>

            <td style="text-align: center;">4</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="39" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2100_06',' 附件6');">附件6</a>
                <br>
                评估分值≥45分，得7分；40分≤评估分值＜45分，得5分；35分≤评估分值＜40分，得4分；30分≤评估分值＜35分，得2分；评估分值＜30分，不得分
            </td>

            <td style="text-align: center;">7</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao6" onchange="saveScore4Expert(this,7,0);" itemId="40" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.3技能操作完成情况（数量）</td>
            <td>
                指导住院医师完成技能操作的数量
            </td>
            <td>
                随机抽查1～2名住院医师（二年级以上）的培训记录，查看技能操作的完成数量
            </td>
            <td>
                完成率≥95%，得3分<br>
                90分≤完成率＜95%，得2分<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="41" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标43项。三级指标中，核心指标18项、计60分，一般指标25项、计40分，共100分。单个核心指标达标判定标准 ：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
