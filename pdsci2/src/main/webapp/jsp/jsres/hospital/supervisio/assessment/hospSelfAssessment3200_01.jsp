...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">口腔正畸科疾病种类及年诊治数量</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            ...
            <th>
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['sjzyw']}" itemId="sjzyw" class="input" type="text" style=" text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['sjzyw']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <th>
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['sjnmzl']}" itemId="sjnmzl" class="input" type="text" style=" text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['sjnmzl']}
                </c:if>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,1000);" itemId="2" name="first" class="input"
