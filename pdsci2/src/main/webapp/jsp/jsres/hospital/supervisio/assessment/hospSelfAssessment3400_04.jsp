...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">口腔颌面影像科住院医师临床技能操作考核评分表</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            <th rowspan="5">技术操作规范性</th>
            <td>规范</td>
            <td style="text-align: center">15</td>
            <td rowspan="5" style="text-align: center">15</td>
            <td rowspan="5" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="6" name="first" class="input" type="text" value="${scoreMap['6']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['6']}
                </c:if>
        ...
        <tr style="height:32px">
            <th rowspan="5">影像质量</th>
            <td>良好</td>
            <td style="text-align: center">15</td>
            <td rowspan="5" style="text-align: center">15</td>
            <td rowspan="5" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="8" name="first" class="input" type="text" value="${scoreMap['8']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['8']}
                </c:if>
