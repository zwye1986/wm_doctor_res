                ...
                <tr class="fixTrTd">
                    ...
                    <td>
                        <c:if test="${nowTime < s.startTime}">
                            <a class="btn_green" href="javascript:void(0);"style="color: white" onclick="addSub('edit','${s.recordFlow}');">修改</a>
                        </c:if>
                        <c:if test="${nowTime >= s.startTime  and nowTime <=s.endTime}">
                            <a class="btn_green" href="javascript:void(0);"style="color: white" onclick="assInfo('${s.recordFlow}','Y');">评分</a>
                        </c:if>
                        <c:if test="${nowTime > s.endTime}">
                            <a class="btn_green" href="javascript:void(0);"style="color: white" onclick="assInfo('${s.recordFlow}','N');">查看</a>
                        </c:if>
                    </td>
                </tr>
            </c:forEach>
