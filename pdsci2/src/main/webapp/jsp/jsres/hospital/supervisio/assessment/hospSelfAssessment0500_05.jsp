...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">精神科住院医师噎食处理考核评分表</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr style="height:32px;">
            ...
            <th colspan="2" style="width: 55%">考核内容</th>
            <th style="width: 15%">分值</th>
            <th style="width: 15%">得分</th>
        </tr>
        <tr>
            <th rowspan="4">一、临床常规预防 <br>（20分）</th>
            <td colspan="2">医护人员平素需观察病人进餐</td>
        ...
        <tr >
            <td rowspan="3" style="width: 15%;">高危人群</td>
            <td style="width: 30%;">已有EPS等相关药物不良反应</td>
        ...
        <tr >
            <th rowspan="4">二、发现噎食 <br>（20分）</th>
            <td colspan="2">评估意识</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr >
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="11" name="first" class="input" type="text" value="${scoreMap['11']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['11']}
                </c:if>
