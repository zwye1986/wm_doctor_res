...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——外科（胸心外科方向）（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            <td rowspan="11">1.基本条件<br>（15分）</td>
            <td rowspan="10">1.1专业基地相关<br>医疗和设备条件</td>
            <td>1.1.1总床位数</td>
            <td>三级甲等综合医院外科床位总数≥200张</td>
            <td>
                现场查看
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>胸心外科总床位≥40张，使用率≥85%，平均住院日≤15天
            </td>
            <td>
                符合标准，得1分<br>
                不达标准，不得分
        ...
        <tr style="height:50px">
            ...
            <td>必备科室:普通外科、骨科、泌尿外科、麻醉科、外科重症监护治疗
                室(SICU)、外科实验室</td>
            <td>现场查看</td>
            <td>
                满足要求，得1分<br>
        ...
        <tr style="height:50px">
            ...
            <td>普通外科、骨科、泌尿外科、胸心外科、 神经外科、 麻醉科、外
                科重症监护室</td>
            <td>1.现场查看
                2.访谈住院医师</td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准（2022年版）》和《住院医师
                规范化培训内容与标准（2022年版）》外科（胸心外科方向）专业
                细则要求（见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1100_01','附件1');">附件1</a>）</td>
            <td>
                现场查看
            </td>
            <td>
                1.专业基地的疾病种类及数量符合标准要求，或疾
                病种类及数量≥规定数的75%，且有符合要求的协
                同单位，总疾病种类及数量符合标准要求，得满分
        ...
        <tr style="height:50px">
            ...
            <td>专业基地的临床技能操作种类及数量符合标准要求，得满分，否则，不得分</td>
        ...
        <tr style="height:50px">
            ...
            <td>X线机、数字减影血管造影机(DSA)、CT、MR、放射治疗机、彩色B超
                (带Doppler等探头)、血液、生化、免疫、尿液检验设备、肺功能仪
                、呼吸机、胃镜、结肠镜、心血管介入、肝胆介入治疗设备、层流
                手术间、麻醉机、腹腔镜、胆道镜、手术显微镜、关节镜、C形臂、
                膀胱镜、输尿管镜、经皮肾镜等
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>1.支气管镜≥1台
                2.胸腔镜、开胸手术器械至少各2套
                3.多导监护仪、氧饱和度监测仪、指测血糖仪、输液泵、微量泵至
                少各5台
                4.体外循环机≥1台</td>
            <td>
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="91"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>协同单位数量不超过3家，协同培训的科室（含亚专业）不超过
                3个，在协同培训单位的轮转时间累计不超过6个月
            </td>
            <td>
                现场查看
            </td>
            <td>
                完全符合要求，得2分
                1项不符合要求，不得分
                协同单位存在独立招收、独立培训住院医师的，此
                处不得分，撤销培训基地资格
                专业基地自身基本条件符合标准要求，无协同单
                位，此处不失分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>医学本科及以上学历，主治医师专业技术职务3年以上，从事本专业
                工作5年及以上
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计表，包括姓名、毕业时
                间、毕业学校、学历学位、专业技术职务、专业技术职务
                任职时间、工作时间，需加盖人事部门公章
            </td>
            <td>
                符合条件，得1分
        ...
        <tr style="height:50px">
            ...
            <td>保有在职指导医师≥6人，各亚专业（专科）有主任医师≥1人，副
                主任医师≥1人，主治医师≥4人
            </td>
            <td>
                符合标准，得1分
        ...
        <tr style="height:50px">
            ...
            <td>医学本科及以上学历，主任医师专业技术职务，从事外科专业的医
                疗、科研和教学工作超过15年，具有丰富的教学管理工作经验
            </td>
            <td>
                符合标准，得1分
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>为每名住院医师配置1名固定的责任指导医师作为导师，负责住院医
                师在培训期间的全程指导
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>指导医师上岗前需参加院级师资上岗培训，培训率100%，持有效期
                内师资证上岗，并不断接受教学能力提升的继续教育。近5年内，每
                个专业基地负责人、教学主任、教学秘书和每个轮转科室1名以上骨
                干指导医师经过省级及以上的师资培训
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            <td>2.2.3激励制度★</td>
            <td>建立带教活动绩效管理制度，将带教活动与专业基地绩效考核挂
                钩，并在科室二次分配中将专业基地负责人、教学主任、教学秘书
                的教学管理活动和指导医师的带教活动，纳入个人绩效考核的重要
                指标范围
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="14">3.培训管理（35分）</td>
            <td rowspan="5">3.1制度与落实</td>
            <td>
                3.1.1专业基地负责人
            </td>
            <td>实行专业基地负责人负责制，负责协调本专业和相关专业的教学资
                源,加强对教学与培训人员的组织管理,整体把控培训质量,对本专业
                基地(含协同单位)的培训质量承担主要责任，并切实落实
            </td>
            <td rowspan="4">
                1.现场查看
                2.访谈专业基地管理人员、指导医
        ...
        <tr style="height:50px">
            ...
            <td>设置教学主任岗位，负责本专业住院医师的轮转计划制订;负责本专
                业培训的全过程管理;定期检查评价住院医师的培训质量 和指导医
                师的带教质量等
            </td>
            <td>
                职责明确，履职认真，得2分
        ...
        <tr style="height:50px">
            ...
            <td>设置教学秘书岗位，协助专业基地负责人、教学主任开展培训与教
                学工作。执行专业基地负责人、教学主任布置的各项培训工作任务, 督促指导医师积极落实带教任务等。
            </td>
            <td>
                有教学秘书，履职认真，得2分
                无教学秘书，或履职不认真，不得分
        ...
        <tr style="height:50px">
            ...
            <td>成立教学小组，组成合理、职责明确，切实履职能定期进行带教指
                导、指导医师培训、教学培训实施和考核、质量监管以及教学研究
                等工作
            </td>
            <td>
                有教学小组，履职认真，得3分
        ...
        <tr style="height:50px">
            ...
            <td>按规定制定和落实轮转计划和要求，体现分层递进的培训理念
            </td>
            <td>
                1.现场核查在培住院医师轮转情况
        ...
        <tr style="height:50px">
            ...
            <td>容量测算科学合理，完成招收任务，且在培住院医师≥10名，不能
                超容量招收
            </td>
            <td>
                1.现场查看
            ...
            <td>
                招收在容量测算数内，完成招收任务，且在培住院
                医师≥10名，得3分
                容量测算科学合理，近三年未完成招收任务，但在
                培住院医师≥10名，得1分
        ...
        <tr style="height:50px">
            ...
            <td>规范开展入专业基地教育，包括学科背景、规章制度及流程、专业
                基地培训目标、培训内容和轮转计划、轮转期间所需掌握的临床诊
                疗能力、技能操作等内容，并有专人组织实施
                规范开展入轮转科室教育，包括科室情况、科室纪律、培养计划与
                要求、医德医风、医患沟通等内容的入科教育，培训与考核要求体
                现科室岗位基本需求特点，并有专人组织实施
            </td>
            <td rowspan="4">
                1.现场查看教学活动落实情况
                2.访谈专业基地管理人员、指导医师和住院医师
            ...
            <td>
                1.按指南要求规范组织实施入专业基地教育，得1 分；未组织或组织实施不规范，不得分
                2.按指南要求规范组织实施入轮转科室教育，得1 分；未组织或组织实施不规范，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="27" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="29" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>3.4.1日常考核</td>
            <td>包括医德医风、临床职业素养、考勤、临床实践能力、培训指标完
                成情况和参加业务学习情况，以及形成性评价开展情况等内容，相
                关记录等原始资料齐全，真实规范
            </td>
            <td rowspan="3">
                1.现场查看过程考核落实情况
        ...
        <tr style="height:50px">
            <td>3.4.2出科考核★</td>
            <td>
                有出科考核实施细则；考核内容包括理论与技能，体现专业特点和
                岗位胜任、分层递进的培训理念；出科考核形式规范，原始资料齐
                全，专业基地教学小组审核和组长签字
            </td>
            <td>
                1.有实施细则，得1分
                2.考核内容齐全，并体现专业特点和岗位胜任力、
                分层递进，得1.5分
                3.考核形式规范，资料齐全，有专业基地教学小组
                审核和组长签字，得0.5分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>有符合本专业的年度考核实施细则，内容包括个人总结、理论知识
                、实践技能、综合评价等，能真实全面反映年度培训情况，体现专
                业特点和分层递进的培训要求
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>病房工作期间每名住院医师日管理床位≥5张(在带教医师指导下独
                立于其他住院医师管理床位)
            </td>
            <td>
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈
                各类住院医师各1～2名
            </td>
            <td>
                管床数（或管理患者数）达到要求，得2分
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1100_02','附件2');">附件2</a>
                <br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>指导医师协助并指导住院医师完成技能操作或手术，带教严格规范
            </td>
            <td>
                随机抽查1～2名指导医师指导住院医师（二年级以上）进
                行技能操作或手术情况
            </td>
            <td>
                1.住院医师操作前进行有效的交流，并与患者沟通
                核实，得1分；
                2.住院医师操作中应如遇重大医疗安全隐患或将造
                成患者较大伤害的，应予以及时制止与纠正，得1 分；
                3.住院医师操作结束后提问，得1分；
                4.对住院医师的操作采用合适的反馈方式进行总体
                评价，如有必要进行适当示范，得2分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1100_03','附件3');">附件3</a> <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>住院医师技能操作或手术情况</td>
            <td>随机抽查1～2名二年级以上住院医师进行技能操作或常见
                手术操作（术者、助手），查看其掌握情况
            </td>
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1100_04','附件4');">附件4</a>
                <br>
                评估分值≥90分，得7分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得4分； <br>
        ...
        <tr style="height:50px">
            ...
            <td>每个轮转科室均按照《住院医师规范化培训内容与标准（2022年
                版）》本专业培训细则要求执行，为每名住院医师安排并完成规定
                的技能操作和手术</td>
            <td>
                随机抽查5～10名住院医师，由评估专家根据本专业实际
                需求确定手术或技能操作项目，查看技能操作或手术记
                录，掌握岗位胜任力的实际情况
            </td>
            <td>
                完成率≥95%，得6分
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加执业医师资格考试
                的通过率≥近三年全国本专业住院医师首次参加执
                业医师资格考试的平均通过率，得2分；低于近三
                年全国本专业住院医师首次参加执业医师资格考试
                的平均通过率5个百分点，得1分，其他情况不得分
                （近三年本专业住院医师首次参加执业医师资格考
                试的通过率=近三年本专业首次参加考试通过的人
                数/近三年本专业首次参加考试总人数）
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加结业理论考核的通
                过率≥近三年全国本专业住院医师首次参加结业理
                论考核平均通过率，得3分；低于近三年全国本专
                业住院医师首次参加结业理论考核平均通过率，每
                降低1个百分点，扣1分，扣完为止
                （近三年本专业住院医师首次参加结业理论考核的
                通过率=近三年本专业首次参加结业理论考核通过
                的人数/近三年本专业首次参加结业理论考核总人
                数）
            </td>
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1..一级指标4项，二级指标11项，三级指标40项。三级指标中，核心指标17项、计64分，一般指标23项、计36分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
