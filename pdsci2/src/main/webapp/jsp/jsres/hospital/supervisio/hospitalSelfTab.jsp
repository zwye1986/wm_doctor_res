...
<script type="text/javascript">
	...
	function hospMant(tabTag){
		if("manage"==tabTag)
		{
            ...
            jboxLoad("mainDiv","<s:url value='/jsres/supervisio/hospitalSelfAssessment'/>",true);
		}else{
    ...
    function search() {
        jboxStartLoading();
        jboxPostLoad("mainDiv","<s:url value='/jsres/supervisio/userSignAssessment'/>",$("#searchForm").serialize(),false);
    }
</script>
...
<div class="main_hd">
    ...
    <div class="title_tab">
        <ul id="reducationTab">
            <li id="manage" class="tab" onclick="hospMant('manage');"><a>医院基地自评</a></li>
