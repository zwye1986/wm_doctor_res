...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——骨科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td>
                创伤骨科≥10张；关节外科≥10张；脊柱外科≥10张；运动医学科≥5张
            </td>
            <td rowspan="2">
                检查相关统计报表复印件，需加盖医院公章
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                必备科室:普通外科、胸外科或神经外科、麻醉科、外科重症监护治疗室(SICU) 、康复科、门诊部、急诊科、内科、中心手术室<br>
                辅助科室：放射(影像)科、病理科、细菌室、生化实验室、血库、外科实验室、动物实验室
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                普通外科(包括门、急诊)、骨科(包括门、急诊)、胸心外科、神经外科、麻醉科、外科重症监护室、放射影像科
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》骨科专业细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1400_01','附件1');">附件1</a>）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                X线机、CT、MR、彩色B超(带Doppler等探头)；层流手术间、氧饱和度监测仪、多导监护仪；血液、生化、免疫、尿液检验设备；麻醉机
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                手术显微镜，关节镜及其配套影像、动力、射频系统，C臂系统，具备闭路电视转播系统的手术间1～2间
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                指导医师应具有医学本科及以上学历，主治医师专业技术职务3年及以上，从事本专业医疗和教学工作5年及以上
            </td>
            <td rowspan="3">
        ...
        <tr style="height:50px">
            ...
            <td>
                应保有在职指导医师10名及以上，各亚专业（专科）有主任医师≥1人，副主任医师≥1人，主治医师≥1人
            </td>
            <td>
                符合标准，得1分<br>
                只要有1个亚专业不达标，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                具有本科及以上学历,高级专业技术职务,从事本专业的医疗、教学工作超过15年
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                教学绩效考核不低于考核总分的 8%，考核结果与专业技术职务晋升挂钩 ，得4分<br>
                教学绩效考核占考核总分的 5%～8%之间，得2分<br>
                教学绩效考核占考核总分低于 5%或不纳入，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>3.5.1管理床位数★</td>
            <td>
                病房工作期间每名住院医师日管理床位≥4张(在指导医师指导下独立于其他住院医师管理床位)
            </td>
            <td rowspan="2">
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈各类住院医师各1～2名
            </td>
            <td>
                管床数（或管理患者数）达到规定数要求，得3分<br>
                日管床数≥规定数50%，得1分<br>
                日管床数＜规定数50%或未安排，不得分
            </td>
        ...
        <tr style="height:50px">
            <td>3.5.2门急诊工作量</td>
            <td>
                门诊：每名住院医师门诊工作期间日诊治患者≥30人次<br>
                急诊：每名住院医师急诊工作期间日诊治患者≥10人次
            </td>
            <td>
                门急诊工作量达到要求，得3分<br>
                门急诊量≥规定数80%，得2分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1400_02','附件2');">附件2</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1400_03','附件3');">附件3</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,6,0);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1400_04','附件4');">附件4</a><br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,7,0);" itemId="38" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                按照骨科专业《住院医师规范化培训内容与标准（2022年版）》骨科培训细则，核实技能操作和手术的完成情况
            </td>
            <td>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="39" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标41项。三级指标中，核心指标17项、计64分，一般指标24项、计36分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥14个<br>
        基本合格：70分≤评估分值＜80分，且10个≤核心指标达标数≤13个<br>
        限期整改(黄牌)：60分≤评估分值＜70分；或基本条件合格，7个≤核心指标达标数≤9个；或在培住院医师总数近 3年达不到专业基地最小培训容量要求的；未制定轮转计划或未严格落实的；结业理论考核通过率处于全省末位者。<br>
