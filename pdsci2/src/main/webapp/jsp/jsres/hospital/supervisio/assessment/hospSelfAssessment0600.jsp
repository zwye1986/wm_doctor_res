...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——神经内科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td>应具备相关科室15个以上，包括神经外科、呼
                吸科、心血管内科、内分泌科、康复科、儿科
                、皮肤科、医学影像科、病理科、检验科等</td>
            <td>现场查看</td>
            <td>
                满足要求，得1分<br>
                缺1项，不得分
        ...
        <tr style="height:50px">
            ...
            <td>神经内科、呼吸内科、心血管内科、内分泌科
                、神经外科、医学影像科、精神科(或神经心理
                科) 、急诊科等</td>
            <td>1.现场查看
                2.访谈住院医师</td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准（2022年
                版）》和《住院医师规范化培训内容与标准
                （2022年版）》神经内科专业细则的要求（详
                见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_01','附件1');">附件1</a>）</td>
            <td>
                现场查看
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>符合《住院医师规范化培训基地标准（2022年
                版）》神经内科专业基地细则的要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_02','附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb2" onchange="saveScore4Expert(this,0.5);" itemId="9"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,0.5);" itemId="91"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>协同单位数量不超过3家，协同培训的科室（含
                亚专业）不超过3个，在协同培训单位的轮转时
                间累计不超过6个月
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>专业基地应保有在职指导医师7人及以上,其中
                主任医师专业技术职务不少于2名、副主任医师
                专业技术职务不少于2名、主治医师专业技术职
                务不少于3名(技术职务级别高的指导医师可以
                替代技术职务级别低的指导医师)
            </td>
            <td>
                符合标准，得1分
        ...
        <tr style="height:50px">
            ...
            <td>医学本科及以上学历，主任医师专业技术职
                务，从事本专业的医疗、科研和教学工作超过
                15年
            </td>
            <td>
                符合标准，得1分
        ...
        <tr style="height:50px">
            ...
            <td>为每名住院医师配置1名固定的责任指导医师作
                为导师，负责住院医师在培训期间的全程指导
            </td>
            <td>
                1.现场查看
                2.访谈责任导师和住院医师
        ...
        <tr style="height:50px">
            ...
            <td>指导医师上岗前需参加院级师资上岗培训，培
                训率100%，持有效期内师资证上岗，并不断接
                受教学能力提升的继续教育。近5年内，每个专
                业基地负责人、教学主任、教学秘书和每个轮
                转科室1名以上骨干指导医师经过省级及以上的
                师资培训
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            <td>2.2.3激励制度★</td>
            <td>建立带教活动绩效管理制度，将带教活动与专
                业基地绩效考核挂钩，并在科室二次分配中将
                专业基地负责人、教学主任、教学秘书的教学
                管理活动和指导医师的带教活动，纳入个人绩
                效考核的重要指标范围
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>实行专业基地负责人负责制，负责协调本专业
                和相关专业的教学资源,加强对教学与培训人员
                的组织管理,整体把控培训质量,对本专业基地
                (含协同单位)的培训质量承担主要责任，并切
                实落实
            </td>
            <td rowspan="4">
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>设置教学主任岗位，负责本专业住院医师的轮
                转计划制订;负责本专业培训的全过程管理;定
                期检查评价住院医师的培训质量 和指导医师的
                带教质量等
            </td>
            <td>
                职责明确，履职认真，得2分
        ...
        <tr style="height:50px">
            ...
            <td>设置教学秘书岗位，协助专业基地负责人、教
                学主任开展培训与教学工作。执行专业基地负
                责人、教学主任布置的各项培训工作任务,督促
                指导医师积极落实带教任务等。
            </td>
            <td>
                有教学秘书，履职认真，得2分
        ...
        <tr style="height:50px">
            ...
            <td>成立教学小组，组成合理、职责明确，切实履
                职。能定期进行带教指导、指导医师培训、教
                学培训实施和考核、质量监管以及教学研究等
                工作
            </td>
            <td>
                有教学小组，履职认真，得3分
        ...
        <tr style="height:50px">
            ...
            <td>规范开展入专业基地教育，包括学科背景、规
                章制度及流程、专业基地培训目标、培训内容
                和轮转计划、轮转期间所需掌握的临床诊疗能
                力、技能操作等内容，并有专人组织实施
                规范开展入轮转科室教育，包括科室情况、科
                室纪律、培养计划与要求、医德医风、医患沟
                通等内容的入科教育，培训与考核要求体现科
                室岗位基本需求特点，并有专人组织实施
            </td>
            <td rowspan="4">
                1.现场查看教学活动落实情况
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="26" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>3.4.1日常考核</td>
            <td>包括医德医风、临床职业素养、考勤、临床实
                践能力、培训指标完成情况和参加业务学习情
                况，以及形成性评价开展情况等内容，相关记
                录等原始资料齐全，真实规范
            </td>
            <td rowspan="3">
                1.现场查看过程考核落实情况
        ...
        <tr style="height:50px">
            <td>3.4.2出科考核★</td>
            <td>
                有出科考核实施细则；考核内容包括理论与技
                能，体现专业特点和岗位胜任、分层递进的培
                训理念；出科考核形式规范，原始资料齐全，
                专业基地教学小组审核和组长签字
            </td>
            <td>
                1.有实施细则，得1分
                2.考核内容齐全，并体现专业特点和岗位胜
                任力、分层递进，得1.5分
        ...
        <tr style="height:50px">
            ...
            <td>有符合本专业的年度考核实施细则，内容包括
                个人总结、理论知识、实践技能、综合评价
                等，能真实全面反映年度培训情况，体现专业
                特点和分层递进的培训要求
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_03','附件3');">附件3</a>）
                <br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_04','附件4');">附件4</a>）
                <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
        ...
        <tr style="height:50px">
            ...
            <td>住院医师技能操作或手术情况</td>
            <td>随机抽查1～2名二年级以上住院医师
                进行技能操作，查看其掌握情况。
            </td>
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_05','附件5');">附件5</a>）
                <br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb5" onchange="saveScore4Expert(this,7,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>每个轮转科室均按照《住院医师规范化培训内
                容与标准（2022年版）》本专业培训细则要求
                执行，为每名住院医师安排并完成规定的技能
                操作（见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0600_01','附件1');">附件1</a>）
                ）</td>
            <td>
                随机抽查5～10名住院医师，由评估专
                家根据本专业实际需求确定技能操作
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标17项、计63分，一般指标25项、计37分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
