...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——外科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准
                （2022年版）》和《住院医师规范化培
                训内容与标准（2022年版）》外科专业
                细则要求（详见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment0900_Main',' 附件1-1至1-6');">附件1-1至1-6</a>）</td>
            <td>
                现场查看
            </td>
            <td>
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea id="fubiao11" onchange="saveSpeReason(this);" itemId="7" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%;"
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="17">3.培训管理（35分）</td>
            <td rowspan="6">3.1制度与落实</td>
            <td>
                3.1.1专业基地负责人
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="24" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="241" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['241']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['241']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="241" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%;"
                              class="text-input validate[required,maxSize[1000]]">${contentMap['241']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['241']}
                </c:if>
            </td>
            <td name="file" itemId="241"></td>
        </tr>
        <tr style="height:50px">
            <td>3.2培训招收
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="291" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0900_07','附件2');">附件2</a>
                <br>
                评估分值≥90分，得5分；<br>
                80分≤评估分值＜90分，得4分；<br>
                70分≤评估分值＜80分，得3分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="f2" onchange="saveScore4Expert(this,5,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0900_08','附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；   <br>
                80分≤评估分值＜90分，得5分；   <br>
                70分≤评估分值＜80分，得3分；   <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="f3" onchange="saveScore4Expert(this,6,0);" itemId="366" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0900_09','附件4');">附件4</a>
                <br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="f4" onchange="saveScore4Expert(this,7,0);" itemId="36" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注：
        1.一级指标4项，二级指标11项，三级指标44项。三级指标中，核心指标18项、计60分，一般指标26项、计40分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其<br>
