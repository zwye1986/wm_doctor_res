...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——放射肿瘤科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td rowspan="8">1.1专业基地相关医疗和设备条件</td>
            <td>
                1.1.1总床位数
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                必备科室：肿瘤专科医院应有肿瘤外科、肿瘤内科、妇科肿瘤科。综合性医院应有外科、妇科、耳鼻咽喉科、肿瘤内科。<br>
                辅助科室：医学影像科（含超声和核医学）、病理科、检验科、输血科（室）、心电图室、内镜科（室）、图书馆等相关科室。
            </td>
            <td>
                现场查看
            </td>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="4" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                普通内科（可由可轮转的综合医院提供）: <br>
                心血管内科、呼吸内科、消化内科<br>
                重症监护治疗室（ICU)或急诊科耳鼻咽喉科<br>
                肿瘤基础：影像诊断科、病理科<br>
                肿瘤内科<br>
                普通外科/肿瘤外科<br>
                放射肿瘤科
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="5"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》
                放射肿瘤科专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2500_01',' 附件1');">附件1</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,2,0);" itemId="6"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3,0);" itemId="7" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                符合《住院医师规范化培训基地标准（2022年版）》放射肿瘤科专业基地细则（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2500_02',' 附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,1);" itemId="8" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                完全符合要求，得2分<br>
                1项不符合要求，不得分<br>
                协同单位存在独立招收、独立培训住院医师的，此处不得分，撤销培训基地资格专业基地自身基本条件符合标准要求，无协同单位，此处不失分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="10" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主治医师专业技术职务3年以上，从事本专业医疗、教学工作5年及以上
            </td>
            <td rowspan="3">
        ...
        <tr style="height:50px">
            ...
            <td>
                应保有在职指导医师10名及以上，其中主任医师至少2名，副主任医师至少3名，主治医师至少5名；在职指导医师，基地负责人的专业及执业范围为肿瘤放射治疗；医学物理人员≥5人且至少1名具有高级专业技术职务
            </td>
            <td>
                符合标准，得1分<br>
                只要有1个亚专业不达标，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事本专业的医疗、科研和教学工作超过15年，且正在从事本专业临床医疗与教学工作
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                教学绩效考核不低于考核总分的8%，考核结果与专业技术职务晋升挂钩，得3分<br>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="22"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>3.2.1培训容量及招收★</td>
            <td>
                容量测算科学合理，完成招录任务，且在培住院医师≥12名，不能超容量招收
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
            ...
            <td>
                招收在容量测算数内，完成招收任务，且在培住院医师≥12名，得2分<br>
                容量测算科学合理，近三年未完成招收任务，但在培住院医师≥12名，得1分<br>
                在培住院医师＜12名，或超容量招收，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="24"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.3.5靶区勾画、计划评估教学</td>
            <td>
                开展规范的靶区勾画、计划评估教学活动，至少2周1次
            </td>
            <td>
                开展次数达标，且认真规范，得满分<br>
                未达标或不规范，不得分
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="30"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="31"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.5培训强度</td>
            <td>3.5.1管理床位数（或管理患者数）★</td>
            <td>
                每名住院医师在放射肿瘤科病房工作期间，管理住院和门诊病人≥40人次，独立管理病床数≥4张
            </td>
            <td>
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈各类住院医师各1～2名
            </td>
            <td>
                管床数（或管理患者数）达到要求，得2分<br>
                管床3张，或5～9张，得1分<br>
                管床数≤2张，或≥10张，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2500_03',' 附件3');">附件3</a>
                ≥95分，得4分；80分≤评估分值＜
                95分，得2分；60分≤评估分值＜80分，
                得1分；＜60分，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,4,0);" itemId="33"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="42"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2500_04',' 附件4');">附件4</a>
                <br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,6,0);" itemId="34" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2500_05',' 附件5');">附件5</a>
                <br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao5" onchange="saveScore4Expert(this,7,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.3技能操作安排情况</td>
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准（2022年版）》本专业培训细则要求执行，为每名住院医师安排并完成规定的技能操作
            </td>
            <td>
                随机抽查1～2名指导医师查看对住院医师安排技能操作情况
            </td>
            <td>
                完成率≥90%，得4分<br>
                80%≤完成率＜90%，得3分<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.4完成培训内容与要求★</td>
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准（2022年版）》本专业培训细则要求执行，为每名住院医师安排并完成规定的培训内容
            </td>
            <td>
                随机抽查2～3名住院医师，查看轮转登记手册、出科考核等原始资料，掌握岗位胜任力的实际情况
            </td>
            <td>
                完成率≥90%，得5分<br>
                80%≤完成率＜90%，得3.5分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加执业医师资格考试的通过率≥近三年全国本专业住院医师首次参加执业医师资格考试的平均通过率，得1分；低于近三年全国本专业住院医师首次参加执业医师资格考试的平均通过率不得分<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="38" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="39" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标40项。三级指标中，核心指标17项、计59分，一般指标23项、计41分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
