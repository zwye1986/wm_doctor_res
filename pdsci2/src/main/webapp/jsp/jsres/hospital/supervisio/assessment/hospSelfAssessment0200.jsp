...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;"
    ...
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——儿科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr height="28">
            ...
            <th style="text-align:left;padding-left: 4px;" height="28" colspan="4">所属省（区、市）：${cityName}</th>
        </tr>
        <tr style="height:16px;">
            <th style="min-width: 360px;max-width: 360px;height: 16px;" colspan="3">评估项目</th>
            <th style="min-width: 310px;max-width: 470px;" rowspan="2">评估内容</th>
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="6" name="local"
                           class="input"
        ...
        <tr >
            ...
            <td rowspan="2">
                ...
                内容与标准（2022版）》儿科专业细则
                要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0200_01','附件1');">附件1</a>）
            </td>
            <td>现场查看</td>
            <td>
                1.专业基地的疾病种类及数量符合标准要
        ...
        <tr >
            ...
            <td>符合《住院医师规范化培训基地标准
                （2022版）》儿科专业基地细则要求
                （详见 <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0200_02','附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="10" name="local"
                           class="input"
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="14" name="local" class="input"
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="19" name="local" class="input"
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="28" name="local" class="input"
        ...
        <tr >
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="291" name="local" class="input"
        ...
        <tr >
            ...
            <td>病房工作期间每名住院医师日管理床位3 ～6张(在指导医师指导下独立于其他住
                院医师管理床位)，年诊治住院病人100 ～150人次
            </td>
            <td rowspan="2">
                查看轮转手册（或医院相关电子系
                统）等，随机抽查访谈各类住院医
        ...
        <tr >
            ...
            <td>教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0200_03','附件3');">附件3</a> <br>
                评估分值≥90分，得5分； <br>
                80分≤评估分值＜90分，得4分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得1分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb3" onchange="saveScore4Expert(this,6,0);" itemId="34" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                带教情况评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0200_10','附件6');">附件6</a> <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb6" onchange="saveScore4Expert(this,6,0);" itemId="35" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                病历书写评分表见  <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0200_04','附件4');">附件4</a> <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,6,0);" itemId="36" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment0200_Main','附件5');">附件5</a> <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    ...
                    <input type="hidden" id="scoreInfo54" value="${scheduleMap['scoreInfo54']}" name="scoreOneInfo">
                    <input type="hidden" id="scoreInfo55" value="${scheduleMap['scoreInfo55']}" name="scoreOneInfo">
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标18项、计65分，一般指标24项、计35分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
