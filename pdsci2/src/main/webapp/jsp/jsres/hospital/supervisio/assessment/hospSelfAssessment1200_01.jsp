...
<head>
    ...
    <script type="text/javascript">
        ...
        function subInfo() {
            ...
            var inputSelf1 = window.parent.frames["jbox-message-iframe"].$("#fb11");
            var inputSelf2 = window.parent.frames["jbox-message-iframe"].$("#fb12");
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,70);" itemId="1" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td>腹腔镜或开放肾切除术及肾部分切除术*</td>
            <td colspan="2" style="text-align: center;">≥40</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,40);" itemId="13" name="first" class="input"
        ...
        <tr style="height:32px">
            <td>腹腔镜或开放肾输尿管全长切除术</td>
            <td colspan="2" style="text-align: center;">≥15</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="14" name="first" class="input"
        ...
        <tr style="height:32px">
            <td>输尿管镜检查及碎石术(输尿管镜或体外冲击波碎石术)*</td>
            <td colspan="2" style="text-align: center;">≥20</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td>膀胱全切、尿流改道术或前列腺癌根治术*</td>
            <td colspan="2" style="text-align: center;">≥20</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="19" name="first" class="input"
        ...
        <tr style="height:32px">
            <td>腹腔镜肾囊肿去顶术、精索静脉高位结扎术、睾丸鞘膜翻转术或膀胱造瘘术*</td>
            <td colspan="2" style="text-align: center;">≥40</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,40);" itemId="22" name="first" class="input"
    ...
    <div>注：*泌尿外科专业基地必须具备的病种及数量、手术及数量</div>
</div>
