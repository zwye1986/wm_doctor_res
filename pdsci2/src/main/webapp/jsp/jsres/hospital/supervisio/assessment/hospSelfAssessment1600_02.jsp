...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="4">
                <h2 style="font-size:150%">妇产科专业基地基本设备要求</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th style="width: 40%;">设备名称</th>
            <th  style="width: 20%;">标准数</th>   
            <th style="width: 20%;">实际数</th>
            <th style="width: 20%;">低于标准数（划√）</th>
        </tr>
        <tr style="height:32px">
            <th>12导联心电图机</th>
            <th>≥1台</th>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,4);" itemId="9" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="15" name="first" class="input"
