...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔内科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td>
                口腔颌面外科、口腔修复科、口腔放射<br>
                (影像)科、口腔病理科、检验科、药剂<br>
                科等
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                必选科室：牙体牙髓科、牙周科、口腔<br>
                颌面影像科、口腔修复科、口腔颌面外<br>
                科、口腔预防科、儿童口腔科、口腔黏<br>
                膜科、口腔急诊科<br>
                备选科室：口腔病理科、口腔正畸科、<br>
                口腔种植科、中医科、皮肤科、机动
            </td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准<br>
                （2022年版）》口腔内科专业细则要<br>
                求，详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2900_01',' 附件1');">附件1</a>
            </td>
            <td width="20%">
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                树脂固化机、牙周探针、超声洁牙机、<br>
                龈上洁治器和龈下刮治器、牙周手术器<br>
                械、牙科印模制取托盘、牙科模型制作<br>
                设备、常用牙科器械、材料、药品及口<br>
                腔诊室应必备的器械和材料
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                具有口腔医学本科及以上学历，从事本<br>
                专业临床和教学工作5年及以上，主治<br>
                医师及以上专业技术职务
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师≥15名，有高级专业<br>
                技术职务人员≥30%，高级专业技术职<br>
                务人员≥3名，正高级专业技术职务人<br>
                员≥1名
            </td>
            <td>
                达到标准，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2900_02',' 附件2');">附件2</a>
                <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2900_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；80分≤评估<br>
                分值＜90分，得5分；70分≤评估分值<br>
                ＜80分，得3分；60分≤评估分值＜70<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment2900_Main',' 附件4');">附件4</a>
                <br>
