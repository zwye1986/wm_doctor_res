...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——眼科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            <td rowspan="12">1.基本条件<br>（15分）</td>
            <td rowspan="11">1.1专业基地相关<br>医疗和设备条件</td>
            <td>1.1.1总床位数</td>
            <td>
                总床位数≥40张(包括日间手术病床)
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>必备科室：眼科显微手术训练实验室 <br>
                相关科室：急诊科、 内科、 外科、 耳鼻咽喉科、口腔科、 放射科、 麻醉科、病理科、 检验科等
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>眼科门诊及病房（含门诊治疗室、眼科急诊室、辅
                助检查室、验光、 眼睑泪器病、 白内障、 青光眼
                、 角膜与眼表疾病、 斜视与小儿眼病、眼眶病与
                眼整形、眼底病、眼外伤、葡萄膜病等）、神经内
                科、内分泌科、急诊科。眼科亚专科设置可根据实
                际情况重组或合并，但必须包含以上内容
            </td>
            <td>1.现场查看
                2.访谈住院医师</td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准(2022 年版)》
                和《住院医师规范化培训内容与标准(2022 年版)》
                眼科专业细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_01','附件1');">附件1</a>）
            </td>
            <td>现场查看</td>
            <td>
                1.专业基地的疾病种类及数量符合标准要求，
                或疾病种类及数量≥规定数的75%，且有符合要
                求的协同单位，总疾病种类及数量符合标准要
                求，得满分
                2.其他情况均不得分，专业基地暂停招收住院
                医师
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,2,0);" itemId="7" name="local"
                           class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3);" itemId="8"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,0.5);" itemId="9"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>依据《住院医师规范化培训基地标准(2022年版)》
                眼科专业基地细则的要求（见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_02','附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb2" onchange="saveScore4Expert(this,0.5);" itemId="91"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="92"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>医学本科及以上学历，主治医师专业技术职务3年及
                以上，从事本专业医疗和教学工作5年及以上
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计表，
                包括姓名、毕业时间、毕业学校、学历
        ...
        <tr style="height:50px">
            ...
            <td>指导医师上岗前需参加院级师资上岗培训，培训率
                100%，持有效期内师资证上岗，并不断接受教学能
                力提升的继续教育。近5年内，每个专业基地负责人
                、教学主任、教学秘书和每个轮转科室1名以上骨干
                指导医师经过省级及以上的师资培训
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                评价方案全面，原始记录详实，有落实、评价
                结果分析运用、改进，得3分
                评价方案简单，有落实，无结果分析运用，得2
                分
                无方案，但有单一评价记录，得1分
                无方案或有方案无评价实施记录，不得分
            </td>
        ...
        <tr style="height:50px">
            <td>2.2.3激励制度★</td>
            <td>建立带教活动绩效管理制度，将带教活动与专业基
                地绩效考核挂钩，并在科室二次分配中将专业基地
                负责人、教学主任、教学秘书的教学管理活动和指
                导医师的带教活动，纳入个人绩效考核的重要指标
                范围
            </td>
            <td>
                1.现场查看
            ...
            <td>
                教学绩效考核不低于考核总分的8%，考核结果
                与专业技术职务晋升挂钩，得4分
                教学绩效考核占考核总分的5%～8%之间，得2分
                教学绩效考核占考核总分低于5%或不纳入，不
                得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>实行专业基地负责人负责制，负责协调本专业和相
                关专业的教学资源,加强对教学与培训人员的组织管
                理,整体把控培训质量,对本专业基地(含协同单位)
                的培训质量承担主要责任，并切实落实
            </td>
            <td rowspan="4">
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>设置教学主任岗位，负责本专业住院医师的轮转计
                划制订;负责本专业培训的全过程管理;定期检查评
                价住院医师的培训质量和指导医师的带教质量等
            </td>
            <td>
                职责明确，履职认真，得2分
                无岗位职责，或履职不认真，不得分
        ...
        <tr style="height:50px">
            ...
            <td>设置教学秘书岗位，协助专业基地负责人、教学主
                任开展培训与教学工作。执行专业基地负责人、教
                学主任布置的各项培训工作任务,督促指导医师积极
                落实带教任务等。
            </td>
            <td>
                有教学秘书，履职认真，得2分
        ...
        <tr style="height:50px">
            ...
            <td>成立教学小组，组成合理、职责明确，切实履职。
                能定期进行带教指导、指导医师培训、教学培训实
                施和考核、质量监管以及教学研究等工作
            </td>
            <td>
                有教学小组，履职认真，得3分
        ...
        <tr style="height:50px">
            ...
            <td>规范开展入专业基地教育，包括学科背景、规章制
                度及流程、专业基地培训目标、培训内容和轮转计
                划、轮转期间所需掌握的临床诊疗能力、技能操作
                等内容，并有专人组织实施
                规范开展入轮转科室教育，包括科室情况、科室纪
                律、培养计划与要求、医德医风、医患沟通等内容
                的入科教育，培训与考核要求体现科室岗位基本需
                求特点，并有专人组织实施
            </td>
            <td rowspan="4">
                1.现场查看教学活动落实情况
            ...
            <td>
                1.按指南要求规范组织实施入专业基地教育，
                得1分；未组织或组织实施不规范，不得分
                2.按指南要求规范组织实施入轮转科室教育，
                得1分；未组织或组织实施不规范，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>3.4.1日常考核</td>
            <td>包括医德医风、临床职业素养、考勤、临床实践能
                力、培训指标完成情况和参加业务学习情况，以及
                形成性评价开展情况等内容，相关记录等原始资料
                齐全，真实规范
            </td>
            <td rowspan="3">
                1.现场查看过程考核落实情况
        ...
        <tr style="height:50px">
            <td>3.4.2出科考核★</td>
            <td>
                有出科考核实施细则；考核内容包括理论与技能，
                体现专业特点和岗位胜任、分层递进的培训理念；
                出科考核形式规范，原始资料齐全，专业基地教学
                小组审核和组长签字
            </td>
            <td>
                有实施细则，得1分
                考核内容齐全，并体现专业特点和岗位胜任力
                、分层递进，得1.5分
                考核形式规范，资料齐全，有专业基地教学小
                组审核和组长签字，得0.5分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>有符合本专业的年度考核实施细则，内容包括个人
                总结、理论知识、实践技能、综合评价等，能真实
                全面反映年度培训情况，体现专业特点和分层递进
                的培训要求
            </td>
            <td>考核内容全面，能体现岗位胜任力，得2分
                考核项目不全面，或不能体现岗位胜任力，得1
                分
                无年度考核，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                管床数、年收治患者数达到要求，得2分
                管床3～4张或9～10张，年收治患者数≥150人
                次，得1分
                管床数≤2张或≥11张，年收治患者数＜150人
                次，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="333" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['333']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                  <textarea onchange="saveSpeReason(this);" itemId="333" name="reason"
                            placeholder="请填写详细情况" style="width: 98%;height: 98%;"
                            class="text-input validate[required,maxSize[1000]]">${contentMap['333']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['333']}
                </c:if>
            </td>
            <td name="file" itemId="333"></td>
        </tr>
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_03','附件3');">附件3</a><br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb3" onchange="saveScore4Expert(this,6,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                1.住院医师操作前进行有效的交流，并与患者
                沟通核实，得1分
                2.住院医师操作中应如遇重大医疗安全隐患或
                将造成患者较大伤害的，应予以及时制止与纠
                正，得1分
                3.住院医师操作结束后提问，得1分
                4.对住院医师的操作采用合适的反馈方式进行
                总体评价，如有必要进行适当示范，得2分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_04','附件4');">附件4</a>
                <br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,6,0);" itemId="366" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.2技能操作和手术★</td>
            <td>住院医师技能操作或手术情况</td>
            <td>随机抽查1～2名二年级以上住院医师进
                行技能操作或常见手术操作（术者、助
                手），查看其掌握情况。
            </td>
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_05','附件5');">附件5</a>
                <br>
                评估分值≥90分，得8分； <br>
                80分≤评估分值＜90分，得6分； <br>
                70分≤评估分值＜80分，得4分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb5" onchange="saveScore4Expert(this,8,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>每个轮转科室均按照《住院医师规范化培训内容与
                标准（2022年版）》本专业培训细则要求执行，为
                每名住院医师安排并完成规定的技能操作和手术
                （见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1700_01','附件1');">附件1</a>）</td>
            <td>
                随机抽查5～10名住院医师，由评估专家
                根据本专业实际需求确定手术或技能操
                作项目，查看技能操作或手术记录，掌
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加执业医师资格
                考试的通过率≥近三年全国本专业住院医师首
                次参加执业医师资格考试的平均通过率，得
                1分；低于近三年全国本专业住院医师首次参加
                执业医师资格考试的平均通过率不得分
                （近三年本专业住院医师首次参加执业医师资
                格考试的通过率=近三年本专业首次参加考试通
                过的人数/近三年本专业首次参加考试总人数）
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加结业理论考核
                的通过率≥近三年全国本专业住院医师首次参
                加结业理论考核平均通过率，得3分；低于近三
                年全国本专业住院医师首次参加结业理论考核
                平均通过率，每降低1个百分点，扣1分，扣完
                为止
                （近三年本专业住院医师首次参加结业理论考
                核的通过率=近三年本专业首次参加结业理论考
                核通过的人数/近三年本专业首次参加结业理论
                考核总人数）
            </td>
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标17项、计65分，一般指标25项、计35分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥14个<br>
        基本合格：70分≤评估分值＜80分，且10个≤核心指标达标数≤13个
