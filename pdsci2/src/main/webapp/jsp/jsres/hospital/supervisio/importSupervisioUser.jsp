...
<script type="text/javascript">
	function importExcel(){
		...
		jboxStartLoading();
		var url = "<s:url value='/jsres/supervisio/importSupervisioUser'/>";
		jboxSubmit(
				$('#planForm'),
				url,
				function(resp){
		...
		<table width="100%" class="grid">
			...
			<tr>
				<th style="text-align: right;">导入模板：</th>
					<td style="text-align: left;"><a href="<s:url value='/jsp/jsres/hospital/supervisio/supervisioTemp.xlsx'/>">专家导入模板.xlsx</a></td>
			</tr>
		</table>
	</form>
