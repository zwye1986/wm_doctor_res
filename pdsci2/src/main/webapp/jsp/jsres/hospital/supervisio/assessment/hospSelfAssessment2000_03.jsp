...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">住院医师规范化培训临床小讲课评分表</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th colspan="3" style="text-align: left;">培训基地：${orgName}</th>
            <th colspan="3" style="text-align: left;">专业基地/科室：${speAndDept}</th>
        </tr>
        <tr style="height:32px;">
            ...
            <th colspan="3" style="text-align: left;">专业技术职务：
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <th colspan="3" style="text-align: left;">小讲课主题：
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['xjkzt']}" itemId="xjkzt" class="input" type="text" style="width:65%; text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['xjkzt']}
                </c:if>
