        ...
        function submitScore() {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (Number(allScore) >= 80 && Number(res) >= 15) {
                        assessmentResult = "合格";
                    } else if ((70 <= Number(allScore) && Number(allScore) < 80) && (11 <= Number(res) && Number(res)<= 14)) {
                        assessmentResult = "基本合格";
                    } else if ((60 <= Number(allScore) && Number(allScore) < 70) || (8 <= Number(res) && Number(res)<= 10)) {
                        assessmentResult = "限时整改";
                    } else if (60 < Number(allScore) || 7 <= Number(res)) {
                        assessmentResult = "撤销";
                    }
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔颌面外科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="2" itemName="病床数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="2" itemName="病床数" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="3" itemName="年收治患者量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="3" itemName="年收治患者量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="4" itemName="年门、急诊量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="4" itemName="年门、急诊量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="41" itemName="科室和实验室" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="41" itemName="科室和实验室" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                口腔颌面外科门诊、牙体牙髓科、口腔<br>
                颌面影像科、牙周科、口腔修复科、预<br>
                防口腔科、口腔颌面外科病房、口腔种<br>
                植科、口腔病理科、口腔麻醉科、口腔<br>
                急诊和机动
            </td>
            <td width="20%">
                1.现场查看<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="5" itemName="轮转科室（专业）" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准<br>
                （2022年版）》口腔颌面外科专业细则<br>
                要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3000_01',' 附件1');">附件1</a>）
            </td>
            <td width="20%">
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,2,0);" itemId="7" itemName="技能操作种类及数量" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                心电图机，X线机，曲面体层机，锥形束<br>
                CT或医用CT，血液、生化、免疫、尿液<br>
                检验设备，氧饱和度监测仪，呼吸机，<br>
                指测血糖仪，输液泵，微量泵，麻醉机<br>
                。每个手术间应配备1台手术床、手术器<br>
                械、无影灯、紫外线消毒灯、高压蒸汽<br>
                灭菌设备、电凝器、电动吸引器、药品<br>
                柜等
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                口腔颌面外科病房每名指导医师同时带<br>
                教住院医师≤3名；<br>
                口腔颌面外科门诊须安排至少1名指导医<br>
                师专职带教(不同时从事临床或管理等工<br>
                作)，每名专职指导医师同时带教住院医<br>
                师≤5名
            </td>
            <td width="20%">
                1.现场查看<br>
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                具有口腔医学本科及以上学历，从事口<br>
                腔颌面外科专业临床、教学工作6年及以<br>
                上，具有主治医师及以上专业技术职务3<br>
                年及以上，并符合总则中规定的指导医<br>
                师条件
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="12" itemName="指导医师条件" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="12" itemName="指导医师条件" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师≥10名，有高级专业<br>
                技术职务人员≥30%，高级专业技术职务<br>
                人员≥3名，正高级专业技术职务人员≥<br>
                1名
            </td>
            <td>
                达到标准，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="27" itemName="小讲课" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="28" itemName="疑难病例讨论" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="28" itemName="疑难病例讨论" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="29" itemName="特色教学活动" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="33" itemName="管理床位数" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                1.门诊工作量：保证每名住院医师日均<br>
                独立诊治门诊患者≥8人次，总量≥350<br>
                人次；<br>
                2.急诊工作量：保证每名住院医师诊治<br>
                急诊患者总量≥20人次
            </td>
            <td>
                门急诊工作量达到要求，得3分<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="42" itemName="门急诊工作量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                  <textarea onchange="saveSpeReason(this);" itemId="42" itemName="门急诊工作量" name="reason"
                            placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3000_02',' 附件2');">附件2</a>
                <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3000_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment3000_Main',' 附件4');">附件4</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分<br>
                值＜90分，得5分；70分≤评估分值＜80<br>
                分，得3分；60分≤评估分值＜70分，得<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,6,0);" itemId="37" itemName="技能操作或手术" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                按照《住院医师规范化培训内容与标准<br>
                （2022年版）》口腔全科培训细则，核<br>
                实培训内容的完成情况
            </td>
            <td width="20%">
                随机抽查访谈本院、委培、社会招<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,6,0);" itemId="38" itemName="完成培训内容与要求" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                的平均通过率，得2分；低于近三年全国<br>
                本专业住院医师首次参加执业医师资格<br>
                考试的平均通过率5个百分点，得1分，<br>
                其他情况不得分<br>
                （近三年本专业住院医师首次参加执业<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="39"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="40"  name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标19项、计66分，一般指标23项、计34分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥15个<br>
        基本合格：70分≤评估分值＜80分，且11个≤核心指标达标数≤14个<br>
        限期整改(黄牌)：60分≤评估分值＜70分；或基本条件合格，8个≤核心指标达标数≤10个；或在培住院医师总数近3年达不到专业基地最小培训容量要求的；未制定轮转计划或未严格落实的；结业理论考核通过率处于全省末位者。<br>
        撤销(红牌)：评估分值＜60分；或核心指标达标数≤7个；或连续3年“零”招收<br>
