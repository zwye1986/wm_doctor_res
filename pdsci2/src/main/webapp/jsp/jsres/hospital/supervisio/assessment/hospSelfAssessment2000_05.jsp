...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">临床病理技能操作评分表</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th colspan="2" style="text-align: left;">培训基地：${orgName}</th>
        ...
        <tr style="height:32px;">
            <th colspan="5" style="text-align: left;">取材标本：
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['qcbb']}" itemId="qcbb" class="input" type="text" style="width:200px; text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['qcbb']}
                </c:if>
        ...
        <tr style="height:32px;">
            <th width="20%">操作项目</th>
            <th colspan="2" width="60%">内容</th>
            <th width="10%">分值</th>
            <th width="10%">得分</th>
        </tr>
        <tr style="height:32px">
            <th rowspan="3">取材前准备</th>
            <td colspan="2">
                1. 戴帽子、口罩、手套、鞋套
            </td>
        ...
        <tr style="height:32px">
            <th rowspan="2">职业素质</th>
            <td colspan="2">
                1. 病理医师在对每例标本进行巨检和取材前后，应与记录
                人员认真核对该例标本及其标志与申请单的相关内容是否
                一致
            </td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
        ...
        <tr style="height:32px">
            <td colspan="2">
                2. 每例标本取材前、后，应用流水彻底清洗取材台面和所
                有相关器物，严防检材被无关组织或其他异物污染，严防
                细小检材被流水冲失
            </td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
