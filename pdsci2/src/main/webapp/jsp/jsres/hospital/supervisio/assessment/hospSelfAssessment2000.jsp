...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——临床病理科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="8">1.基本条件<br>（15分）</td>
            <td rowspan="6">1.1专业基地相关<br>医疗和设备条件</td>
            <td>
                1.1.1病例数
            </td>
            <td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="1" itemName="病例数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                   <textarea onchange="saveSpeReason(this);" itemId="1" itemName="病例数" name="reason"
                             placeholder="请填写详细情况" style="width: 98%" class="text-input validate[required,maxSize[1000]]"> ${contentMap['1']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['1']}
                </c:if>
        ...
        <tr style="height:50px">
            ...
            <td>
                工作场地：1000平方米及以上，布局合<br>
                理并符合生物安全的要求。具备规范地<br>
                标本取材室、标准储存室、常规技术<br>
                室，免疫组化室、细胞病理室、分子病<br>
                理室、尸体解剖室（可与上级单位及地<br>
                区法医部门联合）、会诊讨论室、会议<br>
                室和病理档案库等
            </td>
            <td width="20%">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="2" itemName="科室设置" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="2" itemName="科室设置" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td>
                放射科、超声科、常规技术室、组织化<br>
                学室、免疫组化室、细胞病理室、分子<br>
                病理室、尸体解剖室、病理档案库
            </td>
            <td width="20%">
                1.现场查看<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="3" itemName="轮转科室" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="3" itemName="轮转科室" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                符合《住院医师规范化培训基地标准<br>
                (2022年版)》和《住院医师规范化培训<br>
                内容与标准(2022年版)》临床病理科专<br>
                业细则中诊断疾病数量及种类 （包括超<br>
                声医学科、放射科的病种及数量要求）<br>
                （详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_01',' 附件1');">附件1</a>）
            </td>
            <td width="20%">
                现场查看
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao1" onchange="saveScore4Expert(this,5,0);" itemId="4" itemName="疾病种类及数量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="4" itemName="疾病种类及数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                开展组织化学染色6项及以上；开展免疫<br>
                组织化学染色项目80种及以上；原位杂<br>
                交或PCR等分子病理检测项目5种及以上
            </td>
            <td width="20%">
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="5" itemName="临床病理专业技术种类与数量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="5" itemName="临床病理专业技术种类与数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                具备相应人数诊断用显微镜和会诊多头<br>
                显微镜；具备病理资料信息化管理系统<br>
                。双筒光学显微镜、显微照相机或图像<br>
                采集设备、荧光显微镜、病历档案计算<br>
                机管理系统、冷冻切片机、自动化常规<br>
                病理制片设备（脱水、染色、封片、切<br>
                片机）、细胞涂片机、超薄切片机、PCR<br>
                仪、离心机、烤箱等，具备与基本工作<br>
                量相适应的标本取材/储存相关设备；现<br>
                代化常规制片技术
            </td>
            <td width="20%">
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="6" itemName="专业基地设备" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="6" itemName="专业基地设备" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                肿瘤专科医院应协同1家三级甲等综合医<br>
                院；协同单位数量不超过3家，协同培训<br>
                的科室（含亚专业）不超过3个，在协同<br>
                培训单位的轮转时间累计不超过 6个月
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            <td>2.1.2指导医师条件</td>
            <td>
                医学本科及以上学历，主治医师专业技<br>
                术职务3年及以上，且从事临床病理专业<br>
                临床及教学工作5年及以上
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师7名及以上；专业基地 <br>
                师资构成中副主任医师(或副教授)及以 <br>
                上职务人员达30%；具有高级专业技术职 <br>
                务师资2名及以上，并具有不同的临床病 <br>
                理亚专业研究方向
            </td>
            <td>
                符合标准，得1分<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="11"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                具有临床医学本科及以上学历 ,主任医师<br>
                (或教授)专业技术职务,有病理学亚专业<br>
                研究方向；从事临床病理专业医疗和教<br>
                学工作15年以上,有专业特长和研究方向
            </td>
            <td>
                符合标准，得1分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                为每名住院医师配置1名固定的责任指导<br>
                医师作为导师，负责住院医师在培训期<br>
                间的全程指导
            </td>
            <td width="20%">
                1.现场查看<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                育。近5年内，每个专业基地负责人、教<br>
                学主任、教学秘书和每个轮转科室1名以<br>
                上骨干指导医师经过省级及以上的师资<br>
                培训
            </td>
            <td width="20%">
                1.现场查看<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="14"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="15" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="16" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                本专业和相关专业的教学资源 ,加强对教<br>
                学与培训人员的组织管理,整体把控培训<br>
                质量,对本专业基地(含协同单位)的培训<br>
                质量承担主要责任，并切实落实
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="17"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                师的轮转计划制订;负责本专业培训的全<br>
                过程管理;定期检查评价住院医师的培训<br>
                质量和指导医师的带教质量等
            </td>
            <td width="20%">
                职责明确，履职认真，得2分<br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="19" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="20" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="21" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="22" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="23" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="24" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="27" itemName="日常考核" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="27" itemName="日常考核" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="28" itemName="出科考核" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="28" itemName="出科考核" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="29" itemName="年度考核" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="29" itemName="年度考核" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                住院医师独立完成各项培训内容及种类<br>
                能够达到《住院医师规范化培训内容与<br>
                标准(2022年版)》临床病理科细则的要<br>
                求，见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_01',' 附件1');">附件1</a>
            </td>
            <td width="20%">
                查看轮转手册（或医院相关电子系<br>
                统）等，随机抽查访谈各类住院医<br>
            ...
            <td>
                技能操作和各类诊断例数达到要求 ，得5<br>
                分<br>
                技能操作和各类诊断例数≥规定数的<br>
                80%，得3分<br>
                技能操作和各类诊断例数≥规定数的<br>
                60%，得2分<br>
                技能操作和各类诊断例数＜60%，或未安<br>
                排独立操作和报告，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,5,0);" itemId="30" itemName="培训工作量" name="local"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="30" itemName="培训工作量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                教学阅片评分表参见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_02',' 附件2');">附件2</a>
                <br>
                ≥95分，得5分；80分≤评估分值＜<br>
                95分，得3分；60分≤评估分值＜80分，<br>
                得1分；＜60分，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,5,0);" itemId="31" itemName="教学阅片质量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                 <textarea onchange="saveSpeReason(this);" itemId="31" itemName="教学阅片质量" name="reason"
                           placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                指导医师围绕住院医师在临床病理实践<br>
                中存在的问题，以临床知识、循证依据<br>
                和实践经验等为内容，通过讲授和互动<br>
                的方式集中学习
            </td>
            <td width="20%">
                抽查1～2名指导医师进行小讲课；<br>
            ...
            <td>
                临床小讲课评分表参见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得4分；80分≤评估分<br>
                值＜90分，得3分；60分≤评估分值＜80<br>
                分，得2分；评估分值＜60分，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,4,0);" itemId="32" itemName="小讲课质量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="32" itemName="小讲课质量" name="reason"
                         placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                1.对于住院医师操作前进行标本信息核<br>
                对的培训及监督，得1分<br>
                2.对住院医师操作中存在问题及时进行<br>
                指导，得1分<br>
                3.住院医师操作结束后对其进行提问 ，<br>
                得1分<br>
                4.对住院医师的操作进行总体评价 （优<br>
                、缺点点评），得2分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5);" itemId="33"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                临床病理诊断评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_04',' 附件4');">附件4</a>
                <br>
                评估分值≥90分，得7分；80分≤评估分<br>
                值＜90分，得5分；70分≤评估分值＜80<br>
                分，得4分；60分≤评估分值＜70分，得<br>
                2分；评估分值＜60分，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,7,0);" itemId="34" itemName="病理诊断描述及报告书写" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                <textarea onchange="saveSpeReason(this);" itemId="34" itemName="病理诊断描述及报告书写" name="reason"
                          placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                临床病理技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2000_05',' 附件5');">附件5</a>
                <br>
                评估分值≥90分，得5分；80分≤评估分<br>
                值＜90分，得4分；70分≤评估分值＜80<br>
                分，得3分；60分≤评估分值＜70分，得<br>
                1分；评估分值＜60分，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao5" onchange="saveScore4Expert(this,5,0);" itemId="35" itemName="标本取材技能操作" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
               <textarea onchange="saveSpeReason(this);" itemId="35" itemName="标本取材技能操作" name="reason"
                         placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                每个轮转科室均按照《住院医师规范化<br>
                培训内容与标准（2022年版）》本专业<br>
                培训细则要求执行，为每名住院医师安<br>
                排并完成规定的培训内容
            </td>
            <td width="20%">
                随机抽查2～3名住院医师，查看轮<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5);" itemId="36" itemName="完成培训内容与要求" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                 <textarea onchange="saveSpeReason(this);" itemId="36" itemName="完成培训内容与要求" name="reason"
                     placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                的平均通过率，得1分；低于近三年全国<br>
                本专业住院医师首次参加执业医师资格<br>
                考试的平均通过率不得分<br>
                <br>
                （近三年本专业住院医师首次参加执业<br>
                医师资格考试的通过率=近三年本专业首<br>
                次参加考试通过的人数/近三年本专业首<br>
                次参加考试总人数）
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="37" itemName="执业医师资格考试" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                <textarea onchange="saveSpeReason(this);" itemId="37" itemName="执业医师资格考试" name="reason"
                          placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                率，得3分；低于近三年全国本专业住院<br>
                医师首次参加结业理论考核平均通过<br>
                率，每降低1个百分点，扣1分，扣完为<br>
                止<br>
                （近三年本专业住院医师首次参加结业<br>
                理论考核的通过率=近三年本专业首次参<br>
                加结业理论考核通过的人数 /近三年本专<br>
                业首次参加结业理论考核总人数 ）
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="38"  name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标38项。三级指标中，核心指标18项、计64分，一般指标20项、计36分，共100分。单个核心指标达标判定标准 ：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
