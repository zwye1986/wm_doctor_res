...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">麻醉模拟培训相关课程</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th colspan="2">模拟培训相关课程名称</th>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,2);" itemId="2" name="first" class="input"
        ...
        <tr style="height:32px">
            <th colspan="2">纤维支气管镜/可视插管软镜插管</th>
            <th>2</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,2);" itemId="4" name="first" class="input"
        ...
        <tr style="height:32px">
            <th rowspan="6">麻醉危机资源管理（6个基本病例）</th>
            <th>失血性休克</th>
            <th>1</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
