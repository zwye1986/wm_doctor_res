    ...
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr>
            ...
            <td style="text-align: center;width: 10%;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="1" name="first" class="input" type="text" value="${scoreMap['1']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['1']}
                </c:if>
      ...
      <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="2" name="first" class="input" type="text" value="${scoreMap['2']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['2']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="3" name="first" class="input" type="text" value="${scoreMap['3']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['3']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="13" name="first" class="input" type="text" value="${scoreMap['13']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['13']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="14" name="first" class="input" type="text" value="${scoreMap['14']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['14']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="17" name="first" class="input" type="text" value="${scoreMap['17']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['17']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,4);" itemId="18" name="first" class="input" type="text" value="${scoreMap['18']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['18']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="24" name="first" class="input" type="text" value="${scoreMap['24']}"  style="width: 80%;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['24']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="31" <c:if test="${detailedMap['31'] eq '√'}"> checked="checked"</c:if> onclick="checkCheckBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['31']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="32" <c:if test="${detailedMap['32'] eq '√'}"> checked="checked"</c:if> onclick="checkCheckBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['32']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="33" <c:if test="${detailedMap['33'] eq '√'}"> checked="checked"</c:if> onclick="checkCheckBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['33']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="34" <c:if test="${detailedMap['34'] eq '√'}"> checked="checked"</c:if> onclick="checkCheckBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['34']}
                </c:if>
