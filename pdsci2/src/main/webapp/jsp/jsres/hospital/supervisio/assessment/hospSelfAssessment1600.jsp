...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——妇产科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td>
                综合医院妇产科≥50张；妇产科专科医院或妇幼保健院≥200张
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                综合医院妇产科≥1800；妇产科专科医院或妇幼保健院≥4000
            </td>
            <td rowspan="3">
                检查相关统计报表复印件，需加盖医院公章
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="2"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                综合医院妇产科≥50000；妇产科专科医院或妇幼保健院≥150000
            </td>
            <td>
                符合标准，得1分<br>
                不达标准，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                综合医院妇产科≥2000；妇产科专科医院或妇幼保健院≥9000
            </td>
            <td>
                符合标准，得1分<br>
                不达标准，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                轮转包括妇科、产科，及至少一个相关科室，得1分<br>
                仅轮转妇科和产科，缺相关科室轮转，得0.5分<br>
                缺妇科或产科轮转，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》妇产科专业细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1600_01','附件1');">附件1</a>）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3,0);" itemId="8" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                符合《住院医师规范化培训基地标准（2022年版）》妇产科专业基地细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1600_02','附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb2" onchange="saveScore4Expert(this,1);" itemId="9" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                具备手术示教的声像传输系统，有妇产科检查、手术示教、操作训练模型及多媒体电话教学设备
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="11" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历；主治医师专业技术职务3年及以上；从事临床教学工作至少5年；一位指导医师认定不超过2个亚专业
            </td>
            <td rowspan="3">
        ...
        <tr style="height:50px">
            ...
            <td>
                综合医院妇产科保有在职指导医师不低于7名；专科医院妇产科保有在职指导医师不低于10名；<br>
                具有高级职称者应至少占20%。专业基地应设有至少2个亚专业（产科及妇科），每个亚专业至少有3名指导医师，且具有高级职称者至少1名
            </td>
            <td>
                符合标准，得1分<br>
                只要有1项不符合标准，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历，主任医师专业技术职务，在国内或本区域内的妇产科学领域有学术任职并有一定的学术影响力，从事本专业的医疗、教学工作至少15年，有本专业科室或所在医院教学管理工作经验至少3年
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                评价方案全面，原始记录详实，有落实、评价结果分析运用、改进得3分<br>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="22"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="23"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                招收在容量测算数内，完成招收任务，且在培住院医师≥10名，得4分<br>
                容量测算科学合理，未完成招录任务，且在培住院医师≥10名，得2分<br>
        ...
        <tr style="height:50px">
            ...
            <td>3.5.1管理病床数★</td>
            <td>
                病房工作期间每名住院医师日管理病床≥5张，年收治住院病人≥180人次
            </td>
            <td rowspan="2">
                查看轮转手册（或医院相关电子系统）等，随机抽查访谈各类住院医师各1～2名
            </td>
            <td>
                年收治患者数达到要求，得2分；管床≥5张，但年收治患者数少于180人次，得1分<br>
                管床数＜5张，且年收治患者数少于180人次，不得分；
            </td>
        ...
        <tr style="height:50px">
            <td>3.5.2门急诊工作量</td>
            <td>
                门诊工作期间每名住院医师日接诊门诊患者≥20人次，有急诊培训计划的基地，急诊工作期间，每名住院医师日接诊急诊患者≥5人次。
            </td>
            <td>
                门急诊工作量达到要求，得3分<br>
                门急诊量≥规定数80%，得2分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1600_03','附件3');">附件3</a><br>
                评估分值≥90分，得5分；<br>
                80分≤评估分值＜90分，得4分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得1分；<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb3" onchange="saveScore4Expert(this,5,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1600_04','附件4');">附件4</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,6,0);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.2技能操作和手术（质量）★</td>
            <td>
                住院医师技能操作或手术情况
            </td>
            <td>
                随机抽查1～2名二年级以上住院医师进行技能操作或常见手术操作（术者、助手），查看其掌握情况
            </td>
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment1600_Main',' 附件5～附件7');">附件5～附件7</a><br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    ...
                    <input id="fubiao7" onchange="saveScore4Expert(this,7,0);" itemId="38" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.2.3技能操作和手术完成情况（数量）★</td>
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准（2022年版）》妇产培训细则要求执行，为每名住院医师安排并完成规定的技能操作和手术（见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1600_01','附件1');">附件1</a>）
            </td>
            <td>
                随机抽查5～10名住院医师，由评估专家根据本专业实际需求确定手术或技能操作项目，查看技能操作或手术记录，掌握岗位胜任力的实际情况
            </td>
            <td>
                完成率≥95%，得6分<br>
                90%≤完成率＜95%，得5分<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,6,0);" itemId="39" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="40" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="41" name="local" class="input"
