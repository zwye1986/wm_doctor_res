...
<div class="div_table" style="overflow: auto;max-height: 550px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">妇产科临床技能操作评分表（妇科查体双合诊三合诊）</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr>
            <td style="text-align: center;" rowspan="4">妇科检查（双合诊）</td>
            <td style="text-align: left">外阴阴道（内容5分，手法5分）</td>
        ...
        <tr>
            <td style="text-align: left">宫颈（内容10分，手法5分）</td>
            <td style="text-align: center;">15</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="2" name="first" class="input" type="text" value="${scoreMap['2']}"
        ...
        <tr>
            <td style="text-align: left;">子宫（内容10分，手法10分）</td>
            <td style="text-align: center;">20</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="3" name="first" class="input" type="text" value="${scoreMap['3']}"
                           style="height:20px;width: 23px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['3']}
        ...
        <tr>
            <td style="text-align: left;">双附件（内容10分，手法10分）</td>
            <td style="text-align: center;">20</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="4" name="first" class="input" type="text" value="${scoreMap['4']}"  style="height:20px;width: 23px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['4']}
                </c:if>
        ...
        <tr>
            <td style="text-align: center;">妇科检查（三合诊）</td>
            <td style="text-align: left;">三合诊（指征10分，手法5分）</td>
            <td style="text-align: center;">15</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
        ...
        <tr>
            <td style="text-align: center" colspan="2">查体前宣教、爱伤观念、无菌观念等</td>
            <td style="text-align: center;">20</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="6" name="first" class="input" type="text" value="${scoreMap['6']}"  style="height:20px;width: 23px;    text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['6']}
                </c:if>
