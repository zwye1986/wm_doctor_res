...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——急诊科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr >
            <td style="height: 438px;" rowspan="13">1.基本条件<br>（15分）</td>
            <td rowspan="11">1.1专业基地相关医疗和设备条件</td>
            <td>
                1.1.1总床位数
            </td>
            <td>
                总床位数≥30张<br>
                各区域床位数：抢救室≥4张、留观+急<br>
                诊病房≥20张、EICU≥6张
            </td>
            <td>
                现场查看
        ...
        <tr >
            ...
            <td>
                必备科室：预诊台、诊室（成人诊室、小儿诊室、综合诊室及特殊病人如精神病等诊室）、抢救室、输液室、清创室、处置室、急诊病房或观察室、急诊重症监护室、急诊手术室或急诊专用手术间；急诊辅助科室（24小时不间断开诊的急诊药房、急诊检验科、急诊影像科）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr >
            ...
            <td>
                呼吸内科、心血管内科、神经内科、消化内科、其他内科（血液、内分泌、肾脏内科）、麻醉科、综合ICU、普通外科（腹部外科为主）、骨科、神经外科、心胸外科、妇产科急诊、急诊科（含EICU)、感染科、影像科、超声科、心电图室（可自选）、儿科（可自选）、皮肤科门诊（可自选）
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
        ...
        <tr >
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》急诊科专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_01','附件1');">附件1</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11"  onchange="saveScore4Expert(this,2,0);" itemId="7" name="local" class="input"
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,2,0);" itemId="8" name="local" class="input"
        ...
        <tr >
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准（2022年版）》急诊科专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_02','附件2');">附件2</a>）
            </td>
            <td>
                现场查看
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb21" onchange="saveScore4Expert(this,1);" itemId="9" name="local" class="input"
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb22" onchange="saveScore4Expert(this,1);" itemId="10" name="local" class="input"
        ...
        <tr >
            <td rowspan="2">1.2协同情况</td>
            <td>
                1.2.1协同单位与科室数量、轮转时间
            </td>
            <td>
                协同单位数量不超过3家，协同培训的科室（含亚专业）不超过3个，在协同培训单位的轮转时间累计不超过 6个月
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr >
            <td>
                1.2.2未承担院前急救的专业基地应协同120急救中心
            </td>
            <td>
                符合《住院医师规范化培训基地标准（2022年版）》本专业基地细则要求，轮转时间0.5个月
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr >
            ...
            <td>
                保有在职指导医师10名及以上；各亚专业（专科）应由主任医师或副主任医师担任各科室或病区主任或副主任；科室内具有中、高级专业技术职务人数应占科室总医师数比例≥60%，所有医师最低学历为医学本科
            </td>
            <td>
                符合标准，得1分<br>
                只要有1个亚专业不达标，不得分
        ...
        <tr >
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事急诊及相关专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
        ...
        <tr >
            ...
            <td>
                指导医师上岗前需参加院级师资上岗培训，培训率100%，持有效期内师资证上岗，并不断接受教学能力提升的继续教育。近5年内，每个专业基地负责人、教学主任、教学秘书和每个轮转科室 1名以上骨干指导医师经过省级及以上的师资培训
            </td>
            <td>
                1.现场查看<br>
                2.访谈指导医师
        ...
        <tr >
            <td>2.2.2师资评价★</td>
            <td>
                对师资进行实时多维度评价 ，每年至少组织1次对指导医师教学工作综合评价
            </td>
            <td>
                1.现场查看<br>
                2.访谈指导医师和住院医师
        ...
        <tr >
            <td rowspan="15">3.培训管理<br>（35分）</td>
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="26"  name="local" class="input"
        ...
        <tr >
            ...
            <td>
                招收在容量测算数内，完成招收任务，且在培住院医师≥10名，得2分<br>
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="28"  name="local" class="input"
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="29"  name="local" class="input"
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="30"  name="local" class="input"
        ...
        <tr >
            ...
            <td>3.5.1管理床位数★</td>
            <td>
                病房工作期间每名住院医师日管理床位≥3张(在指导医师指导下独立于其他住院医师管理床位)
            </td>
            <td rowspan="2">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="35" name="local" class="input"
        ...
        <tr >
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="36" name="local" class="input"
        ...
        <tr >
            <td rowspan="7">4.培训质量<br>（35分）</td>
            <td rowspan="2">4.1指导医师教学质量</td>
            <td>4.1.1教学查房质量★</td>
            <td>
                主任或指导医师组织教学查房，悉心指导住院医师
            </td>
            <td>
                随机抽查1～2名指导医师教学查房
            </td>
            <td>
                教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_03','附件3');">附件3</a><br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb3" onchange="saveScore4Expert(this,6,0);" itemId="37" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                指导医师协助并指导住院医师完成技能操作或手术，带教严格规范
            </td>
            <td>
                随机抽查1～2名指导医师指导住院医师（二年级以上）进行技能操作或手术情况
            </td>
            <td>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="38" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                随机抽查1～2名住院医师运行病历和归档病历各1份
            </td>
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_04','附件4');">附件4</a><br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,6,0);" itemId="39" name="local" class="input"
        ...
        <tr >
            <td>4.2.2技能操作现场能力考核★</td>
            <td>
                住院医师技能操作现场能力考核
            </td>
            <td>
                随机抽查1～2名二年级以上住院医师进行技能操作现场能力考核，查看其掌握情况
            </td>
            <td>
                气管插管评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_05','附件5');">附件5</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
                ...
                心肺复苏评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_06','附件6');">附件6</a><br>
                评估分值≥45分，得6分；<br>
                40分≤评估分值＜45分，得5分；<br>
                35分≤评估分值＜40分，得3分；<br>
                30分≤评估分值＜35分，得2分；<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb56" onchange="saveScore4Expert(this,6,0);" itemId="40" name="local" class="input"
        ...
        <tr >
            <td>4.2.3技能操作和手术完成情况</td>
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准（2022年版）》本专业培训细则要求执行，为每名住院医师安排并完成规定的技能操作和手术 （见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0300_01','附件1');">附件1</a>）
            </td>
            <td>
                随机抽查5～10名住院医师，由评估专家根据本专业实际需求确定手术或技能操作项目，查看技能操作或手术记录，掌握实际情况
            </td>
            <td>
                完成率≥95%，得5分<br>
                90%≤完成率＜95%，得4分<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5);" itemId="41" name="local" class="input"
        ...
        <tr >
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="42" name="local" class="input"
        ...
        <tr >
            ...
            <td>
                近三年本专业住院医师首次参加结业理论考核的通过率≥近三年全国本专业住院医师首次参加结业理论考核平均通过率，得5分；低于近三年全国本专业住院医师首次参加结业理论考核平均通过率，每降低1个百分点，扣1分，扣完为止<br>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="43" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['43']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['43']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
        ...
        <tr >
            <td colspan="10">
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="44"  name="reason"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标43项。三级指标中，核心指标17项、计59分，一般指标26项、计41分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
