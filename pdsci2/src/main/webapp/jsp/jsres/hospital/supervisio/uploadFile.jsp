...
<body>
<div class="infoAudit">
	<form id="uploadFileForm" method="post" style="position:relative;" action="<s:url value='/jsres/supervisio/checkUploadFile'/>" enctype="multipart/form-data">
		<input type="hidden" name="itemId" value="${itemId}"/>
		<input type="hidden" name="itemName" value="${itemName}"/>
		<input type="hidden" name="subjectYear" value="${subjectYear}"/>
