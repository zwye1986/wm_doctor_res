    ...
    <script type="text/javascript">
        ...
        function saveScore(expl, num) {
            ...
            if (score >= 0 && reg.test(score)) {
                ...
                var substandard=parseInt(score*100/num)+"%";
        ...
        function subInfo() {
            ...
            for (var i = 0; i < itemIdList.length; i++) {
                if (itemIdList[i].getAttribute("name") == "first" ) {
                    firstNum++;
                    var text = $(itemIdList[i]).parent().next().text().substring(0,$(itemIdList[i]).parent().next().text().length-1);
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">${substandardMap['1']}</td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,25);" itemId="2" name="first" class="input"
            ...
            <td style="text-align: center">${substandardMap['2']}</td>
        </tr>
        <tr style="height:32px">
            ...
            <td style="text-align: center">${substandardMap['3']}</td>
        </tr>
        <tr style="height:32px">
            <th>电除颤</th>
            <th colspan="2">≥5</th>
            ...
            <td style="text-align: center">${substandardMap['4']}</td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">${substandardMap['5']}</td>
        </tr>
        <tr style="height:32px">
            <th>呼吸机操作</th>
            <th colspan="2">≥5</th>
            ...
            <td style="text-align: center">${substandardMap['6']}</td>
        </tr>
        <tr style="height:32px">
            <th colspan="4" style="text-align: right">合计：</th>
            <td style="text-align: center;"><span id="expertTotalled">${expertTotalled}</span></td>
            <td style="text-align: center" id=""> <span id="substandard"></span></td>
        </tr>
        </tbody>
