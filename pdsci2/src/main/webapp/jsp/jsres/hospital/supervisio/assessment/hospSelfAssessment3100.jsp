    ...
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔修复科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                ...
                求，详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3100_01',' 附件1');">附件1</a>
            </td>
            <td width="20%">
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                牙科综合治疗台，牙科印模制取托盘、<br>
                牙科模型制作设备及技工设备 、常用牙<br>
                科器械、材料、药品及口腔诊室应必备<br>
                的器械和材料。
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                师专业技术职务，从事口腔修复专业的<br>
                医疗、教学工作≥10年。任职期间，每<br>
                两周从事住院医师规范化培训教学工作<br>
                ≥4学时，并在国内口腔修复学领域具<br>
                有一定学术影响力。
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3100_02',' 附件2');">附件2</a>
                <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3100_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；80分≤评估<br>
                分值＜90分，得5分；70分≤评估分值<br>
                ＜80分，得3分；60分≤评估分值＜70<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment3100_Main',' 附件4');">附件4</a>
                <br>
