...
<head>
    ...
    <script>
        ...
        function planScoreMain(){
            jboxLoad("content","<s:url value='/jsres/supervisio/hospitalPlanScoreMain'/>?roleFlag=${role}",true);
        }
        function signMain(){
            jboxLoad("content","<s:url value='/jsres/supervisio/signHospitalLeaderMain'/>?userFlow=${sessionScope.currUser.userFlow}",true);
        }
    </script>
    <style>
...
<div style="overflow:auto;" id="indexBody">
    <div class="bd_bg">
        <div class="yw">
            <jsp:include page="/jsp/jsres/hospital/supervisio/supervisioHead.jsp" flush="true">
                ...
                <div class="container">
                    <div class="content_side">
                        <dl class="menu menu_first">
                            ...
                            <dd class="menu_item"><a onclick="planScoreMain();">评审项目</a></dd>
