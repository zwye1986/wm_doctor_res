...
<div class="main_hd">
    <h2 class="underline">督导管理 — <c:if test="${GlobalConstant.USER_LIST_LOCAL ne roleFlag}">专业自评</c:if><c:if test="${GlobalConstant.USER_LIST_LOCAL eq roleFlag}">基地自评</c:if></h2>
</div>
