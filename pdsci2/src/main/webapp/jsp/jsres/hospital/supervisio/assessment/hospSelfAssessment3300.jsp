...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔病理科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="2" itemName="年石蜡切片" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="2" itemName="年石蜡切片" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="3" itemName="年冰冻切片" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="3" itemName="年冰冻切片" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="4" itemName="年免疫组化辅助" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="4" itemName="年免疫组化辅助" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                1. 病理科应具备病理诊断室，大体标本<br>
                取材室，组织处理、包埋、切片、染色<br>
                室；免疫组化染色室<br>
                2. 相关科室及其他条件：应有口腔颌面<br>
                外科、口腔黏膜科、口腔放射科
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                口腔颌面外科门诊、牙体牙髓科、牙周<br>
                科、口腔修复科、口腔颌面影像科、口<br>
                腔预防科、外科病理(普通病理)、细胞<br>
                病理、口腔颌面外科、口腔黏膜科、口<br>
                腔病理科、机动
            </td>
            <td width="20%">
                1.现场查看<br>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                ...
                训内容与标准（2022年版）》口腔病理<br>
                科培训细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3300_01',' 附件1');">附件1
                </a>）
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                诊断用光学显微镜、大体标本取材台、<br>
                组织处理机、石蜡包埋机、石蜡切片机<br>
                、冰冻切片机、HE染色设备、免疫组化<br>
                染色设备
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                具有口腔医学本科及以上学历 ，具有主<br>
                治医师专业技术职务3年及以上，从事口<br>
                腔病理专业临床、教学工作8年及以上，<br>
                并符合总则中规定的指导医师条件
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                保有在职指导医师≥3名，有高级专业技<br>
                术职务人员≥30%，高级专业技术职务人<br>
                员≥2名，正高级专业技术职务人员≥1
            </td>
            <td>
                达到标准，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="26" itemName="教学阅片" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="26" itemName="教学阅片" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                根据专业基地条件，开展特色教学活<br>
                动，有助于加强《住院医师规范化培训<br>
                内容与标准（2022年版）》口腔病理科<br>
                培训细则要求的落实
            </td>
            <td width="20%">
                有特色活动，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3300_02',' 附件2');">附件2</a>
                    <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病理诊断描述及报告书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3300_03',' 附件3');">附件3</a>
                    <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,7,0);" itemId="36" itemName="病历书写" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3300_04',' 附件4');">附件4</a>
                    <br>
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项；二级指标11项；三级指标41项，核心指标18项，计64分，一般指标23项，共36分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
