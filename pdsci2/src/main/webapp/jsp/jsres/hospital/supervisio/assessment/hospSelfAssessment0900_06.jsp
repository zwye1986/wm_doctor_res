    ...
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,8);" itemId="1" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,8);" itemId="2" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,8);" itemId="3" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,8);" itemId="4" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="9" name="first" class="input"
