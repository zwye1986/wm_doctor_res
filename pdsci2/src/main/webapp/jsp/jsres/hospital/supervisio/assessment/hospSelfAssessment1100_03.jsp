    ...
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="3">患者姓名：
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['hzxm']}" itemId="hzxm" class="input" type="text" style="width:300px; text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['hzxm']}
                </c:if>
            ...
            <th style="text-align:left;padding-left: 4px;" colspan="3">病案号：
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['bah']}" itemId="bah" class="input" type="text" style="width:300px; text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['bah']}
                </c:if>
        ...
        <tr>
            <th rowspan="7" style="width: 15%;">入院记录 <br>（30分）</th>
            <td style="width: 15%;">一般项目</td>
            <td style="width: 30%;">完整准确</td>
            <td style="text-align: center;width: 10%;">3</td>
            <td style="text-align: center;width: 10%;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="1" name="first" class="input" type="text" value="${scoreMap['1']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['1']}
                </c:if>
      ...
      <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="2" name="first" class="input" type="text" value="${scoreMap['2']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['2']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="3" name="first" class="input" type="text" value="${scoreMap['3']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['3']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="5" name="first" class="input" type="text" value="${scoreMap['5']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['5']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="6" name="first" class="input" type="text" value="${scoreMap['6']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['6']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="9" name="first" class="input" type="text" value="${scoreMap['9']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['9']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="11" name="first" class="input" type="text" value="${scoreMap['11']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['11']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="12" name="first" class="input" type="text" value="${scoreMap['12']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['12']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="15" name="first" class="input" type="text" value="${scoreMap['15']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['15']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="17" name="first" class="input" type="text" value="${scoreMap['17']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['17']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,4);" itemId="18" name="first" class="input" type="text" value="${scoreMap['18']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['18']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="19" name="first" class="input" type="text" value="${scoreMap['19']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['19']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="20" name="first" class="input" type="text" value="${scoreMap['20']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['20']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="21" name="first" class="input" type="text" value="${scoreMap['21']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['21']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="22" name="first" class="input" type="text" value="${scoreMap['22']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['22']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="23" name="first" class="input" type="text" value="${scoreMap['23']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['23']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="24" name="first" class="input" type="text" value="${scoreMap['24']}"  style="width: 23px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['24']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" <c:if test="${detailedMap['33'] eq '√'}"> checked="checked"</c:if> itemid="33" onclick="checkCheckBox(this);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['33']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" <c:if test="${detailedMap['34'] eq '√'}"> checked="checked"</c:if> itemid="34" onclick="checkCheckBox(this);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['34']}
                </c:if>
