...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="31" <c:if test="${detailedMap['31'] eq '√'}"> checked="checked"</c:if> onclick="checkBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['31']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="32" <c:if test="${detailedMap['32'] eq '√'}"> checked="checked"</c:if> onclick="checkBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['32']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="33" <c:if test="${detailedMap['33'] eq '√'}"> checked="checked"</c:if> onclick="checkBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['33']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <label><input type="checkbox" itemid="34"  <c:if test="${detailedMap['34'] eq '√'}"> checked="checked"</c:if> onclick="checkBox(this,0);"/></label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['34']}
                </c:if>
