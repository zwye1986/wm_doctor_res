...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——外科（神经外科方向）（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准
                （2022年版）》和《住院医师规范化培
                训内容与标准（2022年版）》外科（神
                经外科方向）专业细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_01','附件1');">附件1</a>）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4);" itemId="18" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="313" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['313']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['313']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                  <textarea onchange="saveSpeReason(this);" itemId="313" name="reason"
                            placeholder="请填写详细情况" style="width: 98%;height: 98%;"
                            class="text-input validate[required,maxSize[1000]]">${contentMap['313']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['313']}
                </c:if>
            </td>
            <td name="file" itemId="313"></td>
        </tr>
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_03','附件3');">附件3</a>
                <br>
                评估分值≥90分，得5分； <br>
                80分≤评估分值＜90分，得4分； <br>
                70分≤评估分值＜80分，得3分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,5,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                临床技能床旁教学评价表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_04','附件4');">附件4</a>
                <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,5,0);" itemId="365" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_05','附件5');">附件5</a>
                <br>
                评估分值≥90分，得6分；  <br>
                80分≤评估分值＜90分，得5分；  <br>
                70分≤评估分值＜80分，得3分；  <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao5" onchange="saveScore4Expert(this,6,0);" itemId="366" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_06','附件6');">附件6</a><br>
                评估分值≥90分，得7分； <br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb6" onchange="saveScore4Expert(this,7,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>每个轮转科室均按照《住院医师规范化培训内容与标准（2022年版）》本专业培训细则要求执行，为每名住院医师安排并完成规定的技能操作和手术（见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1000_02','附件2');">附件2</a>）</td>
            <td>
                随机抽查5～10名住院医师，由评估
                专家根据本专业实际需求确定手术或
                技能操作项目，查看技能操作或手术
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fj2" onchange="saveScore4Expert(this,7,0);" itemId="37" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项；二级指标11项；三级指标41项，核心指标17项，计63分，一般指标24项，共37分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
