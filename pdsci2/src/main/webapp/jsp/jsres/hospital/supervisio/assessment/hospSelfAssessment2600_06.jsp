...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">住院医师临床能力评分表（染色体阅片）</h2>
            </th>
        </tr>
        ...
        <tr>
            <th rowspan="2" style="width: 12%;">准备（10分）</th>
            <td style="width: 12%;">显微镜的准</td>
            <td style="width: 46%;">显微镜开启、调焦正确</td>
        ...
        <tr>
            <th rowspan="6">阅片（75分）</th>
            <td rowspan="2">计数</td>
            <td>选择适当分散的中期分裂相计数并保证分析量</td>
            <td style="text-align: center">15</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="3" name="first" class="input" type="text" value="${scoreMap['3']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['3']}
                </c:if>
        ...
        <tr>
            <td rowspan="3">核型分析</td>
            <td>挑选适当长度和带纹好的分裂相进行核型分析</td>
            <td style="text-align: center">10</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="5" name="first" class="input" type="text" value="${scoreMap['5']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['5']}
                </c:if>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="6" name="first" class="input" type="text" value="${scoreMap['6']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['6']}
                </c:if>
        ...
        <tr>
            <td>提问：</td>
            <td>何种情况要加大染色体计数的量，何种情况要进行染色体微芯片检查</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <th colspan="3" style="text-align: center;">总分</th>
