...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">住院医师规范化培训临床操作技能床旁教学评分表</h2>
                <h2 style="font-size:150%">（督导专家/同行评议使用）</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="5">操作技能项目：
                <c:if test="${type eq 'Y'}">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="5">指导医师：
                <c:if test="${type eq 'Y'}">
                    <label><input type="radio" name="zrys"  <c:if test="${detailedMap['zrys'] eq '主任医师'}">checked="checked"</c:if> onclick="checkBox(this,'主任医师');" />&#12288;主任医师</label>&#12288;&#12288;&#12288;
                    <label><input type="radio" name="zrys"  <c:if test="${detailedMap['zrys'] eq '副主任医师'}">checked="checked"</c:if> onclick="checkBox(this,'副主任医师');" />&#12288;副主任医师</label>&#12288;&#12288;
                    <label><input type="radio" name="zrys"  <c:if test="${detailedMap['zrys'] eq '主治医师'}">checked="checked"</c:if> onclick="checkBox(this,'主治医师');" />&#12288;主治医师</label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['zrys']}
                </c:if>
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="5">指导模式：
                <c:if test="${type eq 'Y'}">
                    <label><input type="radio" name="zdms"  <c:if test="${detailedMap['zdms'] eq '示教模式'}">checked="checked"</c:if> onclick="checkBox(this,'示教模式');" />&#12288;示教模式</label>&#12288;&#12288;&#12288;
                    <label><input type="radio" name="zdms"  <c:if test="${detailedMap['zdms'] eq '带教模式'}">checked="checked"</c:if> onclick="checkBox(this,'带教模式');" />&#12288;带教模式</label>&#12288;&#12288;&#12288;
                    <label><input type="radio" name="zdms"  <c:if test="${detailedMap['zdms'] eq '协助模式'}">checked="checked"</c:if> onclick="checkBox(this,'协助模式');" />&#12288;协助模式</label>&#12288;&#12288;&#12288;
                    <label><input type="radio" name="zdms"  <c:if test="${detailedMap['zdms'] eq '指导模式'}">checked="checked"</c:if> onclick="checkBox(this,'指导模式');" />&#12288;指导模式</label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['zdms']}
                </c:if>
        ...
        <tr style="height:32px;">
            ...
            <th style="width: 45%">测评要求</th>
            <th style="width: 8%">分值</th>
            <th style="width: 8%">得分</th>
            <th style="width: 15%">存在问题</th>
        </tr>
        <tr>
            <th rowspan="2">组织安排 <br>（15分）</th>
            <td >专业基地在临床操作技能床旁教学教学的组织规范，符合规范要求</td>
            <td style="text-align: center;">10</td>
            <td style="text-align: center;">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="1" name="first" class="input" type="text" value="${scoreMap['1']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['1']}
                </c:if>
        ...
        <tr>
            <th rowspan="7">教学过程 <br>（40分）</th>
            <td>床旁教学项目选择和教学模式符合住院医师水平</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr>
            <td>操作结束后反馈与总结全面，体现教学的效果</td>
            <td style="text-align: center">10</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="8" name="first" class="input" type="text" value="${scoreMap['8']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['8']}
                </c:if>
        ...
        <tr>
            <th rowspan="4">教学方法 <br>（30分）</th>
            <td>根据教学模式，给住院医师充分参与及操作的机会</td>
            <td style="text-align: center">10</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="12" name="first" class="input" type="text" value="${scoreMap['12']}"  style="width: 25px;height:20px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['12']}
                </c:if>
