                ...
                success: function (res) {
                    ...
                    top.jboxPost(url, data, function (resp) {
                        if (resp == "${GlobalConstant.SAVE_SUCCESSED}") {
                            top.jboxTip(resp);        function scheduleMany(fileRoute, fileName) {
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;"
    ...
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——内科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr>
            ...
            <td>1.必备科室： 心血管内科(含心电图室) 、呼吸内科、消化内科、内分泌科、血
                液内科、肾内科、感染科、神经内科、
                风湿免疫科、急诊科、内科门诊(包括内
                科各亚专业)、重症监护病房
                2.可选科室： 医学影像科(含超声科和
        ...
        <tr>
            ...
            <td rowspan="2">
                ...
                训内容与标准（2022年版）》内科专业
                细则要求（详见
             <a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment0100_Main',' 附件1-1至1-8');">
                    附件1-1至1-8</a>）
            </td>
            <td>现场查看</td>
            <td>
            ...
            <input type="hidden" id="scoreInfo14" value="${scheduleMap['scoreInfo14']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo15" value="${scheduleMap['scoreInfo15']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo16" value="${scheduleMap['scoreInfo16']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo17" value="${scheduleMap['scoreInfo17']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo18" value="${scheduleMap['scoreInfo18']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo21" value="${scheduleMap['scoreInfo21']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo22" value="${scheduleMap['scoreInfo22']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo23" value="${scheduleMap['scoreInfo23']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo24" value="${scheduleMap['scoreInfo24']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo25" value="${scheduleMap['scoreInfo25']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo26" value="${scheduleMap['scoreInfo26']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo27" value="${scheduleMap['scoreInfo27']}" name="scoreTwoInfo">
            <input type="hidden" id="scoreInfo28" value="${scheduleMap['scoreInfo28']}" name="scoreTwoInfo">
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr>
            ...
            <td>依据《住院医师规范化培训基地标准
                （2022年版）》内科专业基地细则的要
                求，见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0100_09','附件2');">附件2</a>
            </td>
            <td>
                现场查看
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,0.5);" itemId="10" name="local"
                           class="input"
        ...
        <tr>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="110" name="local"
                           class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['110']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['110']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="110" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 94%;"
                              class="text-input validate[required,maxSize[1000]]">${contentMap['110']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['110']}
                </c:if>
            </td>
            <td name="file" itemId="110"></td>
        </tr>
        <tr>
            <td>
                1.2协同情况
        ...
        <tr>
            ...
            <td>
                1.有实施细则，得1分
                2.考核内容齐全，并体现专业特点和岗位能
                力要求、分层递进，得1.5分
                3.考核形式规范，资料齐全，有专业基地教
                学小组审核和组长签字，得0.5分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="30" name="local"
        ...
        <tr>
            ...
            <td>3.5.1管理床位数（或管理患者数）★
            </td>
            <td>每名住院医师在病房工作期间平均管理
                病床应不少于6张
            </td>
            <td rowspan="2">
                查看轮转手册（或医院相关电子系
        ...
        <tr>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="331" name="local" class="input"
        ...
        <tr>
            ...
            <td>教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0100_10','附件3');">附件3</a><br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
                60分≤评估分值＜70分，得2分； <br>
        ...
        <tr>
            ...
            <td>
                1.住院医师操作前进行有效的交流，并与患
                者沟通核实，得1分
                2.住院医师操作中应如遇重大医疗安全隐患
                或将造成患者较大伤害的，应予以及时制止
                与纠正，得1分
                3.住院医师操作结束后提问，得1分
                4.对住院医师的操作采用合适的反馈方式进
                行总体评价，如有必要进行适当示范，得2
                分
            </td>
        ...
        <tr>
            ...
            <td>
                病历书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0100_11','附件4');">附件4</a>
                <br>
                评估分值≥90分，得5分； <br>
                80分≤评估分值＜90分，得4分； <br>
                70分≤评估分值＜80分，得3分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,5,0);" itemId="36" name="local" class="input"
        ...
        <tr>
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0100_12','附件5');">附件5</a>
                <br>
                评估分值≥27分，得6分；  <br>
                24分≤评估分值＜27分，得5分；  <br>
                21分≤评估分值＜24分，得3分；  <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb5" onchange="saveScore4Expert(this,6,0);" itemId="37" name="local" class="input"
        ...
        <tr>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,6,0);" itemId="38" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标17项、计63分，一般指标25项、计37分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
