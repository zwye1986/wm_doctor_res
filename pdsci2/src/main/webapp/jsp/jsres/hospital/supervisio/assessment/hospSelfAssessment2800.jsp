...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——口腔全科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="41" itemName="年急诊量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="41" itemName="年急诊量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                相关科室：急诊科、心电监护室或配备<br>
                心电监护设备的急诊科、放射或影像科<br>
                （综合性医院的放射科内有从事口腔放<br>
                射影像工作的专业人员）、病理科（综<br>
                合性医院的病理科内有侧重口腔病理诊<br>
                断工作的专业人员）、检验科、药剂科<br>
                等
            </td>
            <td width="20%">
        ...
        <tr style="height:50px">
            ...
            <td>
                牙体牙髓科、牙周科、口腔颌面影像科<br>
                、口腔颌面外科、口腔修复科、口腔预<br>
                防科、儿童口腔科、口腔黏膜科、口腔<br>
                急诊科、口腔正畸科
            </td>
            <td width="20%">
                1.现场查看<br>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准<br>
                （2022年版）》口腔全科专业细则要<br>
                求，详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2800_01',' 附件1');">附件1</a>
            </td>
            <td width="20%">
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                牙科综合治疗台、牙髓活力测定所需设<br>
                备、橡皮障、根管治疗所需器械、光敏<br>
                树脂充填照射灯、牙周探针、超声洁牙<br>
                机、龈上和龈下深刮器、牙科印模制取<br>
                托盘、牙科模型制作设备及技工设备、<br>
                常用牙科（手术）器械、材料、药品及<br>
                口腔诊室应必备的器械和材料
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                教学技能评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2800_02',' 附件2');">附件2</a>
                <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2800_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；80分≤评估<br>
                分值＜90分，得5分；70分≤评估分值<br>
                ＜80分，得3分；60分≤评估分值＜70<br>
        ...
        <tr style="height:50px">
            ...
            <input type="hidden" id="scoreInfo45" value="${scheduleMap['scoreInfo45']}" name="scoreOneInfo">
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment2800_Main',' 附件4');">附件4</a>
                <br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="39" itemName="执业医师资格考试" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
              <textarea onchange="saveSpeReason(this);" itemId="39" itemName="执业医师资格考试" name="reason"
                        placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="40" itemName="执业医师资格考试" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
              <textarea onchange="saveSpeReason(this);" itemId="40" itemName="执业医师资格考试" name="reason"
                        placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            <td colspan="10">
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="41" itemName="执业医师资格考试" name="reason"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标41项。三级指标中，核心指标18项、计64分，一般指标23项、计36分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
