...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——重症医学科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="1" itemName="总床位数" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="3" itemName="床位使用率" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="3" itemName="床位使用率" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="5" itemName="轮转科室" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="5" itemName="轮转科室" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准
                ...
                内容与标准（2022年版）》重症医学科
                专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_01',' 附件1');">附件1
                </a>）
            </td>
            <td>现场查看</td>
            <td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,2,0);" itemId="6" itemName="疾病种类及数量" name="local"
                           class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3,0);" itemId="7" itemName="临床技能操作种类及数量" name="local"
                           class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="7" itemName="临床技能操作种类及数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>符合《住院医师规范化培训基地标准
                （2022年版）》重症医学科专业基地细
                则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_02',' 附件2');">附件2
                </a>）
            </td>
            <td>
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,1);" itemId="8" itemName="医院设备" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="8" itemName="医院设备" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>符合《住院医师规范化培训基地标准
                （2022年版）》重症医学科专业基地细
                则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_03',' 附件3');">附件3
                </a>）
            </td>
            <td>
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,1);" itemId="9" itemName="专业基地设备" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="9" itemName="专业基地设备" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="10" itemName="教学设施和设备" name="local"
                           class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="11" itemName="协同单位与科室数量" name="local"
                           class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="11" itemName="协同单位与科室数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="12" itemName="指导医师与住院医师比例" name="local"
                           class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="12" itemName="指导医师与住院医师比例" name="reason"
                              placeholder="请填写详细情况" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="31" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="32" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_04',' 附件4');">附件4</a>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_05',' 附件5');">附件5</a>
                评估分值≥90分，得6分；80分≤评估分
                值＜90分，得5分；70分≤评估分值＜80
                分，得3分；60分≤评估分值＜70分，得
                2分；评估分值＜60分，不得分
        ...
        <input type="hidden" id="scoreInfo61" value="${scheduleMap['scoreInfo61']}" name="scoreOneInfo">
        <input type="hidden" id="scoreInfo62" value="${scheduleMap['scoreInfo62']}" name="scoreOneInfo">
        <tr style="height:50px">
            <td>
                4.2.2技能操作★
            </td>
            ...
            <td>
                技能操作（心肺复苏、气管插管，2选
                1）评分表见
                <a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment3500_Main','附件6-1和6-2');">附件6-1和6-2</a>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao61" onchange="saveScore4Expert(this,7,0);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>每个轮转科室均按照《住院医师规范化
                ...
                学科专业细则要求执行，为每名住院医
                师安排并完成规定的技能操作（见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment3500_01',' 附件1');">
                    附件1
                </a>）
            </td>
            <td>
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标40项。三级指标中，核心指标16项、计64分，一般指标24项、计36分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其<br>
        中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥13个<br>
        基本合格：70分≤评估分值＜80分，且10个≤核心指标达标数≤12个<br>
        限期整改(黄牌)：60分≤评估分值＜70分；或基本条件合格，6个≤核心指标达标数≤9个；或在培住院医师总数近3年达不到专业基地最小培训容量要求的；未制定轮转计划或未严格落实的；结业理论考核通<br>
        过率处于全省末位者。<br>
