...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——康复医学科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td>
                相关科室：康复医学科专业基地的相关<br>
                科室应有符合条件的神经内科、神经外<br>
                科、骨科或矫形外科、心血管内科、呼<br>
                吸内科、内分泌科、儿科、ICU、放射科<br>
                、超声科、神经电生理室、脑电图室<br>
                等；<br>
                实验室：康复医学科专业基地的相关实<br>
                验室应有符合条件的神经系统疾病、骨<br>
                科疾病、内科疾病相关的实验室等
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                神经康复、脊髓损伤康复、骨科及运动<br>
                医学康复、内科康复、儿童康复、物理<br>
                治疗科（室）、作业治疗科（室）、言<br>
                语治疗科（室）、假肢矫形器科（室）
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                ...
                训内容与标准（2022年版）》康复医学<br>
                科专业细则要求(详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0800_01','附件1');">附件1</a>）
            </td>
            <td width="20%">
                现场查看
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,2,0);" itemId="5" itemName="疾病种类及数量" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="7" itemName="医院设备" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="7" itemName="医院设备" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历，主治医师及<br>
                以上专业技术职务，从事本专业工作5年<br>
                及以上
            </td>
            <td rowspan="4">
                查看人事部门提供的师资状况统计<br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="12" itemName="指导技师条件" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="12" itemName="指导技师条件" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                应保有在职指导医师8名及以上，其中主<br>
                任医师和副主任医师之和占30%；每个亚<br>
                专业≥3名师资；亚专业研究方向≥3个
            </td>
            <td>
                符合标准，得1分<br>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="46" itemName="轮转管理" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['46']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['46']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="46" itemName="轮转管理" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="20%">
                ...
                任务，但在培住院医师≥6名，得1分；<br>
                在培住院医师＜6名，或超容量招收，不<br>
                得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                病房工作期间每名住院医师日管理床位<br>
                ≥5张，平均管床位5-12张（在指导医师<br>
                带教下独立于其他住院医师管理床位）
            </td>
            <td width="20%" rowspan="2">
                查看轮转手册（或医院相关电子系<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0800_02','附件2');">附件2</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="f2" onchange="saveScore4Expert(this,6,0);" itemId="34" itemName="教学查房质量" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0800_03','附件3');">附件3</a><br>
                评估分值≥90分，得6分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="f3" onchange="saveScore4Expert(this,6,0);" itemId="36" itemName="病历书写" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment0800_Main',' 附件4');">附件4</a><br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
                60分≤评估分值＜70分，得2分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    ...
                    <input id="fb4" onchange="saveScore4Expert(this,7,0);" itemId="37" itemName="技能操作" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标43项。三级指标中，核心指标18项、计61分，一般指标25项、计39分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
