...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">超声医学科诊断报告评分表</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px;">
            <th width="15%">考核内容</th>
            <th colspan="2" width="35%">评分标准</th>
            <th width="15%">分值</th>
            <th width="15%">得分</th>
            <th width="20%">扣分原因</th>
        </tr>
        <tr style="height:32px">
            <th rowspan="3">一、一般信息<br>（10分）</th>
            <td width="20%">
                1. 医院名称、病人姓名、性别、年龄、病历号（或住院号）、影
                像号、仪器型号、联系方式等
            </td>
            <td style="text-align: center" rowspan="3">每缺少一项扣1分</td>
        ...
        <tr style="height:32px">
            <th rowspan="4">二、超声所见<br/>（40分）</th>
            <td>1. 书写规范、词句流畅、逻辑性强</td>
            <td style="text-align: center">扣1～15分</td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">扣1～5分（如无则不扣分）</td>
        ...
        <tr style="height:32px">
            <th rowspan="5">三、超声诊断<br/>（30分）</th>
            <td>
                1. 诊断明确；如不肯定时，给出数个诊断并根据可能性予与排名
            </td>
            <td style="text-align: center">扣1～10分</td>
