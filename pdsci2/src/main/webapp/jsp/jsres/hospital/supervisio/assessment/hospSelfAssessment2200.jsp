        ...
        function submitScore() {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (Number(allScore) >= 80 && Number(res) >= 12) {
                        assessmentResult = "合格";
                    } else if ((70 <= Number(allScore) && Number(allScore) < 80) && (9 <= Number(res) && Number(res)<= 11)) {
                        assessmentResult = "基本合格";
                    } else if ((60 <= Number(allScore) && Number(allScore) < 70) || (6 <= Number(res) && Number(res)<= 8)) {
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——放射科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="7">1.基本条件<br>（15分）</td>
            <td rowspan="6">1.1专业基地相关医疗和设备条件</td>
            <td>
                1.1.1科室年检查例数
            </td>
            <td>
                放射科影像年检查总数≥75000例次，具体如下：<br>
                （1）普通X线年检查数量≥35000例次；<br>
                （2）CT年检查数量≥40000例次,且CT图<br>
                像后处理≥1200例次；<br>
                （3）MR年检查数量≥12000例次；<br>
                （4）介入诊断和治疗年检查数量≥500<br>
                例次；<br>
                （5）X线造影年检查数量≥500例次
            </td>
            <td>
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="1"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>亚专业组设置包括胸部影像（呼吸系统、循环系统、乳腺等）、腹部影像（消化系统、泌尿系统、生殖系统等）、神经头颈影像（中枢神经系统、头颈及五官）、骨骼肌肉系统影像、介入放射学等</td>
            <td>
                现场查看
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>放射科（含神经头颈与五官、心胸与乳腺、消化与泌尿生殖、骨肌及介入放射等亚专业组）、超声医学科、核医学科、病理科、内科、外科和急诊科等（含协同单位的科室）</td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="3"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准（2022年版）》和《住院医师规范化培训内容与标准（2022年版）》放射科专业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2200_01',' 附件1');">附件1</a>）</td>
            <td>
                现场查看
            </td>
            <td>
                1.专业基地的疾病种类及数量符合标准要求，或疾病种类及数量≥规定数的75%，且有符合要求的协同单位，总疾病种类及数量符合标准要求，得满分<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                专业基地的临床技能操作种类及数量符合标准要求，得满分，否则，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                1.计算机X线摄影（CR）或数字X线摄影（DR）机≥2台；<br>
                2.数字胃肠造影机≥1台；<br>
                3.乳腺机≥1台；<br>
                4.大型数字减影血管造影（DSA）机≥1台；<br>
                5.64排以上（含64排）螺旋CT机≥1台；<br>
                6.高场强（1.5T及以上）MR机≥1台
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>协同单位不超过2家，协同培训的科室（含亚专业）不超过3个，在协同培训单位的轮转时间累计不超过6个月</td>
            <td>
                现场查看
            </td>
            <td>
                完全符合要求，得2分<br>
                1项不符合要求，不得分<br>
                协同单位存在独立招收、独立培训住院医师的，此处不得分，撤销培训基地资格<br>
                专业基地自身基本条件符合标准要求，无协同单位，此处不失分
            </td>

            <td style="text-align: center;">2</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="7" name="local" class="input"
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="8">2.师资管理<br>（15分）</td>
            <td rowspan="5">
                2.1师资情况
            </td>
            <td>
            ...
            <td>每位指导医师同时带教放射影像专业住院医师不超过3人</td>
            <td>
                1.现场查看<br>
                2.访谈指导医师和住院医师
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>具有医学本科及以上学历、主治医师及以上专业技术职务，且从事放射科临床教学工作至少3年；一位指导医师认定不超过2个亚专业；每年须参加所从事亚专业方向相关的专业培训或继续教育</td>
            <td rowspan="3">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="9" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>应保有在职指导医师至少7人，主任医师（或教授）至少1人，副主任医师（或副教授）至少2人，主治医师（或讲师）至少4人；每个亚专业组师资至少2名</td>
            <td>
                符合标准，得1分<br>
                只要有1个亚专业不达标，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>具有医学本科及以上学历、主任医师专业技术职务，且从事本专业的医疗和教学工作超过15年</td>
            <td>
                符合标准，得1分<br>
                有1项不符合条件，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="11" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>为每名住院医师配置1名固定的责任指导医师作为导师，负责住院医师在培训期间的全程指导</td>
            <td>
                1.现场查看<br>
                2.访谈责任导师和住院医师
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="12" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>指导医师上岗前需参加院级师资上岗培训，培训率100%，持有效期内师资证上岗，并不断接受教学能力提升的继续教育。近5年内，每个专业基地负责人、教学主任、教学秘书和每个轮转科室1名以上骨干指导医师经过省级及以上的师资培训</td>
            <td>
                1.现场查看<br>
                2.访谈指导医师
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>每年度至少组织1次对每位指导医师的教学工作进行评价</td>
            <td>
                1.现场查看<br>
                2.访谈指导医师和住院医师
            </td>
            <td>
                评价方案全面，原始记录详实，有落实、评价结果分析运用、改进，得4分<br>
                评价方案简单，有落实，无结果分析运用，得2分<br>
                无方案，但有单一评价记录，得1分<br>
                无方案或有方案无评价实施记录，不得分
            </td>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="14" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                教学绩效考核不低于考核总分的8%，考核结果与专业技术职务晋升挂钩，得4分<br>
                教学绩效考核占考核总分的5%～8%之间，得2分<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="15" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                实行专业基地负责人负责制，负责协调本专业和相关专业的教学资源,加强对教学与培训人员的组织管理,整体把控培训质量,对本专业基地(含协同单位)的培训质量承担主要责任，并切实落实
            </td>
            <td rowspan="4">
                1.现场查看<br>
                2.访谈专业基地管理人员、指导医师
        ...
        <tr style="height:50px">
            ...
            <td>
                设置教学主任岗位，负责本专业住院医师的轮转计划制订;负责本专业培训的全过程管理;定期检查评价住院医师的培训质量和指导医师的带教质量等
            </td>
            <td>
                职责明确，履职认真，得2分<br>
                无岗位职责，或履职不认真，不得分
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="17" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                设置教学秘书岗位，协助专业基地负责人、教学主任开展培训与教学工作。执行专业基地负责人、教学主任布置的各项培训工作任务,督促指导医师积极落实带教任务等。
            </td>
            <td>
                有教学秘书，履职认真，得2分<br>
                无教学秘书，或履职不认真，不得分
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="18" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                成立教学小组，组成合理、职责明确，切实履职。能定期进行带教指导、指导医师培训、教学培训实施和考核、质量监管以及教学研究等工作
            </td>
            <td>
                有教学小组，履职认真，得3分<br>
                无教学小组，或履职不认真，不得分
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="19" name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.1.5轮转计划★</td>
            <td>
                按规定制定和落实轮转计划和要求，体现分层递进的培训理念
            </td>
            <td>
                1.现场核查在培住院医师轮转情况<br>
                2.访谈专业基地管理人员、指导医师和住院医师
            </td>
            <td>
                轮转计划体现分层递进，并严格落实，得4分<br>
                轮转计划未体现分层递进，但严格落实，得2分<br>
                未制定轮转计划或未严格落实的，不得分，专业基地限期整改
            </td>

            <td style="text-align: center;">4</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="20" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>3.2.1培训容量及招收★</td>
            <td>
                容量测算科学合理，完成招录任务，且在培住院医师≥10名，不能超容量招收
            </td>
            <td>
                1.现场查看<br>
                2.访谈住院医师
            ...
            <td>
                招收在容量测算数内，近三年平均完成招收任务≥80%，且在培住院医师≥10名，得2分<br>
                招收在容量测算数内，近三年平均完成招收任务＜80%，但在培住院医师≥10名，得1分<br>
        ...
        <tr style="height:50px">
            ...
            <td>3.3.1入专业基地及入轮转科室教育</td>
            <td>
                规范开展入专业基地教育，包括学科背景、规章制度及流程、专业基地培训目标、培训内容和轮转计划、轮转期间所需掌握的临床诊疗能力、技能操作等内容，并有专人组织实施<br>
                规范开展入轮转科室教育，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通等内容的入科教育，培训与考核要求体现科室岗位基本需求特点，并有专人组织实施
            </td>
            <td rowspan="5">
                1.现场查看教学活动落实情况<br>
                2.访谈专业基地管理人员、指导医师和住院医师
            ...
            <td>
                1.按指南要求规范组织实施入专业基地教育，得1分；未组织或组织实施不规范，不得分<br>
                2.按指南要求规范组织实施入轮转科室教育，得1分；未组织或组织实施不规范，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="24"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="25"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.3.5影像诊断报告书写指导</td>
            <td>
                开展规范的影像诊断报告书写指导，至少每月1次
            </td>
            <td>
                开展次数达标，且认真规范，得1分<br>
                开展次数不达标或不规范，不得分
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="26"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="3">3.4过程考核</td>
            <td>3.4.1日常考核</td>
            <td>
                包括医德医风、临床职业素养、考勤、临床实践能力、培训指标完成情况和参加业务学习情况，以及形成性评价开展情况等内容，相关记录等原始资料齐全，真实规范
            </td>
            <td rowspan="3">
                1.现场查看过程考核落实情况<br>
                2.访谈专业基地管理人员、指导医师和住院医师
        ...
        <tr style="height:50px">
            <td>3.4.2出科考核★</td>
            <td>
                有出科考核实施细则；考核内容包括理论与技能，体现专业特点和岗位胜任、分层递进的培训理念；出科考核形式规范，原始资料齐全，专业基地教学小组审核和组长签字
            </td>
            <td>
                1.有实施细则，得1分<br>
                2.考核内容齐全，并体现专业特点和岗位胜任力、分层递进，得1.5分<br>
                3.考核形式规范，资料齐全，有专业基地教学小组审核和组长签字，得0.5分
            </td>

            <td style="text-align: center;">3</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3,0);" itemId="28"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.4.3年度考核</td>
            <td>
                有符合本专业的年度考核实施细则，内容包括个人总结、理论知识、实践技能、综合评价等，能真实全面反映年度培训情况，体现专业特点和分层递进的培训要求
            </td>
            <td>
                考核内容全面，能体现岗位胜任力，得1分<br>
                考核项目不全面，或不能体现岗位胜任力，得0.5分<br>
                无年度考核，不得分
            </td>
        ...
        <tr style="height:50px">
            <td rowspan="2">3.5培训强度</td>
            <td>3.5.1影像诊断报告工作量</td>
            <td>
                每个工作日平均完成X线诊断报告≥30份，或CT诊断报告≥25份，或MR诊断报告≥15份
            </td>
            <td rowspan="2">
                查看PACS、轮转手册等相关材料，随机抽查访谈本院、委培、社会招收住院医师各1～2名
            </td>
            <td>
                工作量达到要求，得3分<br>
                工作量≥规定数的80%，得2.5分<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="30"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>3.5.2影像技能操作工作量</td>
            <td>
                每个工作日平均完成X线造影操作≥2例次，或CT图像后处理操作≥5例次，或介入放射操作（观摩）≥2例次
            </td>
            <td>
                工作量达到要求，得3分<br>
                工作量≥规定数的80%，得2.5分<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="31"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>4.1.1教学阅片质量★</td>
            <td>
                主任或指导医师组织教学阅片，悉心指导住院医师
            </td>
            <td>
                随机抽查1～2名指导医师教学阅片
            </td>
            <td>
                教学阅片评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2200_02',' 附件2');">附件2</a>
                <br>
                评估分值≥90分，得5分；80分≤评估分值＜90分，得4分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得1分；评估分值＜60分，不得分
            </td>

            <td style="text-align: center;">5</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,5,0);" itemId="32"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td>4.1.2技能操作带教情况★</td>
            <td>
                指导医师协助并指导住院医师完成技能操作，带教严格规范
            </td>
            <td>
                随机抽查1～2名指导医师指导住院医师（二年级以上）进行技能操作
            </td>
            <td>
                1.住院医师操作前进行有效的交流，并与患者沟通核实，得1分<br>
                2.住院医师操作中应如遇重大医疗安全隐患或将造成患者较大伤害的，应予以及时制止与纠正，得1分<br>
                3.住院医师操作结束后提问，得1分<br>
                4.对住院医师的操作采用合适的反馈方式进行总体评价，如有必要进行适当示范，得2分
            </td>

            <td style="text-align: center;">5</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="33"  name="local" class="input"
        ...
        <tr style="height:50px">
            <td rowspan="5">4.2住院医师培训效果</td>
            <td>4.2.1报告书写★</td>
            <td>
                住院医师诊断报告书写情况
            </td>
            <td>
                随机抽查1～2名住院医师，在PACS中抽取既往书写的影像诊断报告1份，同时抽取当日的影像检查1例并进行现场报告书写
            </td>
            <td>
                诊断报告评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment2200_03',' 附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得3分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>

            <td style="text-align: center;">6</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,6,0);" itemId="34" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                随机抽查1～2名二年级以上住院医师进行技能操作，查看其掌握情况
            </td>
            ...
            <input type="hidden" id="scoreInfo43" value="${scheduleMap['scoreInfo43']}" name="scoreOneInfo">
            <input type="hidden" id="scoreInfo44" value="${scheduleMap['scoreInfo44']}" name="scoreOneInfo">
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment2200_Main',' 附件4');">附件4</a>
                <br>
                评估分值≥90分，得7分；80分≤评估分值＜90分，得5分；70分≤评估分值＜80分，得4分；60分≤评估分值＜70分，得2分；评估分值＜60分，不得分
            </td>

            <td style="text-align: center;">7</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao4" onchange="saveScore4Expert(this,7,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                按照《住院医师规范化培训内容与标准（2022年版）》放射科培训细则要求执行，为每名住院医师安排并完成规定的技能操作
            </td>
            <td>
                随机抽查5～10名住院医师，由评估专家根据本专业实际需求确定技能操作项目，查看技能操作，掌握岗位胜任力的实际情况
            </td>
            <td>
                完成率≥95%，得6分<br>
                90%≤完成率＜95%，得5分<br>
            ...
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,6,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加执业医师资格考试的通过率≥近三年全国本专业住院医师首次参加执业医师资格考试的平均通过率，得2分；低于近三年全国本专业住院医师首次参加执业医师资格考试的平均通过率5个百分点，得1分，其他情况不得分<br>
                （近三年本专业住院医师首次参加执业医师资格考试的通过率=近三年本专业首次参加考试通过的人数/近三年本专业首次参加考试总人数）
            </td>

            <td style="text-align: center;">2</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                近三年本专业住院医师首次参加结业理论考核的通过率≥近三年全国本专业住院医师首次参加结业理论考核平均通过率，得4分；低于近三年全国本专业住院医师首次参加结业理论考核平均通过率，每降低1个百分点，扣1分，扣完为止<br>
                （近三年本专业住院医师首次参加结业理论考核的通过率=近三年本专业首次参加结业理论考核通过的人数/近三年本专业首次参加结业理论考核总人数）
            </td>

            <td style="text-align: center;">4</td>
            <td  style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="38" name="local" class="input"
            ...
            <td colspan="10">
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="39"  name="reason"
                              placeholder="请详细填写存在问题" style="width: 100%;height: 98%;"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标38项。三级指标中，核心指标15项、计60分，一般指标23项、计40分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
        合格：评估分值≥80分，且核心指标达标数≥12个<br>
        基本合格：70分≤评估分值＜80分，且9个≤核心指标达标数≤11个<br>
        限期整改(黄牌)：60分≤评估分值＜70分；或基本条件合格，6个≤核心指标达标数≤8个；或在培住院医师总数近3年达不到专业基地最小培训容量要求的；未制定轮转计划或未严格落实的；结业理论考核通过率处于全省末位者。<br>
        撤销(红牌)：评估分值＜60分；或核心指标达标数≤5个；或连续3年“零”招收<br>
