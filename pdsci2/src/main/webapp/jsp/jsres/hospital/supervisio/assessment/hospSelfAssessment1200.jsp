...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标——外科（泌尿外科方向）（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td>有符合条件的普通外科、骨科、胸心外科、神经外
                科、急诊科、麻醉科、放射科及外科重症监护室</td>
            <td>现场查看</td>
            <td>
                满足要求，得1分<br>
                缺1项，不得分
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准（2022年版）
                》和《住院医师规范化培训内容与标准（2022年
                版）》泌尿外科专业细则要求（详见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1200_01','附件1');">附件1</a>）</td>
            <td>
                现场查看
            </td>
            <td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb11" onchange="saveScore4Expert(this,2,0);" itemId="7" name="local"
                           class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb12" onchange="saveScore4Expert(this,3,0);" itemId="8"  name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>十二导联心电图机、生命体征监护仪、快速血糖自
                动测定仪、中心供氧接口、中心吸引接口、电动吸
                引器、输液泵(1000ml/h) 、微量注射泵
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>输尿管硬镜、输尿管软镜、经皮肾镜、尿道膀胱硬
                镜、尿道膀胱软镜、前列腺电切镜、尿道内切开镜
                、腹腔镜、外科重症监护病房相关设备，包括呼吸
                机、心肺脑复苏急救设备</td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>协同单位数量不超过3家，协同培训的科室（含亚
                专业）不超过3个，在协同培训单位的轮转时间累
                计不超过6个月
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>具有医学本科及以上学历，主治医师专业技术职务
                3年及以上，从事本专业医疗和教学工作5年及以
                上，具有指导住院医师“三基”训练的能力
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计
        ...
        <tr style="height:50px">
            ...
            <td>具有医学本科及以上学历，主任医师专业技术职
                务，从事本专业的医疗和教学工作超过15年
            </td>
            <td>
                符合标准，得1分
                有1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td>指导医师上岗前需参加院级师资上岗培训，培训率
                ...
                力提升的继续教育。近5年内，每个专业基地负责
                人、教学主任、教学秘书和每个轮转科室1名以上
                骨干指导医师经过省级及以上的师资培训
            </td>
            <td>
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>实行专业基地负责人负责制，负责协调本专业和相
                关专业的教学资源,加强对教学与培训人员的组织
                管理,整体把控培训质量,对本专业基地(含协同单
                位)的培训质量承担主要责任，并切实落实
            </td>
            <td rowspan="4">
                1.现场查看
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1200_02','附件3');">附件3</a><br>
                ≥95分，得4分； <br>
                80分≤评估分值＜95分，得2分；<br>
                60分≤评估分值＜80分，得1分；<br>
                ＜60分，不得分
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,4,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1200_03','附件4');">附件4</a><br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得3分；<br>
                60分≤评估分值＜70分，得2分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1200_04','附件5');">附件5</a>
                <br>
                评估分值≥90分，得7分；<br>
                80分≤评估分值＜90分，得5分；<br>
                70分≤评估分值＜80分，得4分；<br>
        ...
        <tr style="height:50px">
            ...
            <td>按照《住院医师规范化培训内容与标准（2022年
                版）》泌尿外科专业培训细则要求执行，为每名住
                院医师安排并完成规定的技能操作和手术（见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1200_05','附件2');">附件2</a>）
            </td>
            <td>
                随机抽查5～10名住院医师，由评估专
                家根据本专业实际需求确定手术或技
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao2" onchange="saveScore4Expert(this,7,0);" itemId="37" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="40" name="local" class="input"
