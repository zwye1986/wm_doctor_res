...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">骨科疾病种类、手术种类及例数要求</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            <th rowspan="15">骨科手术种类</th>
            <th>急性运动损伤手术</th>
            <th>≥10</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="14" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="15" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>常见部位骨折的手法复位，夹板、石膏外固定术 *</th>
            <th>≥50</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,50);" itemId="16" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>常见部位关节脱位的手法复位术 *</th>
            <th>≥10</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="17" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,25);" itemId="18" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>手外伤的清创、缝合、皮肤缺损的修复及肌腱吻合术*</th>
            <th>≥25</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,25);" itemId="19" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>开放骨折的清创、 切开复位内固定术 *</th>
            <th>≥25</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,25);" itemId="20" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="22" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="23" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="25" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>运动系统慢性损伤的局部注射术 *</th>
            <th>≥50</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,50);" itemId="26" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="28" name="two" class="input"
        ...
        <tr style="height:32px">
            <th rowspan="5">康复手术种类</th>
            <th>关节活动度维持和强化*</th>
            <th>≥20</th>
            <th></th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="29" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,15);" itemId="30" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,5);" itemId="31" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="33" name="two" class="input"
        ...
        <tr style="height:32px">
            <th colspan="6" style="text-align: left">注:*骨科专业基地必须具备的病种、治疗种类及数量</th>
        </tr>
