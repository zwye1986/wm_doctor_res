...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">外科(整形外科方向)疾病种类/临床技能操作</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px;">
            <th colspan="2">年住院病人手术量( 人次)</th>
            <th>≥480</th>
        </tr>
        <tr style="height:32px;">
            <th colspan="2">年门诊手术量( 人次)</th>
            <th>≥1440</th>
        </tr>
        <tr style="height:32px;">
            <th colspan="2">年急诊手术量( 人次)</th>
            <th>≥730</th>
        </tr>
        <tr style="height:32px;">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,100);" itemId="13" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,200);" itemId="14" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,10);" itemId="16" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="19" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>手和上、下肢畸形与缺损修复术</th>
            <th colspan="2">≥20</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="20" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,500);" itemId="23" name="two" class="input"
