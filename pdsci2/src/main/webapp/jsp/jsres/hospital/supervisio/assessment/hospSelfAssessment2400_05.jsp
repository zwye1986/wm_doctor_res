...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="7">
                <h2 style="font-size:150%">住院医师规范化培训临床技能操作带教质量评分表<br/></h2>
                <h3>（督导专家/同行评议使用）</h3>
            </th>
        </tr>
        ...
        <tr>
            <th colspan="7" style="text-align: left;">操作技能项目：
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveInpuDetail(this);" value="${detailedMap['czjnxm']}" itemId="czjnxm" class="input" type="text" style="width:200px; text-align: left"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['czjnxm']}
                </c:if>
        ...
        <tr style="height:32px;">
            <th colspan="7" style="text-align: left;">指导医师：
                <c:if test="${type eq 'Y'}">
                    ...
                    <label><input type="radio" name="zdys"  <c:if test="${detailedMap['zdys'] eq '主治医师'}">checked="checked"</c:if> onclick="checkBox(this,'住培第三年');" />&#12288;主治医师</label>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${detailedMap['zdys']}
                </c:if>
        ...
        <tr style="height:32px;">
            <th colspan="7" style="text-align: left;">指导模式：
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            ...
            <td colspan="3">专业基地在临床技能操作的组织规范，符合规范要求</td>
        ...
        <tr style="height:32px">
            <td colspan="3">临床操作技能床旁教学医师资质符合要求</td>
            ...
            <td colspan="6">
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveReason(this);" itemId="17"
                              placeholder="请填写评语" style="width: 98%;height: 200px;"
