...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;"
    ...
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——儿外科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%">
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">符合《住院医师规范化培训基地标准
                （2022年版）》和《住院医师规范化培
                训内容与标准（2022年版）》儿外科专
                业细则要求（详见<a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment1500_Main',' 附件1-1至1-7');">附件1-1至1-7</a>）
            </td>
            <td>
                现场查看
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>X射线机、C形臂X线机、空气灌肠机、B
                超机、CT、MRI、心脏彩色超声、纤维胃
                镜、纤维肠镜、纤维支气管镜、腹腔镜
                、胸腔镜、膀胱镜、尿道镜、尿动力学
                检查设备、24小时pH监测、胃肠动力检
                查设备、手术显微镜、体外循环机、自
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="13" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>病房工作期间每名住院医师日管理床位 4 ～8张(在指导医师指导下独立于其他住
                院医师管理床位)，年诊治住院病人≥
                100人次
            </td>
            <td rowspan="2">
        ...
        <tr style="height:50px">
            ...
            <td>教学查房评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1500_08','附件2');">附件2</a>
                <br>
                评估分值≥90分，得4分；   <br>
                80分≤评估分值＜90分，得3分；   <br>
                60分≤评估分值＜80分，得2分；   <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb2" onchange="saveScore4Expert(this,4,0);" itemId="35" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写质量评价表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1500_09','附件3');">附件3</a>
                <br>
                评估分值≥90分，得4分； <br>
                80分≤评估分值＜90分，得3分； <br>
                60分≤评估分值＜80分，得2分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao3" onchange="saveScore4Expert(this,4,0);" itemId="366" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment1500_10','附件4');">附件4</a>
                <br>
                评估分值≥90分，得8分；<br>
                80分≤评估分值＜90分，得6分；<br>
                70分≤评估分值＜80分，得4分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,8,0);" itemId="36" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,8,0);" itemId="37" name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注：<br>
        1.一级指标4项，二级指标11项，三级指标42项。三级指标中，核心指标17项、计64分，一般指标25项、计36分，共100分。单个核心指标达标判定标准 ：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
