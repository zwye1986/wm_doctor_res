...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px;">
            ...
            <th colspan="4" style="text-align: left;">培训专业：${speAndDept}</th>
        </tr>
        <tr style="height:32px;">
            <th colspan="3" style="text-align: left;">患者姓名：
                <c:if test="${type eq 'Y'}">
            ...
            <th colspan="4" style="text-align: left;">病案号：
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <th colspan="7" style="text-align: left;">住院医师：
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <th colspan="7" style="text-align: left;">病历类型：
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <th width="15%">考核项目</th>
            <th colspan="3" width="45%">考核内容</th>
            <th width="10%">分值</th>
            <th width="10%">得分</th>
            <th width="20%">存在问题</th>
        </tr>
        <tr style="height:32px">
            <th rowspan="7">入院记录 <br>（30分）</th>
            <td width="15%">一般项目</td>
            <td colspan="2">完整准确</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="1" name="first" class="input" type="text" value="${scoreMap['1']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['1']}
                </c:if>
        ...
        <tr style="height:32px">
            <td>拟诊讨论</td>
            <td colspan="2">结合患者，分析有条理，思路清晰</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            ...
            <td colspan="3">准确反映病情变化及诊治过程，有病情分析</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td colspan="3">重要辅助检查结果有记录及分析</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td colspan="3">重要医嘱更改记录及时，理由充分</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td colspan="3">上级医师查房条理清楚、重点突出</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td colspan="3">手术、操作、抢救记录及时完整</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td colspan="3">交接班、转科等记录及时符合要求</td>
            <td style="text-align: center">5</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            ...
            <td colspan="3">会诊单填写完整，会诊目的明确</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="17" name="first" class="input" type="text" value="${scoreMap['17']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['17']}
                </c:if>
        ...
        <tr style="height:32px">
            <td colspan="3">操作、手术等知情同意书填写准确，签字完整</td>
        ...
        <tr style="height:32px">
            <td colspan="3">传染病、院感等报告准确及时，无漏报</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="19" name="first" class="input" type="text" value="${scoreMap['19']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['19']}
                </c:if>
        ...
        <tr style="height:32px">
            <th rowspan="5">出院记录（出院病历需评估）<br/>（15分）</th>
            <td>入院情况</td>
            <td colspan="2">简洁明了，重点突出</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px">
            <td>出院情况</td>
            <td colspan="2">主要症状、体征、辅助检查、存在问题等记录清晰完整</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="22" name="first" class="input" type="text" value="${scoreMap['22']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['22']}
                </c:if>
        ...
        <tr style="height:32px">
            <td>出院诊断</td>
            <td colspan="2">完整规范</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="23" name="first" class="input" type="text" value="${scoreMap['23']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['23']}
                </c:if>
        ...
        <tr style="height:32px">
            <td>出院医嘱</td>
            <td colspan="2">具体全面（包含生活指导，药物及非药物治疗，复诊时间等）</td>
            <td style="text-align: center">3</td>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,3);" itemId="24" name="first" class="input" type="text" value="${scoreMap['24']}"  style="height:25px; text-align: center"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${scoreMap['24']}
                </c:if>
        ...
        <tr style="height:32px;">
            <td colspan="3">2.病历存在复制粘贴现象（针对电子病历）</td>
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <td colspan="3">4.严重缺项（如缺知情同意书、手术记录等）</td>
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <td colspan="3">5.严重错误（如病案号不符、病变部位左右描述错误、重要医嘱更改描述错误等）</td>
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
        ...
        <tr style="height:32px;">
            <td colspan="3">2.问诊查体等基本技能有待提高</td>
            <td colspan="3" style="text-align: center">
                <c:if test="${type eq 'Y'}">
