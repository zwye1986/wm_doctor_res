...
<head>
    ...
    <script type="text/javascript">
        ...
        function subInfo() {
            ...
            var inputSelf2 = window.parent.frames["jbox-message-iframe"].$("#fubiao11");
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">医学遗传科疾病种类/检查项目</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th colspan="2">常规检查种类/常见疾病种类</th>
            <th>最低年检查/诊治例次</th>
            <th>实际年检查/诊治例次</th>
            <th>是否达到标准数<br/>（达到划√，未达到划×）</th>
        </tr>
        <tr style="height:32px">
            <th rowspan="6">检查项目</th>
            <th>外周血核型分析</th>
            <th>400</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,400);" itemId="1" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,120);" itemId="2" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,360);" itemId="3" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,360);" itemId="4" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,360);" itemId="5" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,120);" itemId="6" name="first" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,100);" itemId="7" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,100);" itemId="8" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="10" name="two" class="input"
        ...
        <tr style="height:32px">
            <th>血液系统遗传病(地中海贫血高发省份基地/其余省份基地)</th>
            <th>50/10</th>
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,50);" itemId="11" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="13" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,30);" itemId="15" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,20);" itemId="17" name="two" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore(this,50);" itemId="20" name="two" class="input"
