...
<head>
    ...
    <script type="text/javascript">
        ...
        function scheduleOne(fileRoute, fileName) {
            ...
            if (fileRoute=='hospSelfAssessment0500_01'){
                top.jboxOpen(url, fileName, 1100, 360);
            }else {
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 740px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;width: 100%;">
        <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训专业基地评估指标 ——精神科（2023年版）</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 99%" >
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1,0);" itemId="1" itemName="总床位数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                   <textarea onchange="saveSpeReason(this);" itemId="1" itemName="总床位数" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="2" itemName="年收治病人数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="2" itemName="年收治病人数" name="reason"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="3" itemName="年门诊量" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                精神科专业基地所在医院应具备急诊科<br>
                、心血管内科、神经内科，以及消化内<br>
                科或内分泌科，检验科等，精神专科医<br>
                院需协同具备相关临床科室；精神科专<br>
                业基地相关的实验室包括辅助检查室、<br>
                心理测查科（室）和物理治疗室，均须<br>
                具备诊疗服务所要求设备
            </td>
            <td>
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                科或内分泌科，检验科等，精神专科医<br>
                院需协同具备相关临床科室；精神科专<br>
                业基地应具备精神科普通病房 (以精神<br>
                分裂症、双相/抑郁障碍为主) 、精神科<br>
                轻症病房 (以焦虑、强迫、躯体症状及<br>
                相关障碍为主)、其他专科/专病病房(若<br>
                条件限制,也可普通或轻症病房) 、精神<br>
                科门诊(和/或)急诊，相关的实验室包括<br>
                辅助检查室、心理测查科（室）和物理<br>
                治疗室
            </td>
            <td>
                1.现场查看<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="41" itemName="轮转科室" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="41" itemName="轮转科室" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地标准<br>
                （2022年版）》和《住院医师规范化培<br>
                训内容与标准（2022年版）》精神科专<br>
                业细则要求（详见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0500_01','附件1');">附件1</a>
                和
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0500_02','附件2');">附件2</a>
                ）
            </td>
            <td width="20%">
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao11" onchange="saveScore4Expert(this,3,0);" itemId="5" itemName="疾病种类及数量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="5" itemName="疾病种类及数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fubiao12" onchange="saveScore4Expert(this,3,0);" itemId="6" itemName="临床技能操作种类及数量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="6" itemName="临床技能操作种类及数量" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                具备教学模拟设备，至少应包含普通心<br>
                肺复苏模拟人1台、腰穿模型1台、体外<br>
                除颤训练器
            </td>
            <td width="20%">
                现场查看
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="45" itemName="教学设施和设备" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['45']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['45']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="45" itemName="教学设施和设备" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                协同单位数量不超过3家，协同培训的科<br>
                室（含亚专业）不超过3个，在协同培训<br>
                单位的轮转时间累计不超过6个月
            </td>
            <td width="20%">
                现场查看
        ...
        <tr style="height:50px">
            ...
            <td>
                具有医学本科及以上学历，主治医师专<br>
                业技术职务，从事本专业医疗、教学工<br>
                作5年及以上
            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="11" itemName="指导医师条件" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="11" itemName="指导医师条件" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                高级专业技术职务（含主任医师和副主<br>
                任医师）与主治医师比例至少1:1；<br>
                综合医院精神科专业基地应保有在职指<br>
                导医师5名及以上，精神专科医院专业基<br>
                地应保有在职指导教师20名及以上
            </td>
            <td>
                符合标准，得1分<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="13" itemName="指导医师组成" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="13" itemName="指导医师组成" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                教学绩效考核不低于考核总分的8%，考<br>
                核结果与专业技术职务晋升挂钩，得4分<br>
                教学绩效考核占考核总分的5%～8%之<br>
                间，得2分<br>
                教学绩效考核占考核总分低于5%或不纳<br>
                入，不得分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,4,0);" itemId="18" itemName="激励制度" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="19" itemName="专业基地负责人" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                综合医院在培住院医师≥10名，专科医<br>
                院在培住院医师≥18名，不能超容量招<br>
                收
            </td>
            <td>
                1.现场查看<br>
            ...
            <td width="20%">
                招收在容量测算数内，完成招收任务，<br>
                且综合医院在培住院医师≥10名，专科<br>
                医院在培住院医师≥18名，得2分<br>
                容量测算科学合理，近三年未完成招收<br>
                任务，但综合医院在培住院医师≥<br>
                10名，专科医院在培住院医师≥18名，<br>
                得1分<br>
                综合医院在培住院医师＜10名，专科医<br>
                院在培住院医师＜18名，或超容量招<br>
                收，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="26" itemName="教学查房" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2);" itemId="50" itemName="专业特色活动" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['50']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['50']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                    <textarea onchange="saveSpeReason(this);" itemId="50" itemName="专业特色活动" name="reason"
                              placeholder="请填写详细情况" style="width: 98%;height: 98%"
                              class="text-input validate[required,maxSize[1000]]">${contentMap['50']}</textarea>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    ${contentMap['50']}
                </c:if>
            </td>
            <td name="file" itemId="50"></td>
        </tr>
        <tr style="height:50px">
            <td rowspan="3">
                3.4过程考核
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,1);" itemId="32" itemName="年度考核" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                在急诊科、神经内科、心血管内科及消<br>
                化内科（或内分泌科）病房工作期间每<br>
                名住院医师日管理床位≥3张，管理病人<br>
                ≥47例，管理急诊病人≥70例；<br>
                在精神科普通病房、轻症病房、专科或<br>
                专门病房工作期间，管床≥4张，管理病<br>
                人≥25例
            </td>
            <td width="20%" rowspan="2">
                查看轮转手册（或医院相关电子系<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,2,0);" itemId="33" itemName="管理床位数" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                  <textarea onchange="saveSpeReason(this);" itemId="33" itemName="管理床位数" name="reason"
                            placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="47" itemName="门急诊工作量" name="local" class="input"
                           type="text" style="height:20px;width: 25px; text-align: center" value="${scoreMap['47']}"/>
                </c:if>
                <c:if test="${type ne 'Y'}">
                    <span name="local">${scoreMap['47']}</span>
                </c:if>
            </td>
            <td>
                <c:if test="${type eq 'Y'}">
                  <textarea onchange="saveSpeReason(this);" itemId="47" itemName="门急诊工作量" name="reason"
                            placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                教学查房评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0500_03','附件3');">附件3</a>
                <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb3" onchange="saveScore4Expert(this,6,0);" itemId="34" itemName="教学查房质量" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                <textarea onchange="saveSpeReason(this);" itemId="34" itemName="教学查房质量" name="reason"
                          placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                1.住院医师操作前进行有效的交流，并<br>
                与患者沟通核实，得1分<br>
                2.住院医师操作中如遇重大医疗安全隐<br>
                患或将造成患者较大伤害的，应予以及<br>
                时制止与纠正，得1分<br>
                3.住院医师操作结束后提问，得1分<br>
                4.对住院医师的操作采用合适的反馈方<br>
                式进行总体评价，如有必要进行适当示<br>
                范，得2分
            </td>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="35" itemName="技能操作带教" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
               <textarea onchange="saveSpeReason(this);" itemId="35" itemName="技能操作带教" name="reason"
                         placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                <a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0500_04','附件4');">附件4</a>
                <br>
                评估分值≥90分，得6分； <br>
                80分≤评估分值＜90分，得5分； <br>
                70分≤评估分值＜80分，得3分； <br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input id="fb4" onchange="saveScore4Expert(this,6,0);" itemId="36" itemName="病历书写" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                <a href="javascript:void(0)" onclick="scheduleMany('hospSelfAssessment0500_Main','附件5');">附件5</a>
                <br>
                评估分值≥90分，得5分；<br>
                80分≤评估分值＜90分，得4分；<br>
                70分≤评估分值＜80分，得3分；<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input type="hidden" id="scoreInfo51" value="${scheduleMap['scoreInfo51']}" name="scoreOneInfo">
                    <input type="hidden" id="scoreInfo52" value="${scheduleMap['scoreInfo52']}" name="scoreOneInfo">
                    <input type="hidden" id="scoreInfo53" value="${scheduleMap['scoreInfo53']}" name="scoreOneInfo">
                    <input id="fubiao5" onchange="saveScore4Expert(this,5,0);" itemId="37" itemName="技能操作" name="local" class="input"
            ...
            <td>
                <c:if test="${type eq 'Y'}">
                <textarea onchange="saveSpeReason(this);" itemId="37" itemName="技能操作" name="reason"
                          placeholder="请填写详细情况" style="width: 98%;height: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                培训细则要求执行，住院医师完成规定<br>
                的技能操作情况（见<a href="javascript:void(0)" onclick="scheduleOne('hospSelfAssessment0500_02','附件2');">附件2</a>）
            </td>
            <td width="20%">
                查看轮转手册等相关材料，随机抽<br>
                查访谈本院、委培、社会招收住院<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,5,0);" itemId="38" itemName="完成培训内容与要求" name="local" class="input"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                的平均通过率，得3分；低于近三年全国<br>
                本专业住院医师首次参加执业医师资格<br>
                考试的平均通过率5个百分点，得2分，<br>
                其他情况不得分<br>
                （近三年本专业住院医师首次参加执业<br>
            ...
            <td width="56px" style="text-align: center">
                <c:if test="${type eq 'Y'}">
                    <input onchange="saveScore4Expert(this,3);" itemId="39"  name="local" class="input"
    ...
    <div style="margin-top: 20px;">
        备注： <br>
        1.一级指标4项，二级指标11项，三级指标41项。三级指标中，核心指标18项、计65分，一般指标23项、计35分，共100分。单个核心指标达标判定标准：单个核心指标得分率≥70%为达标，＜70%为不达标。其中，单项指标满分为3分的，若评估得2分的则判定为达标。<br>
