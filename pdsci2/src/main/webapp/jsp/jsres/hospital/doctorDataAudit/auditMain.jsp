...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		//jboxStartLoading();
		//jboxPostLoad("doctorListZi","<s:url value='/jsres/doctorDataAudit/auditList'/>?roleFlag=${roleFlag}",$("#searchForm").serialize(),true);
	}
		...
		<table class="searchTable" style="width: 100%;border-collapse:separate; border-spacing:0px 10px;">
			...
			<tr>
				...
				<td colspan="4" style="text-align: center;">
					...
					<input class="btn_green" type="button" value="批量审核" onclick="exportInfo();"/>
				</td>
			</tr>
		</table>
	</form>
