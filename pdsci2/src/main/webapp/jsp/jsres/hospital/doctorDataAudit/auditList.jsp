...
<c:if test="${not empty list}">
	...
	function showAllInfo(recruitFlow,applyYear)
	{
		...
		jboxOpen(url, "学员报考材料查看",1380,500);
	}
//毕业证书图片
		...
		<table class="grid" style="width: auto;" id="dataTable">
			...
			<c:forEach items="${list}" var="doctor">
				<tr class="fixTrTd">
					...
					<td style="min-width: 150px; max-width: 150px; " class="by"><a href="javascript:void(0);" onclick="showScore('${doctor.scoreFlow}','${doctor.recruitFlow}')">${doctor.isPass}</a></td>
