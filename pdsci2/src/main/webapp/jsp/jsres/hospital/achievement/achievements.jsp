    ...
    <div class="div_search">
        <form id="searchForm" action="<s:url value='/jsres/hospital/getAchievementList'/>" method="post">
            ...
            <div class="form_search">
                ...
                <div class="form_item form_item_hide" style="width:500px ;">
                    <div class="form_label">排序方式：</div>
                    <input type="radio" name="sortType" value="Exam"  id="radioa"  <c:if test="${param.sortType eq 'Exam'}"> checked</c:if> /><label style="margin: auto 0" for="radioa">按笔试成绩</label>&#12288;
                    <input type="radio" name="sortType" value="Interview"  id="radio0"  <c:if test="${param.sortType eq 'Interview'}"> checked</c:if> /><label style="margin: auto 0" for="radio0">按面试成绩</label>&#12288;
                    <input type="radio" name="sortType" value="Skill" id="radio1" <c:if test="${param.sortType eq 'Skill'}">checked</c:if> /><label style="margin: auto 0" for="radio1">按操作成绩</label>&#12288;
...
<%--                <div>--%>
<%--                    <label class="form_label">录取状态：</label>--%>
<%--                    <select style="width: 161px" name="recruitFlag" class="select" >--%>
<%--                       <option value="">全部</option>--%>
<%--                       <option value="F" ${param.recruitFlag eq 'F'?'selected':''}>待审核</option>--%>
<%--                       <option value="Y" ${param.recruitFlag eq 'Y'?'selected':''}>已录取</option>--%>
<%--                       <option value="N" ${param.recruitFlag eq 'N'?'selected':''}>未录取</option>--%>
...
<%--                </div>--%>
<%--                <div>--%>
<%--                    <label class="form_label">排序方式：</label>--%>
