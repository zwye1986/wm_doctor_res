...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("achievementContent","<s:url value='/jsres/hospital/getAchievementDetails?scoreType=exam'/>",$("#searchForm").serialize(),false);
    }
    ...
    function impExamResult(){
        jboxOpen("<s:url value='/jsp/jsres/hospital/achievement/importExamResult.jsp'/>", "笔试成绩单导入", '600', '300');
    }
            ...
            <div style="display: flex;justify-content: space-between; margin-top: 15px">
             ...
             <div id="hideForm" style="display: none;justify-content: flex-start; column-gap: 65px;  margin-top: 15px">
                <div>
                    ...
                    <select style="width: 161px" name="examStatusId" class="select">
                        <option value="">全部</option>
