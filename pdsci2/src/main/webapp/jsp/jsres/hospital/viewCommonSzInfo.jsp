...
<div style="height: 760px;overflow-y: auto">
	<c:if test="${not empty roleFlag and roleFlag eq 'global'}">
		<div class="div_table">
			<h5><svg width="3" height="12" class="vertical-line"></svg>&#12288;基地信息</h5>
			<table border="0" cellspacing="0" cellpadding="0" class="base_info " style="margin-top: 6px">
				...
				<tbody>
				<tr>
					<th style="background-color: #f4f5f9; text-align: center">基地编号</th>
					<td style="text-align: center">${sysOrg.orgCode}</td>
					<th style="background-color: #f4f5f9; text-align: center">基地名称</th>
					<td style="text-align: center">${sysOrg.orgName}</td>
				</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="div_table" <c:if test="${not empty roleFlag and roleFlag eq 'global'}"> style="margin-top: 10px"</c:if>>
