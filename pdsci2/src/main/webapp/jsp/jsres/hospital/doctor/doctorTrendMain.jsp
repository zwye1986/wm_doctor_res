...
<script type="text/javascript">
	...
	function getInfo(doctorFlow){
		...
		var url = "<s:url value='/jsres/manage/province/doctor/doctorMain'/>?doctorFlow="+doctorFlow+"&hideApprove="+hideApprove;
...
<div class="main_bd" id="div_table_0" >
	...
	<form id="searchForm">
	   ...
	   &#12288;&#12288;&nbsp;
		届&#12288;&#12288;别：<input type="text" name="sessionNumber" value="${param.sessionNumber}" style="width: 100px;" class="input"/>
		 <br/>
