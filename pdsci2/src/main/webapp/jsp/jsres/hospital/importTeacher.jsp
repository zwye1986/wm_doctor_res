...
function importUsers(){
	...
	jboxStartLoading();
	var url = "<s:url value='/jsres/manage/importTeacherTrainingExcel'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="grid" style="width: 100%;margin-top: 30px">
		...
		<tr>
			<th>模板文件</th>
			<td style="padding-left:10px;"><a href="<s:url value='/jsp/sys/impactorFactor/template/teacherTrainingTemplate.xlsx'/>">师资导入模板.xlsx</a></td>
		</tr>
	</table>
	<br/>
	<p style="text-align: center;">
		<input type="button" onclick="importUsers();" value="确认导入" class="btn_green"/>
	</p>
</form>
</body>
</html>