...
//                $("#qrcode3").show();
        ...
        function  down2(name)
        {
            $('#qrcode2 canvas').downCanvasImg("【签退二维码】（此二维码在讲座结束前${endTime}钟至结束后${endTime}分钟内有效）.png");
        }
        function  down3(name)
        {
...
<div id="SingnDiv" style="display: none;">
    ...
    <div>
        【签到二维码】（此二维码在讲座开始前${startTime}钟至结束后${startTime}分钟内有效）
    </div>
...
<div id="SingnOutDiv" style="display: none;">
    ...
    <div>
        【签退二维码】（此二维码在讲座结束前${endTime}钟至结束后${endTime}分钟内有效）
    </div>
