...
<script>
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("detail8","<s:url value='/jsres/monthlyReport/detail8'/>",$("#searchForm").serialize(),false);
    }
    function exportExl(){
        var url = "<s:url value='/jsres/monthlyReport/exportDetail8'/>";
        jboxTip("导出中…………");
        ...
        <form id="searchForm">
            ...
            <table class="searchTable">
                <tr>
                    ...
                    <td>
                        <input type="text" name="teacherUserName" value="" class="input"/>
                    </td>
                    <td>
