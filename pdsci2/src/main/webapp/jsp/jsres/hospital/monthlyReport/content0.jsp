...
<script>
    $(function(){
        jboxLoad("content1","<s:url value='/jsres/monthlyReport/content1'/>?baseRange=1&monthDate=${monthDate}",false);
    })
    function content1(baseRange){
        jboxLoad("content1","<s:url value='/jsres/monthlyReport/content1'/>?baseRange="+baseRange+"&monthDate=${monthDate}",false);
    }
</script>
