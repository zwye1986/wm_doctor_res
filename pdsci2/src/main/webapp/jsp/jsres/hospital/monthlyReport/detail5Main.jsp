...
<script>
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("detail5","<s:url value='/jsres/monthlyReport/detail5'/>",$("#searchForm").serialize(),false);
    }
    function exportExl(){
        var url = "<s:url value='/jsres/monthlyReport/exportDetail5'/>";
        jboxTip("导出中…………");
        jboxExp($("#searchForm"),url);
    }
    function exportExl2(){
        var url = "<s:url value='/jsres/monthlyReport/exportDoctorDetail5'/>";
        jboxTip("导出中…………");
        jboxExp($("#searchForm"),url);
    }
            ...
            <table class="searchTable">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        <input class="btn_green" type="button" value="导出列表" onclick="exportExl();"/>
                        <input class="btn_green" type="button" value="导出详情" onclick="exportExl2();"/>
                    </td>
                </tr>
            </table>
        </form>
