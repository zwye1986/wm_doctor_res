...
<script>
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("detail7","<s:url value='/jsres/monthlyReport/detail7'/>",$("#searchForm").serialize(),false);
    }
    function exportExl(){
        var url = "<s:url value='/jsres/monthlyReport/exportDetail7'/>";
        jboxTip("导出中…………");
...
<div class="main_bd" id="div_table_0">
    ...
    <div id="detail7" style="overflow: auto">
    </div>
</div>
