...
function returnUrl(){
	...
	console.log(window.parent.$("#"+"divFile_"+id)[0]);
	window.parent.$("#"+"divFile_"+id)[0].innerHTML+=(html);
	//window.parent.searchEvaluationInfo();
...
<body>
<div class="infoAudit">
	<form id="uploadFileForm" method="post" style="position:relative;" action="<s:url value='/jsres/evaluation/checkUploadFile'/>?itemId="+${itemId} enctype="multipart/form-data">
		...
		<div id="uploadFileDiv" style="display: ${empty result?'':'none'}">
			<div style="text-align: center;vertical-align: middle;">
				<table style="width: 100%;border: 1px solid #e3e3e3; height: 100px;margin-top: 25px;">
					<tr><td style="border: 1px solid #e3e3e3;">上传文件：</td><td style="text-align: left;padding-left: 10px;"><input type="file" name="uploadFile" class="validate[required] auto" style="border: none;" onchange="checkFile(this);" accept="${sysCfgMap['res_file_support_suffix']}"/></td></tr>
