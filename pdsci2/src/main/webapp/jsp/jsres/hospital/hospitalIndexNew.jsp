...
//	});
    ...
    <script>
        ...
        function doctorList() {
            ...
            jboxLoad("content", "<s:url value='/jsres/doctorRecruit/provinceDoctorList'/>?roleFlag=" + roleFlag + "&orgFlow=${sessionScope.currUser.orgFlow}", true);
        }

        function temporaryOutSearch() {
            jboxLoad("content", "<s:url value='/res/manager/temporaryOutSearch'/>?roleId=org&biaoJi=Y",true);
        }
        ...
        function asseWaitAudit() {
            ...
            jboxLoad("content", "<s:url value='/jsres/menuNew/asseMain'/>?roleFlag=" + roleFlag + "&tabTag=FristWait&catSpeId=DoctorTrainingSpe", true);
        }
        ...
        function asseAuditList() {
            var roleFlag = "${GlobalConstant.USER_LIST_LOCAL}";
            jboxLoad("content", "<s:url value='/jsres/menuNew/asseAuditListMain'/>?roleFlag=" + roleFlag + "&tabTag=FristList&catSpeId=DoctorTrainingSpe", true);
        }
        ...
        function schedulingMain() {
            var url = "<s:url value='/jsres/menuNew/schedulingMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function rotationMainList() {
            jboxLoad("content", "<s:url value='/jsres/menuNew/rotationMainList'/>", true);
        }
        function rotationMain() {
            var url = "<s:url value='/jsres/menuNew/rotationMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function activityMain() {
            var url = "<s:url value='/jsres/menuNew/activityMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function hospitalSubject() {
            var url = "<s:url value='/jsres/menuNew/hospitalSubject'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function cycleMain() {
            var url = "<s:url value='/jsres/menuNew/cycleMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function doctorDataMain() {
            var url = "<s:url value='/jsres/statistic/doctorDataMain'/>?roleFlag=local";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function leaveSearch(form) {
            jboxLoad("content", "<s:url value='/jsres/attendanceNew/leaveVerifyList/manager'/>", true);
        }

        function kqStatistics(form) {
            jboxLoad("content", "<s:url value='/jsres/attendanceNew/kqStatisticsList/manager'/>", true);
        }
        ...
        function schedulingAudit() {
            jboxLoad("content", "<s:url value='/jsres/doctorRecruit/schedulingAudit'/>", true);
        }

        //排班查询
        function schedulingSearch() {
            jboxLoad("content", "<s:url value='/jsres/doctorRecruit/schedulingSearch'/>", true);
        }
        ...
        //查看请假
        function leaveMain(form) {
            var url = "<s:url value='/jsp/jsres/attendance/hospital/leaveMain.jsp'/>";
            jboxLoad("content", url, false);
        }
        ...
        function zlcxMain() {
            var url = "<s:url value='/jsres/menuNew/zlcxMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function szMain() {
            var url = "<s:url value='/jsres/menuNew/szMain'/>";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function hospitalSelfAssessment() {
            jboxLoad("content","<s:url value='/jsres/supervisio/hospitalSelfAssessment'/>",true);
        }
        //督导基地自评
        ...
        function reductionTab() {
            var url = "<s:url value='/jsres/reduction/reductionTab?roleId=${GlobalConstant.USER_LIST_LOCAL}'/>";
            currentJboxLoadNoData("content", url, true);
        }

        function showSelectMenu() {
            window.open("<s:url value='/jsres/manage/local?'/>", "_blank")
        }
    </script>
    <style>
        .side-button {
...
<%--	                            <a><c:out value="${param.actionName}" default="切换"/></a>&#12288;--%>
            ...
            <div class="body">
                <div class="container">
                    ...
                    <div id="menuNew" class="content_side">
                        <input type="hidden" id="orgFlow3" value='${orgFlow}'/>
                        <dl class="menu menu_first">
                            <a class="side-button" href="#" onclick="showSelectMenu();">切<br/>换<br/>旧<br/>版<br/>菜<br/>单</a>

                            <dt class="menu_title">
                                <i class="icon_menu menu_function"></i>基地管理
                            </dt>
                            <dd class="menu_item"><a href="javascript:hosMain('${sessionScope.currUser.orgFlow}');">基地信息管理</a>
                            </dd>
                            <%--<dd class="menu_item" id="evaluation"><a onclick="searchEvaluationInfo();">培训基地评估</a></dd>--%>
                            <dd class="menu_item"><a href="javascript:baseInfo();">科室管理</a></dd>
                            <dd class="menu_item"><a href="javascript:baseAllocationDetails();">基地拨付详情</a></dd>
                            <dd class="menu_item"><a href="javascript:hospitalSelfAssessment();">医院基地自评</a></dd>
                            <dd class="menu_item"><a href="javascript:hospitalSpeSelfAssessment();">专业基地自评</a></dd>
                        </dl>
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_doctor"></i>人员管理
                            </dt>
                            <dd class="menu_item" id="doctorList"><a onclick="doctorList();">学员管理</a></dd>
                            <dd class="menu_item"><a onclick="reductionTab();">减免管理</a></dd>
                            <dd class="menu_item"><a onclick="changeBaseMain();">学员变更查询
...
<%--                                &lt;%&ndash;<img  id="speFlag" style="display: none;" src="<s:url value="/jsp/jsres/images/gantanhao.png" />"/>&ndash;%&gt;--%>
<%--                            </a></dd>--%>
<%--                            <dd class="menu_item"><a onclick="delay();">延期学员查询</a></dd>--%>
<%--                            <dd class="menu_item"><a--%>
<%--                                    &lt;%&ndash;href="javascript:backTrain();"&ndash;%&gt;onclick="backTrain()">退培学员查询</a></dd>--%>
                            <dd class="menu_item"><a
                                    <%--href="javascript:searchBlackInfo();"--%>onclick="searchBlackInfo()">黑名单管理</a>
                            </dd>
                            <dd class="menu_item"><a onclick="szMain();">师资管理</a></dd>
                            <dd class="menu_item"><a onclick="professionalBaseManagerList();">部门管理员</a></dd>
                            <dd class="menu_item"><a onclick="hsxxgl();">护士管理</a></dd>
                        </dl>
                        <dl class="menu">
                            <dt class="menu_title">
                            ...
                            <c:if test="${pdfn:jsresPowerCfgMap(key) eq GlobalConstant.RECORD_STATUS_Y}">
                                <dd class="menu_item"><a onclick="zljh();">招录计划</a></dd>
                            </c:if>


                            <dd class="menu_item"><a onclick="bmsh();">招录考核</a></dd>
                            <dd class="menu_item"><a onclick="xycjgl();">成绩管理</a></dd>
                            <dd class="menu_item"><a onclick="zlxygl();">录取管理</a></dd>
                            ...
                            <dd class="menu_item"><a onclick="zlcxMain();">统计查询</a></dd>
<%--                            <dd class="menu_item"><a onclick="zlDocQuery();">招录学员查询</a></dd>--%>
                        </dl>
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_management_train_query"></i>过程管理
                            </dt>
                            <dd class="menu_item" id="recruitAuditSearch"><a onclick="recruitAuditSearch();">报到管理</a>
                            </dd>
<%--                            <dd class="menu_item" id="reductionRotationOper"><a onclick="reductionRotationOper();">排班管理--%>
<%--                                &lt;%&ndash;<img  id="reducationCount" style="display: none;" src="<s:url value="/jsp/jsres/images/gantanhao.png" />"/>&ndash;%&gt;--%>
<%--                            </a>--%>
                            <dd class="menu_item"><a onclick="schedulingMain();">排班管理</a></dd>
                            <dd class="menu_item"><a onclick="admissionEducationManage()">入科管理</a></dd>

                            <dd class="menu_item"><a onclick="rotationMain();">轮转数据</a></dd>
                            <dd class="menu_item"><a onclick="rotationMainList();">轮转查询</a></dd>

                            <dd class="menu_item"><a onclick="activityMain();">教学管理</a></dd>


                            <c:if test="${hospitalSupervisor eq 'Y'}" >
                                <dd class="menu_item"><a onclick="hospitalSubject();">督导管理</a></dd>
<%--                                <dl class="menu">--%>
<%--                                    <dt class="menu_title">--%>
...
<%--                                </dl>--%>
                            ...
                            <dd class="menu_item"><a onclick="cycleMain();">出科管理</a></dd>
...
<%--                            <dd class="menu_item"><a onclick="afterDataBack();">出科数据恢复</a></dd>--%>
                        ...
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_360check"></i>督导管理
                            </dt>
                        ...
                        <dl class="menu">
                            ...
                            <dd class="menu_item"><a onclick="asseWaitAudit();">结业资格管理</a></dd>
                            <dd class="menu_item"><a onclick="asseAuditList();">补考管理</a></dd>
<%--                            			   <dd class="menu_item"><a onclick="searchAsseList();">考核资格查询</a></dd>--%>
                            <dd class="menu_item"><a onclick="scoreManage()">成绩管理</a></dd>
                            <%--<dd class="menu_item"><a &lt;%&ndash;href="javascript:signUpmain();"&ndash;%&gt;onclick="signUpmain()">补考审核</a></dd>--%>
                            <%--<dd class="menu_item"><a onclick="skillTestManage();">技能考核管理</a></dd>--%>
                            <dd class="menu_item"><a onclick="certificateManageNew();">证书管理</a></dd>
                        ...
                        <c:if test="${pdfn:jsresPowerCfgMap(key) eq GlobalConstant.RECORD_STATUS_Y}">
                            <dl class="menu">
                                ...
                                <dd class="menu_item"><a onclick="signinSet();">考勤设置</a></dd>


                                <dd class="menu_item"><a onclick="attendanceTab()">日常考勤</a></dd>
<%--                                <dd class="menu_item"><a onclick="attendBack();">退回日常考勤</a></dd>--%>

                                <dd class="menu_item"><a onclick="leaveMain()">请假管理</a></dd>

<%--                                <dd class="menu_item"><a onclick="timeSet();">请假参数配置</a></dd>--%>
<%--                                <dd class="menu_item"><a onclick="leaveSearch();">学员请假管理</a></dd>--%>
<%--                                <dd class="menu_item"><a onclick="kqStatistics();">查询统计</a></dd>--%>
                            </dl>
                        </c:if>
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_360check"></i>考核管理
                            </dt>
<%--                            <dd class="menu_item"><a href="javascript:EvaStudent();">评价学员</a></dd>--%>
                            <dd class="menu_item"><a href="javascript:pjjgcx('global');">360°评价</a></dd>
                            <dd class="menu_item"><a onclick="graduationExam()">理论考核</a></dd>
                        </dl>
                        ...
                        <dl class="menu">
                            ...
                            <dd class="menu_item"><a onclick="doctorDataMain()">学员填写量</a></dd>
                            <dd class="menu_item"><a onclick="teacherAuditMain()">带教审核量</a></dd>
                        </dl>
                        ...
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_system"></i>信息管理
                            </dt>
                            <dd class="menu_item"><a onclick="zlxxfb();">通知公告</a></dd>
                            <c:set value="jsres_hospital_zpyjfk_${sessionScope.currUser.orgFlow }" var="key"/>
                            <c:if test="${pdfn:jsresPowerCfgMap(key) eq GlobalConstant.RECORD_STATUS_Y}">
                                <dd class="menu_item"><a onclick="opinions(null)">意见反馈</a></dd>
                            </c:if>
                        </dl>
                        <dl class="menu">
                            <dt class="menu_title">
                                <i class="icon_menu menu_system"></i>个人中心
                            </dt>
                        ...
                        <dl class="menu">
                            ...
                            <dd class="menu_item"><a
                                    <%--href="javascript:accountManage();"--%>onclick="accountManage()">用户管理</a></dd>
<%--                            <dd class="menu_item"><a &lt;%&ndash;href="javascript:accounts();"&ndash;%&gt;onclick="accounts()">安全中心</a>--%>
<%--                            </dd>--%>
                        </dl>
