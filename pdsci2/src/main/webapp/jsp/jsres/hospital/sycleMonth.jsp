...
<script type="text/javascript">
    ...
    function exportInfo() {
        ...
        var url ="";
        if(papersFlag){
            url = "<s:url value='/jsres/doctorRecruit/exportCycleResultsAndPapers?schEnd='/>" + schEndDate + "&schStart=" + schStatrDate;
        }else{
            url = "<s:url value='/jsres/doctorRecruit/exportCycleResults?schEnd='/>" + schEndDate + "&schStart=" + schStatrDate;
        }
        var data = top.$("#searchForm").serialize();
        jboxTip("导出中…………");
