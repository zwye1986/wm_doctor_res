...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectTea(stationFlow,stationName){//房间流水号recordFlow，用来判定编辑则清空$("#teaTD")内容
            ...
            // jboxMessager(iframe,'编辑考官',300,320,true);
...
<div class="mainright">
        <form id="myForm">
            ...
            <table class="grid" style="width:100%; margin-bottom: 10px; margin-top: 30px;">
                <tr>
                    <th style="text-align:right;width:35%;">房间名称：</th>
                    <td>
                        <select id="roomFlow" name="roomFlow" style="width:137px;" class="validate[required] select" ${empty param.recordFlow?"":"disabled='disabled'"}>
                            <option/>
