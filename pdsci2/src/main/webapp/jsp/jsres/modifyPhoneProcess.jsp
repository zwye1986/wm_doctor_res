...
<head><title>江苏省住院医师规范化培训管理平台</title>
    ...
    <link rel="stylesheet" type="text/css"
          href="<s:url value='/css/skin/LightBlue/basic.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
    <script type="text/javascript">
        ...
        function register() {
            ...
            if ($("#userPhone").val() == "${sessionScope.currUser.userPhone}") {
                jboxTip("与当前绑定手机号相同，请重新输入");
                return;
            }
            if ($("#verifyCode").val() == "") {
                jboxTip("验证码不能为空");
        ...
        function checkPhone(obj) {
            ...
            var url = "<s:url value='/inx/jsres/modifyPhone'/>";
            jboxPost(url, {"userPhone": $("#userPhone").val()},
                function (resp) {
                    jboxTip(resp);
        ...
        <div class="title1 clearfix">
            <div id="tagContent">
                <div class="tagContent selectTag" id="tagContent0">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="userPhone" id="userPhone"
                                       onkeydown="clearUselessInfo()" class="validate[custom[mobile] required] xltext"
                                       />
                    ...
                    <div class="button">
                        <input type="button" value="确&nbsp;&nbsp;定" onclick="register();" id="registerButton"
                               class="search"
