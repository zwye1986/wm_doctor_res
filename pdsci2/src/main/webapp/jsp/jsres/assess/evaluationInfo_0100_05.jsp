...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">临床能力考核评分表</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="2">考核项目：${assessmentName}</th>
            <th style="text-align:left;padding-left: 4px;" colspan="3"></th>
        </tr>
