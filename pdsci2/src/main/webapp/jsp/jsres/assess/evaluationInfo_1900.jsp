...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——麻醉科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="21">1.基本条件（18分）</td>
            <td style="height:53px;" rowspan="18">1.1专业基地所在医院条件</td>
            <td>1.1.1年麻醉总量</td>
            <td width="313px">
                麻醉总数量≥10000例 <br>
                麻醉恢复室≥2500例<br>
            ...
            <td name="file" itemId="2022-1.1.1" itemName="年麻醉总量" width="180px"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
                       itemName="年麻醉总量" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.1" itemName="年麻醉总量" name="expert"
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input   type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','self','2','1项不达标，不得分')"/>
                    &nbsp;<label >1项不达标，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label >符合标准，得2分</label><br>
                    <input type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','expert','2','1项不达标，不得分')"/>
                    &nbsp;<label >1项不达标，不得分</label>
                </c:if>
                ...
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-1.1.1" itemName="年麻醉总量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td rowspan="9">1.1.2年亚专业麻醉例数</td>
            <td>
                普通外科麻醉≥2400例，泌尿外科麻醉≥800例，骨科麻醉≥800例
            </td>
            <td rowspan="9">检查相关统计报表复印件，需加盖医院公章</td>
            <td rowspan="9">
                符合标准，得3分<br>
                1项不达标，得2分<br>
                2项及以上不达标，不得分
            ...
            <td rowspan="9" name="file" itemId="2022-1.1.2" itemName="年亚专业麻醉例数"></td>
            <td rowspan="9"><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.2" itemName="年亚专业麻醉例数" name="self"
                                   class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="9"><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.2" itemName="年亚专业麻醉例数"
                                   name="expert" class="input" type="text"
                                   style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="9">
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"   name="2022-1.1.2" value="3" onchange="selectRadio('2022-1.1.2','3','self','3','')"/>
                    &nbsp;<label >符合标准，得3分</label><br>
                    <input  type="radio"  name="2022-1.1.2" value="2" onchange="selectRadio('2022-1.1.2','2','self','3',' 1项不达标，得2分')"/>
                    &nbsp;<label > 1项不达标，得2分</label><br>
                    <input  type="radio"  name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','self','3','2项及以上不达标，不得分')"/>
                    &nbsp;<label >2项及以上不达标，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.2" value="3" onchange="selectRadio('2022-1.1.2','3','expert','3','')"/>
                    &nbsp;<label >符合标准，得3分</label><br>
                    <input   type="radio"   name="2022-1.1.2" value="2" onchange="selectRadio('2022-1.1.2','2','expert','3',' 1项不达标，得2分')"/>
                    &nbsp;<label > 1项不达标，得2分</label><br>
                    <input   type="radio"   name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','expert','3','2项及以上不达标，不得分')"/>
                    &nbsp;<label >2项及以上不达标，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-1.1.2" itemName="年亚专业麻醉例数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>
                眼、耳鼻喉科麻醉≥700例（其中，眼科麻醉≥150）
            </td>
        </tr>
        <tr style="height:50px">
            <td>
        ...
        <tr style="height:50px">
            <td>
                心血管外科麻醉≥200例，胸外科麻醉≥400例
            </td>
        </tr>
        <tr style="height:50px">
            <td>
                妇产科麻醉≥400例（其中，产科麻醉≥200例）
            </td>
        </tr>
        <tr style="height:50px">
            <td>
        ...
        <tr style="height:50px">
            <td>1.1.3轮转科室</td>
            <td>
                1.麻醉科室(必选)：普外科麻醉、骨科麻醉、泌尿外科麻醉、眼科和耳鼻咽喉科麻醉、口腔外科麻醉、神经外科麻醉、胸心血管外科麻醉、妇产科麻醉、小儿外科麻醉、门诊和手术室外麻醉、麻醉恢复室、疼痛科、重症监护
                <br>
                2.非麻醉科室(任选2～3个)：普通外科、神经内科、神经外科、胸心外科、呼吸内科、心血管内科、内分泌科、小儿内科、急诊科、心电图室、影像科
            </td>
            <td>
                1.查看各(亚)专业设置名称<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio" name="2022-1.1.3" value="2" onchange="selectRadio('2022-1.1.3','2','self','2','')"/>
                    &nbsp;<label >轮转科室齐全，得2分</label><br>
                    <input   type="radio"   name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','self','2','必选科室缺1个科室或任选科室缺2个科室，不得分')"/>
                    &nbsp;<label > 必选科室缺1个科室或任选科室缺2个科室，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.3" value="2" onchange="selectRadio('2022-1.1.3','2','expert','2','')"/>
                    &nbsp;<label>轮转科室齐全，得2分</label><br>
                    <input  type="radio"  name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','expert','2','必选科室缺1个科室或任选科室缺2个科室，不得分')"/>
                    &nbsp;<label >必选科室缺1个科室或任选科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="轮转科室" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.3']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.4疾病种类及数量★</td>
            <td>
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》麻醉科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1900_01','附表1');">
                        附表1</a>
            </td>
            <td>
            ...
            <td><input id="fubiao11" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao11Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input id="fubiao12" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.5']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td rowspan="2">1.1.6麻醉科室设备</td>
            <td>
                有创血压监测设备、除颤器、 血气分析仪、快速输血系统、保温及降温设备、微量注射泵、血糖仪、肌松监测仪、神经刺激器、血液回收机、纤维支气管镜及应对呼吸困难的常用设备，体温监测仪，床旁超声仪
            </td>
            <td rowspan="2">检查设备清单复印件，需加盖医院公章，实地考察
            </td>
            <td rowspan="2">
                缺1项，不得分
            </td>
            <td rowspan="2" style="text-align: center;">2</td>
            <td rowspan="2" name="file" itemId="2022-1.1.6" itemName="麻醉科室设备"></td>
            <td rowspan="2"><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="麻醉科室设备" name="self"
                                   class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="2"><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="麻醉科室设备"
                                   name="expert" class="input" type="text"
                                   style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="2">
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio"  name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','self','2','缺1项，不得分')"/>
                    &nbsp;<label >缺1项，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.6" value="2" onchange="selectRadio('2022-1.1.6','2','expert','2','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input type="radio"   name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','expert','2','缺1项，不得分')"/>
                    &nbsp;<label>缺1项，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="麻醉科室设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>
                每个手术间最低配置:麻醉机，具有心电图、氧饱和度监测、无创血压监测等功能的监护仪，急救药物及基本麻醉与复苏用品
            </td>
        </tr>
        <tr style="height:50px">
            <td rowspan="2">1.1.7专业基地设备</td>
            <td>
                重症监护室最低配置:呼吸机，具有心电图、氧饱和度、温度监测、无创及有创血压监测的监护仪，多通道输液泵/床<br>
                重症监护室公用设备:除颤器、血气分析仪、快速输血系统、保温及降温设备、血糖仪、纤维支气管镜
            </td>
            <td rowspan="2">检查设备清单复印件，需加盖医院公章，实地考查</td>
            <td rowspan="2">
                缺1项，不得分
            </td>
            <td rowspan="2" style="text-align: center;">1</td>
            <td rowspan="2" name="file" itemId="2022-1.1.7" itemName="专业基地设备"></td>
            <td rowspan="2"><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="2"><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td rowspan="2">
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','self','1','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','self','1','缺1项，不得分')"/>
                    &nbsp;<label >缺1项，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','expert','1','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input type="radio"   name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','expert','1','缺1项，不得分')"/>
                    &nbsp;<label>缺1项，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-1.1.7" itemName="专业基地设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.7']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>
        ...
        <tr style="height:50px">
            <td>1.1.8教学设备和设施</td>
            <td>模拟教学设备：气管插管模型、桡动脉和中心静脉穿刺模型和心肺复苏模型；科室的示教室和信息网络系统</td>
            <td> 检查设备清单复印件，需加盖医院公章，实地考察</td>
            <td>
                教学设备设施完善，得1分 <br>
                模拟教学设备缺1项，或无示教室，或有示教室无设备，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.8" itemName="教学设备和设施"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="教学设备和设施" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="教学设备和设施" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','self','1','')"/>
                    &nbsp;<label >教学设备设施完善，得1分</label><br>
                    <input type="radio"  name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','self','1','模拟教学设备缺1项，或无示教室，或有示教室无设备，不得分')"/>
                    &nbsp;<label >模拟教学设备缺1项，或无示教室，或有示教室无设备，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','expert','1','')"/>
                    &nbsp;<label>教学设备设施完善，得1分</label><br>
                    <input type="radio"   name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','expert','1','模拟教学设备缺1项，或无示教室，或有示教室无设备，不得分')"/>
                    &nbsp;<label>模拟教学设备缺1项，或无示教室，或有示教室无设备，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="教学设备和设施" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.8']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.2.1" itemName="协同数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.2.1" itemName="协同数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.2.2" itemName="协同床位数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.2.2" itemName="协同床位数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.2.3" itemName="轮转时间" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.2.3" itemName="轮转时间" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.2.3']}</textarea>
            </td>
        </tr>
        <tr style="height:60px;">
            <td style="height: 438px;" rowspan="7">2.师资管理（17分）</td>
            <td rowspan="4">2.1师资情况</td>
            <td>2.1.1带教医师与培训对象比例★</td>
            <td>
                每1名带教医师同时带教本专业培训对象不超过2名
            </td>
            <td>
                查看原始资料，访谈培训对象
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="带教医师与培训对象比例" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="带教医师与培训对象比例" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-2.1.1" itemName="带教医师与培训对象比例" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:38px;">
            ...
            <td rowspan="3">
                查看人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章
            </td>
            <td>
                其中1名带教医师不符合要求，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-2.1.2" itemName="带教医师条件" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:38px;">
            <td style="height: 38px;">2.1.3带教医师组成</td>
            <td>
                各亚专业（专科）副主任及以上医师≥1人，副主任和或主治医师≥6人
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-2.1.3" itemName="带教医师组成" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:38px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-2.1.4" itemName="专业基地负责人条件" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-2.1.4" itemName="专业基地负责人条件" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-2.1.4" itemName="专业基地负责人条件" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.4']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:35px;">
            ...
            <td>带教医师均参加过院级师资培训；<br>
                各亚专业（专科）至少1名带教医师参加过省级及以上师资培训；<br>
                培训证书3年有效
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.2.1" value="3" onchange="selectRadio('2022-2.2.1','4','expert','3','')"/>
                    &nbsp;<label >2项培训均满足，得3分</label><br>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-2.2.1" itemName="师资培训" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.2.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:35px;">
            <td>2.2.2师资评价★</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-2.2.2" itemName="师资评价" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-2.2.2" itemName="师资评价" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-2.2.2" value="4" onchange="selectRadio('2022-2.2.2','4','self','4','')"/>
                    &nbsp;<label >有评价方案，原始记录详实，得4分</label><br>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-2.2.2" itemName="师资评价" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.2.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:59px;">
            <td style="height: 59px;">2.2.3激励制度★</td>
            <td>建立带教活动绩效管理制度，将带教活动与专业基地绩效考核挂钩，并在科室二次分配中将专业基地负责人、教学主任、教学秘书的教学管理活动和指导医师的带教活动，纳入个人绩效考核的重要指标范围</td>
            <td>查看相关材料，访谈带教医师</td>
            <td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-2.2.3" itemName="激励制度" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.1" itemName="主任职责" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.2" itemName="教学主任" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-3.1.3" itemName="教学秘书" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-3.1.3" itemName="教学秘书" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.3" itemName="教学秘书" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.3']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td>3.1.4教学小组</td>
            <td>成立教学小组，明确小组职责，定期进行带教指导、带教老师培训、带教质量督查及教学研究工作</td>
            <td>
                查看教学小组名单、职责和研究教学工作记录
            </td>
            <td>有教学小组，履职认真，得2分；<br>
                无，或履职不认真，不得分
            </td>
            <td style="text-align: center;">2</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.4" itemName="教学小组" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.4']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td>3.1.5轮转计划★</td>
            <td>按规定落实轮转计划和要求，体现分层递进的培训理念</td>
            <td>
                查看2～3培训对象轮转手册等原始资料，访谈培训对象
            </td>
            <td>严格落实，且体现分层递进，得4分 <br>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.5" itemName="轮转计划" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.5']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td>3.1.6考勤制度</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.6" itemName="考勤制度" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.6']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:40px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.1" itemName="入科教育" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.1" itemName="入科教育" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.1" itemName="入科教育" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="教学查房" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.3小讲课</td>
            <td>开展规范的小讲课活动，至少每2周1次</td>
            <td rowspan="2">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.3" itemName="小讲课" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.3']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.4病例讨论</td>
            <td>开展规范的病例讨论，至少每2周1次</td>
            <td>
                开展次数达标，且认真规范，得2分 <br>
                未达标或不规范，不得分
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.4" itemName="病例讨论" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.4" itemName="病例讨论" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.4" itemName="病例讨论" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.4']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            ...
            <td>3.3.1出科考核★</td>
            <td>
                理论考核(如临床病例分析)试题、技能操作考核评分标准、培训对象测评结果、考勤记录等原始资料齐全，真实规范，体现专业特点和分层递进的培训理念
            </td>
            <td>随机抽查访谈不同培训年限的本院、委培、社会招收培训对象各1～2名，检查近1年原始资料</td>
            <td>
                考核项目全面，且认真规范，得3分 <br>
                仅有技能操作考核，得2分<br>
                仅有理论考试，得1分<br>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.3.1" itemName="出科考核" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.3.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height:136px;">3.4培训工作量</td>
            <td style="height: 48px;">3.4.1培训强度★</td>
            <td>
                按照专业基地培训对象临床技能操作能够达到《住院医师规范化培训内容与标准（试行）》麻醉科培训细则的要求
            </td>
            <td>查看轮转手册等相关材料，随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
            <td>
                独立技能操作种类及数量达要求，得6分 <br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-3.4.1" itemName="培训强度" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-3.4.1" itemName="培训强度" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','self','6','')"/>
                    &nbsp;<label >独立技能操作种类及数量达要求，得6分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','self','6','独立技能操作≥规定数的80%，得3分')"/>
                    &nbsp;<label >独立技能操作≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','6','独立技能操作≥规定数的60%，得1分')"/>
                    &nbsp;<label >独立技能操作≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','6','＜60%，或未安排独立操作，不得分')"/>
                    &nbsp;<label >＜60%，或未安排独立操作，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','expert','6','')"/>
                    &nbsp;<label>独立技能操作种类及数量达要求，得6分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','expert','6','独立技能操作≥规定数的80%，得3分')"/>
                    &nbsp;<label >独立技能操作≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','6','独立技能操作≥规定数的60%，得1分')"/>
                    &nbsp;<label >独立技能操作≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','6','＜60%，或未安排独立操作，不得分')"/>
                    &nbsp;<label >＜60%，或未安排独立操作，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="培训强度" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height:96px;" rowspan="7">4.质量控制（35分）</td>
            <td rowspan="2">4.1带教医师教学质量</td>
            <td>4.1.1技能操作或手术带教情况★</td>
            <td>带教医师协助并指导培训对象完成技能操作或手术，带教严格规范</td>
            <td>随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作或手术</td>
            <td>
                1.培训对象操作前是否与患者交流、沟通情况1分 <br>
                2.培训对象操作中存在问题及时进行指导 1分<br>
                3.培训对象操作结束后是否进行提问1分<br>
                4.对培训对象的操作的总体评价（优、缺点点评)2分
            </td>
            <td style="text-align: center;">5</td>
            <td name="file" itemId="2022-4.1.1" itemName="技能操作或手术带教情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.1.1" itemName="技能操作或手术带教情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.1.1" itemName="技能操作或手术带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="技能操作或手术带教情况" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.1']}</textarea>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.2带教医师教学能力情况★</td>
            <td>带教医师进行小讲课或病例讨论或教学查房，带教认真规范
            </td>
            <td>随机抽查1～2名带教医师进行小讲课或病例讨论或教学查房示范，了解实际情况，评分表打分</td>
            <td>
                根据评分表 <br>
                ≥90分，得9分；≥80分，得7分；≥70分，得5分；≥60分，得2分；＜60分，不得分
            </td>
            <td style="text-align: center;">9</td>
            <td name="file" itemId="2022-4.1.2" itemName="带教医师教学能力情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,9);" itemId="2022-4.1.2" itemName="带教医师教学能力情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,9);" itemId="2022-4.1.2" itemName="带教医师教学能力情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.2" value="9" onchange="selectRadio('2022-4.1.2','9','self','9','')"/>
                    &nbsp;<label >≥90分，得9分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="7" onchange="selectRadio('2022-4.1.2','7','self','9','≥80分，得7分')"/>
                    &nbsp;<label >≥80分，得7分</label> <br>
                    <input type="radio"  name="2022-4.1.2" value="5" onchange="selectRadio('2022-4.1.2','5','self','9','≥70分，得5分')"/>
                    &nbsp;<label >≥70分，得5分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','self','9','≥60分，得2分')"/>
                    &nbsp;<label >≥60分，得2分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','9','＜60分，不得分')"/>
                    &nbsp;<label >＜60分，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.2" value="9" onchange="selectRadio('2022-4.1.2','9','expert','9','')"/>
                    &nbsp;<label>≥90分，得9分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="7" onchange="selectRadio('2022-4.1.2','7','expert','9','≥80分，得7分')"/>
                    &nbsp;<label >≥80分，得7分</label> <br>
                    <input type="radio"  name="2022-4.1.2" value="5" onchange="selectRadio('2022-4.1.2','5','expert','9','≥70分，得5分')"/>
                    &nbsp;<label >≥70分，得5分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','expert','9','≥60分，得2分')"/>
                    &nbsp;<label >≥60分，得2分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','expert','9','＜60分，不得分')"/>
                    &nbsp;<label >＜60分，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="带教医师教学能力情况" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea></c:if>
            </td>
        </tr>

        <tr style="height:48px;">
            <td rowspan="5">4.2培训对象学习效果</td>
            <td style="height: 48px;">4.2.1技能操作★</td>
            <td>培训对象进行技能操作情况</td>
            <td>随机抽查1～2名二年级以上培训对象进行技能操作，查看其掌握情况</td>
            <input type="hidden" id="scoreInfo1" name="scoreInfo" value="${scoreInfo1}">
            <input type="hidden" id="scoreInfo2" name="scoreInfo" value="${scoreInfo2}">
            <input type="hidden" id="scoreInfo3" name="scoreInfo" value="${scoreInfo3}">
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_1900_Main','附表2-4');">
                        附表2-4</a>
                <br>
                ≥90分，得7分；≥80分，得5分；≥70分，得3分；≥60分，得2分；＜60分，不得分
            </td>
            <td style="text-align: center;">7</td>
            <td name="file" itemId="2022-4.2.1" itemName="技能操作"></td>
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="技能操作" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="技能操作" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.2.1" itemName="技能操作" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.1']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.2临床思维考核★</td>
            <td>培训对象综合临床思维能力</td>
            <td>随机抽查1～2名二年级以上培训对象，抽取临床案例进行综合思维能力评估</td>
            <td>
                根据评分表 <br>
                ≥90分，得8分；≥80分，得7分；≥70分，得5分；≥60分，得3分；＜60分，不得分
            </td>
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-4.2.2" itemName="临床思维考核"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="临床思维考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="临床思维考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.2" value="8" onchange="selectRadio('2022-4.1.2','8','self','8','')"/>
                    &nbsp;<label >≥90分，得8分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="7" onchange="selectRadio('2022-4.1.2','7','self','8','≥80分，得7分')"/>
                    &nbsp;<label >≥80分，得7分</label> <br>
                    <input type="radio"  name="2022-4.1.2" value="5" onchange="selectRadio('2022-4.1.2','5','self','8','≥70分，得5分')"/>
                    &nbsp;<label >≥70分，得5分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="3" onchange="selectRadio('2022-4.1.2','3','self','8','≥60分，得2分')"/>
                    &nbsp;<label >≥60分，得3分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','8','＜60分，不得分')"/>
                    &nbsp;<label >＜60分，不得分</label>
                </c:if>
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.2" value="8" onchange="selectRadio('2022-4.1.2','8','expert','8','')"/>
                    &nbsp;<label>≥90分，得8分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="7" onchange="selectRadio('2022-4.1.2','7','expert','8','≥80分，得7分')"/>
                    &nbsp;<label >≥80分，得7分</label> <br>
                    <input type="radio"  name="2022-4.1.2" value="5" onchange="selectRadio('2022-4.1.2','5','expert','8','≥70分，得5分')"/>
                    &nbsp;<label >≥70分，得5分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="3" onchange="selectRadio('2022-4.1.2','3','expert','8','≥60分，得2分')"/>
                    &nbsp;<label >≥60分，得3分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','expert','8','＜60分，不得分')"/>
                    &nbsp;<label >＜60分，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.2.2" itemName="临床思维考核" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.3执业医师资格考试</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.3" itemName="执业医师资格考试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.3" itemName="执业医师资格考试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.3" itemName="执业医师资格考试" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.3']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.4结业考核★</td>
            <td>住院医师首次参加结业考核的通过率</td>
            <td>查看上一年度首次参加结业考核的所有培训对象的成绩等原始资料</td>
            <td>
                通过率≥85%，得2分；通过率＜85%，但≥本省（区、市）平均通过率，得1分；在平均通过率的基础上，每提高5个百分点，加0.5分，最多得2分；通过率＜本省（区、市）平均通过率，不得分
            </td>
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.4" itemName="结业考核"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="结业考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="结业考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.4" itemName="结业考核" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.4']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.5年度业务水平测试</td>
            <td>住院医师年度业务水平测试排名</td>
            <td>查看上一年度参加年度业务水平测试的所有培训对象的成绩等原始资料</td>
            <td>
                ≥全国平均线，得2分；＜全国平均线，不得分
            </td>
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.5" itemName="年度业务水平测试"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.5" itemName="年度业务水平测试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.5" itemName="年度业务水平测试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.2.5" value="2" onchange="selectRadio('2022-4.2.5','2','self','2','')"/>
                    &nbsp;<label >≥全国平均线，得2分</label><br>
                    <input type="radio"  name="2022-4.2.5" value="0" onchange="selectRadio('2022-4.2.5','0','self','4','＜全国平均线，不得分')"/>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.5" itemName="年度业务水平测试" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.5']}</textarea></c:if>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                1.一级指标4项，二级指标10项，三级指标37项。三级指标中，核心指标15项、计65分，共100分。<br>
