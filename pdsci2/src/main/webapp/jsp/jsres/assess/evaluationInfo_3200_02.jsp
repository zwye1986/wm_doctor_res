...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-1.1" itemName="准备工作充分，认真组织口腔临床教学" name="self"
                       class="input"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-1.2" itemName="病例选择合适" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-1.3" itemName="熟悉患者病情" name="self"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-2.1"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-2.2"
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3200-02-2.3"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-2.4"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-2.5"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-2.6"
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3200-02-2.7"
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3200-02-2.8"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-3.1"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-3.2"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-3.3"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-4.1"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-4.2"
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3200-02-5.1"
