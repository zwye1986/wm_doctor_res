...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——外科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            ...
            <td rowspan="11">1.1专业基地所在医院条件</td>
            <td>1.1.1总床位数</td>
            <td width="313px">
                ≥200张
            </td>
            ...
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.1" itemName="总床位数" name="self" class="input"
        ...
        <tr style="height:32px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','self','1','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.6" value="1" onchange="selectRadio('2022-1.1.6','1','expert','1','')"/>
                    &nbsp;<label>科室齐全，得1分</label><br>
                    <input type="radio" name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','expert','1','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
            <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:64px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》外科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_0900_Main','附表1-1至1-6');">
                        附表1-1至1-6</a>
            </td>
            <td>
                核对上一年度亚专业（专科）收治疾病种类及数量统计报表
            </td>
            <td>
                符合要求（含协同单位），得2分<br>
        ...
        <tr style="height:64px;">
            ...
            <td>
                核对上一年度亚专业（专科）技能操作、手术种类及数量的统计报表
            </td>
            <td>
                符合要求（含协同单位），得4分<br>
            ...
            <td><input id="fubiao12" onchange="saveScore(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量"
                       name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4Expert(this,4);" itemId="2022-1.1.8"
                       itemName="技能操作和手术种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:50px;">
            <td style="height: 32px;">1.1.11教学设施和设备</td>
            <td>
                示教室、教学设备、手术电视转播设备
            </td>
            <td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-1.1.11" value="0" onchange="selectRadio('2022-1.1.11','0','self','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label>无示教室或有示教室无设备，不得分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.11" value="1" onchange="selectRadio('2022-1.1.11','1','expert','1','')"/>
                    &nbsp;<label>有示教室且设备完善，得1分</label><br>
                    <input type="radio" name="2022-1.1.11" value="0" onchange="selectRadio('2022-1.1.11','0','expert','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label>无示教室或有示教室无设备，不得分</label>
                </c:if>
            <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px;">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业（专科）床位数（参照《住院医师规范化培训基地认定标准（试行）》外科细则要求）
            </td>
            <td>
                满足要求，得1分（无协同单位的专业基地，此处不失分）
            </td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事外科专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:35px;">
            <td>2.2.3激励制度★</td>
            <td>
                建立带教活动绩效管理制度，将带教活动与专业基地绩效考核挂钩，并在科室二次分配中将专业基地负责人、
                教学主任、教学秘书的教学管理活动和指导医师的带教活动，纳入个人绩效考核的重要指标范围
            </td>
            <td>
                查看相关材料，访谈带教医师
            </td>
        ...
        <tr style="height:40px;">
            ...
            <td>
                规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通等内容的入科教育，培训与考核要求体现科室岗位基本需求特点，并有专人组织实施
            </td>
            <td>提供本年度入科教育原始资料</td>
            <td>
                有，且严格落实，得1分<br>
        ...
        <tr style="height:48px;">
            ...
            <td>3.4.1管理病床数★</td>
            <td>
                日管床数（病房）≥5张(在带教医师指导下独立于其他培训对象管理床位)
            </td>
            <td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>管床数达到要求，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','2','管床数≥3张，得1分')"/>
                    &nbsp;<label>管床数≥3张，得1分</label><br>
                  ...
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>管床数达到要求，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','2','管床数≥3张，得1分')"/>
                    &nbsp;<label>管床数≥3张，得1分</label><br>
        ...
        <tr style="height:48px;">
            <td style="height:96px;" rowspan="9">4.质量控制<br>（35分）</td>
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_02','附表2');">附表2</a>
                <br>
                ≥90分，得4分；≥80分，得3分；≥70分，得2分<br>
                ≥60分，得1分；＜60分，不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.1.1" itemName="查房质量"></td>
            <td><input id="fubiao2" onchange="saveScore(this,4);" itemId="2022-4.1.1" itemName="查房质量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.1" itemName="查房质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:48px;">
            <td>4.1.2技能操作和手术带教情况★</td>
            <td>
                带教医师协助并指导培训对象完成技能操作或手术，带教严格规范
            </td>
            <td>
                随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作或手术情况
            </td>
            <td>
            ...
            <td name="file" itemId="2022-4.1.2" itemName="技能操作和手术带教情况"></td>
            <td><input onchange="saveScore(this,5);" itemId="2022-4.1.2" itemName="技能操作和手术带教情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,5);" itemId="2022-4.1.2" itemName="技能操作和手术带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作和手术带教情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td rowspan="7">4.2培训对象学习效果</td>
            <td style="height: 48px;">4.2.1病历书写★</td>
            <td>培训对象病历书写情况</td>
            <td>随机抽查1～2名培训对象运行病历，结合病历提问题</td>
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_03','附表3');">附表3</a>
                <br>
                ≥90分，得4分；≥80分，得3分；≥70分，得2分<br>
                ≥60分，得1分；＜60分，不得分
            </td>
            ...
            <td><input id="fubiao3" onchange="saveScore(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_04','附表4');">附表4</a>
                <br>
                ≥90分，得8分；≥80分，得5分；≥70分，得3分<br>
                ≥60分，得1分；＜60分，不得分
            </td>
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-4.2.2" itemName="技能操作和手术"></td>
            <td><input id="fubiao4" onchange="saveScore(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao4Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.2" itemName="技能操作和手术" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.2']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.3技能操作和手术完成情况★</td>
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，
                为每名培训对象安排并完成规定的技能操作和手术（见附件4）
            </td>
            <td>
                随机抽查5～10名培训对象，由评估专家根据本专业实际需求确定手术或技能操作项目，
                查看技能操作或手术记录，掌握实际情况
            </td>
            <td>
                完成率≥90%，得6分<br>
            ...
            <td name="file" itemId="2022-4.2.3" itemName="技能操作和手术完成情况"></td>
            <td><input onchange="saveScore(this,6);" itemId="2022-4.2.3" itemName="技能操作和手术完成情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,6);" itemId="2022-4.2.3" itemName="技能操作和手术完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.3" itemName="技能操作和手术完成情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.3']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.4腔镜培训开展情况</td>
            <td>
                腔镜培训设施、设备、内容、方法
            </td>
            <td>
                查看培训场地，培训设备，培训内容，考核方法
            </td>
            <td>
                符合要求得2分<br>
                有场地、有设备但培训工作不规范，得1分<br>
                没有开展腔镜培训，不得分
            </td>
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.4" itemName="腔镜培训开展情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="腔镜培训开展情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="腔镜培训开展情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.4" value="2" onchange="selectRadio('2022-4.2.4','2','self','2','')"/>
                    &nbsp;<label>符合要求得2分</label><br>
                    <input type="radio" name="2022-4.2.4" value="1" onchange="selectRadio('2022-4.2.4','1','self','2','有场地、有设备但培训工作不规范，得1分')"/>
                    &nbsp;<label>有场地、有设备但培训工作不规范，得1分</label><br>
                    <input type="radio" name="2022-4.2.4" value="0" onchange="selectRadio('2022-4.2.4','0','self','2','没有开展腔镜培训，不得分')"/>
                    &nbsp;<label>没有开展腔镜培训，不得分</label><br>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.4" value="2" onchange="selectRadio('2022-4.2.4','2','expert','2','')"/>
                    &nbsp;<label>符合要求得2分</label><br>
                    <input type="radio" name="2022-4.2.4" value="1" onchange="selectRadio('2022-4.2.4','1','expert','2','有场地、有设备但培训工作不规范，得1分')"/>
                    &nbsp;<label>有场地、有设备但培训工作不规范，得1分</label><br>
                    <input type="radio" name="2022-4.2.4" value="0" onchange="selectRadio('2022-4.2.4','0','expert','2','没有开展腔镜培训，不得分')"/>
                    &nbsp;<label>没有开展腔镜培训，不得分</label><br>
                </c:if>
            <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.4" itemName="腔镜培训开展情况" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.5执业医师资格考试</td>
            <td>
            ...
            <td>
                通过率≥85%，得2分；<br>
                通过率＜85%，但≥本省（区、市）平均通过率，得1分；<br>
                在平均通过率的基础上，每提高5个百分点，加0.5分，最多得2分；<br>
                通过率＜本省（区、市）平均通过率，不得分
            </td>
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.5" itemName="执业医师资格考试"></td>
            <td><input onchange="saveScore(this,2);" itemId="2022-4.2.5" itemName="执业医师资格考试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,2);" itemId="2022-4.2.5" itemName="执业医师资格考试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.5" itemName="执业医师资格考试" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.5']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.6结业考核★</td>
            <td>
                住院医师首次参加结业考核的通过率
            </td>
            <td>
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.6" itemName="结业考核"></td>
            <td><input onchange="saveScore(this,2);" itemId="2022-4.2.6" itemName="结业考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,2);" itemId="2022-4.2.6" itemName="结业考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.6" itemName="结业考核" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.6']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.7年度业务水平测试</td>
            <td>
                住院医师年度业务水平测试排名
            </td>
            <td>
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-4.2.7" itemName="年度业务水平测试"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.7" itemName="年度业务水平测试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.7" itemName="年度业务水平测试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.7" value="2" onchange="selectRadio('2022-4.2.7','2','self','2','')"/>
                    &nbsp;<label>≥全国平均线，得2分</label><br>
                    <input type="radio" name="2022-4.2.7" value="0" onchange="selectRadio('2022-4.2.7','0','self','2','＜全国平均线，不得分')"/>
                    &nbsp;<label>＜全国平均线，不得分</label><br>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.7" value="2" onchange="selectRadio('2022-4.2.7','2','expert','2','')"/>
                    &nbsp;<label>≥全国平均线，得2分</label><br>
                    <input type="radio" name="2022-4.2.7" value="0" onchange="selectRadio('2022-4.2.7','0','expert','2','＜全国平均线，不得分')"/>
                    &nbsp;<label>＜全国平均线，不得分</label><br>
                </c:if>
            <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.7" itemName="年度业务水平测试" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
                              class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.7']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:40px;">
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注:<br>
                &#12288;&#12288;1.一级指标4项，二级指标10项，三级指标43项。三级指标中，核心指标16项、计62分，共100分。<br>
