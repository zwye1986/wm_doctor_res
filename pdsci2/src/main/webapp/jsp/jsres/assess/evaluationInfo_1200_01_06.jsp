	...
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		<tbody>
			...
			<tr style="height:32px;">
				...
				<th rowspan="3">实际数</th>
				<th>
					<input onchange="saveScore(this,750);" itemId="1200-06-1.1" itemName="k年收治病人数"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
				</th>
				<th rowspan="3">低于标准数（划√）</th>
				<th>
					<input itemId="1200-06-1.1" itemName="d年收治病人数" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</th>
			</tr>
			<tr style="height:32px;">
				...
				<th>≥2000</th>
				<th>
					<input onchange="saveScore(this,2000);" itemId="1200-06-1.2" itemName="k年门诊量"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
				</th>
				<th>
					<input itemId="1200-06-1.2" itemName="d年门诊量" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</th>
			</tr>
			<tr style="height:32px;">
				...
				<th>≥300</th>
				<th>
					<input onchange="saveScore(this,300);" itemId="1200-06-1.3" itemName="k年急诊量"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
				</th>
				<th>
					<input itemId="1200-06-1.3" itemName="d年急诊量" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</th>
			</tr>
			<tr style="height:32px;">
			...
			<tr style="height:32px">
				...
				<th colspan="2">≥8</th>
				<td colspan="2">
					<input onchange="saveScore(this,8);" itemId="1200-06-2.1" itemName="k颅内高压"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-2.1" itemName="d颅内高压" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >头皮损伤</th>
				<th colspan="2">≥8</th>
				<td colspan="2">
					<input onchange="saveScore(this,8);" itemId="1200-06-2.2" itemName="k头皮损伤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-2.2" itemName="d头皮损伤" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅骨损伤</th>
				<th colspan="2">≥8</th>
				<td colspan="2">
					<input onchange="saveScore(this,8);" itemId="1200-06-2.3" itemName="k颅骨损伤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-2.3" itemName="d颅骨损伤" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅内或椎管内肿瘤</th>
				<th colspan="2">≥8</th>
				<td colspan="2">
					<input onchange="saveScore(this,8);" itemId="1200-06-2.4" itemName="k颅内或椎管内肿瘤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-2.4" itemName="d颅内或椎管内肿瘤" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅内或椎管内血管性疾病</th>
				<th colspan="2">≥8</th>
				<td colspan="2">
					<input onchange="saveScore(this,8);" itemId="1200-06-2.5" itemName="k颅内或椎管内血管性疾病"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-2.5" itemName="d颅内或椎管内血管性疾病" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				...
				<th colspan="2">≥20</th>
				<td colspan="2">
					<input onchange="saveScore(this,20);" itemId="1200-06-3.1" itemName="k头皮损伤手术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-3.1" itemName="d头皮损伤手术" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >腰椎穿刺</th>
				<th colspan="2">≥20</th>
				<td colspan="2">
					<input onchange="saveScore(this,20);" itemId="1200-06-3.2" itemName="k腰椎穿刺"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-3.2" itemName="d腰椎穿刺" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >开颅手术</th>
				<th colspan="2">≥20</th>
				<td colspan="2">
					<input onchange="saveScore(this,20);" itemId="1200-06-3.3" itemName="k开颅手术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-3.3" itemName="d开颅手术" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >脑室穿刺术</th>
				<th colspan="2">≥15</th>
				<td colspan="2">
					<input onchange="saveScore(this,15);" itemId="1200-06-3.4" itemName="k脑室穿刺术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-06-3.4" itemName="d脑室穿刺术" name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
