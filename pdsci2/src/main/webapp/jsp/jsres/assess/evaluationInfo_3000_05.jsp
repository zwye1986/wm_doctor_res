...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3000-05-1.1" itemName="冠部检查" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <th>15</th>
            <td>
                <input onchange="saveScore(this,15);" itemId="3000-05-1.2" itemName="车针及根管锉选择" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-05-1.3" itemName="体位和手法" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>18</th>
            <td>
                <input onchange="saveScore(this,18);" itemId="3000-05-1.4" itemName="入口洞形" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="3000-05-1.5" itemName="揭髓室顶" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>16</th>
            <td>
                <input onchange="saveScore(this,16);" itemId="3000-05-1.6" itemName="修整髓室侧壁" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-05-1.7" itemName="定位根管口" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>6</th>
            <td>
                <input onchange="saveScore(this,6);" itemId="3000-05-1.8" itemName="熟练程度" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>-100</th>
            <td>
                <input onchange="saveScore(this,100);" itemId="3000-05-1.9" itemName="单项否决" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
