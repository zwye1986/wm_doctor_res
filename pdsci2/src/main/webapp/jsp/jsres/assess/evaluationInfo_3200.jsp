    ...
    <script type="text/javascript">
        ...
        function submitScore() {
            if ('${roleFlag}' == 'local' || '${roleFlag}' == 'baseExpert') {
                ...
                var url = "<s:url value='/hbres/supervisio/saveSpeScoreTotal'/>";
        ...
        function printEvaScore() {
            top.jboxExp(null, "<s:url value='/hbres/supervisio/scoreDownload?userFlow=${userFlow}&subjectFlow=${subjectFlow}&roleFlag=${roleFlag}'/>");
        }
        ...
        function saveScore(expl, num) {
            ...
            if (score >= 0 && score <= num && reg.test(score)) {
                ...
                var url = "<s:url value='/hbres/supervisio/saveOwnerScore'/>";
                var data = {
                    "itemId": itemId,
                    "itemName": itemName,
                    "score": score1,
        ...
        function saveScore4ExpertOnlyIntenger(expl, num) {
            ...
            if (score >= 0 && score <= num && reg.test(score)) {
                var score1 = parseInt(score);
                $(expl).attr("preValue", score1);
                var url = "<s:url value='/hbres/supervisio/saveSpeScore'/>";
                var data = {
                    "itemId": itemId,
                    "itemName": itemName,
                    "score": score1,
        ...
        function scheduleMany(fileRoute, fileName) {
            var url = "<s:url value ='/hbres/supervisio/scheduleMany'/>?orgName=${orgName}&userFlow=${userFlow}&orgFlow=${orgFlow}&roleFlag=${roleFlag}&isRead=${isRead}&speId=${speId}&editFlag=${editFlag}&subjectFlow=${subjectFlow}&fileRoute=" + fileRoute;
            top.jboxOpen(url, fileName, 1100, 690);
        }

        function Schedule(fileRoute, fileName) {
            var url = "<s:url value ='/hbres/supervisio/Schedule'/>?orgName=${orgName}&userFlow=${userFlow}&orgFlow=${orgFlow}&isRead=${isRead}&speId=${speId}&roleFlag=${roleFlag}&editFlag=${editFlag}&subjectFlow=${subjectFlow}&fileRoute=" + fileRoute;
        ...
        function saveSpeReason(expl) {
            ...
            var itemId = expl.getAttribute("itemId");
            var itemName = expl.getAttribute("itemName");
            var url = "<s:url value='/hbres/supervisio/saveSpeReason'/>";
            var data = {
        ...
        function uploadFile(itemId, itemName) {
            var url = "<s:url value='/hbres/supervisio/uploadFile'/>?itemId=" + itemId + "&itemName=" + encodeURIComponent(encodeURIComponent(itemName)) + "&subjectFlow=${subjectFlow}" + "&speId=${speId}";
            typeName = "医院评估附件";
        ...
        function delFile(recordFlow, exp) {
            top.jboxConfirm("确认移除该附件吗？", function () {
                var url = "<s:url value='/hbres/supervisio/removeFile?recordFlow='/>" + recordFlow;
        ...
        function downloadFile(recordFlow) {
            top.jboxTip("下载中…………");
            var url = "<s:url value='/hbres/supervisio/downloadFile?recordFlow='/>" + recordFlow;
...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——口腔正畸科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        <tr height="34" class="firstRow">
            <th colspan="11">
                <h2 style="font-size:150%">住院医师规范化培训评估指标——口腔全科专业基地</h2>
            </th>
        </tr>
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" height="28" colspan="6">培训基地（医院）名称：${orgName}</th>
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="11">1.基本条件（17分）</td>
            <td style="height:53px;" rowspan="8">1.1专业基地所在医院条件</td>
            <td>1.1.1牙科综合治疗台数</td>
            <td width="313px">
                牙科综合治疗台数≥20台
            </td>
            ...
            <td name="file" itemId="2022-1.1.1" itemName="牙科综合治疗台数"  width="180px"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
                       itemName="牙科综合治疗台数" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.1" itemName="牙科综合治疗台数" name="expert"
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                     <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="牙科综合治疗台数" name="reason"
                               placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]"></textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td rowspan="2">检查相关统计报表复印件，需加盖医院公章</td>
            <td>
                符合标准，得1分<br>
                不达标准，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.2" itemName="年门诊量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.2" value="${ownerScoreMap['2022-1.1.2']}"
                       itemName="年门诊量" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="年门诊量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                   <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="年门诊量" name="reason"
                             placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]"></textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.3" itemName="年急诊量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.3" value="${ownerScoreMap['2022-1.1.3']}"
                       itemName="年急诊量" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.3" itemName="年急诊量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="年急诊量" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]"></textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.4科室和实验室</td>
            <td>
                必备科室:急诊科、心电监护室或配备心电监护设备的急诊科、放射（影像）科[综合性医院的放射科内有从事口腔放射（影像）工作的专业人员]、病理科（综合性医院的病理科内有侧重口腔病理诊断工作的专业人员）、检验科、药剂科等
            </td>
            <td>
                查看相关文件，实地考查
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.4" value="${ownerScoreMap['2022-1.1.4']}"
                       itemName="科室和实验室" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.4" itemName="科室和实验室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','self','1','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input  type="radio"  name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','self','1','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','expert','1','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input type="radio"   name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','expert','1','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="科室和实验室" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]"></textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.5轮转科室</td>
            <td>
                牙体牙髓科、儿童口腔科、口腔颌面外科、口腔正畸科、口腔预防科、牙周科、口腔黏膜科、口腔修复科、口腔颌面影像科
            </td>
            <td>
                1.查看各亚专业(专科)设置名称 <br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.5" value="${ownerScoreMap['2022-1.1.5']}"
                       itemName="轮转科室" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.5" value="3" onchange="selectRadio('2022-1.1.5','3','self','3','')"/>
                    &nbsp;<label >科室齐全，得满分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','3','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.5" value="3" onchange="selectRadio('2022-1.1.5','3','expert','3','')"/>
                    &nbsp;<label>科室齐全，得满分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','3','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="轮转科室" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]"></textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.6疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》口腔全科专业细则要求，详见
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3200_01','附表1');">
                    附表1</a>
            </td>
            <td>核对上一年度各亚专业(专科)收治疾病种类及数量统计报表
            </td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td><input id="fubiao11" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.6"
                       value="${ownerScoreMap['2022-1.1.6']}" itemName="疾病种类及数量" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao11Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="疾病种类及数量"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="疾病种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.7技能操作和手术种类及数量★</td>

            <td>核对上一年度各亚专业(专科)技能操作和手术种类及数量的统计报表</td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td name="file" itemId="2022-1.1.7" itemName="技能操作和手术种类及数量"></td>
            <td><input id="fubiao12" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.7"
                       value="${ownerScoreMap['2022-1.1.7']}" itemName="技能操作和手术种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.7"
                       itemName="技能操作和手术种类及数量" name="expert" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.7" itemName="技能操作和手术种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.8专业基地设备</td>
            <td>
                牙科综合治疗台、牙髓活力测定所需设备、根管治疗所需器械、银汞调合机、光敏树脂充填照射灯、牙周探针、超声洁牙机、龈上和龈下深刮器、牙科印模制取托盘、牙科模型制作设备及技工设备、常用牙科器械、材料、药品以及口腔诊室应必备的器械和材料
            </td>
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.8" itemName="专业基地设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="专业基地设备" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》口腔全科细则要求)
            </td>
            <td>
                满足要求，得1分（无协同单位的专业基地，此处不失分）
            </td>
        ...
        <tr style="height:60px;">
            <td style="height: 438px;" rowspan="7">2.师资条件（18分）</td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                具有中、高级专业技术职务人员数应大于基地总医师数的50%，高级专业技术职务人员≥3名
            <td>
                1个亚专业(专科)不达标，不得分
            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:35px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-2.2.1" itemName="师资培训" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-2.2.1" itemName="师资培训" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:35px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input  type="radio"  name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','self','4','有评价记录，无方案，得2分')"/>
                    &nbsp;<label >有评价记录，无方案，得2分</label><br>
                    <input  type="radio"  name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','self','4','有方案，无评价记录，得1分')"/>
                    &nbsp;<label >有方案，无评价记录，得1分</label><br>
                    <input type="radio"  name="2022-2.2.2" value="0" onchange="selectRadio('2022-2.2.2','0','self','4','无，不得分')"/>
                    &nbsp;<label >无，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-2.2.2" value="4" onchange="selectRadio('2022-2.2.2','4','expert','4','')"/>
                    &nbsp;<label>有评价方案，原始记录详实，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','expert','4','有评价记录，无方案，得2分')"/>
                    &nbsp;<label>有评价记录，无方案，得2分</label><br>
                    <input   type="radio"  name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','expert','4','有方案，无评价记录，得1分')"/>
                    &nbsp;<label>有方案，无评价记录，得1分</label><br>
                    <input type="radio"   name="2022-2.2.2" value="0" onchange="selectRadio('2022-2.2.2','0','expert','4','无，不得分')"/>
                    &nbsp;<label>无，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:59px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input  type="radio"  name="2022-2.2.3" value="2" onchange="selectRadio('2022-2.2.3','2','self','4','有机制，未与奖金、评优挂钩，得2分')"/>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有机制，并与奖金、评优等挂钩，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.3" value="2" onchange="selectRadio('2022-2.2.3','2','expert','4','有机制，未与奖金、评优挂钩，得2分')"/>
                    &nbsp;<label>有机制，未与奖金、评优挂钩，得2分</label><br>
        ...
        <tr style="height:32px;">
            <td style="height: 438px;" rowspan="11">3.过程管理（30分）</td>
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.1.2" itemName="教学主任" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.1.2" itemName="教学主任" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:40px;">
            <td style="height:136px;" rowspan="3">3.2培训活动</td>
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.2小讲课</td>
            <td>开展规范的小讲课活动，至少1周1次</td>
            <td rowspan="2">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-3.2.2" itemName="小讲课" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-3.2.2" itemName="小讲课" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="小讲课" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.3疑难病例讨论</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-3.2.3" itemName="疑难病例讨论" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-3.2.3" itemName="疑难病例讨论" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.3" itemName="疑难病例讨论" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','self','4','仅有技能操作考核，得2分')"/>
                    &nbsp;<label >仅有技能操作考核，得2分</label>
                    <input type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','self','4','仅有理论考试或仅有测评结果和考勤记录，得1分')"/>
                    &nbsp;<label >仅有理论考试或仅有测评结果和考勤记录，得1分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.3.1" value="4" onchange="selectRadio('2022-3.3.1','4','expert','4','')"/>
                    &nbsp;<label>考核项目全面，且认真规范，得满分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','expert','4','仅有技能操作考核，得2分')"/>
                    &nbsp;<label >仅有技能操作考核，得2分</label>
                    <input type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','expert','4','仅有理论考试或仅有测评结果和考勤记录，得1分')"/>
                    &nbsp;<label >仅有理论考试或仅有测评结果和考勤记录，得1分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:48px;">
            ...
            <td>
                按照专业基地培训对象临床操作能够达到《住院医师规范化培训内容与标准（试行）》口腔全科培训细则的要求
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-3.4.1" itemName="培训强度" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-3.4.1" itemName="培训强度" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.4.1" value="5" onchange="selectRadio('2022-3.4.1','5','self','5','')"/>
                    &nbsp;<label >技能操作达要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','self','5','技能操作≥规定数的80%，得3分')"/>
                    &nbsp;<label >技能操作≥规定数的80%，得3分</label>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','5','技能操作≥规定数的70%，得1分')"/>
                    &nbsp;<label >技能操作≥规定数的70%，得1分</label>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','5','＜70%，或未安排独立操作，不得分')"/>
                    &nbsp;<label >＜70%，或未安排独立操作，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="5" onchange="selectRadio('2022-3.4.1','5','expert','5','')"/>
                    &nbsp;<label>技能操作达要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','expert','5','技能操作≥规定数的80%，得3分')"/>
                    &nbsp;<label >技能操作≥规定数的80%，得3分</label>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','5','技能操作≥规定数的70%，得1分')"/>
                    &nbsp;<label >技能操作≥规定数的70%，得1分</label>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','5','＜70%，或未安排独立操作，不得分')"/>
                    &nbsp;<label >＜70%，或未安排独立操作，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="培训强度" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>4.1.1临床教学质量★</td>
            <td>针对培训对象开展规范的临床教学，悉心指导培训对象</td>
            <td>随机抽查1～2名带教医师临床教学</td>
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3200_02','附表2');">
                    附表2</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.1.1" itemName="临床教学质量"></td>
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="临床教学质量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="临床教学质量"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="临床教学质量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.1']}</textarea>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.2技能操作或手术安排情况★</td>
            <td>每个轮转科室均能按照《住院医师规范化培训内容与标准》本专业细则要求执行，为每名培训对象安排并完成规定的技能操作种类和数量
            </td>
            <td>随机抽查5～10名培训对象技能操作记录，了解实际情况</td>
            <td>
                满意率≥90%，得满分 <br>
                满意率≥80%，得4分 <br>
                满意率＜80%，不得分
            ...
            <td name="file" itemId="2022-4.1.2" itemName="技能操作或手术安排情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作或手术安排情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作或手术安排情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.2" value="8" onchange="selectRadio('2022-4.1.2','8','self','8','')"/>
                    &nbsp;<label >满意率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','self','8','满意率≥80%，得4分')"/>
                    &nbsp;<label >满意率≥80%，得4分</label>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','8','满意率＜80%，不得分')"/>
                    &nbsp;<label >满意率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.2" value="8" onchange="selectRadio('2022-4.1.2','8','expert','8','')"/>
                    &nbsp;<label>满意率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','expert','8','满意率≥80%，得4分')"/>
                    &nbsp;<label >满意率≥80%，得4分</label>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','expert','8','满意率＜80%，不得分')"/>
                    &nbsp;<label >满意率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作或手术安排情况" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.3技能操作或手术带教情况★</td>
            <td>带教医师协助并指导培训对象完成技能操作或手术，带教严格规范
            </td>
            <td>随机抽查1～2名带教医师指导培训对象(二年级以上)进行技能操作情况</td>
            <td>
                1.培训对象操作前是否与患者交流、沟通1分<br>
        ...
        <tr style="height:48px;">
            ...
            <td>
                ...
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3200_03','附表3');">
                    附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            ...
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
        ...
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.2技能操作或手术★</td>
            <td>培训对象技能操作或手术情况</td>
            <td>随机抽查1～2名二年级以上培训对象进行技能操作或常见手术，查看其掌握情况</td>
            <td>
                技能操作评分表见附件

                <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_3200_Main','附表4-1至4-5');">
                    附表4-1至4-5</a>
                <br>
            ...
            <input type="hidden" id="scoreInfo4" name="scoreInfo" value="${scoreInfo4}">
            <input type="hidden" id="scoreInfo5" name="scoreInfo" value="${scoreInfo5}">
            <td style="text-align: center;">6</td>
            <td name="file" itemId="2022-4.2.2" itemName="技能操作或手术"></td>
            <td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.2.2" itemName="技能操作或手术" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.2.2" itemName="技能操作或手术"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.2" itemName="技能操作或手术" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                &#12288;&#12288;1.一级指标4项，二级指标10项，三级指标35项。三级指标中，核心指标14项、计67分，一般指标21项、计33分，共100分。<br>
