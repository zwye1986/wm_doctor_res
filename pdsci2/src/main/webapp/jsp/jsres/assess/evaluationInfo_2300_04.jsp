	...
	<script type="text/javascript">
		...
		function subInfo() {
			...
			if (${ roleFlag==("baseExpert")}) {
				input = window.parent.frames["jbox-message-iframe"].$("#fubiao4s");
			} else if (${roleFlag==("expertLeader")}) {
				input = window.parent.frames["jbox-message-iframe"].$("#fubiao4e");
			}
			if (expertTotal >= 90) {
				expertTotal = 8;
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
	<table cellpadding="4" style="width: 1000px">
		...
		<tr height="34" class="firstRow">
			<th colspan="6">
				<h2 style="font-size:150%">超声科学员上机操作评分表</h2>
			</th>
		</tr>
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;" colspan="4">培训基地（医院）：${orgName}</th>
			<th style="text-align:left;padding-left: 4px;" colspan="2">外单位者的单位名称：</th>
		</tr>
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;" colspan="4">学员姓名：</th>
			<th style="text-align:left;padding-left: 4px;" colspan="2">规1/2/3: </th>
		</tr>
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;" colspan="4">本科学员：是 （专硕）</th>
			<th style="text-align:left;padding-left: 4px;" colspan="2">社会人：</th>
		</tr>
