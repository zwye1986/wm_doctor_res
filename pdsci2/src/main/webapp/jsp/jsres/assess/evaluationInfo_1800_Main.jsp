    ...
    <div class="title_tab" id="toptab">
        <ul>
            <li class="tab" id="1A" style="cursor: pointer;">
                <a href="javascript:void(0)"  onclick="Schedule('evaluationInfo_1800_01','1A');">附表1-1</a>
            </li>
            <li class="tab" id="2A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_02','2A');">附表1-2</a>
            </li>
            <li class="tab" id="3A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_03','3A');">附表1-3</a>
            </li>
            <li class="tab" id="4A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_04','4A');">附表1-4</a>
            </li>
        </ul>
    </div>
</div>
