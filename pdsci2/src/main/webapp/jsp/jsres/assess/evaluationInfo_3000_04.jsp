...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <td style="width: 25%">
                <input onchange="saveScore(this,15);" itemId="3000-04-1.1" itemName="问诊及临床检查" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <td style="width: 25%">
                <input onchange="saveScore(this,25);" itemId="3000-04-1.2" itemName="口腔检查" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,6);" itemId="3000-04-2.1" itemName="主诉" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,4);" itemId="3000-04-2.2" itemName="现病史" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,2);" itemId="3000-04-2.3" itemName="既往史" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,8);" itemId="3000-04-2.4" itemName="临床检查" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td style="text-align: center;">8</td>
            <td>
                <input onchange="saveScore(this,8);" itemId="3000-04-2.5" itemName="诊断" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,12);" itemId="3000-04-2.6" itemName="治疗计划" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td style="text-align: center;">4</td>
            <td>
                <input onchange="saveScore(this,4);" itemId="3000-04-2.7" itemName="书写规范" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,16);" itemId="3000-04-3.1" itemName="医患沟通" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
