...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.1" itemName="器械选择" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.2" itemName="体位" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>4</th>
            <td>
                <input onchange="saveScore(this,4);" itemId="3000-06-1.3" itemName="探查" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>6</th>
            <td>
                <input onchange="saveScore(this,6);" itemId="3000-06-1.4" itemName="握持方法" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.5" itemName="支点" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.6" itemName="器械角度" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.7" itemName="工作端在操作中的使用情况" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>13</th>
            <td>
                <input onchange="saveScore(this,13);" itemId="3000-06-1.8" itemName="用力方式和方向" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-06-1.9" itemName="运动幅度" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3000-06-1.10" itemName="探针检查情况" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>12</th>
            <td>
                <input onchange="saveScore(this,12);" itemId="3000-06-1.11" itemName="干净程度" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
