...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
	<div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
		<table class="grid" style="width: 100%;" >
			<tr height="34" class="firstRow">
				<th colspan="11">
					<h2 style="font-size:150%">住院医师规范化培训评估指标——眼科专业基地</h2>
				</th>
			</tr>
			<tr height="28">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
		...
		<tr style="height:50px">
			...
			<td>
		     ...
		     <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
				   ...
				   <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="年收治病人数" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.2']}</textarea>
				</c:if>
			</td>
		</tr>
		<tr style="height:50px">
		...
		<tr style="height:50px">
			...
			<td>
				必备科室：眼科显微手术训练室 <br>
				相关科室：内科、外科、耳鼻喉科、口腔科、放射科、麻醉科、病理科、检验科
			</td>
			<td>查看相关文件，实地考查</td>
			<td>
				缺1个科室，不得分
		...
		<tr style="height:50px">
			<td>1.1.6轮转科室</td>
			<td>
				眼科门诊及病房（含白内障、青光眼、玻璃体视网膜、视光和屈光手术、斜视、角膜和眼表、眼整形、眼眶病和眼外伤等）神经内科、内分泌科、急诊科
			</td>
		...
		<tr style="height:50px">
			<td>1.1.7疾病种类及数量</td>
			<td rowspan="2">
				符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》眼科专业细则要求，详见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1700_01','附表1');">
						附表1</a>
			</td>
			<td>核对上一年度各亚专业（专科）收治疾病种类统计报表 </td>
			<td>
				符合要求（含协同单位），得满分 <br>
			...
			<td><input id="fubiao11" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.7"  itemName="疾病种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao11Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.7" itemName="疾病种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:50px">
			...
			<td><input id="fubiao12" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.8"  itemName="技能操作和手术种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao12Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:50px">
			...
			<td><input id="fubiao22" onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.9"  itemName="医院设备"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao22Expert" onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.9" itemName="医院设备"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
		...
		<tr style="height:50px">
			<td>1.1.10专业基地设备</td>
			<td>
				依据《住院医师规范化培训基地认定标准（试行）》眼科专业基地细则的要求，见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1700_02','附表2');">
						附表2</a>
			</td>
			<td>
				缺1项，不得分
			...
			<td style="text-align: center;">1</td>
			<td name="file" itemId="2022-1.1.1" itemName="专业基地设备"></td>
			<td><input id="fubiao21" onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.10"  itemName="专业基地设备"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao21Expert" onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="专业基地设备"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:60px;">
			...
			<td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.1.1"  itemName="师资情况"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="师资情况"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
		     ...
		     <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
				   ...
				   <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea onchange="saveSpeReason(this);" itemId="2022-2.1.1" itemName="师资情况" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.1']}</textarea>
				</c:if>
			</td>
		</tr>
		...
		<tr style="height:38px;">
			...
			<td>
				各亚专业（专科）应有主任医师≥1人，副主任医师≥2人，主治医师≥4人
			</td>
			<td>
				1个亚专业不达标，不得分			</td>
			<td style="text-align: center;">1</td>
		...
		<tr style="height:38px;">
			...
			<td>
				医学本科及以上学历,主任医师专业技术职务,从事眼科的医疗、科研和教学工作超过15年			</td>
			<td>1项不符合条件，不得分</td>
			<td style="text-align: center;">1</td>
		...
		<tr style="height:35px;">
			...
			<td>2.2.1师资培训★</td>
			<td>带教医师均参加过院级师资培训，亚专业（专科）至少1名带教医师参加过省级及以上师资培训</td>
		...
		<tr style="height:32px;">
			<td style="height: 32px;">3.2.3小讲课房</td>
			...
			<td style="text-align: center;">2</td>
			<td name="file" itemId="2022-3.2.3" itemName="小讲课房"></td>
			<td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.3"  itemName="小讲课房"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.3" itemName="小讲课房"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
		     ...
		     <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
				   ...
				   <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea onchange="saveSpeReason(this);" itemId="2022-3.2.3" itemName="小讲课房" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.3']}</textarea>
				</c:if>
			</td>
		</tr>
		<tr style="height:32px;">
		...
		<tr style="height:48px;">
			...
			<td>随机抽查访谈本院、委培、社会招收培训对象各1～2名，检查本年度原始资料</td>
			<td>
				考核项目全面，且认真规范，得满分<br>
				仅有技能操作考核，得2分<br>
				仅有理论考试，得1分<br>
		...
		<tr style="height:48px;">
			...
			<td rowspan="2">随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
			<td>
				管床数达到要求，得满分 <br>
				管床数≥3张，得2分 <br>
				管床数≥2，得1分 <br>
		...
		<tr style="height:48px;">
			...
			<td>4.1.1查房质量★</td>
			<td>主任或带教医师组织教学查房，悉心指导培训对象</td>
			<td>随机抽查1～2名带教医师教学查房</td>
			<td>
				教学查房评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1700_03','附表3');">
						附表3</a>
				<br>
			...
			<td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.1"  itemName="查房质量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="查房质量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:32px;">
			<td style="height: 32px;">4.1.2技能操作和手术安排情况★</td>
			<td>每个轮转科室均能按照《住院医师规范化培训内容与标准（试行）》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术
			</td>
			...
			<td>
		     ...
		     <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
				   ...
				   <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.1']}</textarea>
				</c:if>
			</td>
		</tr>
		<tr style="height:32px;">
		...
		<tr style="height:48px;">
			...
			<td>
				病历书写评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1700_04','附表4');">
						附表4</a>
				<br>
				≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
			</td>
			...
			<td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.1"  itemName="病历书写"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:48px;">
			...
			<td>
				技能操作评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1700_05','附表5');">
						附表5</a>
				<br>
			...
			<td><input id="fubiao5" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2"  itemName="技能操作和手术"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao5Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr>
			<td colspan="11" style="text-align: left">
				备注：<br>
				1.一级指标4项，二级指标10项，三级指标39项。三级指标中，核心指标14项、计65分，一般指标25项、计35分，共100分。<br>
