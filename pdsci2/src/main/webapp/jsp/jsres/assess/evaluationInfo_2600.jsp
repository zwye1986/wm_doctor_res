...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——医学遗传科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="12">1.基本条件（20分）</td>
            <td style="height:53px;" rowspan="9">1.1专业基地所在医院条件</td>
            <td>1.1.1总床位数</td>
            <td width="366px">
                三级甲等综合或专科医院医学遗传科床位总数≥30张（含妇产科、儿科、神经内科等遗传亚专业床位合计）
            </td>
            <td width="367px">符合标准，得满分 <br>
                不达标准，不得分
            <td style="text-align: center;width: 74px">3</td>
            <td width="207px" name="file" itemId="2022-1.1.1" itemName="总床位数"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}" itemName="总床位数"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.1" itemName="总床位数"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.1" value="3" onchange="selectRadio('2022-1.1.1','3','self','3','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input   type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','self','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.1" value="3" onchange="selectRadio('2022-1.1.1','3','expert','3','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','expert','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ...
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="总床位数" name="reason" placeholder="请填写扣分原因"
                               style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="年收治病人数" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="年门诊量" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.3']}</textarea>
                </c:if>
        ...
        <tr style="height:50px">
            <td>1.1.4科室和实验室</td>
            <td>
                必备科室:门诊部、急诊科、内科、外科、妇产科、儿科<br>
                辅助科室：放射科、超声科、病理科、检验医学科、遗传实验室
            </td>
            <td>符合要求（含协同单位），得1分<br>
                必备科室缺1个科室，不得分<br>
                辅助科室缺2个科室，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.4" itemName="科室和实验室" ></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.4" itemName="科室和实验室"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.4" itemName="科室和实验室"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','self','1','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input  type="radio"  name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','self','1','必备科室缺1个科室或辅助科室缺2个科室，不得分')"/>
                    &nbsp;<label >必备科室缺1个科室或辅助科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','expert','1','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input type="radio"   name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','expert','1','必备科室缺1个科室或辅助科室缺2个科室，不得分')"/>
                    &nbsp;<label>必备科室缺1个科室或辅助科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="科室和实验室" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.4']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.5轮转科室</td>
            <td>
                必选轮转科室：心血管内科、呼吸内科、消化内科、神经内科、儿科、妇产科、超声医学科、放射科、、医学遗传科、细胞遗传实验室、分子遗传实验室、遗传代谢实验室 <br>
                可选轮转科室：肾脏科、血液科、内分泌科、骨科、心胸外科、泌尿外科、耳鼻喉科、皮肤科、眼科
            <td>
                科室齐全（含协同单位），得满分<br>
                必选科室缺1个科室，不得分<br>
                可选科室缺2个科室，不得分
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="轮转科室"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="轮转科室"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.5" value="3" onchange="selectRadio('2022-1.1.5','3','self','3','')"/>
                    &nbsp;<label >科室齐全（含协同单位），得满分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','3','必选科室缺1个科室或可选科室缺2个科室，不得分')"/>
                    &nbsp;<label >必选科室缺1个科室或可选科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.5" value="3" onchange="selectRadio('2022-1.1.5','3','expert','3','')"/>
                    &nbsp;<label>科室齐全（含协同单位），得满分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','3','必选科室缺1个科室或可选科室缺2个科室，不得分')"/>
                    &nbsp;<label>必选科室缺1个科室或可选科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="轮转科室" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.5']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.6疾病种类及数量★</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》医学遗传科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2600_01','附表1');">
                        附表1</a>
                和
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2600_02','附表2');">
                        附表2</a>
            </td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td style="text-align: center;">3</td>
            <td name="file" itemId="2022-1.1.6" itemName="疾病种类及数量"></td>
            <td><input id="fubiao1" onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.6" itemName="疾病种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao1Expert" onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.6" itemName="疾病种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-1.1.6" itemName="疾病种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.7临床技能操作种类及数量★</td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td style="text-align: center;">3</td>
            <td name="file" itemId="2022-1.1.7" itemName="临床技能操作种类及数量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-1.1.7" itemName="临床技能操作种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.7']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.8医院设备</td>
            <td>
                神经电生理检查设备、彩色B超、X线射线机、CT、核磁共振
            </td>
            <td>
                缺1项，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.8" itemName="医院设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="医院设备"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="医院设备"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','self','1','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','self','1','缺1项，不得分')"/>
                    &nbsp;<label >缺1项，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','expert','1','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input type="radio"   name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','expert','1','缺1项，不得分')"/>
                    &nbsp;<label>缺1项，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="医院设备" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.8']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.9专业基地设备</td>
            <td>
                普通光学显微镜、二氧化碳培养箱、清洁操作台、大型离心机、小型离心机、涡旋混匀器、通风柜、DNA测序仪、恒温水浴箱、染色体图像采集及处理系统、倒置显微镜、荧光显微镜、串联质谱仪、全自动生化仪、冰箱、PCR仪、gPCR仪、电泳仪、高性高效液相仪
            </td>
            <td>
                缺1项，不得分
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.9" itemName="专业基地设备"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.9" itemName="专业基地设备"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.9" itemName="专业基地设备" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.9']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td style="height:53px;" rowspan="3">1.2协同单位</td>
            <td>1.2.1协同数</td>
            <td>
                协同数量不应超过3个
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.2.2" itemName="协同床位数" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.2.2']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.2.3轮转时间</td>
        ...
        <tr style="height:60px;">
            <td style="height: 438px;" rowspan="7">2.师资条件（15分）</td>
            <td rowspan="4">2.1师资情况</td>
            <td>2.1.1带教医师与培训对象比例★</td>
            <td>
                每名带教医师同时带教本专业培训对象不超过1名
            </td>
            <td>
                不达标准，不得分
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="带教医师与培训对象比例"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="带教医师与培训对象比例"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.1.1" value="3" onchange="selectRadio('2022-2.1.1','3','self','3','')"/>
                    &nbsp;<label >达到标准，得满分</label><br>
                    <input   type="radio"  name="2022-2.1.1" value="0" onchange="selectRadio('2022-2.1.1','0','self','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.1.1" value="3" onchange="selectRadio('2022-2.1.1','3','expert','3','')"/>
                    &nbsp;<label >达到标准，得满分</label><br>
                    <input type="radio"  name="2022-2.1.1" value="0" onchange="selectRadio('2022-2.1.1','0','expert','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-2.1.1" itemName="带教医师与培训对象比例" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历,主治医师专业技术职务3年以上，从事本专业医疗、科研和教学工作≥3年
            </td>
            <td>
                其中1名带教医师不符合要求，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-2.1.2" itemName="带教医师条件" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:38px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-2.1.3" itemName="带教医师组成" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.3']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历,主任医师专业技术职务,从事本专业的医疗、科研和教学工作≥15年
            </td>
            <td>1项不符合条件，不得分</td>
            <td style="text-align: center;">1</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-2.1.4" itemName="专业基地负责人条件" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.1.4']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:35px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-2.2.1" itemName="师资培训" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.2.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:35px;">
            <td>2.2.2师资评价★</td>
            <td>每年至少组织1次对带教医师教学工作进行评价</td>
            <td>
                有评价方案，原始记录详实，得满分<br>
                有评价记录，无方案，得2分<br>
                有方案，无评价记录，得1分<br>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input  type="radio"  name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','self','3','有评价记录，无方案，得2分')"/>
                    &nbsp;<label >有评价记录，无方案，得2分</label><br>
                    <input  type="radio"  name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','self','3','有方案，无评价记录，得1分')"/>
                    &nbsp;<label >有方案，无评价记录，得1分</label><br>
                    <input type="radio"  name="2022-2.2.2" value="0" onchange="selectRadio('2022-2.2.2','0','self','3','无，不得分')"/>
                    &nbsp;<label >无，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-2.2.2" value="3" onchange="selectRadio('2022-2.2.2','3','expert','3','')"/>
                    &nbsp;<label>有评价方案，原始记录详实，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','expert','3','有评价记录，无方案，得2分')"/>
                    &nbsp;<label>有评价记录，无方案，得2分</label><br>
                    <input   type="radio"  name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','expert','3','有方案，无评价记录，得1分')"/>
                    &nbsp;<label>有方案，无评价记录，得1分</label><br>
                    <input type="radio"   name="2022-2.2.2" value="0" onchange="selectRadio('2022-2.2.2','0','expert','3','无，不得分')"/>
                    &nbsp;<label>无，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-2.2.2" itemName="师资评价" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.2.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:59px;">
            <td style="height: 59px;">2.2.3激励制度★</td>
            <td>建立带教医师激励机制，将教学工作与绩效考评、奖金、评优等挂钩</td>
            <td>
                有机制，并与奖金、评优等挂钩，得满分<br>
                有机制，未与奖金、评优挂钩，得1分<br>
                无，不得分
            </td>
            <td style="text-align: center;">3</td>
            <td name="file" itemId="2022-2.2.3" itemName="激励制度"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.2.3" itemName="激励制度"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.2.3" itemName="激励制度"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-2.2.3" value="3" onchange="selectRadio('2022-2.2.3','3','self','3','')"/>
                    &nbsp;<label >有机制，并与奖金、评优等挂钩，得满分</label><br>
                    <input  type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','self','3','有机制，未与奖金、评优挂钩，得2分')"/>
                    &nbsp;<label >有机制，未与奖金、评优挂钩，得2分</label><br>
                    <input type="radio"  name="2022-2.2.3" value="0" onchange="selectRadio('2022-2.2.3','0','self','3','无，不得分')"/>
                    &nbsp;<label >无，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-2.2.3" value="3" onchange="selectRadio('2022-2.2.3','3','expert','3','')"/>
                    &nbsp;<label>有机制，并与奖金、评优等挂钩，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','expert','3','有机制，未与奖金、评优挂钩，得2分')"/>
                    &nbsp;<label>有机制，未与奖金、评优挂钩，得2分</label><br>
                    <input type="radio"   name="2022-2.2.3" value="0" onchange="selectRadio('2022-2.2.3','0','expert','3','无，不得分')"/>
                    &nbsp;<label>无，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-2.2.3" itemName="激励制度" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-2.2.3']}</textarea>
                </c:if>
            </td>
        </tr>

        <tr style="height:32px;">
            <td style="height: 438px;" rowspan="12">3.过程管理（30分）</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.1.1" itemName="主任职责" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-3.1.2" itemName="教学主任"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-3.1.2" itemName="教学主任"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.1.2" value="1" onchange="selectRadio('2022-3.1.2','1','self','1','')"/>
                    &nbsp;<label >职责明确，履职认真，得1分</label><br>
                    <input type="radio"  name="2022-3.1.2" value="0" onchange="selectRadio('2022-3.1.2','0','self','1','无岗位职责，或履职不认真，不得分')"/>
                    &nbsp;<label >无岗位职责，或履职不认真，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.1.2" value="1" onchange="selectRadio('2022-3.1.2','1','expert','1','')"/>
                    &nbsp;<label>职责明确，履职认真，得1分</label><br>
                    <input type="radio"   name="2022-3.1.2" value="0" onchange="selectRadio('2022-3.1.2','0','expert','1','无岗位职责，或履职不认真，不得分')"/>
                    &nbsp;<label>无岗位职责，或履职不认真，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.1.2" itemName="教学主任" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-3.1.3" itemName="教学秘书" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.3']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td>3.1.4教学小组</td>
            <td>成立教学小组，明确小组职责，定期组织研究教学工作</td>

            <td>有教学小组，履职认真，得1分<br>
                无，或履职不认真，不得分
            </td>
            <td style="text-align: center;">1</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.1.4" itemName="教学小组" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.4']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-3.1.5" itemName="轮转计划"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-3.1.5" itemName="轮转计划"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.1.5" value="3" onchange="selectRadio('2022-3.1.5','3','self','3','')"/>
                    &nbsp;<label >有，且严格落实，得满分</label><br>
                    <input type="radio"  name="2022-3.1.5" value="0" onchange="selectRadio('2022-3.1.5','0','self','3','未严格落实，不得分')"/>
                    &nbsp;<label >未严格落实，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.1.5" value="3" onchange="selectRadio('2022-3.1.5','3','expert','3','')"/>
                    &nbsp;<label>有，且严格落实，得满分</label><br>
                    <input type="radio"   name="2022-3.1.5" value="0" onchange="selectRadio('2022-3.1.5','0','expert','3','未严格落实，不得分')"/>
                    &nbsp;<label>未严格落实，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-3.1.5" itemName="轮转计划" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.5']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td>3.1.6考勤制度</td>
            <td>有考勤规章制度，有专人负责，并严格执行</td>
            <td>有，且严格落实，得满分
                未严格落实，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);"  itemId="2022-3.1.6" itemName="考勤制度" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.6']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:40px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-3.2.1" itemName="入科教育" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.2教学查房</td>
            <td>开展规范的教学查房或门诊病例讨论，至少每周1次</td>
            <td>
                开展次数达标，且认真规范，得满分 <br>
                未达标或不规范，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="教学查房" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.3小讲课</td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.2.3" itemName="小讲课" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.3']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.4疑难病例讨论</td>
            <td>开展规范的疑难病例讨论，至少2周1次</td>
            <td>
                开展次数达标，且认真规范，得满分 <br>
                未达标或不规范，不得分
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.2.4" itemName="疑难病例讨论" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.4']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height:136px;" rowspan="1">3.3过程考核</td>
            <td>3.3.1出科考核★</td>
            <td>
                理论考核(如临床病例分析)试题、技能操作考核评分标准、培训对象测评结果、考勤记录等原始资料齐全，真实规范

            <td>考核项目全面，且认真规范，得满分<br>
                仅有技能操作考核，得4分<br>
                仅有理论考试，得2分<br>
                仅有测评结果和考勤记录，得1分
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-3.3.1" itemName="出科考核"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-3.3.1" itemName="出科考核"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.3.1" value="7" onchange="selectRadio('2022-3.3.1','7','self','7','')"/>
                    &nbsp;<label >考核项目全面，且认真规范，得满分</label><br>
                    <input   type="radio"  name="2022-3.3.1" value="4" onchange="selectRadio('2022-3.3.1','4','self','7','仅有技能操作考核，得4分')"/>
                    &nbsp;<label >仅有技能操作考核，得4分</label><br>
                    <input   type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','self','7','仅有理论考试，得2分')"/>
                    &nbsp;<label >仅有理论考试，得2分</label><br>
                    <input   type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','self','7','仅有测评结果和考勤记录，得1分')"/>
                    &nbsp;<label >仅有测评结果和考勤记录，得1分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-3.3.1" value="7" onchange="selectRadio('2022-3.3.1','7','expert','7','')"/>
                    &nbsp;<label >考核项目全面，且认真规范，得满分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="4" onchange="selectRadio('2022-3.3.1','4','expert','7','仅有技能操作考核，得4分')"/>
                    &nbsp;<label >仅有技能操作考核，得4分</label><br>
                    <input   type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','self','7','仅有理论考试，得2分')"/>
                    &nbsp;<label >仅有理论考试，得2分</label><br>
                    <input   type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','self','7','仅有测评结果和考勤记录，得1分')"/>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-3.3.1" itemName="出科考核" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.3.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height:136px;">3.4培训强度</td>
            <td style="height: 48px;">3.4.1培训工作量★</td>
            <td>
                符合《住院医师规范化培训内容与标准（试行）》医学遗传科专业细则的要求
            <td>
                管床或处置遗传病例数达要求，得满分 <br>
                管床或处置数≥规定数的80%，得3分<br>
                管床或处置数≥规定数的60%，得1分<br>
                未安排独立管床或不能独立处置，不得分
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label >管床或处置遗传病例数达要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','self','6','管床或处置数≥规定数的80%，得3分')"/>
                    &nbsp;<label >管床或处置数≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','6','管床或处置数≥规定数的60%，得1分')"/>
                    &nbsp;<label >管床或处置数≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','6','未安排独立管床或不能独立处置，不得分')"/>
                    &nbsp;<label >未安排独立管床或不能独立处置，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','expert','6','')"/>
                    &nbsp;<label>管床或处置遗传病例数达要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','expert','6','管床或处置数≥规定数的80%，得3分')"/>
                    &nbsp;<label >管床或处置数≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','6','管床或处置数≥规定数的60%，得1分')"/>
                    &nbsp;<label >管床或处置数≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','6','未安排独立管床或不能独立处置，不得分')"/>
                    &nbsp;<label >未安排独立管床或不能独立处置，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="培训工作量" name="reason" placeholder="请填写扣分原因"
                           style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.1']}</textarea>
                </c:if>
            </td>
        </tr>

        <tr style="height:48px;">
            <td style="height:96px;" rowspan="6">4.质量控制（35分）</td>
            <td rowspan="3">4.1带教医师教学质量</td>
            <td>4.1.1查房质量★</td>
            <td>主任或带教医师组织开展规范的教学查房，悉心指导培训对象</td>
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2600_03','附表3');">
                        附表3</a>
                <br>
            ...
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.1.1" itemName="带教医师教学质量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.1.1" itemName="带教医师教学质量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.2技能操作安排情况★</td>
            <td>每个轮转科室均能按照《住院医师规范化培训内容与标准（试行）》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作
            </td>
            <td>
                满意率≥90%，得满分 <br>
                满意率≥80%，得2分 <br>
            ...
            <td name="file" itemId="2022-4.1.2" itemName="技能操作安排情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作安排情况"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作安排情况"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','self','4','')"/>
                    &nbsp;<label >满意率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','self','4','满意率≥80%，得2分')"/>
                    &nbsp;<label >满意率≥80%，得2分</label>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','4','满意率＜80%，不得分')"/>
                    &nbsp;<label >满意率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','expert','4','')"/>
                    &nbsp;<label>满意率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','expert','4','满意率≥80%，得2分')"/>
                    &nbsp;<label >满意率≥80%，得2分</label>
                    <input type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','expert','4','满意率＜80%，不得分')"/>
                    &nbsp;<label >满意率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.1.2" itemName="技能操作安排情况" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.3技能操作带教情况★</td>
            <td>带教医师协助并指导培训对象完成技能操作，带教严格规范
            </td>
            <td>
                1.培训对象操作前是否与患者交流、沟通 1分<br>
                2.培训对象操作中存在问题及时进行指导 1分<br>
                3.培训对象操作结束后提问 1分<br>
                4.对培训对象的操作进行总体评价（优、缺点点评） 2分
            </td>
            <td style="text-align: center;">5</td>
            <td name="file" itemId="2022-4.1.3" itemName="技能操作带教情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作带教情况"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作带教情况"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td style="height: 48px;">4.2.1病历或医疗文书书写★</td>
            <td>培训对象病历或系谱图分析、基因检测报告等医疗文书书写规范</td>
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2600_04','附表4');">
                        附表4</a>
                <br>
                ≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">7</td>
            <td name="file" itemId="2022-4.2.1" itemName="病历或医疗文书书写"></td>
            <td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="病历或医疗文书书写"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="病历或医疗文书书写"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.2.1" itemName="病历或医疗文书书写" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.1']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.2技能操作★</td>
            <td>培训对象技能操作情况</td>
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2600_05','附表5');">
                        附表5</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">5</td>
            <td name="file" itemId="2022-4.2.2" itemName="技能操作"></td>
            <td><input id="fubiao5" onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.2.2" itemName="技能操作"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao5Expert" onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.2.2" itemName="技能操作"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.3" itemName="完成培训内容与要求"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.3" itemName="完成培训内容与要求"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.2.3" value="8" onchange="selectRadio('2022-4.2.3','8','self','8','')"/>
                    &nbsp;<label > 完成率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','self','8','完成率≥85%，得5分')"/>
                    &nbsp;<label >完成率≥85%，得5分</label>
                    <input type="radio"  name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','self','8','完成率≥80%，得3分')"/>
                    &nbsp;<label >完成率≥80%，得3分</label>
                    <input type="radio"  name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','self','8','完成率＜80%，不得分')"/>
                    &nbsp;<label >完成率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.2.3" value="8" onchange="selectRadio('2022-4.2.3','8','expert','8','')"/>
                    &nbsp;<label> 完成率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','expert','8','完成率≥85%，得5分')"/>
                    &nbsp;<label >完成率≥85%，得5分</label>
                    <input type="radio"  name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','expert','8','完成率≥80%，得3分')"/>
                    &nbsp;<label >完成率≥80%，得3分</label>
                    <input type="radio"  name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','expert','8','完成率＜80%，不得分')"/>
                    &nbsp;<label >完成率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.2.3" itemName="完成培训内容与要求" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.3']}</textarea>
                </c:if>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="10" style="text-align: left">
                备注：<br>
                &#12288;&#12288;1.一级指标4项，二级指标10项，三级指标38项。三级指标中，核心指标15项、计67分，一般指标23项、计33分，共100分。<br>
