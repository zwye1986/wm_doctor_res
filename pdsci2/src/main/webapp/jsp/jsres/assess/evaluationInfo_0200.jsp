...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——儿科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%;" >
        ...
        <tr style="height:50px">
            ...
            <td rowspan="10">1.1专业基地<br>所在医院条件</td>
            <td >1.1.1总床位数</td>
            <td width="313px">
                儿科床位总数≥100张
            </td>
        ...
        <tr style="height:53px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or 
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="年收治病人数" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.5科室和实验室</td>
            <td>
                必备科室:门诊部、急诊科、影像科、病理科、检验科
                综合实验室：肺功能室、血检室、胃肠功能室、内分泌功能检查室
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                必备科室缺1个科室，不得分<br>
        ...
        <tr style="height:53px;">
            ...
            <td rowspan="2">
                ...
                和《住院医师规范化培训内容与标准（试行）》
                儿科专业细则要求。详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0200_01','附表1');">附表1</a>
            </td>
            <td>核对上一年度各亚专业(专科)
                收治疾病种类和数量统计报表
            </td>
        ...
        <tr style="height:53px;">
            <td>1.1.9医院设备</td>
            <td>
                CT、X射线机、脑电图机、心脏彩色超声心动图仪、
                纤维胃镜、纤维肠镜、纤维支气管镜、呼吸机、
                心脏脑复苏等急救设备。详见

                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0200_02','附表2');">附表2</a>
            </td>
            ...
            <td><input id="fubiao22" onchange="saveScore(this,1);" itemId="2022-1.1.9" itemName="医院设备" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao22Expert" onchange="saveScore4Expert(this,1);" itemId="2022-1.1.9" itemName="医院设备"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            ...
            <td><input id="fubiao21" onchange="saveScore(this,1);" itemId="2022-1.1.10" itemName="专业基地设备" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao21Expert" onchange="saveScore4Expert(this,1);" itemId="2022-1.1.10" itemName="专业基地设备"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，
                从事儿科专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                符合条件，得满分<br>
                1项不符合条件，不得分
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="培训强度" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="培训强度" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>管床数≥3张，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','4','管床数≥2张，得1分')"/>
                    &nbsp;<label>管床数≥2张，得1分</label><br>
        ...
        <tr style="height:50px">
            <td style="height: 238px;" rowspan="6">4.质量控制<br>（35分）</td>
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0200_03','附表3');">附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，<br>
                ≥70分得2分，≥60分得1分，<br>
                ＜60分不得分<br>
            ...
            <td><input id="fubiao3" onchange="saveScore(this,4);" itemId="2022-4.1.1" itemName="教学查房质量" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.1" itemName="教学查房质量"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                要求执行，为每名培训对象安排并完
                成规定的技能操作和手术（见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0200_01','附件1');">附件1</a>
                ）
            </td>
            <td>随机抽查5～10名培训对象，由评
                估专家根据本专业实际需求确定手
            ...
            <td><input id="fubiao111" onchange="saveScore(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao111Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                    ...
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0200_04','附表4');">附表4</a>
                <br>
                ≥90分得满分，≥80分得3分， <br>
                ≥70分得2分，≥60分得1分，<br>
                ＜60分不得分
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_0200_Main','附表5');">附表5</a>
                <br>
                ≥90分得满分，≥80分得5分， <br>
                ≥70分得3分，≥60分得1分， <br>
                ＜60分不得分
            ...
            <input type="hidden" id="scoreInfo5" value="${scoreInfo5}">

            <td><input id="fubiao5" onchange="saveScore(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao5Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                按照本专业《住院医师规范化培训内容与标准（试行）》细则，现场考察培训对象掌握情况
            </td>
            <td>随机抽查本院、委培、社会招收培训对象各2～3名，进行现场理论考核
            </td>
            <td>
                ≥90分，得满分<br>
                ≥80分，得5分<br>
