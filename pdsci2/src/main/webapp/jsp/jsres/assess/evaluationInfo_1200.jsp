...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——外科（泌尿外科）专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:64px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》
                外科（泌尿外科方向）专业细则要求，详见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_1200_Main','附表1-1至1-6');">附表1-1至1-6</a>
            </td>
            <td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事泌尿外科专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1200_02','附表2');">附表2</a>
                <br>
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1200_03','附表3');">附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分<br>
                ≥60分得1分，＜60分不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1200_04','附表4');">附表4</a>
                <br>
            ...
            <td><input id="fubiao4" onchange="saveScore(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao4Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
