...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
	<div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
		<table class="grid" style="width: 100%;" >
			<tr height="34" class="firstRow">
				<th colspan="11">
					<h2 style="font-size:150%">住院医师规范化培训评估指标——儿外科专业基地</h2>
				</th>
			</tr>
			<tr height="28" >
	...
	<table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
		...
		<tr style="height:32px;">
			...
			<td>
				门诊部、急诊科、影像科、病理科、检验科、重症监护室、儿内科、手术室、麻醉科、中心实验室、输血科
			</td>
			<td>查看相关文件，实地考查</td>
			<td>
				缺1个科室，不得分
		...
		<tr style="height:32px;">
			...
			<td>
				综合医院：成人普通外科、成人胸心外科、成人泌尿外科、成人骨科，小儿普通外科、小儿骨科、
				小儿泌尿外科、小儿心胸外科、小儿神经外科、新生儿外科、小儿肿瘤外科、小儿麻醉科或儿科重症监护（PICU）、
				小儿烧伤整形科、小儿医学影像科或病理科<br>
				儿童医院：除成人外科部分之外的其他小儿外科部分的相应专业
			</td>
			<td>
				1.查看各亚专业（专科）设置名称<br>
		...
		<tr style="height:64px">
			...
			<td>
				符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》儿外科专业细则要求，详见
					<a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_1500_Main','附表1-1至1-6');">
						附表1-1至1-6</a>
			</td>
			<td>
		...
		<tr style="height:50px;">
			...
			<td>
				X射线机、C形臂X线机、空气灌肠机、B超机、CT、MRI、心脏彩色超声、脑电图机、纤维胃镜、纤维肠镜、纤维支气管镜、
				腹腔镜、胸腔镜、膀胱镜、尿道镜、尿动力学检查设备、24小时pH监测、胃肠动力检查设备、手术显微镜、体外循环机、
				自体血液回收机、麻醉机、呼吸机、监护仪、心肺脑复苏急救设备
			</td>
			<td>
		...
		<tr style="height:50px;">
			...
			<td>
				心电图、暖箱、新生儿辐射式抢救台、蓝光箱、雾化吸入装置、血气分析仪、输液泵、监护仪、中心供氧接口或氧气筒、常用急救设备
			</td>
			<td>
				检查设备清单复印件，需加盖医院公章，实地考查
			</td>
		...
		<tr style="height:38px;">
			...
			<td>
				医学本科及以上学历,主治医师专业技术职务3年以上，从事本专业工作≥5年
			</td>
			<td rowspan="3">
		...
		<tr style="height:38px;">
			...
			<td>
				医学本科及以上学历，主任医师专业技术职务，从事儿外科专业的医疗、科研和教学工作≥15年
			</td>
			<td>
				1项不符合条件，不得分
			</td>
		...
		<tr style="height:48px;">
			...
			<td>3.4.1管理床位数★</td>
			<td>
				病房：日管床数≥8张(在带教医师指导下独立于其他培训对象管理床位)
			</td>
			<td rowspan="2">
			...
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
					...
					<input type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','4','管床数≥6张，得2分')"/>
					&nbsp;<label >管床数≥6张，得2分</label><br>
					<input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','4','管床数≥5，得1分')"/>
					&nbsp;<label >管床数≥5，得1分</label><br>
					<input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','4','管床数＜5张，或未安排，不得分')"/>
					&nbsp;<label >管床数＜5张，或未安排，不得分</label>
				</c:if>
				 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
					<input   type="radio"  name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','expert','4','')"/>
					&nbsp;<label>管床数达到要求，得满分</label><br>
					<input type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','expert','4','管床数≥6张，得2分')"/>
					&nbsp;<label >管床数≥6张，得2分</label><br>
					<input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','4','管床数≥5，得1分')"/>
					&nbsp;<label >管床数≥5，得1分</label><br>
					<input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','4','管床数＜5张，或未安排，不得分')"/>
					&nbsp;<label >管床数＜5张，或未安排，不得分</label>
				</c:if>
				  <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea  onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="管理病床数" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.1']}</textarea>
				</c:if>
			</td>
		</tr>
		<tr style="height:48px;">
		...
		<tr style="height:48px;">
			...
			<td>
				教学查房评分表见
					...
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1500_02','附表2');">
						附表2</a>
				<br>
			...
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
				 ...
				 <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
				  ...
				  <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
				<textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea>
				</c:if>
			</td>
		</tr>
		<tr style="height:48px;">
		...
		<tr style="height:48px;">
			...
			<td>
				病历书写评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1500_03','附表3');">
						附表3</a>
		...
		<tr style="height:48px;">
			...
			<td>
				技能操作评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1500_04','附表4');">
						附表4</a>
				<br>
			...
			<td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr>
			<td colspan="11" style="text-align: left">
				备注：<br>
				&#12288;&#12288;1.一级指标4项，二级指标10项，三级指标37项。三级指标中，核心指标15项、计68分，一般指标24项、计32分，共100分。<br>
				&#12288;&#12288;2.随机抽查对象优先选择委托培训对象和面向社会招收的培训对象，如果没有，可考虑本基地培训对象。<br>
				&#12288;&#12288;3.现场评估时详细填写存在的问题和扣分原因。<br>
