...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-07-1.1" itemName="无菌原则：洗手方法(4分)" name="self"
                       class="input"
        ...
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-07-1.2" itemName="器械准备：手术器械盘的准备（2分）" name="self"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="3000-07-1.3" itemName="画线" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-07-1.4" itemName="切开" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>15</th>
            <td>
                <input onchange="saveScore(this,15);" itemId="3000-07-1.5" itemName="缝合：右手持针器的握持姿势以及方法" name="self"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>15</th>
            <td>
                <input onchange="saveScore(this,15);" itemId="3000-07-1.6" itemName="缝合：缝合时术者肘部指点的放置" name="self"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>15</th>
            <td>
                <input onchange="saveScore(this,15);" itemId="3000-07-1.7" itemName="打结" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-07-1.8" itemName="剪线" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="3000-07-1.9" itemName="整体评价" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
