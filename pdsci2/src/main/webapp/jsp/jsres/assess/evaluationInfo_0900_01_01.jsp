	...
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		<tbody>
			<tr height="34" class="firstRow">
				<th colspan="6">
					<h2 style="font-size:150%"> ICU疾病种类/临床技能操作</h2>
				</th>
			</tr>
			...
			<tr style="height:32px">
				...
				<th colspan="2">≥50</th>
				<td>
					<input onchange="saveScore(this,50);" itemId="0900-01-1.1" itemName="k重症病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-1.1" readonly="readonly" itemName="d重症病人"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >机械通气治疗病人</th>
				<th colspan="2">≥25</th>
				<td>
					<input onchange="saveScore(this,25);" itemId="0900-01-1.2" itemName="k机械通气治疗病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-1.2"readonly="readonly" itemName="d机械通气治疗病人"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				...
				<th colspan="2">≥5</th>
				<td>
					<input onchange="saveScore(this,5);" itemId="0900-01-2.1" itemName="k心肺复苏"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-2.1"readonly="readonly" itemName="d心肺复苏"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >电除颤</th>
				<th colspan="2">≥5</th>
				<td>
					<input onchange="saveScore(this,5);" itemId="0900-01-2.2" itemName="k电除颤"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-2.2"readonly="readonly" itemName="d电除颤"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >常用监测技术</th>
				<th colspan="2">≥10</th>
				<td>
					<input onchange="saveScore(this,10);" itemId="0900-01-2.3" itemName="k常用监测技术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-2.3"readonly="readonly" itemName="d常用监测技术"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >呼吸机操作</th>
				<th colspan="2">≥5</th>
				<td>
					<input onchange="saveScore(this,5);" itemId="0900-01-2.4" itemName="k呼吸机操作"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="0900-01-2.4" readonly="readonly" itemName="d呼吸机操作"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
