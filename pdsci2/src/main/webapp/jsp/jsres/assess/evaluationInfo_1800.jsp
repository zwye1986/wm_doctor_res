...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——耳鼻咽喉科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="13">1.基本条件（18分）</td>
            <td style="height:53px;" rowspan="10">1.1专业基地所在医院条件</td>
            <td>1.1.1总床位数</td>
            <td width="313px">
                三级甲等综合医院耳鼻咽喉科床位总数≥30张（鼻科≥10张，耳科≥10张，咽喉、头颈外科≥10张）
            </td>
            ...
            <td>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label >符合标准，得1分</label><br>
                    <input type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','expert','2','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                ...
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="总床位数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="年收治病人数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="年门诊量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="年急诊量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.5科室和实验室</td>
            <td>
                普通外科、胸心外科、神经外科、急诊科、麻醉科、放射科、外科重症监护室、基础实验室（中心实验室）
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                缺1个科室，不得分
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','1','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.5" value="1" onchange="selectRadio('2022-1.1.5','1','expert','1','')"/>
                    &nbsp;<label>科室齐全，得满分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','1','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="科室和实验室" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                           class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.5']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.6轮转科室</td>
            <td>
                耳鼻咽喉科门急诊、耳鼻咽喉头颈外科病房、相关临床科室（重症监护病房ICU、急诊科、普通外科、麻醉科、放射影像科）
            </td>
            <td>查看各亚专业（专科）设置名称 <br>
                查看培训对象轮转计划和登记手册<br>
                实地考查，访谈培训对象
            </td>
            <td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="轮转科室" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.7疾病种类及数量</td>
            <input type="hidden" id="jScoreInfo1" name="jScoreInfo" value="${jScoreInfo1}">
            <input type="hidden" id="jScoreInfo2" name="jScoreInfo" value="${jScoreInfo2}">
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》耳鼻咽喉科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_1800_Main','附表1-1至1-4');">
                        附表1-1至1-4</a>
            </td>
            <td>核对上一年度各亚专业（专科）收治疾病种类及数量统计报表</td>
            <td>
                符合要求（含协同单位），得满分 <br>
            ...
            <td><input id="fubiao1" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.7" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao1Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.7" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.7" itemName="疾病种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.7']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.8技能操作和手术种类及数量★</td>
            <input type="hidden" id="cScoreInfo1" name="cScoreInfo" value="${cScoreInfo1}">
            <input type="hidden" id="cScoreInfo2" name="cScoreInfo" value="${cScoreInfo2}">
            <td>核对上一年度各亚专业（专科）技能操作、手术种类及数量的统计报表</td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.9" itemName="医院设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.9']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.10专业基地设备</td>
            <td>
                依据《住院医师规范化培训基地认定标准（试行）》本专业基地细则的要求，见
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_05','附表2');"/>
            </td>
            <td>检查设备清单复印件，需加盖医院公章，实地考查</td>
            <td>
                缺1项，不得分
            ...
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.10" itemName="专业基地设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:60px;">
            <td style="height: 438px;" rowspan="7">2.师资条件（17分）</td>
            ...
            <td name="file" itemId="2022-2.1.1" itemName="轮转时间"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="轮转时间" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="轮转时间" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.1.1" value="3" onchange="selectRadio('2022-2.1.1','3','self','3','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input   type="radio"  name="2022-2.1.1" value="1" onchange="selectRadio('2022-2.1.1','1','self','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.1.1" value="3" onchange="selectRadio('2022-2.1.1','3','expert','3','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-2.1.1" value="1" onchange="selectRadio('2022-2.1.1','1','expert','3','不达标准，不得分')"/>
                    &nbsp;<label >不达标准，不得分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-2.1.1" itemName="轮转时间" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主治医师专业技术职务3年以上，从事本专业临床工作≥10年
            </td>
            <td rowspan="3">
        ...
        <tr style="height:38px;">
            ...
            <td>
                各亚专业（专科）应有3名以上符合带教资格的带教医师；科室主任医师与副主任医师比例1:3，临床医师与医技人员的比例为1：3
            </td>
            <td>1个亚专业（专科）不达标，不得分</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事耳鼻咽喉科专业工作超过15年
            </td>
            <td>1项不符合条件，不得分</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:59px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input  type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','self','4','有激励机制，未与奖金、评优挂钩，得1分')"/>
                    &nbsp;<label >有激励机制，未与奖金、评优挂钩，得1分</label><br>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有激励机制，并与奖金、评优挂钩，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','expert','4','有激励机制，未与奖金、评优挂钩，得1分')"/>
                    &nbsp;<label>有激励机制，未与奖金、评优挂钩，得1分</label><br>
        ...
        <tr style="height:40px;">
            ...
            <td>
                规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通等内容的入科教育，并有专人组织实施
            </td>
            <td>提供本年度入科教育原始资料</td>
            <td>
                有，且严格落实，得1分 <br>
        ...
        <tr style="height:48px;">
            ...
            <td style="height: 48px;">3.4.1管理床位数★</td>
            <td>
                病房：日管床数≥6张(在带教医师指导下独立于其他培训对象管理床位)
            </td>
            <td rowspan="2">查看轮转手册等相关材料，随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
            <td>
                管床数达到要求，得满分 <br>
                管床数≥4张，得2分<br>
                管床数≥3，得1分<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="管理床位数" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="管理床位数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','self','4','')"/>
                    &nbsp;<label >管床数达到要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','4','管床数≥4张，得2分')"/>
                    &nbsp;<label >管床数≥4张，得2分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','4','管床数≥3，得1分')"/>
                    &nbsp;<label >管床数≥3，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','4','管床数＜3张，或未安排，不得分')"/>
                    &nbsp;<label >管床数＜3张，或未安排，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','expert','4','')"/>
                    &nbsp;<label>管床数达到要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','expert','4','管床数≥4张，得2分')"/>
                    &nbsp;<label >管床数≥4张，得2分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','4','管床数≥3，得1分')"/>
                    &nbsp;<label >管床数≥3，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','4','管床数＜3张，或未安排，不得分')"/>
                    &nbsp;<label >管床数＜3张，或未安排，不得分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="管理床位数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.1']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">3.4.2门急诊工作量</td>
            <td>门急诊量（参照《住院医师规范化培训基地认定标准（试行）》本专业细则要求）
            </td>
            <td>
                门急诊工作量达到要求，得满分 <br>
                门急诊量≥规定数的80%，得2分<br>
            ...
            <td>
                ...
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.4.2" itemName="门急诊工作量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            ...
            <td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="查房质量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="查房质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="查房质量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.1']}</textarea>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.2技能操作和手术安排★</td>
            <input type="hidden" id="AScoreInfo1" name="AScoreInfo" value="${AScoreInfo1}">
            <input type="hidden" id="AScoreInfo2" name="AScoreInfo" value="${AScoreInfo2}">
            <td>每个轮转科室均按照《住院医师规范化培训内容与标准（试行）》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术（
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_02','附件1-2');">附件1-2</a>
                和
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_04','附件1-4');">附件1-4</a>）
            </td>
            <td>随机抽查5～10名培训对象技能操作和手术记录，了解实际情况</td>
            <td>
                完成率≥90%，得满分 <br>
                完成率≥80%，得4分<br>
                完成率＜80%，不得分
            ...
            <td><input id="fubiao112" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao112Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.3技能操作和手术带教情况★</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_06','附表3');">
                        附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            ...
            <td><input id="fubiao5" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao5Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);"  itemId="2022-4.2.1" itemName="病历书写" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>培训对象技能操作或手术情况</td>
            <td>随机抽查1～2名二年级以上培训对象进行技能操作或常见手术操作（术者、助手），查看其掌握情况</td>
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1800_07','附表4');">
                        附表4</a>
                <br>
            ...
            <td><input id="fubiao6" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao6Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作和手术" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.2.2" itemName="技能操作和手术" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.2.3" value="6" onchange="selectRadio('2022-4.2.3','6','self','6','')"/>
                    &nbsp;<label > 完成率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','self','6','完成率≥85%，得5分')"/>
                    &nbsp;<label >完成率≥85%，得5分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','self','6','完成率≥80%，得3分')"/>
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label> 完成率≥90%，得满分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','expert','6','完成率≥85%，得5分')"/>
                    &nbsp;<label >完成率≥85%，得5分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','expert','6','完成率≥80%，得3分')"/>
                    &nbsp;<label >完成率≥80%，得3分</label><br>
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                1.一级指标4项；二级指标10项；三级指标37项，核心指标15项，计68分，一般指标22项，共32分，共100分。<br>
