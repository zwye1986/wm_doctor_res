...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——检验医学科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="9">1.基本条件<br>（18分）</td>
            ...
            <td name="file" itemId="2022-1.1.1" itemName="日检验标本数" width="180px"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
                       itemName="日检验标本数" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.1" itemName="日检验标本数" name="expert"
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ...
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="日检验标本数" name="reason"
        ...
        <tr style="height:53px;">
            <td style="height:53px;">1.1.2质量体系和实验室安全</td>
            <td>质量相关文件体系和实验室安全设施</td>
            <td>实地考察</td>
            <td>合理,有效，得1分
                有欠缺，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.2" itemName="质量体系和实验室安全"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="质量体系和实验室安全" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="质量体系和实验室安全" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"   name="2022-1.1.2" value="1" onchange="selectRadio('2022-1.1.2','1','self','1','')"/>
                    &nbsp;<label >合理,有效，得1分</label><br>
                    <input  type="radio"  name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','self','1','有欠缺，不得分')"/>
                    &nbsp;<label >有欠缺，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.2" value="1" onchange="selectRadio('2022-1.1.2','1','expert','1','')"/>
                    &nbsp;<label >合理,有效，得1分</label><br>
                    <input   type="radio"   name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','expert','1','有欠缺，不得分')"/>
                    &nbsp;<label >有欠缺，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="质量体系和实验室安全" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td style="height:53px;">1.1.3专业设置</td>
            <td>临床体液、血液学专业
                临床微生物学专业
                临床化学专业
                临床免疫学专业
            ...
            <td name="file" itemId="2022-1.1.3" itemName="专业设置"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="专业设置" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="专业设置" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="专业设置" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.3']}</textarea>
            </td>
        </tr>
        <tr style="height:53px;">
            <td style="height:53px;">1.1.4轮转科室</td>
            <td>临床科室：心血管内科、肾内科、呼吸内科、消化内科、内分泌科、血液科
                专业科室：临床体液血液检验(包含输血1个月,如果同意，需要加具体培训内容）、临床免疫学检验、临床化学检验、临床微生物学检验、临床细胞分子遗传学检验
            </td>
            <td>查看培训对象轮转计划和登记手册
                实地考察，访谈培训对象
            </td>
            ...
            <td name="file" itemId="2022-1.1.4" itemName="轮转科室"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.4" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.4" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.4" value="3" onchange="selectRadio('2022-1.1.4','3','self','3','')"/>
                    &nbsp;<label >科室齐全，得3分</label><br>
                    <input  type="radio"  name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','self','3','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.4" value="3" onchange="selectRadio('2022-1.1.4','3','expert','3','')"/>
                    &nbsp;<label>科室齐全，得3分</label><br>
                    <input type="radio"   name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','expert','3','缺1个科室，不得分')"/>
                    &nbsp;<label>缺1个科室，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="轮转科室" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.4']}</textarea></c:if>
            </td>
        </tr>
        <tr style="height:53px;">
            <td>1.1.5疾病种类及数量★</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》检验医学科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2100_01','附表1');">附表1</a>
            </td>
            <td>核对上一年度轮转内科各亚专业（专科）收治疾病种类及数量的统计报表</td>
            <td>
                符合要求，得3分
                疾病种类及数量≥规定数的90%，得2分
                疾病种类及数量≥规定数的85%，得1分
            ...
            <td><input id="fubiao1s" onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao1e" onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="疾病种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.5']}</textarea>
            </td>
        </tr>
        <tr style="height:53px;">
            <td>1.1.6技能操作种类及数量★</td>
            <td>核对上一年度各亚专业（专科）技能操作种类及数量的统计报表</td>
            <td>
                符合要求，得4分
            ...
            <td name="file" itemId="2022-1.1.6" itemName="技能操作种类及数量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.6" itemName="技能操作种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.6" itemName="技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="技能操作种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea>
            </td>
        </tr>
        <tr style="height:53px;">
            <td>1.1.7实验室信息管理系统</td>
            <td>有完善的实验室信息管理系统，患者、仪器和标本检验信息进行统一管理</td>
            <td>实地考察</td>
            <td>
                有管理系统，并日常规范使用，得1分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.7" itemName="实验室信息管理系统"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="实验室信息管理系统" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="实验室信息管理系统" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','self','1','')"/>
                    &nbsp;<label >有管理系统，并日常规范使用，得1分</label><br>
                    <input type="radio"  name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','self','1','无管理系统，或日常不规范使用，不得分')"/>
                    &nbsp;<label >无管理系统，或日常不规范使用，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','expert','1','')"/>
                    &nbsp;<label>有管理系统，并日常规范使用，得1分</label><br>
                    <input type="radio"   name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','expert','1','无管理系统，或日常不规范使用，不得分')"/>
                    &nbsp;<label>无管理系统，或日常不规范使用，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.7" itemName="实验室信息管理系统" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.8" itemName="教学设施和设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="教学设施和设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="教学设施和设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','self','1','')"/>
                    &nbsp;<label >有示教室且设备完善，得1分</label><br>
                    <input type="radio"  name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','self','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label >无示教室或有示教室无设备，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','expert','1','')"/>
                    &nbsp;<label>有示教室且设备完善，得1分</label><br>
                    <input type="radio"   name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','expert','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label>无示教室或有示教室无设备，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="教学设施和设备" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.9专业基地设备</td>
            <td>
                1.共用设备：离心机、冰箱、低温冰箱、生物安全柜、光学生物显微镜
                2.临床体液、血液检验：全自动血细胞分析仪（五分类）、尿液干化学分析仪、尿液形态学分析仪、全自动凝血分析仪、血小板聚集仪、细胞显微图像分析仪
                3.临床微生物学检验：血培养仪、细菌药敏试验及鉴定仪、35℃培养箱、二氧化碳培养箱
                4.临床化学检验：全自动生化分析（含电解质测定）仪、蛋白电泳仪、高速离心机
                5.临床免疫检验：酶标仪、洗板机、化学或电化学发光免疫分析仪、荧光显微镜、恒温水浴箱
                6.临床细胞分子遗传检验：光学生物显微镜及纤维照像系统、洁净工作台、PCR仪、电泳仪、质谱仪、测序仪、流式细胞仪
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.9" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.9" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.9" itemName="专业基地设备" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.9']}</textarea>
            </td>
        </tr>
        <tr style="height:53px;">
            <td style="height: 200px;" rowspan="7">2.师资管理<br>（17分）</td>
            <td rowspan="4">2.1师资情况</td>
            <td>2.1.1带教医师与培训对象比例★</td>
            <td>
                根据样本量设置检验医师数量：检验医师 5人/100-150万样本量;10人/150-200万样本量;15人/大于200万。每名带教医师同时带教本专业培训对象不超过3名 .
            </td>
            <td>查看原始资料，访谈培训对象</td>
            <td>
                不达标准，不得分
            ...
            <td style="text-align: center;">3</td>
            <td name="file" itemId="2022-2.1.1" itemName="师资情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="师资情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.1.1" itemName="师资情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-2.1.1" itemName="师资情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>2.1.2带教医师条件</td>
            <td>
                从事检验医学科工作5年以上,主治医师或主管技师以上专业技术职称, 具有执业医师资质。
            </td>
            <td>查看人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章</td>
            <td>
                其中1名带教医师不符合要求，不得分
            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:53px;">
            <td>2.1.3带教医师组成</td>
            <td>
                各亚专业（专科）至少有1名检验医学专业副高及以上专业技术职务带教医师
            </td>
            <td rowspan="2">查看人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章</td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:53px;">
            ...
            <td>
                具有检验医学专业正高职称,同时是硕导或博导, 从事检验医学科工作10年以上.
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:53px;">
            ...
            <td style="text-align: center;">3</td>
            <td name="file" itemId="2022-2.2.1" itemName="师资建设"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.2.1" itemName="师资建设" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.2.1" itemName="师资建设" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-2.2.1" itemName="师资建设" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td rowspan="3">查看岗位职责等相关文件，访谈各类人员</td>
            <td>
                职责明确，履职认真，得1分
                无岗位职责，或履职不认真，不得分
            </td>
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ...
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.1.1" itemName="主任职责" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.1.1']}</textarea></c:if>>
        </tr>
        <tr style="height:50px">
            <td>3.1.2教学主任★</td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>3.2.1入科教育</td>
            <td>
                规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通等入科教育，培训与考核要求体现科室岗位基本需求特点，并有专人组织实施
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-3.2.1" itemName="入科教育" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-3.2.1" itemName="入科教育" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:50px">
            <td>3.2.2教学查房或临床巡诊</td>
            <td>
                开展规范的教学查房(诊断性/综合检验报告分析)或临床巡诊,至少每2周1次
            </td>
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-3.2.2" itemName="教学查房或临床巡诊"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学查房或临床巡诊" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学查房或临床巡诊" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.2.2" value="2" onchange="selectRadio('2022-3.2.2','2','self','2','')"/>
                    &nbsp;<label >开展次数达标，得2分</label><br>
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="教学查房或临床巡诊" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-3.2.4" itemName="病例/临床反馈/异常报告单讨论"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.4" itemName="病例/临床反馈/异常报告单讨论" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.4" itemName="病例/临床反馈/异常报告单讨论" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.4" itemName="病例/临床反馈/异常报告单讨论" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>3.3.1出科考核★</td>
            <td>
                理论考试试题、技能操作考核评分标准、培训对象测评结果、考勤记录等原始资料齐全，真实规范，体现专业特点和分层递进的培训理念
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.3.1" itemName="出科考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.3.1" itemName="出科考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.3.1" value="4" onchange="selectRadio('2022-3.3.1','4','self','4','')"/>
                    &nbsp;<label >考核项目全面，且认真规范，得4分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','self','4','仅有技能操作考核或仅有理论考试，得2分')"/>
                    &nbsp;<label >仅有技能操作考核或仅有理论考试，得2分</label><br>
        ...
        <tr style="height:50px">
            ...
            <td>3.4.1培训工作量★</td>
            <td>
                按照专业基地培训对象临床操作能够达到《住院医师规范化培训内容与标准（试行）》检验医学科专业细则的要求
            </td>
            <td>随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
            <td>
                管床数或完成检查项目达要求，得6分
                管床数或完成检查项目≥规定数的80%，得3分
                管床数或完成检查项目≥规定数的60%，得1分
                未安排管床或未独立完成检查，不得分
            </td>
            <td style="text-align: center;">6</td>
            <td name="file" itemId="2022-3.4.1" itemName="培训工作量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-3.4.1" itemName="培训工作量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-3.4.1" itemName="培训工作量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','self','6','')"/>
                    &nbsp;<label >管床数或完成检查项目达要求，得6分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','self','6','管床数或完成检查项目≥规定数的80%，得3分')"/>
                    &nbsp;<label >管床数或完成检查项目≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','6','管床数或完成检查项目≥规定数的60%，得1分')"/>
                    &nbsp;<label >管床数或完成检查项目≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','6','未安排管床或未独立完成检查，不得分')"/>
                    &nbsp;<label >未安排管床或未独立完成检查，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','expert','6','')"/>
                    &nbsp;<label>管床数或完成检查项目达要求，得6分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','expert','6','管床数或完成检查项目≥规定数的80%，得3分')"/>
                    &nbsp;<label >管床数或完成检查项目≥规定数的80%，得3分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','6','管床数或完成检查项目≥规定数的60%，得1分')"/>
                    &nbsp;<label >管床数或完成检查项目≥规定数的60%，得1分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','6','未安排管床或未独立完成检查，不得分')"/>
                    &nbsp;<label >未安排管床或未独立完成检查，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="培训工作量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>4.1.1教学查房或临床巡诊质量★</td>
            <td>
                主任或带教医师组织开展规范的教学查房（教学活动主要是出具并分析诊断性/综合检验报告）或临床巡诊，悉心指导培训对象
            </td>
            <td>随机抽查1～2名带教医师教学查房或临床巡诊，进行检验诊断报告能力评价</td>
            <td>
                现场评价满意，得7分
                现场评价较好，得5分
                现场评价一般，得3分
            ...
            <td name="file" itemId="2022-4.1.1" itemName="教学查房或临床巡诊质量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-4.1.1" itemName="教学查房或临床巡诊质量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-4.1.1" itemName="教学查房或临床巡诊质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.1" value="7" onchange="selectRadio('2022-4.1.1','7','self','7','')"/>
                    &nbsp;<label >现场评价满意，得7分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="5" onchange="selectRadio('2022-4.1.1','5','self','7','现场评价较好，得5分')"/>
                    &nbsp;<label >现场评价较好，得5分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="3" onchange="selectRadio('2022-4.1.1','3','self','7','现场评价一般，得3分')"/>
                    &nbsp;<label >现场评价一般，得3分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="0" onchange="selectRadio('2022-4.1.1','0','self','7','现场评价较差，不得分')"/>
                    &nbsp;<label >现场评价较差，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.1" value="7" onchange="selectRadio('2022-4.1.1','7','expert','7','')"/>
                    &nbsp;<label>现场评价满意，得7分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="3" onchange="selectRadio('2022-4.1.1','5','expert','7','现场评价较好，得5分')"/>
                    &nbsp;<label >现场评价较好，得5分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="1" onchange="selectRadio('2022-4.1.1','3','expert','7','现场评价一般，得3分')"/>
                    &nbsp;<label >现场评价一般，得3分</label><br>
                    <input type="radio"  name="2022-4.1.1" value="0" onchange="selectRadio('2022-4.1.1','0','expert','7','现场评价较差，不得分')"/>
                    &nbsp;<label >现场评价较差，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="教学查房或临床巡诊质量" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:50px">
            <td>4.1.2技能操作完成情况★</td>
            <td>
                每个轮转科室均能按照《住院医师规范化培训内容与标准（试行）》本专业细则要求执行，为每名培训对象安排并完成规定的技能操作种类和数量
            </td>
            <td>随机抽查1～2名培训对象技能操作记录，了解实际情况</td>
            <td>
                满意率≥90%，得4分 <br>
                满意率≥80%，得2分 <br>
                满意率＜80%，不得分
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','self','4','')"/>
                    &nbsp;<label >满意率≥90%，得4分</label><br>
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作情况</td>
            <td>
                1.培训对象操作前是否与患者交流、沟通1分
                2.培训对象操作中存在问题及时进行指导1分
                3.培训对象操作结束后提问1分
                4.对培训对象的操作进行总体评价（优、缺点点评）1分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.1.3" itemName="技能操作带教情况"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>4.2.1病历书写或分析报告★</td>
            <td>
                培训对象病历或分析报告书写情况
            </td>
            <td>随机抽查1～2名培训对象运行病历或分析报告并提问题（在医学检验科轮转）</td>
            <td>
                病历书写评分表见<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2100_02','附表2');">附表2</a>
                ≥90分，得4分；≥80分，得3分；≥70分，得2分；≥60分，得1分，＜60分不得分
                分析报告得分 :现场评价满意，得4分
                现场评价较好，得2分
                现场评价一般，得1分
                现场评价较差，不得分
            ...
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.2.1" itemName="病历书写或分析报告"></td>
            <td><input id="fubiao2s" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写或分析报告" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2e" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写或分析报告" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.1" itemName="病历书写或分析报告" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>培训对象技能操作情况</td>
            <td>
                随机抽查1～2名二年级以上培训对象进行技能操作，查看其掌握情况
            </td>
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_2100_Main','附表3');">附表3</a>
                ≥90分，得6分；≥80分，得3分；≥70分，得2分；≥60分，得1分；＜60分，不得分
            </td>
            <td style="text-align: center;">6</td>
            ...
            <td><input id="fubiao3s" onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.2.2" itemName="技能操作" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3e" onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.2.2" itemName="技能操作" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                随机抽查访谈本院、委培、社会招收培训对象各2～3名，进行检验诊断报告能力评价；查看轮转登记手册、出科考核等原始资料
            </td>
            <td>
                完成率≥90%，得4分
                完成率≥80%，得2分
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-4.2.3" value="4" onchange="selectRadio('2022-4.2.3','4','self','4','')"/>
                    &nbsp;<label > 完成率≥90%，得4分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="2" onchange="selectRadio('2022-4.2.3','2','self','4','完成率≥80%，得2分')"/>
                    &nbsp;<label >完成率≥80%，得2分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','self','4','完成率＜80%，不得分')"/>
                    &nbsp;<label >完成率＜80%，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.2.3" value="4" onchange="selectRadio('2022-4.2.3','4','expert','4','')"/>
                    &nbsp;<label> 完成率≥90%，得4分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="2" onchange="selectRadio('2022-4.2.3','2','expert','4','完成率≥80%，得2分')"/>
                    &nbsp;<label >完成率≥80%，得2分</label><br>
                    <input type="radio"  name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','expert','4','完成率＜80%，不得分')"/>
                    &nbsp;<label >完成率＜80%，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            ...
            <td>
                查看上一年度首次参加执业医师资格考试的所有培训对象的成绩等原始资料
            </td>
            <td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="执业医师资格考试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.4" itemName="执业医师资格考试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.2.4" itemName="执业医师资格考试" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.5" itemName="结业考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.5" itemName="结业考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-4.2.5" itemName="结业考核" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-4.2.6" itemName="年度业务水平测试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-4.2.6" itemName="年度业务水平测试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
           ...
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);"   itemId="2022-4.2.6" itemName="年度业务水平测试" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.6']}</textarea></c:if>
            </td>
        </tr>
        ...
        <tr style="height:150px;">
            ...
            <td rowspan="2" colspan="8">
                <textarea class="input" type="text" id="speContentInput" name="speContentInput"
                          style="width: 96%;height: 150px;text-indent: 3px;"
                          onchange="saveSpeContent(this,'${userFlow}')">${subjectUser.speContent}</textarea>
            </td>
        </tr>
        <tr style="height:16px;">
        </tr>
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                1.一级指标4项，二级指标9项，三级指标37项。三级指标中，核心指标17项、计69分，共100分。<br>
