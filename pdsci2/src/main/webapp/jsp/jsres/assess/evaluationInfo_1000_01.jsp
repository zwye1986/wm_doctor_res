...
<head>
	...
	<script type="text/javascript">
		...
		function subInfo() {
			...
			selfOneScore = parseInt(selfOneScore / 350 * 100);
			selfTwoScore = parseInt(selfTwoScore / 400 * 100);
			var url = "<s:url value='/jsres/supervisio/saveManyScheduleTotalled'/>";
			var data = {
				"itemIdOne": 'scoreInfo11',
				"itemIdTwo": 'scoreInfo21',
				"itemName": 'evaluationInfo_1000',
...
<div class="div_table">
	<table cellpadding="4" style="width: 1000px">
		<tbody>
			...
			<tr style="height:32px">
				<th rowspan="3">疾病种类</th>
				<th >中、重度颅脑外伤</th>
				<th>＞150</th>
				<td>
					<input onchange="saveScore(this,150);" itemId="1000-01-1.1" itemName="k中、重度颅脑外伤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-1.1" itemName="d中、重度颅脑外伤"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅脑、椎管内肿瘤</th>
				<th>＞100</th>
				<td>
					<input onchange="saveScore(this,100);" itemId="1000-01-1.2" itemName="k颅脑、椎管内肿瘤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-1.2" itemName="d颅脑、椎管内肿瘤"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅脑、椎管内血管性疾病瘤</th>
				<th>＞100</th>
				<td>
					<input onchange="saveScore(this,100);" itemId="1000-01-1.3" itemName="k颅脑、椎管内血管性疾病瘤"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-1.3" itemName="d颅脑、椎管内血管性疾病瘤"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				...
				<th>＞100</th>
				<td>
					<input onchange="saveScore(this,100);" itemId="1000-01-2.1" itemName="k颅脑外伤"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-2.1" itemName="d颅脑外伤"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅脑、椎管内肿瘤</th>
				<th>＞80</th>
				<td>
					<input onchange="saveScore(this,80);" itemId="1000-01-2.2" itemName="k颅脑、椎管内肿瘤2"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-2.2" itemName="d颅脑、椎管内肿瘤2"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >颅脑、椎管内血管性疾病瘤</th>
				<th>＞80</th>
				<td>
					<input onchange="saveScore(this,80);" itemId="1000-01-2.3" itemName="k颅脑、椎管内血管性疾病瘤2"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-2.3" itemName="d颅脑、椎管内血管性疾病瘤2"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >腰椎穿刺术</th>
				<th>＞120</th>
				<td>
					<input onchange="saveScore(this,120);" itemId="1000-01-2.4" itemName="k腰椎穿刺术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-2.4" itemName="d腰椎穿刺术"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >脑室穿刺术</th>
				<th>＞20</th>
				<td>
					<input onchange="saveScore(this,20);" itemId="1000-01-2.5" itemName="k脑室穿刺术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td>
					<input itemId="1000-01-2.5" itemName="d脑室穿刺术"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
