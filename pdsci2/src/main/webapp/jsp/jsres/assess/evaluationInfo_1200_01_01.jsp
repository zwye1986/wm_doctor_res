	...
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		<tbody>
			...
			<tr style="height:32px;">
				...
				<td style="width: 12.5%">
					<input onchange="saveScore(this,190);" itemId="1200-01-1.1" itemName="k年收治病人数"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<th style="width: 12.5%">低于标准数（划√）</th>
				<td style="width: 12.5%">
					<input itemId="1200-01-1.1" itemName="d年收治病人数"  name="less" readonly="readonly"   class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px;">
			...
			<tr style="height:32px">
				...
				<th colspan="2">≥50</th>
				<td colspan="2">
					<input onchange="saveScore(this,50);" itemId="1200-01-2.1" itemName="k重症病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-2.1" itemName="d重症病人"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >机械通气治疗病人</th>
				<th colspan="2">≥25</th>
				<td colspan="2">
					<input onchange="saveScore(this,25);" itemId="1200-01-2.2" itemName="k机械通气治疗病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-2.2" itemName="d机械通气治疗病人"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				...
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1200-01-3.1" itemName="k心肺复苏"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-3.1" itemName="d心肺复苏"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >电除颤</th>
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1200-01-3.2" itemName="k电除颤"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-3.2" itemName="d电除颤"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >常用监测技术</th>
				<th colspan="2">≥10</th>
				<td colspan="2">
					<input onchange="saveScore(this,10);" itemId="1200-01-3.3" itemName="k常用监测技术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-3.3" itemName="d常用监测技术"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >呼吸机操作</th>
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1200-01-3.4" itemName="k呼吸机操作"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1200-01-3.4" itemName="d呼吸机操作"  name="less" readonly="readonly"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
