...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——临床病理科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%;margin-top: -34px" >
        <tr height="34" class="firstRow">
            <th colspan="11">
                <h2 style="font-size:150%">住院医师规范化培训评估指标——临床病理科专业基地</h2>
            </th>
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="9">1.基本条件（15分）</td>
            ...
            <td name="file" itemId="2022-1.1.1" itemName="病例数" width="180px"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
                       itemName="病例数" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.1" itemName="病例数" name="expert"
            ...
            <td>
                ...
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="病例数" name="reason"
        ...
        <tr style="height:50px">
            <td>1.1.2科室设置</td>
            <td>
                具备健全的常规病理技术室、特殊染色和免疫组织化学室、病理档案室、电镜室、分子病理室和尸体解剖室（后3者可与上级单位或本地区其他单位共同使用）
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                缺1个科室，不得分
            ...
            <td name="file" itemId="2022-1.1.2" itemName="科室设置"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="科室设置" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="科室设置" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="科室设置" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.3轮转科室</td>
            <td>
                放射影像科；超声科；病理技术：包括病理标本检查和档案管理、常规制片室、免疫组化室、分子病理室或电镜室；组织病理诊断或分子病理诊断；细胞学技术及诊断
            </td>
            <td>
                1.查看各亚专业（专科）设置名称 <br>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                   ...
                   <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>科室齐全，得满分</label><br>
                    <input  type="radio"  name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','expert','2','科室齐全，得满分')"/>
                    &nbsp;<label >科室齐全，得满分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="轮转科室" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.4疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》临床病理科专业细则要求
            </td>
            <td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="疾病种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                核对上一年度各亚专业（专科）临床技能操作或手术种类和数量的统计报表
            </td>
            <td>符合要求（含协同单位），得满分 <br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input  type="radio"  name="2022-1.1.5" value="4" onchange="selectRadio('2022-1.1.5','4','self','4','')"/>
                    &nbsp;<label >符合要求（含协同单位），得满分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="2" onchange="selectRadio('2022-1.1.5','2','self','4','技能操作种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="1" onchange="selectRadio('2022-1.1.5','1','self','4','技能操作种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','4','技能操作种类及数量＜规定数85%，不得分')"/>
                    &nbsp;<label >技能操作种类及数量＜规定数85%，不得分</label>
                </c:if>
                   <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-1.1.5" value="4" onchange="selectRadio('2022-1.1.5','4','expert','4','')"/>
                    &nbsp;<label>符合要求（含协同单位），得满分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="2" onchange="selectRadio('2022-1.1.5','2','expert','4','技能操作种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label>技能操作种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="1" onchange="selectRadio('2022-1.1.5','1','expert','4','技能操作种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label>技能操作种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio"   name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','4','技能操作种类及数量＜规定数85%，不得分')"/>
                    &nbsp;<label>技能操作种类及数量＜规定数85%，不得分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="临床技能操作种类及数量" name="reason"
                          placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.6专业基地设备</td>
            <td>
                多头光学显微镜（3头以上）、双筒光学显微镜、显微照相机或图像采集设备、荧光显微镜、病历档案计算机管理系统、冷冻切片机、自动化常规病理制片设备（脱水、染色、封片、切片机）、细胞涂片机、电镜（可与其他单位共用）、超薄切片机、PCR仪、普通冰箱、低温冰箱、微波炉、离心机、烤箱、电泳仪
            </td>
            <td>检查设备清单复印件，需加盖医院公章，实地考查
            </td>
            <td>
                缺1项，不得分
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="专业基地设备" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事临床病理科专业医疗、科研和教学工作超过15年
            </td>
            <td>1项不符合条件，不得分</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:40px;">
            ...
            <td>
                规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通、生物安全等入科教育，并有专人组织实施
            </td>
            <td>提供本年度入科教育原始资料</td>
            <td>
                有，且严格落实，得满分 <br>
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.2教学会诊</td>
            <td>开展规范的教学会诊，至少每周1次</td>
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-3.2.2" itemName="教学会诊"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学会诊" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学会诊" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="教学会诊" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                按照专业基地培训对象独立完成技术操作能够达到《住院医师规范化培训内容与标准（试行）》本专业细则的要求
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label >技能操作和报告数达到要求，得满分</label><br>
        ...
        <tr style="height:48px;">
            <td style="height:96px;" rowspan="6">4.质量控制（38分）</td>
            <td rowspan="3">4.1带教医师教学质量</td>
            <td>4.1.1教学会诊质量★</td>
            <td>主任或带教医师针对住院医师开展规范的教学会诊，悉心指导培训对象</td>
            <td>随机抽查1～2名带教医师教学会诊</td>
            <td>
                带教医师评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2000_01','附表1');">
                        附表1</a>
                <br>
                ≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">5</td>
            <td name="file" itemId="2022-4.1.1" itemName="教学会诊质量"></td>
            <td>
                <input id="fubiao1" onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.1.1" itemName="教学会诊质量" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center" value=""/>
            </td>
            <td><input id="fubiao1Expert" onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.1.1" itemName="教学会诊质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="教学会诊质量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td>每个轮转科室均能按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作
            </td>
            <td>随机抽查1～5名培训对象技能操作记录，了解实际情况</td>
            <td>
                完成率≥90%，得满分 <br>
                完成率≥80%，得4分<br>
                完成率＜80%，不得分
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td>随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作或手术情况</td>
            <td>
                1.培训对象操作前是否与患者交流、沟通 1分 <br>
                2.对培训对象操作中存在问题及时进行指导 1分<br>
                3.培训对象操作结束后对其进行提问1分<br>
        ...
        <tr style="height:48px;">
            ...
            <td style="height: 48px;">4.2.1病理描述及诊断书写★</td>
            <td>培训对象规范书写病理描述及诊断</td>
            <td>随机抽查1～2名培训对象运行病历，或诊断报告并提问题</td>
            <td>
                病理描述、诊断评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2000_02','附表2');">
                        附表2</a>
                <br>
                ≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">6</td>
            <td name="file" itemId="2022-4.2.1" itemName="病理描述及诊断书写"></td>
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.2.1" itemName="病理描述及诊断书写" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.2.1" itemName="病理描述及诊断书写" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.1" itemName="病理描述及诊断书写" name="reason"
                          placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.2标本取材技能操作★</td>
            <td>培训对象标本取材技能操作情况</td>
            ...
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-4.2.2" itemName="标本取材技能操作"></td>
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="标本取材技能操作" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="标本取材技能操作" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.2" itemName="标本取材技能操作" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                1.一级指标4项，二级指标10项，三级指标34项。三级指标中，核心指标15项、计73分，一般指标19项、计27分，共100分。<br>
