...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">口腔外科疾病种类</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th>≥5000</th>
            <td>
                <input onchange="saveScore(this,5000);" itemId="3000-01-1.1" itemName="k牙体牙髓疾病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.1" itemName="d牙体牙髓疾病" name="less1" class="input" type="text"
        ...
        <tr style="height:32px">
            ...
            <th>≥1500</th>
            <td>
                <input onchange="saveScore(this,1500);" itemId="3000-01-1.2" itemName="k牙周疾病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.2" itemName="d牙周疾病" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥1000</th>
            <td>
                <input onchange="saveScore(this,1000);" itemId="3000-01-1.3" itemName="k儿童口腔疾病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.3" itemName="d儿童口腔疾病" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥1000</th>
            <td>
                <input onchange="saveScore(this,1000);" itemId="3000-01-1.4" itemName="k口腔黏膜疾病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.4" itemName="d口腔黏膜疾病" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥5000</th>
            <td>
                <input onchange="saveScore(this,1000);" itemId="3000-01-1.5" itemName="k口腔颌面外科" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.5" itemName="d口腔颌面外科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥5000</th>
            <td>
                <input onchange="saveScore(this,5000);" itemId="3000-01-1.6" itemName="k口腔修复科" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.6" itemName="d口腔修复科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥1000</th>
            <td>
                <input onchange="saveScore(this,1000);" itemId="3000-01-1.7" itemName="k口腔正畸科" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.7" itemName="d口腔正畸科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥1600</th>
            <td>
                <input onchange="saveScore(this,1600);" itemId="3000-01-1.8" itemName="k口腔颌面影像科" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.8" itemName="d口腔颌面影像科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥1000</th>
            <td>
                <input onchange="saveScore(this,1000);" itemId="3000-01-1.9" itemName="k口腔急诊科" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.9" itemName="d口腔急诊科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>≥200</th>
            <td>
                <input onchange="saveScore(this,200);" itemId="3000-01-1.10" itemName="k口腔病理科" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="3000-01-1.10" itemName="d口腔病理科" name="less1" class="input" type="text"
                       style="height:20px; text-align: center" readonly="readonly"/>
            </td>
        </tr>
        <tr style="height:32px">
