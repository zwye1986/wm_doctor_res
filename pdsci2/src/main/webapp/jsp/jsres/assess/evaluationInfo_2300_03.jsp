...
<div class="div_table" style="overflow: auto;max-height: 570px;">
	<table cellpadding="4" style="width: 1000px">
		...
		<tr height="34" class="firstRow">
			<th colspan="6">
				<h2 style="font-size:150%">超声科诊断报告抽查评分表（针对学员）</h2>
			</th>
		</tr>
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;" colspan="3">培训基地（医院）：${orgName}</th>
			<th style="text-align:left;padding-left: 4px;" colspan="3">外单位者的单位名称：</th>
		</tr>
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;" colspan="3">学员姓名：</th>
			<th style="text-align:left;padding-left: 4px;" colspan="3">规1/2/3: </th>
		</tr>
		<tr height="28" >
