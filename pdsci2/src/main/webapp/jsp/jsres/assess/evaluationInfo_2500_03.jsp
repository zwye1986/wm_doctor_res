...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">住院医师终末病历检查评分表</h2>
            </th>
        </tr>
        <tr style="height:32px; text-align: left;">
            <th colspan="2">科室：</th>
            <th colspan="3">住院医师：</th>
        </tr>
        <tr style="height:32px; text-align: left;">
            <th colspan="2">病人姓名：</th>
            <th colspan="1">住院号：</th>
            <th colspan="2">主要诊断：</th>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th>4</th>
            <td>
                <input onchange="saveScore(this,4);" itemId="2500-03-4.6" itemName="d出院医嘱"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
