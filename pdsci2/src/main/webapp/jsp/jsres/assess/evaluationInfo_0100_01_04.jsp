...
<head>
    ...
    <script type="text/javascript">
        ...
        function subInfo() {
            ...
            selfOneScore = parseInt(selfOneScore / 284 * 100);
            selfTwoScore = parseInt(selfTwoScore / 200 * 100);
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">内科(内分泌科)疾病种类/临床技能操作</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            <th rowspan="14">疾病种类</th>
            <th>糖尿病</th>
            <th colspan="2">≥100</th>
            <td>
                <input onchange="saveScore(this,100);" itemId="0100-04-1.1" itemName="k糖尿病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.1" itemName="d糖尿病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>甲状腺功能亢进症( Graves病等)</th>
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-04-1.2" itemName="k甲状腺功能亢进症( Graves病等)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.2" itemName="d甲状腺功能亢进症( Graves病等)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>糖尿病酮症酸中毒和糖尿病高渗性昏迷</th>
            <th colspan="2">≥12</th>
            <td>
                <input onchange="saveScore(this,12);" itemId="0100-04-1.3" itemName="k糖尿病酮症酸中毒和糖尿病高渗性昏迷" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.3" itemName="d糖尿病酮症酸中毒和糖尿病高渗性昏迷" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥30</th>
            <td>
                <input onchange="saveScore(this,30);" itemId="0100-04-1.4" itemName="k痛风(包括门诊)" name="self1"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.4" itemName="d痛风(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>皮质醇增多症/原发性醛固酮增多症/嗜铬细胞瘤</th>
            <th colspan="2">≥12</th>
            <td>
                <input onchange="saveScore(this,12);" itemId="0100-04-1.5" itemName="k皮质醇增多症/原发性醛固酮增多症/嗜铬细胞瘤"
                       name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.5" itemName="d皮质醇增多症/原发性醛固酮增多症/嗜铬细胞瘤" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-04-1.6" itemName="k甲状腺结节(包括门诊)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.6" itemName="d甲状腺结节(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-04-1.7" itemName="k各型甲状腺炎(包括门诊)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.7" itemName="d各型甲状腺炎(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0100-04-1.8" itemName="k甲状腺功能减退症(包括门诊)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-1.8" itemName="d甲状腺功能减退症(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.9','k尿崩症');" itemId="0100-04-1.9"
                        itemName="k尿崩症"
            ...
            <td>
                <input itemId="0100-04-1.9" itemName="d尿崩症" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.10','k甲亢危象');" itemId="0100-04-1.10"
                        itemName="k甲亢危象"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-04-1.10" itemName="d甲亢危象" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>原发性肾上腺皮质功能低下症(Addison病)</th>
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.11','k原发性肾上腺皮质功能低下症(Addison病)');" itemId="0100-04-1.11"
                        itemName="k原发性肾上腺皮质功能低下症(Addison病)"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
                    <option value="无" style="text-align: center">无</option>
            ...
            <td>
                <input itemId="0100-04-1.11" itemName="d原发性肾上腺皮质功能低下症(Addison病)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.12','k高脂血症及高脂蛋白血症');" itemId="0100-04-1.12"
                        itemName="k高脂血症及高脂蛋白血症"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
                    <option value="无" style="text-align: center">无</option>
            ...
            <td>
                <input itemId="0100-04-1.12" itemName="d高脂血症及高脂蛋白血症" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.13','k泌乳素瘤');" itemId="0100-04-1.13"
                        itemName="k泌乳素瘤"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-04-1.13" itemName="d泌乳素瘤" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-1.14','k骨质疏松症');" itemId="0100-04-1.14"
                        itemName="k骨质疏松症"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-04-1.14" itemName="d骨质疏松症" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-04-2.1" itemName="k口服葡萄糖耐量试验" name="self2"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-2.1" itemName="d口服葡萄糖耐量试验" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-04-2.2" itemName="k各类激素测定" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-2.2" itemName="d各类激素测定" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥100</th>
            <td>
                <input onchange="saveScore(this,100);" itemId="0100-04-2.3" itemName="k制订糖尿病营养食谱" name="self2"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-04-2.3" itemName="d制订糖尿病营养食谱" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-2.4','k禁水加压素试验');" itemId="0100-04-2.4"
                        itemName="k禁水加压素试验"
            ...
            <td>
                <input itemId="0100-04-2.4" itemName="d禁水加压素试验" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-04-2.5','k地塞米松抑制试验');" itemId="0100-04-2.5"
                        itemName="k地塞米松抑制试验"
                        name="self2" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-04-2.5" itemName="d地塞米松抑制试验" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
