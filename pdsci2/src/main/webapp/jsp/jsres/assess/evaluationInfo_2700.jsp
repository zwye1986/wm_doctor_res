...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="10">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——预防医学科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="9">1.基本条件（20分）</td>
            <td style="height:53px;" rowspan="6">1.1专业基地所在医院条件</td>
            <td>1.1.1科室和实验室</td>
            <td width="366px">
                必备科室：心血管内科、呼吸内科、神经内科、感染科、肿瘤科、内分泌科、医院感染管理科、康复医学科 <br>
                相关科室：消化内科、妇科、儿科、老年医学科、五官科、营养科等其中的2～4个科室，或具备航空医学、海洋高压氧医学、职业病科、（临床）肿瘤预防科、心血管疾病预防科等其中的1个科室
            </td>
            <td width="367px">必备科室缺1个科室，不得分<br>
                相关科室缺2个科室，不得分
            </td>
            <td width="74px" style="text-align: center;">2</td>
            <td name="file" width="207px" itemId="2022-1.1.1" itemName="科室和实验室"></td>
            <td width="74px"><input  onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
                       itemName="科室和实验室" name="self" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input  onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.1" itemName="科室和实验室" name="expert"
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input   type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','self','2','必备科室缺1个科室或相关科室缺2个科室，不得分')"/>
                    &nbsp;<label >必备科室缺1个科室或相关科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','expert','2','必备科室缺1个科室或相关科室缺2个科室，不得分')"/>
                    &nbsp;<label >必备科室缺1个科室或相关科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ...
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="科室和实验室" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.2轮转科室</td>
            <td>
                1.医院临床相关科室轮转：心血管内科、呼吸内科、感染科、肿瘤科、内分泌科、神经内科、医院感染管理科、康复医学科、消化内科、妇科、儿科、门诊部、老年医学、眼科/耳鼻喉科、营养科 <br>
                2.疾病预防控制与公共卫生专业能力培训科室：传染病防制科（包括结核病、性病、艾滋病防治）、免疫规划科、慢性病防控科、职业卫生科、环境卫生科、营养与食品卫生科、健康教育与健康促进科、妇幼卫生科、精神卫生科、社区卫生服务中心
            </td>
            <td>
                科室齐全，得满分<br>
                缺1个科室，不得分
            ...
            <td name="file" itemId="2022-1.1.2" itemName="轮转科室"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.2" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-1.1.2" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.2" value="3" onchange="selectRadio('2022-1.1.2','3','self','3','')"/>
                    &nbsp;<label >科室齐全，得满分</label><br>
                    <input   type="radio"  name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','self','3','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.2" value="3" onchange="selectRadio('2022-1.1.2','3','expert','3','')"/>
                    &nbsp;<label >科室齐全，得满分</label><br>
                    <input type="radio"  name="2022-1.1.2" value="0" onchange="selectRadio('2022-1.1.2','0','expert','3','缺1个科室，不得分')"/>
                    &nbsp;<label >缺1个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="轮转科室" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.3疾病种类及数量★</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》预防医学专业细则要求
            </td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td name="file" itemId="2022-1.1.3" itemName="疾病种类及数量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.3" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.3" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.3" value="4" onchange="selectRadio('2022-1.1.3','4','self','4','')"/>
                    &nbsp;<label >符合要求（含协同单位），得满分</label><br>
                    <input   type="radio"  name="2022-1.1.3" value="2" onchange="selectRadio('2022-1.1.3','2','self','4','疾病种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label >疾病种类及数量≥规定数的90%，得2分</label><br>
                    <input   type="radio"  name="2022-1.1.3" value="1" onchange="selectRadio('2022-1.1.3','1','self','4','疾病种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label >疾病种类及数量≥规定数的85%，得1分</label><br>
                    <input   type="radio"  name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','self','4','疾病种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label >疾病种类及数量＜规定数的85%，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.3" value="4" onchange="selectRadio('2022-1.1.3','4','expert','4','')"/>
                    &nbsp;<label >符合要求（含协同单位），得满分</label><br>
                    <input type="radio"  name="2022-1.1.3" value="2" onchange="selectRadio('2022-1.1.3','2','expert','4','疾病种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label >疾病种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio"  name="2022-1.1.3" value="1" onchange="selectRadio('2022-1.1.3','1','expert','4','疾病种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label >疾病种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio"  name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','expert','4','疾病种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label >疾病种类及数量＜规定数的85%，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="疾病种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.3']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.4临床技能操作种类及数量★</td>
            <td>
                符合要求（含协同单位），得满分<br>
            ...
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-1.1.4" itemName="临床技能操作种类及数量"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.4" itemName="临床技能操作种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.4" itemName="临床技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.4" value="4" onchange="selectRadio('2022-1.1.4','4','self','4','')"/>
                    &nbsp;<label >符合要求（含协同单位），得满分</label><br>
                    <input   type="radio"  name="2022-1.1.4" value="2" onchange="selectRadio('2022-1.1.4','2','self','4','技能操作种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的90%，得2分</label><br>
                    <input   type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','self','4','技能操作种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的85%，得1分</label><br>
                    <input   type="radio"  name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','self','4','技能操作种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label >技能操作种类及数量＜规定数的85%，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.4" value="4" onchange="selectRadio('2022-1.1.4','4','expert','4','')"/>
                    &nbsp;<label >符合要求（含协同单位），得满分</label><br>
                    <input type="radio"  name="2022-1.1.4" value="2" onchange="selectRadio('2022-1.1.4','2','expert','4','技能操作种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio"  name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','expert','4','技能操作种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label >技能操作种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio"  name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','expert','4','技能操作种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label >技能操作种类及数量＜规定数的85%，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.4" itemName="临床技能操作种类及数量" name="reason" placeholder="请填写扣分原因"
                          style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td name="file" itemId="2022-1.1.5" itemName="医院设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="医院设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="医院设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>.
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.5" value="2" onchange="selectRadio('2022-1.1.5','2','self','2','')"/>
                    &nbsp;<label>符合标准，得满分</label><br>
                    <input   type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','2','缺1项，不得分')"/>
                    &nbsp;<label >缺1项，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.5" value="2" onchange="selectRadio('2022-1.1.5','2','expert','2','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','2','缺1项，不得分')"/>
                    &nbsp;<label >缺1项，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.5" itemName="医院设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.6专业基地设备</td>
            <td>
                所具备的医疗设备应能够满足《住院医师规范化培训基地认定标准（试行）》预防医学专业细则要求
            </td>
            <td>
                不满足，不得分
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.6" value="2" onchange="selectRadio('2022-1.1.6','2','self','2','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input   type="radio"  name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','self','2','不满足，不得分')"/>
                    &nbsp;<label >不满足，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-1.1.6" value="2" onchange="selectRadio('2022-1.1.6','2','expert','2','')"/>
                    &nbsp;<label >符合标准，得满分</label><br>
                    <input type="radio"  name="2022-1.1.6" value="0" onchange="selectRadio('2022-1.1.6','0','expert','2','不满足，不得分')"/>
                    &nbsp;<label >不满足，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-1.1.6" itemName="专业基地设备" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.6']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:50px">
            <td style="height:53px;" rowspan="3">1.2协同单位（科室）</td>
            <td>1.2.1协同数</td>
            <td>
                协同数量不应超过3个
            </td>
        ...
        <tr style="height:50px">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》预防医学科细则要求)
            </td>
            <td>
                满足要求，得1分（无协同单位的专业基地，此处不失分）
            </td>
        ...
        <tr style="height:60px;">
            ...
            <td>
                肿瘤科：主任医师、副主任医师、主治医师与培训对象的比例≥1:1:2:4 <br>
                医院感染管理科：每名带教医师同时带教本专业培训对象不超过4名 <br>
                其他临床和疾病预防控制与公共卫生轮转科室：每名带教医师带教培训对象不超过3名
            </td>
            <td>
                达到标准，得满分 <br>
                不达标准，不得分
        ...
        <tr style="height:38px;">
            ...
            <td>
                医院感染管理科副主任医师≥1人，主治医师≥2人 <br>
                其他临床各轮转科室主任医师≥1人，副主任医师≥1人，主治医师≥2人 <br>
            <td>
                1个亚专业(专科)不达标，不得分
            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师等正高级专业技术职务，从事本专业的公共卫生实践、科研和教学工作超过15年
            </td>
            <td>1项不符合条件，不得分</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:59px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-2.2.3" itemName="激励制度" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-2.2.3" itemName="激励制度" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio"  name="2022-2.2.3" value="3" onchange="selectRadio('2022-2.2.3','3','self','3','')"/>
                    &nbsp;<label >有机制，并与奖金、评优等挂钩，得满分</label><br>
                    <input   type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','self','3','有机制，未与奖金、评优挂钩，得1分')"/>
                    ...
                    &nbsp;<label >有机制，并与奖金、评优等挂钩，得满分</label><br>
                    <input type="radio"  name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','expert','3','有机制，未与奖金、评优挂钩，得1分')"/>
                    &nbsp;<label >有机制，未与奖金、评优挂钩，得1分</label><br>
        ...
        <tr style="height:32px;">
            <td style="height: 438px;" rowspan="13">3.过程管理（30分）</td>
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-3.1.2" itemName="教学主任" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-3.1.2" itemName="教学主任" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-3.1.4" itemName="教学小组" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-3.1.4" itemName="教学小组" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-3.1.5" itemName="轮转计划" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,3);" itemId="2022-3.1.5" itemName="轮转计划" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:32px;">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);"  itemId="2022-3.2.4" itemName="疑难病例讨论" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-3.3.1" itemName="出科考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-3.3.1" itemName="出科考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:48px;">
            ...
            <td style="height: 48px;">3.4.1管理病床数★</td>
            <td rowspan="2">
                按照专业基地培训对象管床数和技能操作数能够达到《住院医师规范化培训内容与标准(试行)》预防医学科培训细则的要求
            <td>
                管床数达到要求，得满分<br>
                管床数≥3张，得2分<br>
                管床数≥2张，得1分<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="管理病床数" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.4.1" itemName="管理病床数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input   type="radio"  name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','4','管床数≥2张，得1分')"/>
                    &nbsp;<label >管床数≥2张，得1分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','4','管床数＜2张或未安排，不得分')"/>
                    &nbsp;<label >管床数＜2张或未安排，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea  onchange="saveSpeReason(this);" itemId="2022-3.4.1" itemName="管理病床数" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.4.1']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">3.4.2门急诊工作量</td>
            <td>
                门急诊工作量达到要求，得满分<br>
                门急诊量≥规定数的80%，得2分<br>
                门急诊量≥规定数的60%，得1分<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.4.2" itemName="门急诊工作量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.4.2" itemName="门急诊工作量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.2" value="2" onchange="selectRadio('2022-3.4.2','2','self','2','')"/>
                    &nbsp;<label >门急诊工作量达到要求或门急诊量≥规定数的80%，得2分</label><br>
                    <input   type="radio"  name="2022-3.4.2" value="1" onchange="selectRadio('2022-3.4.2','1','self','2','门急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label >门急诊量≥规定数的60%，得1分</label><br>
                    <input   type="radio"  name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','self','2',' 门急诊量＜规定数60%或未安排，不得分')"/>
                    &nbsp;<label > 门急诊量＜规定数60%或未安排，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-3.4.2" value="2" onchange="selectRadio('2022-3.4.2','2','expert','2','')"/>
                    &nbsp;<label >门急诊工作量达到要求或门急诊量≥规定数的80%，得2分</label><br>
                    <input   type="radio"  name="2022-3.4.2" value="1" onchange="selectRadio('2022-3.4.2','1','self','2','门急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label >门急诊量≥规定数的60%，得1分</label><br>
                    <input   type="radio"  name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','self','2',' 门急诊量＜规定数60%或未安排，不得分')"/>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.4.2" itemName="门急诊工作量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2700_01','附表1');">附表1</a>
                <br>
                ≥90分得满分，≥80分得4分，≥70分得3分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">6</td>
            <td name="file" itemId="2022-4.1.1" itemName="教学查房质量"></td>
            <td><input id="fubiao1" onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.1.1" itemName="教学查房质量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao1Expert" onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.1.1" itemName="教学查房质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="教学查房质量" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.1']}</textarea>
            </td>
        </tr>
        <tr style="height:32px;">
            <td style="height: 32px;">4.1.2技能操作安排情况★</td>
            <td>每个轮转科室均能按照《住院医师规范化培训内容与标准（试行）》本专业细则要求执行，为每名培训对象安排并完成规定的技能操作种类和数量
            </td>
            <td>
                满意率≥90%，得满分 <br>
                满意率≥80%，得2分 <br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','2','self','4','')"/>
                    &nbsp;<label >满意率≥90%，得满分分</label><br>
                    <input   type="radio"  name="2022-4.1.2" value="1" onchange="selectRadio('2022-4.1.2','1','self','4','满意率≥80%，得2分')"/>
                    &nbsp;<label >满意率≥80%，得2分</label><br>
                    <input   type="radio"  name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','4',' 满意率＜80%，不得分')"/>
                    &nbsp;<label > 满意率＜80%，不得分</label>
                </c:if>
                      <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','2','expert','4','')"/>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);"  itemId="2022-4.1.2" itemName="技能操作安排情况" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.3']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td rowspan="3">4.2培训对象学习效果</td>
            <td style="height: 48px;">4.2.1病历或报告书写★</td>
            <td>培训对象病历或调查方案、调查报告、工作总结等书写规范</td>
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2700_02','附表2');">
                        附表2</a>
                <br>
                ≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">7</td>
            <td name="file" itemId="2022-4.2.1" itemName="病历或报告书写"></td>
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="病历或报告书写" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,7);" itemId="2022-4.2.1" itemName="病历或报告书写" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.2.1" itemName="病历或报告书写" name="reason" placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2700_03','附表3');">
                        附表3</a>
                <br>
            ...
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,5);" itemId="2022-4.2.2" itemName="技能操作" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,5);" itemId="2022-4.2.2" itemName="技能操作" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.2.2" itemName="技能操作" name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.2']}</textarea>
            </td>
        </tr>
        <tr style="height:48px;">
            <td style="height: 48px;">4.2.3完成培训内容与要求★</td>
            <td>按照《住院医师规范化培训内容与标准（试行）》预防医学专业细则，核实培训内容的完成情况</td>
            <td>
                完成率≥90%，得满分<br>
                完成率≥85%，得5分<br>
                完成率≥80%，得3分<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.3" itemName="完成培训内容与要求" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr>
            <td colspan="10" style="text-align: left">
                备注：<br>
                &#12288; &#12288; 1.一级指标4项，二级指标10项，三级指标35项。三级指标中，核心指标15项、计69分，一般指标20项、计31分，共100分。<br>
