...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——放射肿瘤科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="11">1.基本条件（16分）</td>
            <td style="height:53px;" rowspan="8">1.1专业基地所在医院条件</td>
            <td>1.1.1总床位数</td>
            <td width="313px">
                三级甲等综合医院或三级肿瘤专科医院放射肿瘤科病床数≥30张
            </td>
        ...
        <tr style="height:50px">
            <td>1.1.4科室和实验室</td>
            <td>
                肿瘤相关亚专业（专科）、放射科、超声医学科、核医学科、病理科、麻醉科、检验科、输血科、图书馆
            </td>
            <td>
                查看相关文件，实地考查
            </td>
        ...
        <tr style="height:50px">
            <td>1.1.5轮转科室</td>
            <td>
                普通内科：心血管内科、呼吸内科、消化内科、感染科、重症监护治疗室（ICU)、急诊科 <br>
                肿瘤基础：放射影像科、病理科、肿瘤内科<br>
                普通外科/肿瘤外科<br>
                放射治疗科
            </td>
            <td>1.查看各亚专业(专科)设置名称<br>
        ...
        <tr style="height:50px">
            <td>1.1.6疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》放射肿瘤科专业细则要求 ，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2500_01','附表1');">
                        附表1</a>
            </td>
            <td>核对上一年度各亚专业(专科)收治疾病种类和数量统计报表
            </td>
            <td>
                符合要求（含协同单位），得满分 <br>
            ...
            <td><input id="fubiao11" onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="疾病种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao11Expert" onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.6" itemName="疾病种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:50px">
            <td>1.1.7技能操作种类及数量★</td>

            <td>核对上一年度各亚专业(专科)技能操作种类和数量的统计报表 </td>
            <td>
                符合要求（含协同单位），得满分 <br>
            ...
            <td name="file" itemId="2022-1.1.7" itemName="技能操作种类及数量"></td>
            <td><input id="fubiao12" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.7" itemName="技能操作种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao12Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.7" itemName="技能操作种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <textarea onchange="saveSpeReason(this);"  itemId="2022-1.1.7" itemName="技能操作种类及数量" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.7']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>1.1.8专业基地设备</td>
            <td>直线加速器、后装治疗机、模拟定位机、三维计划治疗系统、质量控制和质量保证设备（晨检仪、水平尺、坐标纸、钢尺、电离室、剂量仪、二维探测器阵列、图像质量检测模体、胶片剂量计、温度计/气压计）</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="专业基地设备"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="专业基地设备"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);"  itemId="2022-1.1.8" itemName="专业基地设备" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.8']}</textarea>
                </c:if>
            </td>
        </tr>
        ...
        <tr style="height:50px">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》放射肿瘤科细则要求)
            </td>
            <td>
                满足要求，得1分（无协同单位的专业基地，此处不失分）
            </td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历,副主任医师或任主治医师专业技术职务3年以上，从事放射治疗专业10年以上            </td>
            <td rowspan="3">
                查看人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章            </td>
            <td>
                其中1名带教医师不符合要求，不得分
            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                各亚专业(专科)主任医师≥2人，副主任医师≥3人，主治医师≥5人；医学物理人员≥5人
            <td>
            1个亚专业(专科)不达标，不得分            </td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事本专业的医疗、科研和教学工作超过15年            </td>
            <td>1项不符合条件，不得分</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:32px;">
            <td style="height: 438px;" rowspan="12">3.过程管理（32分）</td>
        ...
        <tr style="height:40px;">
            ...
            <td>
                规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通等入科教育，并有专人组织实施            </td>
            <td>提供本年度入科教育原始资料</td>
            <td>
                有，且严格落实，得满分 <br>
                未严格落实，不得分
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">3.2.2教学查房（阅片会）</td>
            <td>开展规范的教学查房（阅片会），至少1周1次</td>
            ...
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-3.2.2" itemName="教学查房（阅片会）"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学查房（阅片会）"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.2.2" itemName="教学查房（阅片会）"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-3.2.2" itemName="教学查房（阅片会）" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-3.2.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
        ...
        <tr style="height:48px;">
            ...
            <td>3.3.1出科考核</td>
            <td>
                理论考核(如临床病例分析)试题、技能操作考核评分标准、培训对象测评结果、考勤记录等原始资料齐全，真实规范            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','self','3','仅有技能操作考核或仅有理论考试，得2分')"/>
                    &nbsp;<label >仅有技能操作考核或仅有理论考试，得2分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','self','3','仅有测评结果和考勤记录，得1分')"/>
                    &nbsp;<label >仅有测评结果和考勤记录，得1分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.3.1" value="3" onchange="selectRadio('2022-3.3.1','3','expert','3','')"/>
                    &nbsp;<label>考核项目全面，且认真规范，得满分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','expert','3','仅有技能操作考核或仅有理论考试，得2分')"/>
                    &nbsp;<label >仅有技能操作考核或仅有理论考试，得2分</label><br>
                    <input type="radio"  name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','expert','3','仅有测评结果和考勤记录，得1分')"/>
                    &nbsp;<label >仅有测评结果和考勤记录，得1分</label>
                </c:if>
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:48px;">
            ...
            <td>
                按照专业基地培训对象临床操作和报告能够达到《住院医师规范化培训内容与标准（试行）》放射肿瘤科专业细则的要求
            </td>
            <td>查看轮转手册等相关材料，随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
            <td>
                管床数、技能操作数达要求，得满分 <br>
                管床数、技能操作≥规定数的80%，得4分 <br>
                管床数、技能操作≥规定数的70%，得2分 <br>
                未安排独立管床或技能操作，不得分
            </td>
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-3.4.1" itemName="培训强度"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-3.4.1" itemName="培训强度"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-3.4.1" itemName="培训强度"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input   type="radio"  name="2022-3.4.1" value="8" onchange="selectRadio('2022-3.4.1','8','self','8','')"/>
                    &nbsp;<label >管床数、技能操作数达要求，得满分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','self','8','管床数、技能操作≥规定数的80%，得4分')"/>
                    &nbsp;<label >管床数、技能操作≥规定数的80%，得4分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','8','管床数、技能操作≥规定数的70%，得2分')"/>
                    &nbsp;<label >管床数、技能操作≥规定数的70%，得2分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','8','未安排独立管床或技能操作，不得分')"/>
                    &nbsp;<label >未安排独立管床或技能操作，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio"  name="2022-3.4.1" value="8" onchange="selectRadio('2022-3.4.1','8','expert','8','')"/>
                    &nbsp;<label >管床数、技能操作数达要求，得满分</label><br>
                    <input type="radio"  name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','expert','8','管床数、技能操作≥规定数的80%，得4分')"/>
                    &nbsp;<label >管床数、技能操作≥规定数的80%，得4分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','8','管床数、技能操作≥规定数的70%，得2分')"/>
                    &nbsp;<label >管床数、技能操作≥规定数的70%，得2分</label><br>
                    <input   type="radio"  name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','8','未安排独立管床或技能操作，不得分')"/>
        ...
        <tr style="height:48px;">
            ...
            <td rowspan="3">4.1.1带教医师教学质量</td>
            <td>4.1.1查房质量★</td>
            <td>主任或带教医师组织开展规范的教学查房，悉心指导培训对象</td>
            <td>随机抽查1～2名带教医师教学查房</td>
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2500_02','附表2');">
                        附表2</a>
                <br>
            ...
            <td><input id="fubiao2" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="查房质量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao2Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.1" itemName="查房质量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:32px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作安排情况"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.1.2" itemName="技能操作安排情况"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                 ...
                 <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                    ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                <textarea  onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作安排情况" name="reason" placeholder="请填写扣分原因" style="width: 98%" class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.2']}</textarea>
                </c:if>
            </td>
        </tr>
        <tr style="height:32px;">
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2500_03','附表3');">
                        附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            ...
            <td><input id="fubiao3" onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao3Expert" onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.1" itemName="病历书写"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_2500_04','附表4');">
                        附表4</a>
                <br>
            ...
            <td><input id="fubiao4" onchange="saveScoreOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
            <td><input id="fubiao4Expert" onchange="saveScore4ExpertOnlyIntenger(this,8);" itemId="2022-4.2.2" itemName="技能操作"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
            <td>
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                &#12288;&#12288; 1.一级指标4项二，级指标10项，三级指标36项。三级指标中，核心指标14项、计65分，一般指标22项、计35分，共100分。<br>
