...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
	<div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
		<table class="grid" style="width: 100%;" >
			<tr height="34" class="firstRow">
				<th colspan="10">
					<h2 style="font-size:150%">住院医师规范化培训评估指标——外科（整形外科方向）专业基地</h2>
				</th>
			</tr>
			<tr height="28" >
	...
	<table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
		...
		<tr style="height:50px">
			<td style="height: 438px;" rowspan="13">1.基本条件<br>（20分）</td>
			<td rowspan="10">1.1专业基地条件</td>
			<td>1.1.1总床位数</td>
			<td width="366px">
				三级甲等综合医院整形外科床位总数≥30张
			</td>
			<td width="367px">
				符合标准，得满分<br>
				不达标准，不得分
		...
		<tr style="height:64px">
			...
			<input type="hidden" id="jScoreInfo3" name="jScoreInfo" value="${jScoreInfo3}">
			<input type="hidden" id="jScoreInfo4" name="jScoreInfo" value="${jScoreInfo4}">
			<input type="hidden" id="jScoreInfo5" name="jScoreInfo" value="${jScoreInfo5}">
			<input type="hidden" id="jScoreInfo6" name="jScoreInfo" value="${jScoreInfo6}">
			<td rowspan="2">
				符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》本专业细则要求，详见

					<a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_1300_Main','附表1-1至1-6');">
						附表1-1至1-6</a>
			</td>
			<td>
				符合要求（含协同单位），得满分<br>
			...
			<td><input id="fubiao11" onchange="saveScore(this,3);" itemId="2022-1.1.7" itemName="疾病种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao11Expert" onchange="saveScore4Expert(this,3);" itemId="2022-1.1.7" itemName="疾病种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:64px;">
			...
			<input type="hidden" id="cScoreInfo3" name="cScoreInfo" value="${cScoreInfo3}">
			<input type="hidden" id="cScoreInfo4" name="cScoreInfo" value="${cScoreInfo4}">
			<input type="hidden" id="cScoreInfo5" name="cScoreInfo" value="${cScoreInfo5}">
			<input type="hidden" id="cScoreInfo6" name="cScoreInfo" value="${cScoreInfo6}">
			<td>
				符合要求（含协同单位），得满分<br>
			...
			<td><input id="fubiao12" onchange="saveScore(this,3);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao12Expert" onchange="saveScore4Expert(this,3);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:50px;">
			...
			<td>
				1.纤维胃镜、结肠镜、肝脏介入治疗设备、腹腔镜、胆道镜等<br>
				2.手术显微镜、关节镜、 C形臂<br>
				3.支气管镜、胸腔镜、多导监护仪<br>
		...
		<tr style="height:38px;">
			...
			<td>
				医学本科及以上学历，主任医师专业技术职务，从事整形外科专业的医疗、科研和教学工作超过15年
			</td>
			<td>
				1项不符合条件，不得分
			</td>
		...
		<tr style="height:35px;">
			...
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
					...
					<input type="radio" name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','self','3','有激励机制，未与奖金、评优挂钩，得1分')"/>
				   ...
				   <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
					...
					&nbsp;<label>有激励机制，并与奖金、评优挂钩，得满分</label><br>
					<input type="radio" name="2022-2.2.3" value="1" onchange="selectRadio('2022-2.2.3','1','expert','3','有激励机制，未与奖金、评优挂钩，得1分')"/>
			...
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
				   ...
				   <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
					...
					&nbsp;<label>仅有技能操作考核，得4分</label><br>
					<input type="radio" name="2022-3.3.1" value="2" onchange="selectRadio('2022-3.3.1','2','expert','7','仅有理论考试，得2分')"/>
					&nbsp;<label>仅有理论考试，得2分</label><br>
					<input type="radio" name="2022-3.3.1" value="1" onchange="selectRadio('2022-3.3.1','1','expert','7','仅有测评结果和考勤记录，得1分')"/>
					&nbsp;<label>仅有测评结果和考勤记录，得1分</label>
				</c:if>
		     <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
		...
		<tr style="height:48px;">
			...
			<td>
				教学查房评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1300_02','附表2');">
						附表2</a>
				<br>
				≥90分得满分，≥80分得4分，≥70分得2分<br>
				≥60分得1分，＜60分不得分
			</td>
			<td style="text-align: center;">6</td>
			<td name="file" itemId="2022-4.1.1" itemName="查房质量"></td>
			<td><input id="fubiao2" onchange="saveScore(this,6);" itemId="2022-4.1.1" itemName="查房质量"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao2Expert" onchange="saveScore4Expert(this,6);" itemId="2022-4.1.1" itemName="查房质量"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:48px;">
			...
			<td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
				<c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
					<input type="radio" name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','self','4','')"/>
					&nbsp;<label>完成率≥90%，得满分</label><br>
					<input type="radio" name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','self','4','完成率≥80%，得2分')"/>
					&nbsp;<label>完成率≥80%，得2分</label><br>
					<input type="radio" name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','self','4','完成率＜80%，不得分')"/>
					&nbsp;<label>完成率＜80%，不得分</label><br>
				</c:if>
				   <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
					<input type="radio" name="2022-4.1.2" value="4" onchange="selectRadio('2022-4.1.2','4','expert','4','')"/>
					&nbsp;<label>完成率≥90%，得满分</label><br>
					<input type="radio" name="2022-4.1.2" value="2" onchange="selectRadio('2022-4.1.2','2','expert','4','完成率≥80%，得2分')"/>
					&nbsp;<label>完成率≥80%，得2分</label><br>
					<input type="radio" name="2022-4.1.2" value="0" onchange="selectRadio('2022-4.1.2','0','expert','4','完成率＜80%，不得分')"/>
					&nbsp;<label>完成率＜80%，不得分</label><br>
				</c:if>
		     <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
		...
		<tr style="height:48px;">
			...
			<td>
				病历书写评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1300_03','附表3');">
						附表3</a>
				<br>
			...
			<td><input id="fubiao3" onchange="saveScore(this,5);" itemId="2022-4.2.1" itemName="病历书写"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao3Expert" onchange="saveScore4Expert(this,5);" itemId="2022-4.2.1" itemName="病历书写"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
		...
		<tr style="height:48px;">
			...
			<td>
				技能操作评分表见
					<a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1300_04','附表4');">
						附表4</a>
				<br>
			...
			<td><input id="fubiao4" onchange="saveScore(this,7);" itemId="2022-4.2.2" itemName="技能操作和手术"  name="self"  class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></td>
			<td><input id="fubiao4Expert" onchange="saveScore4Expert(this,7);" itemId="2022-4.2.2" itemName="技能操作和手术"  name="expert"  class="input" type="text"   style="height:20px;width: 25px; text-align: center"  /></td>
			<td>
