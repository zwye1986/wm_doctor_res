...
<head>
	...
	<script type="text/javascript">
        ...
        function subInfo() {
            ...
            selfTwoScore = parseInt(selfTwoScore / 25 * 100);
            var url = "<s:url value='/jsres/supervisio/saveManyScheduleTotalled'/>";
            var data = {
                "itemIdOne": 'jScoreInfo1',
                "itemIdTwo": 'cScoreInfo1',
            ...
            top.jboxPost(url, data, function (resp) {
                if (resp == "${GlobalConstant.OPERATE_SUCCESSED}") {
                    window.parent.frames["jbox-message-iframe"].$("#jScoreInfo1")[0].value = selfOneScore;
                    window.parent.frames["jbox-message-iframe"].$("#cScoreInfo1")[0].value = selfTwoScore;
                    var scoreOneAll = 0;
                    var scoreTwoAll = 0;
                    var oneNum = 0;
                    var twoNum = 0;
	...
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		<tbody>
			<tr height="34" class="firstRow">
				<th colspan="8">
					<h2 style="font-size:150%">外科(ICU)疾病种类/临床技能操作</h2>
				</th>
			</tr>
			<tr style="height:32px;">
				<th colspan="2">年收治病人数(人次)</th>
				<th style="width: 12.5%">标准</th>
				<th style="width: 12.5%">≥190</th>
				<th style="width: 12.5%">实际数</th>
				<td style="width: 12.5%">
					<input onchange="saveScore(this,190);" itemId="1300-01-1.1" itemName="k1年收治病人数"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<th style="width: 12.5%">低于标准数（划√）</th>
				<td style="width: 12.5%">
					<input itemId="1300-01-1.1" itemName="d1年收治病人数"  name="less"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px;">
			...
			<tr style="height:32px">
				<th rowspan="2">疾病种类</th>
				<th >重症病人</th>
				<th colspan="2">≥50</th>
				<td colspan="2">
					<input onchange="saveScore(this,50);" itemId="1300-01-2.1" itemName="k重症病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-2.1" itemName="d重症病人"  name="less1"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >机械通气治疗病人</th>
				<th colspan="2">≥25</th>
				<td colspan="2">
					<input onchange="saveScore(this,25);" itemId="1300-01-2.2" itemName="k机械通气治疗病人"  name="self1"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-2.2" itemName="d机械通气治疗病人"  name="less1"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			...
			<tr style="height:32px">
				...
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1300-01-3.1" itemName="k心肺复苏"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-3.1" itemName="d心肺复苏"  name="less2"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >电除颤</th>
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1300-01-3.2" itemName="k电除颤"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-3.2" itemName="d电除颤"  name="less2"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >常用监测技术</th>
				<th colspan="2">≥10</th>
				<td colspan="2">
					<input onchange="saveScore(this,10);" itemId="1300-01-3.3" itemName="k常用监测技术"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-3.3" itemName="d常用监测技术"  name="less2"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
			</tr>
			<tr style="height:32px">
				<th >呼吸机操作</th>
				<th colspan="2">≥5</th>
				<td colspan="2">
					<input onchange="saveScore(this,5);" itemId="1300-01-3.4" itemName="k呼吸机操作"  name="self2"  class="input" type="text"  style="height:20px; text-align: center"  />
				</td>
				<td colspan="2">
					<input itemId="1300-01-3.4" itemName="d呼吸机操作"  name="less2"  class="input" type="text" style="height:20px; text-align: center"/>
				</td>
