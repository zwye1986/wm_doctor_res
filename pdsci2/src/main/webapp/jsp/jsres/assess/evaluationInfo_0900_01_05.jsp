...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.1" itemName="k食管(贲门)癌" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.1" itemName="d食管(贲门)癌" name="less" readonly="readonly" class="input"
        ...
        <tr style="height:32px">
            ...
            <th colspan="2">≥15</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.2" itemName="k肺癌" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.2" itemName="d肺癌" name="less" readonly="readonly" class="input" type="text"
        ...
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.3" itemName="k胸部外伤、 血胸、 气胸" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.3" itemName="d胸部外伤、 血胸、 气胸" name="less" readonly="readonly" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥15</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.4" itemName="k其他普胸病种" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.4" itemName="d其他普胸病种" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.5" itemName="k常见先天性心脏病" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.5" itemName="d常见先天性心脏病" name="less" readonly="readonly" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥5</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.6" itemName="k心脏瓣膜疾病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.6" itemName="d心脏瓣膜疾病" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-1.7" itemName="k其他心血管外科疾病" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-1.7" itemName="d其他心血管外科疾病" name="less" readonly="readonly" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥15</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.1" itemName="k胸腔穿刺术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.1" itemName="d胸腔穿刺术" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥15</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.2" itemName="k胸腔闭式引流术" name="self2"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.2" itemName="d胸腔闭式引流术" name="less" readonly="readonly" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.3" itemName="k开胸术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.3" itemName="d开胸术" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.4" itemName="k食管、贲门癌手术" name="self2"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.4" itemName="d食管、贲门癌手术" name="less" readonly="readonly" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.5" itemName="k肺叶切除术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.5" itemName="d肺叶切除术" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.6" itemName="k先心病手术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.6" itemName="d先心病手术" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0900-05-2.7" itemName="k其他心脏手术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0900-05-2.7" itemName="d其他心脏手术" name="less" readonly="readonly" class="input" type="text"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
