...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——康复科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            ...
            <td>检查相关文件复印件，需加盖医院公章 ，实地考查</td>
            <td>
                符合标准，得满分<br>
                不达标准，不得分
            </td>
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.1" itemName="总床位数"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.1" value="${ownerScoreMap['2022-1.1.1']}"
        ...
        <tr style="height:39px;">
            <td>1.1.4科室和实验室</td>
            <td>
                神经内科、神经外科、ICU、骨科或矫形外科、心血管内科、心胸外科、呼吸内科、儿科、放射影像学科、
                超声科，神经电生理、心肺运动试验室
            </td>
            <td>
                查看相关文件，实地考查
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">1.1.5轮转科室</td>
            <td width="313px">
                神经康复、骨科康复、内科康复、儿童康复、物理治疗科、作业治疗科、言语治疗科、假肢矫形器科
            </td>
            <td width="193px">
                1.查看各亚专业（专科）设置名称<br>
            ...
            <td name="file" itemId="2022-1.1.5" itemName="轮转科室" width="180px"></td>
            <td width="74px"><input onchange="saveScoreOnlyIntenger(this,3);" itemId="2022-1.1.5" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
        ...
        <tr style="height:32px;">
            <td style="height: 32px;">1.1.6疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》康复科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0800_01','附表1');">附表1</a>
            </td>
            <td>
        ...
        <tr style="height:64px">
            <td style="height: 32px;">1.1.7临床技能操作种类及数量★</td>
            <td>
        ...
        <tr style="height:64px;">
            <td style="height: 32px;">1.1.8医院设备</td>
            <td>
                大型X射线机、 彩色超声仪、 CT、 MRI、 骨密度测定仪、核素扫描仪、肌电图、脑电图仪、动态心电图仪、临床技能模拟培训系统
            </td>
            <td>
        ...
        <tr style="height:50px;">
            <td style="height: 32px;">1.1.9专业基地设备</td>
            <td>
                心电图仪、心肺运动试验仪、步态分析仪、超声诊断仪
            </td>
            <td>
                检查设备清单复印件，需加盖医院公章，实地考查
            </td>
        ...
        <tr style="height:50px;">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准（试行）》康复科细则要求)
            </td>
            <td>
                满足要求，得1分（无协同单位的专业基地，此处不失分）
            </td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                各亚专业（专科）有主任医师≥1人，副主任医师≥2人，主治医师≥2人
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                主任医师专业技术职务,从事康复专业的医疗、科研和教学工作超过10年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','4','管床数≥5张，得2分')"/>
                    &nbsp;<label>管床数≥5张，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','4','管床数≥4张，得1分')"/>
                    &nbsp;<label>管床数≥4张，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','4','管床数＜4张，或未安排，不得分')"/>
                    &nbsp;<label>管床数＜4张，或未安排，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','expert','4','')"/>
                    &nbsp;<label>管床数达到要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','expert','4','管床数≥5张，得2分')"/>
                    &nbsp;<label>管床数≥5张，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','4','管床数≥4张，得1分')"/>
                    &nbsp;<label>管床数≥4张，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','4','管床数＜4张，或未安排，不得分')"/>
                    &nbsp;<label>管床数＜4张，或未安排，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:48px;">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','self','3','无，不得分')"/>
                    &nbsp;<label>无，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.2" value="3" onchange="selectRadio('2022-3.4.2','3','expert','3','')"/>
                    &nbsp;<label>门急诊工作量达到要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','expert','3','无，不得分')"/>
                    &nbsp;<label>无，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0800_02','附表2');">附表2</a>
                <br>
            ...
            <td><input id="fubiao2" onchange="saveScore(this,4);" itemId="2022-4.1.1" itemName="查房质量" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.1" itemName="查房质量"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0800_03','附表3');">附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分<br>
                ≥60分得1分，＜60分不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_0800_Main','附表4');">附表4</a>
                <br>
                ≥90分得满分，≥80分得5分，≥70分得3分<br>
                ≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">8</td>
            <input type="hidden" id="scoreInfo1" value="${scoreInfo1}" name="scoreInfo">
            <input type="hidden" id="scoreInfo2" value="${scoreInfo2}" name="scoreInfo">
        ...
        <tr style="height:150px;">
            ...
            <td rowspan="2" colspan="8">
                <textarea class="input" type="text" id="speContentInput" name="speContentInput"
                          ...
                          onchange="saveSpeContent(this,'${orgFlow}')">${subjectUser.speContent}</textarea>
            </td>
        </tr>
        <tr style="height:16px;">
        </tr>
