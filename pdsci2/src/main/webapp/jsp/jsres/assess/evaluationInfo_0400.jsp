...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——皮肤科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            ...
            <td>1.1.1总床位数</td>
            <td width="313px">
                三级甲等综合医院的皮肤科专业基地应设有皮肤门诊、性病门诊和皮肤科病房，总床位数≥15张
            </td>
        ...
        <tr style="height:53px;">
            ...
            <td>必备科室:门诊部、急诊科、内科、外科、妇产科、放射科、病理科、超声科，皮肤科实验室
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                缺1个科室，不得分
        ...
        <tr style="height:53px;">
            <td>1.1.5轮转科室</td>
            <td>
                1.必选轮转科室：心血管内科、呼吸内科、风湿免疫科（以上均病房为主）、急诊科
                2.可选轮转科室：消化内科、肾脏内科、血液科、内分泌科、感染内科、普通外科、整形外科 ，泌尿外科和妇科（以门诊为主）、
                3.皮肤性病科门诊
                4.皮肤科病房
                5.皮肤病理科、实验室及治疗室
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','self','2','必选科室缺1个科室或可选科室缺2个科室，不得分')"/>
                    &nbsp;<label>必选科室缺1个科室或可选科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.5" value="2" onchange="selectRadio('2022-1.1.5','2','expert','2','')"/>
                    &nbsp;<label>科室齐全，得满分</label><br>
                    <input type="radio" name="2022-1.1.5" value="0" onchange="selectRadio('2022-1.1.5','0','expert','2','必选科室缺1个科室或可选科室缺2个科室，不得分')"/>
                    &nbsp;<label>必选科室缺1个科室或可选科室缺2个科室，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:53px;">
            <td>1.1.6疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》皮肤科专业细则要求，详见
                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_01_01','附表1-1',1100,670);">附表1-1</a>、
                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_01_02','附表1-2',1100,330);">附表1-2</a>
            </td>
            ...
            <td><input  id="fubiao11" onchange="saveScore(this,3);" itemId="2022-1.1.6" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao11Expert" onchange="saveScore4Expert(this,3);" itemId="2022-1.1.6" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            ...
            <td><input id="fubiao12" onchange="saveScore(this,4);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4Expert(this,4);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            <td>1.1.8医院设备</td>
            <td>冰冻切片机、荧光显微镜、图书馆、计算机与网络系统</td>
            <td>
        ...
        <tr style="height:53px;">
            <td>1.1.9专业基地设备</td>
            <td>
                普通光学显微镜、组织标本自动脱水机、清洁操作台、病理切片机、清洁恒温孵箱、二氧化碳激光治疗仪、He-Ne激光治疗仪、紫外线治疗仪、液氮冷冻治疗仪、12导联心电图机、生命体征监护仪（无创血压、心电、脉氧、呼吸等）、快速血糖自动测定仪、中心供氧接口或氧气筒、中心吸引接口或电动吸引器、常用急救设备
            </td>
        ...
        <tr style="height:53px;">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》本专业细则要求)
            </td>
            <td>
        ...
        <tr style="height:53px;">
            <td>2.1.2带教医师条件</td>
            <td>
                医学本科及以上学历,主治医师专业技术职务3年以上，从事本专业工作≥10年
            </td>
        ...
        <tr style="height:53px;">
            <td>2.1.3带教医师组成</td>
            <td>
                有从事皮肤病理、真菌、性病的专业，有开展冷冻、CO2激光、点解、光疗等治疗专业人员
                中级专业技术职务以上人员≥7人，其中高级专业技术职务≥4名
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
        ...
        <tr style="height:53px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事皮肤专业临床医疗、科研与教学工作15年以上
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>3.4.1培训工作量★</td>
            <td>
                按照专业基地培训对象管理床位数能够达到《住院医师规范化培训内容与标准（试行）》皮肤科专业细则的要求
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>管床数和门急诊量达要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','self','6','管床数和门急诊量≥规定数的80%，得3分')"/>
                    &nbsp;<label>管床数和门急诊量≥规定数的80%，得3分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','6','管床数和门急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label>管床数和门急诊量≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','6','＜60%，或未安排、未完成，不得分')"/>
                    &nbsp;<label>＜60%，或未安排、未完成，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.1" value="6" onchange="selectRadio('2022-3.4.1','6','expert','6','')"/>
                    &nbsp;<label>管床数和门急诊量达要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.1" value="3" onchange="selectRadio('2022-3.4.1','3','expert','6','管床数和门急诊量≥规定数的80%，得3分')"/>
                    &nbsp;<label>管床数和门急诊量≥规定数的80%，得3分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','6','管床数和门急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label>管床数和门急诊量≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','6','＜60%，或未安排、未完成，不得分')"/>
                    &nbsp;<label>＜60%，或未安排、未完成，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            ...
            <td>4.1.1教学查房质量★</td>
            <td>
                主任或带教医师开展规范的教学查房，悉心指导培训对象
            </td>
            <td>随机抽查1～2名带教医师教学查房</td>
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_02','附表2',1100,670);">附表2</a>
                <br>
        ...
        <tr style="height:50px">
            <td>4.1.2技能操作完成情况★</td>
            <td>每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作（见

                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_01_02','附件1-2',1100,670);">附件1-2</a>
                ）
            </td>
            <td>
                随机抽查5～10名培训对象，由评估专家根据本专业实际需求确定手术或技能操作项目，查看技能操作，掌握实际情况
            </td>
            <td>
                完成率≥90%，得满分
                完成率≥80%，得4分
            ...
            <td><input onchange="saveScore(this,8);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,8);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.2" itemName="技能操作完成情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>4.1.3技能操作带教情况★</td>
            <td>带教医师协助并指导培训对象完成技能操作，带教严格规范</td>
            <td>
                随机抽查1～2名带教医师指导培训对象(二年级以上)进行技能操作情况
            </td>
            <td>
            ...
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.3" itemName="技能操作带教情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['4.1.3']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            ...
            <td>培训对象病历书写规范</td>
            <td>
                随机抽查1～2名培训对象运行病历，结合病历提问题
            </td>
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_03','附表3',1100,670);">附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-1.1.1" itemName="病历书写"></td>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)"
                       onclick="Schedule('evaluationInfo_0400_04','附表4',1100,670);">附表4</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">8</td>
