    ...
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——口腔修复科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">
                ...
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3100_01','附表1');">
                    附表1</a>
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学技能评分表见
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3100_02','附表2');">
                    附表2</a>
                <br>
        ...
        <tr style="height:48px;">
            ...
            <td>
                ...
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_3100_03','附表3');">
                    附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                ...
                <a href="javascript:void(0)" onclick="scheduleMany('evaluationInfo_3100_Main','附表4-1至4-5');">
                    附表4-1至4-5</a>
                <br>
