...
<head>
    ...
    <script type="text/javascript">
        ...
        function subInfo() {
            ...
            selfTwoScore = parseInt(selfTwoScore / 50 * 100);
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr style="height:32px">
            <th rowspan="13">疾病种类</th>
            <th>病毒性肝炎</th>
            <th colspan="2">≥60</th>
            <td>
                <input onchange="saveScore(this,60);" itemId="0100-07-1.1" itemName="k病毒性肝炎" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.1" itemName="d病毒性肝炎" name="less" class="input" type="text" readonly="readonly"
        ...
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-07-1.2" itemName="k发热待查" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.2" itemName="d发热待查" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥30</th>
            <td>
                <input onchange="saveScore(this,30);" itemId="0100-07-1.3" itemName="k细菌性痢疾" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.3" itemName="d细菌性痢疾" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-07-1.4" itemName="k中枢神经系统感染" name="self1"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.4" itemName="d中枢神经系统感染" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="0100-07-1.5" itemName="k败血症、感染性休克" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.5" itemName="d败血症、感染性休克" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0100-07-1.6" itemName="k细菌性食物中毒" name="self1"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.6" itemName="d细菌性食物中毒" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>获得性免疫缺陷综合征(AIDS)</th>
            <th colspan="2">≥5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="0100-07-1.7" itemName="k获得性免疫缺陷综合征(AIDS)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.7" itemName="d获得性免疫缺陷综合征(AIDS)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th style="width: 20%">伤寒/麻疹/疟疾/霍乱/乙型脑炎/肝脓肿/阿米巴病/血吸虫/钩端螺旋体病/流行性腮腺炎/流行性脑脊髓膜炎/流行性出血热/肝吸虫病/黑热病/囊虫病</th>
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-07-1.8"
                       itemName="k伤寒"
                       name="self1" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-1.8"
                       itemName="d伤寒" readonly="readonly"
                       name="less" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>传染性单核细胞增多症</th>
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-1.9','k传染性单核细胞增多症');" itemId="0100-07-1.9"
                        itemName="k传染性单核细胞增多症"
            ...
            <td>
                <input itemId="0100-07-1.9" itemName="d传染性单核细胞增多症" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-1.10','k弓形虫病');" itemId="0100-07-1.10"
                        itemName="k弓形虫病"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-07-1.10" itemName="d弓形虫病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-1.11','k布鲁菌病');" itemId="0100-07-1.11"
                        itemName="k布鲁菌病"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-07-1.11" itemName="d布鲁菌病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-1.12','k医院内感染');" itemId="0100-07-1.12"
                        itemName="k医院内感染"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-07-1.12" itemName="d医院内感染" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-1.13','k狂犬病');" itemId="0100-07-1.13"
                        itemName="k狂犬病"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-07-1.13" itemName="d狂犬病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-07-2.1" itemName="k消毒隔离的程序" name="self2"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-07-2.1" itemName="d消毒隔离的程序" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-2.2','k肝穿刺活检');" itemId="0100-07-2.2"
                        itemName="k肝穿刺活检"
            ...
            <td>
                <input itemId="0100-07-2.2" itemName="d肝穿刺活检" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-07-2.3','k人工肝');" itemId="0100-07-2.3"
                        itemName="k人工肝"
                        name="self2" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-07-2.3" itemName="d人工肝" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
