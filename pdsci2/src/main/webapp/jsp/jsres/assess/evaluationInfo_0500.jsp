...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——精神科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:16px;">
            ...
            <th style="min-width: 50px;max-width: 50px" rowspan="2">分值</th>
            <th style="min-width: 130px;max-width: 130px" rowspan="2">附件信息</th>
            <th style="min-width: 54;max-width: 50px" rowspan="2">自评得分</th>
            <th style="min-width: 54;max-width: 50px" rowspan="2">专家评分</th>
            <th style="min-width: 150px;max-width: 150px" rowspan="2">扣分原因</th>
        </tr>
        <tr style="height:32px">
            <th style="width: 100px;height: 32px;">一级指标</th>
        ...
        <tr style="height:53px;">
            <td style="height:53px;">1.1.4科室和实验室</td>
            <td>依托本院或其他综合医院的内科、神经内科和急诊科专业基地的相应科室和实验室
                专科医院应有独立的检验医学科
            </td>
            <td>查看相关文件，实地考查</td>
            <td>缺1个科室，不得分</td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.4" itemName="科室和实验室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
        ...
        <tr style="height:53px;">
            ...
            <td>
                神经内科、急诊科、ICU、心血管内科、
                精神科重症病房、精神科轻症病房或临床心理科、
                其他精神科病房（如老年、儿童）、精神科门急诊
            </td>
            <td>1.查看各亚专业（专科）设置名称
                2.查看培训对象轮转计划和登记手册
                3.实地考查，访谈培训对象
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="轮转科室" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.5" itemName="轮转科室" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:53px;">
            <td>1.1.6疾病种类及数量</td>
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》精神科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0500_01_01','附件1-1');">附件1-1</a>
                和
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0500_01_02','附件1-2');">附件1-2</a>
            </td>
            ...
            <td><input id="fubiao11" onchange="saveScore(this,2);" itemId="2022-1.1.6" itemName="疾病种类及数量" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao11Expert" onchange="saveScore4Expert(this,2);" itemId="2022-1.1.6" itemName="疾病种类及数量"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            ...
            <td><input id="fubiao12" onchange="saveScore(this,4);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量"
                       name="self" class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4Expert(this,4);" itemId="2022-1.1.7"
                       itemName="临床技能操作种类及数量" name="expert" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.7" itemName="临床技能操作种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            <td>1.1.8医院设备</td>
            <td>MECT治疗仪、多导心电监测仪、脑电地形图仪、生命体征监护仪（无创血压、心电、脉氧、呼吸等）、快速血糖自动测定仪、氧气瓶、X射线机、完备的急救系统和相关设备等</td>
            <td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="医院设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.8" itemName="医院设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
               ...
               <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.8" itemName="医院设备" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.9专业基地设备</td>
            <td>
                MECT治疗仪、多导心电监测仪、生命体征监护仪（无创血压、心电、脉氧、呼吸等）、快速血糖自动测定仪、常用急救设备
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.9" itemName="专业基地设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.9" itemName="专业基地设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:53px;">
            <td rowspan="3">1.2协同单位（科室）</td>
            <td>1.2.1协同数</td>
            <td>协同数量不应超过3个</td>
            <td rowspan="3">查看原始资料，核实相关信息</td>
            <td>满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
            <td style="text-align: center;">1</td>
        ...
        <tr style="height:53px;">
            <td>1.2.2协同床位数</td>
            <td>
                各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准》精神科细则要求)
            </td>
            <td>
            ...
            <td>
               ...
               <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="协同床位数" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td style="height: 338px;" rowspan="7">2.师资条件<br>（17分）</td>
            ...
            <td><input onchange="saveScore(this,3);" itemId="2022-2.1.1" itemName="师资情况" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,3);" itemId="2022-2.1.1" itemName="师资情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            <td>2.1.2带教医师条件</td>
            <td>
                医学本科及以上学历,主治医师专业技术职务3年以上，精神科临床工作≥5年
            </td>
        ...
        <tr style="height:53px;">
            <td>2.1.3带教医师组成</td>
            <td>
                主任医师:副主任医师:主治医师=1:2:4；综合医院精神科至少有1名主任医师；专科医院有2名以上主任医师，心理治疗在内的≥2个成熟亚专业
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
        ...
        <tr style="height:53px;">
            ...
            <td>
                医学本科及以上学历,主任医师专业技术职务,从事精神科专业医疗、科研和教学工作≥15年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-3.1.2" itemName="教学主任" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-3.1.2" itemName="教学主任" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
               ...
               <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.1" itemName="教学主任" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
                              class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-1.1.1']}</textarea>
                </c:if>
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>查看考勤规章制度，抽查2～3名培训对象考勤记录原始资料</td>
            <td>
                有，且严格落实，得满分<br>
                未严格落实，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td rowspan="2">提供本年度原始资料，访谈培训对象，核实落实情况</td>
            <td>
                开展次数达标，且认真规范，得满分<br>
                未达标或不规范，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>管床数均达到要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','4','管床数≥规定数的80%，得2分')"/>
                    &nbsp;<label>管床数≥规定数的80%，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','4','管床数≥规定数的60%，得1分')"/>
                    &nbsp;<label>管床数≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','4','管床数＜规定数60%或未安排，不得分')"/>
                    &nbsp;<label>管床数＜规定数60%或未安排，不得分</label><br>
                </c:if>
               <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.1" value="4" onchange="selectRadio('2022-3.4.1','4','expert','4','')"/>
                    &nbsp;<label>管床数均达到要求，得满分</label><br>
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','expert','4','管床数≥规定数的80%，得2分')"/>
                    &nbsp;<label>管床数≥规定数的80%，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','4','管床数≥规定数的60%，得1分')"/>
                    &nbsp;<label>管床数≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','4','管床数＜规定数60%或未安排，不得分')"/>
                    &nbsp;<label>管床数＜规定数60%或未安排，不得分</label><br>
                </c:if>
               <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            ...
            <td>4.1.1教学查房质量★</td>
            <td>
                主任或带教医师组织开展规范的教学查房，悉心指导培训对象
            </td>
            <td>随机抽查1～2名带教医师教学查房</td>
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0500_02','附表2');">附表2</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，，＜60分不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.1.1" itemName="教学查房质量"></td>
            <td><input id="fubiao2" onchange="saveScore(this,4);" itemId="2022-4.1.1" itemName="教学查房质量" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.1" itemName="教学查房质量"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.1" itemName="教学查房质量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.1.1']}</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td>4.1.2技能操作和手术完成情况★</td>
            <td>
            ...
            <td><input onchange="saveScore(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,8);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0500_03','附表3');">附表3</a>
                <br>
                ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.2.1" itemName="病历书写"></td>
            <td><input id="fubiao3" onchange="saveScore(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.2.1" itemName="病历书写"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0500_04','附表4');">附表4</a>
                <br>
                ≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分
            </td>
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-4.2.2" itemName="技能操作"></td>
            <td><input id="fubiao4" onchange="saveScore(this,8);" itemId="2022-4.2.2" itemName="技能操作" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao4Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.2.2" itemName="技能操作"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                随机抽查本院、委培、社会招收培训对象各2～3名，进行现场理论考核
            </td>
            <td>
                ≥90分，得满分<br>
                ≥80分，得5分<br>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,6);" itemId="2022-4.2.3" itemName="现场理论考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,6);" itemId="2022-4.2.3" itemName="现场理论考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.3" value="6" onchange="selectRadio('2022-4.2.3','6','self','6','')"/>
                    &nbsp;<label>≥90分，得满分</label><br>
                    <input type="radio" name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','self','6','≥80分，得5分')"/>
                    &nbsp;<label>≥80分，得5分</label><br>
                    <input type="radio" name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','self','6','≥70分，得3分')"/>
                    &nbsp;<label>≥70分，得3分</label><br>
                    <input type="radio" name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','self','6','＜70分，不得分')"/>
                    &nbsp;<label>＜70分，不得分</label><br>
                </c:if>
               <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.3" value="6" onchange="selectRadio('2022-4.2.3','6','expert','6','')"/>
                    &nbsp;<label>≥90分，得满分</label><br>
                    <input type="radio" name="2022-4.2.3" value="5" onchange="selectRadio('2022-4.2.3','5','expert','6','≥80分，得5分')"/>
                    &nbsp;<label>≥80分，得5分</label><br>
                    <input type="radio" name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','expert','6','≥70分，得3分')"/>
                    &nbsp;<label>≥70分，得3分</label><br>
                    <input type="radio" name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','expert','6','＜70分，不得分')"/>
                    &nbsp;<label>＜70分，不得分</label><br>
                </c:if>
               <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.3" itemName="现场理论考核" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:150px;">
            <td rowspan="2" colspan="3">存在的主要问题<br>（请详细填写）：</td>
