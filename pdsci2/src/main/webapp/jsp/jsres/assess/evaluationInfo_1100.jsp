...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——外科（胸心外科方向）专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:64px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》外科（胸心外科方向）专业细则要求
            </td>
            <td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.7" itemName="疾病种类及数量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.7" itemName="疾病种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.7" value="2" onchange="selectRadio('2022-1.1.7','2','self','2','')"/>
                    &nbsp;<label>符合要求（含协同单位），得满分</label><br>
                    <input type="radio" name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','self','2','疾病种类及数量≥规定数的90%，得1分')"/>
                    &nbsp;<label>疾病种类及数量≥规定数的90%，得1分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0.5" onchange="selectRadio('2022-1.1.7','0.5','self','2','疾病种类及数量≥规定数的85%，得0.5分')"/>
                    &nbsp;<label>疾病种类及数量≥规定数的85%，得0.5分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','self','2','疾病种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label>疾病种类及数量＜规定数的85%，不得分</label>
                </c:if>
               <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.7" value="2" onchange="selectRadio('2022-1.1.7','2','expert','2','')"/>
                    &nbsp;<label>符合要求（含协同单位），得满分</label><br>
                    <input type="radio" name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','expert','2','疾病种类及数量≥规定数的90%，得1分')"/>
                    &nbsp;<label>疾病种类及数量≥规定数的90%，得1分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0.5" onchange="selectRadio('2022-1.1.7','0.5','expert','2','疾病种类及数量≥规定数的85%，得0.5分')"/>
                    &nbsp;<label>疾病种类及数量≥规定数的85%，得0.5分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','expert','2','疾病种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label>疾病种类及数量＜规定数的85%，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:64px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-1.1.8" itemName="技能操作和手术种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.8" value="4" onchange="selectRadio('2022-1.1.8','4','self','4','')"/>
                    &nbsp;<label>符合要求（含协同单位），得满分</label><br>
                    <input type="radio" name="2022-1.1.8" value="2" onchange="selectRadio('2022-1.1.8','2','self','4','技能操作和手术种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label>技能操作和手术种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio" name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','self','4','技能操作和手术种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label>技能操作和手术种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio" name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','self','4','技能操作和手术种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label>技能操作和手术种类及数量＜规定数的85%，不得分</label>
                </c:if>
               <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.8" value="4" onchange="selectRadio('2022-1.1.8','4','expert','4','')"/>
                    &nbsp;<label>符合要求（含协同单位），得满分</label><br>
                    <input type="radio" name="2022-1.1.8" value="2" onchange="selectRadio('2022-1.1.8','2','expert','4','技能操作和手术种类及数量≥规定数的90%，得2分')"/>
                    &nbsp;<label>技能操作和手术种类及数量≥规定数的90%，得2分</label><br>
                    <input type="radio" name="2022-1.1.8" value="1" onchange="selectRadio('2022-1.1.8','1','expert','4','技能操作和手术种类及数量≥规定数的85%，得1分')"/>
                    &nbsp;<label>技能操作和手术种类及数量≥规定数的85%，得1分</label><br>
                    <input type="radio" name="2022-1.1.8" value="0" onchange="selectRadio('2022-1.1.8','0','expert','4','技能操作和手术种类及数量＜规定数的85%，不得分')"/>
                    &nbsp;<label>技能操作和手术种类及数量＜规定数的85%，不得分</label>
                </c:if>
           <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历,主治医师专业技术职务3年以上，从事胸心外科专业工作5年以上
            </td>
            <td rowspan="3">
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事胸心外科专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1100_01','附表1');">附表1</a>
                <br>
            ...
            <td><input id="fubiao1" onchange="saveScore(this,6);" itemId="2022-4.1.1" itemName="查房质量" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao1Expert" onchange="saveScore4Expert(this,6);" itemId="2022-4.1.1" itemName="查房质量"
        ...
        <tr style="height:48px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术安排情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
        ...
        <tr style="height:48px;">
            ...
            <td><input onchange="saveScore(this,5);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,5);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.3" itemName="技能操作和手术带教情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1100_02','附表2');">附表2</a>
                <br>
            ...
            <td><input id="fubiao2" onchange="saveScore(this,5);" itemId="2022-4.2.1" itemName="病历书写" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao2Expert" onchange="saveScore4Expert(this,5);" itemId="2022-4.2.1" itemName="病历书写"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_1100_03','附表3');">附表3</a>
                <br>
            ...
            <td><input id="fubiao3" onchange="saveScore(this,7);" itemId="2022-4.2.2" itemName="技能操作和手术" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4Expert(this,7);" itemId="2022-4.2.2" itemName="技能操作和手术"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：<br>
                &#12288;&#12288;1.一级指标4项，二级指标10项，三级指标37项。三级指标中，核心指标15项、计68分，一般指标22项、计32分，共100分。<br>
