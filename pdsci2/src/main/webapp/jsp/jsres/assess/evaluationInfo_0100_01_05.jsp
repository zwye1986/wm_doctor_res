...
<head>
    ...
    <script type="text/javascript">
        ...
        function subInfo() {
            ...
            selfOneScore = parseInt(selfOneScore / 260 * 100);
            selfTwoScore = parseInt(selfTwoScore / 120 * 100);
...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="6">
                <h2 style="font-size:150%">内科(血液内科)疾病种类/临床技能操作</h2>
            </th>
        </tr>
        ...
        <tr style="height:32px">
            <th rowspan="16">疾病种类</th>
            <th>缺铁性贫血(包括门诊)</th>
            <th colspan="2">≥80</th>
            <td>
                <input onchange="saveScore(this,80);" itemId="0100-05-1.1" itemName="k缺铁性贫血(包括门诊)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.1" itemName="d缺铁性贫血(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
        ...
        <tr style="height:32px">
            ...
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-05-1.2" itemName="k再生障碍性贫血" name="self1"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.2" itemName="d再生障碍性贫血" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0100-05-1.3" itemName="k特发性血小板减少性紫癜" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.3" itemName="d特发性血小板减少性紫癜" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥50</th>
            <td>
                <input onchange="saveScore(this,50);" itemId="0100-05-1.4" itemName="k急性白血病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.4" itemName="d急性白血病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-05-1.5" itemName="k淋巴瘤" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.5" itemName="d淋巴瘤" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥30</th>
            <td>
                <input onchange="saveScore(this,30);" itemId="0100-05-1.6" itemName="k巨幼细胞贫血(包括门诊)" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.6" itemName="d巨幼细胞贫血(包括门诊)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥6</th>
            <td>
                <input onchange="saveScore(this,6);" itemId="0100-05-1.7" itemName="k溶血性贫血" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.7" itemName="d溶血性贫血" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥12</th>
            <td>
                <input onchange="saveScore(this,12);" itemId="0100-05-1.8" itemName="k白细胞减少及粒细胞缺乏症" name="self1"
                       class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.8" itemName="d白细胞减少及粒细胞缺乏症" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0100-05-1.9" itemName="k慢性白血病" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.9" itemName="d慢性白血病" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="0100-05-1.10" itemName="k过敏性紫癜" name="self1" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.10" itemName="d过敏性紫癜" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">≥12</th>
            <td>
                <input onchange="saveScore(this,12);" itemId="0100-05-1.11" itemName="k多发性骨髓瘤" name="self1"
                       class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-1.11" itemName="d多发性骨髓瘤" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-05-1.12','k弥散性血管内凝血(DIC)');" itemId="0100-05-1.12"
                        itemName="k弥散性血管内凝血(DIC)"
            ...
            <td>
                <input itemId="0100-05-1.12" itemName="d弥散性血管内凝血(DIC)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-05-1.13','k凝血功能障碍性疾病');" itemId="0100-05-1.13"
                        itemName="k凝血功能障碍性疾病"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
            ...
            <td>
                <input itemId="0100-05-1.13" itemName="d凝血功能障碍性疾病" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-05-1.14','k骨髓增生异常综合征(MDS)');" itemId="0100-05-1.14"
                        itemName="k骨髓增生异常综合征(MDS)"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
                    <option value="无" style="text-align: center">无</option>
            ...
            <td>
                <input itemId="0100-05-1.14" itemName="d骨髓增生异常综合征(MDS)" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-05-1.15','k先天性凝血因子缺乏症');" itemId="0100-05-1.15"
                        itemName="k先天性凝血因子缺乏症"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
                    <option value="无" style="text-align: center">无</option>
            ...
            <td>
                <input itemId="0100-05-1.15" itemName="d先天性凝血因子缺乏症" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>骨髓增生性疾病(真性红细胞增多症、原发性骨髓纤维化、原发性血小板增多症)</th>
            <th colspan="2">有</th>
            <td>
                <select onchange="saveSelect(this,'0100-05-1.16','k骨髓增生性疾病');" itemId="0100-05-1.16" itemName="k骨髓增生性疾病"
                        name="self1" style="width: 160px;margin-left: 6px;">
                    <option value="" style="text-align: center">请选择</option>
                    <option value="有" style="text-align: center">有</option>
                    <option value="无" style="text-align: center">无</option>
            ...
            <td>
                <input itemId="0100-05-1.16" itemName="d骨髓增生性疾病" name="less" class="input" type="text"
                       readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">100</th>
            <td>
                <input onchange="saveScore(this,100);" itemId="0100-05-2.1" itemName="k骨髓穿刺" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-2.1" itemName="d骨髓穿刺" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th colspan="2">20</th>
            <td>
                <input onchange="saveScore(this,20);" itemId="0100-05-2.2" itemName="k骨髓活检术" name="self2" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input itemId="0100-05-2.2" itemName="d骨髓活检术" name="less" class="input" type="text" readonly="readonly"
                       style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
