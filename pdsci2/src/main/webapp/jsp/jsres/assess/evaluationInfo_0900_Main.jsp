    ...
    <div class="title_tab" id="toptab">
        <ul>
            <li class="tab" id="1A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_01','1A');">附表1</a>
            </li>
            <li class="tab" id="2A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_02','2A');">附表2</a>
            </li>
            <li class="tab" id="3A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_03','3A');">附表3</a>
            </li>
            <li class="tab" id="4A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_04','4A');">附表4</a>
            </li>
            <li class="tab" id="5A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_05','5A');">附表5</a>
            </li>
            <li class="tab" id="6A" style="cursor: pointer;">
                <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0900_01_06','6A');">附表6</a>
            </li>
        </ul>
    </div>
</div>
