...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——神经内科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:32px;">
            ...
            <td>
                应具备相关科室15个以上，包括神经外科、呼吸科、心血管内科、内分泌科、康复科、儿科、皮肤科、医学影像科、病理科、检验科等
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                缺1个科室，不得分
        ...
        <tr style="height:32px;">
            ...
            <td>
                神经内科、神经内科ICU或急诊室、心血管内科、呼吸内科、内分泌科、神经外科、医学影像科、神经电生理室、神经病理科
            </td>
            <td>
                1.查看各亚专业（专科）设置名称<br>
        ...
        <tr style="height:64px">
            ...
            <td rowspan="2">
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》神经内科专业基地细则的要求。
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_01','附表1');">附表1</a>
            </td>
            <td>
        ...
        <tr style="height:64px;">
            <td style="height: 32px;">1.1.8临床技能操作种类及数量★</td>
            <td>
        ...
        <tr style="height:50px;">
            ...
            <td>
                X射线机、CT、MRI、全自动血液生化分析仪、血气分析仪、PCR仪、快速血糖自动测定仪、便携式B超机、便携式X射线机、12导联心电图记录仪、生命体征监护仪(无创血压、心电、脉氧、呼吸等)、呼吸机、除颤起搏器、中心供氧接口、中心吸引接口或电动吸引器
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_02','附件2');">附件2</a>
        ...
        <tr style="height:38px;">
            ...
            <td>
                各亚专业（专科）师资队伍的正高、副高及中级专业技术职务人员比例应为1：2：4
            </td>
            <td>
                1个亚专业（专科）不达标，不得分
            </td>
        ...
        <tr style="height:38px;">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事神经内科专业的医疗、科研和教学工作超过15年
            </td>
            <td>
                1项不符合条件，不得分
            </td>
        ...
        <tr style="height:35px;">
            ...
            <td>2.2.1师资培训★</td>
            <td>
                带教医师均参加过院级师资培训 轮转科室至少1名带教医师参加过省级及以上师资培训
            </td>
            <td>
                查看培训资料、名单和培训证书
            </td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_03','附表3');">附表3</a>
                <br>
            ...
            <td><input id="fubiao3" onchange="saveScore(this,4);" itemId="2022-4.1.1" itemName="教学查房质量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao3Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.1" itemName="教学查房质量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                ...
                为每名培训对象安排并完成规定的技能操作（见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_01','附件1');">附件1</a>
                ）
            </td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作
            </td>
            <td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                病历书写评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_04','附表4');">附表4</a>
                <br>
                ≥90分得满分，<br>≥80分得3分，<br>≥70分得2分<br>
                ≥60分得1分，<br>＜60分不得分
            </td>
            <td style="text-align: center;">4</td>
        ...
        <tr style="height:48px;">
            ...
            <td>
                技能操作评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0600_05','附表5');">附表5</a>
                <br>
                ≥90分得满分，<br>≥80分得5分，<br>≥70分得3分<br>
                ≥60分得1分，<br>＜60分不得分
            </td>
            <td style="text-align: center;">8</td>
            <td name="file" itemId="2022-4.2.2" itemName="技能操作"></td>
            <td><input id="fubiao5" onchange="saveScore(this,8);" itemId="2022-4.2.2" itemName="技能操作" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao5Expert" onchange="saveScore4Expert(this,8);" itemId="2022-4.2.2" itemName="技能操作"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
