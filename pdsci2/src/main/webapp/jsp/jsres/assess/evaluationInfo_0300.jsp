...
<div id="tableContext" style="overflow-y: auto;margin-left: 10px;margin-right: 10px;height: 750px;" onscroll="tableFixed(this);">
    <div id="dateFixed" style="height: 0px;overflow: visible;position: relative;">
        <table class="grid" style="width: 100%;" >
            <tr height="34" class="firstRow">
                <th colspan="11">
                    <h2 style="font-size:150%">住院医师规范化培训评估指标——急诊科专业基地</h2>
                </th>
            </tr>
            <tr height="28">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="grid" style="width: 100%" >
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.1" itemName="总床位数" name="expert"
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-1.1.1" value="0" onchange="selectRadio('2022-1.1.1','0','self','2','不达标准，不得分')"/>
        ...
        <tr style="height:53px;">
            <td style="height:53px;">1.1.2抢救室年收治病人数</td>
            <td>≥2000人次</td>
            <td rowspan="3">
                检查相关统计报表复印件，需加盖医院公章
            </td>
            ...
            <td name="file" itemId="2022-1.1.2" itemName="抢救室年收治病人数"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="抢救室年收治病人数" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.2" itemName="抢救室年收治病人数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.2" itemName="抢救室年收治病人数" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td style="height:53px;">1.1.3EICU、留观和病房年收治病人数</td>
            <td>≥4000人次，其中EICU≥100人次</td>
            <td>
                符合标准，得2分<br>
                1项不达标准，扣1分，扣完为止<br>
                多项不达标准，不得分
            ...
            <td name="file" itemId="2022-1.1.3" itemName="EICU、留观和病房年收治病人数"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="EICU、留观和病房年收治病人数" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.3" itemName="EICU、留观和病房年收治病人数"
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>符合标准，得2分</label><br>
                    <input type="radio" name="2022-1.1.3" value="1" onchange="selectRadio('2022-1.1.3','1','self','2','1项不达标准，扣1分')"/>
                    &nbsp;<label>1项不达标准，得1分</label><br>
                    <input type="radio" name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','self','2','多项不达标准，不得分')"/>
                    &nbsp;<label>多项不达标准，不得分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input  type="radio" name="2022-1.1.3" value="2" onchange="selectRadio('2022-1.1.3','2','expert','2','')"/>
                    &nbsp;<label>符合标准，得2分</label><br>
                    <input  type="radio" name="2022-1.1.3" value="1" onchange="selectRadio('2022-1.1.3','1','expert','2','1项不达标准，扣1分')"/>
                    &nbsp;<label>1项不达标准，得1分</label><br>
                    <input  type="radio" name="2022-1.1.3" value="0" onchange="selectRadio('2022-1.1.3','0','expert','2','多项不达标准，不得分')"/>
                    &nbsp;<label>多项不达标准，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.3" itemName="EICU、留观和病房年收治病人数" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="年急诊量" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-1.1.4" itemName="年急诊量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.4" value="2" onchange="selectRadio('2022-1.1.4','2','self','2','')"/>
                    &nbsp;<label>符合标准，得2分</label><br>
                    <input type="radio" name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','self','2','不达标准，但≥4万人次，得1分')"/>
                    &nbsp;<label>不达标准，但≥4万人次，得1分</label><br>
                    <input type="radio" name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','self','2','小于4万人次，不得分')"/>
                    &nbsp;<label>小于4万人次，不得分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input  type="radio" name="2022-1.1.4" value="2" onchange="selectRadio('2022-1.1.4','2','expert','2','')"/>
                    &nbsp;<label>符合标准，得2分</label><br>
                    <input  type="radio" name="2022-1.1.4" value="1" onchange="selectRadio('2022-1.1.4','1','expert','2','不达标准，但≥4万人次，得1分')"/>
                    &nbsp;<label>不达标准，但≥4万人次，得1分</label><br>
                    <input  type="radio" name="2022-1.1.4" value="0" onchange="selectRadio('2022-1.1.4','0','expert','2','小于4万人次，不得分')"/>
                    &nbsp;<label>小于4万人次，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:53px;">
            <td>1.1.5科室和实验室</td>
            <td>
                必备科室:预诊台、诊室（成人诊室、小儿诊室、综合诊室及特殊病人如精神病、囚犯等诊室）、抢救室、输液室、清创室、处置室、急诊病房或观察室、急诊重症监护室、急诊手术室或急诊专用手术间；急诊辅助科室（24小时不间断开诊的急诊药房、急诊检验科、急诊影像科）
            </td>
            <td>查看相关文件，实地考查</td>
            <td>
                必备科室缺1个科室，不得分<br>
        ...
        <tr style="height:53px;">
            <td>1.1.6轮转科室</td>
            <td>
                呼吸内科、心血管内科、神经内科、消化内科、其他内科（血液、内分泌、肾脏内科）、麻醉科、综合ICU、普通外科（腹部外科为主）、骨科、神经外科、心胸外科、妇产科急诊、急诊科（含EICU)、感染科、影像科、超声科、心电图室、儿科（可自选）、皮肤科门诊（可自选）
            </td>
            <td>查看各(亚)专业设置名称
                查看培训对象轮转计划和登记手册
                实地考查，访谈培训对象
        ...
        <tr style="height:53px;">
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.7" itemName="教学设施和设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="教学设施和设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.7" itemName="教学设施和设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','self','1','')"/>
                    &nbsp;<label>有示教室且设备完善，得1分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','self','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label>无示教室或有示教室无设备，不得分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.7" value="1" onchange="selectRadio('2022-1.1.7','1','expert','1','')"/>
                    &nbsp;<label>有示教室且设备完善，得1分</label><br>
                    <input type="radio" name="2022-1.1.7" value="0" onchange="selectRadio('2022-1.1.7','0','expert','1','无示教室或有示教室无设备，不得分')"/>
                    &nbsp;<label>无示教室或有示教室无设备，不得分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.7" itemName="教学设施和设备" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.8疾病种类及数量★</td>
            <td>
                符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》急诊科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_01','附件1');">附件1</a>
            </td>
            ...
            <td><input id="fubiao11" onchange="saveScore(this,2);" itemId="2022-1.1.8" itemName="教学设施和设备" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao11Expert" onchange="saveScore4Expert(this,2);" itemId="2022-1.1.8" itemName="教学设施和设备"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:53px;">
            <td>1.1.9临床技能操作或手术种类及数量★</td>
            <td>符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》急诊科专业细则要求，详见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_01','附件1（1）');">附件1（1）</a>
            </td>
            <td>核对上一年度各亚专业（专科）临床技能操作或手术种类和数量的统计报表</td>
            <td>
                符合要求（含协同单位），得2分<br>
                技能操作种类及数量≥规定数的90%，得1分<br>
                技能操作种类及数量≥规定数的85%，得0.5分<br>
                技能操作种类及数量＜规定数85%，不得分
            </td>
            <td style="text-align: center;">2</td>
            <td name="file" itemId="2022-1.1.9" itemName="临床技能操作种类及数量"></td>
            <td><input id="fubiao12" onchange="saveScore(this,2);" itemId="2022-1.1.9" itemName="临床技能操作种类及数量"
                       name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao12Expert" onchange="saveScore4Expert(this,2);" itemId="2022-1.1.9"
                       itemName="临床技能操作种类及数量" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.9" itemName="临床技能操作种类及数量" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.10医院设备</td>
            <td>
                大型X射线机、数字血管造影设备、CT、核磁共振、放射治疗机、彩色多普勒超声
            </td>
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.10" itemName="医院设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="医院设备" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.1.10" itemName="医院设备" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-1.1.10" value="1" onchange="selectRadio('2022-1.1.10','1','self','1','')"/>
                    &nbsp;<label>符合要求，得1分</label><br>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.10" itemName="医院设备" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.1.11专业基地设备</td>
            <td>
                符合《住院医师规范化培训基地认定标准（试行）》急诊科专业细则要求，详见

                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_02','附件2');">附件2</a>
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.1.11" itemName="专业基地设备"></td>
            <td><input id="fubiao21" onchange="saveScore(this,1);" itemId="2022-1.1.11" itemName="专业基地设备" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td width="74px"><input id="fubiao21Expert" onchange="saveScore4Expert(this,1);" itemId="2022-1.1.11" itemName="专业基地设备"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-1.1.11" itemName="专业基地设备" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:53px;">
            <td>1.2协同单位</td>
            <td>
                1.2.1未承担院前急救的专业基地可以协同120急救中心
            </td>
            <td>符合《住院医师规范化培训基地认定标准（试行）》本专业细则要求，轮转时间0.5个月</td>
            <td>查看原始资料，核实相关信息</td>
            <td>
            ...
            <td style="text-align: center;">1</td>
            <td name="file" itemId="2022-1.2.1" itemName="专业基地设备"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,1);" itemId="2022-1.2.1" itemName="未承担院前急救的专业基地可以协同120急救中心" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,1);" itemId="2022-1.2.1" itemName="未承担院前急救的专业基地可以协同120急救中心"
                       name="expert" class="input" type="text" style="height:20px;width: 25px; text-align: center"/>
            </td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-1.2.1" itemName="未承担院前急救的专业基地可以协同120急救中心"
        ...
        <tr style="height:50px">
            <td rowspan="5">2.2师资建设</td>
            <td>2.1.3带教医师组成</td>
            <td>
                各亚专业（专科）应由主任医师或副主任医师担任各科室或病区主任或副主任。科室内具有中、高级专业技术职务人数应占科室总医师数比例≥60%，所有医师最低学历为医学本科
            </td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                医学本科及以上学历，主任医师专业技术职务，从事急诊科专业的医疗、科研和教学工作超过15年
            </td>
            <td></td>
            <td>
                符合条件，得满分<br>
        ...
        <tr style="height:50px">
            <td>2.2.1师资培训★</td>
            <td>
                带教医师均参加过院级师资培训，且有50%以上师资参加过省级及以上本专业师资培训，培训证书3年有效
            </td>
        ...
        <tr style="height:50px">
            <td>2.2.2师资评价★</td>
            <td>
                对师资进行实时多维度评价，每年至少组织1次对带教医师教学工作综合评价
            </td>
            <td>查看原始资料，访谈带教医师和培训对象</td>
            <td>
                有评价方案，有原始记录，有数据分析和反馈，改进措施，效果分析等，体现PDCA，得4分<br>
                有评价记录，有方案和原始记录，未体现PDCA，得2分<br>
                仅有方案或记录，得1分
            </td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有评价方案，有原始记录，有数据分析和反馈，改进措施，效果分析等，体现PDCA，得4分</label><br>
                    <input type="radio" name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','self','4','有评价记录，有方案和原始记录，未体现PDCA，得2分')"/>
                    &nbsp;<label>有评价记录，有方案和原始记录，未体现PDCA，得2分</label><br>
                    <input type="radio" name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','self','4','仅有方案或记录，得1分')"/>
                    &nbsp;<label>仅有方案或记录，得1分</label>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-2.2.2" value="4" onchange="selectRadio('2022-2.2.2','4','expert','4','')"/>
                    &nbsp;<label>有评价方案，有原始记录，有数据分析和反馈，改进措施，效果分析等，体现PDCA，得4分</label><br>
                    <input type="radio" name="2022-2.2.2" value="2" onchange="selectRadio('2022-2.2.2','2','expert','4','有评价记录，有方案和原始记录，未体现PDCA，得2分')"/>
                    &nbsp;<label>有评价记录，有方案和原始记录，未体现PDCA，得2分</label><br>
                    <input type="radio" name="2022-2.2.2" value="1" onchange="selectRadio('2022-2.2.2','1','expert','4','仅有方案或记录，得1分')"/>
                    &nbsp;<label>仅有方案或记录，得1分</label>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            <td style="height: 200px;" rowspan="11">3.过程管理<br>（30分）</td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>职责明确，履职认真，落实到位，得1分</label><br>
        ...
        <tr style="height:50px">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>职责明确，履职认真，落实到位，得3分</label><br>
                    <input type="radio" name="2022-3.1.2" value="1" onchange="selectRadio('2022-3.1.2','1','self','3','职责明确，未落实到位，得1分')"/>
                    &nbsp;<label>职责明确，未落实到位，得1分</label><br>
                  ...
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>职责明确，履职认真，落实到位，得3分</label><br>
                    <input type="radio" name="2022-3.1.2" value="1" onchange="selectRadio('2022-3.1.2','1','expert','3','职责明确，未落实到位，得1分')"/>
                    &nbsp;<label>职责明确，未落实到位，得1分</label><br>
        ...
        <tr style="height:50px">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有教学小组，履职认真，落实到位，得2分</label><br>
        ...
        <tr style="height:50px">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有，且严格落实，内容得到不断完善，得2分</label><br>
                    <input type="radio" name="2022-3.2.1" value="1" onchange="selectRadio('2022-3.2.1','1','self','2','能常规落实，但不完善，得1分')"/>
                    &nbsp;<label>能常规落实，但不完善，得1分</label><br>
                  ...
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>有，且严格落实，内容得到不断完善，得2分</label><br>
                    <input type="radio" name="2022-3.2.1" value="1" onchange="selectRadio('2022-3.2.1','1','expert','2','能常规落实，但不完善，得1分')"/>
                    &nbsp;<label>能常规落实，但不完善，得1分</label><br>
        ...
        <tr style="height:50px">
            <td>3.2.3小讲课</td>
            <td>开展规范的小讲课活动，至少2周1次</td>
            <td rowspan="2">提供本年度或上一年度原始资料，访谈培训对象，核实落实情况</td>
            <td>
                开展次数达标，且认真规范，得2分<br>
                不达标或不规范，不得分
            </td>
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-3.2.4" itemName="病例讨论" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    <input type="radio" name="2022-3.3.1" value="3" onchange="selectRadio('2022-3.3.1','3','self','4','考核项目全面，但欠认真规范，得3分')"/>
                    &nbsp;<label>考核项目全面，但欠认真规范，得3分</label><br>
                  ...
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>考核项目全面，且认真规范，得4分</label><br>
                    <input type="radio" name="2022-3.3.1" value="3" onchange="selectRadio('2022-3.3.1','3','expert','4','考核项目全面，但欠认真规范，得3分')"/>
                    &nbsp;<label>考核项目全面，但欠认真规范，得3分</label><br>
        ...
        <tr style="height:50px">
            <td style="height: 200px;" rowspan="2">3.过程管理<br>（30分）</td>
            <td rowspan="2">3.4培训强度</td>
            <td>3.4.1管理病床数★</td>
            <td>
                日管床数（病房）≥3张(在带教医师指导下独立于其他培训对象管理床位)
            </td>
            ...
            <td><input onchange="saveScoreOnlyIntenger(this,2);" itemId="2022-3.4.1" itemName="管理病床数" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,2);" itemId="2022-3.4.1" itemName="管理病床数" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','self','2','')"/>
                    &nbsp;<label>管床数≥3张，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','self','2','管床数≥2张，得1分')"/>
                    &nbsp;<label>管床数≥2张，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','self','2','管床数＜2张，或未安排，不得分')"/>
                    &nbsp;<label>管床数＜2张，或未安排，不得分</label><br>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.1" value="2" onchange="selectRadio('2022-3.4.1','2','expert','2','')"/>
                    &nbsp;<label>管床数≥3张，得2分</label><br>
                    <input type="radio" name="2022-3.4.1" value="1" onchange="selectRadio('2022-3.4.1','1','expert','2','管床数≥2张，得1分')"/>
                    &nbsp;<label>管床数≥2张，得1分</label><br>
                    <input type="radio" name="2022-3.4.1" value="0" onchange="selectRadio('2022-3.4.1','0','expert','2','管床数＜2张，或未安排，不得分')"/>
                    &nbsp;<label>管床数＜2张，或未安排，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            ...
            <td>
                手术例数和急诊量达到要求，得3分<br>
                手术例数和急诊量≥规定数的80%，得2分<br>
                手术例数和急诊量≥规定数的60%，得1分<br>
                ＜规定数60%，或未完成急诊量，不得分
            </td>
            <td style="text-align: center;">3</td>
            ...
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    ...
                    &nbsp;<label>手术例数和急诊量达到要求，得3分</label><br>
                    <input type="radio" name="2022-3.4.2" value="2" onchange="selectRadio('2022-3.4.2','2','self','3','手术例数和急诊量≥规定数的80%，得2分')"/>
                    &nbsp;<label>手术例数和急诊量≥规定数的80%，得2分</label><br>
                    <input type="radio" name="2022-3.4.2" value="1" onchange="selectRadio('2022-3.4.2','1','self','3','手术例数和急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label>手术例数和急诊量≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','self','3','＜规定数60%，或未完成急诊量，不得分')"/>
                    &nbsp;<label>＜规定数60%，或未完成急诊量，不得分</label><br>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-3.4.2" value="3" onchange="selectRadio('2022-3.4.2','3','expert','3','')"/>
                    &nbsp;<label>手术例数和急诊量达到要求，得3分</label><br>
                    <input type="radio" name="2022-3.4.2" value="2" onchange="selectRadio('2022-3.4.2','2','expert','3','手术例数和急诊量≥规定数的80%，得2分')"/>
                    &nbsp;<label>手术例数和急诊量≥规定数的80%，得2分</label><br>
                    <input type="radio" name="2022-3.4.2" value="1" onchange="selectRadio('2022-3.4.2','1','expert','3','手术例数和急诊量≥规定数的60%，得1分')"/>
                    &nbsp;<label>手术例数和急诊量≥规定数的60%，得1分</label><br>
                    <input type="radio" name="2022-3.4.2" value="0" onchange="selectRadio('2022-3.4.2','0','expert','3','＜规定数60%，或未完成急诊量，不得分')"/>
                    &nbsp;<label>＜规定数60%，或未完成急诊量，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
        ...
        <tr style="height:50px">
            <td style="height: 438px;" rowspan="9">4.质量控制<br>（35分）</td>
            <td rowspan="3">4.1带教医师教学质量</td>
            <td>4.1.1教学查房质量★</td>
            <td>
                带教医师组织规范的教学查房，悉心指导培训对象
            </td>
            <td>随机抽查1～2名带教医师教学查房</td>
            <td>
                教学查房评分表见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_03','附表3');">附表3</a>
                <br>
                ≥90分，得6分； <br>
                ≥85分，得5分； <br>
                ≥80分，得4分； <br>
        ...
        <tr style="height:50px">
            ...
            <td>
                每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术（见
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_01','附件1（2）');">附件1（2）</a>
                ）
            </td>
            <td>随机抽查5～10名培训对象，由评估专家根据本专业实际需求确定手术或技能操作项目，查看技能操作或手术记录，掌握实际情况</td>
            <td>
                完成率≥90%，得4分；完成率≥85%，得3分；完成率≥80%，得2分；完成率≥75%，得1分；完成率＜75%，不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.1.2" itemName="技能操作和手术完成情况"></td>
            <td><input id="fubiao13" onchange="saveScore(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao13Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.1.2" itemName="技能操作和手术完成情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                2.培训对象操作中存在问题及时进行指导 1分
                3.培训对象操作结束后是否进行提问 1分
                4.对培训对象的操作的总体评价（优、缺点点评）2分
            </td>
            <td style="text-align: center;">5</td>
            <td name="file" itemId="2022-4.1.3" itemName="技能操作或手术带教情况"></td>
            <td><input onchange="saveScore(this,5);" itemId="2022-4.1.3" itemName="技能操作或手术带教情况" name="self"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,5);" itemId="2022-4.1.3" itemName="技能操作或手术带教情况" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.1.3" itemName="技能操作或手术带教情况" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                病历书写评分表见
                    ...
                    <a href="javascript:void(0)" onclick="Schedule('evaluationInfo_0300_04_02','附表4-2');">附表4-2</a>
                ≥90分，得4分；≥80分，得3分；≥70分，得2分；≥60分，得1分；＜60分，不得分
            </td>
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.2.1" itemName="病历书写"></td>
            <td><input id="fubiao42" onchange="saveScore(this,4);" itemId="2022-4.2.1" itemName="病历书写" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao42Expert" onchange="saveScore4Expert(this,4);" itemId="2022-4.2.1" itemName="病历书写"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            ...
            <td>随机抽查1～2名二年级及以上培训对象进行技能操作或常见手术操作（术者、助手），查看其掌握情况
            <td>
                技能操作评分表见
                <a href="javascript:void(0)"
                   onclick="scheduleMany('evaluationInfo_0300_Main','附表5-1-5-4');">附表5-1-5-4</a>

                <br>
                ≥90分，得6分；<br>
                ≥85分，得5分；<br>≥80分，得4分；<br>≥75分，得3分；<br>≥70分，得2分；<br>≥60分，得1分；<br>＜60分，不得分
            </td>
            <td style="text-align: center;">6</td>
            <input type="hidden" id="scoreInfo1" value="${scoreInfo1}">
            <input type="hidden" id="scoreInfo2" value="${scoreInfo2}">
            <input type="hidden" id="scoreInfo3" value="${scoreInfo3}">
            <input type="hidden" id="scoreInfo4" value="${scoreInfo4}">
            <td name="file" itemId="2022-4.2.2" itemName="技能操作或手术"></td>
            <td><input id="fubiao5" onchange="saveScore(this,6);" itemId="2022-4.2.2" itemName="技能操作或手术" name="self"
                       class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input id="fubiao5Expert" onchange="saveScore4Expert(this,6);" itemId="2022-4.2.2" itemName="技能操作或手术"
                       name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
        ...
        <tr style="height:50px">
            <td>4.2.3现场临床能力考核★</td>
            <td>培训对象影像学阅片、心电图判读和临床思维能力考核</td>
            <td>
                随机考核3名本专业各年级培训对象，查看其掌握情况
            </td>
            <td>
                优秀，得4分；<br>
                良好，得3分；<br>
            ...
            <td style="text-align: center;">4</td>
            <td name="file" itemId="2022-4.2.3" itemName="现场临床能力考核"></td>
            <td><input onchange="saveScoreOnlyIntenger(this,4);" itemId="2022-4.2.3" itemName="现场临床能力考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4ExpertOnlyIntenger(this,4);" itemId="2022-4.2.3" itemName="现场临床能力考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <c:if test="${(roleFlag eq GlobalConstant.USER_LIST_LOCAL or roleFlag eq 'baseExpert')and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.3" value="4" onchange="selectRadio('2022-4.2.3','4','self','4','')"/>
                    &nbsp;<label>优秀，得4分</label><br>
                    <input type="radio" name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','self','4','良好，得3分')"/>
                    &nbsp;<label>良好，得3分</label><br>
                    <input type="radio" name="2022-4.2.3" value="2" onchange="selectRadio('2022-4.2.3','2','self','4','一般，得2分')"/>
                    &nbsp;<label>一般，得2分</label><br>
                    <input type="radio" name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','self','4','差，不得分')"/>
                    &nbsp;<label>差，不得分</label><br>
                </c:if>
                  <c:if test="${roleFlag eq 'expertLeader' and isRead ne 'Y'}">
                    <input type="radio" name="2022-4.2.3" value="4" onchange="selectRadio('2022-4.2.3','4','expert','4','')"/>
                    &nbsp;<label>优秀，得4分</label><br>
                    <input type="radio" name="2022-4.2.3" value="3" onchange="selectRadio('2022-4.2.3','3','expert','4','良好，得3分')"/>
                    &nbsp;<label>良好，得3分</label><br>
                    <input type="radio" name="2022-4.2.3" value="2" onchange="selectRadio('2022-4.2.3','2','expert','4','一般，得2分')"/>
                    &nbsp;<label>一般，得2分</label><br>
                    <input type="radio" name="2022-4.2.3" value="0" onchange="selectRadio('2022-4.2.3','0','expert','4','差，不得分')"/>
                    &nbsp;<label>差，不得分</label><br>
                </c:if>
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.3" itemName="现场临床能力考核" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore(this,2);" itemId="2022-4.2.4" itemName="执业医师资格考试" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,2);" itemId="2022-4.2.4" itemName="执业医师资格考试" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.4" itemName="执业医师资格考试" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td><input onchange="saveScore(this,2);" itemId="2022-4.2.5" itemName="结业考核" name="self" class="input"
                       type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td><input onchange="saveScore4Expert(this,2);" itemId="2022-4.2.5" itemName="结业考核" name="expert"
                       class="input" type="text" style="height:20px;width: 25px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.5" itemName="结业考核" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
        ...
        <tr style="height:50px">
            ...
            <td>
                ...
                <c:if test="${roleFlag ne 'baseExpert' and roleFlag ne 'expertLeader' and roleFlag ne GlobalConstant.USER_LIST_LOCAL or
                ((roleFlag eq 'expertLeader'or roleFlag eq 'baseExpert' or roleFlag eq GlobalConstant.USER_LIST_LOCAL) and isRead eq 'Y')}">
                    <textarea onchange="saveSpeReason(this);" itemId="2022-4.2.6" itemName="年度业务水平测试" name="reason"
                              placeholder="请填写扣分原因" style="width: 98%"
                              class="text-input validate[required,maxSize[1000]]">${deductionMap['2022-4.2.6']}</textarea>
                </c:if>
            </td>
        </tr>
        ...
        <tr style="height:150px;">
            <td rowspan="2" colspan="3">存在的主要问题（请详细填写）：</td>
        ...
        <tr>
            <td colspan="11" style="text-align: left">
                备注：
                1.一级指标4项，二级指标10项，三级指标41项。三级指标中，核心指标17项、计62分，共100分。<br>
