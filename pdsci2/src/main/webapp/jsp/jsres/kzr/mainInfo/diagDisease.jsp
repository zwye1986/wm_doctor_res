...
<form id='BaseInfoForm' style="position:relative;">
	...
	<input type="hidden" name="flag" value="${GlobalConstant.DIAG_DISEASE}"/>
	<div class="main_bd"
		...
		<div class="div_table">
			...
			<c:if test="${viewFlag ne 'Y'}">
				<img src="<s:url value='/jsp/res/images/test.png'/>" onclick="editInfo('DiagDisease','${deptFlow}');"
...
<%--<c:if test="${viewFlag ne 'Y'}">
	<div class="btn_info">
		<input type="button" class="btn_green"  value="编&#12288;辑"onclick="editInfo('DiagDisease','${deptFlow}');"></input>
	</div>
</c:if>--%>
</form>
