...
<div <c:if test="${isglobal eq 'Y'}"> style="position: relative;overflow-y: auto;height: 600px" </c:if> >
    <form id='BaseInfoForm' style="position:relative;">
        ...
        <div class="main_bd"  <c:if test="${isJoin eq 'Y'}"> style="position: relative;overflow-y: auto;" </c:if>  >
            <div class="div_table">
                <h4>培训对象医疗工作量</h4>
