...
<script type="text/javascript">
   ...
   <form id='BaseInfoForm' style="position:relative;">
	   ...
	   <div class="main_bd"
		   ...
		   <c:if test="${isJoin eq 'Y'}"> style="position: relative;overflow-y: auto;height: 610px" </c:if>  >
			<div class="div_table">
				<h4>科室负责人情况</h4>
				<table border="0" cellspacing="0" cellpadding="0" class="base_info">
					...
					<tbody>
						<tr>
							...
							<td><input type="text"  class="input validate[required]"  name="departmentHeadForm.userName"
									   style="width:100px;" value="${departmentHeadForm.userName}"/></td>
							<th>
							...
							<td><input type="text"  class='input validate[required,custom[integer],min[0]]'style="width:100px;"
									   name="departmentHeadForm.userAge"  value="${departmentHeadForm.userAge}"/></td>
							<th>
								<span style="color: red">*</span>&nbsp;学历：
							</th>
							<td><input type="text"  class="input validate[required]" style="width:100px;"
									   name="departmentHeadForm.xl"  value="${departmentHeadForm.xl}"/></td>
						</tr>
						<tr>
							<th>
								<span style="color: red">*</span>&nbsp;学位：
							</th>
							<td><input type="text"  class="input validate[required]"  name="departmentHeadForm.xw"
									   style="width:100px;" value="${departmentHeadForm.xw}"/></td>
							<th>
								<span style="color: red">*</span>&nbsp;职称：
							</th>
							<td><input type="text"  class="input validate[required]" style="width:100px;"
									   name="departmentHeadForm.zc"  value="${departmentHeadForm.zc}"/></td>
							<th>
								<span style="color: red">*</span>&nbsp;职务：
							</th>
							<td colspan="3">
								<input type="text" class="input validate[required]" style="width:100px;"
									   name="departmentHeadForm.zw"  value="${departmentHeadForm.zw}"/>
							</td>
						</tr>
						<tr>
							<th>导师情况：</th>
