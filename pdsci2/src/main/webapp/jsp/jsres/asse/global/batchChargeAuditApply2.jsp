...
function  applyAudit()
{
	...
	jboxConfirm("确认审核？" , function(){
		jboxStartLoading();
		jboxPost("<s:url value='/jsres/asseGlobal/batchChargeSaveAuditList'/>?"+applyFlows,
				$("#myform").serialize(),
				function(resp){
					top.jboxEndLoading();
					endloadIng();
...
$(function(){
	...
	datas.push(arry);
	var arry ={"id":"我已复核该医师的结业考核资格相关材料原件，以上内容来源于上述材料，内容真实。","text":"我已复核该医师的结业考核资格相关材料原件，以上内容来源于上述材料，内容真实。"};
	datas.push(arry);
