...
<script type="text/javascript">
	...
	{
		var url = "<s:url value='/jsres/asse/showAllInfoMain?isShow=Y&recruitFlow='/>"+recruitFlow+"&applyYear="+applyYear;
					...
					<tr class="fixTrTd">
						...
						<c:if test="${f eq 'Y'}">
							<td style="min-width: 100px;max-width: 100px; " class="by">
								<c:if test="${  doctor.orgFlow eq currentUser.orgFlow and doctor.applyYear eq pdfn:getCurrYear() }">
