...
<c:if test="${param.basic_bootstrap=='true'}">
	<script type="text/javascript" src="<s:url value='/js/bootstrap/js/jquery.2.1.1.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script type="text/javascript" charset="utf-8" src="<s:url value='/js/bootstrap/js/bootstrap.3.3.4.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script type="text/javascript" src="<s:url value='/js/jquery.SuperSlide.2.1.1.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script type="text/javascript" src="<s:url value='/js/common.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>
<c:if test="${param.bootstrapSelect=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/js/bootstrap/css/bootstrap.3.3.4.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	<link rel="stylesheet" type="text/css" href="<s:url value='/css/bootstrap-select/bootstrap-select.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	<script type="text/javascript" charset="utf-8" src="<s:url value='/js/bootstrap/select/bootstrap-select.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>
<c:if test="${param.consult=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jsres/css/consulting.css'/>" />
</c:if>
...
<c:if test="${param.queryFont=='true'}">
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jsres/css/queryFont.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
<c:if test="${param.complete=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jsres/css/register.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"/>
</c:if>
...
<c:if test="${param.impromptu=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/js/impromptu/jquery-impromptu.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	<script type="text/javascript" src="<s:url value='/js/impromptu/jquery-impromptu.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>
...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jsres/css/login.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
...
<c:if test="${param.jquery_datePicker2=='true'}">
	<script type="text/javascript"
			src="<s:url value='/js/DatePicker/WdatePicker.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>

<c:if test="${param.jquery_datePicker3=='true' && param.jquery_datePicker!='true'}">
    <link rel="stylesheet" type="text/css" href="<s:url value='/css/bootstrap.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
    <link rel="stylesheet" type="text/css" href="<s:url value='/css/bootstrap-datetimepicker.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
    <script type="text/javascript" charset="utf-8" src="<s:url value='/js/bootstrap.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
    <script type="text/javascript" charset="utf-8" src="<s:url value='/js/bootstrap-datetimepicker.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
    <script type="text/javascript" charset="utf-8" src="<s:url value='/js/bootstrap-datetimepicker.zh-CN.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>
...
<!-- 加密密码 -->
<c:if test="${param.cryptojs=='true'}">
	<script type="text/javascript"
			src="<s:url value='/js/cryptojs/tripledes.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script type="text/javascript"
			src="<s:url value='/js/cryptojs/mode-ecb.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>

<c:if test="${param.rsasecurity=='true'}">
	<script type="text/javascript"
			src="<s:url value='/js/rsasecurity.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>