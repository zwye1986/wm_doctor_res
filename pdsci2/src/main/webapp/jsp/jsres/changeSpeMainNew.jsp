...
//		return currentdate;
    ...
    function search() {
        ...
        var url = "<s:url value='/jsres/manage/changeSpeMainList'/>";
        ...
        if ("${GlobalConstant.FLAG_Y}" == "${param.viewFlag}") {
            ...
            url = "<s:url value='/jsres/manage/searchChangeSpeNew'/>?viewFlag=${param.viewFlag}";
        }
