...
$(document).ready(function(){
    jboxPostLoad("schDeptDetail","<s:url value='/jsres/asse/recruitDetailData'/>?recruitFlow=${param.recruitFlow}&applyYear=${param.applyYear}",null,true);
});
...
<script type="text/javascript">
	...
	function printDiv(academicFlow) {
		jboxTip("正在准备打印…")
		setTimeout(function () {
			var newstr = $("#schDeptDetail").html();
...
<div class="main_bd" id="div_table_0" >
    <div id="" >
		<div class="search_table" style="text-align: right;">
			<input type="button" class="btn_green" value="打印" name="sincerity" onclick="printDiv();"/>
		</div>
		<div id="schDeptDetail" style="height: 450px;overflow: auto;">
			<%--<div class="search_table">--%>
				<%--<table style="width: 100%">--%>
					<%--<tr>--%>
						<%--<td style="width: 50%;text-align: left;border:0px solid #e7e7eb;"><B>姓名：</B>${sysUser.userName}&#12288;<B>培训专业：</B>${recruit.speName }</td>--%>
					<%--</tr>--%>
				<%--</table>--%>
			<%--</div>--%>
