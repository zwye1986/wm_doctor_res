...
function getDoctorRecruit(recruitFlow, doctorFlow){
	...
	var url = "<s:url value='/jsres/doctor/getDoctorRecruit?doctorStatus=signup&openType=open&auditFlag=${GlobalConstant.FLAG_Y}&recruitFlow='/>"+recruitFlow + "&doctorFlow=" + doctorFlow + "&exType=" + "${param.exType}";
...
function backTrain(doctorFlow){
    var url = "<s:url value='/jsres/doctor/backTrainInfo?currentPage=1&seeFlag=N&isAudio=N&userFlow='/>"+doctorFlow;
    jboxLoad("contentDiv", url, true);
}
</script>
</head>
