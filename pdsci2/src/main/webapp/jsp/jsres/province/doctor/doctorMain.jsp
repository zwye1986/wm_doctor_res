...
function getDoctorRecruit(recruitFlow, doctorFlow, backFlag){
	<c:if test="${GlobalConstant.USER_LIST_LOCAL eq sessionScope.userListScope}" >
		var url = "<s:url value='/jsres/doctor/getDoctorRecruit?studyFlag=${GlobalConstant.FLAG_Y}&isRetrunShow=${param.isRetrunShow}&info=${param.info}&openType=open&recruitFlow='/>"+recruitFlow+"&doctorFlow="+doctorFlow+"&backFlag="+backFlag;
	</c:if>
	<c:if test="${GlobalConstant.USER_LIST_LOCAL ne sessionScope.userListScope}" >
		var url = "<s:url value='/jsres/doctor/getDoctorRecruit?isRetrunShow=${param.isRetrunShow}&info=${param.info}&openType=open&recruitFlow='/>"+recruitFlow+"&doctorFlow="+doctorFlow+"&backFlag="+backFlag;
	</c:if>
