...
require(['echarts','echarts/chart/bar','echarts/chart/line'],function(ec){
	...
	var exp2 = '';
	var specialty = '';
	if(${GlobalConstant.USER_LIST_LOCAL eq sessionScope.userListScope}){
		exp2 = 'bar';
		<%--if("${sysCfgMap[rotationSwitch] eq GlobalConstant.RECORD_STATUS_Y}"=="true"){--%>
		<%--}--%>
	}else {
		exp2 = 'line'
	}
