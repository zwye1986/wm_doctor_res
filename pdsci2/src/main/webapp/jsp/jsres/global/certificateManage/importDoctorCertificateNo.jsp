...
function daoRu(){
	...
	jboxStartLoading();
	var url = "<s:url value='/jsres/certificateManage/importDoctorCertificateNoFromExcel2'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="grid" style="width: 100%;margin-top: 50px;">
		...
		<tr>
			...
			<td style="text-align: left;"><a href="<s:url value='/jsp/jsres/global/certificateManage/importSchoolRoll.xlsx'/>">证书信息导入模板.xlsx</a></td>
		</tr>
	</table>
</form>
