...
String.prototype.htmlFormart = function(){
	...
	function importCourse(roleFlag){
		...
		jboxStartLoading();
		var url = "<s:url value='/jsres/statistic/importTeacherExcel'/>?roleFlag=" + roleFlag;
		jboxSubmit(
				$('#excelForm'),
				url,
				function(data){
		...
		<tr>
			...
			<td>
				...
				<c:if test="${roleFlag eq GlobalConstant.USER_LIST_LOCAL}">
					<label style="float: left;margin-left: 35px"><a href="<s:url value='/jsp/jsres/daochu/teacherTrainLocalImport.xls' />">培训师资信息导入模板.xlsx</a></label>
				</c:if>
			</td>
		</tr>
	</table>
	<div style="text-align: center; margin-top: 10px;">
		<input type="button" onclick="importCourse('${roleFlag}');" class="btn_green" value="导&#12288;入"/>
