                        ...
                        <td>
                            <div>
                                <ul >
                                    ...
                                    <li><span style="font-size: 12px;color: #459ae9;" title="未上传附件">${teacher.certificateNo }</span></li>
                                </ul>
                            </div>
                        </td>
                    </c:if>
                            ...
                            <div align="center">
                                <ul >
                                    <li id="ratateImg${status.index+1}">
                                        <img src="${sysCfgMap['upload_base_url']}/${teacher.certificateUrl}" style="width: 80px;height: 80px;" >
                                    </li>
                                    <li>
                                        <a onclick="downImg('${teacher.recordFlow}');" style="font-size: 12px;">${teacher.certificateNo }</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
