...
function searchInfo(sessionNumber,trainTypeId){
	...
	jboxLoad("content","<s:url value='/jsres/statistic/statisticCountryOrg'/>?orgLevel="+orgLevel+""+data+"&viewBox="+viewBox+"&trainTypeId="+trainTypeId+"&sessionNumber="+sessionNumber,true);
}
