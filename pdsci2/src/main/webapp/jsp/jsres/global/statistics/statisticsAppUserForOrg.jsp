...
// 		var endTime=$("#endTime").val().substring(0,4)+$("#endTime").val().substring(5,7);
		...
		jboxLoad("hosContent","<s:url value='/jsres/statistic/statisticsAppUserForOrg'/>?catSpeId="+catSpeId+"&sessionNumber="+sessionNumber,true);
// 	}else{
...
// 		var endTime=$("#endTime").val().substring(0,4)+$("#endTime").val().substring(5,7);
		var catSpeId = $("#catSpeId").val();
		jboxOpen("<s:url value='/jsres/statistic/statisticsAppUser'/>?open=Y&catSpeId="+catSpeId+"&orgFlow="+orgFlow+"&sessionNumber="+sessionNumber,"APP使用情况折线图",1050,550);
// 	}else{
// 		jboxTip("开始时间不能大于结束时间！");return;
// 	}
}
