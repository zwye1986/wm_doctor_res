...
<div style="height: 760px;overflow-y: auto">
	...
	<div class="div_table" style="margin-top: 10px">
		<h5><svg width="3" height="12" class="vertical-line"></svg>&#12288;审核记录</h5>
		<table border="0" cellspacing="0" cellpadding="0" class="base_info " style="margin-top: 6px">
			<colgroup>
				<col width="30%"/>
				<col width="40%"/>
			...
			<tbody>
			<tr>
				<th style="background-color: #f4f5f9; text-align: center">审核进度</th>
				<th style="background-color: #f4f5f9; text-align: center">审核备注</th>
				<th style="background-color: #f4f5f9; text-align: center">审核时间</th>
			</tr>
			<tr>
				...
				<td style="text-align: center">${not empty teacherTraining.applicationAuditMessage ? teacherTraining.applicationAuditMessage : '--'}</td>
				<td style="text-align: center">${teacherTraining.applicationAuditStatus == 'HeadAuditing' ? '--' : teacherTraining.modifyTime}</td>
			</tr>
			</tbody>
		</table>
	</div>
