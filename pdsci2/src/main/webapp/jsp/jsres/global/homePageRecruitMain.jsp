...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        jboxPostLoad("doctorListZi","<s:url value='/jsres/manage/homePageRecruitList'/>?tabId=orgType",$("#searchForm").serialize(),false);
    });

    function toPage() {
        var tab=$("#DataType").val();
        jboxStartLoading();
        jboxPostLoad("doctorListZi","<s:url value='/jsres/manage/homePageRecruitList'/>?tabId="+tab,$("#searchForm").serialize(),false);
    }
    ...
    function tabClick(tag,type){
        ...
        jboxPostLoad("doctorListZi","<s:url value='/jsres/manage/homePageRecruitList'/>?tabId="+type,$("#searchForm").serialize(),false);
        jboxStartLoading();
    }
