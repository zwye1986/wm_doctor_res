...
function showBackCheck(){
    ...
    var url="<s:url value='/jsres/doctor/showBackCheckMainAcc'/>";
...
function backTrainInfo(){
    ...
    var url="<s:url value='/jsres/doctor/backTrainInfoMainAcc?roleFlag=global&currentPage=1'/>";
	jboxLoad("hosContent",url,true);
}
function backTrainStatistics(){
	var url="<s:url value='/jsres/doctor/backTrainStatisticsAcc'/>";
	jboxLoad("hosContent",url,true);
}
</script>
<body>
