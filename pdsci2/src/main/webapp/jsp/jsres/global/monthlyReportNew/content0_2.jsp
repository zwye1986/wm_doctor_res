...
<script>
    $(function(){
        jboxLoad("content1_2","<s:url value='/jsres/monthlyReportGlobalNew/content1_2'/>?baseRange=1&monthDate=${monthDate}",false);
    })
    function content1(baseRange){
        jboxLoad("content1_2","<s:url value='/jsres/monthlyReportGlobalNew/content1_2'/>?baseRange="+baseRange+"&monthDate=${monthDate}",false);
    }
</script>
<%--<div class="item-content">--%>
    ...
    <div class="item-body">
        ...
        <div class="substance" id="content1_2" style="overflow: hidden;">
