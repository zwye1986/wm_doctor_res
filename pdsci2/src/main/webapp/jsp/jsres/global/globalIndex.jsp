...
<%--    <script type="text/javascript"
    ...
    <script type="text/javascript" src="<s:url value='/js/echarts/echarts-all.js'/>"></script>--%>
    ...
    <script>
        ...
        function finishStudyReport() {
            var roleFlag = "${GlobalConstant.USER_LIST_GLOBAL}";
            jboxLoad("content", "<s:url value='/jsres/graduation/finishStudyReport'/>?roleFlag=" + roleFlag + "&tabTag=Org&catSpeId=DoctorTrainingSpe", true);
        }
        ...
        function showProfBaseList() {
            jboxLoad("content", "<s:url value='/jsres/base/showProfBaseList'/>", true);
        }
        ...
        function deptManagement(){
            var roleFlag="${GlobalConstant.USER_LIST_GLOBAL}";
            jboxLoad("content","<s:url value='/jsres/dept/deptManagementMain'/>?roleFlag="+roleFlag,true);
        }
        ...
        function delayNew() {
            var url = "<s:url value='/jsres/doctor/delayNew'/>";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function doctorDataMain() {
            var url = "<s:url value='/jsres/statistic/doctorDataMain'/>?roleFlag=global";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function searchBlackInfoNew() {
            var roleFlag = "${GlobalConstant.USER_LIST_GLOBAL}";
            var url = "<s:url value='/jsres/blackList/blackListInfoMain?currentPage=1'/>" + "&roleFlag=" + roleFlag;
            currentJboxLoadNoData("content", url, true);
        }
    ...
    <script type="text/javascript">
        ...
        function homePageTraining(sessionNumber,statisticsType) {
            var url = "<s:url value ='/jsres/manage/homePageTrainingMain'/>?sessionNumber="+sessionNumber+"&statisticsType="+statisticsType;
            jboxOpen(url, "在培人员情况", 1000, 700);
        }

        function homePageRecruit(sessionNumber) {
            var url = "<s:url value ='/jsres/manage/homePageRecruitMain'/>?sessionNumber="+sessionNumber;
                ...
                <div class="container">
                    <div class="content_side">
                        <dl class="menu menu_first">
                            ...
                            <dd class="menu_item" id="profBaseList"><a onclick="showProfBaseList();">专业基地清单</a></dd>
...
<%--                            <dd class="menu_item"><a onclick="examStatistics()">考试人员情况统计</a></dd>--%>
                            ...
                            <%--<dd class="menu_item"><a onclick="certificateSearch();">证书信息查询</a></dd>--%>
                            <%--<dd class="menu_item"><a onclick="skillTimeConfig();">技能考核时间配置</a></dd>--%>
                        </dl>
                         <dl class="menu">
                             <dt class="menu_title">
                        ...
                        <%--<dl class="menu">
                            ...
                            <dd class="menu_item"><a href="javascript:signUpmain('Theory');">理论补考报名</a></dd>
                            <dd class="menu_item"><a href="javascript:signUpmain('Skill');">技能补考报名</a></dd>
                            <dd class="menu_item"><a onclick="doctorTheoryList();">理论成绩管理</a></dd>
                            <dd class="menu_item"><a onclick="doctorSkillList();">技能成绩查询</a></dd>
                            ...
                            <dd class="menu_item"><a onclick="CompletionReport();">结业统计</a></dd>
                        </dl>--%>
                        <dl class="menu">
                            <dt class="menu_title">
                        ...
                        <dl class="menu">
                            ...
                            <dd class="menu_item"><a href="javascript:deptManagement();">标准科室管理</a></dd>
