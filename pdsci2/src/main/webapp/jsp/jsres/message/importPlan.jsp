...
function importExcel(){
    ...
    jboxStartLoading();
	var url = "<s:url value='/jsres/message/importAssignInfo'/>";
	jboxSubmit(
		$('#planForm'),
		url,
		function(resp){
...
<div style="padding:0px 20px;margin-top:30px;">
	...
	<form id="planForm" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="assignYear" value="${param.assignYear}"/>
		<table width="100%" class="grid">
			...
			<tr>
				...
				<td style="text-align: left;"><a href="<s:url value='/jsp/jsres/message/planTemp.xlsx'/>">招录计划导入模板.xlsx</a></td>
			</tr>
		</table>
	</form>
