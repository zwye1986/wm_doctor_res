...
<script type="text/javascript">
	...
	function selTag(tabTag){
		if("WaitAudit"==tabTag)
		{
			...
			//待审核
			jboxLoad("mainDiv","<s:url value='/jsres/teacher/attendanceSearchTab/speAdminSecretary'/>",true);
		}else{
			...
			//审核列表
			jboxLoad("mainDiv","<s:url value='/jsres/teacher/attendanceSearch/speAdminSecretary'/>",true);
		}
	}
</script>
