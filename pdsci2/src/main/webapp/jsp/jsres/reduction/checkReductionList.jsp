...
<head>
    ...
    <script type="text/javascript">
        function submit() {
            ...
            var url = "<s:url value='/jsres/reduction/checkReductionInfoList'/>";
...
<div class="div_search" style="margin-top: 20px">
    ...
    <form id="editForm" style="position: relative;" method="post"
          action="<s:url value='/jsres/reduction/checkReductionInfoList'/>"
          enctype="multipart/form-data">
        <input type="hidden" name="recordFlowList" value="${recordFlowList}"/>
            ...
            <tr>
                ...
                <td>
                    <input class="validate[required]" type="radio" name="reductionAuditStatusId"
                           value="${agree}"
                           <c:if test="${roleId eq GlobalConstant.USER_LIST_GLOBAL}">onchange="editOpinon('Y');"</c:if>/>&nbsp;同意&#12288;
                    <input class="validate[required]" type="radio" name="reductionAuditStatusId"
                           value="${disAgree}"
                           <c:if test="${roleId eq GlobalConstant.USER_LIST_GLOBAL}">onchange="editOpinon('N');"</c:if>/>&nbsp;不同意
                </td>
            </tr>
            <tr>
                <th>&#12288;审核意见：</th>
