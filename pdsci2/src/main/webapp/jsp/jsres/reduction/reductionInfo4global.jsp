...
<%--                        <td>--%>
<%--                            <input type="text" name="orgName" value="${param.orgName}" class="input"--%>
<%--                                   style="width: 100px;"/>&#12288;--%>
<%--                        </td>--%>
                        <td>
                            <select name="orgName"  id="orgName" class="select" style="width:107px;">
                                <option value="">请选择</option>
                                <c:forEach items="${orgs}" var="org">
                                    <option value="${org.orgName}" ${param.orgName eq org.orgName?'selected':''}>${org.orgName}</option>
                                </c:forEach>
                            </select>
                        </td>
