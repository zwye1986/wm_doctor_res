...
<script type="text/javascript">
    ...
    function selTag(tabTag){
        if("Regiest"==tabTag)
        {
            ...
            jboxLoad("mainDiv","<s:url value='/jsres/speAdmin/showRegistEval'/>?activityFlow=${param.activityFlow}&roleFlag=${param.roleFlag}",true);
        }else{
            $("#Singn").removeClass("tab");
            $("#Singn").addClass("tab_select");
            $("#Regiest").addClass("tab");
            $("#Regiest").removeClass("tab_select");
            jboxLoad("mainDiv","<s:url value='/jsres/speAdmin/showEval'/>?activityFlow=${param.activityFlow}&roleFlag=${param.roleFlag}",true);
        }
    }
</script>
