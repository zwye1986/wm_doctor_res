...
<script type="text/javascript">
    function showEquipmentInstruments(standardDeptFlow, standardDeptName, isJoin, speFlow) {
        var url = "<s:url value ='/jsres/base/showEquipmentInstrumentsInfo'/>?onlyRead=${ishos}&standardDeptFlow=" + standardDeptFlow + "&orgFlow=${orgFlow}&isJoin=Y&speFlow=" + speFlow+"&isglobal=Y&sessionNumber=${sessionNumber}";
                    ...
                    <c:forEach items="${resultList}" var="r">
                        <tr>
                            ...
                            <td style="text-align: center">
                                    <a href="javascript:void(0)" onclick="showEquipmentInstruments('${r.standardDeptFlow}','${r.standardDeptName}','${isJoin}','${speFlow}');" style="color:#59d5ff;">查看</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
