...
<script type="text/javascript">
    function showDiagDisease(standardDeptFlow, standardDeptName, isJoin, speFlow) {
        var url = "<s:url value ='/jsres/base/showDiagDiseaseInfo'/>?onlyRead=${ishos}&standardDeptFlow=" + standardDeptFlow + "&orgFlow=${orgFlow}&isJoin=Y&speFlow=" + speFlow+"&isglobal=Y&sessionNumber=${sessionNumber}";
                    ...
                    <c:forEach items="${resultList}" var="r">
                        <tr>
                            ...
                            <td style="text-align: center">
                                    <a href="javascript:void(0)" onclick="showDiagDisease('${r.standardDeptFlow}','${r.standardDeptName}','${isJoin}','${speFlow}');" style="color:#59d5ff;">查看</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
