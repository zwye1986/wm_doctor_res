...
<form id='BaseInfoForm' style="position:relative;">
	...
	<div class="main_bd"
		...
		<div class="div_table">
			...
			<table id="zy" border="0" cellspacing="0" cellpadding="0" class="base_info">
				<colgroup>
					<col width="27%"/>
					<col width="12%"/>
					<col width="8%"/>
...
<%--<c:if test="${viewFlag ne 'Y'}">
	<div class="btn_info">
		<input type="button" class="btn_green"  value="编&#12288;辑"onclick="editInfo('DepartmentHead','${speFlow}');"></input>
	</div>
</c:if>--%>
</form>
