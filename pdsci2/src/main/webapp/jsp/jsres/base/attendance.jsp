...
<script type="text/javascript">
    ...
    function selTag(tabTag){
        if("WaitAudit"==tabTag)
        {
            ...
            //待审核
            jboxLoad("mainDiv","<s:url value='/jsres/teacher/attendanceSearchTab/hospital'/>?baseFlag=${param.baseFlag}",true);
        }else{
            ...
            //审核列表
            jboxLoad("mainDiv","<s:url value='/jsres/teacher/attendanceSearch/hospital'/>?baseFlag=${param.baseFlag}",true);
        }
    }
</script>
