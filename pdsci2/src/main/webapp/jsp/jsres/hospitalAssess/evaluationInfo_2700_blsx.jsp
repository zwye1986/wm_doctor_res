...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px;">
            <th colspan="3" style="text-align: left;"><div style="margin-top: 8px"><span>培训对象姓名：</span></div>
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="2700-02-0.3" name="reason" onchange="saveSpeReason(this);"></textarea></th>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="2700-02-1.1" itemName="主诉" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <th rowspan="8">15</th>
            <td rowspan="8">
                <input onchange="saveScore(this,15);" itemId="2700-02-2.1" itemName="现病史"
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="2700-02-3.1" itemName="其他病史"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="5">10</th>
            <td rowspan="5">
                <input onchange="saveScore(this,10);" itemId="2700-02-4.1" itemName="体格检查"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="2700-02-5.1"
                       itemName="辅助检查"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        ...
        <tr style="height:32px">
            ...
            <th style="text-align: left;">1、主要诊断及主要并发症有错误或有遗漏、诊断不规范（如甲亢、风心病等）</th>
            <th>扣2-5分</th>
            <th rowspan="3">10</th>
            <td rowspan="3">
                <input onchange="saveScore(this,10);" itemId="2700-02-6.1" itemName="诊断"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="2700-02-7.1" itemName="首次病程日志病例特点"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">10</th>
            <td rowspan="3">
                <input onchange="saveScore(this,10);" itemId="2700-02-8.1" itemName="诊断分析"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="2">5</th>
            <td rowspan="2">
                <input onchange="saveScore(this,5);" itemId="2700-02-9.1" itemName="诊疗计划"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="6">15</th>
            <td rowspan="6">
                <input onchange="saveScore(this,15);" itemId="2700-02-10.1" itemName="病程记录"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="4">15</th>
            <td rowspan="4">
                <input onchange="saveScore(this,15);" itemId="2700-02-11.1" itemName="提问"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_2700_blsx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
