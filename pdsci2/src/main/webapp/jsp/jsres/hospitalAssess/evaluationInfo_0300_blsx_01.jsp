...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="28">
            <th colspan="3" style="text-align:left;padding-left: 4px;">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="0300-05-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
            </th>
        ...
        <tr style="height:32px">
            <th rowspan="3" style="width: 20%">一、主诉</th>
            ...
            <td rowspan="3" style="width: 20%">
                <input onchange="saveScore(this,5);" itemId="0300-05-1.1" itemName="主诉" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <td>1.发病情况及患病时间叙述不清，未说明有无诱因与可能的病因</td>
            <td style="text-align: center; ">扣1-2分</td>
            <td style="text-align: center;" rowspan="8">15</td>
            <td rowspan="8">
                <input onchange="saveScore(this,15);" itemId="0300-05-2.1" itemName="现病史" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="0300-05-3.1" itemName="其他病史" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td rowspan="5">
                <input onchange="saveScore(this,10);" itemId="0300-05-4.1" itemName="体格检查" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-05-5.1" itemName="辅助检查" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td rowspan="3">
                <input onchange="saveScore(this,10);" itemId="0300-05-6.1" itemName="诊断" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center;" rowspan="3">5</td>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="0300-05-7.1" itemName="首次病程日志病例特点" name="self"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center;" rowspan="3">10</td>
            <td rowspan="3">
                <input onchange="saveScore(this,10);" itemId="0300-05-8.1" itemName="诊断分析" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td rowspan="2">
                <input onchange="saveScore(this,5);" itemId="0300-05-9.1" itemName="诊疗计划" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <td rowspan="6">
                <input onchange="saveScore(this,15);" itemId="0300-05-10.1" itemName="病程记录" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            <td>
                6、会诊记录单及各种记录检查单填写有缺项（姓名、病例号、日期、诊断、签名等）
            </td>
            <td style="text-align: center; ">
                扣0.5-2分
            </td>
        ...
        <tr style="height:32px">
            ...
            <td rowspan="4">
                <input onchange="saveScore(this,15);" itemId="0300-05-11.1" itemName="提问" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_0300_blsx_01');"/>&#12288;
    <c:if test="${edit ne 'N'}">
