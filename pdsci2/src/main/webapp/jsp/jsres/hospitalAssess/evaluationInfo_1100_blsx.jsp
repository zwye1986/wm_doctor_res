	...
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		...
		<tr height="28" >
			<th colspan="3" style="text-align:left;padding-left: 4px;" >
				...
				<textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
						  itemId="1100-02-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
			</th>
		...
		<tr style="height:32px">
			...
			<td rowspan="3" style="width: 20%">
				<input onchange="saveScore(this,5);" itemId="1100-02-1.1" itemName="主诉"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>2、发病时间有遗漏或错误</td>
		...
		<tr style="height:32px">
			...
			<td rowspan="8">
				<input onchange="saveScore(this,15);" itemId="1100-02-2.1" itemName="现病史"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
		...
		<tr style="height:32px">
			...
			<td rowspan="3">
				<input onchange="saveScore(this,5);" itemId="1100-02-3.1" itemName="其他病史"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td rowspan="5">
				<input onchange="saveScore(this,10);" itemId="1100-02-4.1" itemName="体格检查"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td>
				<input onchange="saveScore(this,5);" itemId="1100-02-5.1" itemName="辅助检查"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			...
			<td rowspan="3">
				<input onchange="saveScore(this,10);" itemId="1100-02-6.1" itemName="诊断"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td style="text-align: center;" rowspan="3">5</td>
			<td rowspan="3">
				<input onchange="saveScore(this,5);" itemId="1100-02-7.1" itemName="首次病程日志病例特点"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td style="text-align: center;" rowspan="3">10</td>
			<td rowspan="3">
				<input onchange="saveScore(this,10);" itemId="1100-02-8.1" itemName="诊断分析"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td rowspan="2">
				<input onchange="saveScore(this,5);" itemId="1100-02-9.1" itemName="诊疗计划"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td rowspan="6">
				<input onchange="saveScore(this,15);" itemId="1100-02-10.1" itemName="病程记录"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
		...
		<tr style="height:32px">
			...
			<td rowspan="4">
				<input onchange="saveScore(this,15);" itemId="1100-02-11.1" itemName="提问"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  />
			</td>
		</tr>
		<tr style="height:32px">
			<td>
...
<div class="button">
	<input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_1100_blsx');"/>&#12288;
	<c:if test="${edit ne 'N'}">
