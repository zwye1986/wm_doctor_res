...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">住院医师规范化培训临床文献研读会评分表（通用表）</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="5">临床文献研读会主题：
                <textarea type="text"style="border: 1px solid #bababa;width: 40%;height: 25px;" itemId="lcwxydhzt" name="reason"
        ...
        <tr height="28">
            ...
            <th style="text-align:left;padding-left: 4px;" colspan="3">日期：
        ...
        <tr style="height:32px">
            <td>
                选题内容紧扣本专业培训细则，具有临床应用价值，难度符合教学对象
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                主讲住院医师汇报：汇报内容熟悉准确，重点突出，信息呈现充足，汇报富有感染力
            </td>
            <td style="text-align: center;">10</td>
            <td>
                <input onchange="saveScore(this,10);" itemId="6" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                师生共同讨论：从问题入手，围绕预定的临床问题，紧密结合文献展开陈述和讨论；住院医师能积极提问或发表独立见解，指导医师积极引导
            </td>
            <td style="text-align: center;">10</td>
            <td>
                <input onchange="saveScore(this,10);" itemId="7" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                指导医师点评总结：对文献内容和价值、住院医师的表现、预期目标的达成情况等进行准确点评，归纳重点和难点，必要时布置会后作业
            </td>
            <td style="text-align: center;">10</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                评价和反馈：发放评价表或通过访谈了解研读会的效果和不足之处，提出今后的整改措施
            </td>
            <td style="text-align: center;">10</td>
            <td>
        ...
        <tr style="height:32px">
            <th rowspan="4">研读会方法（20分）</th>
            <td>
                以住院医师为主体，充分体现住院医师学习的主动性、积极性
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                指导医师在研读会中应及时给予引导，鼓励所有住院医师积极参与讨论，讨论针对文献主题展开，实现对该主题的深入学习
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                点评、反馈要结合先进的理念，采用合适的方法，充分激发住院医师学习和实践的动力
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <th rowspan="3">总体评价（15分)</th>
            <td>
                住院医师临床思维培训效果良好（四个特性：逻辑性、批判性、发散性、综合性）
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                研读会中融入思政内涵，将价值塑造、知识传授和能力培养三者融为一体
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>
                指导医师仪态端庄，情绪饱满，语言亲切；对重点、难点指导和把握适当；时间分配合理
            </td>
            <td style="text-align: center;">5</td>
            <td>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_lcwxyd');"/>&#12288;
    <c:if test="${edit ne 'N'}">
