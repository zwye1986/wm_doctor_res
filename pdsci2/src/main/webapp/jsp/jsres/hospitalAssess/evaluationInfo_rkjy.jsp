...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">住院医师规范化培训入科教育项目评价表（通用表）</h2>
            </th>
        </tr>
        <tr style="height:32px;">
            <th style="text-align:left;padding-left: 4px;" colspan="3">轮转科室：${activityDept}</th>
        ...
        <tr style="height:32px">
            <td>学习管理</td>
            <td>
                3.建立有效的住院医师交流沟通渠道得2分 <br>
                4.将完成入科教育作为住院医师进入临床岗位的必备条件，并有效落实得3分
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <th rowspan="7">培训实施（70分）</th>
            <td>培训目标</td>
            <td>
                1.有明确、具体和可行的培训目标得3分 <br>
                2.培训目标与住院医师角色特点和需求相符得2分
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            <td>培训内容</td>
            <td>
                1.培训内容系统全面，并涵盖科室介绍、工作要求、培养计划、教学活动、技能操作、过程考核及其他7个方面 得21分；每少1个方面内容扣3分 <br>
                2.培训内容符合住院医师角色特点和需求得3分 <br>
                3.培训内容具有较好的专科性得3分 <br>
                4.培训内容具有较好的实用性得3分 <br>
                5.培训内容紧密联系临床实践得3分 <br>
                6.培训内容体现个性化和分层递进理念得3分
            </td>
            <td style="text-align: center;">36</td>
            <td>
                <input onchange="saveScore(this,36);" itemId="6" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <td>培训形式</td>
            <td>
                培训形式能促进住院医师主动思考和积极参与得3分
            </td>
            <td style="text-align: center;">3</td>
            <td>
        ...
        <tr style="height:32px">
            <td>任课老师</td>
            <td>
                1.授课态度严肃认真，仪表端正，体现师德师风得3分 <br>
                2、弘扬正能量，注重思政引导，言行举止得体，体现医学人文关怀得3分 <br>
                3.熟悉授课内容，表达清晰、流利，整体印象好得3分
            </td>
            <td style="text-align: center;">9</td>
            <td>
                <input onchange="saveScore(this,9);" itemId="8" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <td>严格落实</td>
            <td>
                严格落实培训计划与学习考核要求，首次参加入科教育的住院医师完成率达到100%得5分；不足100%，不得分
            </td>
            <td style="text-align: center;">5</td>
            <td>
        ...
        <tr style="height:32px">
            ...
            <td>
                1.有完善的课件等教学资料得3分 <br>
                2.有完善的住院医师考勤记录等管理资料 得3分 <br>
                3.各类档案资料完整，且归档整齐得3分
            </td>
            <td style="text-align: center;">9</td>
            <td>
                <input onchange="saveScore(this,9);" itemId="10" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>质量管理（15）</th>
            <td>培训反馈</td>
            <td>
                1.有问卷调查等形式的培训反馈得5分 <br>
                2.反馈结果有及时分析和有效应用得5分 <br>
                3.住院医师满意度（选择好或非常好的比例）≥90%得5分，每低 5%（不足 5%按 5%计）扣1分；低于 80%不得分
            </td>
            <td style="text-align: center;">15</td>
            <td>
                <input onchange="saveScore(this,15);" itemId="11" name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px;">
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_rkjy');"/>&#12288;
    <c:if test="${edit ne 'N'}">
