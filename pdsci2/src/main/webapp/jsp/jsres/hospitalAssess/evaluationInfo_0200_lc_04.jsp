...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px;font-size: inherit">
        ...
        <tr height="34" class="firstRow">
            <th colspan="4">
                <h2 style="font-size:150%">临床操作技能床旁教学（气管插管）考核评分表</h2>
            </th>
        </tr>
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="2">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="0200-09-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
            </th>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">3</td>
            <td>
                <input onchange="saveScore(this,3);" itemId="0200-09-4.1" itemName="禁忌症" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px;">
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_0200_lc_04');"/>&#12288;
    <c:if test="${edit ne 'N'}">
