...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px;">
            <th style="text-align: left;" colspan="2">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="1700-04-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
            </th>
            <th style="text-align: left;" colspan="3">所在科室：${deptName}</th>
        </tr>
        <tr style="height:32px;">
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="1700-04-1.1" itemName="主诉" name="self" class="input"
        ...
        <tr style="height:32px">
            ...
            <th rowspan="8">15</th>
            <td rowspan="8">
                <input onchange="saveScore(this,15);" itemId="1700-04-2.1" itemName="现病史"
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="1700-04-3.1" itemName="其他病史"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="5">10</th>
            <td rowspan="5">
                <input onchange="saveScore(this,10);" itemId="1700-04-4.1" itemName="体格检查"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            <th>五、辅助检查 <br>（5分）</th>
            <th style="text-align: left;">专科检查、血尿粪常规、重要化验、X射线、心电图、B超等相关检查遗漏或描述不正确</th>
            <th>每项扣1分</th>
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="1700-04-5.1"
                       itemName="辅助检查"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        ...
        <tr style="height:32px">
            <th rowspan="4">六、诊断 <br>（10分）</th>
            <th style="text-align: left;">1、第一诊断和主诉不符合</th>
            <th>扣5分</th>
            <th rowspan="4">10</th>
            <td rowspan="4">
                <input onchange="saveScore(this,10);" itemId="1700-04-6.1" itemName="诊断"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th style="text-align: left;">2、主要诊断及主要并发症有错误或有遗漏、诊断不规范（如甲亢、风心病等）</th>
            <th>扣2-5分</th>
        </tr>
        <tr style="height:32px">
            <th style="text-align: left;">3、次要诊断遗漏或错误、不规范</th>
            <th>扣1-3分</th>
        </tr>
        <tr style="height:32px">
            <th style="text-align: left;">4、诊断主次顺序错误</th>
            <th>扣1-2分</th>
        </tr>
        <tr style="height:32px">
            <th rowspan="3">七、首次病程录病例特点 <br>（5分）</th>
            <th style="text-align: left;">1、内容有遗漏</th>
            <th>遗漏1项扣0.5分</th>
            <th rowspan="3">5</th>
            <td rowspan="3">
                <input onchange="saveScore(this,5);" itemId="1700-04-7.1" itemName="首次病程录病例特点"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="3">10</th>
            <td rowspan="3">
                <input onchange="saveScore(this,10);" itemId="1700-04-8.1" itemName="诊断分析"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th rowspan="2">5</th>
            <td rowspan="2">
                <input onchange="saveScore(this,5);" itemId="1700-04-9.1" itemName="诊疗计划"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <th style="text-align: left;">1、病程记录不及时、入院后3天无病程记录，长期住院病人超过1周无病程记录</th>
            <th>扣1-2分</th>
            <th rowspan="6">15</th>
            <td rowspan="6">
                <input onchange="saveScore(this,15);" itemId="1700-04-10.1" itemName="病程记录"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        ...
        <tr style="height:32px">
            <th style="text-align: left;">5、长期住院病人无阶段小结，无交接班记录</th>
            <th>扣1-2分</th>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <th rowspan="4">15</th>
            <td rowspan="4">
                <input onchange="saveScore(this,15);" itemId="1700-04-11.1" itemName="提问"
                       name="self" class="input"
                       type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_1700_blsx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
