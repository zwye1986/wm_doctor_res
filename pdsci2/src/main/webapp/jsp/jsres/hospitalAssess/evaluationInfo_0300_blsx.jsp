		...
		<tr height="28" >
			<th style="text-align:left;padding-left: 4px;width: 35%" colspan="3">
				...
				<textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
						  itemId="0300-04-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
			</th>
...
<div class="button">
	<input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_0300_blsx');"/>&#12288;
	<c:if test="${edit ne 'N'}">
