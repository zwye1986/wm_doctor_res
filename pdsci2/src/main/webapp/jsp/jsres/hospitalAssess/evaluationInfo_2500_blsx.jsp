...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">住院病历书写指导教学考核评分表1</h2>
            </th>
        </tr>
        <tr height="28" >
            <th style="text-align:left;padding-left: 4px;" colspan="3">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="2500-03-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
            </th>
        ...
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="2500-03-1.1" itemName="d病历首页"
        ...
        <tr style="height:32px">
            ...
            <th>1</th>
            <td>
                <input onchange="saveScore(this,1);" itemId="2500-03-1.2" itemName="d一般项目"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-1.3" itemName="d主诉"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>现病史</th>
            <th style="text-align: left">起病时间、诱因、症状、加重及缓解因素、诊治经过、具有鉴别意义的阴性病史、发病后一般情况</th>
            <th>8</th>
            <td>
                <input onchange="saveScore(this,8);" itemId="2500-03-1.4" itemName="d现病史"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-1.5" itemName="d既往史等"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            <th>体格检查</th>
            <th style="text-align: left">各大系统无遗漏、阳性体征准确；有鉴别意义的阴性体征无遗漏</th>
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="2500-03-1.6" itemName="d各大系统无遗漏、阳性体征准确；"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-1.7" itemName="d辅助检查"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>3</th>
            <td>
                <input onchange="saveScore(this,3);" itemId="2500-03-1.8" itemName="d诊断"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>1</th>
            <td>
                <input onchange="saveScore(this,1);" itemId="2500-03-1.9" itemName="d签名"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-1.10" itemName="d病例摘要"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>3</th>
            <td>
                <input onchange="saveScore(this,3);" itemId="2500-03-2.1" itemName="d病历特点"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>10</th>
            <td>
                <input onchange="saveScore(this,10);" itemId="2500-03-2.2" itemName="d诊断依据"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>8</th>
            <td>
                <input onchange="saveScore(this,8);" itemId="2500-03-2.3" itemName="d鉴别诊断"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>5</th>
            <td>
                <input onchange="saveScore(this,5);" itemId="2500-03-2.4" itemName="d诊疗计划"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>3</th>
            <td>
                <input onchange="saveScore(this,3);" itemId="2500-03-3.1" itemName="d时间"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th rowspan="6">12</th>
            <td rowspan="6">
                <input onchange="saveScore(this,12);" itemId="2500-03-3.2" itemName="d准确反映病情变化及诊治过程、有病情分析；"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <th rowspan="2">5</th>
            <td rowspan="2">
                <input onchange="saveScore(this,5);" itemId="2500-03-3.3" itemName="d在规定时间内完成"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
        ...
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-4.1" itemName="d一般情况"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-4.2" itemName="d入院情况"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>4</th>
            <td>
                <input onchange="saveScore(this,4);" itemId="2500-03-4.3" itemName="d诊疗经过"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-4.4" itemName="d出院情况"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-4.5" itemName="d出院诊断"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>2</th>
            <td>
                <input onchange="saveScore(this,2);" itemId="2500-03-4.6" itemName="d出院医嘱"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <th>4</th>
            <td>
                <input onchange="saveScore(this,4);" itemId="2500-03-4.7" itemName="d出院医嘱"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_2500_blsx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
