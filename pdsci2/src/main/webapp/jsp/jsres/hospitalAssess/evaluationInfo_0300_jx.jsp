...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
          ...
          <%--  <th style="text-align:left;padding-left: 4px;" colspan="2">患者病历号：${userCaseId}</th>
            <th style="text-align:left;padding-left: 4px;" colspan="2">疾病名称：${diseaseName}</th>--%>
              <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
                  ...
                  <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 80px" itemId="0300-03-0.1" name="reason"
              ...
              <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
                  ...
                  <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 70px" itemId="0300-03-0.2" name="reason"
                            onchange="saveSpeReason(this);"></textarea>
              </th>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <td><input onchange="saveScore(this,5);" itemId="0300-03-1.1" itemName="准备工作充分，认真组织教学查房" name="self"
                       class="input" type="text" style="height:20px; text-align: center"/></td>
        </tr>
        <tr style="height:32px">
            <td>2.病例选择合适</td>
            <td style="text-align: center">5</td>
            <td><input onchange="saveScore(this,5);" itemId="0300-03-1.2" itemName="病例选择合适" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/></td>
        </tr>
        <tr style="height:32px">
            <td>3.熟悉患者病情，全面掌握近期病情演变</td>
            <td style="text-align: center">5</td>
            <td><input onchange="saveScore(this,5);" itemId="0300-03-1.3" itemName="熟悉患者病情，全面掌握近期病情演变" name="self"
                       class="input" type="text" style="height:20px; text-align: center"/></td>
        </tr>
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.1"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.2"
                       itemName="与患者核实、补充病史，指导培训对象认真询问病史"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
        </tr>
        <tr style="height:32px">
            <td>
                3.查体示范准确标准，及时纠正培训对象不正确手法并指导规范查体
            </td>
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.3"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.4"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.5"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.6"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.7"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-2.8"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-3.1"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-3.2"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-3.3"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-3.4"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-3.5"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-4.1"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-4.2"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-4.3"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0300-03-5.1"
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_0300_jx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
