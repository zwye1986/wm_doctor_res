        ...
        <tr style="height:32px;">
            <th colspan="2" style="text-align: left;"><div style="margin-top: 8px"><span>培训对象姓名：</span></div>
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="2800-07-0.3" name="reason" onchange="saveSpeReason(this);"></textarea></th>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_2800_lc_02');"/>&#12288;
    <c:if test="${edit ne 'N'}">
