    ...
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px;">
            <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 80px" itemId="1800-05-0.1" name="reason"
            ...
            <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 70px" itemId="1800-05-0.2" name="reason"
                          onchange="saveSpeReason(this);"></textarea>
            </th>
        </tr>
        <tr style="height:32px;">
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_1800_jx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
