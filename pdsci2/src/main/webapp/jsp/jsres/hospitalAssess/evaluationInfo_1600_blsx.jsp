...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr style="height:32px; text-align: left;">
            <th colspan="3">
                ...
                <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 90px"
                          itemId="1600-02-0.3" name="reason" onchange="saveSpeReason(this);"></textarea>
            </th>
            <th colspan="3">所在科室：${deptName}</th>
        </tr>
        <tr style="height:32px; text-align: left;">
        ...
        <tr style="height:32px">
            ...
            <th>4</th>
            <td>
                <input onchange="saveScore(this,4);" itemId="1600-02-5.1" itemName="k病历规格"
                       name="takeOut" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
            <td>
                <input  itemId="1600-02-5.1" itemName="d病历规格"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/>
            </td>
        </tr>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_1600_blsx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
