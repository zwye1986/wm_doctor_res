...
<div class="div_table" style="overflow: auto;max-height: 570px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="5">
                <h2 style="font-size:150%">培训基地指导医师教学查房评分表</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr height="28">
               <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="3">
                   ...
                   <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 80px" itemId="0600-03-0.1" name="reason"
               ...
               <th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
                   ...
                   <textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 70px" itemId="0600-03-0.2" name="reason"
                             onchange="saveSpeReason(this);"></textarea>
               </th>
        </tr>
        ...
        <tr style="height:32px">
            ...
            <td><input onchange="saveScore(this,5);" itemId="0600-03-1.1" itemName="准备工作充分，认真组织教学查房" name="self"
                       class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="0600-03-1.1" itemName="准备工作充分，认真组织教学查房" name="reason"
        ...
        <tr style="height:32px">
            <td>2.病例选择合适；</td>
            <td style="text-align: center">5</td>
            <td><input onchange="saveScore(this,5);" itemId="0600-03-1.2" itemName="病例选择合适" name="self" class="input"
                       type="text" style="height:20px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="0600-03-1.2" itemName="病例选择合适" name="reason"
                          placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        </tr>
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td><input onchange="saveScore(this,5);" itemId="0600-03-1.3" itemName="熟悉患者病情，全面掌握近期病情演变" name="self"
                       class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
                <textarea onchange="saveSpeReason(this);" itemId="0600-03-1.3" itemName="熟悉患者病情，全面掌握近期病情演变"
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.1"
            ...
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.1"
                          itemName="有教书育人意识，尊重和关心患者，注意医德医风教育和爱伤观念教育，体现严肃、严谨、严格的医疗作风"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.2"
                       itemName="与患者核实、补充病史，指导培训对象认真询问病史"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.2"
                          itemName="与患者核实、补充病史，指导培训对象认真询问病史"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.3"
                       itemName="查体示范准确标准，及时纠正培训培训对象不正确手法并指导规范查体"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.3"
                          itemName="查体示范准确标准，及时纠正培训培训对象不正确手法并指导规范查体"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.4"
                       itemName="指导培训对象正确判读心电图、影像学资料等，分析各种辅助检查报告单，并提出个人见解"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.4"
                          itemName="指导培训对象正确判读心电图、影像学资料等，分析各种辅助检查报告单，并提出个人见解"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.5"
                       itemName="点评培训对象病历书写并指出不足，指导规范书写病历及总结病例特点"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.5"
                          itemName="点评培训对象病历书写并指出不足，指导规范书写病历及总结病例特点"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.6"
                       itemName="指导培训对象做出正确的诊断、鉴别诊断，并提出相应依据"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.6"
                          itemName="指导培训对象做出正确的诊断、鉴别诊断，并提出相应依据"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.7"
                       itemName="指导培训对象提出正确的诊疗计划"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.7"
                          itemName="指导培训对象提出正确的诊疗计划"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-2.8"
                       itemName="结合病例，联系理论基础，讲解疑难问题和介绍医学新进展，并指导培训对象阅读有关书籍、文献、参考资料等"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-2.8"
                          itemName="结合病例，联系理论基础，讲解疑难问题和介绍医学新进展，并指导培训对象阅读有关书籍、文献、参考资料等"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-3.1"
                       itemName="结合病例有层次地设疑提问，启发培训对象独立思考问题、训练独立诊疗疾病的思维能力"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-3.1"
                          itemName="结合病例有层次地设疑提问，启发培训对象独立思考问题、训练独立诊疗疾病的思维能力"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-3.2"
                       itemName="鼓励培训对象主动提问，并耐心解答各种问题"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-3.2"
                          itemName="鼓励培训对象主动提问，并耐心解答各种问题"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-3.3"
                       itemName="合理使用病例资源，鼓励培训对象临床实践，提高动手能力"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-3.3"
                          itemName="合理使用病例资源，鼓励培训对象临床实践，提高动手能力"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-3.4"
                       itemName="用语专业、规范，合理教授专业英语词汇"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-3.4"
                          itemName="用语专业、规范，合理教授专业英语词汇"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-3.5"
                       itemName="及时归纳查房内容，指导培训对象小结学习内容"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-3.5"
                          itemName="及时归纳查房内容，指导培训对象小结学习内容"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-4.1"
                       itemName="通过查房训练培训对象医患沟通、采集病史技巧，体格检查手法，临床思维"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-4.1"
                          itemName="通过查房训练培训对象医患沟通、采集病史技巧，体格检查手法，临床思维"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-4.2"
                       itemName="查房内容及形式充实，重点突出，时间安排合理，培训对象能掌握或理解大部分查房内容"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-4.2"
                          itemName="查房内容及形式充实，重点突出，时间安排合理，培训对象能掌握或理解大部分查房内容"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-4.3"
                       itemName="查房基本模式、过程、效果达到预期目的"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-4.3"
                          itemName="查房基本模式、过程、效果达到预期目的"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
        ...
        <tr style="height:32px">
            ...
            <td style="text-align: center">5</td>
            <td>
                <input onchange="saveScore(this,5);" itemId="0600-03-5.1"
                       itemName="态度严肃认真，仪表端正，行为得体，着装大方，谈吐文雅"
                       name="self" class="input" type="text" style="height:20px; text-align: center"/></td>
            <td>
				<textarea onchange="saveSpeReason(this);" itemId="0600-03-5.1"
                          itemName="态度严肃认真，仪表端正，行为得体，着装大方，谈吐文雅"
                          name="reason" placeholder="请填写扣分原因" style="width: 98%"
                          class="text-input validate[required,maxSize[1000]]"></textarea>
            </td>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_0600_jx');"/>&#12288;
    <c:if test="${edit ne 'N'}">
