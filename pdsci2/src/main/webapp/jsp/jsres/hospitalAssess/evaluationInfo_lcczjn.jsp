...
<div class="div_table" style="overflow: auto;max-height: 600px;">
    <table cellpadding="4" style="width: 1000px">
        ...
        <tr height="34" class="firstRow">
            <th colspan="4">
                <h2 style="font-size:150%">住院医师规范化培训临床操作技能床旁教学评分表（通用表）</h2>
            </th>
        </tr>
        <tr height="28">
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="4">操作技能项目：
                <textarea type="text"style="border: 1px solid #bababa;width: 40%;height: 25px;" itemId="czjnxm" name="reason"
        ...
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="4">指导模式：
                ...
                <label><input type="radio" name="zdms" itemid="zdms" radioBox="指导模式" onclick="checkBox(this,'指导模式');" />&#12288;指导模式</label>
            </th>
        </tr>
        <tr height="28">
            <th style="text-align:left;padding-left: 4px;" colspan="4">指导地点：
                <textarea type="text"style="border: 1px solid #bababa;width: 40%;height: 25px;" itemId="zddd" name="reason"
                          onchange="saveSpeReason(this);"></textarea>
            </th>
        </tr>
...
<div class="button">
    <input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_lcczjn');"/>&#12288;
    <c:if test="${edit ne 'N'}">
