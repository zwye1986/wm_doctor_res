...
<div class="div_table"style="overflow: auto;max-height: 570px;">
	<table cellpadding="4" style="width: 1000px;font-size: inherit">
		...
		<tr height="28" >
			...
			<textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 80px" itemId="1000-02-0.1" name="reason"
			...
			<th style="text-align:left;padding-left: 4px;;height: 34px" colspan="2">
				...
				<textarea type="text"style="border: 1px solid #bababa;width: 50%;height: 25px;margin-top: -22px;margin-left: 70px" itemId="1000-02-0.2" name="reason"
						  onchange="saveSpeReason(this);"></textarea>
			</th>
		</tr>
		...
		<tr style="height:32px">
			...
			<td><input onchange="saveScore(this,5);" itemId="1000-02-1.1" itemName="准备工作充分，认真组织教学查房"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  /></td>
		</tr>
		<tr style="height:32px">
			<td>2.病例选择合适</td>
			<td style="text-align: center">5</td>
			<td><input onchange="saveScore(this,5);" itemId="1000-02-1.2" itemName="病例选择合适"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  /></td>
		</tr>
		<tr style="height:32px">
			<td>3.熟悉患者病情，全面掌握近期病情演变</td>
			<td style="text-align: center">5</td>
			<td><input onchange="saveScore(this,5);" itemId="1000-02-1.3" itemName="熟悉患者病情，全面掌握近期病情演变"  name="self"  class="input" type="text"  style="height:20px; text-align: center"  /></td>
		</tr>
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.1"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.2"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.3"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.4"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.5"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.6"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.7"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-2.8"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-3.1"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-3.2"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-3.3"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-3.4"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-3.5"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-4.1"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-4.2"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-4.3"
		...
		<tr style="height:32px">
			...
			<td style="text-align: center">5</td>
			<td>
				<input onchange="saveScore(this,5);" itemId="1000-02-5.1"
...
<div class="button">
	<input class="btn_green" type="button" value="打&#12288;印" onclick="printHospitalScore('evaluationInfo_1000_jx');"/>&#12288;
	<c:if test="${edit ne 'N'}">
