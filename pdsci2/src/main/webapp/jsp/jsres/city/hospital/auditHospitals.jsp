...
<script type="text/javascript">
	...
	function searchBase(baseFlow){
		jboxPost("<s:url value='/jsres/base/findBaseInfo'/>?auditFlag=${GlobalConstant.FLAG_Y}" , $("#searchForm").serialize() , function(resp){
			$("#content").html(resp);
		} , null , false);
	}
</script>
...
<%-- 	    </c:if> --%>
		<form id="searchForm">
		 ...
		 <input id="currentPage" type="hidden" name="role" id="role"value="${GlobalConstant.USER_LIST_CHARGE}"/>
