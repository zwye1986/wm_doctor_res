...
<head>
    ...
    <script>
        ...
        function doctorList(){
            ...
            jboxLoad("content","<s:url value='/jsres/doctorRecruit/provinceDoctorListAcc'/>?roleFlag="+roleFlag,true);
        }
...
// 为echarts对象加载数据
        ...
        function doctorDataMain() {
            var url = "<s:url value='/jsres/statistic/doctorDataMainAcc'/>?roleFlag=charge";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function countryBaseStatistics(){
            jboxLoad("content","<s:url value='/jsres/statistic/statisticCountryOrgAcc'/>?trainTypeId=AssiGeneral&sessionNumber=${pdfn:getCurrYear()}",true);
        }
        function jointBaseStatistics(){
            jboxLoad("content","<s:url value='/jsres/statistic/statisticJointOrgAcc'/>?trainTypeId=AssiGeneral&sessionNumber=${pdfn:getCurrYear()}",true);
        }
        function statisticsAppUser(){

            jboxLoad("content","<s:url value='/jsres/appUseInfo/mainAcc?userListScope=charge'/>",false);
        ...
        function changeBaseMain(){
            var url = "<s:url value='/jsres/manage/changeBaseAcc'/>";
            currentJboxLoadNoData("content", url, true);
        }
        ...
        function backTrain(){
            ...
            var url = "<s:url value='/jsres/doctor/changeBackTrainInfoAcc?sessionNumber=${pdfn:getCurrYear()}&currentPage=1'/>";
            currentJboxLoadNoData("content", url, true);
        }
        function speMain(){
	...
	jboxLoad("content","<s:url value='/jsres/certificateManage/freeMain'/>?roleFlag="+roleFlag,true);
        ...
        function graduactionStatisticsAcc(){
            jboxLoad("content", "<s:url value='/jsres/graduationStatistics/graduationDoctorStatisticsMain'/>?roleFlag=${GlobalConstant.USER_LIST_CHARGE}&catSpeId=AssiGeneral", true);
        }

        // 应结业学员查询
        function searchGraduactionDoctorAcc(){
            jboxLoad("content", "<s:url value='/jsres/graduationStatistics/searchGraduationDoctorList'/>?roleFlag=${GlobalConstant.USER_LIST_CHARGE}&catSpeId=AssiGeneral", true);
        }
    </script>
    <style>
                ...
                <div class="container">
                    <div class="content_side">
                      ...
                      <%--  <dl class="menu">
                            ...
                            &lt;%&ndash;<dd class="menu_item"><a onclick="asseAudit();">考核资格审核</a></dd>&ndash;%&gt;
                            ...
                            &lt;%&ndash;<dd class="menu_item"><a href="javascript:signUpmain();">补考审核</a></dd>&ndash;%&gt;
                            <dd class="menu_item"><a onclick="asseAuditList();">结业考核资格查询</a></dd>
                            &lt;%&ndash;<dd class="menu_item"><a onclick="skillManage()">技能考试管理</a></dd>&ndash;%&gt;
