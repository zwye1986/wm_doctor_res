...
<head>
	...
	<script type="text/javascript">
		function save() {
			...
			if(external=='0'&&!$("#cityAuditOpinion").val()) {
				jboxTip("请输入审核意见！");
				return false;
			}
...
<div class="infoAudit">
	<div class="div_table">
		<form id="editForm" style="position: relative;" method="post">
			...
			<input type="hidden" name="roleFlag" value="charge"/>
			<table border="0" cellpadding="0" cellspacing="0" class="base_info">
				...
				<tr>
					<th>市局审核意见：</th>
					<td><textarea  name="cityAuditOpinion" id="cityAuditOpinion" type="text" style="width: 260px;height: 120px;"></textarea>
					</td>
				</tr>
				</tbody>
			</table>
