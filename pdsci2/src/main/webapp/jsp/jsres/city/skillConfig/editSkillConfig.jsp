...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            addPerson();
            var flag = '${resSkillConfig.skillWay}';
            if (flag == 'order') {
                $(".order").show();
            } else {
                $(".order").hide();
    ...
    <form id="saveCfgForm" style="position: relative;">
        ...
        <table class="grid" style="width:100%; margin-bottom: 10px; margin-top: 30px;">
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: left">
                    <input type="radio" name="skillWay" value="order" onchange="isShow('Y');"
                           <c:if test="${resSkillConfig.skillWay eq 'order'}">checked="checked"</c:if>>预约
                    <input type="radio" name="skillWay" value="export" onchange="isShow('N');"
                           <c:if test="${resSkillConfig.skillWay eq 'export'}">checked="checked"</c:if>>导入
                </td>
            </tr>
            <tr  class="order">
                ...
                <td colspan="2" style="text-align: left">
                        <div class="">
                            <div style="width: 100%;height: 35px">
                                <span>查找：</span>
                                <input placeholder="输入名称搜索" type="text" class="input" value="" style="width: 50%" onkeyup="likeSearch(this.value);"/>
                            </div>
                                ...
                                <div style="width: 80%; margin-left: 10%;border: 1px solid #336544; overflow:auto;height: 300px">
                                    <c:forEach items="${orgs}" var="org">
                                        <div onclick="checkedDiv(this);" style="width: 100%;margin-top: 5px"
                                             orgName="${org.orgName}">
                                            <label>
                                                <input type="checkbox" readonly="readonly" name="orgFlow" id="orgFlow"
                                                       <c:if test="${pdfn:contain(org.orgFlow, orgList)}">checked</c:if> value="${org.orgFlow}"/>
                                                    ${org.orgName}
                                            </label>
