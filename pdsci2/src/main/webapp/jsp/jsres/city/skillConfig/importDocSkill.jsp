...
<head>
	...
	<script type="text/javascript">
		function daoRu(){
			...
			var url = "<s:url value='/jsres/skillTimeConfig/importDocSkill'/>";
			jboxSubmit(
					$('#excelForm'),
					url,
					function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	...
	<table class="grid" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<th>模板文件</th>
			<td style="text-align: left"><a href="<s:url value='/jsp/jsres/city/skillConfig/importDocSkill.xlsx'/>">&#12288;技能考核导入学员模板.xlsx</a></td>
		</tr>
	</table>
</form>
<div style="text-align: center; margin-top: 10px;">
	<input type="button" class="btn_green" onclick="daoRu();" value="导&#12288;入" class="btn_green"/>&#12288;
