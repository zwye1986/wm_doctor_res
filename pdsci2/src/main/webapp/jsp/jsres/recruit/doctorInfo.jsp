	...
	<div class="div_table">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="base_info">
			...
			<tbody>
				...
				<tr  class="graduateTh1 undergradTh1" style="display: none">
					<th>学历证书照片：</th>
					<td colspan="4">
				...
				<tr class="graduateTh2 undergradTh12" style="display: none">
					<th>学位证书照片：</th>
					<td colspan="4">
				...
				<tr  class="graduateTh2 undergradTh2" style="display: none">
					<th>学位证书编号：</th>
					<td>
				...
				<tr class="graduateTh">
			        <th>最高学历：</th>
			        <td colspan="8">${user.educationName}</td>
			    </tr>
			    ...
			    <tr>
			    	...
			    	<td class="masterTh"style="display: none;" colspan="2">
						<c:if test="${ empty euserResumeExt.masterDegreeTypeName}">
								<c:if test="${userResumeExt.masterDegreeTypeId eq '1' }">专业型</c:if>
								<c:if test="${userResumeExt.masterDegreeTypeId eq '2' }">学术型</c:if>
						</c:if>
						<c:if test="${!empty euserResumeExt.masterDegreeTypeName}">
							${userResumeExt.masterDegreeTypeName}
						</c:if>
				...
				<tr class="" id="masterTh1" style="display: none">
					<th>学历证书照片：</th>
					<td>
				...
				<tr class="masterTh2"  style="display: none">
					<th>学位证书编号：</th>
					<td>
						<input name="userResumeExt.masterDegreeNo" value="${userResumeExt.masterDegreeNo}" class="validate[required] input masterTh2"/>&#12288;</td>
					</td>
					<th>学位证书取得时间：</th>
					<td>
						<input name="userResumeExt.masterDegreeTime" value="${userResumeExt.masterDegreeTime}" class="input datepicker master validate[required] masterTh2" readonly="readonly"/>&#12288;</td>
					</td>
				</tr>
			    <tr>
			    	<th>是否为博士：</th>
			    	...
			    	<td class="doctorTh" style="display: none;"colspan="2">
							<c:if test="${ empty euserResumeExt.doctorDegreeTypeName}">
									<c:if test="${userResumeExt.doctorDegreeTypeId eq '1' }">专业型</c:if>
									<c:if test="${userResumeExt.doctorDegreeTypeId eq '2' }">学术型</c:if>
							</c:if>
							<c:if test="${!empty euserResumeExt.doctorDegreeTypeName}">
								${userResumeExt.doctorDegreeTypeName}
							</c:if>
					</td>
			    </tr>
		  	    <tr class="doctorTh">
