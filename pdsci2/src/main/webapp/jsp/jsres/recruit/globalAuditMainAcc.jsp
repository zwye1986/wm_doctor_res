...
<script type="text/javascript">
    ...
    function searchDoctor(source){
        ...
        jboxLoad("mainContent","<s:url value='/jsres/recruitDoctorInfo/auditMainAcc'/>?roleFlag="+roleFlag+"&source="+source,true);
    }
</script>
<div class="main_hd">
    <h2>招录学员审核</h2>
    <div class="title_tab">
        <ul>
            <li class="tab_select" onclick="searchDoctor('DoctorSend')"><a>报送审核</a></li>
            <li class="tab" onclick="searchDoctor('DoctorSignup')"><a>招录审核</a></li>
        </ul>
    </div>
</div>
