...
function auditRecruit(recruitFlow, doctorFlow, exType){
    var url = "<s:url value='/jsres/manage/global/doctor/auditRecruit'/>?openType=open&doctorSignupFlag=${source}&recruitFlow="+recruitFlow+"&doctorFlow="+doctorFlow + "&exType=" + exType;
		...
		<%--省厅市局查询条件--%>
			...
			<table class="searchTable">
				...
				<tr>
					...
					<td>
						<input type="text" name="idNo" id="idNo" value="${param.idNo}" class="input" />
					</td>
				</tr>
				<tr>
