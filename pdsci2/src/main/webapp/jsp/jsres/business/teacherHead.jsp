...
<script type="text/javascript">
    ...
    function searchTeaList(type){
        var url ="<s:url value='/jsres/business/teacherList'/>?checkStatusId="+type;
        jboxPostLoad("teacherContent", url, $("#searchForm").serialize(), true);
    }
...
<div class="main_hd">
    ...
    <div class="title_tab">
        <ul>
            <li class="tab_select" onclick="searchTeaList('Passing')"><a>待审核</a></li>
            <li class="tab" onclick="searchTeaList('Passed')"><a>审核通过</a></li>
