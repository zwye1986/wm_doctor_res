...
<script type="text/javascript">
    ...
    function save(userFlows,flag){
        ...
        var url = "<s:url value='/jsres/business/updateTeaCheck'/>?userFlows="+userFlows+"&flag="+flag+"&checkReason="+reason;
        jboxPost(url, $("#cfgForm").serialize(), function(resp){
            if(resp == "${GlobalConstant.SAVE_SUCCESSED}"){
                jboxTip("操作成功！");
                window.parent.searchTea();
                setTimeout(function(){
                    jboxClose();
                },2000);
            }else{
...
<div class="main_bd" id="div_table_0">
    <div class="div_search">
        ...
        <div style="text-align: center">
            <input class="btn_green" type="button" value="通&#12288;过"  onclick="save('${userFlows}','Y');" />
            <input class="btn_red" type="button" value="不通过"  onclick="save('${userFlows}','N');" />
