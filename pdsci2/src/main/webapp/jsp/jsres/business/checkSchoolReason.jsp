...
<script type="text/javascript">
    ...
    function save(dictFlows,flag){
        ...
        var url = "<s:url value='/jsres/business/updateSchoolCheck'/>?dictFlows="+dictFlows+"&flag="+flag+"&checkReason="+reason;
        jboxPost(url, $("#cfgForm").serialize(), function(resp){
            if(resp == "${GlobalConstant.SAVE_SUCCESSED}"){
                jboxTip("操作成功！");
                window.parent.searchSchool();
                setTimeout(function(){
                    jboxClose();
                },2000);
            }else{
...
<div class="main_bd" id="div_table_0">
    <div class="div_search">
        ...
        <div style="text-align: center">
            <input class="btn_green" type="button" value="通&#12288;过"  onclick="save('${dictFlows}','Y');" />
            <input class="btn_red" type="button" value="不通过"  onclick="save('${dictFlows}','N');" />
