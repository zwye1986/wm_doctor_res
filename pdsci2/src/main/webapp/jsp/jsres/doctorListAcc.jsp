			...
			<c:when test="${sessionScope.userListScope == GlobalConstant.USER_LIST_LOCAL}">
					<table class="searchTable">
						...
						<tr>
							...
							<td class="td_left" id="isPostpone1" style="display: none">是否延期：</td>
							<td id="isPostpone2" style="display: none">
						...
						<tr>
							<td colspan="8">
								...
								<input class="btn_green" type="button" value="导出" onclick="exportExcel();"/>
						...
						<c:if test="${sessionScope.userListScope ne GlobalConstant.USER_LIST_GLOBAL}">
							<tr>
								<td id="func" colspan="8">
									<input class="btn_green" style="margin-left: 0px;" type="button" value="导出" onclick="exportExcel();"/>&nbsp;
<%--
