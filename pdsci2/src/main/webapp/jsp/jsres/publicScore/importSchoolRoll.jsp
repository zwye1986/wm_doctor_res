...
function daoRu(){
	...
	jboxStartLoading();
	var url = "<s:url value='/jsres/doctorTheoryScore/importPublicScoreFromExcel'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table  class="grid" style="width: 100%;">
		...
		<tr>
			...
			<td style="text-align: left;"><a href="<s:url value='/jsp/jsres/publicScore/importPublicScore.xlsx'/>">学生公共科目成绩导入模板.xlsx</a></td>
		</tr>
	</table>
</form>
