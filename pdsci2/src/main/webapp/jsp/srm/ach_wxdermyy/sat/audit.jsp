...
<head>
    ...
    <script type="text/javascript">
        function saveAudit(agreeFlag, satFlow,tip) {
        ...
        <c:if test="${sat.operStatusId ne achStatusEnumFirstAudit.id}">
            ...
            <form method="post" id="auditForm">
                <div align="center">
                    ...
                    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${sat.satFlow}','审核通过')" type='button'
                           value='同&#12288;意'/>&#12288;
                    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${sat.satFlow}','退回')" type='button'
                           value='退&#12288;回'/>&#12288;
                </div>
            </form>
        </c:if>
