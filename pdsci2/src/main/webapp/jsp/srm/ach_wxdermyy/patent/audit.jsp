...
<head>
    ...
    <script type="text/javascript">
        function saveAudit(agreeFlag, patentFlow,tip) {
            ...
            jboxConfirm("确认" + tip + "?", function () {
                if (!savePat(agreeFlag)) return false;
        ...
        <c:if test="${patent.operStatusId ne achStatusEnumFirstAudit.id}">
            ...
            <form method="post" id="auditForm">
                <div style="text-align: center;">
                    ...
                    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${patent.patentFlow }','审核通过')"
                           type='button' value='同&#12288;意'/>&#12288;
                    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${patent.patentFlow }','退回')"
