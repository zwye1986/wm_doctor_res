                        ...
                        <c:if test="${not empty resultMap_ky.apply}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/apply/list/local/ky?recTypeId=Apply'/>"
                        ...
                        <c:if test="${not empty resultMap_ky.contract}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/contract/list/local/ky?recTypeId=Contract'/>"
                        ...
                        <c:if test="${not empty resultMap_ky.scheduleReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/local/ky?recTypeId=ScheduleReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.changeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/local/ky?recTypeId=ChangeReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.terminateReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/terminate/list/local/ky?recTypeId=TerminateReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.completeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/complete/list/local/ky?recTypeId=CompleteReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        ...
                        <c:if test="${not empty resultMap_qw.apply}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/apply/list/local/qw?recTypeId=Apply'/>"
                        ...
                        <c:if test="${not empty resultMap_qw.contract}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/contract/list/local/qw?recTypeId=Contract'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.scheduleReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/local/qw?recTypeId=ScheduleReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.changeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/local/qw?recTypeId=ChangeReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.terminateReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/terminate/list/local/qw?recTypeId=TerminateReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.completeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/complete/list/local/qw?recTypeId=CompleteReport'/>"
                                        style="color: red;">这里</a> 确认!
