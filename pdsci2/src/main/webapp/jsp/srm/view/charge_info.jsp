                        ...
                        <c:if test="${not empty resultMap_ky.apply}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/apply/list/charge/ky?recTypeId=Apply'/>"
                        ...
                        <c:if test="${not empty resultMap_ky.contract}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/contract/list/charge/ky?recTypeId=Contract'/>"
                        ...
                        <c:if test="${not empty resultMap_ky.scheduleReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/charge/ky?recTypeId=ScheduleReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.changeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/charge/ky?recTypeId=ChangeReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.terminateReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/terminate/list/charge/ky?recTypeId=TerminateReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${not empty resultMap_ky.completeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/complete/list/charge/ky?recTypeId=CompleteReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
                        ...
                        <c:if test="${not empty resultMap_qw.apply}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/apply/list/charge/qw?recTypeId=Apply'/>"
                        ...
                        <c:if test="${not empty resultMap_qw.contract}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/contract/list/charge/qw?recTypeId=Contract'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.scheduleReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/charge/qw?recTypeId=ScheduleReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.changeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/schedule/list/charge/qw?recTypeId=ChangeReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.terminateReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/terminate/list/charge/qw?recTypeId=TerminateReport'/>"
                                        style="color: red;">这里</a> 确认!
                        ...
                        <c:if test="${not empty resultMap_qw.completeReport}">
                            <tr>
                                <td style="text-align: left;padding-left: 20px">您有 <font
                                        ...
                                        href="<s:url value='/srm/proj/complete/list/charge/qw?recTypeId=CompleteReport'/>"
                                        style="color: red;">这里</a> 确认!
                                </td>
                            </tr>
                        </c:if>
