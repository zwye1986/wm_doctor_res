...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveSecondScore(){
            if((parseFloat($("#scoreSum").val())/20).toFixed(2) > 10){
            ...
            if ($("#myForm").validationEngine("validate")) {
                jboxPost("<s:url value='/srm/expert/proj/saveSecondScore?expertProjFlow=${expertProjFlow}&itemFlow=${itemFlow}'/>",$('#myForm').serialize(),function(resp){
                    if(resp=="${GlobalConstant.SAVE_SUCCESSED}") {
                        window.parent.frames['mainIframe'].$("#itemFlow${itemFlow}").text((parseFloat($("#scoreSum").val())/20).toFixed(2));
                        window.parent.frames['mainIframe'].$("#itemFlow${itemFlow}").prev().val((parseFloat($("#scoreSum").val())/20).toFixed(2));
                        var obj = window.parent.frames['mainIframe'].$("#scoreTotal");
                        $(obj).val(accSub(accAdd($(obj).val(),(parseFloat($("#scoreSum").val())/20).toFixed(2)),(parseFloat(${empty dataMap['scoreSum']?0:dataMap['scoreSum']})/20).toFixed(2)));
                        jboxClose();
                    }
                },null,true);
            }
...
<div style="width:100%;height:100%;overflow:auto;">
    <form id="myForm">
        <input type="hidden" name="jzScore" value="20"><!-- 基准分 -->
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            <tr>
                <th colspan="7" style="text-align: center"><h2 style="font-size:150%">团队发展潜力</h2></th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score9']?'':dataMap['score9'] * 10}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score10']?'':dataMap['score10'] * 5}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score11']?'':dataMap['score11'] * 3}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score12']?'':dataMap['score12'] * 20}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score13']?'':dataMap['score13'] * 15}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score14']?'':dataMap['score14'] * 10}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score15']?'':dataMap['score15'] * 7}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score16']?'':dataMap['score16'] * 5}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score17']?'':dataMap['score17'] * 1}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">5</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]] zlScore" size="10" name="score" value="${dataMap['score19']}" onblur="limitScore(this,'Y')"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score19']?'':dataMap['score19'] * 5}"/></th>
                <th rowspan="2" style="text-align: center;">合计最高15分</th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><input type="text" class="validate[custom[number]] zlScore" size="10" name="score" value="${dataMap['score20']}" onblur="limitScore(this,'Y')"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score20']?'':dataMap['score20'] * 2}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: left;">&nbsp;1、年龄、职称、学缘结构合理，博士占30%以上</th>
                <th style="text-align: center;">10</th>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score21']?'':dataMap['score21'] * 10}"/></th>
            ...
            <tr>
                <th style="text-align: left;">&nbsp;2、年龄、职称、学缘结构比较合理，博士占20%以&#12288;&#12288;上</th>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score22']?'':dataMap['score22'] * 6}"/></th>
                <th style="text-align: center;"><input type="text" name="remark" style="width:110px;" value="${remarkMap['score22']}"/></th>
            </tr>
            <tr>
                <th style="text-align: left;">&nbsp;3、年龄、职称、学缘结构不够合理，博士占10%以&#12288;&#12288;上</th>
                <th style="text-align: center;">3</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]]" size="10" name="score" value="${dataMap['score23']}" onblur="limitScore(this)"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score23']?'':dataMap['score23'] * 3}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">10</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]]" size="10" name="score" value="${dataMap['score24']}" onblur="limitScore(this)"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score24']?'':dataMap['score24'] * 10}"/></th>
                <th rowspan="3" style="text-align: center;"></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">6</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]]" size="10" name="score" value="${dataMap['score25']}" onblur="limitScore(this)"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score25']?'':dataMap['score25'] * 6}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">3</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]]" size="10" name="score" value="${dataMap['score26']}" onblur="limitScore(this)"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score26']?'':dataMap['score26'] * 3}"/></th>
            ...
            <tr>
                <th style="text-align:left;" colspan="7">&#12288;等次评定标准：每20分折算“领军人才学术水平”1分，得分≥160分为优秀；≥100为良好；<100分为一般。</th>
            </tr>
        </table>
    </form>
