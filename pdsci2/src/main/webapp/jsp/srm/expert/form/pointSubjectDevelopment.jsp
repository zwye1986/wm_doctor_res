...
<div style="width:100%;height:100%;overflow:auto;">
    <form id="myForm">
        ...
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            ...
            <tr>
                <th style="text-align: left;">&nbsp;4、省级学会专科分会专业学组组长、市级学会主&#12288;&#12288;&#12288;委、副主委（减半计分）</th>
                <th style="text-align: center;">5</th>
            ...
            <tr>
                ...
                <th style="text-align: center;">5</th>
                <th style="text-align: center;"><input type="text" class="validate[thcustom[number]] zlScore" size="10" name="score" value="${dataMap['score19']}" onblur="limitScore(this,'Y')"></th>
            ...
            <tr>
                <th rowspan="2" style="text-align: center;">学科基础</th>
                <th style="text-align: left;">&nbsp;1、国家临床重点专科</th>
                <th style="text-align: center;">10</th>
                <th style="text-align: center;"><input type="text" class="validate[thcustom[number]]" size="10" name="score" value="${dataMap['score21']}" onblur="limitScore(this)"></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score22']?'':dataMap['score22'] * 5}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score23']?'':dataMap['score23'] * 10}"/></th>
                <th rowspan="3"></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score24']?'':dataMap['score24'] * 6}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score25']?'':dataMap['score25'] * 3}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score26']?'':dataMap['score26'] * 10}"/></th>
                <th rowspan="3"></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score27']?'':dataMap['score27'] * 6}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score28']?'':dataMap['score28'] * 3}"/></th>
