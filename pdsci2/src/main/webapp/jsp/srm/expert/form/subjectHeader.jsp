            ...
            if ($("#myForm").validationEngine("validate")) {
                jboxPost("<s:url value='/srm/expert/proj/saveSecondScore?expertProjFlow=${expertProjFlow}&itemFlow=${itemFlow}'/>",$('#myForm').serialize(),function(resp){
                    if(resp=="${GlobalConstant.SAVE_SUCCESSED}") {
                        ...
                        $(obj).val(accSub(accAdd(parseFloat($(obj).val()),(parseFloat($("#scoreSum").val())/10).toFixed(2)),(parseFloat(${empty dataMap['scoreSum']?0:dataMap['scoreSum']})/10).toFixed(2)));
                        jboxClose();
                    }
                },null,true);
            }
    ...
    <form id="myForm">
        ...
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score23']?'':dataMap['score23'] * 2}"/></th>
