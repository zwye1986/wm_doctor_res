...
<div style="width:100%;height:100%;overflow:auto;">
    <form id="myForm">
        ...
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            <tr>
                <th colspan="7" style="text-align: center"><h2 style="font-size:150%">学科带头人</h2></th>
            </tr>
            <tr>
            ...
            <tr>
                <th style="text-align: left;">&nbsp;4、省级学会专科分会专业学组组长、市级学会主委</th>
                <th style="text-align: center;">5</th>
            ...
            <tr>
                <th rowspan="2" style="text-align: center;">科研项目</th>
                ...
                <th rowspan="2" style="text-align: center;">同一项目按照最高层次得分记一次，不同项目可累加计分。</th>
            ...
            <tr>
                <th rowspan="4" style="text-align: center;">科技成果</th>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score15']?'':dataMap['score15'] * 20}"/></th>
                <th rowspan="4" style="text-align: center;">只计排名前三成果，按照排名倒比计分。同一成果按照最高层次得分记一次，不同成果可累加计分。</th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score16']?'':dataMap['score16'] * 15}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score17']?'':dataMap['score17'] * 10}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score18']?'':dataMap['score18'] * 7}"/></th>
            ...
            <tr>
                <th style="text-align:left;" colspan="7">&#12288;等次评定标准：每10分折算“领军人才学术水平”1分，得分≥80分为优秀；≥50为良好；<50分为一般。</th>
            </tr>
        </table>
    </form>
