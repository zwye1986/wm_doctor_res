...
<div style="width:100%;height:100%;overflow:auto;">
    <form id="myForm">
        ...
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            <tr>
                <th colspan="7" style="text-align: center"><h2 style="font-size:150%">已有业绩与发展潜力</h2></th>
            </tr>
            <tr>
            ...
            <tr>
                <th style="text-align: center;">研究生导师</th>
                <th style="text-align: left;">&nbsp;1、硕士生导师</th>
            ...
            <tr>
                <th rowspan="3" style="text-align: center;">学会任职</th>
                <th style="text-align: left;">&nbsp;1、全国学会委员、青年委员及以上、省级学会常&#12288;&#12288;&#12288;委、专业学组组长</th>
                <th style="text-align: center;">15</th>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score8']?'':dataMap['score8'] * 15}"/></th>
                <th rowspan="3" style="text-align: center;">中华医学会、中华中医药学会系列学会任职按最高层次得分记一次，不重复计分。</th>
                <th style="text-align: center;"><input type="text" name="remark" style="width:110px;" value="${remarkMap['score8']}"/></th>
            </tr>
            <tr>
                <th style="text-align: left;">&nbsp;2、省级学会委员、青年委员、市级学会副主委</th>
                <th style="text-align: center;">10</th>
            ...
            <tr>
                <th style="text-align: left;">&nbsp;3、市级学会委员</th>
                <th style="text-align: center;">5</th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score11']?'':dataMap['score11'] * 15}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score12']?'':dataMap['score12'] * 7}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score13']?'':dataMap['score13'] * 5}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score14']?'':dataMap['score14'] * 20}"/></th>
                <th rowspan="5" style="text-align: center;">个人排名进入前三的成果可计分，按照排名倒比计分，同一成果按照最高层次得分记一次，不同成果可累加计分。</th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score15']?'':dataMap['score15'] * 15}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score16']?'':dataMap['score16'] * 10}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score17']?'':dataMap['score17'] * 7}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score18']?'':dataMap['score18'] * 5}"/></th>
            ...
            <tr>
                <th style="text-align: left;">&nbsp;2、中华医学系列杂志（非核心期刊论文减半计分）</th>
                <th style="text-align: center;">1</th>
                ...
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score20']?'':dataMap['score20'] * 1}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">5</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]] zlScore" size="10" name="score" value="${dataMap['score21']}" onblur="limitScore(this,'Y')"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score21']?'':dataMap['score21'] * 5}"/></th>
            ...
            <tr>
                ...
                <th style="text-align: center;">2</th>
                <th style="text-align: center;"><input type="text" class="validate[custom[number]] zlScore" size="10" name="score" value="${dataMap['score22']}" onblur="limitScore(this,'Y')"></th>
                <th style="text-align: center;"><fmt:formatNumber type="number" value="${empty dataMap['score22']?'':dataMap['score22'] * 2}"/></th>
