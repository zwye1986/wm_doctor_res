...
<div style="width:100%;height:100%;overflow:auto;">
    <form id="myForm">
        ...
        <table  class="basic" style="margin:10px 0px 0px 0px;">
            <tr>
                <th colspan="7" style="text-align: center"><h2 style="font-size:150%">领军人才学术水平</h2></th>
            </tr>
            <tr>
            ...
            <tr>
                <th rowspan="2" style="text-align: center;">人才荣誉称号</th>
            ...
            <tr>
                ...
                <th rowspan="4" style="text-align: center;">同一成果按照最高层次得分记一次，不同成果可累加计分。</th>
