...
//            searchInfo();
        ...
        function expert() {
            var url = "<s:url value='/srm/ach/copyright/exportCopyrightExcel/global'/>";
                    ...
                    <select id="chargeOrg" name="chargeOrgFlow" onchange="loadApplyOrg();" class="xlselect">
                        ...
                        <c:forEach var="chargeOrg" items="${firstGradeOrgList}">
                            <option value="${chargeOrg.orgFlow}"
                                    <c:if test="${chargeOrg.orgFlow eq param.chargeOrgFlow}">selected="selected"</c:if> >${chargeOrg.orgName}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="searchDiv">
