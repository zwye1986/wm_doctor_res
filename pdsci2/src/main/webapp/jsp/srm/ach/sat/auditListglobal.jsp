...
//            searchInfo();
        ...
        function expert() {
            var url = "<s:url value='/srm/ach/sat/exportSatExcel/global'/>";
...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/srm/ach/sat/auditList/global"/>" method="post">
                <p>
                <div class="searchDiv">
                    &#12288;科技名称：
