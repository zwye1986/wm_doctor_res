...
function saveAudit(agreeFlag,appraisalFlow){
	var tip =  agreeFlag=="${GlobalConstant.FLAG_Y}"?"审核通过":"退回";
	var url = "<s:url value='/srm/ach/appraisal/saveAudit'/>?agreeFlag="+agreeFlag+"&appraisalFlow="+appraisalFlow;
...
<div class="mainright">
    <div class="content">
		...
		<div style="text-align: center;">
		    ...
		    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${appraisal.appraisalFlow }')" type='button'  value='同&#12288;意' />&#12288;
			<input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${appraisal.appraisalFlow }')" type='button' value='退&#12288;回'/>&#12288;
		</div>
		</form>
	</div>
</div> 
