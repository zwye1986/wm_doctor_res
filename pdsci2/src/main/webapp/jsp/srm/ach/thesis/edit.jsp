		...
		<div id="look">
     	<form id="srmThesis" action="<s:url value="/srm/ach/thesis/save"/>" method="post" style="position: relative;" enctype="multipart/form-data">
			...
			<table class="basic" style="width: 100%">
				...
				<tr>
					<th width="20%">关键字：</th>
					<td><input type="text" class="xltext" style="width: 97%;" name="keyWord"  placeholder="例如：关键字1 关键字2(100个字符以内)" value="${thesis.keyWord}" onblur="strChar(this,100)"/></td>
				</tr>
				<tr>
					<th width="20%">论文摘要：</th>
					<td><textarea class="xltxtarea" style="margin-left: 0px;" maxlength="1000" name="summary" onblur="strChar(this,1000)">${thesis.summary}</textarea></td>
				</tr>
				<tr>
					<th width="20%">备注信息：</th>
					<td><textarea class="xltxtarea" style="margin-left: 0px;" placeholder="100个字符以内" name="remark" onblur="strChar(this,100)">${thesis.remark}</textarea></td>
				</tr>
			</table>
				...
				<tr>
					<th colspan="8" class="bs_name"> 论文作者<c:if test="${param.editFlag != GlobalConstant.FLAG_N}">
                        ...
                        <a href="javascript:void(0)"><img src="<s:url value='/'/>css/skin/${skinPath}/images/add.png"
														   onclick="addAuthor();" title="添加"></img></a></c:if></c:if></th>
		   		</tr>
				<tr>
