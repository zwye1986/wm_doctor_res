...
//            searchInfo();
        ...
        function expert() {
            var url = "<s:url value='/srm/ach/thesis/exportThesisExcel/global'/>";
...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/srm/ach/thesis/auditList/global"/>" method="post">
                <p>
                <div class="searchDiv">
                    &#12288;发表时间：
                    ...
                    <select name="projSourceId" class="xlselect">
                        ...
                        <c:forEach items="${dictTypeEnumProjSourceList }" var="dict">
                            <option value="${dict.dictId }"
                                    <c:if test="${param.projSourceId eq dict.dictId }">selected="selected"</c:if>>${dict.dictName }</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="searchDiv">
