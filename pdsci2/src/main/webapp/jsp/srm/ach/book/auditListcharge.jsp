...
<head>
    ...
    <script type="text/javascript">
        ...
        function expert() {
            var url = "<s:url value='/srm/ach/book/exportBookExcel/charge'/>";
...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/srm/ach/book/auditList/charge"/>" method="post">
                <p>
                <div class="searchDiv">
                    &#12288;出版日期：
        ...
        <table class="xllist">
            ...
            <c:forEach items="${bookList}" var="book">
                <tr>
                    ...
                    <td>
                            <%-- <input type="button" class="search" onclick="edit('${book.bookFlow}','look');" value="查看"/> --%>
