...
function saveAudit(agreeFlag,topicFlow){
	var tip =  agreeFlag=="${GlobalConstant.FLAG_Y}"?"审核通过":"退回";
	var url = "<s:url value='/srm/ach/topic/saveAudit'/>?agreeFlag=" + agreeFlag + "&topicFlow=" + topicFlow;
...
<div class="mainright">
    <div class="content">
		...
		<div align="center">
		    ...
		    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${topic.topicFlow}')" type='button'  value='同&#12288;意' />&#12288;
			<input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${topic.topicFlow}')" type='button' value='退&#12288;回'/>&#12288;
		</div>
		</form>
	</div>
</div> 
