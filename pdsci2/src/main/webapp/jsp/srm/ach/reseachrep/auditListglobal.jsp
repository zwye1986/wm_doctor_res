...
//            searchInfo();
        ...
        function expert() {
            var url = "<s:url value='/srm/ach/reseachrep/exportReseachrepExcel/global'/>";
...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/srm/ach/reseachrep/auditList/global"/>" method="post">
                <p>
                <div class="searchDiv">
                    &#12288;提交时间：
                    <input class="xltext ctime" style="width:158px;" type="text" name="submitDate"
                    ...
                    <select id="chargeOrg" name="chargeOrgFlow" onchange="loadApplyOrg();" class="xlselect">
                        ...
                        <c:forEach var="chargeOrg" items="${firstGradeOrgList}">
                            <option value="${chargeOrg.orgFlow}"
                                    <c:if test="${chargeOrg.orgFlow==param.chargeOrgFlow}">selected="selected"</c:if> >${chargeOrg.orgName}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="searchDiv">
