...
<div id="main">
    <div class="mainright">
        <div class="content">
            <p style="padding-top: 15px; padding-bottom:10px; font-weight: bold;">医院账户管理</p>
            <div>
                <span>账号：${hospitalFundInfo.accountNo}&#12288;&#12288;</span>
                <span>经费总额：${empty hospitalFundInfo.realityAmount ? 0:pdfn:transMultiply(hospitalFundInfo.realityAmount,10000)}（元）&#12288;&#12288;</span>
                <span>已报销金额：${empty hospitalFundInfo.yetPaymentAmount ? 0:pdfn:transMultiply(hospitalFundInfo.yetPaymentAmount,10000)}（元）&#12288;&#12288;</span>
                <span>剩余金额：${empty hospitalFundInfo.realityBalance ? 0:pdfn:transMultiply(hospitalFundInfo.realityBalance,10000)}（元）</span>
            </div>
            <p>
                <c:if test="${sessionScope.projListScope eq 'finance'}">
                <a href="javascript:void(0)" onclick="selectAuthor('${hospitalFundInfo.fundFlow}')" style="float: right;margin-right: 30px;font-size: 16px">[添加报销]</a>
                </c:if>
            </p>
