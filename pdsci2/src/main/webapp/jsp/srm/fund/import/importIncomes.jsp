...
<head>
    ...
    <script type="text/javascript">
        function importUsers(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/srm/fund/importIncomesFromExcel'/>";
    ...
    <div class="content">
        ...
        <form id="excelForm" method="post" enctype="multipart/form-data">
            <table width="100%" class="basic">
                ...
                <tr>
                    <th>模板文件</th>
                    <td style="padding-left:10px;"><a href="<s:url value='/jsp/srm/fund/import/template/IncomeTemplate.xlsx'/>">经费到账导入模板.xlsx</a></td>
                </tr>
            </table>
            <br/>
            <p style="text-align: center;">
                <input type="button" onclick="importUsers();" value="经费到账导入" class="search"/>
            </p>
        </form>
    </div>
</div>
