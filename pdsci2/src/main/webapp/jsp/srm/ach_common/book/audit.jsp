...
<head>
    ...
    <script type="text/javascript">
        function saveAudit(agreeFlag, bookFlow,tip) {
    ...
    <div class="content">
        ...
        <form method="post" id="auditForm">
            <div style="text-align: center;">
                ...
                <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${book.bookFlow }','审核通过')" type='button'
                       value='同&#12288;意'/>&#12288;
                <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${book.bookFlow }','退回')" type='button'
                       value='退&#12288;回'/>&#12288;
            </div>
        </form>
        </c:if>
