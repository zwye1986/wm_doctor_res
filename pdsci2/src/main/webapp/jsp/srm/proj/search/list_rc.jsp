...
<script type="text/javascript">
    ...
    function expExcel(){
        var url="<s:url value='/srm/proj/search/rcExport'/>";
        jboxTip("导出中…………");
    ...
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm"
                ...
                <div class="searchDiv">
                    人才编号：
                    <input name="projNo" value="${param.projNo}" class="xltext"/>
                </div>
                ...
                <div class="searchDiv">
                    ...
                    <input type="button" class="search" onclick="expExcel();" value="导出Excel">
                </div>
            </form>
        </div>
