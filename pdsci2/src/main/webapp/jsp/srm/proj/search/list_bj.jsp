            ...
            <form id="searchForm"
                ...
                <div class="searchDiv">
                    ...
                    <select class="xlselect" name="projTypeId">
                        ...
                        <c:forEach var="dict" items="${dictTypeEnumAwardTypeList}">
                ...
                <div class="searchDiv">
                    ...
                    <select name="projStatusId" class="xlselect">
                        ...
                        <option <c:if test="${param.projStatusId eq 'Apply'}">selected="selected"</c:if> value="Apply">申报填写</option>
                        <option <c:if test="${param.projStatusId eq 'Submit'}">selected="selected"</c:if> value="Submit">申报提交</option>
                        <option <c:if test="${param.projStatusId eq 'FirstAudit'}">selected="selected"</c:if> value="FirstAudit">承担单位审核通过</option>
                        <option <c:if test="${param.projStatusId eq 'SecondAudit'}">selected="selected"</c:if> value="SecondAudit">主管部门审核通过</option>
                        <option <c:if test="${param.projStatusId eq 'SecondBack'}">selected="selected"</c:if> value="SecondBack">主管部门退回</option>
                        <option <c:if test="${param.projStatusId eq 'ThirdBack'}">selected="selected"</c:if> value="ThirdBack">${sysCfgMap['top_org_level']}审核退回</option>
                        <option <c:if test="${param.projStatusId eq 'Approving'}">selected="selected"</c:if> value="Approving">发奖审核中</option>
                        <option <c:if test="${param.projStatusId eq 'AwardPrizes'}">selected="selected"</c:if> value="AwardPrizes">确认发奖</option>
                        <option <c:if test="${param.projStatusId eq 'NoPrizes'}">selected="selected"</c:if> value="NoPrizes">不发奖</option>
                    </select>
                </div>
                <c:if test='${sessionScope.projListScope=="charge"}'>
                    <div class="searchDiv">
                        ...
                        <input id="orgFlow" name="applyOrgFlow" class="input" value="${param.applyOrgFlow}" type="hidden"
