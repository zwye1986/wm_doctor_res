                ...
                <div class="searchDiv">
                    ...
                    <select name="projTypeId" class="xlselect">
                        ...
                        <c:forEach var="dictEnuAwardType" items="${dictTypeEnumAwardTypeList}">
                            <option value="${dictEnuAwardType.dictId}"
                                    <c:if test='${param.projTypeId==dictEnuAwardType.dictId}'>selected="selected"</c:if>>${dictEnuAwardType.dictName}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="searchDiv">
