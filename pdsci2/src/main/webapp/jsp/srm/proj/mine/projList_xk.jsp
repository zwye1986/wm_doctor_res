...
<head>
    ...
    <script type="text/javascript">
        ...
        function applyProj() {
            var applyLimit = "${sysCfgMap['researcher_apply_limit_xk']}";
            var projCategoryId = "${projCategroyEnumXk.id}";
            if (applyLimit != "") {
                var data = {
                ...
                jboxPost(url, data, function (resp) {
                    if ("${GlobalConstant.FLAG_Y}" == resp) {
                        ...
                        jboxInfo("您本年度申请重点学科项目数已满，无法继续申请！");
                    } else {
                        return false;
                    }
                }, null, false);
        ...
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/srm/proj/mine/projList/${sessionScope.projCateScope}" />"
                ...
                <div class="searchDiv">
                    ...
                    <input type="button" class="search" style="width: 100px" onclick="applyProj();" value="申报新学科">
                </div>
            </form>
        </div>
        <table class="xllist">
            ...
            <tr>
                ...
                <th width="20%" rowspan="2">学科名称</th>
                <th width="12%" rowspan="2">学科类型</th>
