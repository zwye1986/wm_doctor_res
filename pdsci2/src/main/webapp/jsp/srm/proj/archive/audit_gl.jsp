...
<div class="mainright">
    <div class="content">
        ...
        <div>
            <form id="projForm"
                  action="<s:url value='/srm/proj/archive/saveAudit/${sessionScope.projListScope}/${sessionScope.projCateScope}'/>"
                  method="post">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr style="height: 25px; background-image: url(../css/skin/${skinPath}/images/top_bg.jpg); background-repeat: repeat-x">
                                    <td colspan="2" style="width: 100%; text-align: left">
                                        &#12288;&#12288;&#12288;<span style="font-weight: bold">项目审核信息：<font
                                            color="red"> 项目被退回时必须填写“审核意见”(最多200个字)</font></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="width:17%">归档意见：</th>
                                    <td style="text-align: left;padding-left: 0px;">
                                        <textarea id="sub" name="sub" class="validate[maxSize[200]] textbox" rows="6"
                                                  cols="20" style="width:100%;resize :none"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;padding-top:5px;">
                                        <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}')"
                                               type='button' value='归&#12288;档'/>
