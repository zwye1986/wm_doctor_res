...
//            searchInfo();
        ...
        function reAuditOption(projFlow) {
            jboxConfirm("确认申报重审？",function(){
                jboxPost("<s:url value='/srm/proj/approve/reAuditOption?projFlow='/>"+projFlow,null,function(resp){
        ...
        <table class="xllist">
            ...
            <c:forEach var="proj" items="${projList}">
                <tr>
                    ...
                    <td>
                        [<a href="javascript:void(0)" onclick="reAuditOption('${proj.projFlow}')">申报重申</a>]&nbsp;
