    	...
    	<div class="content">
        	<div class="title1 clearfix">
              ...
              <div>
              	...
              	<table class="xllist">
              		<tr><th style="text-align: left;"> &#12288;报奖评审信息：
	        	  ...
	        	  <table class='basic' width="100%" style="margin-top:10px;">
	        	  	<tr>
							<th colspan="4" style="text-align: left;">
	                            &#12288;<span style="font-weight: bold">确认发奖意见：<font color="red"> 确认发奖意见(最多200个字)</font></span>
	                        </th>
						</tr>
						<%--<tr>--%>
        	  ...
        	  <div style='text-align: center;margin-top: 20px;'>
        	  		<input onclick="saveApprove('${GlobalConstant.FLAG_Y}');"  class="search" type="button" value="发&#12288;奖"/>
        	  		<input onclick="saveApprove('${GlobalConstant.FLAG_N}');"  class="search" type="button" value="不&nbsp;发&nbsp;奖"/>
