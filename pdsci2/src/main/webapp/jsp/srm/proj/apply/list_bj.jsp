            ...
            <form id="searchForm"
                ...
                <div class="searchDiv">
                    ...
                    <select class="xlselect" name="projTypeId">
                        ...
                        <c:forEach var="dictAwardType" items="${dictTypeEnumAwardTypeList}">
                            <option value="${dictAwardType.dictId}"
                                    <c:if test='${param.projTypeId==dictAwardType.dictId}'>selected="selected"</c:if>>${dictAwardType.dictName}</option>
                        </c:forEach>
                    </select>
                </div>
                <c:if test='${sessionScope.projListScope=="charge"}'>
