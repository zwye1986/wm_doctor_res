                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 85%; text-align: left">
                            <textarea id="auditContent" name="auditContent" rows="6" cols="20"  class="textbox validate[maxSize[200]]" style="width:90%;" placeholder="请填写审核意见..."></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <input class='search' onclick="checkApplyLimit('${GlobalConstant.FLAG_Y}')" type='button'  value='同&#12288;意' />&#12288;
