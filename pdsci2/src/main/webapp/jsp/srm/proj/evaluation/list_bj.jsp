...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            ...
            <form id="searchForm"
                  action="<c:if test='${(evaluationId eq evaluationEnmuApproveEvaluation.id) or (evaluationId eq evaluationEnmuAwardEvaluation.id)}'><s:url value="/srm/proj/evaluation/approveList/${sessionScope.projListScope}/${sessionScope.projCateScope}" /></c:if><c:if test='${evaluationId eq evaluationEnmuCompleteEvaluation.id}'><s:url value="/srm/proj/evaluation/completeList/${sessionScope.projListScope}/${sessionScope.projCateScope}" /></c:if>"
                  method="post">
                <p>
                <div class="searchDiv">
                    年&#12288;&#12288;份：
