      ...
      <div class="content">
        <div class="title1 clearfix">
          ...
          <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">临床医学中心（创新平台）人员信息</a></li>
            ...
            <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">协作科室</a></li>
