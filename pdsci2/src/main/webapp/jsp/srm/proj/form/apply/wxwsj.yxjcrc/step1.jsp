            ...
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            <td style="text-align: right;" colspan="2">是否为省级、市级人才培养对象：</td>
                        ...
                        <tr>
                            <th colspan="6" style="text-align: left;padding-left: 20px;"><font color="red">*</font>个人简介（业务能力、学术地位等）</th>
                        </tr>
                        <tr>
                            <td colspan="6"><textarea class="validate[required]" name="personalInfo" style="width:98%;height: 150px;">${resultMap.personalInfo}</textarea></td>
                        </tr>
                    </table>
                </form>
                <c:if test="${param.view!=GlobalConstant.FLAG_Y}">
                    <div align="center" style="margin-top: 10px">
                        <input id="prev" type="button" onclick="nextOpt('step0')" class="search" value="上一步"/>
