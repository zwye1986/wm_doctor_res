	...
	<div class="mainright">
    	<div class="content">
    		<ul id="tags">
	            ...
	            <li id='tag1'><a onclick="selectTag('tagContent1','tag1')" href="javascript:void(0)">学科简述</a></li>
	            <li id='tag2'><a onclick="selectTag('tagContent2','tag2')" href="javascript:void(0)">学科建设具体指标</a></li>
	            <li id='tag3'><a onclick="selectTag('tagContent3','tag3')" href="javascript:void(0)">学科带头人情况</a></li>
	            <li id='tag4'><a onclick="selectTag('tagContent4','tag4')" href="javascript:void(0)">经费来源与支出预算</a></li>
	            <li id='tag5'><a onclick="selectTag('tagContent5','tag5')" href="javascript:void(0)">有关指标</a></li>
        	</ul>
