            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">带头人概况</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">带头人简历</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">带头人业绩</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">创新团队简介</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">创新团队主攻方向</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">创新团队人员信息</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">创新团队主要业绩（一）</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">创新团队主要业绩（二）</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">影响因子统计</a></li>
                        <li><a onclick="selectTag('tagContent10',this)" href="javascript:void(0)">依托科室条件</a></li>
                        <li><a onclick="selectTag('tagContent11',this)" href="javascript:void(0)">经费预算</a></li>
                        <li><a onclick="selectTag('tagContent12',this)" href="javascript:void(0)">概述协作任务</a></li>
                        <li><a onclick="selectTag('tagContent13',this)" href="javascript:void(0)">审核意见</a></li>
                        <li><a onclick="selectTag('tagContent14',this)" href="javascript:void(0)">附件信息</a></li>
                    </ul>
                </div>
                <div id="tagContent" style="margin-top:30px;">
                    ...
                    <div class="tagContent" id="tagContent13" style="padding-top: 0px;">
                        <jsp:include page="step12.jsp">
                            <jsp:param name="view" value="${ GlobalConstant.FLAG_Y}"/>
                        </jsp:include>
                    </div>
                    <div class="tagContent" id="tagContent14" style="padding-top: 0px;">
                        <jsp:include page="step13.jsp">
                            <jsp:param name="view" value="${ GlobalConstant.FLAG_Y}"/>
                        </jsp:include>
                    </div>
                </div>
