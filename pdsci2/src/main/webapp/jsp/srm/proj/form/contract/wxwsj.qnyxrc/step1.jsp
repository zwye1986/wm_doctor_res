        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333; ">无锡市青年医学重点人才培养合同书</font>
                    <table class="basic" style="width: 100%">
                        <tr>
                            <th colspan="2" class="theader"></th>
                        </tr>
                        <tr>
                            <td width="200px;" style="text-align: center">人才姓名：</td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;padding-left: 10px;" colspan="3">
                                <input type="text" class="validate[required] inputText" name="baseTaskName"
                                       value="<c:if test='${empty resultMap.baseTaskName and param.view!=GlobalConstant.FLAG_Y}'>${proj.projName}</c:if><c:if test='${! empty resultMap.baseTaskName}'>${resultMap.baseTaskName}</c:if>" style="width: 46%"/>
                                <span class="redspan" style="color: red;padding: 0px;margin-left: 10px;">*</span>
                            </td>
                        </tr>
                        <tr>
