...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
	...
	<table class="bs_tb" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="8" class="theader">六、近五年为第一负责人已完成的市局级及以上科研项目共<input type="text" name="totalmainUserFinishProList" id="totalmainUserFinishProList" value="${resultMap.totalmainUserFinishProList}" class="inputText" style="width: 70px;"/>项。（限填15项代表作）
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
...
<c:if test="${!(param.expert eq GlobalConstant.FLAG_Y)}">
	...
	<table class="bs_tb" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="8" class="theader">七、近五年为第一负责人在研的市局级及以上科技项目共<input type="text" name="totalmainUserProingList" id="totalmainUserProingList" value="${resultMap.totalmainUserProingList}" class="inputText" style="width: 70px;"/>项。（限填15项代表作）
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
									<span style="float: right;padding-right: 10px">
