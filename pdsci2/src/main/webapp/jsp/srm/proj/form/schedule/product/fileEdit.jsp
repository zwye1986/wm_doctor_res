        ...
        <div class="mainright">
            <div class="content">
                <form id="fileForm" action="<s:url value="/srm/proj/mine/savePageGroupStep"/>" method="post" enctype="multipart/form-data" target="screct_frame" style="position: relative;">
                    ...
                    <table class="basic">
                        <tr>
                            <th colspan="4" style="text-align: left;padding-left: 15px;font-size: 14px;">附件</th>
                        </tr>
                        <tbody>
                            <tr>
                                <td width="20%" style="text-align: right;">附件名称：</td>
                                <td width="30%">
                         	        <input class="inputText validate[required]" name="fileEdit_fileName" type="text" value="${file.fileEdit_fileName}" style="width: 90%"/>
                                </td>
                                <td width="20%" style="text-align: right;">附件：</td>
                                <td width="30%">
                         	        <input type="file" name="fileEdit_file" class="validate[required] " />
                                </td>
                            </tr>
                            <tr>
                                <td width="20%" style="text-align: right;">附件备注：</td>
                                <td colspan="3">
                         	        <input class="inputText validate[required]" name="fileEdit_fileRemark" type="text" style="width: 90%" value="${file.fileEdit_fileRemark}" />
                                </td>
                           </tr>
                       </tbody>
                   </table>
