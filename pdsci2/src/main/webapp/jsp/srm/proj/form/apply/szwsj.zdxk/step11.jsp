	...
	$("#"+tb+"Tb").children("tr").last().children("td").eq(1).text(length+1);
        	    	...
        	    	<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
   					...
   					<table class="bs_tb" style="width: 100%;margin-top: 10px" id="office">
						<tr>
							<th colspan="9" class="theader">表 12：近五年学会任职情况，共 <input type="text" name="officeNum" value="${resultMap.officeNum}" class="validate[custom[integer]] inputText" style="width:30px;"/>个职务。（限填10项最高职务）
							<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
