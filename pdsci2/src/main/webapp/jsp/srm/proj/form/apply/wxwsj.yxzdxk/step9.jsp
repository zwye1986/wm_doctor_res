...
<head>
    ...
    <style type="text/css">
        .bs_tb tbody td input{margin-left: 10px;}
    </style>
</head>
<body>
<div id="main">
                        ...
                        <tr>
                            <th colspan="8" class="theader">十一、近五年为主编/副主编出版的学术专著共<input type="text" name="totalmainAuthorProList" id="totalmainAuthorProList" value="${resultMap.totalmainAuthorProList}" class="inputText" style="width: 70px;"/>本。（限填10项代表作）
                                <c:if test="${param.view!=GlobalConstant.FLAG_Y }">
									...
									<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('mainAuthorProList',10)"/>&#12288;
...
<c:if test="${!(param.expert eq GlobalConstant.FLAG_Y)}">
                    ...
                    <table class="bs_tb" style="width: 100%;margin-top: 10px;">
                        <tr>
                            <th colspan="9" class="theader">十二、近五年学会任职情况，共<input type="text" name="totaluserDeptList" id="totaluserDeptList" value="${resultMap.totaluserDeptList}" class="inputText" style="width: 70px;"/>个职务。（限填5项最高职务）
                                <c:if test="${param.view!=GlobalConstant.FLAG_Y }">
									<span style="float: right;padding-right: 10px">
									<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('userDeptList',5)"/>&#12288;
...
<c:if test="${!(param.expert eq GlobalConstant.FLAG_Y)}">
                ...
                <div style="display: none">
                    <!-- 近五年为主编/副主编出版的学术专著模板 -->
                    <table class="bs_tb" id="mainAuthorProListTemplate" style="width: 100%">
                        <tr>
                            <td width="50px" style="text-align: center;"><input name="mainAuthorProListIds" type="checkbox"/></td>
