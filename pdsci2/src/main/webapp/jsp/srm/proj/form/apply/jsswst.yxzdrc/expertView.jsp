        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">主要业绩</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">依托课题立题依据</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">研究内容</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">影响因子统计</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">依托科室条件</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">项目费用</a></li>
                    </ul>
                </div>
                <div id="tagContent">
