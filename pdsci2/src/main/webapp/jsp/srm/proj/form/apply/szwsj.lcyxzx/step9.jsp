...
function addProj(tb,obj){
	...
	'<td><input type="text" class="inputText" name="certificate_awardTime" style="width:80%;" onclick="WdatePicker({dateFmt:'+"'yyyy-MM-dd'"+'})" readonly="readonly"/></td>'+
		...
		$("."+tb+"Serial").each(function(){
			...
			$(this).text(serial);
					 ...
					 <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
						...
						<tr>
							<th colspan="7" class="theader">表 10：近五年为第一完成人的发明专利、新药证书共 <input type="text" name="certificateNum" value="${resultMap.certificateNum}" class="validate[custom[integer]] inputText" style="width:30px;"/> 张。（限填15项代表作）
							<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
