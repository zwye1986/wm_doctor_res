        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">学科简介</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">主攻方向</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">带头人主要业绩</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">人员信息</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">第一负责人项目</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">奖项/论文/专利</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">专著/任职/设备</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">协作任务</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">项目规划</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">经费预算</a></li>
                        <li><a onclick="selectTag('tagContent10',this)" href="javascript:void(0)">审核意见</a></li>
                        <li><a onclick="selectTag('tagContent11',this)" href="javascript:void(0)">附件信息</a></li>
                    </ul>
                </div>
                <div id="tagContent">
