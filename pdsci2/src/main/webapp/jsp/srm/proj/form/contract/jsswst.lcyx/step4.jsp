        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333; ">五、中心人员名单（限20人，必须和申报书人员名单一致）</font>
                    <table class="basic" style="width: 100%">
                        ...
                        <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="centerDirectorBirthday"
                    ...
                    <table class="basic" style="width: 100%">
                        ...
                        <tbody class="deputyDirector">
                        <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
                            <c:forEach var="deputyDirector" items="${resultMap.deputyDirector}" varStatus="deputyDirectorStatus">
                                <tr>
                                    <td><input type="checkbox" class="toDel"></td>
                                    <td class="seq">${deputyDirectorStatus.count}</td>
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="deputyDirector_name"
                                               value="${deputyDirector.objMap.deputyDirector_name}" style="width: 80%"/>
                                    </td>
                                    <td>
                                        <select name="deputyDirector_sex" class="inputText validate[required]" style="width: 80%;">
                                            <option value=""> </option>
                                            <option value="男"
                                                    <c:if test="${deputyDirector.objMap.deputyDirector_sex eq '男'}">selected="selected"</c:if>>男</option>
                                            <option value="女"
                                                    <c:if test="${deputyDirector.objMap.deputyDirector_sex eq '女'}">selected="selected"</c:if>>女</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="deputyDirector_birthday"
                                               value="${deputyDirector.objMap.deputyDirector_birthday}" onClick="WdatePicker({dateFmt:'yyyy-MM'})"
                                               readonly="readonly" style="width: 80%" />
                                    </td>
                                    <td>
                                        <select name="deputyDirector_title" class="inputText validate[required]" style="width: 80%;">
                                            <option value="">请选择</option>
                                            <c:forEach var="dict" items="${dictTypeEnumUserTitleList}">
                                                <option value="${dict.dictName }"
                                                        <c:if test="${deputyDirector.objMap.deputyDirector_title eq dict.dictName }">selected="selected"</c:if>>${dict.dictName }</option>
                                            </c:forEach>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="deputyDirector_major"
                                               value="${deputyDirector.objMap.deputyDirector_major}" style="width: 80%"/>
                                    </td>
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="deputyDirector_task"
                                               value="${deputyDirector.objMap.deputyDirector_task}" style="width: 80%"/>
                                    </td>
                                    <td>
                                        <input type="text" class="inputText validate[required]" name="deputyDirector_org"
                                               value="${deputyDirector.objMap.deputyDirector_org}" style="width: 80%"/>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        <c:if test="${param.view eq GlobalConstant.FLAG_Y}">
                            <c:forEach var="deputyDirector" items="${resultMap.deputyDirector}" varStatus="deputyDirectorStatus">
                                <tr>
                                    <td>${deputyDirectorStatus.count}</td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_name}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_sex}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_birthday}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_title}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_major}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_task}
                                    </td>
                                    <td>
                                            ${deputyDirector.objMap.deputyDirector_org}
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    ...
                    <table class="basic" style="width: 100%">
						...
						<span style="float: right;padding-right: 10px">
							<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />"
                                 style="cursor: pointer;" onclick="add('projMember',17);"/>
							<img title="删除" style="cursor: pointer;"
                                 src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>"
                ...
                <table id="template" style="display: none">
                    <tr id="deputyDirector">
                        <td><input type="checkbox" class="toDel"></td>
                        <td class="seq"></td>
                        <td>
                            <input type="text" class="inputText validate[required]" name="deputyDirector_name" value="" style="width: 80%"/>
                        </td>
                        <td>
                            <select name="deputyDirector_sex" class="inputText validate[required]" style="width: 80%;">
                                <option value=""> </option>
                        ...
                        <td>
                            <input type="text" class="inputText validate[required]" name="deputyDirector_birthday" onClick="WdatePicker({dateFmt:'yyyy-MM'})"
                                   readonly="readonly" style="width: 80%" />
                        </td>

                        <td>
                            <%--<input type="text" class="inputText validate[required]" name="deputyDirector_title" style="width: 80%"/>--%>
                            <select name="deputyDirector_title" class="inputText validate[required]" style="width: 80%;">
                                <option value="">请选择</option>
                                <c:forEach var="dict" items="${dictTypeEnumUserTitleList}">
                        ...
                        <td>
                            <input type="text" class="inputText validate[required]" name="deputyDirector_major" style="width: 80%"/>
                        </td>
                        <td>
                            <input type="text" class="inputText validate[required]" name="deputyDirector_task" style="width: 80%"/>
                        </td>
                        <td>
                            <input type="text" class="inputText validate[required]" name="deputyDirector_org" style="width: 80%"/>
                        </td>
                    </tr>
