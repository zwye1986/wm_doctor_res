...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
    ...
    <input type="hidden" id="pageName" name="pageName" value="step8_1"/>
    ...
    <table class="basic" style="width: 100%;margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="text-align: center;" width="30%"><font color="red">*</font>时间</td>
    ...
    <c:if test="${param.view != GlobalConstant.FLAG_Y}">
        <div align="center" style="margin-top: 10px">
            <input id="prev" type="button" onclick="nextOpt('step8_0')" class="search" value="上一步"/>
