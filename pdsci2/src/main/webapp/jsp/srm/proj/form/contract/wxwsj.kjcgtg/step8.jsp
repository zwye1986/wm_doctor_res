...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
    ...
    <table class="basic" style="width: 100%">
                ...
                <c:if test="${param.view!=GlobalConstant.FLAG_Y }">
						<span style="float: right;padding-right: 10px">
							<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />"
                                 style="cursor: pointer;" onclick="add('presideList',2);"/>
        ...
        <tr>
            ...
            <td style="text-align: center;" width="15%"><font color="red">*</font>单位（部门）</td>
            <td style="text-align: center;" width="25%"><font color="red">*</font>工作分工</td>
            <td style="text-align: center;" width="10%"><font color="red">*</font>联系电话</td>
            <td style="text-align: center;" width="10%">本人签名</td>
        </tr>
        ...
        <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
            <c:forEach var="presideList" items="${resultMap.presideList}" varStatus="presideListStatus">
                <tr>
                    ...
                    <td>
                        <input type="text" class="inputText" name="presideList_sign"
                               value="${presideList.objMap.presideList_sign}" style="width: 80%"/>
                    </td>
                </tr>
            </c:forEach>
        </c:if>
        <c:if test="${param.view eq GlobalConstant.FLAG_Y}">
            <c:forEach var="presideList" items="${resultMap.presideList}" varStatus="presideListStatus">
                <tr>
                    ...
                    <td>
                            ${presideList.objMap.presideList_sign}
                    </td>
                </tr>
            </c:forEach>
        </c:if>
        ...
        <tr>
            <th style="text-align: left;padding-left: 15px;" colspan="9">
                ...
                <c:if test="${param.view!=GlobalConstant.FLAG_Y }">
						<span style="float: right;padding-right: 10px">
							<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />"
                                 style="cursor: pointer;" onclick="add('memberList',99);"/>
							<img title="删除" style="cursor: pointer;"
                                 src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="inputText" name="memberList_sign"
                               value="${memberList.objMap.memberList_sign}" style="width: 80%"/>
                    </td>
        ...
        <c:if test="${param.view eq GlobalConstant.FLAG_Y}">
            <c:forEach var="memberList" items="${resultMap.memberList}" varStatus="memberListStatus">
                <tr>
                    ...
                    <td>
                            ${memberList.objMap.memberList_sign}
                    </td>
                </tr>
            </c:forEach>
        </c:if>
...
<table id="template" style="display: none">
    <tr id="memberList">
        ...
        <td>
            <input type="text" class="inputText" name="memberList_sign" style="width: 80%"/>
        </td>
    </tr>
    ...
    <tr id="presideList">
        ...
        <td>
            <input type="text" class="inputText validate[required]" name="presideList_sign" style="width: 80%"/>
        </td>
    </tr>
</table>
