        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">医学杰出人才简历</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">医学杰出人才主要业绩</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">依托课题立题依据</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">依托课题研究内容</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">课题组成员名单</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">项目规划</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">经费预算</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">审核意见</a></li>
