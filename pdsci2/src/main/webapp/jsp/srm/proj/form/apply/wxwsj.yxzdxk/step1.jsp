	...
	<table  class="bs_tb" style="width: 100%">
		...
		<tr>
			...
			<td width="35%" style="text-align: left;padding-left: 10px;">
				<input type="text"  class="inputText" name="zdxkAddress"
					value="<c:if test='${empty resultMap.zdxkAddress and param.view!=GlobalConstant.FLAG_Y}'>${org.orgAddress}</c:if><c:if test='${!empty resultMap.zdxkAddress}'>${resultMap.zdxkAddress}</c:if>" style="width: 90%"/>
			</td>
