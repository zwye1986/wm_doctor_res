    ...
    <div class="mainright">
        <div class="content">
            <div class="title1 clearfix">
                ...
                <ul id="tags">
                    <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">封面信息</a>
                    </li>
                    <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">基本情况</a></li>
                    <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">课题组主要成员情况表</a></li>
                    <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">立项依据</a></li>
                    <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">研究目标、可行性分析</a></li>
                    <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">研究基础与工作条件</a></li>
                    <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">实施计划、考核指标</a></li>
                    <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">经费预算分类细目</a></li>
                    <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">保证与审核</a></li>
                    <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">附件目录</a></li>
                </ul>
                    </div>
                <div id="tagContent">
