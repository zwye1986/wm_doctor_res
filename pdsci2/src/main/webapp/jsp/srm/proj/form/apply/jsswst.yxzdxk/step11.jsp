			...
			<div class="content">
			   <div style="margin-top: 10px;">
					<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;" id="projForm">
						...
						<font style="font-size: 14px; font-weight:bold;color: #333;">十六、经费预算</font>
						<table class="basic" style="width: 100%; margin-top: 10px;">
							...
							<tr>
								<td style="text-align: left;">四、研究项目费用</td>
								<td colspan="5"></td>
								<%--<td style="text-align: center;"><input type="text" name="four" value="${resultMap.four}" onchange="setTotal('one')" class="inputText validate[custom[number]]" style="width: 80%;"/></td>
								<td style="text-align: center;"><input type="text" name="fours" value="${resultMap.fours}" onchange="setTotal('two')" class="inputText validate[custom[number]]" style="width: 80%;"/></td>
								<td style="text-align: center;"><input type="text" name="fourss" value="${resultMap.fourss}" onchange="setTotal('three')" class="inputText validate[custom[number]]" style="width: 80%;"/></td>
								<td style="text-align: center;"><input type="text" name="foursss" value="${resultMap.foursss}" onchange="setTotal('four')" class="inputText validate[custom[number]]" style="width: 80%;"/></td>
								<td style="text-align: center;"><input type="text" name="fourssss" value="${resultMap.fourssss}" onchange="setTotal('five')" class="inputText validate[custom[number]]" style="width: 80%;"/></td>--%>
							</tr>
							<tr>
					...
					<div class="button" style="width: 100%; <c:if test="${param.view == GlobalConstant.FLAG_Y}">display:none</c:if>">
						<input id="prev" type="button" onclick="nextOpt('step10_1')" class="search" value="上一步"/>
