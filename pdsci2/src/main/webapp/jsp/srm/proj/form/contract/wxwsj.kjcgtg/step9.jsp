...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
    ...
    <table class="basic" style="width: 100%">
        ...
        <tr>
            ...
            <td style="text-align: center;" width="15%"><font color="red">*</font>受推单位</td>
            <td style="text-align: center;" width="15%"><font color="red">*</font>项目负责人</td>
            <td style="text-align: center;" width="15%"><font color="red">*</font>所在部门（科室）</td>
            <td style="text-align: center;" width="15%"><font color="red">*</font>职务（职称）</td>
            <td style="text-align: center;" width="15%"><font color="red">*</font>联系电话</td>
            <td style="text-align: center;" width="15%">签字</td>
        </tr>
        ...
        <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
            <c:forEach var="acceptList" items="${resultMap.acceptList}" varStatus="acceptListStatus">
                <tr>
                    ...
                    <td>
                        <input type="text" class="inputText" name="acceptList_sign"
                               value="${acceptList.objMap.acceptList_sign}" style="width: 80%"/>
                    </td>
                </tr>
            </c:forEach>
        </c:if>
        <c:if test="${param.view eq GlobalConstant.FLAG_Y}">
            <c:forEach var="acceptList" items="${resultMap.acceptList}" varStatus="acceptListStatus">
                <tr>
                    ...
                    <td>
                            ${acceptList.objMap.acceptList_sign}
                    </td>
                </tr>
            </c:forEach>
        </c:if>
...
<table id="template" style="display: none">
    <tr id="acceptList">
        ...
        <td>
            <input type="text" class="inputText" name="acceptList_sign" style="width: 80%"/>
        </td>
    </tr>
</table>
