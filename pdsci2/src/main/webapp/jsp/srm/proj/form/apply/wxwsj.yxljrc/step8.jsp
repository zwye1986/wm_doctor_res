	...
	<table class="basic" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="7" style="text-align: left;padding-left: 15px;">
				...
				<input type="text" name="teamScientificResult" value="${resultMap.teamScientificResult}" class="inputText projCount" style="width: 20px;"/>
				项，限填10项代表作。
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
						<span style="float: right;padding-right: 10px">
							<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('teamScientificResults');"/>
							<img title="删除" style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="del('teamScientificResults');"/>
						</span>
				</c:if>
			</th>
		</tr>
...
<c:if test="${!(param.expert eq GlobalConstant.FLAG_Y)}">
		...
		<c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
			<c:forEach var="teamScientificResults" items="${resultMap.teamScientificResults}" varStatus="teamScientificResultsStatus">
				<tr>
					...
					<td>
						<input type="text" class="inputText validate[required]" name="teamScientificResults_grantDept" value="${teamScientificResults.objMap.teamScientificResults_grantDept}" style="width: 80%"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="inputText validate[required]" name="teamScientificResults_peopleName" value="${teamScientificResults.objMap.teamScientificResults_peopleName}" style="width: 80%"/>
					</td>
				</tr>
			</c:forEach>
		</c:if>
	...
	<table class="basic" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="8" style="text-align: left;padding-left: 15px;">
				...
				<input type="text" name="teamScientificTopic" value="${resultMap.teamScientificTopic}" class="inputText projCount" style="width: 20px;"/>
				项，限填10项代表作。
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
					<span style="float: right;padding-right: 10px">
						<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('teamScientificTopics');"/>
						<img title="删除" style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="del('teamScientificTopics');"/>
					</span>
				</c:if>
			</th>
		</tr>
		...
		<c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
			<c:forEach var="teamScientificTopics" items="${resultMap.teamScientificTopics}" varStatus="teamScientificTopicsStatus">
				<tr>
					...
					<td>
						<input type="text" class="inputText validate[required]" name="teamScientificTopics_topicNo" value="${teamScientificTopics.objMap.teamScientificTopics_topicNo}" style="width: 80%"/>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamScientificTopics_topicName" value="${teamScientificTopics.objMap.teamScientificTopics_topicName}" style="width: 80%"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="inputText validate[required,custom[number]]" name="teamScientificTopics_funds" value="${teamScientificTopics.objMap.teamScientificTopics_funds}" style="width: 80%"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="inputText validate[required]" name="teamScientificTopics_peopleName" value="${teamScientificTopics.objMap.teamScientificTopics_peopleName}" style="width: 80%"/>
					</td>
				</tr>
			</c:forEach>
		</c:if>
...
<table id="template" style="display: none">
	<tr id="teamScientificResults">
		...
		<td>
			<input type="text" class="inputText ctime validate[required]" name="teamScientificResults_grantDate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
		</td>
		<td>
			<select name="teamScientificResults_resultName" class="inputText validate[required]" style="width: 90%;">
				<option value="">请选择</option>
		...
		<td>
			<input type="text" class="inputText validate[required]" name="teamScientificResults_grantDept" value="" style="width: 80%"/>
		</td>
		<td>
			<select name="teamScientificResults_level" class="inputText validate[required]" style="width:90%;">
				<option value="">请选择</option>
		...
		<td>
			<input type="text" class="inputText validate[required]" name="teamScientificResults_peopleName" value="" style="width: 80%"/>
		</td>
	</tr>
	...
	<tr id="teamScientificTopics">
		...
		<td>
			<input type="text" class="inputText validate[required]" name="teamScientificTopics_topicNo" value="" style="width: 80%"/>
		</td>
		<td>
			<input type="text" class="inputText validate[required]" name="teamScientificTopics_topicName" value="" style="width: 80%"/>
		</td>
		<td>
			<select name="teamScientificTopics_topicSource" class="inputText validate[required]" style="width: 90%;">
				<option value="">请选择</option>
		...
		<td>
			<input type="text" class="inputText validate[required,custom[number]]" name="teamScientificTopics_funds" value="" style="width: 80%"/>
		</td>
		<td>
		...
		<td>
			<input type="text" class="inputText validate[required]" name="teamScientificTopics_peopleName" value="" style="width: 80%"/>
		</td>
	</tr>
</table>
