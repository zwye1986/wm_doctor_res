            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">科研假说或技术构思</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">研究试验方法及技术路线</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">现有工作条件和基础</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">计划进度</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">意见及具体分工</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">经费概算</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">主要研究人员</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">单位意见</a></li>
