    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288;简述主要研究内容、技术路线、预期成果、年度安排等。（限2000字）
            </th>
        </tr>
        <tr>
            <td><textarea name="titleContent" style="width:98%;height: 150px;"
                          class="validate[maxSize[2000]]">${resultMap.titleContent}</textarea></td>
        </tr>
