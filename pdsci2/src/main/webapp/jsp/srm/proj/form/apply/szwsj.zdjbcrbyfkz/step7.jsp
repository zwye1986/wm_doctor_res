 ...
 .bs_tb tbody td input{text-align: left;margin-left: 10px;}
	...
	<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
		...
		<table width="100%" cellspacing="0" cellpadding="0" class="bs_tb">
			<tr>
				<th colspan="2" class="theader">本项目任务书所附的附件
					<c:if test="${param.view!=GlobalConstant.FLAG_Y}">
						<span style="float: right;padding-right: 10px"><a href="javascript:void(0)">
							<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="addFile('projFileTb')"></img></a>&#12288;<a href="javascript:void(0)">
							<img title="删除"  style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="delTr('projFileTb')"></img></a>
						</span>
					</c:if>
				</th>
			</tr>
			<tr>
				<th width="5%"></th>
				<th style="text-align: left;padding-left: 10px;">附件名称</th>
			</tr>
			<tbody id="projFileTb">
