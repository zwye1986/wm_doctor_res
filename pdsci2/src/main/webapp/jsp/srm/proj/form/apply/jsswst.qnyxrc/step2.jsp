        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333;">一、青年医学人才个人概况</font>
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="main_name" value="${resultMap.main_name}"
                            ...
                            <td><input type="text" name="main_nation" value="${resultMap.main_nation}"
                                       class="inputText validate[required]" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><font color="red">*</font>出生年月：</td>
                            <td><input class="inputText ctime validate[required]" type="text" name="main_birthday"
                                       value="${resultMap.main_birthday}" onClick="WdatePicker({dateFmt:'yyyy-MM'})"
                            ...
                            <td><input class="inputText ctime validate[required]" type="text" name="awardTime"
                                       value="${resultMap.awardTime}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
                                       readonly="readonly" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><font color="red">*</font>最终学位授予单位：</td>
                            <td><input type="text" name="awardOrg" value="${resultMap.awardOrg}"
                                       class="inputText validate[required]" style="width: 80%"/></td>
                            <td style="text-align: right;">目前从事专业：</td>
                            <td><input type="text" name="engageMajor" value="${resultMap.engageMajor}" class="inputText"
                                       style="width: 80%"/></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="political" value="${resultMap.political}" class="inputText"
                                       style="width: 80%"/></td>
                            <td style="text-align: right;">行政职务：</td>
                            <td><input type="text" name="administrativePost" value="${resultMap.administrativePost}"
                                       class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;" colspan="2">是否为省级或省级以上人才培养对象：</td>
                            <td colspan="4"><input type="text" name="cultivateObject"
                                                   value="${resultMap.cultivateObject}" class="inputText"
                                                   style="width: 80%"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="telephone" value="${resultMap.telephone}"
                                       class="inputText validate[required,custom[integer]]" style="width: 80%"/></td>
                            <td style="text-align: right;">传真：</td>
                            <td><input type="text" name="main_fax" value="${resultMap.main_fax}" class="inputText"
                                       style="width: 80%"/></td>
                            <td style="text-align: right;"><font color="red">*</font>Email：</td>
                            <td><input type="text" name="mailbox" value="${resultMap.mailbox}"
                                       class="inputText validate[required,custom[email]]" style="width: 80%"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input type="text" name="companyPlace" value="${resultMap.companyPlace}"
                                                   class="inputText" style="width: 80%"/></td>
                            <td style="text-align: right;">隶属关系：</td>
                            <td colspan="2"><input type="text" name="subordination" value="${resultMap.subordination}"
                                                   class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">传真：</td>
                            <td colspan="2"><input type="text" name="companyPlaceFax" value="${resultMap.companyPlaceFax}"
                                                   class="inputText" style="width: 80%"/></td>
                            <td style="text-align: right;">邮编：</td>
                            <td colspan="2"><input type="text" name="main_postcode" value="${resultMap.main_postcode}"
                                                   class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">通讯地址：</td>
                            <td colspan="5"><input type="text" name="postalAddress" value="${resultMap.postalAddress}"
                                                   class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
