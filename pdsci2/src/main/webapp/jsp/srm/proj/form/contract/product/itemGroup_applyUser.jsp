           ...
           <table class="basic">
                 ...
                 <tbody>
                      ...
                      <tr>
                         <th width="20%">生日：</th>
                         <td width="30%">
                         	<input type="text" name="applyUserBirthday" value="${resultMap.applyUserBirthday }" class="xltext">
                         </td>
                         <th width="20%">职称:</th>
                         <td width="30%">
                      ...
                      <tr>
                         ...
                         <td width="30%">
                         	<input type="text" name="applyUserTime" value="${resultMap.applyUserTime }" class="xltext">
                         </td>
                      </tr>
                      <tr>
