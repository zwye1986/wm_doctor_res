...
//		国家自然（社会）科学基金 国家卫计委行业专项 省科技厅临床重大专项 省自然（社会）科学基金项目
//	    省卫计委科研项目 省其他部委项目 市科技局项目 市卫计委项目 其他
//		1 2 3 4 5 6 7 8 9
...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <table class="bs_tb" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="8" class="theader">六、近五年为第一负责人已完成的市局级及以上科研项目共<input type="text"
                    ...
                    <td>
                        <select name="mainUserFinishProList_from" class="inputText validate[required]"
                            ...
                            <option value="国家自然（社会）科学基金"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国家自然（社会）科学基金'}">selected="selected"</c:if>>
                                国家自然（社会）科学基金
                            </option>
                            ...
                            <option value="省科技厅临床重大专项"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '省科技厅临床重大专项'}">selected="selected"</c:if>>
                                省科技厅临床重大专项
                            </option>
                            <option value="省自然（社会）科学基金项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '省自然（社会）科学基金项目'}">selected="selected"</c:if>>
                                省自然（社会）科学基金项目
                            </option>
                            <option value="省卫计委科研项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '省卫计委科研项目'}">selected="selected"</c:if>>
                                省卫计委科研项目
                            </option>
                            <option value="省其他部委项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '省其他部委项目'}">selected="selected"</c:if>>
                                省其他部委项目
                            </option>
                            <option value="市科技局项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '市科技局项目'}">selected="selected"</c:if>>
                                市科技局项目
                            </option>
                            <option value="市卫计委项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '市卫计委项目'}">selected="selected"</c:if>>
                                市卫计委项目
                            </option>
                            ...
                            <option value="国家自然科学基金"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国家自然科学基金'}">selected="selected"</c:if>>
                                国家自然科学基金
                            </option>
                            ...
                            <option value="科技部项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '科技部项目'}">selected="selected"</c:if>>
                                科技部项目
                            </option>
                            <option value="国家卫生计生委项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国家卫生计生委项目'}">selected="selected"</c:if>>
                                国家卫生计生委项目
                            </option>
                            <option value="教育部项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '教育部项目'}">selected="selected"</c:if>>
                                教育部项目
                            </option>
                            <option value="国家其他部委项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国家其他部委项目'}">selected="selected"</c:if>>
                                国家其他部委项目
                            </option>
                            <option value="中华医学会项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '中华医学会项目'}">selected="selected"</c:if>>
                                中华医学会项目
                            </option>
                            <option value="其他国家级学会项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '其他国家级学会项目'}">selected="selected"</c:if>>
                                其他国家级学会项目
                            </option>
                            <option value="江苏省科技厅项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '江苏省科技厅项目'}">selected="selected"</c:if>>
                                江苏省科技厅项目
                            </option>
                            <option value="江苏省教育厅项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '江苏省教育厅项目'}">selected="selected"</c:if>>
                                江苏省教育厅项目
                            </option>
                            <option value="江苏省卫生计生委项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '江苏省卫生计生委项目'}">selected="selected"</c:if>>
                                江苏省卫生计生委项目
                            </option>
                            <option value="省级学会项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '省级学会项目'}">selected="selected"</c:if>>
                                省级学会项目
                            </option>
                            <option value="市级项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '市级项目'}">selected="selected"</c:if>>
                                市级项目
                            </option>
                            <option value="国际合作项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国际合作项目'}">selected="selected"</c:if>>
                                国际合作项目
                            </option>
                            <option value="973计划"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '973计划'}">selected="selected"</c:if>>
                                973计划
                            </option>
                            <option value="主管部门科技项目"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '主管部门科技项目'}">selected="selected"</c:if>>
                                主管部门科技项目
                            </option>
                            <option value="国家发改委"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '国家发改委'}">selected="selected"</c:if>>
                                国家发改委
                            </option>
                            <option value="科技重大专项"
                                    <c:if test="${mainUserFinishProList.objMap.mainUserFinishProList_from eq '科技重大专项'}">selected="selected"</c:if>>
                                科技重大专项
                            </option>
                            <option value="其他"
    ...
    <table class="bs_tb" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="8" class="theader">七、近五年为第一负责人在研的市局级及以上科技项目共<input type="text" name="totalmainUserProingList"
                ...
                <tr>
                    ...
                    <td>
                        <select name="mainUserProingList_from" class="inputText validate[required]" style="width: 90%;"
                            ...
                            <option value="">请选择</option>
                            <option value="国家自然（社会）科学基金"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国家自然（社会）科学基金'}">selected="selected"</c:if>>
                                国家自然（社会）科学基金
                            </option>
                            <option value="国家卫计委行业专项"
                            ...
                            <option value="省科技厅临床重大专项"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '省科技厅临床重大专项'}">selected="selected"</c:if>>
                                省科技厅临床重大专项
                            </option>
                            <option value="省自然（社会）科学基金项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '省自然（社会）科学基金项目'}">selected="selected"</c:if>>
                                省自然（社会）科学基金项目
                            </option>
                            <option value="省卫计委科研项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '省卫计委科研项目'}">selected="selected"</c:if>>
                                省卫计委科研项目
                            </option>
                            <option value="省其他部委项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '省其他部委项目'}">selected="selected"</c:if>>
                                省其他部委项目
                            </option>
                            <option value="市科技局项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '市科技局项目'}">selected="selected"</c:if>>
                                市科技局项目
                            </option>
                            <option value="市卫计委项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '市卫计委项目'}">selected="selected"</c:if>>
                                市卫计委项目
                            </option>
                            <option value="国家杰出青年科学基金项目"
                            ...
                            <option value="国家自然科学基金"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国家自然科学基金'}">selected="selected"</c:if>>
                                国家自然科学基金
                            </option>
                            <option value="国家自然科学基金面上项目"
                            ...
                            <option value="科技部项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '科技部项目'}">selected="selected"</c:if>>
                                科技部项目
                            </option>
                            <option value="国家卫生计生委项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国家卫生计生委项目'}">selected="selected"</c:if>>
                                国家卫生计生委项目
                            </option>
                            <option value="教育部项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '教育部项目'}">selected="selected"</c:if>>
                                教育部项目
                            </option>
                            <option value="国家其他部委项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国家其他部委项目'}">selected="selected"</c:if>>
                                国家其他部委项目
                            </option>
                            <option value="中华医学会项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '中华医学会项目'}">selected="selected"</c:if>>
                                中华医学会项目
                            </option>
                            <option value="其他国家级学会项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '其他国家级学会项目'}">selected="selected"</c:if>>
                                其他国家级学会项目
                            </option>
                            <option value="江苏省科技厅项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '江苏省科技厅项目'}">selected="selected"</c:if>>
                                江苏省科技厅项目
                            </option>
                            <option value="江苏省教育厅项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '江苏省教育厅项目'}">selected="selected"</c:if>>
                                江苏省教育厅项目
                            </option>
                            <option value="江苏省卫生计生委项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '江苏省卫生计生委项目'}">selected="selected"</c:if>>
                                江苏省卫生计生委项目
                            </option>
                            <option value="省级学会项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '省级学会项目'}">selected="selected"</c:if>>
                                省级学会项目
                            </option>
                            <option value="市级项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '市级项目'}">selected="selected"</c:if>>
                                市级项目
                            </option>
                            <option value="国际合作项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国际合作项目'}">selected="selected"</c:if>>
                                国际合作项目
                            </option>
                            <option value="973计划"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '973计划'}">selected="selected"</c:if>>
                                973计划
                            </option>
                            <option value="主管部门科技项目"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '主管部门科技项目'}">selected="selected"</c:if>>
                                主管部门科技项目
                            </option>
                            <option value="国家发改委"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '国家发改委'}">selected="selected"</c:if>>
                                国家发改委
                            </option>
                            <option value="科技重大专项"
                                    <c:if test="${mainUserProingList.objMap.mainUserProingList_from eq '科技重大专项'}">selected="selected"</c:if>>
                                科技重大专项
                            </option>
                            <option value="其他"
    ...
    <table id="proAmountTotal" class="basic" style="width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td><input type="text" name="pro_28" value="${resultMap.pro_28}" class="inputText validate[custom[number]]"
                       readonly="readonly" title="自动统计，不可修改" style="width: 80%;"/></td>
            <td><input type="text" name="pro_29" value="${resultMap.pro_29}" class="inputText validate[custom[number]]"
                       readonly="readonly" title="自动统计，不可修改" style="width: 80%;"/></td>
            <td><input type="text" name="pro_30" value="${resultMap.pro_30}" class="inputText validate[custom[number]]"
                       readonly="readonly" title="自动统计，不可修改" style="width: 80%;"/></td>
            <td><input type="text" name="pro_31" value="${resultMap.pro_31}" class="inputText validate[custom[number]]"
                       readonly="readonly" title="自动统计，不可修改" style="width: 80%;"/></td>
        </tr>
        <tr>
            <td style="text-align: center;" width="120px;">经费(万元)</td>
            ...
            <td><input type="text" name="amount_28" value="${resultMap.amount_28}"
                       class="inputText validate[custom[number]]" readonly="readonly" title="自动统计，不可修改"
                       style="width: 80%;"/></td>
            <td><input type="text" name="amount_29" value="${resultMap.amount_29}"
                       class="inputText validate[custom[number]]" readonly="readonly" title="自动统计，不可修改"
                       style="width: 80%;"/></td>
            <td><input type="text" name="amount_30" value="${resultMap.amount_30}"
                       class="inputText validate[custom[number]]" readonly="readonly" title="自动统计，不可修改"
                       style="width: 80%;"/></td>
            <td><input type="text" name="amount_31" value="${resultMap.amount_31}"
                       class="inputText validate[custom[number]]" readonly="readonly" title="自动统计，不可修改"
                       style="width: 80%;"/></td>
        </tr>
    </table>
