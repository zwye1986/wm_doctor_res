...
<style>
	...
	<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
		...
		<font style="font-size: 14px; font-weight:bold;color: #333;">六、学科建设经费来源与支出预算</font>
		<table class="basic" style="width: 100%; margin-top: 10px;" >
			<tr>
				<th colspan="4" style="text-align: left;padding-left: 20px;">1、经费支出预算<span style="float: right;">单位：万元（保留两位小数）</span></th>
			</tr>
	        <tr>		
		...
		<table class="basic" style="width: 100%; margin-top: 15px;" >
			<tr>
				<th colspan="5" style="text-align: left;padding-left: 20px;">2、配套经费<span style="float: right;">单位：万元（保留两位小数）</span></th>
			</tr>
	        <tr>		
    ...
    <c:if test="${param.view!=GlobalConstant.FLAG_Y}">
		<div align="center" style="margin-top: 10px">
		    ...
		    <input id="prev" type="button" onclick="nextOpt('step7')" class="search" value="下一步"/>
       	</div>
    </c:if>
