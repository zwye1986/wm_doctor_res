    ...
    <div class="mainright">
        <div class="content">
            <div class="title1 clearfix">
                ...
                <ul id="tags">
                    <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">基本信息</a>
                    </li>
                    <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">个人概况</a></li>
                    <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">人才简历</a></li>
                    <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">主要业绩</a></li>
                    <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">导师概况</a></li>
                    <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">依托课题立题依据</a></li>
                    <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">研究内容</a></li>
                    <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">组员名单</a></li>
                    <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">影响因子统计</a></li>
                    <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">依托科室条件</a></li>
                    <li><a onclick="selectTag('tagContent10',this)" href="javascript:void(0)">项目费用</a></li>
                    <li><a onclick="selectTag('tagContent11',this)" href="javascript:void(0)">审核意见</a></li>
                    <li><a onclick="selectTag('tagContent12',this)" href="javascript:void(0)">附件</a></li>
                </ul>
                    </div>
                <div id="tagContent">
