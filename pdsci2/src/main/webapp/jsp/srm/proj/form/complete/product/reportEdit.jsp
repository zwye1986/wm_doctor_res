      ...
      <div class="content">
        ...
        <form id="fileForm" action="<s:url value="/srm/proj/mine/savePageGroupStep"/>" method="post" enctype="multipart/form-data" target="screct_frame">
           ...
           <table class="basic" width="100%">
                 <thead>
                    <tr>
                        <th colspan="4" style="border-top: 1px solid #D0E3F2;text-align: left;padding-left: 15px;font-size: 14px;font-weight: bold;background: #ECF2FA;height: 35px;line-height: 35px;">总结报告</th>
                    </tr>
                 </thead>
                 <tbody>
                      <tr>
                         <td width="100px">总结报告名称：</td>
                         <td width="200px">
                         	<input class="validate[required] inputText" name="reportEdit_fileName" style="width: 90%" type="text" value="${file.reportEdit_fileName}"/>
                         </td>
                         <td width="100px">总结报告:</td>
                         <td>
                         	<input type="file" name="reportEdit_file" class="validate[required] inputText" style="width: 90%" />
                         	
                         </td>
                      </tr>
                      <tr>
                         <td width="100px">总结报告备注：</td>
                         <td colspan="3">
                         	<input class="validate[required] inputText" name="reportEdit_fileRemark" type="text" style="width: 90%" value="${file.reportEdit_fileRemark}" />
                         </td>
