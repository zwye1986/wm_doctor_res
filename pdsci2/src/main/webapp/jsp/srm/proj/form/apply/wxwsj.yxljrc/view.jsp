      ...
      <div class="content">
        <div class="title1 clearfix">
          ...
          <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent11',this)" href="javascript:void(0)">协作任务</a></li>
        ...
        <div id="tagContent" style="margin-top:30px;">
            ...
            <div class="tagContent" id="tagContent12" style="padding-top: 0px;">
                <jsp:include page="step12.jsp" flush="true"><jsp:param  name="view" value="${ GlobalConstant.FLAG_Y}"/></jsp:include>
            </div>
            <div class="tagContent" id="tagContent13" style="padding-top: 0px;">
                <jsp:include page="step13.jsp" flush="true"><jsp:param  name="view" value="${ GlobalConstant.FLAG_Y}"/></jsp:include>
            </div>
        </div>
    </div>
    <p>
