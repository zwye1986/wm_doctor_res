        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">人才简历</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">主要业绩</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">依托课题立题依据</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">研究内容</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">组员名单</a></li>
