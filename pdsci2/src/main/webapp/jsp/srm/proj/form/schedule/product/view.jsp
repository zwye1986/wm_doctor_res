   ...
   <div class="mainright">
      <div class="content">
        <div class="title1 clearfix">
          ...
          <ul id="tags">
            <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">经费情况</a></li>
            <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">人员情况</a></li>
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">进展情况</a></li>
            <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">取得成果</a></li>
            <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">执行情况</a></li>
