	...
	<div class="mainright">
    	<div class="content">
    		...
    		<ul id="tags">
	            ...
	            <li id='tag2'><a onclick="selectTag('tagContent2','tag2')" href="javascript:void(0)">研究内容</a></li>
	            <li id='tag3'><a onclick="selectTag('tagContent3','tag3')" href="javascript:void(0)">研究方法</a></li>
	            <li id='tag4'><a onclick="selectTag('tagContent4','tag4')" href="javascript:void(0)">工作基础</a></li>
	            <li id='tag5'><a onclick="selectTag('tagContent5','tag5')" href="javascript:void(0)">预期成果</a></li>
	            <li id='tag6'><a onclick="selectTag('tagContent6','tag6')" href="javascript:void(0)">进度与考核</a></li>
	            <li id='tag7'><a onclick="selectTag('tagContent7','tag7')" href="javascript:void(0)">附件</a></li>
        	</ul>
				</div>
