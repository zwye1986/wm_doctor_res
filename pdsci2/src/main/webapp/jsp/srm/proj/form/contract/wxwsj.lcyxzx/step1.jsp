        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333; ">无锡市临床医学中心建设合同书</font>
                    <table class="basic" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;padding-left: 10px;">
                                <input type="text" class="inputText" value="2016年~2020年" readonly="readonly" style="width: 46%">
