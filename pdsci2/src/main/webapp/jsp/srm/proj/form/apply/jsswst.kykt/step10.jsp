...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">九、单位意见</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th></th>
        </tr>
        <tr>
            <td><textarea name="auditOpinion" style="width:98%;height: 150px;"
                          class="xltxtarea">${resultMap.auditOpinion}</textarea></td>
        </tr>
    </table>
