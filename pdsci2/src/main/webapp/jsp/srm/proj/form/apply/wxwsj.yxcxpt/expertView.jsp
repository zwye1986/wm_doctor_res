        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">简介</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">带头人业绩</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">创新平台（实验室）人员信息</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">第一负责人项目</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">奖项/论文/专利</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">专著/任职/设备</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">协作任务</a></li>
