   ...
   <div class="mainright">
      <div class="content">
        <div class="title1 clearfix">
          ...
          <ul id="tags">
            <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">首页信息</a></li>
            <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">基本情况</a></li>
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">项目目标和主要研究内容</a></li>
            <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">项目验收内容和考核指标</a></li>
            <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">项目年度计划及考核指标</a></li>
            <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">项目主要研究开发人员</a></li>
            <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">项目经费预算</a></li>
            <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">附件信息</a></li>
          </ul>
                </div>
        <div id="tagContent">
