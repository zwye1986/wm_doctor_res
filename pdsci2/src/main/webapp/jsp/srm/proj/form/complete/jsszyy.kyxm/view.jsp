            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">项目工作报告</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">总结报告</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">项目经费决算表</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">项目组主要参加人员名单</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">专家验收意见</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">项目管理部门意见</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">成果目录及附件</a></li>
                    </ul>
                </div>
                <div id="tagContent">
