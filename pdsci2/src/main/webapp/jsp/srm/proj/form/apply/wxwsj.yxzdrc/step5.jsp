        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333;">四、指导老师概况</font>
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="teacherIsTutor" id="tutor_bd" value="博导" class="inputText" <c:if test="${resultMap.teacherIsTutor eq '博导'}">checked="checked"</c:if>/>
                                <label for="tutor_bd">&nbsp;博导</label>&nbsp;
                                <input type="radio" name="teacherIsTutor" id="tutor_sd" value="硕导" class="inputText" <c:if test="${resultMap.teacherIsTutor eq '硕导'}">checked="checked"</c:if>/>
                                <label for="tutor_sd">&nbsp;硕导</label>
                            </td>
                            <td style="text-align: right;">目前从事专业：</td>
                            <td><input type="text" name="currentMajor" value="${resultMap.currentMajor}" class="inputText" style="width: 80%"/></td>
                            <td style="text-align: right;">本人研究方向：</td>
                            <td><input type="text" name="researchArea" value="${resultMap.researchArea}" class="inputText" style="width: 80%"/></td>

                        </tr>
                        <tr>
                            <td style="text-align: right;">所在单位：</td>
                            <td><input type="text" name="unit" value="${resultMap.unit}" class="inputText" style="width: 80%"/></td>
                            <td style="text-align: right;">最高学术头衔：</td>
                            <td><input type="text" name="academicTitle" value="${resultMap.academicTitle}" class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="tel" value="${resultMap.tel}" class="inputText validate[required,custom[integer]]" style="width: 80%"/></td>
                            ...
                            <td><input type="text" name="postCode" value="${resultMap.postCode}" class="inputText validate[required,custom[integer]" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><font color="red">*</font>Email：</td>
                            <td colspan="5"><input type="text" name="email" value="${resultMap.email}" class="inputText validate[required]"style="width: 80%"/></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="6"><textarea class="validate[required]" name="tutorCommitment" style="width:98%;height: 150px;">${resultMap.tutorCommitment}</textarea>
                            </td>
                        </tr>
                    </table>
                </form>
