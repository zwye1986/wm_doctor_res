        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
                    ...
                    <table id="fund1" style="width: 100%;margin-top: 10px;" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="amountFund" value="${resultMap.amountFund}" type="text"
                                       class="inputText validate[custom[number]] amount"
                                       style="margin-right: 0px; width:26%; margin-left: 22px;"  readonly="readonly"/>（万元）
                            </td>
                        </tr>
                    </table>
                    ...
                    <table id="fund2" style="width: 100%;border-top: none;" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td>合&#12288;&#12288;&#12288;计</td>
                            <td><input type="text" name="amountFirstYear" value="${resultMap.amountFirstYear}"
                                       class="inputText validate[custom[number]] amount" style="width:80%;" readonly="readonly"/></td>
                            <td><input type="text" name="amountSecondYear" value="${resultMap.amountSecondYear}"
                                       class="inputText validate[custom[number]] amount" style="width:80%;" readonly="readonly"/></td>
                            <td><input type="text" name="amountThirdYear" value="${resultMap.amountThirdYear}"
                                       class="inputText validate[custom[number]] amount" style="width:80%;" readonly="readonly"/></td>
                            <td><input type="text" name="amountFourthYear" value="${resultMap.amountFourthYear}"
                                       class="inputText validate[custom[number]] amount" style="width:80%;" readonly="readonly"/></td>
                            <td><input type="text" name="amountFifthYear" value="${resultMap.amountFifthYear}"
                                       class="inputText validate[custom[number]] amount" style="width:80%;" readonly="readonly"/></td>
                        </tr>
                    </table>
                ...
                <div class="button"
                    ...
                    <input id="prev" type="button" onclick="nextOpt('step6')" class="search" value="下一步"/>
                </div>
            </div>
        </div>
    </div>
