...
<div class="content">
		<div class="title1 clearfix">
			<ul id="tags">
				...
				<li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">项目经费</a></li>
				<li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">承担单位</a></li>
				<li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">项目负责人及项目组成员</a></li>
				<li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">主要内容和目标</a></li>
				<li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">计划进度目标</a></li>
			</ul>
