...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
	...
	<table class="basic" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="7" style="text-align: left;padding-left: 15px;">
				...
				<input type="text" name="teamLearningPaper" value="${resultMap.teamLearningPaper}" class="inputText projCount" style="width: 20px;"/>
				篇，限填15项代表作。(中华级论文影响因子统一填写0.5)
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
					<span style="float: right;padding-right: 10px">
						<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('teamLearningPapers',15);"/>
						<img title="删除" style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="del('teamLearningPapers');"/>
					</span>
				</c:if>
			</th>
		</tr>
		...
		<c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
			<c:forEach var="teamLearningPapers" items="${resultMap.teamLearningPapers}" varStatus="teamLearningPapersStatus">
				<tr>
					...
					<td>
						<input type="text" class="inputText ctime validate[required]" name="teamLearningPapers_publishDate" value="${teamLearningPapers.objMap.teamLearningPapers_publishDate}"
							   onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningPapers_paperName" value="${teamLearningPapers.objMap.teamLearningPapers_paperName}" style="width: 80%"/>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningPapers_publicactionName" value="${teamLearningPapers.objMap.teamLearningPapers_publicactionName}" style="width: 80%"/>
					</td>
					<td>
	...
	<table class="basic" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="6" style="text-align: left;padding-left: 15px;">
				4、近五年学术杂志任职情况，共
				<input type="text" name="teamLearningMagazine" value="${resultMap.teamLearningMagazine}" class="inputText projCount" style="width: 20px;"/>
				份杂志，限填8份代表杂志。
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
					<span style="float: right;padding-right: 10px">
						<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('teamLearningMagazines',8);"/>
						<img title="删除" style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="del('teamLearningMagazines');"/>
					</span>
				</c:if>
			</th>
		</tr>
		...
		<c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
			<c:forEach var="teamLearningMagazines" items="${resultMap.teamLearningMagazines}" varStatus="teamLearningMagazinesStatus">
				<tr>
					<td><input type="checkbox" class="toDel"></td>
					...
					<td>
						<input type="text" class="inputText validate[required,custom[number]]" name="teamLearningMagazines_officeYear" value="${teamLearningMagazines.objMap.teamLearningMagazines_officeYear}" style="width: 80%"/>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningMagazines_name" value="${teamLearningMagazines.objMap.teamLearningMagazines_name}" style="width: 80%"/>
					</td>
					<td>
						<select name="teamLearningMagazines_title" class="inputText validate[required]" style="width: 90%;">
							<option value="">请选择</option>
							<option value="主编" <c:if test="${teamLearningMagazines.objMap.teamLearningMagazines_title eq '主编'}">selected</c:if>>
								主编
							</option>
							<option value="副主编" <c:if test="${teamLearningMagazines.objMap.teamLearningMagazines_title eq '副主编'}">selected</c:if>>
								副主编
							</option>
							<option value="编委" <c:if test="${teamLearningMagazines.objMap.teamLearningMagazines_title eq '编委'}">selected</c:if>>
								编委
							</option>
						</select>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningMagazines_peopleName" value="${teamLearningMagazines.objMap.teamLearningMagazines_peopleName}" style="width: 80%"/>
					</td>
				</tr>
			</c:forEach>
		</c:if>
	...
	<table class="basic" style="width: 100%;margin-top: 10px;">
		<tr>
			<th colspan="6" style="text-align: left;padding-left: 15px;">
				5、近五年学会任职情况，共
				<input type="text" name="teamLearningWork" value="${resultMap.teamLearningWork}" class="inputText projCount" style="width: 20px;"/>
				个职务，限填5项最高职务。
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
					<span style="float: right;padding-right: 10px">
						<img title="新增" src="<s:url value="/css/skin/${skinPath}/images/add3.png" />" style="cursor: pointer;" onclick="add('teamLearningWorks',5);"/>
						<img title="删除" style="cursor: pointer;" src="<s:url value='/css/skin/${skinPath}/images/del1.png'/>" onclick="del('teamLearningWorks');"/>
					</span>
				</c:if>
			</th>
		</tr>
		...
		<c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
			<c:forEach var="teamLearningWorks" items="${resultMap.teamLearningWorks}" varStatus="teamLearningWorksStatus">
				<tr>
					...
					<td>
						<input type="text" class="inputText validate[required,custom[number]]" name="teamLearningWorks_officeYear" value="${teamLearningWorks.objMap.teamLearningWorks_officeYear}" style="width: 80%"/>
					</td>
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningWorks_name" value="${teamLearningWorks.objMap.teamLearningWorks_name}" style="width: 80%"/>
					</td>
					<td>
						<select name="teamLearningWorks_title" class="inputText validate[required]" style="width: 90%;">
							...
							<option value="副主委"
									<c:if test="${teamLearningWorks.objMap.teamLearningWorks_title eq '副主委'}">selected</c:if>>副主委
							</option>
							<option value="组长"
					...
					<td>
						<input type="text" class="inputText validate[required]" name="teamLearningWorks_peopleName" value="${teamLearningWorks.objMap.teamLearningWorks_peopleName}" style="width: 80%"/>
					</td>
				</tr>
			</c:forEach>
		</c:if>
...
<table id="template" style="display: none">
	<tr id="teamLearningPapers">
		...
		<td>
			<input type="text" class="inputText ctime validate[required]" name="teamLearningPapers_publishDate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
		</td>
		<td>
			<input type="text" class="inputText validate[required]" name="teamLearningPapers_paperName" value="" style="width: 80%"/>
		</td>
		<td>
			<input type="text" class="inputText validate[required]" name="teamLearningPapers_publicactionName" value="" style="width: 80%"/>
		</td>
	...
	<tr id="teamLearningMagazines">
		...
		<td>
			<input type="text" class="inputText validate[required,custom[number]]" name="teamLearningMagazines_officeYear" value="" style="width: 80%"/>
		</td>
		<td>
			<input type="text" class="inputText validate[required]" name="teamLearningMagazines_name" value="" style="width: 80%"/>
		</td>
		<td>
			<select name="teamLearningMagazines_title" class="inputText validate[required]" style="width: 90%;">
				<option value="">请选择</option>
	...
	<tr id="teamLearningWorks">
		...
		<td>
			<input type="text" class="inputText validate[required,custom[number]]" name="teamLearningWorks_officeYear" value="" style="width: 80%"/>
		</td>
		<td>
			<input type="text" class="inputText validate[required]" name="teamLearningWorks_name" value="" style="width: 80%"/>
		</td>
		<td>
			<select name="teamLearningWorks_title" class="inputText validate[required]" style="width: 90%;">
				<option value="">请选择</option>
