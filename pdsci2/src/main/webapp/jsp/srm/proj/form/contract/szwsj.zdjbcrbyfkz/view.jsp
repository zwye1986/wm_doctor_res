      ...
      <div class="content">
        <div class="title1 clearfix">
          <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">项目实施人员情况</a></li>
        ...
        <div id="tagContent">
            ...
            <div class="tagContent" id="tagContent2" style="padding-top: 0px;">
                  <jsp:include page="subjectUserList.jsp" flush="true">
            	  	<jsp:param  name="view" value="${ GlobalConstant.FLAG_Y}"/>
            	  </jsp:include>
            </div>
            ...
            <div class="tagContent" id="tagContent4" style="padding-top: 0px;">
            	  <jsp:include page="fundsBudget.jsp" flush="true">
            	  	<jsp:param  name="view" value="${ GlobalConstant.FLAG_Y}"/>
            	  </jsp:include>
            </div>
        </div>
