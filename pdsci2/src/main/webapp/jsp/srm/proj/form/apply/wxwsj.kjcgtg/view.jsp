                ...
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)"
                                                 href="javascript:void(0)">封面信息</a>
                        </li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">基本信息</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">推广项目内容</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">成果技术水平</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">已推广应用情况</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">拟推广应用范围</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">拟推广应用方式</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">推广应用计划进度</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">推广单位可提供的条件</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">受推单位需具备的条件</a></li>
                        <li><a onclick="selectTag('tagContent10',this)" href="javascript:void(0)">预期目标及健康、社会效益</a></li>
