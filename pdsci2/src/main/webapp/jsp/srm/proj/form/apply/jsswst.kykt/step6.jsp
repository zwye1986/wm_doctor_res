...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">五、计划进度</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        ...
        <tr>
            <td><textarea name="schedule" style="width:98%;height: 150px;"
                          class="xltxtarea">${resultMap.schedule}</textarea></td>
        </tr>
