        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333; ">无锡市医学杰出人才合同书</font>
                    <table class="basic" style="width: 100%">
                        <tr>
                            <th colspan="2" class="theader"></th>
                        </tr>
                        <tr>
                            <td width="200px;" style="text-align: center">合同书名称：</td>
                            <td style="text-align: left;padding-left: 10px;" colspan="3">
                                <select class="validate[required] inputText" name="contractName" style="width: 46%;padding-left: 10%" >
                                    ...
                                    >无锡市医学杰出人才培育对象合同书</option>
                                </select>
                                <span class="redspan" style="color: red;padding: 0px;margin-left: 10px;">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="200px;" style="text-align: center">杰出人才姓名：</td>
                            <td style="text-align: left;padding-left: 10px;" colspan="3">
                                <input type="text" class="validate[required] inputText" name="elitistName"
                                       style="width: 46%"
                                       value="<c:if test='${empty resultMap.elitistName and param.view!=GlobalConstant.FLAG_Y}'>${proj.applyUserName}</c:if><c:if test='${! empty resultMap.elitistName}'>${resultMap.elitistName}</c:if>"/>
                                <span class="redspan" style="color: red;padding: 0px;margin-left: 10px;">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center">依托课题：</td>
                            <td style="text-align: left;padding-left: 10px;" colspan="3">
                                <input type="text" class="validate[required] inputText" name="subject"
                                       value="<c:if test='${empty resultMap.subject and param.view!=GlobalConstant.FLAG_Y}'>${proj.projName}</c:if><c:if test='${! empty resultMap.subject}'>${resultMap.subject}</c:if>" style="width: 46%"/>
                                <span class="redspan" style="color: red;padding: 0px;margin-left: 10px;">*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: center">合同起止年限：</td>
                        ...
                        <tr>
                            <td style="text-align: center">无锡市卫生计生委编号：</td>
                            <td style="text-align: left;padding-left: 10px;">
