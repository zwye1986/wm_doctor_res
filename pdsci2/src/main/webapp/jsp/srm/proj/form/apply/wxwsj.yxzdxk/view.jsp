            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">第一负责人项目</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">奖项/论文/专利</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">专著/任职/设备</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">协作任务</a></li>
                        <li><a onclick="selectTag('tagContent10',this)" href="javascript:void(0)">项目规划</a></li>
