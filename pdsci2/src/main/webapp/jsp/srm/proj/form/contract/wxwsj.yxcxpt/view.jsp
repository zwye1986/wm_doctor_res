      ...
      <div class="content">
        <div class="title1 clearfix">
          <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">考核指标</a></li>
            <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">承建单位支撑计划</a></li>
            <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">学科人员名单</a></li>
