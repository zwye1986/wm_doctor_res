        ...
        <c:forEach var="changememberList" items="${resultMap.changememberList}" varStatus="changememberListStatus">
            <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
                <tr>
                    ...
                    <td>
                        <input type="text" class="inputText <%--validate[required]--%>" name="changememberList_ranking"
...
<table style="display:none">
    <tr id="outmemberList">
        ...
        <td><input type="text" name="outmemberList_ranking" value="" class="inputText " style="width: 90%;"/></td>
    ...
    <tr id="changememberList">
        ...
        <td><input type="text" name="changememberList_ranking" value="" class="inputText " style="width: 90%;"/></td>
