...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">七、推广应用计划进度</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288; （以2年项目周期，按半年度划分工作节点，明确各阶段工作内容、进度与目标）
            </th>
        </tr>
        <tr>
            <td><textarea name="extend_plan" style="width:98%;height: 150px;"
                          class="validate[maxSize[1000]]">${resultMap.extend_plan}</textarea></td>
        </tr>
