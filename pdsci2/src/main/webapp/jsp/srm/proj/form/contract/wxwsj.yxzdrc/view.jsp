      ...
      <div class="content">
        <div class="title1 clearfix">
          <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">依托课题/发展规划</a></li>
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">个人学术地位发展目标</a></li>
            <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">考核指标/单位培养措施</a></li>
            <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">指导导师承诺书</a></li>
            <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">经费预算</a></li>
            <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">附件信息</a></li>
          </ul>
        <div id="tagContent">
