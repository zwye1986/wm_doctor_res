...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post"
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">三、青年医学人才主要业绩</font>
    <table class="basic" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="6" style="text-align: left;padding-left: 15px;">
                1、近五年为前三名以内完成人的县区级及以上科研成果（含专利）共<font color="red">*</font>
        ...
        <c:if test="${!(param.view eq GlobalConstant.FLAG_Y)}">
            <c:forEach var="scientificResults" items="${resultMap.scientificResults}"
                ...
                <tr>
                    ...
                    <td>
                        <select name="scientificResults_resultName" class="inputText validate[required]"
                                style="width: 90%;">
                            <option value="">请选择</option>
                            <c:forEach var="dict" items="${dictTypeEnumCgResultNameList}">
                                <option value="${dict.dictName }"
                                        <c:if test="${scientificResults.objMap.scientificResults_resultName eq dict.dictName }">selected="selected"</c:if>>${dict.dictName }</option>
                            </c:forEach>
                        </select>
                    </td>
                    <td>
                    ...
                    <td>
                        <select name="scientificResults_level" class="inputText validate[required]" style="width:90%;">
                            <option value="">请选择</option>
                            <option value="一等"
                                    <c:if test="${scientificResults.objMap.scientificResults_level eq '一等'}">selected="selected"</c:if>>
                                一等
                            </option>
                            <option value="二等"
                                    <c:if test="${scientificResults.objMap.scientificResults_level eq '二等'}">selected="selected"</c:if>>
                                二等
                            </option>
                            <option value="三等"
                                    <c:if test="${scientificResults.objMap.scientificResults_level eq '三等'}">selected="selected"</c:if>>
                                三等
                            </option>
                            <option value="无"
                                    <c:if test="${scientificResults.objMap.scientificResults_level eq '无'}">selected="selected"</c:if>>
                                无
                            </option>
                        </select>
                    </td>
    ...
    <table class="basic" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="7" style="text-align: left;padding-left: 15px;">
                2、近五年为前三名以内的县区级及以上科研课题共<font color="red">*</font>
    ...
    <table class="basic" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="6" style="text-align: left;padding-left: 15px;">
                3、近五年为前三名以内发表的SCI、中华级及其他核心期刊学术论文共<font color="red">*</font>
    ...
    <table class="basic" style="width: 100%;margin-top: 10px;">
        <tr>
            <th colspan="5" style="text-align: left;padding-left: 15px;">
                4、近五年学会任职情况，共<font color="red">*</font>
...
<table id="template" style="display: none">
    ...
    <tr id="learningPapers">
        ...
        <td><input type="text" name="learningPapers_reason" class="inputText validate[required]" style="width: 90%"/>
        </td>
    </tr>
