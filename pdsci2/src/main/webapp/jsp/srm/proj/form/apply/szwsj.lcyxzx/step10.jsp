	...
	$("#"+tb+"Tb").children("tr").last().children("td").eq(1).text(length+1);
        	    	...
        	    	<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
   					...
   					<table class="bs_tb" style="width: 100%;margin-top: 10px;" id="monograph">
   						<tr>
	   						<th colspan="8" class="theader">表 11：近五年为主编/副主编出版的学术专著共 <input type="text" name="monographNum" value="${resultMap.monographNum}" class="validate[custom[integer]] inputText" style="width:30px;"/>本。（限填15项代表作）
	   						<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
