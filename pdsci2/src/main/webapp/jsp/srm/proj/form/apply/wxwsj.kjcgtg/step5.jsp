...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">四、已推广应用情况</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288;（包括本单位及其他单位已经应用该成果技术时间、例数、成效等）
            </th>
        </tr>
        <tr>
            <td><textarea name="extend_achieve" style="width:98%;height: 150px;"
                          class="validate[maxSize[1000]]">${resultMap.extend_achieve}</textarea></td>
        </tr>
