...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">六、依托课题研究内容</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288;简述主要研究内容、技术路线、预期成果、年度安排等。（限1000字）
            </th>
        </tr>
        <tr>
            <td><textarea name="titleContent" style="width:98%;height: 150px;" class="validate[maxSize[1000]]">${resultMap.titleContent}</textarea></td>
        </tr>
    </table>
