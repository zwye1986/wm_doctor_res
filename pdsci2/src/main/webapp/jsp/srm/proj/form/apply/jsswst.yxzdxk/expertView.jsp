        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">主攻方向</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">带头人主要业绩</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">科研项目</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">奖项专利等</a></li>
                        <%--<li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">其他资历</a></li>--%>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">依托科室条件</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">经费预算</a></li>
                    </ul>
                </div>
                <div id="tagContent">
