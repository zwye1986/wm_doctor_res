...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
	...
	<table class="bs_tb" style="width: 100%; margin-top: 10px;">
		<tr>
			<th colspan="8" class="theader">
				表 7：近五年为第一负责人<b>在研</b>的市级及以上科技项目共 <input type="text" name="researchNum" id="researchNum" value="${resultMap.researchNum}" class="validate[custom[integer]] inputText" style="width: 30px;" /> 项。（限填10项代表作） 
				<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
			...
			<tr>
				...
				<td>
					<select name="research_projSource" class="validate[required] inputText" style="width: 90%;" onchange="calculate()">
						...
						<option value="科技部"
							<c:if test="${research.objMap.research_projSource eq '科技部'}">selected="selected"</c:if>>科技部</option>
						<option value="国家卫计委"
	...
	<table id="amount" class="bs_tb" style="width: 100%;">
		<tr>
			...
			<td style="font-weight:bold;">科技部</td>
