...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">五、依托课题立题依据</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288;简述研究目的、临床意义及创新点，包括国内外研究现状、预试验结果，现有技术条件等（需提供国家相关部门认定的查新检索单位出具的课题查新结论报告，限1000字，）
            </th>
        </tr>
        <tr>
            <td><textarea name="titleBase" style="width:98%;height: 150px;" class="validate[maxSize[1000]]">${resultMap.titleBase}</textarea></td>
        </tr>
    </table>
