           ...
           <table class="basic">
                 ...
                 <tbody>
                      ...
                      <tr>
                         <th width="20%">生日：</th>
                         <td width="30%">
                         	<input type="text" name="developUserBirthday" value="${resultMap.developUserBirthday }" class="xltext">
                         </td>
                         <th width="20%">职称:</th>
                         <td width="30%">
                      ...
                      <tr>
                         ...
                         <td width="30%">
                         	<input type="text" name="developUserTime" value="${resultMap.developUserTime }" class="xltext">
                         </td>
                      </tr>
                      <tr>
