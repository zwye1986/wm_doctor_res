        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <input type="hidden" name="projName" value="${proj.projName}"/>
                    <font style="font-size: 14px; font-weight:bold;color: #333;">一、医学杰出人才个人概况</font>
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            <td style="text-align: right;" colspan="2">是否为国家级、省级人才培养对象：</td>
                        ...
                        <tr>
                            <td style="text-align: right;">传真：</td>
                            <td colspan="2"><input type="text" name="companyPlaceFax"
                                                   value="${resultMap.companyPlaceFax}" class="inputText"
                                                   style="width: 80%"/></td>
                            <td style="text-align: right;">邮编：</td>
                            <td colspan="2"><input type="text" name="postcode" value="${resultMap.postcode}"
                                                   class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
