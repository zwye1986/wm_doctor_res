                ...
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="main_name" value="${resultMap.main_name}" class="inputText validate[required]" style="width: 80%"/></td>
                            ...
                            <td><input type="text" name="main_nation" value="${resultMap.main_nation}" class="inputText validate[required]" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><font color="red">*</font>出生年月：</td>
                            <td><input class="inputText ctime validate[required]" type="text" name="main_birthday" value="${resultMap.main_birthday}" onClick="WdatePicker({dateFmt:'yyyy-MM'})" readonly="readonly" style="width: 80%"/></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="telephone" value="${resultMap.telephone}" class="inputText validate[required,custom[integer]]" style="width: 80%"/></td>
                            <td style="text-align: right;">传真：</td>
                            <td><input type="text" name="main_fax" value="${resultMap.main_fax}" class="inputText" style="width: 80%"/></td>
                        ...
                        <tr>
                            <td style="text-align: right;">传真：</td>
                            <td colspan="2"><input type="text" name="placeFax" value="${resultMap.placeFax}" class="inputText" style="width: 80%"/></td>
                            <td style="text-align: right;">邮编：</td>
                            <td colspan="2"><input type="text" name="main_postcode" value="${resultMap.main_postcode}" class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
