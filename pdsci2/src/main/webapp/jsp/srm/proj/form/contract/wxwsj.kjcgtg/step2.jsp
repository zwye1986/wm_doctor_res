        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <table class="basic" style="width: 90%; margin-top: 10px;">
                        <tr>
                            ...
                            <td style="text-align: left;"><font color="red">*</font>性别：</td>
                            <td>
                            ...
                            <td style="text-align: left;"><font color="red">*</font>年龄：</td>
                            <td colspan="3"><input type="text" name="age" value="${resultMap.age}"
                                                   class="inputText validate[required]" style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;"><font color="red">*</font>学历：</td>
                            <td>
                                <select name="eduRecord" class="validate[required] inputText" style="width: 80%;">
                                    <option value="">请选择</option>
                                    <c:forEach var="dict" items="${dictTypeEnumUserEducationList}">
                                        <option value="${dict.dictName}"
                                                <c:if test="${resultMap.eduRecord eq dict.dictName}">selected="selected"</c:if>>${dict.dictName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            ...
                            <td><input type="text" name="degree" value="${resultMap.degree}" class="inputText"
                                       style="width: 80%"/></td>
                            <td style="text-align: left;"><font color="red">*</font>职称：</td>
                            <td>
                                <select class="validate[required] inputText" name="positional_titles" style="width: 80%">
                                    <option value="">请选择</option>
                                    <c:forEach items="${dictTypeEnumUserTitleList}" var="title">
                                        <option value="${title.dictName}"
                                                <c:if test='${resultMap.positional_titles==title.dictName}'>selected="selected"</c:if>>${title.dictName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            <td style="text-align: left;">职务：</td>
                            <td>
                                <select class="validate[required] inputText" name="business" style="width: 80%">
                                    <option value="">请选择</option>
                                    <c:forEach items="${dictTypeEnumUserPostList}" var="post">
                                        <option value="${post.dictName}"
                                                <c:if test='${resultMap.business==post.dictName}'>selected="selected"</c:if>>${post.dictName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4"><input type="text" name="workUnit" value="${resultMap.workUnit}" class="inputText"
                                       style="width: 80%"/></td>
                            <td style="text-align: left;">所在科室</td>
                            <td colspan="2"><input type="text" name="department" value="${resultMap.department}" class="inputText"
                                       style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">从事专业</td>
                            <td colspan="3"><input type="text" name="major" value="${resultMap.major}" class="inputText"
                                       style="width: 80%"/></td>
                            <td style="text-align: left;">联系电话（手机）</td>
                            <td colspan="3"><input type="text" name="telPhone" value="${resultMap.telPhone}" class="inputText"
                                       style="width: 80%"/></td>
                        </tr>

                        <tr>
                            <th rowspan="6">项目摘要</th>
                        </tr>
                        <tr>
                            <td tyle="text-align: left;padding-left: 20px;"><font color="red">*</font>项目名称
                            </td>
                            <td colspan="7"><input type="text" name="proj_name"
                        ...
                        <tr>
                            <td style="text-align: left;padding-left: 20px;">所属学科
                            </td>
                            <td colspan="3"><input type="text" name="proj_subject"
                                                   value="${resultMap.proj_subject}"
                                                   class="inputText"
                                                   style="width: 80%"/></td>
                            <td  style="text-align: left;padding-left: 20px;">相关学科</td>
                            <td colspan="3"><input type="text" name="related_subject"
                                                   value="${resultMap.related_subject}"
                                                   class="inputText"
                                                   style="width: 80%"/></td>
                        </tr>
                        <tr>
                            <td  style="text-align: left;padding-left: 20px;"><font color="red">*</font>市卫生计生委资助经费</td>
                            <td colspan="3"><input type="text" name="globe_fee"
                                       value="${resultMap.globe_fee}"
                                       class="inputText validate[required]"
                                       style="width: 80%"/> 万元</td>
                            <td style="text-align: left;padding-left: 20px;"><font color="red">*</font>总经费</td>
                            <td colspan="3"><input type="text" name="amount_fee"
                                       value="${resultMap.amount_fee}"
                                       class="inputText validate[required]"
                                       style="width: 80%"/> 万元</td>
                        </tr>
                        <tr>
                            <td style="text-align: left;padding-left: 20px;"><font color="red">*</font>项目起止年月</td>
                            <td colspan="7">
                        ...
                        <tr>
                            <td colspan="8"><textarea placeholder="推广项目概述（简要说明推广内容、方式、目标及成效，限400字）" name="approveSummary" class="validate[maxSize[400]]"
