    ...
    <table class="bs_tb" id="expendBudgetTb" style="width: 100%;margin-top: 10px; border-bottom-style: none;">
        ...
        <tr>
            <td colspan="8" style="text-align:left; height: 50px">
                &#12288;项目负责人（签名）：<input type="text" name="applyUser_sign"
                                         value="${resultMap.applyUser_sign}" class="inputText"/><br/>
                &#12288;财务负责人（签名）:<input type="text" name="applyFund_sign"
                                         value="${resultMap.applyFund_sign}" class="inputText"/>&#12288;&#12288;
                &#12288;项目单位负责人（签名）：<input type="text" name="applyOrg_sign"
                                           value="${resultMap.applyOrg_sign}" class="inputText"/>
            </td>
        </tr>
    </table>
</form>
