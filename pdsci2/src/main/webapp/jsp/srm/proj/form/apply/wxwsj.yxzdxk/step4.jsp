        ...
        <div class="content">
            <div style="margin-top: 10px;">
                <form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" style="position: relative;"
                    ...
                    <font style="font-size: 14px; font-weight:bold;color: #333;">三、重点学科（发展学科）带头人概况</font>
                    <table class="basic" style="width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            <td style="text-align: left;">最高学会任职：</td>
                            <td><input type="text" name="highestServe" value="${resultMap.highestServe}" class="inputText" style="width: 80%"/></td>
                        </tr>
                        <tr>
