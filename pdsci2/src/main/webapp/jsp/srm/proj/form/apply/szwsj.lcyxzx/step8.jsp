	...
	$("#"+tb+"Tb").children("tr").last().children("td").eq(1).text(length+1);
        	    	...
        	    	<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
   					...
   					<table class="bs_tb" style="width: 100%;margin-top: 10px;" id="sciThesis">
   						<tr>
	   						<th colspan="6" class="theader">表 9：近五年为第一作者发表的SCI收录及中华级论文共 <input type="text" name="sciThesisNum" value="${resultMap.sciThesisNum}" class="validate[custom[integer]] inputText" style="width:30px;"/> 项。（限填20项代表作）
	   						<c:if test="${param.view!=GlobalConstant.FLAG_Y }">
