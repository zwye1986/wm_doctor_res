      ...
      <div class="content">
        ...
        <form id="fileForm" action="<s:url value="/srm/proj/mine/savePageGroupStep"/>" method="post" enctype="multipart/form-data" target="screct_frame">
           ...
           <table class="basic" width="100%">
                 <thead>
                    <tr>
                        <th colspan="4" style="border-top: 1px solid #D0E3F2;text-align: left;padding-left: 15px;font-size: 14px;font-weight: bold;background: #ECF2FA;height: 35px;line-height: 35px;">项目合同</th>
                    </tr>
                 </thead>
                 <tbody>
                      <tr>
                         <td width="100px">项目合同名称：</td>
                         <td width="200px">
                         	<input class="validate[required] inputText" name="contractEdit_fileName" type="text" value="${file.fileName}" style="width: 90%"/>
                         </td>
                         <td width="80px">项目合同:</td>
                         <td>
                         	<input type="file" name="contractEdit_file" class="validate[required] inputText" style="width: 90%"/>
                         </td>	
                      </tr>
                      <tr>
                         <td width="100px">项目合同备注：</td>
                         <td colspan="3">
                         	<input class="validate[required] inputText" name="contractEdit_fileRemark" type="text" style="width: 90%" value="${file.fileRemark}" />
                         </td>
           ...
           <div class="button">
		   	<input class="search" type="button" id="sv" onclick="save();" value="保存"/>
      	   </div>
           </form>
         </div>
