                    ...
                    <tr>
                        ...
                        <td colspan="3" width="80%">
                            <input name="startYear" type="text"
                                   ...
                                   <c:if test="${empty applicationScope.sysCfgMap['srm_contract_start_time']}">onClick="WdatePicker({dateFmt:'yyyy年MM月'})"</c:if>/>~
                            <input name="endYear" type="text"
                                   ...
                                   class="validate[required] inputText" readonly="readonly" style="width: 40%; "
                                   <c:if test="${empty applicationScope.sysCfgMap['srm_contract_end_time']}">onClick="WdatePicker({dateFmt:'yyyy年MM月'})"</c:if>/>
                            <span class="redspan" style="color: red;padding: 0px;margin-left: 10px;">*</span>
                        </td>
                    </tr>
                    <tr>
