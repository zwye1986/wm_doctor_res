...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">十、预期目标及健康、社会效益</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        <tr>
            <th style="text-align: left;">
                &#12288;&#12288;（包括预期推广单位数、培训人员数、开展应用例数、取得的健康效益及社会效益等）
            </th>
        </tr>
        <tr>
            <td><textarea name="expect_target" style="width:98%;height: 150px;"
                          class="validate[maxSize[1000]]">${resultMap.expect_target}</textarea></td>
        </tr>
