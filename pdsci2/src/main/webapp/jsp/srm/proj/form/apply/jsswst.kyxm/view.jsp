            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">项目负责人概况</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">课题组总体情况</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">主要研究内容及考核指标</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">预期成果、预期经济效益、项目经费</a>
                        </li>
                    </ul>
                    </div>
                    <div id="tagContent">
