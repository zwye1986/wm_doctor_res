...
<form action="<s:url value='/srm/proj/mine/saveStep'/>" method="post" id="projForm" style="position: relative;">
    ...
    <font style="font-size: 14px; font-weight:bold;color: #333;">三、推广方式方法</font>
    <table width="100%" cellspacing="0" cellpadding="0" class="basic">
        ...
        <tr>
            <td><textarea name="extend_method" style="width:98%;height: 150px;">${resultMap.extend_method}</textarea></td>
        </tr>
