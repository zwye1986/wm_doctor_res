	...
	<div class="mainright">
    	<div class="content">
    		<ul id="tags">
	            ...
	            <li id='tag1'><a onclick="selectTag('tagContent1','tag1')" href="javascript:void(0)">项目的目标和主要研究内容</a></li>
	            <li id='tag2'><a onclick="selectTag('tagContent2','tag2')" href="javascript:void(0)">项目验收内容和考核指标</a></li>
	            <li id='tag3'><a onclick="selectTag('tagContent3','tag3')" href="javascript:void(0)">项目进度计划与考核指标</a></li>
	            <li id='tag4'><a onclick="selectTag('tagContent4','tag4')" href="javascript:void(0)">人员情况</a></li>
