      ...
      <div class="content">
        ...
        <form id="fileForm" action="<s:url value="/srm/proj/mine/savePageGroupStep"/>" method="post" enctype="multipart/form-data" target="screct_frame">
           ...
           <table class="basic">
                 <thead>
                    <tr>
                        <th colspan="4" style="border-top: 1px solid #D0E3F2;text-align: left;padding-left: 15px;font-size: 14px;font-weight: bold;background: #ECF2FA;height: 35px;line-height: 35px;">项目经费决算表</th>
                    </tr>
                 </thead>
                 <tbody>
                      <tr>
                         <td width="150px">项目经费决算表名称：</td>
                         <td width="180px">
                         	<input class="validate[required] inputText" name="costEdit_fileName" type="text" style="width:90%" value="${file.costEdit_fileName}"/>
                         </td>
                         <td width="120px">项目经费决算表：</td>
                         <td>
                         	<input type="file" name="costEdit_file" class="validate[required] inputText" style="width:90%" />
                         	
                         </td>
                      </tr>
                      <tr>
                         <td width="150px">项目经费决算表备注：</td>
                         <td colspan="3">
                         	<input class="validate[required] inputText" name="costEdit_fileRemark" type="text" style="width: 90%" value="${file.costEdit_fileRemark}" />
                         </td>
