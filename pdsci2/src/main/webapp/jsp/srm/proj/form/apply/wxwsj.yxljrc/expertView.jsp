        ...
        <div class="content">
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">带头人简历</a></li>
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">带头人业绩</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">创新团队简介</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">创新团队主攻方向</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">创新团队人员信息</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">创新团队主要业绩（一）</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">创新团队主要业绩（二）</a></li>
