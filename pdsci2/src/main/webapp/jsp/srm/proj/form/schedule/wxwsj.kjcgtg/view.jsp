            ...
            <div class="title1 clearfix">
                <div style="overflow:hidden;">
                    <ul id="tags">
                        ...
                        <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">简表</a></li>
                        <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">推广项目内容</a></li>
                        <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">推广方式方法</a></li>
                        <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">推广计划进度</a></li>
                        <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">推广工作条件保障</a></li>
                        <li><a onclick="selectTag('tagContent6',this)" href="javascript:void(0)">推广工作目标与效益</a></li>
                        <li><a onclick="selectTag('tagContent7',this)" href="javascript:void(0)">推广单位项目组成员</a></li>
                        <li><a onclick="selectTag('tagContent8',this)" href="javascript:void(0)">受推单位及项目负责人</a></li>
                        <li><a onclick="selectTag('tagContent9',this)" href="javascript:void(0)">项目经费使用预算</a></li>
