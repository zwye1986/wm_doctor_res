    ...
    <div class="mainright">
        <div class="content">
            <div class="title1 clearfix">
                ...
                <ul id="tags">
                    <li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">项目基本情况</a>
                    </li>
                    <li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">项目简介</a></li>
                    <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">主要完成人情况表（一）</a></li>
                    <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">主要完成人情况表（二）</a></li>
                    <li><a onclick="selectTag('tagContent4',this)" href="javascript:void(0)">主要完成人情况表（三）</a></li>
                    <li><a onclick="selectTag('tagContent5',this)" href="javascript:void(0)">附件信息</a></li>
                </ul>
                    </div>
                <div id="tagContent">
