...
<div class="mainright">
  <div class="content">
	...
	<p>
		...
		&#12288;出版年份：
	    <input onClick="WdatePicker({dateFmt:'yyyy'})" style="width: 160px;" class="xlname ctime" name="publishDate" type="text" value="${param.publishDate}" />
	...
	<table class="xllist">
		...
		<tr>
			...
			<td><a href="javascript:void(0);" onclick="auditProcess('${achBook.bookFlow}')">${achBook.operStatusName}</a></td>
			<td>
				<c:choose>
