...
function getChangeOrgDetail(doctorFlow, recordFlow){
	var url = "<s:url value='/jszy/manage/getChangeOrgDetail'/>?change=Y&doctorFlow=" + doctorFlow + "&recordFlow="+recordFlow;
...
function search(){
	...
	if("${GlobalConstant.FLAG_Y}"=="${param.viewFlag}"){
		url="<s:url value='/jszy/manage/searchChangeSpe'/>?viewFlag=${param.viewFlag}";
	}
