...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/jszy/doctorTheoryScore/doctorTheoryListSun'/>?" + data + "&roleFlag=${roleFlag}", $("#searchForm").serialize(), false);
    }
    function importExcel() {
        var url = "<s:url value='/jszy/doctorTheoryScore/importSchoolRoll'/>";
    ...
    function exportExcel(){
        ...
        var url = "<s:url value='/jszy/doctorTheoryScore/doctorTheoryListSunExport'/>?" + data + "&roleFlag=${roleFlag}";
        jboxTip("导出中…………");
    ...
    function deleteScore(scoreFlow, roleFlag,page) {
        jboxConfirm("确认删除？", function () {
            jboxPost("<s:url value='/jszy/doctorTheoryScore/deleteScore'/>?scoreFlow=" + scoreFlow + "&roleFlag=" + roleFlag, null, function (resp) {
    ...
    function saveScore(scoreFlow, k, obj, roleFlag) {
        ...
        jboxPost("<s:url value='/jszy/doctorTheoryScore/saveTheoryScore?roleFlag='/>" + roleFlag, data, function (resp) {
            if ("1" == resp) {
    ...
    function skillScoreDetail(doctorFlow, scoreFlow, scoreType, scoreYear) {
        var url = "<s:url value='/jszy/doctorTheoryScore/scoreDetail?scoreFlow='/>" + scoreFlow + "&doctorFlow=" + doctorFlow + "&scoreType=" + scoreType + "&scoreYear=" + scoreYear;
