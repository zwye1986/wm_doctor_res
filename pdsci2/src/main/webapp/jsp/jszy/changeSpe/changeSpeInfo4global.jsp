...
<script type="text/javascript">
    ...
    function showCheckChangeSpe(recordFlow) {
        var url = "<s:url value='/jszy/manage/showCheckChangeSpe'/>?roleId=${roleId}&recordFlow=" + recordFlow;
        jboxOpen(url, "审核", 750, 530);
    }
    ...
    function searchIn() {
        var url = "<s:url value='/jszy/manage/changeSpeManage'/>";
                        ...
                        <c:forEach items="${historysMap[docOrgHistoryExt.userFlow]}" var="docSpeHistory"
                            ...
                            <c:if test="${num.count > 1}">
                                ...
                                <tr>
                                    ...
                                    <td class="${docOrgHistoryExt.userFlow}Show" style="display: none;" title="${hostory.trainingTypeName}">${pdfn:cutString(hostory.trainingTypeName,4,true,3)}</td>
                                    <td class="${docOrgHistoryExt.userFlow}Show" style="display: none;" title="${hostory.trainingSpeName}">${pdfn:cutString(hostory.trainingSpeName,4,true,3)}</td>
                                    <td class="${docOrgHistoryExt.userFlow}Show" style="display: none;" title="${hostory.secondSpeName}">${pdfn:cutString(hostory.secondSpeName,4,true,3)}</td>
                                </tr>
                            </c:if>
                        </c:forEach>
                    </c:if>
