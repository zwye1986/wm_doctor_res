...
function getDoctorRecruit(recruitFlow, doctorFlow){
	var url = "<s:url value='/jszy/doctor/getDoctorRecruit?change=${param.change}&openType=open&recruitFlow='/>"+recruitFlow +"&doctorFlow=" + doctorFlow;
...
function delay(userFlow,jointOrg){
	var url = "<s:url value='/jszy/doctor/delay?seeFlag=Y&userFlow='/>"+userFlow+"&jointOrg="+jointOrg;
	jboxLoad("contentDiv", url, true);
}
</script>
</head>
