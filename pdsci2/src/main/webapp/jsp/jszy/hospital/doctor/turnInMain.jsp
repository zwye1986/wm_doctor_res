...
function turnInOrg(recordFlow, auditFlag, doctorFlow){
	...
	if(title=="不通过"){
		...
		var url="<s:url value='/jszy/manage/info'/>?recordFlow="+recordFlow +"&changeStatusId="+changeStatusId+"&doctorFlow="+doctorFlow;
...
function searchIn(){
	var url ="<s:url value='/jszy/manage/turnInMain'/>";
