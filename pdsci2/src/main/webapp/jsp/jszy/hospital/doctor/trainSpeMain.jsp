...
function trainSpeOperate(){
	jboxOpen("<s:url value='/jsp/jszy/hospital/doctor/trainSpeOperate.jsp'/>","变更专业",550,250);
}
...
function getInfo(){
	jboxOpen("<s:url value='/jsp/jszy/province/doctor/doctorMain.jsp'/>","医师信息",1050,550);
}
</script>
</head>
<body>
