...
function changeMonth(){
	var currentPage=1;
	var month = $("#month").val();
	var url = "<s:url value='/jszy/statistic/statisticsNoAppUser'/>?open=${param.open}&month="+month+"&currentPage="+currentPage+"&catSpeId=${param.catSpeId}&orgFlow=${param.orgFlow}";
