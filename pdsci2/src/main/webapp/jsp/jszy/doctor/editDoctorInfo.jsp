...
//	}
        ...
        var url = "<s:url value='/jszy/doctor/saveDoctorInfo'/>";
    ...
    function getUserResumeExtName(){
        ...
        console.log(practicingCategoryName);
        ...
        console.log(practicingScopeName);
    }
    ...
    function uploadFile(type,typeName) {
        var url = "<s:url value='/jszy/doctor/uploadFile'/>?userFlow=${user.userFlow}&operType="+type;
                    ...
                    <td style="padding-left:10px;">
                        ...
                        <select id="practicingCategoryId" name="userResumeExt.practicingCategoryId" class="select" style="width: 160px;" onchange="changeCategoryId(this.value)">
                            ...
                            <c:forEach items="${dictTypeEnumPracticeTypeList}" var="dictTypeEnumPracticeType">
                                <option value="${dictTypeEnumPracticeType.dictId}"	 <c:if test='${userResumeExt.practicingCategoryId==dictTypeEnumPracticeType.dictId}'>selected</c:if>>${dictTypeEnumPracticeType.dictName}</option>
                            </c:forEach>
                        </select>
                    </td>
                    <th>执业范围：</th>
                        ...
                        <select id="practicingScopeId" name="userResumeExt.practicingScopeId" class="select" style="width: 160px;">
                            ...
                            <c:forEach items="${dictTypeEnumPracticeTypeList}" var="dict">
                                ...
                                <c:forEach items="${applicationScope[dictKey]}" var="scope">
                                    <option class="${scope.dictTypeId}" value="${scope.dictId}" <c:if test='${userResumeExt.practicingScopeId==scope.dictId and dict.dictId == userResumeExt.practicingCategoryId}'>selected</c:if>>${scope.dictName}</option>
                                </c:forEach>
                            </c:forEach>
                        </select>
                    </td>
