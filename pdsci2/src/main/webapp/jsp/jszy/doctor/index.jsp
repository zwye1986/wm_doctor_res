...
<head>
    ...
    //			}
                ...
                <%--}--%>
                if(result==1){
                   // jboxOpen("<s:url value='/jszy/doctor/saveForLack'/>",null,650,380);
                }
            <%--}--%>
        ...
        function main(recruitFlow) {
            var url = "<s:url value='/jszy/doctor/main'/>";
            if (recruitFlow != "") {
        ...
        function shouye() {
            var url = "<s:url value='/jszy/doctor/index'/>";
        ...
        function toPage(page) {
            ...
            var url = "<s:url value='/jszy/doctor/index'/>?currentPage=" + currentPage;
            window.location.href = url;
        }
        ...
        function trainRegister() {
            jboxLoad("content", "<s:url value='/jszy/doctor/trainRegister'/>", true);
        }
        function reductionApplyMain() {
            jboxLoad("content", "<s:url value='/jszy/reduction/reductionApplyMain'/>", true);
        }
        //安全中心
        function accounts(){
            jboxLoad("content", "<s:url value='/jszy/manage/accounts'/>", true);
        }
        function doctorBaseInfo(userFlow){
            jboxLoad("content", "<s:url value='/jszy/doctor/doctorInfo?userFlow='/>" + userFlow, true);
        }
        function certificateManage() {
            jboxLoad("content", "<s:url value='/jszy/graduationManager/doctorMain'/>", true);
        }
        function graduationRegistrate() {
            jboxLoad("content", "<s:url value='/jszy/asse/graduationRegistrate'/>", true);
        }
        /*成绩查询*/
        function owenScore(){
            jboxLoad("content","<s:url value='/jszy/doctor/owenScore'/>",true);
        }
    </script>
    <style>
        body {
                ...
                <div class="container">
                    <div class="content_side">
                        ...
                        <dl class="menu">
                            ...
                            <dd class="menu_item"><a onclick="graduationRegistrate();">结业考核申请</a></dd>
