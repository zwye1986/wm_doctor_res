...
function submit(){
	...
	var url = "<s:url value='/jszy/doctor/submitDoctorOrgHistory'/>";
...
function checkResOrgSpe(orgFlow){
	...
	if("${recruit.sessionNumber}">="2015"){
		jboxStartLoading();
		var url = "<s:url value='/jszy/doctor/checkResOrgSpe'/>?catSpeId=${param.catSpeId}&speId=${param.speId}&orgFlow=" +orgFlow;
		jboxGet(url, null, function(resp){
				jboxEndLoading();
...
<div class="div_search">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="base_info" style="margin-top: 25px;">
			...
			<td colspan="3">
	           ...
	           <tr>
					<th>模板文件：</th>
					<td colspan="3"><a href="<s:url value='/jsp/jszy/daochu/changeBase.docx'/>">培训基地变更申请表.docx</a></td>
				</tr>
	           </tbody>
          </table>
          </form>
