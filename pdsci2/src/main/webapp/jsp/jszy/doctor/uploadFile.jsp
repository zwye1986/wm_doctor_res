...
function checkUploadFile(){
	if ($("#uploadFileForm").validationEngine("validate")) {
		...
		var url = "<s:url value='/jszy/doctor/checkUploadFile'/>";
...
<body>
<div class="infoAudit">
	<form id="uploadFileForm" method="post" style="position:relative;" action="<s:url value='/jszy/doctor/checkUploadFile'/>" enctype="multipart/form-data">
