...
function search(){
	...
	var url="<s:url value='/jszy/blackList/blackListInfo'/>";
...
function removeBlack(userFlow,recordStatus,recordflow){
	jboxConfirm("确认移除该记录吗？",function () {
		var url = "<s:url value='/jszy/blackList/removeBlack?userFlow='/>" + userFlow + "&recordStatus=" + recordStatus +"&recordFlow=" + recordflow;
...
function addBlackList(){
	jboxOpen("<s:url value='/jszy/blackList/addBlackList'/>","黑名单添加", 500, 400);
}
