...
<script type="text/javascript">
    ...
    function toPage(page,scoreYear) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/jszy/doctorTheoryScore/doctorSkillListSun'/>?" + data + "&roleFlag=${roleFlag}", $("#searchForm").serialize(), false);
    }
    function importExcel() {
        var url = "<s:url value='/jszy/doctorTheoryScore/importSkillScore'/>";
    ...
    function deleteSkillScore(scoreFlow, roleFlag,page) {
        jboxConfirm("确认删除？", function () {
            jboxPost("<s:url value='/jszy/doctorTheoryScore/deleteSkillScore'/>?scoreFlow=" + scoreFlow + "&roleFlag=" + roleFlag, null, function (resp) {
    ...
    function saveScore2(scoreFlow, k, obj, stationName, roleFlag) {
        ...
        jboxPost("<s:url value='/jszy/doctorTheoryScore/saveSkillIsPass?roleFlag='/>" + roleFlag + "&stationName=" + k + "&isPass=" + score, data, function (resp) {
            if ("1" == resp) {
    ...
    function saveScore(scoreFlow, k, obj, stationName, roleFlag) {
        ...
        jboxPost("<s:url value='/jszy/doctorTheoryScore/saveSkillScore?roleFlag='/>" + roleFlag + "&stationName=" + k + "&skilScore=" + score, data, function (resp) {
            if ("1" == resp) {
