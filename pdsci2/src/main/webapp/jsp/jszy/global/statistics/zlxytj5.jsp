...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content", "<s:url value='/jszy/statistic/zlxytj5'/>", $("#searchForm").serialize(), true);
    }
    ...
    function exportExcel() {
        ...
        var url = "<s:url value='/jszy/statistic/exportZlxytj4'/>";
        jboxTip("导出中…………");
        ...
        <form id="searchForm">
            ...
            <table class="searchTable">
                <tr>
                    ...
                    <td id="provCityAreaId">
                        <select id="cityId" name="cityId" onchange="searchOrgList();"
                                class="city select validate" data-value="${cityId}"   style="width: 106px;">
                        </select>
                    </td>
                    <td class="td_left">基&#12288;&#12288;地：</td>
                    <td>
                        <select id="orgFlow" name="sorgFlow" class="validate select" onchange="checkResOrgSpe(this.value);" style="width: 106px;">
                ...
                <tr>
                    ...
                    <td colspan="2" id="func" style="text-align: center;">
