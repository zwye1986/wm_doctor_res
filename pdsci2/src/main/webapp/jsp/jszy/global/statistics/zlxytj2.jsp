...
//            return false;
        ...
        jboxPostLoad("content", "<s:url value='/jszy/statistic/zlxytj2'/>", $("#searchForm").serialize(), true);
    }
    ...
    function exportExcel() {
        ...
        var url = "<s:url value='/jszy/statistic/exportZlxytj2'/>";
        jboxTip("导出中…………");
    ...
    function showSecondSpe(orgFlow, speId, sessionNumber) {
        ...
        var url = "<s:url value='/jszy/statistic/zltjSecondSpe'/>?orgFlow=" + orgFlow+"&speId="+speId+"&sessionNumber="+sessionNumber+data+trainYears;
        jboxStartLoading();
