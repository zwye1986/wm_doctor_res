...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/jszy/certificateManage/list'/>?roleFlag=${roleFlag}", $("#searchForm").serialize(), false);
    }
    ...
    function exportExcel() {
        ...
        var url = "<s:url value='/jszy/certificateManage/exportCertificateList'/>";
        jboxTip("导出中…………");
    ...
    function importExcel() {
        var url = "<s:url value='/jsp/jszy/global/certificateManage/importDoctorCertificateNo.jsp'/>";
