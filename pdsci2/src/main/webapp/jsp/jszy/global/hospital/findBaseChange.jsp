...
function getChangeOrgDetail(doctorFlow, recordFlow){
	var url = "<s:url value='/jszy/manage/getChangeOrgDetail'/>?change=Y&openType=open&doctorFlow=" + doctorFlow + "&recordFlow="+recordFlow;
...
function audit(recordFlow,doctorFlow){
	var url="<s:url value='/jszy/manage/audit'/>?doctorFlow="+doctorFlow+"&recordFlow="+recordFlow+"";
...
<div class="main_bd">
	<div class="div_search">
		<form id="inForm">
			...
			姓&#12288;&#12288;名：<input type="text" name="doctorName" value="${param.doctorName}" class="input"
									  style="width: 100px;"/>&#12288;
			年&#12288;&#12288;级：
			...
			<label style="cursor: pointer;"><input type="checkbox" name="statusFlag" value="${GlobalConstant.FLAG_Y}"
												   <c:if test="${param.statusFlag eq GlobalConstant.FLAG_Y}">checked="checked"</c:if>
												   onclick="check(this);">&nbsp;未通过记录&#12288;</label>
