...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/jszy/archive/doctorTrendListSun'/>?"+data+"&roleFlag=${roleFlag}",$("#searchForm").serialize(),false);
	}

	function doctorPassedList(doctorFlow,recruitFlow,archiveFlow){
		var hideApprove="hideApprove";
		var url = "<s:url value='/jszy/archive/province/doctor/doctorPassedList'/>?info=${GlobalConstant.FLAG_Y}&liId="+recruitFlow+"&recruitFlow="+recruitFlow+"&archiveFlow="+archiveFlow+"&openType=open&doctorFlow="+doctorFlow+"&hideApprove="+hideApprove;
	...
	function exportExcel(){
		...
		var url = "<s:url value='/jszy/archive/exportDoctor'/>?"+data+"&sessionNumber="+sessionNumber;
		jboxTip("导出中…………");
	...
	function exportForDetail(){
		...
		var url = "<s:url value='/jszy/archive/exportForDetail'/>?"+data+"&sessionNumber="+sessionNumber;
		jboxTip("导出中…………");
		jboxSubmit($("#searchForm"), url, null, null, false);
		jboxEndLoading();
	}
...
// alert($("#"+orgFlow));
// 	var url = "<s:url value='/jszy/doctor/searchJointOrgFlag'/>?orgFlow="+orgFlow;
...
// 		}, null , false);
	...
	function exTrainingDocPdf(){
		...
		location.href = '<s:url value="/jszy/manage/exTrainingDocLogPdf"/>?orgFlow=${currUser.orgFlow}&archiveFlow='+ archiveFlow + '&sessionNumber='+sessionNumber;
	...
	function exZLTrainingDocPdf(){
		...
		location.href = '<s:url value="/jszy/manage/exZLTrainingDocLogPdf"/>?orgFlow=${currUser.orgFlow}&archiveFlow='+ archiveFlow + '&sessionNumber='+sessionNumber;
	}
