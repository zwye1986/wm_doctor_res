...
function  applyAudit()
{
	...
	jboxConfirm("确认审核？" , function(){
		jboxStartLoading();
		jboxPost("<s:url value='/jszy/asseGlobal/chargeSaveAudit'/>?roleFlag=${param.roleFlag}",
				$("#myform").serialize(),
				function(resp){
					top.jboxEndLoading();
					endloadIng();
	...
	<div class="main_bd" id="div_table_0" >
		...
		<table border="0" cellpadding="0" cellspacing="0" style=" width:100%;text-align: center;"class="base_info" >
			...
			<tbody>
				...
				<tr style=" width:100%;text-align: center;">
					...
					<td style="text-align: left;">&#12288;&#12288;<input type="radio" name="auditStatusId" value="${jszyResAuditStatusEnumNotPassed.id}" onclick="check();">不通过</td>
				</tr>
				<tr style=" width:100%;text-align: center;">
		...
		<div class="main_bd" id="div_table_1" >
			<div align="center" style="margin-top: 20px; margin-bottom:20px;">
				<input type="button" id="" class="btn_brown" onclick="applyAudit();" value="确定"/>&nbsp;
