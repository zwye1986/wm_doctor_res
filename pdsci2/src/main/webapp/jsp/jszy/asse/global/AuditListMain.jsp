...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/jszy/asseGlobal/AuditList'/>?roleFlag=${roleFlag}",$("#searchForm").serialize(),false);
	}
	function exportInfo()
	{
		if(!$("#applyYear").val()){
		...
		var url = "<s:url value='/jszy/asseGlobal/exportList'/>?roleFlag=${roleFlag}";
