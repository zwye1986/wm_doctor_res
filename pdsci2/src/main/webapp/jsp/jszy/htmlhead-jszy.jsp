...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jszy/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
<c:if test="${param.queryFont=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jszy/css/queryFont.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
<c:if test="${param.login=='true'}">
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jszy/css/login.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>

<c:if test="${param.register=='true'}">
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/jszy/css/style.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
