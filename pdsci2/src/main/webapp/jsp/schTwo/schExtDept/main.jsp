		...
		<form  id="doctorSearchForm" method="post">
			...
			<table class="basic" style="width:100%;margin-top: 10px;">
				<tr>
					...
					<td>
						<select name="doctorCategoryId" id="doctorCategoryId" class="xlselect" onchange="changeSpeId();search();">
					...
					<td>
						<select name="sessionNumber" id="sessionNumber" class="xlselect" onchange="search();">
					...
					<th>培训专业：</th>
					<td>
						<select name="trainingSpeId" id="trainingSpeId"class="xlselect" onchange="initDepts();changRotation();search();">
							<option value="">请选择</option>
					...
					<th>轮转方案：</th>
					<td>
						<select name="rotationFlow" id="rotationFlow" class="xlselect" onchange="initDepts();searchDept(this); search();">
							<option value="">请选择</option>
						</select>
					</td>
				</tr>
		...
		<table class="basic" style="width:100%;margin-top: 20px;">
			...
			<tr>
				<td style="text-align: center;" colspan="4">
					<input type="button" value="保存" class="search" onclick="save();"/>
				</td>
			</tr>
		</table>
