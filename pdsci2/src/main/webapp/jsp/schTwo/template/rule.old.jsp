...
<script type="text/javascript">
	function doBack(){
		var target = "<s:url value='/schTwo/template/list'/>";
	...
	function delRotationDept(recordFlow,groupFlow){
		jboxConfirm("确认删除?",function () {
			var url = "<s:url value='/schTwo/template/delRotationDept'/>?rotationFlow=${param.rotationFlow}&recordFlow="+recordFlow+"&groupFlow="+groupFlow;
...
// 	}
	...
	//加载后滑出
	function rotationRequire(recordFLow){
		jboxGet("<s:url value='/schTwo/template/rotationRequire'/>?roleFlag=${param.roleFlag}&speId=${param.speId}&sessionNumber=${param.sessionNumber}&rotationFlow=${param.rotationFlow}&recordFlow="+recordFLow,null,function(resp){
	...
	function refresh(rotationFlow){
		window.location.href="<s:url value='/schTwo/template/rule'/>?roleFlag=${param.roleFlag}&speId=${param.speId}&sessionNumber=${param.sessionNumber}&rotationFlow="+rotationFlow;
	}
	...
	function relCfg(deptBody){
		...
		jboxPost("<s:url value='/schTwo/template/relSchDept'/>?standardDeptId="+$("."+deptBody).attr("standardId"),null,function(resp){
			if(resp){
...
// 			}
		...
		jboxConfirm("确认保存修改?",function(){
			jboxPostJson("<s:url value='/schTwo/template/saveCfg'/>?groupFlow="+groupFlow+"&deptNum="+deptNum,JSON.stringify(rotationDeptList),function(resp){
