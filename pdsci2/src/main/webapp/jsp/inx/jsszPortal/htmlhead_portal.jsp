...
<c:if test="${param.font=='true'}">
    <link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/zsey/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
...
<c:if test="${param.bootstrap=='true'}">
    <link rel="shortcut icon" href="<s:url value='/jsp/inx/jsszPortal/images/logo.ico'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/jsszPortal/bootstrap-3.3.7-dist/css/bootstrap.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/jsszPortal/css/swiper.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/jsszPortal/css/common.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<script src="<s:url value='/jsp/inx/jsszPortal/js/jquery-1.10.2.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/jsszPortal/js/swiper.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/jsszPortal/bootstrap-3.3.7-dist/js/bootstrap.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/jsszPortal/js/common.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>