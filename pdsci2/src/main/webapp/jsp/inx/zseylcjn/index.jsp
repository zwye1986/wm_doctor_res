...
<div class="loginbg">
    <div class="loginbar">
        <div class="mainlogin">
            <form id="loginForm" action="<s:url value='/inx/zseylcjn/login'/>" method="post">
        ...
        <div class="loginlogo">
            <%--<img src="<s:url value='/jsp/inx/zseylcjn/images/logo.png'/>">--%>
        </div>
        <div class="title">
            临床技能训练中心预约管理系统
        </div>
        <%--<div class="side-bar" style="display:none;">--%>
            <%--<a href="javascript:void(0);" class="icon-chat" title="浏览器扫码">手机版--%>
                <%--<div class="chat-tips"><i></i><img style="width:138px;height:138px;" src="<s:url value='/jsp/inx/zseylcjn/images/lcjnapp.png'/>"></div>--%>
            <%--</a>--%>
