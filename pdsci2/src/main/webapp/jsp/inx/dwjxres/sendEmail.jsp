...
<body>
	<div class="yw">
		<c:if test="${sysCfgMap['jx_templete_name'] eq 'cd'}">
			<div class="top" onclick="window.location.href='<s:url value='/inx/dwjxres'/>'" style="cursor: pointer;">${sysCfgMap['jx_top_name']}</div>
		</c:if>
		...
		<%--<h1 class="reg_title">邮箱激活</h1>--%>
	     <div <%--style="margin-left: 50px;margin-top: 20px;"--%>>
               ...
               <ul class="noEamil" style="margin-top:30px;margin-left: 52px; ">
                  <li>没收到邮件？</li>
                  <li>1、请检查邮箱地址是否正确，你可以返回<a href="<s:url value='/jsp/inx/dwjxres/register.jsp'/>">重新填写</a></li>
                  <li>2、检查你的邮件垃圾箱</li>
                ...
                <ul class="noEamil" style="margin-top:50px;/*margin-left: 52px;*/ text-align: center;font-size: 20px; ">
               	...
               	<font style="color: red">(请确保您填写的邮箱真实有效，以便您可以接收到报名审核结果与录取通知)</font></li>--%>
             	 	 <li><a href='<s:url value="/inx/dwjxres/activateuser?activationCode=${activationCode}"/>'>点此链接激活</a></li>
                </ul>
	     </div>
	     </div>
	</div>
