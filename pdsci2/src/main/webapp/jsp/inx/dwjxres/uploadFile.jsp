...
function returnUrl(){
	...
	if ("${operType}"=="doctorHeadImgFile") {//证件照需预览
		...
		var onclick="showImage('"+filePath+"');";
		window.parent.$('#${operType}Span').find("a").attr('onclick',onclick);
	}
	doClose();
}
...
<body>
<form id="uploadFileForm" method="post" action="<s:url value='/inx/dwjxres/checkUploadFile'/>" enctype="multipart/form-data">
