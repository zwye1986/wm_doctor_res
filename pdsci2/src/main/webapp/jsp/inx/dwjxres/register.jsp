...
/*	if(!checkMail()){
	...
	jboxPost(url,{/*"userEmail":$("#userEmail").val(),*/"idNo":$("#idNo").val()},
		function(resp){
			if(resp){
				jboxTip(resp);
			}else{
...
<body>
   ...
   <div style="width: 800px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
       <div id="operDiv">
    	...
    	<h2 class="line" style="font-weight:normal;">如已拥有帐户信息，则<a href="<s:url value='/inx/dwjxres'/>" class="line_c">在此登录</a></h2>
        <form id="registerForm" action="<s:url value='/inx/dwjxres/regist'/>" method="post" style="position: relative; margin:20px 30px;">
