...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/jsdxyxy/css/login.css'/>" />
...
<input type="hidden" name="errorLoginPage" value="inx/jsdxyxy/index"/>
<div class="njmu_top_box">
	<div class="njmu_top">
    	<span class="njmu_riqi" style="padding-top:0px;"><img src="<s:url value="/jsp/inx/jsdxyxy/images/logo1.png"/>" /></span>
        <div class="code fr">
	     ...
	     <font class="fr">请扫描二维码下载</font>
	      <div class="QR_android QR" style="display: none;"><img class="QR_code" src="<s:url value='/jsp/inx/jsdxyxy/images/android.png'/>" /></div>
	      <div class="QR_iphone QR" style="display: none;"><img class="QR_code" src="<s:url value='/jsp/inx/jsdxyxy/images/iphone.png'/>" /></div>
	  </div>
    </div>
</div>
<div class="njmu_banner_box">
	<img class="njmu_banner" src="<s:url value="/jsp/inx/jsdxyxy/images/njmu_banner2.png"/>" />
     <div class="njmu_weixin_bg">
           <div class="njmu_weixin">
                 <a class="njmu_db njmu_login_title" >用户登录</a>
                 <div class="njmu_login">
                      <img src="<s:url value="/jsp/inx/jsdxyxy/images/njmu_login_pic1.png"/>" />
                      <input class="validate[required]" name="userCode" value="" placeholder="登录名/学号">
                 </div>
                 <div class="njmu_mima">
                      <img src="<s:url value="/jsp/inx/jsdxyxy/images/njmu_login_pic2.png"/>" />
