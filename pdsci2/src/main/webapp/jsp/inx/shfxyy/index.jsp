...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/shfxyy/css/font.css'/>"/>
    <style>
...
<div class="hb_CN">
    <div class="index_header">
        <div style="margin:50px 0px 0px -700px;height:100%;background-image:url(<s:url value='/jsp/inx/shfxyy/images/logo.png'/>);background-repeat:no-repeat;background-position:center;"></div>
    </div>
            ...
            <div class="banner_box">
                <div class="mainlogin">
                    <form id="loginForm" action="<s:url value='/login'/>" method="post">
                        <input type="hidden" name="errorLoginPage" value="inx/shfxyy/index">
    ...
    <div class="index_footer">
        <div align="center" style="font-size: 15px">
            ...
            </c:if> 地址：南桥镇南奉公路6600号&emsp;&emsp;&emsp;电话：021-57420702&emsp;021-57412833
        </div>
    </div>
</div>
</body>
