  ...
  <div class="content-body container">
    <div class="content-left col-xs-9">
      <div class="notice-list">
        ...
        <div class="files-content clearfix">
              <ul class="files-list">
                  ...
                  <c:if test="${empty infoList}">
                      <li class="files-list-item">无记录！</li>
                  </c:if>
              </ul>
          <%--<div class="files-content-right">--%>
            <%--<div class="panel panel-default">--%>
              <%--<div class="panel-heading">--%>
                <%--<img src="<s:url value='/jsp/inx/portal/images/panner-title.png'/>">--%>
                <%--<span class="files-panel-title">住院医师规范化培训管理系统文件列表</span>--%>
              <%--</div>--%>
              <%--<div class="panel-body">--%>
                <%--<c:forEach items="${fileList}" var="file">--%>
                  <%--<div class="download-hover-box">--%>
                        <%--<c:if test="${file.type == 'pdf'}">--%>
                            <%--<img src="<s:url value='/jsp/inx/portal/images/icon-pdf.png'/>">--%>
                        <%--</c:if>--%>
                        <%--<c:if test="${file.type == 'word'}">--%>
                            <%--<img src="<s:url value='/jsp/inx/portal/images/icon-word.png'/>">--%>
                        <%--</c:if>--%>
                      <%--<div class="download-hover">--%>
                        <%--<a href="javascript:;">--%>
                            <%--<span>${file.title}</span>--%>
                        <%--</a>--%>
                        <%--<a href="${file.url}" class="download-hover-img"></a>--%>
                      <%--</div>--%>
                  <%--</div>--%>
                <%--</c:forEach>--%>
          ...
          <%--&lt;%&ndash;  <div class="panel panel-default">--%>
              <%--<div class="panel-heading">--%>
                <%--<img src="<s:url value='/jsp/inx/portal/images/panner-title.png'/>">--%>
                <%--<span class="files-panel-title">住院医师规范化培训管理系统正式上线住院医师</span>--%>
              <%--</div>--%>
              <%--<div class="panel-body">--%>
                <%--<p class="panel-txt-title">住院医师规范化培训管理系统正式上线住院医师</p>--%>
                <%--<p>各组住院医师规范化培训基地：</p>--%>
                <%--<p class="details-para">为加强煮鱼啊那一世规范化培训（以下简称住培）基地建设与管理，优化资源配置，激励狮子带教，科学核定规范，提升培训质量，根据 为加强煮鱼啊那一世规范化培训（以下简称住培）基地建设与管理，优化资源配置，激励狮子带教，科学核定规范，提升培训质量，根据为加强煮鱼啊那一世规范化培训（以下简称住培）基地建设与管理，优化资源配置，激励狮子带教，科学核定规范，提升培训质量。</p>--%>
                <%--<div class="panel-footer-box">--%>
                  <%--<span>发表时间：</span>--%>
                  <%--<span>2016-07-22&nbsp;&nbsp;&nbsp;&nbsp;15:58:27</span>--%>
                <%--</div>--%>
              <%--</div>--%>
            <%--</div>&ndash;%&gt;--%>
          <%--</div>--%>
