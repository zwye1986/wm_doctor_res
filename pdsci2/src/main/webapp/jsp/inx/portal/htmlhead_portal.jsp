...
<c:if test="${param.bootstrap=='true'}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/portal/bootstrap-3.3.7-dist/css/bootstrap.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/portal/css/swiper.min.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<link rel="stylesheet" href="<s:url value='/jsp/inx/portal/css/common.css'/>?v=${applicationScope.sysCfgMap['sys_version']}">
	<script src="<s:url value='/jsp/inx/portal/js/jquery-1.10.2.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/portal/js/swiper.min.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/portal/bootstrap-3.3.7-dist/js/bootstrap.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
	<script src="<s:url value='/jsp/inx/portal//js/common.js'/>?v=${applicationScope.sysCfgMap['sys_version']}"></script>
</c:if>