...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/zseyjxres/css/login.css'/>"/>
...
<script>
    ...
    function register(){
        window.location.href="<s:url value='/jsp/inx/zseyjxres/register_en.jsp'/>";
    }
...
<div id="con_main">
    <div class="main">
        <div class="logo">
            <img src="<s:url value='/jsp/zseyjxres/images/logo_en.png'/>" alt="logo" title="logo" style="margin-left: -441px;">
        </div>
        <div class="banner">
            <h3><img src="<s:url value='/jsp/zseyjxres/images/sys_logo_en.png'/>" style="margin-left: -415px;"></h3>
            <form id="loginForm" action="<s:url value='/inx/gzzyjxrecruit/login'/>" method="post">
                <div class="bg_login">
                    <table>
                        ...
                        <tr>
                            <td>
                                <img alt="User name" title="User name" src="<s:url value='/jsp/zseyjxres/images/password_1.png'/>">
                                <input style="width:180px;margin-top: 2px;" type="password" id="userPasswd" name="userPasswd" placeholder="password">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <img alt="Verification Code" title="Verification Code" src="<s:url value='/jsp/zseyjxres/images/yzm.png'/>">
                                <input style="margin-top: 2px;width: 115px;float: left" type="text" id="verifyCode" name="verifyCode" placeholder="Verification Code" >
                                <img id="verifyImage" src="<s:url value='/inx/zseyjxres/captcha'/>" style="cursor:pointer;width:64px;height:28px;" onclick="reloadVerifyCode();" title="Click the change verification code" alt="I can't see it. Change it" />
                            </td>
                        </tr>
                        <tr>
