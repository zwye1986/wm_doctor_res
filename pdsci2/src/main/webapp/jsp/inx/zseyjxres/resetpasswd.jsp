...
var tip = {
	...
	function modPasswd() {
		...
		var url = "<s:url value='/inx/zseyjxres/savePasswd'/>?actionId=${actionId}";
		...
		jboxPost(url, data, function(res) {
			if ("${GlobalConstant.RESET_SUCCESSED}"==res) {
				...
				setTimeout(function(){
					window.location.href="<s:url value='/inx/zseyjxres'/>";
				},1000);
...
<body>
  ...
  <div class="content">
   ...
   <div style="width: 900px;height: 450px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
    	...
    	<h2 class="line" style="font-weight:normal;">如已拥有帐户信息，则<a href="<s:url value='/inx/zseyjxres'/>" class="line_c">在此登录</a></h2>
