...
<body>
<div class="yw">
    <div class="top" onclick="window.location.href='<s:url value='/inx/gzzyjxrecruit'/>'" style="cursor: pointer;">${sysCfgMap['jx_top_name']}</div>
			...
			<div style="width: 800px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
				<div style="margin-top:20px;">
					...
					<h2 class="line" style="font-weight:normal;float:right;text-align:right;padding-right:20px;">
						If you have the account information,<a href="<s:url value='/inx/gzzyjxrecruit'/>" class="line_c">click here to login</a>
					</h2>
				</div>
				<form id="registerForm" action="<s:url value='/inx/gzzyjxrecruit/regist'/>" method="post" style="position: relative; margin:65px 30px;">
					  ...
					  <div style="text-align:left;margin:5px auto 10px 210px">
							<input type="button" value="register" onclick="register();" id="registerButton" class="button  button-blue" />
