...
<body>
<div class="yw">
    <div class="top" onclick="window.location.href='<s:url value='/inx/zseyjxres'/>'" style="cursor: pointer;">${sysCfgMap['jx_top_name']}</div>
		...
		<div class="notPass wjpsw" >
			<div style="width: 800px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
				<div style="margin-top:20px;">
					...
					<h2 class="line" style="font-weight:normal;float:right;text-align:right;padding-right:20px;">如已拥有帐户信息，则<a href="<s:url value='/inx/zseyjxres'/>" class="line_c">在此登录</a><br/>
						If you have the account information,<a href="<s:url value='/inx/zseyjxres'/>" class="line_c">click here to login</a>
					</h2>
				</div>
				<form id="registerForm" action="<s:url value='/inx/zseyjxres/regist'/>" method="post" style="position: relative; margin:65px 30px;">
...
<div class="footer"><jsp:include page="/jsp/zseyjxres/foot.jsp" flush="true"/></div>
</body>
</html>