...
<html>
<head>
<jsp:include page="/jsp/common/htmlhead_en.jsp" flush="true">
...
<body>
<form id="uploadFileForm" method="post" action="<s:url value='/inx/czyyjxrecruit/checkUploadFile'/>" enctype="multipart/form-data">
