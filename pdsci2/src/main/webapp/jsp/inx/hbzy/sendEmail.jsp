...
<body>
	<div class="yw">
    <div class="register_top" onclick="window.location.href='<s:url value='/inx/hbzy'/>'" style="cursor: pointer;">${sysCfgMap['sys_title_name']}</div>
	     ...
	     <div style="margin-left: 50px;margin-top: 20px;">
                <ul class="noEamil" style="margin-top:30px;margin-left: 52px; "> 
               	<li>您也可以 通过点击下方激活链接进行快速激活操作</li>
             	 	 <li><a href='<s:url value="/inx/hbzy/activateuser?activationCode=${activationCode}"/>'>点此链接激活</a></li>
                </ul>
	     </div>
	     </div>
	</div>
