...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/zseyGate/css/step.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
...
//        }
    ...
    function uploadFile(type, typeName) {
        jboxOpen("<s:url value='/inx/zseyjxres/uploadFile'/>?operType=" + type, "上传" + typeName, 450, 150);
    }
    /**
     * 删除证书及文件
     */
    ...
    var len;
    $(document).ready(function(){
        if($("#speTb tr").length==null || ''){
            len=0;
        }else{
            len = $("#spefTb tr").length;
        }
    });
...
<%--//        $('#registerFormUri').removeClass("validate[required]");--%>
        ...
        <%--}else if(templeteName=='xz'){--%>
            <%--templeteName = "徐州中心医院";--%>
        <%--}--%>
        <%--jboxPost("<s:url value='/zseyjxres/doctor/valideExist'/>",{"batchFlow":batchFlow},function(resp){--%>
            <%--if(null != resp && resp != ""){--%>
                <%--jboxTip("下载中,请稍等...");--%>
                <%--var url = '<s:url value="/zseyjxres/hospital/printApplForm?resumeFlow="/>'+resp+"&printFlag=doctor"+"&templeteName="+encodeURI(encodeURI(templeteName));--%>
    ...
    <%--function submiteApply(){--%>
        ...
        <%--jboxConfirm("确认提交吗？提交后申请信息不可修改！" , function(){--%>
            <%--jboxStartLoading();--%>
            <%--jboxPost("<s:url value='/zseyjxres/doctor/saveSingupInfo?flag=true&stuBatId='/>"+stuBatId+"&registerFormUriValue="+registerFormUriValue,null,function(resp){--%>
                <%--if(resp=="1"){--%>
                    <%--jboxTip("保存成功");--%>
                    <%--search(stuBatId);--%>
                    <%--//自动跳转到主页（仅第一次点击提交）--%>
                    <%--location.href="/pdsci/zseyjxres/doctor/index";--%>
    ...
    <%--function loadTitle(){--%>
        ...
        <%--if (titleType) {--%>
            <%--var url = "<s:url value='/zseyjxres/doctor/loadTitle'/>?titleTypeId=" + titleType;--%>
<%--//            jboxStartLoading();--%>
...
<div id="singupContent">
    <div id='docTypeForm'>
        ...
        <div class="sontitle">
            <span class="fl sonnewtitle">网上报名</span>
        </div>
        <div class="main_bd">
            <div class="div_table">
                <div class="score_frame" style="width: 960px">
                    <div class="div_table" style="padding:20px 0px 0px;">
                        <div class="stepDiv">
                            ...
                            <a href="#" class="stepA2" onclick="showBigStep('stepA2');" style="cursor:default">审核结果</a>
                        </div>
                    </div>
                    <div class="div_table parentDiv" id="div_table_1" >
                            ...
                            <form id="basicForm" style="position:relative;">
                                ...
                                <table style="width: 100%;" class="searchTable" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="idNo" class='input validate[required]' onchange="changeIdNo(this);" type="text" name="user.idNo"  value="${extInfo.idNo}" style="width: 150px;margin-left: 0px"/>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="userBirthday" name="user.userBirthday" value="${extInfo.userBirthday}"  class='input validate[required] datepicker' readonly="readonly" style="width: 150px;margin-left: 0px"/>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class='input validate[required]' id="userAge" type="text" name="stuUser.userAge" style="width: 150px;margin-left: 0px"/>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td class="td_left">
                                            <font color="red">*</font>拟报科室：
                                        </td>
                                        <td>
                                            <select id="" name="" class="select validate[required]" style="width: 157px;margin-left: 0px;">
                                                <option value="">请选择</option>
                                                <option value="">本科生教育</option>
                                                <option value="">研究生教育</option>
                                                <option value="">住院医师培训</option>
                                                <option value="">进修生教育</option>
                                                <option value="">护理教学</option>
                                                <option value="">护士培训</option>
                                            </select>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td style="text-align: center" colspan="5">
                                            <input type="button" class="btn_green save_btn" onclick="jboxTip('操作成功')" value="提交"/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <form id="socialForm"  style="position:relative;" >
                                ...
                                <table style="width: 100%;" class="searchTable" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="stuUser.unitpropertyId" class="select validate[required]" style="width: 157px;margin-left: 0px;">
                                                <option value="">请选择</option>
                                                <c:forEach items="${unitPropertyEnumList}" var="unitProperty">
                                                    <option value="${unitProperty.id}"
                                                            <c:if test="${stuUser.unitpropertyId eq unitProperty.id}">selected</c:if>>${unitProperty.name}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                        <td class="td_left">
                                        ...
                                        <td>
                                            <select name="stuUser.unitrankId" class="select validate[required]" style="width: 157px;margin-left: 0px;">
                                                <option value="">请选择</option>
                                                <c:forEach items="${unitRankEnumList}" var="unitRank">
                                                    <option value="${unitRank.id}" ${stuUser.unitrankId eq unitRank.id?'selected':''}>${unitRank.name}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="stuUser.unitlevelId" class="select validate[required]" style="width: 157px;margin-left: 0px;">
                                                <option value="">请选择</option>
                                                <c:forEach items="${unitLevelEnumList}" var="unitLevel">
                                                    <option value="${unitLevel.id}" ${stuUser.unitlevelId eq unitLevel.id?'selected':''}>${unitLevel.name}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                        <td class="td_left">
                                    ...
                                    <tr>
                                        <td class="td_left">
                                            <font color="red">*</font>长途区号：
                                        </td>
                                        <td>
                                            <input type='text'style="width: 150px;margin-left: 0px" class="input validate[required]" name="extInfo.areaCode" value="${extInfo.areaCode}"/>
                                        </td>
                                        <td class="td_left">
                                            <font color="red">*</font>办公电话：
                                        </td>
                                        <td>
                                            <input type='text'style="width: 150px;margin-left: 0px" class="input validate[required]" name="extInfo.oph" value="${extInfo.oph}"/>
                                        </td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="td_left">
                                            <font color="red">*</font>传真电话：
                                        </td>
                                        <td>
                                            <input type='text'style="width: 150px;margin-left: 0px" class="input validate[required]" name="extInfo.faxTelephone" value="${extInfo.faxTelephone}"/>
                                        </td>
                                        <%--<td class="td_left">--%>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type='text' class='input validate[required] datepicker' name="extInfo.graduationDate" value="${extInfo.graduationDate}" readonly="readonly" style="width: 146px;margin-left: 0px" />
                                        </td>
                                        <td class="td_left">
                                ...
                                <table style="width: 100%;" class="searchTable" >
                                    ...
                                    <%--  <tr>
                                          <td colspan="5" style="height: 10px"><font style="color: red;font-size: 10px">（请下载<a href="<s:url value='/jsp/zseyjxres/print/agreementTemeplete.doc'/>">遵守纪律协议书模板</a>，再上传审核盖章的协议书扫描件并以PDF格式上传。）</font></td>
                                      </tr>--%>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="td_left"><font color="red">*</font>执业证末次注册时间：</td>
                                        <td colspan="4">
                                            <input type='text' class='input validate[required] datepicker' name="extInfo.cerLastRegisterDate" value="${extInfo.cerLastRegisterDate}" readonly="readonly" style="width: 296px;margin-left: 0px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td_left"><font color="red">*</font>医师执业地点、类别、范围：</td>
                                        <td colspan="4">
                                            <input type='text' class='input validate[required]' name="extInfo.practiceContent" value="${extInfo.practiceContent}"  style="width: 300px;margin-left: 0px" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center" colspan="10">
                                            <input type="button" onclick="jboxTip('操作成功')" class="btn_green save_btn" value="保存此页信息"/>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                        ...
                        <div id="infoDiv3" class="infoDiv search_table doctorInfo" style="margin-top:20px;display: none;">
                            ...
                            <form id="studyForm" style="position:relative;">
                                ...
                                <div>
                                    <h4 style="width: 100%;float: left;border-left:4px">进修专业（最多只能添加3个）
                                ...
                                <table style="width: 100%;" class="grid" >
                                    ...
                                    <c:forEach var="speForm" items="${extInfo.speFormList}" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                                <input    class="validate[required] input" name="extInfo.speFormList[${status.index}].stuTimeId" type="text" value="${speForm.stuTimeId}"  style="width: 60%" />
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                ...
                                <table style="width: 100%;" class="searchTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_left">
                                            <font color="red">*</font>是否我院教学基地<br/>或帮扶协议单位：
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="text-align: center;text-align: center" colspan="10">
                                            <input type="button"  onclick="jboxTip('操作成功')" class="btn_green save_btn" value="提交"/>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                    ...
                    <div  class="div_table parentDiv" id="div_table_3" style="display: none">
                        <table id="applyInfo" style="width: 75%;margin-left: 50px;" class="searchTable" cellpadding="10">
                            <tr style="height: 70px;font-size: 110%;">
                                <c:if test="${sysCfgMap['jx_templete_name'] eq 'xz'}">
                                    <td style="background-color: #cadeee;" colspan="4">&nbsp;上传审核盖章后的进修申请表扫描件，完成申请流程。<font style="color: red">（请以PDF文件格式上传）</font></td>
                                </c:if>
                                <c:if test="${sysCfgMap['jx_templete_name'] eq 'cd'}">
                                    <td style="background-color: rgb(255, 224, 168);" colspan="4">&nbsp;上传审核盖章后的进修申请表扫描件，完成申请流程。<font style="color: red">（请以PDF文件格式上传）</font></td>
                                </c:if>
                            </tr>
                            <tr style="height: 70px;font-size: 110%;">
                                ...
                                <td style="text-align: right;">
                                    ...
                                    <a id="registerFormUri" href="javascript:uploadFile('registerFormUri','申请登记附件');" class="btn_green <c:if test="${empty extInfo.registerFormUri}">validate[required]</c:if>">${empty extInfo.registerFormUri?'上&#12288;传':'重新上传'}</a>&#12288;
                    ...
                    <div  class="div_table parentDiv" id="div_table_4" style="display: none">
                        ...
                        <%--<c:if test="${stuUser.stuStatusId eq stuStatusEnumUnPassed.id and stuUser.isBack ne 'Y'}">--%>
                            <%--<table id="" style="width: 60%;margin-left: 50px;" class="searchTable" cellpadding="10">--%>
                                ...
                                <%--</tr>--%>
                                    <%--&lt;%&ndash;<tr style="height: 80px;">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<td>原因：${auditAgree}</td>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
                            <%--</table>--%>
                        <%--</c:if>--%>
                        <%--<c:if test="${stuUser.isBack eq 'Y'}">--%>
                            <%--<table id="" style="width: 60%;margin-left: 50px;" class="searchTable" cellpadding="10">--%>
                                ...
                                <%--</tr>--%>
                                <%--<tr style="height: 80px;">--%>
                                        <%--&lt;%&ndash;<td colspan="3">原因：${auditAgree}</td>&ndash;%&gt;--%>
    ...
    <div style="display: none">
        ...
        <table id="speTemplate">
            <tr>
                ...
                <td>
                    <input    class="validate[required] input" name="extInfo.speFormList[{index}].stuTimeId" type="text" value="${speForm.stuTimeId}"  style="width: 60%" />
                </td>
            </tr>
        </table>
        <!-- 工作经历模板 -->
