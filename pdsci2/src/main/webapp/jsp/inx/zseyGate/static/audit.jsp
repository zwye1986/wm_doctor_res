...
<script type="text/javascript">
    ...
    //报名信息审核
    function auditInfo(){
        jboxOpen("<s:url value='/jsp/inx/zseyGate/static/singupinfoforaudit.jsp'/>","用户信息",1000,550);
    }
...
<div class="main_hd">
    <div class="sontitle" style="margin-bottom: 10px;">
        <span class="fl sonnewtitle" >资料审核</span>
    </div>
        ...
        <form id="auditForm">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        &#12288;<input type="button"  class="btn_green" value="查&#12288;询" onclick="" />
                        <c:if test="${statusId eq regStatusEnumPassed.id}">
                            <a href="javascript:void(0);" onclick="" class="btn_green">导&#12288;出</a>
                        </c:if>
                    </td>
                </tr>
            </table>
        ...
        <c:if test="${statusId ne stuStatusEnumUnPassed.id and statusId ne stuStatusEnumUnHeadPassed.id}">
            <table border="0" cellpadding="0" cellspacing="0" class="grid">
                    ...
                    <%--<c:forEach items="${stuUserLst}" var="user">--%>
                        ...
                        <%--<tr>--%>
                            ...
                            <%--<td colspan="2">--%>
                                ...
                                <%--</c:forEach>--%>
                            <%--</td>--%>
                                <%--&lt;%&ndash; <c:if test="${statusId eq regStatusEnumPassed.id}">--%>
                                     <%--<td>--%>
                ...
                <tr>
                    ...
                    <td>临床医学</td>
                    <td colspan="2">呼吸内科（2）</td>
                    <td><a onclick="auditInfo()">[报名信息审核]</a></td>
                </tr>
