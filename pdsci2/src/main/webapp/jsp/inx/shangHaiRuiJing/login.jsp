...
<head>
  ...
  <link rel="stylesheet" href="<s:url value='/jsp/inx/shangHaiRuiJing/css/common.css'/>">
  <script src="<s:url value='/jsp/inx/shangHaiRuiJing/js/jquery-1.10.2.min.js'/>"></script>
  <script src="<s:url value='/jsp/inx/shangHaiRuiJing/js/common.js'/>"></script>
...
<body>
  <div class="top">
    <div class="logo-box clearfix">
      <img src="<s:url value='/jsp/inx/shangHaiRuiJing/images/logo1.png'/>">
      <span>上海交通大学医学院附属瑞金医院</span>
    </div>
    <div class="logo-box clearfix">
      <img src="<s:url value='/jsp/inx/shangHaiRuiJing/images/logo2.png'/>">
  ...
  <div class="middle">
    <div class="middle-box clearfix">
      ...
      <form id="loginForm" action="<s:url value='/inx/shangHaiRuiJing/login'/>" method="post">
      <div class="login-box">
        <div class="login-title">用户登录</div>
        <div class="input-box">
          <img src="<s:url value='/jsp/inx/shangHaiRuiJing/images/icon-user.png'/>">
          <input name="userCode2" type="text" class="validate[required]" placeholder="用户名/手机号/Email" value=""/>
          <input type="hidden" name="userCode">
        </div>
        <div class="input-box">
          <img src="<s:url value='/jsp/inx/shangHaiRuiJing/images/icon-pwd.png'/>">
        ...
        <div class="input-box input-yzm">
          <img src="<s:url value='/jsp/inx/shangHaiRuiJing/images/icon-yzm.png'/>">
  ...
  <div class="footer">
    ...
    <div>Copyright © 2001-2018 Nanjing Character Network Information Technology Co.,Ltd. All rights reserved.</div>
  </div>
</body>
</html>