       ...
       <div class="firstStep clearfix">
         <div class="left1 fl">
           ...
           <dl>
                 <dt>邮箱</dt>
                 <dd class="import">
                 	<input type="text" id="userEmail" class="validate[required,maxSize[50],custom[email]]" name="userEmail" onchange="checkMailRepeat(null);" value="${param.userEmail}">
                 </dd>
                 <dd class="message">
           ...
           <dl>
                 <dt>密码</dt>
                 <dd class="import">
                 	<input type="password" name="userPasswd" onchange="checkPasswd();" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" value="${param.userPasswd}"/>
                 </dd>
                 <dd class="message">
           ...
           <dl>
                 <dt>确认密码</dt>
                 <dd class="import">
                 	<input type="password" name="userPasswd2" onchange="checkPasswd();" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" value="${param.userPasswd2}"/>
                 </dd>
                 <dd class="message">
		...
		<div class="right fr">已有平台账号？<a href="<s:url value='/inx/hbres'/>">立即登录</a></div>
		   <div class="right fr">
			   <img src="<s:url value="/jsp/inx/hbres/images/erweima.png" />"/>
			   <div style="color:red;line-height: 30px;">关注“湖北住培”微信公众号，<br>掌握招录住培最新动态，了解住培最新咨询！</div>
		   </div>
      </div>
    </div>
</div>
