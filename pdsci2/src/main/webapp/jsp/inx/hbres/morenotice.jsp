...
function toPage(page) {
	...
	location.href="<s:url value='/inx/hbres/noticelist'/>?currentPage="+currentPage;
} 
</script>
</head>
   ...
   <div class="container">
      <div class="notice">
          ...
          <c:forEach items="${infos}" var="msg">
            <li>
            <strong><a href="<s:url value='/inx/hbres/noticeview'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a>
