...
<head>
    ...
    <script type="text/javascript">
        ...
        function eidtPassword() {
            ...
            var url = "<s:url value='/inx/jsres/eidtPassword'/>";
...
<div class="yw"  style="width: 100%; min-height: 100%;">
    <div class="top"  style="cursor: pointer;height: auto"><%="临床技能考核管理系统"%></div>
            ...
            <div class="cont_sty">
                <div id="operDiv">
                    <div class="cont_header">
                        ...
                        <h2>如已拥有帐户信息，则<a href="<s:url value='/inx/osce'/>"
                    ...
                    >
                        <div class="cont_body">
                            ...
                            <div class="form_item">
                                ...
                                <input type="text" placeholder="身份证/姓名/手机号"
                                       class="validate[required] txt cont_input"
