...
<head>
    ...
    <script type="text/javascript">
        function toPage(page) {
            ...
            location.href="<s:url value='/inx/osce/allNotice'/>?currentPage="+currentPage;
        }
    </script>
</head>
                    ...
                    <div class="index_form">
                        ...
                        <ul class="form_main">
                            <c:forEach items="${infos}" var="msg">
                                <li>
                                    <strong><a href="<s:url value='/inx/osce/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a>
