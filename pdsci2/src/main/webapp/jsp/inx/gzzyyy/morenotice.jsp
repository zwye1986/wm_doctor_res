...
function toPage(page) {
	...
	location.href="<s:url value='/inx/gzzyyy/noticelist'/>?sysId=${param.sysId}&typeId=${param.typeId}&currentPage="+currentPage;
} 
</script>
</head>
...
<div class="yw">
 ...
 <div class="body">
   <div class="container">
      <div class="notice">
          ...
          <h3>
              <c:choose>
                  <c:when test="${param.typeId eq 'LM05'}">基地公告</c:when>
          ...
          <c:forEach items="${infos}" var="msg">
            <li>
            <strong><a href="<s:url value='/inx/gzzyyy/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a>
 ...
 <div class="foot">
   ...
   主管单位：江苏省中医药局 | 协管单位：江苏省中医药毕业后继续教育委员会办公室 
   </div>
 </div>
