...
<div class="top_box" style="overflow: visible;">
	<div class="top">
		...
		<div class="code fr" style="padding-top: 6px;">
			...
			<div class="QR_android QR" style="display:none ;"><img class="QR_code" src="<s:url value='/jsp/inx/jszy/images/jsQrcode.jpg'/>" /></div>
			<div class="QR_iphone QR" style="display:none ;"><img class="QR_code" src="<s:url value='/jsp/inx/jszy/images/jszyappQrcode.jpg'/>" /></div>
		</div>
    </div>
</div>
...
<div class="footer_box">
	<a class="login_footer db">主管单位：江苏省中医药局 | 技术支持：南京品德网络信息技术有限公司</a>
</div>
