...
<div class="yw" style="width: 100%; min-height: 100%; position: relative;">
    <%--<div class="register_top" onclick="window.location.href='<s:url value='/inx/jszy'/>'" style="cursor: pointer;">${sysCfgMap['sys_title_name']}</div>--%>
		<div class="head">
			<div class="head_inner">
				<h1 class="logo">
					<img style="margin-top: 30px;" onclick="window.location.href='<s:url value='/inx/jszy'/>'" style="cursor: pointer;" src="<s:url value='/css/skin/Yellow/images/jszy_head2.png'/>"/>
				</h1>
			</div>
		</div>
		...
		<div class="notPass wjpsw" >
			   <div style="width: 800px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
				   <div id="operDiv">
						...
						<h2 class="line" style="font-weight:normal;">如已拥有帐户信息，则<a href="<s:url value='/inx/jszy'/>" class="line_c">在此登录</a></h2>
	...
	<div class="footer">主管单位：江苏省中医药管理局 | 协管单位：江苏省中医药毕业后继续教育委员会办公室</div>
</div>
