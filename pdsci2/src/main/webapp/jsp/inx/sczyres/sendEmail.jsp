		...
		<h1 class="reg_title">账号激活</h1>
	     <div style="margin-left: 50px;margin-top: 20px;">
               ...
               <%--<ul class="noEamil" style="margin-top:30px;margin-left: 52px; ">--%>
                  <%--<li>没收到邮件？</li>--%>
                  <%--<li>1、请检查邮箱地址是否正确，你可以返回<a href="<s:url value='/jsp/inx/sczyres/register.jsp'/>">重新填写</a></li>--%>
                  <%--<li>2、检查你的邮件垃圾箱</li>--%>
               ...
               <%--</ul>--%>
                <ul class="noEamil" style="margin-top:30px;margin-left: 52px; "> 
               	<li>请点击下方激活链接进行快速激活操作<br/>
               	<%--<font style="color: red">(请确保您填写的邮箱真实有效，以便您可以接收到报名审核结果与录取通知)</font>--%>
				</li>
             	 	 <li><a href='<s:url value="/inx/sczyres/activateuser?activationCode=${activationCode}"/>'>点此链接激活</a></li>
                </ul>
	     </div>
	     </div>
	</div>
