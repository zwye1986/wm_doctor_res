...
<head>
    ...
    <script type="text/javascript">
        ...
        function registerNew() {
            ...
            var url = "<s:url value='/inx/jsres/registerNew'/>";
            // var data = $('#modPasswdForm').serialize();
            var pw1 = $("#userPasswd").val();
            var pw2 = pw1.replaceAll("%","%25");
            var pw3 = pw2.replaceAll("+","%2B");
            var data = {userPhone : $("#userPhone").val(),userPasswd : pw3, verifyCode : $("#verifyCode").val()};
            ...
            jboxPost(url, {data : data}, function (res) {
                if ("${GlobalConstant.USER_REG_SUCCESSED}" == res) {
                    jboxTip("${GlobalConstant.USER_REG_SUCCESSED}");
                    setTimeout(function () {
                        window.location.href = "<s:url value='/inx/jsres/goToLogin'/>";
                    }, 1000);
            ...
            <div class="cont_sty">
                <div id="operDiv">
                    <div class="cont_header">
                        <h1>注册信息</h1>
                        <h2>如已拥有帐户信息，则<a href="<s:url value='/inx/jsres'/>"
                    ...
                    >
                        <div class="cont_body">
                            ...
                            <div>
                                <input type="button" value="注&nbsp;&nbsp;册" onclick="registerNew();"
