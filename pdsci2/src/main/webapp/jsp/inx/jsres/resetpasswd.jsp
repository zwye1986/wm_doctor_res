...
var tip = {
	...
	function modPasswd() {
		...
		var url = "<s:url value='/inx/jsres/savePasswd'/>?actionId=${actionId}";
		...
		jboxPost(url, data, function(res) {
			if ("${GlobalConstant.RESET_SUCCESSED}"==res) {
				...
				setTimeout(function(){
					window.location.href="<s:url value='/inx/jsres'/>";
				},1000);
...
<body>
  <div class="top">江苏省住院医师规范化培训管理平台</div>
  <div class="content">
   ...
   <div style="width: 900px;height: 450px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
    	...
    	<h2 class="line" style="font-weight:normal;">如已拥有帐户信息，则<a href="<s:url value='/inx/jsres'/>" class="line_c">在此登录</a></h2>
...
<div class="footer">主管单位：江苏省卫生和计划生育委员会  |  <a href="https://beian.miit.gov.cn/" target="_blank" style="color:#FFFFFF;">工信部备案号：苏ICP备14054231号-1</a></div>
