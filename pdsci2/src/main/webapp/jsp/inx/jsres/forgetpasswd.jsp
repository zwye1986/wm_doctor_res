...
function sendResetPassEmail(){
	...
	jboxPost("<s:url value='/inx/jsres/sendResetPassEmail'/>?userEmail="+$("#userEmail").val()
...
<body>
  <div class="top"><%=JsresUtil.getTitle(request,response,application)%></div>
  <div class="content" >
  <div class="notPass wjpsw" >
   <div style="width: 900px;height: 300px;margin:0 auto;text-align: left; border:1px solid #DADADA; background: #F9F9F9;">
       <div id="operDiv">
    	...
    	<h2 class="line" style="font-weight:normal;">如已拥有帐户信息，则<a href="<s:url value='<%=JsresUtil.getUrl(request,response,application)%>'/>" class="line_c">在此登录</a></h2>
        <form id="forgetPasswdForm" style="position: relative; margin:30px 20px 20px 30px;">
         	  ...
         	  <tr>
         	  	...
         	  	<td style="text-align: left;">
         	  		<input type="text" id="userEmail" class="validate[required] txt" style="width:290px;" placeholder="身份证" value="" />
...
<div class="footer">主管单位：${sysCfgMap['the_competent_unit']}   |  技术支持：南京品德网络信息技术有限公司</div>
