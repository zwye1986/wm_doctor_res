...
<div class="top_box">
	<div class="top">
    	<span class="riqi"><img src="<s:url value='/jsp/njmuedu/css/images/gzmu_logo.png'/>" /></span>
...
<div class="banner_box">
   <form id="loginForm" action="<s:url value='/inx/gzmuedu/login'/>"  method="post">
	<img class="banner" src="<s:url value='/jsp/njmuedu/css/images/njmu_banner5.png'/>" />
     <div class="weixin_bg">
           <div class="weixin">
