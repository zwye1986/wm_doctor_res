...
<div class="top_box" style="background:#eee">
    <div class="top">
        <span class="fl logo"><img width="600" src="<s:url value="/jsp/inx/tjresexam/images/title.png"/>"/></span>
        <span class="fr top_text" style="color:#949090">欢迎使用天津结业考试管理平台！</span>
    </div>
</div>
<div class="banner_box" style="bottom:48px;background-image: no-repeat; background:#fff url('<s:url value='/jsp/inx/tjresexam/images/banner.png'/>') bottom center">
    <%--<img class="banner" src=""/>--%>
    <%--<img class="login_people" src="<s:url value='/jsp/inx/tjresexam/images/login_bg.png'/>"/>--%>
    <%--<img class="banner_title" width="600" src="<s:url value='/jsp/inx/tjresexam/images/title.png'/>"/>--%>
    <div class="login_bg" style="top:20%;background: url('<s:url value='/jsp/inx/tjresexam/images/login_bg.png'/>')">
        <form id="loginForm" action="<s:url value='/inx/tjResExam/login'/>" method="post">
            <div class="login_box" style="margin-top: 24px">
                <span class="login_title" ><img style="margin-bottom: 20px" src="<s:url value='/jsp/inx/tjresexam/images/login_title.png'/>"/></span>
                <div class="username" style="border:solid 1px #ffffff;margin-left: 10px">
                    <img style="margin-top: 5px; margin-right: 8px;" src="<s:url value='/jsp/inx/tjresexam/images/name.png'/>"/>
                    <input id="userCode" name="userCode" value="" placeholder="学员编号"/>
                </div>
                <div class="password" style="border:solid 1px #ffffff;margin-left: 10px">
                    <img style="margin-top: 5px; margin-right: 8px;" src="<s:url value='/jsp/inx/tjresexam/images/pass.png'/>"/>
                ...
                <div class="denglu" style="width:100%;text-align:center;margin-left: 20px">
                    ...
                    <%--<a class="login1 fl" onclick="return checkForm();" style="margin-bottom: 10px;"><img src="<s:url value='/jsp/inx/tjresexam/images/login_btn.png'/>"/> </a>--%>
