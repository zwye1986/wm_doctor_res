...
function importUsers(){
	...
	jboxStartLoading();
	var url = "<s:url value='/study/hospital/importUsersFromExcel'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table width="100%" class="basic">
		...
		<tr>
			<th>模板文件</th>
			<td style="padding-left:10px;"><a href="<s:url value='/jsp/study/hospital/userTemplate.xlsx'/>">学员导入模板.xlsx</a></td>
		</tr>
	</table>
	<br/>
