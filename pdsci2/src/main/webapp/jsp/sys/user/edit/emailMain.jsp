...
function newEmail(){
	...
	reloadContent('<s:url value='/sys/user/edit/newEmail'/>?userFlow=${param.userFlow}');
}
...
<div id="main">
	  ...
	  <ol class="num4">
        ...
        <li id="step2">
          <span><i>2</i><em>输入新邮箱地址</em></span>
        </li>
        <li id="step3">
          <span><i>3</i><em>发送邮箱验证码</em></span>
        </li>
