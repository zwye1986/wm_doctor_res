...
<head>
	...
	<script type="text/javascript">
		function importUsers(){
			...
			var url = "<s:url value='/sczyres/hosptial/importGrades'/>";
			jboxSubmit(
					$('#excelForm'),
					url,
					function(resp){
	...
	<div style="padding:0px 20px;margin-top:20px;">
		...
		<form id="excelForm" method="post" enctype="multipart/form-data">
			<table width="100%" class="basic">
				...
				<tr>
					<th>导入模板：</th>
					<td><a href="<s:url value='/jsp/sczyres/hosptial/gradeTemp.xlsx'/>">成绩导入模板.xlsx</a></td>
				</tr>
			</table>
			<br/>
			<p style="text-align: center;">
				<input type="button" onclick="importUsers();" value="成绩导入" class="btn_blue"/>
			</p>
		</form>
	</div>
</div>
