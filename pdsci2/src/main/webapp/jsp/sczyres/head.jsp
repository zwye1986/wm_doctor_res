...
<div class="head">
   <div class="head_inner">
     <h1 class="logo">
       <a href="<s:url value='/sczyres/doctor/index'/>">${sysCfgMap['sys_title_name']}</a>
     </h1>
     ...
     <div class="account">
       ...
       <div class="head_right">
        <a href="<s:url value='/sczyres/doctor/index'/>">首页</a>&#12288;
        <c:if test='${param.notice}'>
           <a onclick="msg();">公告</a>&#12288;
        </c:if>
         <a href="<s:url value='/inx/sczyres/logout'/>">退出</a>
       </div>
     </div>
     </c:if>
   </div>
