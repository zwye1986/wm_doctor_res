...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——神经内科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院神经内科床位总数≥60张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">应具备相关科室15个以上，包括神经外科、呼吸科、心血管内科、内分泌科、康复科、儿科、皮肤科、医学影像科、病理科、检验科等</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">神经内科、神经内科ICU或急诊室、心血管内科、呼吸内科、内分泌科、神经外科、医学影像科、神经电生理室、神经病理科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》神经内科专业基地细则的要求。见附表1   </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">X射线机、CT、MRI、全自动血液生化分析仪、血气分析仪、PCR仪、快速血糖自动测定仪、便携式B超机、便携式X射线机、12导联心电图记录仪、生命体征监护仪(无创血压、心电、脉氧、呼吸等)、呼吸机、除颤起搏器、中心供氧接口、中心吸引接口或电动吸引器</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">脑电图仪、肌电图仪、诱发电位仪、眼震电图仪、彩色经颅多普勒 </td>
          <td class="left">检查设备清单复印件，需加盖医院公章，实地考查</td>
          <td class="left">缺1项，不得分</td>
          <td>1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）师资队伍的正高、副高及中级专业技术职务人员比例应为1：2：4</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事神经内科专业的医疗、科研和教学工作超过15年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作（见附件1）</td>
          <td class="left">随机抽查5～10名培训对象，由评估专家根据本专业实际需求确定手术或技能操作项目，查看技能操作记录，掌握实际情况</td>
      ...
      <tr class="td_group">
        <td colspan="10" style="text-align: left">
          备注：<br/>
          1.一级指标4项，二级指标10项，三级指标38项。三级指标中，核心指标14项、计65分，一般指标24项、计35分，共100分。<br/>
