...
<div data-role="page" id="pageone">
  ...
  <h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——临床病理科专业基地</h1>
  ...
  <div data-role="main" class="ui-content">
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          <th rowspan="9">1.基本条件（15分）</th>
          <td rowspan="6">1.1专业基地所在医院条件</td>
          <td class="left">1.1.1病例数</td>
          <td class="left">年活检标本病例数≥20000例<br/>
            年尸体解剖病例数≥5例<br/>
            年冰冻快速诊断量≥1500例<br/>
            年细胞学检查病例数≥5000例</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">具备健全的常规病理技术室、特殊染色和免疫组织化学室、病理档案室、电镜室、分子病理室和尸体解剖室（后3者可与上级单位或本地区其他单位共同使用）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">放射影像科；超声科；病理技术：包括病理标本检查和档案管理、常规制片室、免疫组化室、分子病理室或电镜室；组织病理诊断或分子病理诊断；细胞学技术及诊断</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上一年度各亚专业（专科）临床技能操作或手术种类和数量的统计报表</td>
          <td class="left">符合要求（含协同单位），得满分<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">多头光学显微镜（3头以上）、双筒光学显微镜、显微照相机或图像采集设备、荧光显微镜、病历档案计算机管理系统、冷冻切片机、自动化常规病理制片设备（脱水、染色、封片、切片机）、细胞涂片机、电镜（可与其他单位共用）、超薄切片机、PCR仪、普通冰箱、低温冰箱、微波炉、离心机、烤箱、电泳仪</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">专科亚专业（专科）床位数≥规定数</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事临床病理科专业医疗、科研和教学工作超过15年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">带教医师均参加过院级师资培训<br/>
            亚专业（专科）至少1名带教医师参加过省级及以上师资培训</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">规范实施，包括科室情况、科室纪律、培养计划与要求、医德医风、医患沟通、生物安全等入科教育，并有专人组织实施</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">开展规范的教学会诊，至少每周1次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作和报告数达到要求，得满分<br/>
            技能操作和报告数≥规定数的80%，得3分<br/>
            技能操作和报告数≥规定数的60%，得1分<br/>
            ＜60%，或未安排独立操作和报告，不得分</td>
          <td>6</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">随机抽查1～5名培训对象技能操作记录，了解实际情况</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">随机抽查1～2名带教医师指导培训对象（二年级以上）进行技能操作或手术情况</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">培训对象规范书写病理描述及诊断</td>
          <td class="left">随机抽查1～2名培训对象运行病历，或诊断报告并提问题</td>
          <td class="left">病理描述、诊断评分表见附件2<br/>
            ≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>6</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">培训对象标本取材技能操作情况</td>
          <td class="left">随机抽查1～2名二年级以上培训对象进行技能操作，查看其掌握情况</td>
          <td class="left">技能操作评分表见附表2<br/>
