...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017住院医师规范化培训评估指标——外科（泌尿外科）专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">1.查看亚专业（专科）设置名称<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">完成率≥90%，得满分<br/>完成率≥85%，得4分<br/>完成率≥80%，得2分<br/>完成率＜80%，不得分</td>
          <td>6</td>
