...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——耳鼻咽喉科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">三级甲等综合医院耳鼻咽喉科床位总数≥30张（鼻科≥10张，耳科≥10张，咽喉、头颈外科≥10张）</td>
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.1"]}"/></td>
        ...
        <tr class="td_group">
          ...
          <td class="left">≥1600人次</td>
          <td class="left" rowspan="3">检查相关统计报表复印件，需加盖医院公章</td>
          <td class="left">符合标准，得满分<br/>不达标准，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="1.1.2"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">≥1800人次</td>
          <td class="left">符合标准，得满分<br/>不达标准，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="1.1.4"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.4"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.4"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">普通外科、胸心外科、神经外科、急诊科、麻醉科、放射科、外科重症监护室、基础实验室（中心实验室）</td>
          <td class="left">查看相关文件，实地考查</td>
          <td class="left">缺1个科室，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="1.1.5"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.5"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.5"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">耳鼻咽喉科门急诊、耳鼻咽喉头颈外科病房、相关临床科室（重症监护病房ICU、急诊科、普通外科、麻醉科、放射影像科）</td>
          <td class="left">查看各亚专业（专科）设置名称
            查看培训对象轮转计划和登记手册
            实地考查，访谈培训对象</td>
          <td class="left">科室齐全，得满分<br/>缺1个科室，不得分</td>
          <td>2</td>
          <input type="hidden" name="orderNumber" value="1.1.6"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.6"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.6"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》耳鼻咽喉科专业细则要求，详见附表1-1至1-4</td>
          <td class="left">核对上一年度各亚专业（专科）业收治疾病种类及数量统计报表 </td>
          <td class="left">符合要求（含协同单位），得满分<br/>疾病种类及数量≥规定数的90%，得1分<br/>疾病种类及数量≥规定数的85%，得0.5分<br/>疾病种类及数量＜规定数的85%，不得分</td>
          <td>2</td>
          <input type="hidden" name="orderNumber" value="1.1.7"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.7"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.7"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上一年度各亚专业（专科）业技能操作、手术种类及数量的统计报表</td>
          <td class="left">符合要求（含协同单位），得满分<br/>技能操作和手术种类及数量≥规定数的90%，得2分<br/>技能操作和手术种类及数量≥规定数的85%，得1分<br/>技能操作和手术种类及数量＜规定数的85%，不得分</td>
          <td>4</td>
          <input type="hidden" name="orderNumber" value="1.1.8"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.8"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.8"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.9"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.9"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">依据《住院医师规范化培训基地认定标准（试行）》本专业基地细则的要求，见附表2</td>
          <td class="left">检查设备清单复印件，需加盖医院公章，实地考查</td>
          <td class="left">缺1项，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="1.1.10"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.1.10"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.1.10"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.2.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.2.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.2.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.2.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["1.2.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["1.2.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.1.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.1.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主治医师专业技术职务3年以上，从事本专业临床工作≥10年</td>
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.1.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.1.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）应有3名以上符合带教资格的带教医师；科室主任医师与副主任医师比例1:3，临床医师与医技人员的比例为1：3</td>
          <td class="left">1个亚专业（专科）不达标，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="2.1.3"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.1.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.1.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历,主任医师专业技术职务,从事耳鼻咽喉科专业工作超过15年</td>
          <td class="left">1项不符合条件，不得分</td>
          <td>1</td>
          <input type="hidden" name="orderNumber" value="2.1.4"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.1.4"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.1.4"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">带教医师均参加过院级师资培训，各亚专业（专科）至少1名带教医师参加过省级及以上师资培训</td>
          <td class="left">查看培训资料、名单和培训证书</td>
          <td class="left">2项培训均满足，得满分<br/>1项满足，得1分</td>
          <td>3</td>
          <input type="hidden" name="orderNumber" value="2.2.1"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.2.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.2.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.2.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.2.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["2.2.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["2.2.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.4"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.4"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.5"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.5"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.1.6"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.1.6"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.2.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.2.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">开展次数达标，且认真规范，得满分<br/>未开展或不达标，不得分</td>
          <td>2</td>
          <input type="hidden" name="orderNumber" value="3.2.2"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.2.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.2.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.2.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.2.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.2.4"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.2.4"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">考核项目全面，且认真规范，得满分<br/>仅有技能操作考核，得2分<br/>仅有理论考试，得1分<br/>仅有测评结果和考勤记录，得1分</td>
          <td>3</td>
          <input type="hidden" name="orderNumber" value="3.3.1"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.3.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.3.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病房：日管床数≥6张(在带教医师指导下独立于其他培训对象管理床位)</td>
          <td class="left" rowspan="2">查看轮转手册等相关材料，随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
          <td class="left">管床数达到要求，得满分<br/>管床数≥4张，得2分<br/>管床数≥3，得1分<br/>管床数＜3张，或未安排，不得分</td>
          <td>4</td>
          <input type="hidden" name="orderNumber" value="3.4.1"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.4.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.4.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">门急诊量（参照《住院医师规范化培训基地认定标准（试行）》本专业细则要求）</td>
          <td class="left">门急诊工作量达到要求，得满分<br/>门急诊量≥规定数的80%，得2分<br/>门急诊量≥规定数的60%，得1分<br/>门急诊量＜规定数60%或未安排，不得分</td>
          <td>3</td>
          <input type="hidden" name="orderNumber" value="3.4.2"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["3.4.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["3.4.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">教学查房评分表见附表2<br/>≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>4</td>
          <input type="hidden" name="orderNumber" value="4.1.1"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.1.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.1.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          <td class="left">4.1.2技能操作和手术安排★</td>
          <td class="left">每个轮转科室均按照《住院医师规范化培训内容与标准（试行）》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术（附件1-2和附件1-4）</td>
          <td class="left">随机抽查5～10名培训对象技能操作和手术记录，了解实际情况</td>
          <td class="left">完成率≥90%，得满分<br/>完成率≥80%，得4分<br/>完成率＜80%，不得分</td>
          <td>8</td>
          <input type="hidden" name="orderNumber" value="4.1.2"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.1.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.1.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.1.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.1.3"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.2.1"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.2.1"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td class="left">技能操作评分表见附表4<br/>≥90分得满分，≥80分得5分，≥70分得3分，≥60分得1分，＜60分不得分 </td>
          <td>8</td>
          <input type="hidden" name="orderNumber" value="4.2.2"/>
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.2.2"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.2.2"]}</textarea></td>
          <td>
        ...
        <tr class="td_group">
          ...
          <td><input type="text" name="score" class="qtext" value="${scoreMap["4.2.3"]}"/></td>
          <td><textarea name="deductMarks" class="qtext">${marksMap["4.2.3"]}</textarea></td>
          <td>
      ...
      <tbody>
        <tr class="td_group">
          ...
          <td><input id="inputSumScore" readonly name="score" class="qtext" value="${scoreMap["sumScore"]}"/></td>
          <td></td>
          <td></td>
        </tr>
        <tr class="td_group">
