...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017住院医师规范化培训评估指标——外科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上一年度亚专业（专科）收治疾病种类及数量统计报表 </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上一年度亚专业（专科）技能操作、手术种类及数量的统计报表 </td>
          <td class="left">符合要求（含协同单位），得满分<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）床位数（参照《住院医师规范化培训基地认定标准（试行）》外科细则要求）</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1</td>
