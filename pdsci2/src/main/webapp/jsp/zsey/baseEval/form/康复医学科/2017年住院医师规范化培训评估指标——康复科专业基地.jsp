...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——康复科专业基地</h1>
  </div>
  <div data-role="main" class="ui-content">
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          <th rowspan="12">1.基本条件（18）</th>
          <td rowspan="9">1.1专业基地所在医院条件</td>
          <td class="left">1.1.1总床位数</td>
          <td class="left">三级甲等综合医院康复科≥20张<br/>
            三级专科医院≥120张</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">神经康复、骨科康复、内科康复、儿童康复、物理治疗科、作业治疗科、言语治疗科、假肢矫形器科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》康复科专业细则要求，详见附表1 </td>
