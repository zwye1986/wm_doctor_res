...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——口腔全科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">牙体牙髓科、儿童口腔科、口腔颌面外科、口腔正畸科、口腔预防科、牙周科、口腔黏膜科、口腔修复科、口腔颌面影像科</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.7技能操作和手术种类及数量★</td>
          <td class="left">核对上一年度各亚专业(专科)技能操作和手术种类及数量的统计报表 </td>
          <td class="left">符合要求（含协同单位），得满分<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">牙科综合治疗台、牙髓活力测定所需设备、根管治疗所需器械、银汞调合机、光敏树脂充填照射灯、牙周探针、超声洁牙机、龈上和龈下深刮器、牙科印模制取托盘、牙科模型制作设备及技工设备、常用牙科器械、材料、药品以及口腔诊室应必备的器械和材料</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">随机抽查1～2名二年级以上培训对象进行技能操作或常见手术，查看其掌握情况</td>
          <td class="left">技能操作评分表见附件附表4-1、附表4-2、附表4-3、附表4-4、附表4-5
