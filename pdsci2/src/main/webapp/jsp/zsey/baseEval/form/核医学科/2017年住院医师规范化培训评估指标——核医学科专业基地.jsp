...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——核医学科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">1.1.1月检查例次</td>
          <td class="left">月检查≥880例次，具体要求：<br/>
            单光子显像检查≥300例次<br/>
            正电子显像检查≥50例次<br/>
            体外分析检查≥500例次<br/>
            功能测定检查≥20例次<br/>
          ...
          <td class="left">符合标准，得满分<br/>1项未达标，得2分<br/>2项及以上未达标，不得分</td>
          <td>2</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.2科室和实验室</td>
          <td class="left">高活性实验室、负荷试验室、核医学专科门诊诊室、放射性废物处理和排放系统、阅片室（PACS系统、图像分析和报告工作站、集体阅片系统）</td>
          <td class="left">查看相关文件，实地考察</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">内分泌科、肿瘤科、放射诊断、核医学科（高活性室、体外分析、核素治疗、功能测定、技术组、SPECT或SPECT/CT、PET或PET/CT）、放射影像诊断科（神经、骨关节、胸部、腹部）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》核医学科专业细则要求，见附件1                    </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">正电子显像设备（包括PET/CT、PET/MRI、PET、符合线路SPECT）、甲状腺功能测定仪、体外分析技术设备、活度计、放射性污染检测或监测仪、通风橱、衰变池，见附件2</td>
          <td class="left">检查设备清单复印件，需加盖医院公章，实地考察</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="3">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td rowspan="3">1</td>
          <input type="hidden" name="orderNumber" value="1.2.1"/>
          <td rowspan="3"><input type="text" name="score" value="${scoreMap["1.2.1"]}"/></td>
          <td rowspan="3"><textarea rows='1' name="deductMarks">${marksMap["1.2.1"]}</textarea></td>
          <td rowspan="3">
        ...
        <tr class="td_group">
          ...
          <td class="left">在协同亚专业（专科）轮转时间符合亚专业相关要求</td>
          <%--<td>1</td>--%>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="3">检查人事部门提供的师资状况统计表，包括姓名、毕业时间、毕业学校、学历学位、专业技术职务、专业技术职务任职时间、工作时间，需加盖人事部门公章</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）主任医师≥1人，副主任医师≥1人，主治医师≥2人   </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事核医学专业的医疗、科研和教学工作超过10年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">查看岗位职责等相关文件，访谈各类人员</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">查看岗位职责等相关文件，访谈各类人员</td>
        ...
        <tr class="td_group">
          <td class="left">3.2.2教学阅片会</td>
          <td class="left">开展规范的阅片会，至少每周1次</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">按照专业基地培训对象临床技能操作和诊断报告能够达到《住院医师规范化培训内容与标准（试行）》核医学科培训细则的要求</td>
          <td class="left">查看轮转手册等相关材料，随机抽查访谈本院、委培、社会招收培训对象各1～2名</td>
          <td class="left">独立技能操作和诊断报告种类及数量达要求，得满分<br/>
            独立技能操作和诊断报告≥规定数的80%，得3分<br/>
            独立技能操作和诊断报告≥规定数的60%，得1分<br/>
            ＜60%，或未安排独立操作及报告，不得分</td>
          <td>6</td>
        ...
        <tr class="td_group">
          <th rowspan="4">4.质量控制（30分）</th>
          <td >4.1带教医师教学质量</td>
          <td class="left">4.1.1临床教学★</td>
          <td class="left">能够针对培训对象开展规范的临床教学（阅片会），悉心指导培训对象</td>
          <td class="left">随机抽查1～2名带教医师临床教学</td>
          <td class="left">教学读片评分表，见附件3<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">4.2.1临床能力（阅片）★</td>
          <td class="left">培训对象影像诊断报告书写规范</td>
          <td class="left">随机抽查1～2名培训对象书写的诊断报告，结合诊断报告提问题</td>
          <td class="left">诊断报告书写考核评分表，见附件4<br/>
            ≥90分得满分，≥80分得4分，≥70分得2分，≥60分得1分，＜60分不得分 </td>
          <td>8</td>
