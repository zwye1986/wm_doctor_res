...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——儿外科专业基地</h1>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:门诊部、急诊科、影像科、病理科、检验科<br/>
            综合实验室：肺功能室、血检室、胃肠功能室、内分泌功能检查室</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事儿科专业的医疗、科研和教学工作超过15年</td>
