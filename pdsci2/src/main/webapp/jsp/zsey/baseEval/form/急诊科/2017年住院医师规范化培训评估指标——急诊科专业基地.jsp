...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——急诊科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        <tr class="td_group">
          ...
          <td class="left">总床位数≥30张，各区域床位数：抢救室≥4张、留观+急诊病房≥20张、EICU≥6张</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.2抢救室年收治病人数</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.3EICU、留观和病房年收治病人数</td>
          <td class="left">≥4000人次</td>
          <td class="left">符合标准，得1分<br/>不达标准，不得分</td>
          <td>1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">必备科室:预诊台、诊室（成人诊室、小儿诊室、妇产科诊室及特殊病人如精神病、囚犯等诊室）、抢救室、输液室、清创室、石膏室、急诊辅助科室（急诊药房、急诊检验科、急诊影像科）、急诊病房或观察室、急诊重症监护室、急诊手术室</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">呼吸内科、心血管内科、神经内科、消化内科、其他内科（血液、内分泌、肾脏内科）、麻醉科、综合ICU、普通外科（腹部外科为主）、骨科、神经外科、心胸外科、妇产科急诊、儿科（可自选）、皮肤科门诊（可自选）、急诊科（含EICU)、感染科、影像科、超声科</td>
          <td class="left">查看各(亚)专业设置名称<br/>
            查看培训对象轮转计划和登记手册<br/>
            实地考查，访谈培训对象</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》急诊科专业细则要求，详见附件1</td>
        ...
        <tr class="td_group">
          <td class="left">1.1.8临床技能操作或手术种类及数量★</td>
          <td class="left">符合《住院医师规范化培训基地认定标准（试行）》和《住院医师规范化培训内容与标准（试行）》急诊科专业细则要求，详见附件1</td>
          <td class="left">核对上1年度各亚专业（专科）临床技能操作或手术种类和数量的统计报表 </td>
          <td class="left">符合要求（含协同单位)，得满分<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">大型X射线机、数字血管造影设备、CT、核磁共振、ECT、放射治疗机、彩色多普勒超声</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">符合《住院医师规范化培训基地认定标准（试行）》急诊科专业细则要求，详见附件2 </td>
          <td class="left">检查设备清单复印件，需加盖医院公章，实地考查</td>
          <td class="left">缺1项，不得分</td>
          <td>1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业(专科)床位数(参照《住院医师规范化培训基地认证标准（试行）》本专业细则要求)</td>
          <td class="left">满足要求，得1分（无协同单位的专业基地，此处不失分）</td>
          <td>1</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">各亚专业（专科）应由主任医师或副主任医师担任各科室或病区主任或副主任。科室内具有中、高级专业技术职务人数应占科室总医师数比例≥60%，所有医师最低学历为医学本科</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">医学本科及以上学历，主任医师专业技术职务，从事急诊科专业的医疗、科研和教学工作超过15年</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">提供本年度原始资料，访谈培训对象，核实落实情况</td>
        ...
        <tr class="td_group">
          ...
          <td class="left" rowspan="2">提供本年度原始资料，访谈培训对象，核实落实情况</td>
          <td class="left">开展次数达标，且认真规范，得满分<br/>不达标或不规范，不得分</td>
          <td>2</td>
        ...
        <tr class="td_group">
          <td class="left">3.4.2急诊工作量</td>
          <td class="left">年急诊手术≥300例<br/>年急诊总量≥5万人次</td>
          <td class="left">手术例数和急诊量达到要求，得满分<br/>
            手术例数和急诊量≥规定数的80%，得2分<br/>
            手术例数和急诊量≥规定数的60%，得1分<br/>
            ＜规定数60%，或未完成急诊量，不得分</td>
          <td>3</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">每个轮转科室均按照《住院医师规范化培训内容与标准》本专业培训细则要求执行，为每名培训对象安排并完成规定的技能操作和手术（见附件1）</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">病历书写评分表见附表4-1/4-2<br/>
            ≥90分得满分，≥80分得3分，≥70分得2分，≥60分得1分，＜60分不得分  </td>
          <td>4</td>
      ...
      <tr class="td_group">
        <td colspan="10" style="text-align: left">
          备注：<br/>
          1.一级指标4项，二级指标10项，三级指标38项。三级指标中，核心指标14项、计65分，一般指标25项、计35分，共100分。<br/>
