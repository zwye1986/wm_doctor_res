...
<div data-role="page" id="pageone">
  <div data-role="header">
	<h1 style="text-align: center;font-size: 25px;">2017年住院医师规范化培训评估指标——内科专业基地</h1>
  </div>
    ...
    <table data-role="table" data-mode=""  class="ui-responsive table-stroke">
      ...
      <tbody  id="dataTable">
        ...
        <tr class="td_group">
          ...
          <td class="left">普通外科、神经内科、重症监护室、皮肤科、口腔科、麻醉科、医学影像科（含超声和核医学）、病理科、检验科（包括免疫室、细菌室、生化实验室）、输血科<br/>
              相关诊断治疗室：①心电图室、心导管室②肺功能室、睡眠呼吸检测室、呼吸内镜室③消化内镜室、胃肠动力实验室④血液实验室、内分泌实验室、风湿免疫实验室（可指医院中心实验室）⑤透析室⑥无菌层流病房</td>
        ...
        <tr class="td_group">
          ...
          <td class="left">必选科室： 心血管内科(含心电图室)、肾脏内科、呼吸内科、血液内科、消化内科、内分泌科、感染科、神经内科、风湿免疫科、急诊科、内科门诊(包括内科各亚专业)、重症监护病房<br/>
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上1年度各亚专业收治疾病种类及数量的统计报表 </td>
        ...
        <tr class="td_group">
          ...
          <td class="left">核对上1年度各亚专业临床技能操作种类及数量的统计报表 </td>
          <td class="left">符合要求（含协同单位），得满分<br/>
