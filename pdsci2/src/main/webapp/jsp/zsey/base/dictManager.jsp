...
function edit(dictFlow){
	jboxOpen("<s:url value='/zsey/base/edit?dictFlow='/>"+dictFlow,"编辑", 500,350);
}

function add(){
	jboxOpen("<s:url value='/zsey/base/edit?dictTypeId=${param.dictTypeId}'/>","新增", 500,350);
}
function search(){
	jboxStartLoading();
	$("#searchForm").submit();	
...
function refresh(){
	var url = "<s:url value='/zsey/base/doRefresh'/>";
...
<div class="mainright">
	<div class="content">
		 ...
		 <form id="searchForm" action="<s:url value="/zsey/base/dictList" />" method="post" >
