...
String.prototype.htmlFormart = function(){
	...
	function importArrange(){
		...
		var length=0;
		jboxStartLoading();
		var url = "<s:url value='/sch/arrangeImport/importArrange'/>";
		 jboxSubmit(
				$('#excelForm'),
				url,
				function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		...
		<tr>
			<th>模板文件</th>
			<td><a href="<s:url value='/jsp/sch/arrangeImport/temp.xls'/>">排班导入模板.xlsx</a></td>
		</tr>
	</table>
	<div style="text-align: left;">
			注意事项：
		<label style="color: red">
			(1)、学员证件号必须是系统中已经存在的。<br>&#12288;&#12288;&#12288;&#12288;&#12288;
			(2)、模板中所以字段不能为空。<br>&#12288;&#12288;&#12288;&#12288;&#12288;
			(3)、主任与带教必须所属对应的科室。<br>&#12288;&#12288;&#12288;&#12288;&#12288;
			(4)、轮转组与标准科室信息。请从此处<a href="javascript:void(0);" onclick="downGroup()">下载</a><br>&#12288;&#12288;&#12288;&#12288;&#12288;
			(5)、学员未开始轮转，排班信息以最后一次为准。如果已开始轮转，则无法使用导入。<br>&#12288;&#12288;&#12288;&#12288;&#12288;
			(6)、带教与主任可填可不填，如果填写的话，请填写用户名
		</label>
	</div>
