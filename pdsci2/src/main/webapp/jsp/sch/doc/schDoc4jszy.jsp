			...
			<table class="basic list" width="100%">
				...
				<c:forEach items="${doctorList}" var="doctor">
					<tr>
						...
						<td title="${doctor.trainingTypeName}">${pdfn:cutString(doctor.trainingTypeName,5,true,3)}</td>
						<td title="${doctor.trainingSpeName}">${pdfn:cutString(doctor.trainingSpeName,10,true,3)}</td>
