...
function importRotation(){
	...
	jboxStartLoading();
	var url = "<s:url value='/sch/importRotationFromExcel'/>";
	jboxSubmit(
			$('#excelForm'),
			url,
			function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table width="100%" class="basic">
		...
		<tr>
			<th>模板文件</th>
			<td style="padding-left:10px;"><a href="<s:url value='/jsp/sch/template/importRotate.xlsx'/>">轮转方案导入模板.xlsx</a></td>
		</tr>
	</table>
	<br/>
	<p style="text-align: center;">
		<input type="button" onclick="importRotation();" value="导入" class="search"/>
	</p>
</form>
</div>
</div>
