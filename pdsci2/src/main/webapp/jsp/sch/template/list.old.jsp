...
<script type="text/javascript">
	function editRotation(rotationFlow){
		...
		jboxOpen("<s:url value='/sch/template/editRotation'/>?roleFlag=${param.roleFlag}&rotationFlow="+rotationFlow,title,800,500);
	}
	
	function rule(rotationFlow){
		window.location.href="<s:url value='/sch/template/rule'/>?rotationFlow="+rotationFlow+"&sessionNumber="+$("#sessionNumber").val()+"&speId="+$("#speId").val()+"&roleFlag=${param.roleFlag}";
	}
