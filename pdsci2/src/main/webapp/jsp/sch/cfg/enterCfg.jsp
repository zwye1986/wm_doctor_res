...
<script type="text/javascript">
	function save(){
		...
		var url = "<s:url value='/sch/cfg/saveEnterCfg'/>";
			...
			<fieldset>
				...
				<div style="text-align: center">
					<form id="searchForm" method="post" >
						...
						<div class="div_search" style="padding: 10px;text-align: left;">
							开始月份：
							<input type="text" class="validate[required] xltext" id="startMonth" name="startMonth" value="${resEnterOpenCfg.startMonth}" onClick="WdatePicker({dateFmt:'yyyy-MM'})" readonly="readonly">
						</div>
						<div class="div_search" style="padding: 10px;text-align: left;">
							当前可选科年级：
							<input type="text" class="validate[required] xltext" id="sessionNumber" name="sessionNumber" value="${resEnterOpenCfg.sessionNumber}" onClick="WdatePicker({dateFmt:'yyyy'})" readonly="readonly">
						</div>
					</form>
				</div>
			<div class="button">
