...
<head>
    ...
    <script type="text/javascript">
        ...
        function leadTo(){
            jboxOpen("<s:url value='/nyzl/retestStudent/leadToMaster'/>?stuSignFlag=${stuSignFlag}&adminFlag=${adminFlag}","导入",500,200);
        }
                        ...
                        <table class="basic table1" style="width: 980px">
                            ...
                            <tr>
                                <td>考生编号：<input type="text" id="stuNo" name="stuNo" value="${param.stuNo}" style="width: 137px;"/>
                                    ...
                                    &#12288;调剂批次：<select style="width: 141px;" name="swapBatchId">
                                        <option value="">全部</option>
                                    ...
                                    <div style="width:0px;height:0px;overflow:visible;float:left;position:relative;top:32px;left:732px;">
                                    ...
                                    <input type="hidden" id="fwhFlow" name="fwhFlow" value="${param.fwhFlow}"/><br/>
