...
<head>
    ...
    <script type="text/javascript">
        ...
        function leadTo(){
            jboxOpen("<s:url value='/nyzl/admissionStudent/leadToSummerCamp'/>?stuSignFlag=${stuSignFlag}","导入",500,150);
        }
                            ...
                            <tr>
                                <td>
                                    ...
                                    <c:if test="${adminFlag eq 'Y'}">
                                        ...
                                        <div style="width:0px;height:0px;overflow:visible;float:left;position:relative;top:32px;left:510px;">
                                        ...
                                        <div style="width:0px;height:0px;overflow:visible;float:left;position:relative;top:32px;left:733px;">
                                        ...
                                        <input type="hidden" id="orgFlow" name="orgFlow" value="${param.orgFlow}"/><br/>
                                    </c:if>
