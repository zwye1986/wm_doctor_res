...
<head>
    ...
    <script type="text/javascript">
        function daoRu(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/nyzl/admissionStudent/importAdmissionStudent?stuSignFlag=${stuSignFlag}'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function(resp){
        ...
        <tr>
            ...
            <td>
                <c:if test="${stuSignFlag eq 'DoctoralStudent'}">
                    <a href="<s:url value='/jsp/nyzl/temeplete/importAdmissionStudent.xls'/>">录取情况导入模板.xlsx</a>
                </c:if>
                <c:if test="${stuSignFlag ne 'DoctoralStudent'}">
                    <a href="<s:url value='/jsp/nyzl/temeplete/importAdmissionTemplete.xls'/>">录取情况导入模板.xlsx</a>
                </c:if>
            </td>
        </tr>
    </table>
