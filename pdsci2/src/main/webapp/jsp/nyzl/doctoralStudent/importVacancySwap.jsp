...
<head>
    ...
    <script type="text/javascript">
        function daoRu(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/nyzl/vacancySwap/importVacancySwap?stuSignFlag=${stuSignFlag}'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="basic" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/nyzl/temeplete/importVacancySwap.xls'/>">调剂缺额信息导入模板.xlsx</a></td>
        </tr>
    </table>
</form>
