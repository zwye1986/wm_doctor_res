...
<head>
    ...
    <script type="text/javascript">
        function importExam(){
            ...
            var url = "<s:url value='/lcjn/lcjnSuppliesAssets/importSupplies'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="basic" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/lcjn/suppliesAndAssets/templet/importSupplies.xlsx'/>">耗材导入模板.xlsx</a></td>
        </tr>
    </table>
</form>
