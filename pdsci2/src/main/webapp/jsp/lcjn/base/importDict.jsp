...
<head>
	...
	<script type="text/javascript">
		function daoRu(){
			...
			jboxStartLoading();
			var url = "<s:url value='/lcjn/base/importDictExcel'/>";
			jboxSubmit(
					$('#excelForm'),
					url,
					function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		<tr>
			<th>字典类型</th>
			<td>
				<select class="validate[required] xlselect" name="dictTypeId" onchange="limitDictName(this.value)">
		...
		<tr>
			<th>模板文件</th>
			<td><a href="<s:url value="/jsp/lcjn/base/dictTemp.xlsx"/>">字典导入模板.xls</a></td>
		</tr>
	</table>
</form>
