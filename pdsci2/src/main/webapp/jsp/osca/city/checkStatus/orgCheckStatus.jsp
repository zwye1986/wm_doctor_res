...
<head>
    ...
    <script>
        ...
        function toPage(page){
            ...
            jboxPostLoad("contentDiv","<s:url value="/osca/examineInfo/checkCityInfoByOrgList/city"/>",$("#searchForm").serialize(),true);
        }

        function exportInfo(){
            var url = "<s:url value='/osca/examineInfo/exportCityInfo/orgInfo/city'/>";
            jboxTip("导出中…………");
...
<div class="mainright">
    <div class="content" id="contentDiv">
        <div class="queryDiv">
        <form id="searchForm" action="<s:url value="/osca/examineInfo/checkCityInfoByOrgList/city"/>" method="post">
