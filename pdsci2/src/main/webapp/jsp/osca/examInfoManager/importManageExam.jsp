...
<head>
    ...
    <script type="text/javascript">
        function importExam(){
            ...
            var url = "<s:url value='/osca/oscaExaminerManage/importManagerExam'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="basic" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/osca/examInfoManager/templet/importManageExam.xls'/>">考官导入模板.xlsx</a></td>
        </tr>
    </table>
</form>
