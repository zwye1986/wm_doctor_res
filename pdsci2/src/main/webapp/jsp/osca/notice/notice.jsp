...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveNotice(){
            ...
            var url = "<s:url value='/osca/oscaNotice/saveNotice/${roleFlag}'/>";
        ...
        function toPage(page) {
            ...
            location.href="<s:url value='/osca/oscaNotice/notice/${roleFlag}'/>?currentPage="+page;
        }
        function goNoticeByPage(){
            toPage("${param.currentPage}");
        }
        function edit(infoFlow){
            var url = "<s:url value='/osca/oscaNotice/findNoticeByFlow'/>?infoFlow="+infoFlow;
        ...
        function delNotice(infoFlow){
            jboxConfirm("确认删除？" , function(){
                var url = "<s:url value='/osca/oscaNotice/delNotice'/>?infoFlow="+infoFlow;
                jboxGet(url , null , function(resp){
                    toPage(1);
                } , null , true);
            });
...
<div id="bodyDiv" style="height: 100%;overflow: auto;">
    <div style="margin-bottom: 20px;">
        ...
        <div id="noticeList" class="index_form" style="margin-top:10px;padding-left: 15px;padding-right: 15px; ">
            <table width="100%" class="basic">
                <tr>
                    <th style="padding-left: 10px;text-align: left;">技能考核通知</th>
                </tr>
                <c:forEach items="${infos}" var="msg">
                    <tr  class="operDiv">
                        <td style="padding-right: 10px;">
                            <div style="float: left;">
                                <a href="<s:url value='/osca/oscaNotice/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a>
                            ...
                            <div style="float: right;">
		            			...
		            			<span style="display:none;">
									...
									<a href="<s:url value='/osca/oscaNotice/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank" style="color: #4195c5;">查看</a> |
