...
<head>
    ...
    <script>
        function toPage(page) {
            ...
            location.href="<s:url value='/osca/oscaNotice/noticeList'/>?currentPage="+currentPage;
        }
    </script>
    <style>
        .btn {
    ...
    <div class="content">
        <table class="basic" width="100%" style="margin:auto;margin-top: 10px;">
            ...
            <c:forEach items="${infos}" var="info">
                <tr>
                    <td>
                        <a href="<s:url value='/osca/oscaNotice/noticeView'/>?infoFlow=${info.infoFlow}" target="_blank">${info.infoTitle}</a>
