...
<div style="overflow: auto;height: 500px;">
    <input class="search" type="button"  value="导&#12288;出" style="margin-bottom: 10px;margin-left: 0px" onclick="expertFrom('00000002copy');"/>
    <table cellpadding="4" style="width: 100%">
        ...
        <tr  style="height:50px">
            ...
            <c:if test="${view eq 'Y'}">${dataMap['score1']}</c:if>
                <c:if test="${empty view}">
                <input name="score1" value="${dataMap['score1']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center">
                ...
                <c:if test="${empty view}">
                <input name="score2" value="${dataMap['score2']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/> </c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score3" value="${dataMap['score3']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/>  </c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score4" value="${dataMap['score4']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score5" value="${dataMap['score5']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score6" value="${dataMap['score6']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/></c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score7" value="${dataMap['score7']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/> </c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="score8" value="${dataMap['score8']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/> </c:if>
            </td>
        ...
        <tr  style="height:50px">
            ...
            <td align="center"  >
                ...
                <c:if test="${empty view}">
                <input name="scoreSum" value="${dataMap['scoreSum']}" class="input" type="text"
                       style="height:20px;width: 25px; text-align: center"/> </c:if>
            </td>
