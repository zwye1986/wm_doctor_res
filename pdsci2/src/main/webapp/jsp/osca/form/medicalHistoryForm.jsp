...
<div style="overflow: auto;height: 500px">
    <input class="search" type="button"  value="导&#12288;出" style="margin-bottom: 10px;margin-left: 0px" onclick="expertFrom('00000004copy');"/>
...
<c:if test="${empty view}">
                <input name="score1" value="${dataMap['score1']}"onchange="saveScore(this,10);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score2" value="${dataMap['score2']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score3" value="${dataMap['score3']}"onchange="saveScore(this,10);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score4" value="${dataMap['score4']}"onchange="saveScore(this,10);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score5" value="${dataMap['score5']}"onchange="saveScore(this,20);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score6" value="${dataMap['score6']}"onchange="saveScore(this,10);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score7" value="${dataMap['score7']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score8" value="${dataMap['score8']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score9" value="${dataMap['score9']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score10" value="${dataMap['score10']}"onchange="saveScore(this,10);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score11" value="${dataMap['score11']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="score12" value="${dataMap['score12']}"onchange="saveScore(this,5);" class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
...
<c:if test="${empty view}">
                <input name="scoreSum" value="${dataMap['scoreSum']}"class="input" type="text"  style="height:20px;width: 25px; text-align: center"  /></c:if>
            </td>
