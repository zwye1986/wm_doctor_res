...
<div>
<input class="search" type="button"  value="导&#12288;出" style="margin-bottom: 10px;margin-left: 0px" onclick="expertFrom('00000005copy');"/>
<table class="basic" width="100%" style="margin-top: 10px;">
    ...
    <tr>
        <th rowspan="7"  style="text-align: center;">病历质量</th>
        <th style="text-align: center;">完成及时</th>
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">格式规范</th>
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">内容完整真实</th>
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">术语表达确切</th>
        <th style="text-align: center;">15</th>
        <td style="text-align: center;">
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">字迹清楚</th>
        <th style="text-align: center;">10</th>
        <td style="text-align: center;">
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">分析合理</th>
        <th style="text-align: center;">15</th>
        <td style="text-align: center;">
...
<c:if test="${empty view}">
    ...
    <tr>
        <th style="text-align: center;">诊断正确</th>
        <th style="text-align: center;">10</th>
        <td style="text-align: center;">
