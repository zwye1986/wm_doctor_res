...
<head>
    ...
    <script>
        ...
        function toPage(page){
            ...
            jboxPostLoad("contentDiv","<s:url value="/osca/examineInfo/checkCityInfoByOrgList/global"/>",$("#searchForm").serialize(),true);
        }

        function exportInfo(){
            var url = "<s:url value='/osca/examineInfo/exportCityInfo/orgInfo/global'/>";
            jboxTip("导出中…………");
        ...
        function initOrgSelect(){
            jboxPost("<s:url value='/osca/examineInfo/loadCityOrgList'/>", $("#searchForm").serialize(), function (resp) {
                $("#orgSelect").empty();
                if (null != resp && resp.length > 0) {
                    $("#orgSelect").append("<option value=''>全部</option>");
                    for(var i= 0;i<resp.length;i++){
                        $("#orgSelect").append("<option value='"+resp[i].orgFlow+"'>"+resp[i].orgName+"</option>");
                    }
                }else {
                    $("#orgSelect").append("<option value=''>全部</option>");
                }
...
<div class="mainright">
    <div class="content" id="contentDiv">
        <form id="searchForm" action="<s:url value="/osca/examineInfo/checkCityInfoByOrgList/global"/>" method="post">
            <%--<div class="choseDivNewStyle" style="min-width: 1100px;">--%>
                ...
                <%--<table class="basic" style="width:100%;border:0px;margin:10px 0px;">--%>
                    ...
                    <div class="inputDiv">
                        ...
                        <select name="orgCityId" class="qselect" onchange="initOrgSelect()">
                    ...
                    <div class="inputDiv">
                        ...
                        <select name="orgFlow" class="qselect" id="orgSelect">
