...
<head>
    ...
    <script>
        ...
        function toPage(page){
            ...
            jboxPostLoad("contentDiv","<s:url value="/osca/examineInfo/checkCityInfoBySpeList/global"/>",$("#searchForm").serialize(),true);
        }

        function exportInfo(){
            var url = "<s:url value='/osca/examineInfo/exportCityInfo/speInfo/global'/>";
            jboxTip("导出中…………");
...
<div class="mainright">
    <div class="content" id="contentDiv">
        <form id="searchForm" action="<s:url value="/osca/examineInfo/checkCityInfoBySpeList/global"/>" method="post">
