...
<head>
	...
	<script type="text/javascript">
		function daoRu(){
			...
			var url = "<s:url value='/osca/base/importStudents?clinicalFlow=${param.clinicalFlow}'/>&timeFlow="+timeFlow;
			jboxSubmit(
					$('#excelForm'),
					url,
					function(resp){
		...
		<tr>
			...
			<td>
				<c:if test="${!(empty skillsAssessmentTimes)}">
					<select class="xlselect validate[required]" name="time" onchange="showTimeDiv(this.value)" style="width: 70%">
