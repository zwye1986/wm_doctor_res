...
<script>
    ...
    function asseAudit(){
        var roleFlag="${GlobalConstant.USER_LIST_LOCAL}";
        jboxLoad("content","<s:url value='/hbres/asseLocal/asseGraduationForHos'/>?roleFlag="+roleFlag+"&tabTag=WaitAudit",true);
    }
	//附件上传
	function attachmentUpload(){
		jboxLoad("content","<s:url value='/hbres/asseLocal/attachmentUpload'/>",true);
	}
</script>
<style>
...
<jsp:include page="/jsp/hbres/head.jsp" flush="true">
    <jsp:param value="/hbres/singup/graduate/manage/local" name="indexUrl"/>
   ...
   <div class="container">
     <div class="content_side">
        <dl class="menu menu_first">
          ...
          <dd class="menu_item"><a onclick="attachmentUpload();">年度考核成绩材料</a></dd>
        </dl>
     </div>
