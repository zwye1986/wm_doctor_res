...
function importExcel(){
	...
	jboxStartLoading();
	var url = "<s:url value='/hbres/singup/impOperExcel'/>";
	jboxSubmit(
		$('#planForm'),
		url,
		function(data){
	...
	<div style="padding:0px 20px;margin-top:20px;">
		...
		<form id="planForm" method="post" enctype="multipart/form-data">
			<table width="100%" class="basic">
				...
				<tr>
					<th>导入模板：</th>
					<td><a href="<s:url value='/jsp/hbres/hospital/operExamTemp.xlsx'/>">复试成绩单导入模板.xlsx</a></td>
				</tr>
				<tr>
					<th>备注：</th>
					<td><font color="red">导入复试成绩前确保已有理论成绩，否则影响总成绩</font></td>
				</tr>
			</table>
			<br/>
			<p style="text-align: center;">
				<input type="button" onclick="importExcel();" value="复试成绩单导入" class="btn_green"/>
			</p>
		</form>
	</div>
</div>
