...
<script>
    ...
    function parameterConfig(){
        jboxLoad("content","<s:url value='/hbres/singup/parameterConfigMain'/>",true);
    }
    function asseAudit(){
        var roleFlag="${GlobalConstant.USER_LIST_GLOBAL}";
        jboxLoad("content","<s:url value='/hbres/asseGlobal/main'/>?roleFlag="+roleFlag+"&tabTag=WaitAudit",true);
    }
...
<div class="yw">
 <jsp:include page="/jsp/hbres/head.jsp" flush="true">
    <jsp:param value="/hbres/singup/graduate/manage/global" name="indexUrl"/>
     ...
     <div class="content_side">
        ...
        <dl class="menu">
          <dt class="menu_title">
           ...
           <dd class="menu_item"><a onclick="parameterConfig();">参数设置</a></dd>
        </dl>
     </div>
