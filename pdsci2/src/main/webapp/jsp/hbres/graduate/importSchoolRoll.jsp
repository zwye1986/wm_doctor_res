...
function daoRu(){
	...
	jboxStartLoading();
	var url = "<s:url value='/hbres/singup/importSchoolRollFromExcel'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="grid" style="width: 100%;">
		...
		<tr>
			...
			<td style="text-align: left;">&ensp;<a href="<s:url value='/jsp/hbres/graduate/importSchoolRoll.xlsx'/>">学生成绩导入模板.xlsx</a></td>
		</tr>
	</table>
</form>
