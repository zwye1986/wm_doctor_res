    ...
    <script type="text/javascript">
        function saveRec(cfgFlow) {
            ...
            if ($("#resRecGradeForm").validationEngine("validate")) {
                jboxConfirm("请确认是否要提交该评价表，注意该评价表为："+cfgCodeName, function () {
                    jboxPost("<s:url value='/res/nurse/saveGrade'/>?cfgFlow=" + cfgFlow, $("#resRecGradeForm").serialize(), function (resp) {
        ...
        function submit() {
            jboxConfirm("确认提交?", function () {
                ...
                jboxPost("<s:url value='/res/nurse/opreResRecForGrade'/>", {
                    "recFlow": recFlow,
            ...
            <div class="title1 clearfix">
                <div style="padding-top: 10px;padding-left: 5px;padding-right: 5px;padding-bottom: 5px;">
                        ...
                        <c:forEach items="${titleFormList}" var="title">
                            <table class="xllist nofix"  style="margin-top: 10px;">
                                ...
                                <tr style="height:150px;">
                                    ...
                                    <td style="text-align: left;"  colspan="3"><textarea class="inputText" name="lostReason" style="text-align: left;width: 95%;height: 95%" value="${gradeMap['lostReason']}"  placeholder="请填写对住院医师的期望和建议">${gradeMap['lostReason']}</textarea></td>
                                </tr>
                            </table>
                        </c:forEach>
                    ...
                    <div style="text-align: center;margin-top: 5px;">
                        <c:if test="${empty rec}">
                           <%-- <input id="submitButton" type="button" value="提&#12288;交" class="search" onclick="submit();"
                                   style="${!empty rec?'':'display: none;'}"/>--%>
                            <input type="button" value="保&#12288;存" class="search" id="saveRec"
                                   onclick="saveRec('${assessCfg.cfgFlow}');"/>
                        </c:if>
