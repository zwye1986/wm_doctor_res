...
<div class="infoAudit">
	<div class="div_table">
		<form id="editForm" style="position: relative;" method="post">
			...
			<input type="hidden" name="processFlow" id="processFlow" value="${processFlow}"/>
			<table border="0" cellpadding="0" cellspacing="0" class="base_info">
				...
				<tr>
					...
					<td id="catSpeTd">
						<span><input type="radio" name="recTypeId" value="TeacherAssess" />住院医师评临床专业指导医师估量表</span>&#12288;&#12288;
						<span><input type="radio" name="recTypeId" value="TeacherAssessTwo" />住院医师评估医技专业指导医师量表</span>
					</td>
				</tr>
				</tbody>
			</table>
