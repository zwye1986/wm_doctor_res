...
<script type="text/javascript">
	function saveRec(cfgFlow){
		if($("#resRecGradeForm").validationEngine("validate")){
			...
			jboxConfirm("请确认是否要提交该评价表，注意该评价表为："+cfgCodeName, function () {
				jboxPost("<s:url value='/res/teacherEvaDoctor/saveGrade'/>?cfgFlow="+cfgFlow,$("#resRecGradeForm").serialize(),function(resp){
	...
	function submit(){
		jboxConfirm("确认提交?",function(){
			...
			jboxPost("<s:url value='/res/teacherEvaDoctor/opreResRecForGrade'/>",{"recFlow":recFlow,"statusId":"${recStatusEnumSubmit.id}"},function(resp){
			...
			<div class="title1 clearfix">
				<div style="padding-top: 10px;padding-left: 5px;padding-right: 5px;padding-bottom: 5px;">
					<form id="resRecGradeForm" style="position: relative;">
						...
						<input type="hidden" name="roleFlag" id="roleFlag" value="${param.roleFlag}"/>
