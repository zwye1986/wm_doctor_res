...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/hbres/asse/AuditList'/>?roleFlag=${roleFlag}",$("#searchForm").serialize(),false);
	}
	function exportInfo()
	{
		if(!$("#applyYear").val()){
		...
		var url = "<s:url value='/hbres/asse/exportList'/>?roleFlag=${roleFlag}";
	...
	<form id="searchForm">
		...
		<table class="searchTable" style="width: 100%;border-collapse:separate; border-spacing:0px 10px;">
			...
			<tr>
				...
				<td>
					<select name="auditStatusId" id="auditStatusId" class="select" style="width: 106px;">
						<option value="">请选择</option>
