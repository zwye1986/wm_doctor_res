...
<script type="text/javascript">
	...
	function toPage(page) {
		...
		jboxStartLoading();
		jboxPostLoad("doctorListZi","<s:url value='/hbres/asseLocal/waitAuditList'/>?"+data+"&roleFlag=${roleFlag}",$("#searchForm").serialize(),true);
	}
	...
	function exportInfo()
	{
		...
		var url = "<s:url value='/hbres/asseLocal/exportList'/>?auditStatusId=${jsResAsseAuditListEnumAuditing.id}&isWaitAudit=Y";
