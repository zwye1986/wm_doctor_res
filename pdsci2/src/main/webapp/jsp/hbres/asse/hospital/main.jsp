...
<script type="text/javascript">
	...
	function selTag(tabTag){
		if("WaitAudit"==tabTag)
		{
			...
			//待审核
			jboxLoad("mainDiv","<s:url value='/hbres/asseLocal/waitAuditMain'/>?roleFlag=${param.roleFlag}",true);
		}else{
			...
			//审核列表
			jboxLoad("mainDiv","<s:url value='/hbres/asseLocal/auditMain'/>?roleFlag=${param.roleFlag}",true);
		}
	}
</script>
