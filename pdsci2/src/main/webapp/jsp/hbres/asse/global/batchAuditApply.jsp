...
function  applyAudit()
{
	...
	if(!reason2&&id=="${jsResAuditStatusEnumNotPassed.id}")
	{
		jboxTip("请填写原因！");
		return false;
	}
...
//	}
	...
	jboxConfirm("确认审核？" , function(){
		jboxStartLoading();
		jboxPost("<s:url value='/hbres/asseGlobal/batchSaveAudit'/>?"+applyFlows,
				$("#myform").serialize(),
				function(resp){
					top.jboxEndLoading();
					endloadIng();
...
//	datas.push(arry);
//	var arry ={"id":"不通过，非2017年国家执业医师考试成绩单/国家执业医师考试成绩不合格","text":"不通过，非2017年国家执业医师考试成绩单/国家执业医师考试成绩不合格"};
//	datas.push(arry);
		...
		<table border="0" cellpadding="0" cellspacing="0" style=" width:100%;text-align: center;"class="base_info" >
			...
			<tbody>
				...
				<tr style=" width:100%;text-align: center;">
					...
					<td style="text-align: left;">&#12288;&#12288;<input type="radio" name="auditStatusId" value="${jsResAuditStatusEnumNotPassed.id}" onclick="check();">退回</td>
				</tr>
				<tr style=" width:100%;text-align: center;">
				...
				<tr style=" width:100%;text-align: center;">
					...
					<td style="border: 0px solid;border-right:1px solid #e7e7eb;text-align: left;padding-left: 30px;" >
						...
						<%--<select id="unpassReason1" class="select" style="width: 250px;">--%>
							...
							<%--<option value="不通过，非2017年国家执业医师考试成绩单/国家执业医师考试成绩不合格">不通过，非2017年国家执业医师考试成绩单/国家执业医师考试成绩不合格</option>--%>
