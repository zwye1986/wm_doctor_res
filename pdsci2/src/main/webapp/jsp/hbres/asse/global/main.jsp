...
<script type="text/javascript">
	...
	function selTag(tabTag){
		if("WaitAudit"==tabTag)
		{
			...
			//待审核
			jboxLoad("mainDiv","<s:url value='/hbres/asseGlobal/waitAuditMain'/>?roleFlag=${param.roleFlag}",true);
		}else{
			...
			//审核列表
			jboxLoad("mainDiv","<s:url value='/hbres/asseGlobal/AuditListMain'/>?roleFlag=${param.roleFlag}",true);
		}
	}
</script>
