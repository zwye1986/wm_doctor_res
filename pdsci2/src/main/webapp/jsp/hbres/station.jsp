...
<div class="mainright">
    ...
    <div id="station">
        ...
        <div class="wsdiv">
            <ul>
                ...
                && sessionScope.hbRoleFlow ne applicationScope.sysCfgMap['res_university_manager_role_flow']
                }">
                <li>
                ...
                <c:if test="${not empty sessionScope.hbRoleFlow && sessionScope.hbRoleFlow ne applicationScope.sysCfgMap['res_university_manager_role_flow'] && flag eq 'Y'}">
                <li>
                    <c:choose>
                        ...
                        <c:when test="${sessionScope.hbRoleFlow eq applicationScope.sysCfgMap['res_free_global_role_flow']}">
                            <c:set var="hbJyUrlPath" value="/hbres/singup/graduate/manage/global"/>
                        </c:when>
                    ...
                    <a href="<s:url value='${hbJyUrlPath}'/>?userFlow=${sessionScope.currUser.userFlow}" target="_top">
                ...
                <c:if test="${sessionScope.hbRoleFlow ne applicationScope.sysCfgMap['res_university_manager_role_flow']}">
                    <li>
                        <a href="http://dlexam.ezhupei.com/login/loginxiyi.aspx" target="_top">
                            <img src="<s:url value='/css/skin/${skinPath}/images/exam.png' />" width="48"/>
                            住院医师理论考试系统
                        </a>
                    </li>
                </c:if>
    ...
    <div id="footer">技术支持：南京品德网络信息技术有限公司<br />Copyright © 2001- 2018 Character Technology, Inc. All rights reserved.</div>
</div>
</body>
</html>