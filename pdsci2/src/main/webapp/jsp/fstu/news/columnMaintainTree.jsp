...
<head>
    ...
    <SCRIPT type="text/javascript">
        ...
        function beforeEditName(treeId, treeNode) {
            ...
            var url = "<s:url value='/fstu/columnManage/getColumnJson'/>";
        ...
        function beforeRemove(treeId, treeNode) {
            ...
            jboxConfirm("确认删除 " + treeNode.name + " 吗？" , function(){
                ...
                var url = "<s:url value='/fstu/columnManage/deleteJson'/>";
        ...
        function submitForm(){
            ...
            if(editForm.validationEngine("validate")){
                ...
                var url = "<s:url value='/fstu/columnManage/editJson'/>";
                                    ...
                                    <td>
                                        <form id="editForm">
                                            ...
                                            <table class="basic" style="display: none;" id="editTable">
                                                ...
                                                <tr>
                                                    <td colspan="2"><input type="button" class="search" value="提 交" onclick="submitForm()">&#12288;&#12288;<input type="button" value="取 消" class="search"  onclick="hideObj('#addTable')"></td>
                                                </tr>
                                            </table>
                                        </form>
                                    </td>
