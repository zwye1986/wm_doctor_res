...
function saveAudit(agreeFlag,achieveFlow){
	var tip =  agreeFlag=="${GlobalConstant.FLAG_Y}"?"审核通过":"退回";
	var url = "<s:url value='/fstu/aisr/achieve/saveAudit'/>?agreeFlag=" + agreeFlag + "&achieveFlow=" + achieveFlow;
...
<div class="mainright">
    <div class="content">
		...
		<div align="center">
		    ...
		    <input class='search' onclick="saveAudit('${GlobalConstant.FLAG_Y}','${achieve.achieveFlow}')" type='button'  value='同&#12288;意' />&#12288;
			<input class='search' onclick="saveAudit('${GlobalConstant.FLAG_N}','${achieve.achieveFlow}')" type='button' value='退&#12288;回'/>&#12288;
		</div>
		</form>
	</div>
</div> 
