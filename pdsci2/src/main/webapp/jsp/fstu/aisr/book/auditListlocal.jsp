...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/fstu/book/auditList/local"/>" method="post">
        ...
        <table class="xllist">
            ...
            <c:forEach items="${bookList}" var="book" varStatus="bookList">
                <tr>
                    ...
                    <td>
                        <c:if test="${book.operStatusId eq proStatusEnumApply.id }">
                            <a href="javascript:void(0)" onclick="audit('${book.bookFlow}');">[审核]</a>
                        </c:if>
                        <c:if test="${book.operStatusId eq proStatusEnumPassed.id }">
