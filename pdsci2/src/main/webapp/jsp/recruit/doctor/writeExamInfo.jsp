...
<head>
    ...
    <script type="text/javascript">
        ...
        function examineMainNote(mainFlow) {
            jboxOpen("<s:url value='/recruit/writeExamInfo/examineMainNote'/>?mainFlow="+mainFlow, "考试须知", 1200, 600 ,true);
        }

        function examineTicket(recruitFlow) {
            jboxOpen("<s:url value='/recruit/writeExamInfo/examineTicket'/>?recruitFlow="+recruitFlow, "准考证", 500, 460);
        }
        ...
        <table class="xllist" style="width: 100%;margin-top: 35px">
            ...
            <c:forEach items="${recruitInfoExts}" var="recruitInfoExt" varStatus="seq">
                <tr>
                    ...
                    <td>
                        <a href="#" onclick="examineTicket('${recruitInfoExt.recruitFlow}')" style="color: blue">准考证</a>
                        |
                        <a href="javascript:examineMainNote('${recruitInfoExt.mainFlow}')" style="color: blue">考试须知</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
