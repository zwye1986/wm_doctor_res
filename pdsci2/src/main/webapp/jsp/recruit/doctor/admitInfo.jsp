...
<head>
    ...
    <script type="text/javascript">
        ...
        function examineAdviceInfo(recruitFlow) {
            jboxOpen("<s:url value='/recruit/admitInfo/examineAdviceInfo'/>?recruitFlow="+recruitFlow, "录取通知书", 800, 600 ,true);
        }
        ...
        <table class="xllist" style="width: 100%;margin-top: 35px">
            ...
            <c:forEach items="${recruitInfoExts}" var="recruitInfoExt" varStatus="seq">
                <tr>
                    ...
                    <td>录取通知</td>
                    <td>
                        <a href="javascript:examineAdviceInfo('${recruitInfoExt.recruitFlow}')" style="color: blue">查看</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
