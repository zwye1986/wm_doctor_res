                ...
                <div style="text-align: center">
                    <form id="recruitInfoForm" name="recruitInfoForm" method="post">
                        <table class="xllist" style="margin-top: 30px">
                            ...
                            <input id="trainingSpeId" name="trainingSpeId" type="text" value="${recruitInfo.trainingSpeId}" hidden>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <input <c:if test="${currentUser.sexId eq 'Man'}">value="男"</c:if>
                                            <c:if test="${currentUser.sexId eq 'Woman'}">value="女"</c:if> class="xltext" readonly>
                                </td>
                                <th>
                            ...
                            <tr>
                                ...
                                <th>审核说明</th>
                                <td>
                                    <input class="xltext" id="auditContent" name="auditContent" value="${recruitInfo.auditContent}" readonly>
                                </td>
                            </tr>
                        </table>
