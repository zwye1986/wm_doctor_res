...
<head>
    ...
    <script type="text/javascript">
        function importInterview(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/recruit/interviewInfoManage/saveImportInterviewScore'/>";
            jboxSubmit(
                $('#excelForm'),
                url,
                function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="basic" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/recruit/interviewInfoManage/importInterview.xlsx'/>">导入模板.xlsx</a></td>
        </tr>
        <tr>
            <td colspan="2" style="color:red;">注：如原来已有面试结果，导入后会直接覆盖</td>
        </tr>
    </table>
</form>
<div style="text-align: center; margin-top: 10px;">
    <input type="button" onclick="importInterview();" value="导&#12288;入" class="search"/>
