...
<head>
    ...
    <script type="text/javascript">
        ...
        function save(){
            ...
            var url = "<s:url value='/recruit/interviewInfoManage/saveInterviewScore'/>";
        ...
        <div class="title1 clearfix" style="overflow: auto;">
            <form id="addExamInfoForm" name="addExamInfoForm"  method="post" style="position: relative;">
                ...
                <table width="100%" class="basic" >
                    <tr>
                        <th style="width: 160px">面试分数：</th>
                        <td  colspan="3">
                            <input type="text" class="validate[required,custom[number,min[0],max[100]]] xltext" id="interviewScore" name="interviewScore" value="${recruitInfoExt.interviewScore}"/>
                        </td>
                    </tr>
                </table>
