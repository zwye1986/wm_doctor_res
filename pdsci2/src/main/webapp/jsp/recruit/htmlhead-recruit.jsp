...
<c:if test="${param.font=='true'}">
    <link rel="stylesheet" type="text/css" href="<s:url value='/jsp/recruit/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
<c:if test="${param.queryFont=='true'}">
    <link rel="stylesheet" type="text/css" href="?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
<c:if test="${param.login=='true'}">
    <link rel="stylesheet" type="text/css" href="<s:url value='/jsp/recruit/css/login.css'/>"></link>
    <link rel="stylesheet" type="text/css" href="<s:url value='http://at.alicdn.com/t/font_1147370_dnhremjtvq.css'/>" />
</c:if>
<c:if test="${param.register=='true'}">
    <link rel="stylesheet" type="text/css" href="<s:url value='/jsp/recruit/css/register.css'/>"></link>
</c:if>
