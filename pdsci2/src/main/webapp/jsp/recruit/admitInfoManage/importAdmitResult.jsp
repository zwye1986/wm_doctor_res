...
<head>
    ...
    <script type="text/javascript">
        function importInterview(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/recruit/admitInfoManage/saveImportAdmitResult'/>";
            jboxSubmit(
                $('#excelForm'),
                url,
                function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="basic" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/recruit/admitInfoManage/importAdmit.xlsx'/>">报到结果导入.xlsx</a></td>
        </tr>
        <tr>
            <td colspan="2" style="color:red;">注：如原来已有报到结果，导入后会直接覆盖</td>
        </tr>
    </table>
</form>
