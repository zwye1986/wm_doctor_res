...
<head>
    ...
    <script type="text/javascript">
        ...
        function importScores(){
            var url = "<s:url value='/res/dgdhyyActivity/importDgdhyyActivityPage'/>";
            jboxOpen(url, "分数导入", 700, 250);
        }
        function del(flow){
            var url = "<s:url value='/res/dgdhyyActivity/delDgdhyyActivity'/>?recordFlow="+flow;
...
<div class="mainright">
    <div class="content">
        <div class=" clearfix">
            <div class="queryDiv">
                <form id="searchForm" action="<s:url value='/res/dgdhyyActivity/dgdhyyActivityList'/>" method="post">
            ...
            <table class="xllist">
                ...
                <c:forEach items="${dgdhyyActivityList}" var="dgdhyyActivity" varStatus="s">
                    <tr>
                        ...
                        <td nowrap=""><a style="cursor: pointer;" onclick="del('${dgdhyyActivity.recordFlow}')">[删除]</a></td>
                    </tr>
                </c:forEach>
