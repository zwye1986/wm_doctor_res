...
function importUsers(){
	...
	jboxStartLoading();
	var url = "<s:url value='/res/dgdhyyActivity/importDgdhyyActivity'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table width="100%" class="basic">
		...
		<tr>
			<th>模板文件</th>
			<td style="padding-left:10px;"><a href="<s:url value='/jsp/res/dgdhyyActivity/dgdhyyActivityTemp.xlsx'/>">活动记录导入模板.xlsx</a></td>
		</tr>
	</table>
	<br/>
	<p style="text-align: center;">
		<input type="button" onclick="importUsers();" value="活动记录导入" class="search"/>
	</p>
</form>
</div>
</div>
