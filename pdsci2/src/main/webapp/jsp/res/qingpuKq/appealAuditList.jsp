	...
	<div class="mainright">
		<div class="content">
			<div class="title1 clearfix">
				<form id="searchForm" action="<s:url value='/res/qingpuKq/appealAuditList/${roleFlag}'/>" method="post">
					...
					<c:forEach items="${kqList}" var="kq">
						...
						<tr>
							...
							<td>
								...
								<c:if test="${empty kq.teacherAgreeFlag and empty kq.headAgreeFlag and 'teacher' ne roleFlag  and !disagreeFlag}">
									<img src="<s:url value='/css/skin/${skinPath}/images/query.gif'/>" alt="待审核"/>&nbsp;${kq.teacherName}
								</c:if>
								<c:if test="${empty kq.teacherAgreeFlag and empty kq.headAgreeFlag and 'teacher' eq roleFlag}">
							...
							<td>
								...
								<c:if test="${empty kq.headAgreeFlag and empty kq.teacherAgreeFlag and 'head' ne roleFlag and !disagreeFlag}">
									<img src="<s:url value='/css/skin/${skinPath}/images/query.gif'/>" alt="待审核"/>&nbsp;${kq.headName}
								</c:if>
								<c:if test="${empty kq.headAgreeFlag and empty kq.teacherAgreeFlag and	'head' eq roleFlag}">
									<a href="javascript:save('${kq.recordFlow}','${GlobalConstant.FLAG_Y}');">同意</a> |
									<a href="javascript:save('${kq.recordFlow}','${GlobalConstant.FLAG_N}');">不同意</a>
								</c:if>
							</td>
