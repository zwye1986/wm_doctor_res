...
<script>
	function save(){
		...
		jboxConfirm("确认保存？",function(){
			var url = "<s:url value='/res/qingpuKq/saveLeave'/>";
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3" style="text-align:left;padding: 5px;">
					     <textarea placeholder="请假事由（限250字）。"  class="validate[required] validate[maxSize[250]] xltxtarea" name="doctorRemarks">${kq.doctorRemarks}</textarea>
			     	</td>
				</tr>
				<tr>
					<th>轮转科室：</th>
