...
<head>
	...
	<script type="text/javascript">
		function editKq(recordFlow){
			...
			var url = "<s:url value='/res/qingpuKq/editAppeal'/>?roleFlag=doctor&recordFlow=" + recordFlow;
...
<div class="mainright">
	<div class="content">
		<div class="title1 clearfix">
			<form id="searchForm" action="<s:url value="/res/qingpuKq/appealList"/>" method="post">
					...
					<c:forEach items="${kqList}" var="kq">
						...
						<tr>
							...
							<td>
								...
								<c:if test="${empty kq.teacherAgreeFlag and empty kq.headAgreeFlag and !disagreeFlag}">
							...
							<td>
								...
								<c:if test="${empty kq.headAgreeFlag and empty kq.teacherAgreeFlag and !disagreeFlag}">
							...
							<td>
								...
								<c:if test="${!((empty kq.teacherAgreeFlag) and (empty kq.headAgreeFlag) and (empty kq.managerAgreeFlag))}">-</c:if>
							</td>
						</tr>
					</c:forEach>
