...
<head>
    ...
    <script type="text/javascript">
        function importTargetData() {
            ...
            jboxStartLoading();
            var url = "<s:url value='/res/activityTarget/importTarget'/>";
            jboxSubmit(
                $('#excelForm'),
                url,
                function (resp) {
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="grid" style="width: 100%;margin-top: 30px">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/res/activity/target/importTarget.xlsx'/>">教学活动评价指标导入模板.xlsx</a></td>
        </tr>
    </table>
</form>
<div style="text-align: center; margin-top: 10px;">
    <input type="button" onclick="importTargetData();" value="导&#12288;入" class="btn_green"/>&#12288;
