...
<head>
    ...
    <script>
        ...
        function exportSiginList(){
            var url = "<s:url value='/res/activityQuery/exportSiginList'/>?activityFlow=${param.activityFlow}";
            jboxExp(null, url);
            jboxEndLoading();
        }
        function effectiveInfo(resultFlow,isEffective)
        {
            ...
            jboxConfirm(msg,function(){
                var url = "<s:url value='/res/activityQuery/effectiveResult'/>?resultFlow="+resultFlow+"&isEffective="+isEffective;
                jboxStartLoading();
            ...
            <table class="xllist" style="width:100%; margin-bottom: 10px;">
                <tr>
                    <td width="100%" style="text-align: right;">
                        <input type="button" onclick="exportSiginList();" class="search" value="导出签到学员"/>
                    </td>
                </tr>
            </table>
