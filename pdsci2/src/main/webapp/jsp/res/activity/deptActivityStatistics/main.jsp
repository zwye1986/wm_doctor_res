...
function toPage(page) {
	...
	jboxLoad("doctorListZi","<s:url value='/res/deptActivityStatistics/list'/>?roleFlag=${param.roleFlag}&"+$("#searchForm").serialize(),true);
}
function exportExcel(){
	var url = "<s:url value='/res/deptActivityStatistics/exportList'/>?roleFlag=${param.roleFlag}";
	jboxTip("导出中…………");
