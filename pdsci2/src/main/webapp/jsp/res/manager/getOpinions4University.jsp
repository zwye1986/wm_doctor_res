...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value='/res/liveTraining/getOpinions4University'/>" method="post">
        ...
        <table class="xllist" style="border-left: none;border-right: none;border-bottom: none;">
            ...
            <c:forEach items="${trainingOpinions}" var="trainingOpinion" varStatus="status">
                ...
                <tr>
                    <td style="text-align: left;width: 10%;border-left: 1px solid #D0E3F2;border-right: 1px solid #D0E3F2;">&nbsp;回复：</td>
                ...
                <tr>
                    ...
                    <td  colspan="3" style="text-align: left;border-left: 1px solid #D0E3F2;">
                        <div>
                            提出人：${trainingOpinion.opinionUserName}&#12288;${trainingOpinion.orgName}&#12288;
                            <span class="ass"></span> &#12288;
                            <c:if test="${empty trainingOpinion.opinionReplyContent}">
