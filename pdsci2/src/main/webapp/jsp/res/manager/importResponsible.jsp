...
<head>
    ...
    <script type="text/javascript">
        function daoRu(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/res/manager/importDiscAndResponFromExcel?type=Responsible'/>";
            jboxSubmit(
                $('#excelForm'),
                url,
                function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
    <table class="grid" style="width: 100%;">
        ...
        <tr>
            <th>模板文件</th>
            <td><a href="<s:url value='/jsp/res/manager/temeplete/importResponsible.xlsx'/>">责任导师导入模板.xlsx</a></td>
        </tr>
    </table>
</form>
