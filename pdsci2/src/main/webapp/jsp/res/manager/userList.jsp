			...
			<div class="title1 clearfix">
				<form id="searchForm" method="post" action="<s:url value='/res/manager/userList/${role}'/>">
					...
					<div class="queryDiv">
						...
						<div class="inputDiv">
							...
							<input type="text" name="sysUser.idNo" value="${param['sysUser.idNo']}" class="qtext"/>
						</div>
						<div class="inputDiv">
							<label class="qlable">状&#12288;&#12288;态：</label>
							<select name="doctorStatusId" class="qselect" >
								<option value="">全部</option>
								<option value="Training" ${param.doctorStatusId eq 'Training'?'selected':''}>在培</option>
								<option value="Graduation" ${param.doctorStatusId eq 'Graduation'?'selected':''}>结业</option>
							</select>
						</div>
						<div class="lastDiv" style="min-width: 95px;max-width: 95px;">
							<input type="button" value="查&#12288;询" class="searchInput" onclick="search();"/>
						</div>
					</div>
					<div class="funcDiv" style="min-width: 800px;max-width: 800px;">
				...
				<table class="basic" width="100%">
					<tr style="font-weight: bold;">
						...
						<td style="text-align: center;padding: 0px;width: 8%;">培训类别</td>
