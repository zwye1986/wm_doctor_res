		...
		<form id="dopsForm" style="position: relative">
			<div id="printDiv">
				<div id="title" style="width:100%;text-align: center;font-size: 15px;">
					上海市奉贤区中心医院住院医师规范化培训<br/>体格检查评分表（心脏体检）
				</div>
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td rowspan="11">心脏体格检查（60分）</td>
						<td rowspan="2">心脏视诊</td>
						<td>5</td>
						<td colspan="3">心脏视诊方法正确</td>
					...
					<tr>
						<td>6</td>
						<td colspan="3">能讲出心脏视诊主要三个内容，并能指出其部位（心前区隆起与凹陷、心尖搏动、心前区异常搏动）</td>
					...
					<tr>
						<td rowspan="3">心脏触诊</td>
						<td>5</td>
						<td colspan="3">触诊手法正确</td>
					...
					<tr>
						<td>5</td>
						<td colspan="3">能在心尖搏动区及心前区正确进行触诊</td>
					...
					<tr>
						<td>4</td>
						<td colspan="3">能提到触诊可触及震颤、心包摩擦感</td>
					...
					<tr>
						<td rowspan="3">心脏叩诊</td>
						<td>5</td>
						<td colspan="3">叩诊手法、姿势、力量正确</td>
					...
					<tr>
						<td>5</td>
						<td colspan="3">会叩心浊音界，能回答并叩出主考官提出的某肋间心浊音界</td>
					...
					<tr>
						<td rowspan="3">心脏听诊</td>
						<td>8</td>
						<td colspan="3">能正确指出心脏瓣膜各听诊区</td>
						...
						<td><input name="part14" type="text" value="${formDataMap['part14']}" class="inputText ctrlInput validate[required,custom[number],max[8],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>4</td>
						<td colspan="3">听诊顺序正确（从二尖瓣区开始肺动脉区主动脉区主动脉第二听诊区三尖瓣区，逆时针方向）</td>
					...
					<tr>
						...
						<td><input name="part16" type="text" value="${formDataMap['part16']}" class="inputText ctrlInput validate[required,custom[number],max[8],min[0]] scoreCount" style="width:90%; " style="width: 80px;"/></td>
					</tr>
					<tr>
						<td>结果提问（5分）</td>
