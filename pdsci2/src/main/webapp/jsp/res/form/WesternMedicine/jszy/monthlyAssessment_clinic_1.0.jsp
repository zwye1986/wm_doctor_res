			...
			<label></label>
				...
				<table class="basic" width="100%" >
					...
					<tr>
						...
						<td style="text-align: center;">
							<label class="inputText " id="part06"style="width: 150px;">${formDataMap['part06']}</label>
							<input  class="validate[required,custom[number]]" name="part06" hidden value="${formDataMap['part06']}" style="width: 150px;"/><br>
						</td>
					</tr>
           		  	<tr >
						<td colspan="5">
