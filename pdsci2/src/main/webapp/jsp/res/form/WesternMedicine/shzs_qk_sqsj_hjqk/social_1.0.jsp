		...
		<div class="title1 clearfix">
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					<tr>
						<td style="width: 20%;"><font color="red">*</font>获奖名称:</td>
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" style="width: 160px;" name="social_awardName" value="${formDataMap['social_awardName']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['social_awardName']}
								<input type="hidden" name="social_awardName" value="${formDataMap['social_awardName']}"/>
							</c:if>
						</td>
						<td style="width: 20%;"><font color="red">*</font>级别:</td>
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" style="width: 160px;" name="social_level" value="${formDataMap['social_level']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['social_level']}
								<input type="hidden" name="social_level" value="${formDataMap['social_level']}"/>
							</c:if>
						</td>
					</tr>
					<tr>
						...
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" style="width: 160px;" name="social_remark" value="${formDataMap['social_remark']}"/>
							</c:if>
							<c:if test="${!doctor}">
