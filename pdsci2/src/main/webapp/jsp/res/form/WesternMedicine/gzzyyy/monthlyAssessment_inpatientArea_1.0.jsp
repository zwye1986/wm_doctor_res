...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
		    $("[name='part08']").attr('disabled',false);
		...
		<form id="monthlyAssessmentForm">
			...
			<table class="basic" width="100%" >
				...
				<tr>
					...
					<td style="text-align: center; width:7%">赋分标准</td>
				...
				<tr>
					...
					<td>轮转时间</td>
					<td>20分</td>
					<td>在轮转科室全勤满分，累计缺一工作日扣2分.（病假≥10天，事假≥5天，该项不得分。累计事假≥10天，月度考核不合格）</td>
					<td style="text-align: center;">
						<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number],max[20],min[0]] scoreCount" name="part01" type="text" value="${formDataMap['part01']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr>
					<td>管床数</td>
					<td>10分</td>
					<td>病区管床≥3张、ICU≥1张，不达标不得分，不管床则月度考核不合格</td>
					<td style="text-align: center;">
						<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number],max[10],min[0]] scoreCount" name="part02" type="text" value="${formDataMap['part02']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr>
					<td>病房值班</td>
					<td>20分</td>
					<td>按各科安排参与病区值班，少值班1次扣10分（总值班数＜2次，该项不得分。孕7月后及产后1年不值夜班）</td>
					<td style="text-align: center;">
				...
				<tr>
					<td>医疗文书书写数量</td>
					<td>10分</td>
					<td>各科按大纲要求，不达标不给分</td>
					<td style="text-align: center;">
						<input style="width:90%; " class="inputText ctrlInput validate[required,custom[number],max[10],min[0]] scoreCount" name="part04" type="text" value="${formDataMap['part04']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr>
					<td>医疗文书书写质量</td>
					<td>10分</td>
					<td>出现一份乙级病历扣5分，丙级病历不得分；抽查门诊病历，有缺项、漏项的每份扣1分</td>
					<td style="text-align: center;">
				...
				<tr>
					...
					<td>按100分卷折计（闭卷考试）</td>
					<td style="text-align: center;">
						<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number],max[10],min[0]] scoreCount" name="part06" type="text" value="${formDataMap['part06']}" style="width: 150px;"/>
					</td>
				</tr>
				<tr>
					<td>出科理论考核</td>
					...
					<td>按100分卷折计（闭卷考试）</td>
					<td style="text-align: center;">
						<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number],max[10],min[0]] scoreCount" name="lilunkaohe" type="text" value="${formDataMap['lilunkaohe']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr>
					<td colspan="4" style="text-align: left">总得分</td>
					<td style="text-align: center;">
						<input style="width: 90%; " class="inputText ctrlInput validate[required,custom[number]]" name="part08" disabled type="text" value="${formDataMap['part08']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr >
					<td colspan="5">
