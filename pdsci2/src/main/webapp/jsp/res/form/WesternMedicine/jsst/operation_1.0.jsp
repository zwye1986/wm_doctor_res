...
<%--       	 			</c:if> --%>
        		...
        		<tr>
        			...
        			<td>
        				<c:if test="${doctor}">
        				<select name="operation_operRole" style="width: 164px;">
        					<option></option>
        					<option value="术者" <c:if test="${'主刀' eq formDataMap['operation_operRole']}">selected</c:if>>术者</option>
        					<option value="一助" <c:if test="${'一助' eq formDataMap['operation_operRole']}">selected</c:if>>一助</option>
        					<option value="二助" <c:if test="${'二助' eq formDataMap['operation_operRole']}">selected</c:if>>二助</option>
       					</select>
       					</c:if>
       					<c:if test="${!doctor}">
