...
//			$(this).replaceWith($('<label>'+$(this).val()+'</label>'));
		...
		$("#dblForm").find("input[name='inHosDate']").attr("onclick","");
//		$("#dblForm :file").remove();
	</c:if>
});
      ...
      <div class="content">
        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
			...
			<tr>
				<td style="width: 100px;text-align: right"><font color="red">*</font>&#12288;入院时间：</td>
				<td colspan="3">
					<input class="validate[required]" name="inHosDate" type="text" value="${formDataMap['inHosDate']}" style="width: 150px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" readonly="readonly"/>
				</td>
			</tr>
			<tr>
