      ...
      <div class="content">
        ...
        <input type="hidden" name="operUserFlow" value="${param.operUserFlow}">
   		<table class="basic" width="100%">
      		...
      		<tr>
             	<td style="width: 100px;"><font color="red">*</font>病种名称：</td>
             	<td  colspan="3">
                	<script>
	                	$(function(){
...
<!-- 	                		</div> -->
      	 			...
      	 			<div id="otherName" style="float: left;display: none;margin-left: 20px;height: 0px;overflow: visible;margin-top: -9px;">
	      	 			...
	      	 			<input type="text" name="regItem" value="${formDataMap['diseaseName']}" style="width: 160px;" class="validate[required]"/>
      	 			</div>
      	 			<c:if test="${rec.auditStatusId eq recStatusEnumTeacherAuditY.id || !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR) || param.isRead}">
             ...
             <tr>
                ...
                <td >
                    <input style="width: 160px;" class="validate[required]" name="patientName" type="text" value="${formDataMap['patientName']}" style="margin-right: 0px"/>
				</td>
				<td style="width: 100px;"><font color="red">*</font>病历号：</td>
                <td >
                    <input style="width: 160px;" class="validate[required]" name="caseNo" type="text" value="${formDataMap['caseNo']}" style="margin-right: 0px"/>
				</td>
             </tr>
              <tr>
             	<td style="width: 100px;"><font color="red">*</font>治疗措施：</td>
                <td >
                    <input style="width: 160px;" class="validate[required]" name="treatMeasure" type="text" value="${formDataMap['treatMeasure']}" style="margin-right: 0px"/>
				</td>
				<td style="width: 100px;">类型：</td>
                <td>
                   	<select style="width: 163px;" name="recType">
              ...
              <tr>
                ...
                <td >
                    <input style="width: 160px;" name="inHosDate" type="text" value="${formDataMap['inHosDate']}" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>
				</td>
                ...
                <td colspan="3">
                    <input type="file" name="file" style="${(!empty file)?'display: none;':''}"/>
				</td>
             	</tr>
              </table>
			<p align="center">
