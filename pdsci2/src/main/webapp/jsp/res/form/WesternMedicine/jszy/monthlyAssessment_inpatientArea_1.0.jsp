		...
		<form id="monthlyAssessmentForm">
			...
			<table class="basic" width="100%" >
				...
				<tr>
					...
					<td style="text-align: center;">
						<label class="inputText " id="part08" style="width: 150px;">${formDataMap['part08']}</label>
						<input  class="validate[required,custom[number]]" name="part08" hidden value="${formDataMap['part08']}" style="width: 150px;"/><br>
					</td>
				</tr>
				<tr >
					<td colspan="5">
