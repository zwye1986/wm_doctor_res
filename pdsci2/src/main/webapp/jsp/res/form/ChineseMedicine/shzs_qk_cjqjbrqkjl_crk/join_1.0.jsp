			...
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						...
						<td style="width: 20%;"><font color="red">*</font>主管医师:</td>
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="join_directorPhysician" style="width: 160px;" value="${formDataMap['join_directorPhysician']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['join_directorPhysician']}
								<input type="hidden" name="join_directorPhysician" value="${formDataMap['join_directorPhysician']}"/>
							</c:if>
						</td>
					</tr>
				</table>
