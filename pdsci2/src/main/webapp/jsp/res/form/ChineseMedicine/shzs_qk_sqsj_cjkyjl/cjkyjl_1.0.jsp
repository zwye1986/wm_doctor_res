			...
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					<tr>
						...
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" style="width: 160px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" name="social_time" value="${formDataMap['social_time']}"/>
							</c:if>
							<c:if test="${!doctor}">
