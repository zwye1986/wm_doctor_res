			...
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						...
						<td><font color="red">*</font>主管医师:</td>
						<td>
							<c:if test="${doctor}">
							...
							<c:if test="${!doctor}">
								${formDataMap['skill_directorPhysician']}
								<input type="hidden" name="skill_directorPhysician" value="${formDataMap['skill_directorPhysician']}"/>
							</c:if>
						</td>
					</tr>
