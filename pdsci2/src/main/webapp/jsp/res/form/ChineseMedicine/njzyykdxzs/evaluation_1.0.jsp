				...
				<table class="basic" width="100%" >
					...
					<tr>
						...
						<td style="text-align: center;">
								<input  class="inputText ctrlInput validate[custom[number],max[20],min[0]] scoreCount" style="width:90%; "  name="responsibility" type="text" value="${formDataMap['responsibility']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>服务态度,沟通能力</td>
						...
						<td>有效投诉一次扣5分</td>
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[10],min[0]] scoreCount"  name="attitude" type="text" value="${formDataMap['attitude']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>医德医风,廉洁行医</td>
						...
						<td>违规一次扣5分</td>
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[10],min[0]] scoreCount" name="doctor" type="text" value="${formDataMap['doctor']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>	
							<td>团结协作,遵守制度</td>
							...
							<td>违规一次扣2分</td>
							<td style="text-align: center;">
								<input style="width:90%; " class="inputText ctrlInput validate[custom[number],max[10],min[0]] scoreCount" name="unite" type="text" value="${formDataMap['unite']}" style="width: 150px;"/><br>
							</td>
					</tr>
					<tr>
						...
						<td>轮转时间每少1天扣一分</td>
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[20],min[0]] scoreCount" name="subject" type="text" value="${formDataMap['subject']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>掌握病症数量</td>
						...
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[30],min[0]] scoreCount" name="disease" type="text" value="${formDataMap['disease']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>掌握病种数量</td>
						...
						<td style="text-align: center;">
								<input style="width:90%; " class="inputText ctrlInput validate[custom[number],max[30],min[0]] scoreCount" name="diseases" type="text" value="${formDataMap['diseases']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>医疗文书书写质量</td>
						...
						<td style="text-align: center;">
							<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[30],min[0]] scoreCount" name="quality" type="text" value="${formDataMap['quality']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td>掌握轮转科室要求的基本技能</td>
						...
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[30],min[0]] scoreCount" name="skill" type="text" value="${formDataMap['skill']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						...
						<td>按100分卷折计</td>
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[25],min[0]] scoreCount" name="theoryAssessment" type="text" value="${formDataMap['theoryAssessment']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						...
						<td style="text-align: center;">
								<input style="width: 90%; " class="inputText ctrlInput validate[custom[number],max[15],min[0]] scoreCount" name="readingNotes" type="text" value="${formDataMap['readingNotes']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						...
						<td style="text-align: center;">
								<input style="width:90%; " class="inputText ctrlInput validate[custom[number],max[10],min[0]] scoreCount" name="activity" type="text" value="${formDataMap['activity']}" style="width: 150px;"/><br>
						</td>
					</tr>
					<tr>
						<td style="text-align: center;">
