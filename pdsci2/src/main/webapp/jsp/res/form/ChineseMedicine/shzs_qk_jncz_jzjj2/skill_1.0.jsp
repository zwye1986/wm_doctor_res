		...
		<div class="title1 clearfix">
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td style="width: 20%;"><font color="red">*</font>主要诊断:</td>
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="skill_mainDiagnosis" style="width: 160px;" value="${formDataMap['skill_mainDiagnosis']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['skill_mainDiagnosis']}
								<input type="hidden" name="disease_mainDiagnosis" value="${formDataMap['skill_mainDiagnosis']}"/>
							</c:if>
						</td>
						<td style="width: 20%;"><font color="red">*</font>次要诊断:</td>
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="skill_secondaryDiagnosis" style="width: 160px;" value="${formDataMap['skill_secondaryDiagnosis']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['skill_secondaryDiagnosis']}
								<input type="hidden" name="skill_secondaryDiagnosis" value="${formDataMap['skill_secondaryDiagnosis']}"/>
							</c:if>
						</td>
					</tr>
					<tr>
						...
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<label><input type="radio" name="skill_director" <c:if test="${'是' eq formDataMap['skill_director']}">checked</c:if> value="是" class="autoValue validate[required]"/>是</label>&#12288;
								<label><input type="radio" name="skill_director"  <c:if test="${'否' eq formDataMap['skill_director']}">checked</c:if> value="否" class="autoValue validate[required]" />否</label>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['skill_director']}
							</c:if>
						</td>
