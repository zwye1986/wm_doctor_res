<table class="basic" width="100%" style="margin-top: 10px;">
	...
	<tr>
		<td colspan="4">日常工作表现(日常考核)（20%)</td>
		...
		<td>20.0%</td>
		<td class="sSum">${formDataMap['cZero']*0.2}</td>
	</tr>
		<tr>
			<td  colspan="2" rowspan="2"> 常规考核（40%）</td>
			...
			<td>20.0%</td>
			<td class="sSum">${formDataMap['cTwo']*0.2}</td>
		</tr>
		<tr>
			...
			<td>20.0%</td>
			<td class="sSum">${formDataMap['cThree']*0.2}</td>
		</tr>
		<tr>
			<td rowspan="2" colspan="2">临床综合能力考核（40%）</td>
		...
		<tr>
			...
			<td>20.0%</td>
			<td class="sSum">${formDataMap['cEight']*0.2}</td>
		</tr>
		<tr>
