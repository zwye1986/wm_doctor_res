					...
					<tr>
						...
						<td colspan="2">
							<c:if test="${param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_TEACHER && empty formDataMap['internshipEvaluation_id']}">
								...
								&#12288;
								<label>
									<input type="radio" value="3" name="internshipEvaluation" <c:if test="${formDataMap['internshipEvaluation_id'] eq '3'}">checked</c:if> class="autoValue"/>
									中
								</label>
								&#12288;
								<label>
					...
					<tr>
						...
						<td colspan="2" >
							<c:if test="${param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_TEACHER && empty formDataMap['totalScore']}">
								<input type="text" class="inputText" id="totalScore" style="width: 60px;" readonly="readonly" name="totalScore" value="${formDataMap['totalScore']}"/>
							</c:if>
							<c:if test="${!empty formDataMap['totalScore']}">
								&#12288;${formDataMap['totalScore']}
								<input type="hidden" id="totalScore" name="totalScore" value="${formDataMap['totalScore']}"/>
							</c:if>
							分
						</td>
					</tr>
