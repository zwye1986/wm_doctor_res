		...
		<div class="title1 clearfix">
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						<td style="width: 14%;"><font color="red">*</font>病历号:</td>
						<td style="width: 20%;">
							<c:if test="${doctor}">
						...
						<td><font color="red">*</font>术者/助手:</td>
						<td>
							<c:if test="${doctor}">
					...
					<tr>
						...
						<td colspan="3">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="skill_remark" style="width: 160px;" value="${formDataMap['skill_remark']}"/>
							</c:if>
							<c:if test="${!doctor}">
								<label>${formDataMap['skill_remark']}</label>
							</c:if>
						</td>
					</tr>
				</table>
