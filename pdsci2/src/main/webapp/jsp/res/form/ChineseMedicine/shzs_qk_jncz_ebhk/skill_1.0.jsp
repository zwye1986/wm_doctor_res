			...
			<form id="skillForm">
				...
				<table class="basic" width="100%" style="margin-top: 10px;">
					...
					<tr>
						...
						<td style="width: 30%;">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="skill_diseaseName" style="width: 160px;" value="${formDataMap['skill_diseaseName']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['skill_diseaseName']}
								<input type="hidden" name="skill_diseaseName" value="${formDataMap['skill_diseaseName']}"/>
							</c:if>
						</td>
						...
						<td>
							...
							<c:if test="${!doctor}">
								${formDataMap['skill_superiorPhysicianName']}
								<input type="hidden" name="skill_superiorPhysicianName" value="${formDataMap['skill_superiorPhysicianName']}"/>
							</c:if>
						</td>
					</tr>
					<tr>
						<td><font color="red">*</font>转归情况:</td>
						<td colspan="3">
							<c:if test="${doctor}">
								<input class="validate[required]" type="text" name="skill_outcome" style="width: 160px;" value="${formDataMap['skill_outcome']}"/>
							</c:if>
							<c:if test="${!doctor}">
								${formDataMap['skill_outcome']}
								<input type="hidden" name="skill_outcome" value="${formDataMap['skill_outcome']}"/>
							</c:if>
						</td>
					</tr>
				</table>
