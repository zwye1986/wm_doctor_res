...
<body style="width:100%; min-width: inherit; height:100%;background-image:none; background:#fff;">
	...
	<div class="infoAudit" >
		...
		<table class="auditConfirm" border="0" width="100%" cellspacing="0" cellpadding="0">
			<caption>华中科技大学同济医学院附属同济医院&#12288;2015&#12288;届实习人员名单<span style="float: right">姓名：<input type="text"/></span></caption>
	     	 <tr><th>姓名</th><th>性别</th><th>身份证号</th><th>专业</th><th>联系方式</th></tr>
	     	 <tr>
				<td style="" width="15%">焦元同</td>
				<td >男</td>
				<td ></td>
				<td>临床医学</td>
				<td ></td>
