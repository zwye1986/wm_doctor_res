...
function daoRu(){
	...
	jboxStartLoading();
	var url = "<s:url value='/res/platform/importStudentMainExcel'/>?orgFlow=${param.orgFlow}";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		...
		<tr>
			<th>模板文件</th>
			<td><a href="<s:url value='/jsp/res/college/temeplete/importStudentMain.xlsx'/>">学员维护模板.xlsx</a></td>
		</tr>
	</table>
</form>
