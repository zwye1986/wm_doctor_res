				...
				<table class="xllist">
					...
					<c:forEach items="${doctorAbsenceList}" var="doctorAbsence">
						...
						<tr>
							...
							<td>
								<c:if test="${doctorAbsence.intervalDay+0 >= sysCfgMap['res_absence_head_day']}">
									...
									<c:if test="${isDue >= 0 && empty doctorAbsence.headAgreeFlag and	GlobalConstant.RES_ROLE_SCOPE_HEAD == resRoleScope
