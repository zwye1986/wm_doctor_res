...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/res/responsibleTeacher/doc/docWorking'/>?baseFlag=${param.baseFlag}", $("#searchForm").serialize(), false);
    }
        ...
        <form id="searchForm">
            ...
            <table style="width:100%">
                    ...
                    <td colspan="3">
                        <c:forEach items="${jsResDocTypeEnumList}" var="type">
                            <label><input type="checkbox" id="${type.id}" value="${type.id}" class="docType"
                                          name="datas" checked/>${type.name}&nbsp;</label>
                        </c:forEach>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <select name="trainingTypeId" id="trainingTypeId" class="select" style="width: 136px"
                                onchange="changeTrainSpes('1')">
                            <option value="">请选择</option>
                            <c:forEach items="${trainCategoryEnumList}" var="trainCategory">
                                <c:if test="${trainCategory.id eq 'DoctorTrainingSpe'}">
                    ...
                    <td>
                        <input type="text" id="sessionNumber" name="sessionNumber" value="${pdfn:getCurrYearByMonth()}"
                               style="width: 130px;margin-left: 0px;" class="input" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="idNo" value="${param.idNo}" class="input"
