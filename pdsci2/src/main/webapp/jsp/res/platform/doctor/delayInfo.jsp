...
function exportDelayInfo(){
    ...
    var url = "<s:url value='/res/doc/exportDelayInfo?roleFlag=${roleFlag}'/>";
    jboxTip("导出中…………");
...
<div class="mainright">
	<div class="content">
		<div class="title1 clearfix">
			<form id="searchForm" action="<s:url value="/res/doc/delayInfo?roleFlag=${roleFlag}" />" method="post">
				...
				<div class="queryDiv">
					<div class="inputDiv">
						...
						<div style="width: 0px;height: 0px;overflow: visible;float: left; position:relative;left:98px;top:35px;">
			...
			<c:forEach items="${resRecList}" var="rec">
				<tr>
					<td title="${rec.orgName}">
							${pdfn:cutString(rec.orgName,16,true,3)}
					</td>
					...
					<td title="${rec.delayreason}">
							${pdfn:cutString(rec.delayreason,10,true,3)}
					</td>
					<td>
