...
<head>
	...
	<script type="text/javascript">
		...
		function exportExl(){
			var url = "<s:url value='/res/statistics/exportExl'/>";
			jboxTip("导出中…………");
...
<div class="mainright">
	<div class="content">
		<div class=" clearfix">
			<div class="queryDiv">
			<form id="searchForm" action="<s:url value='/res/statistics/orgRegistList'/>" method="post">
			...
			<tr>
				...
				<th style="text-align: center;padding: 0px">基地代码</th>
			...
			<c:forEach items="${orgRegistList}" var="regist">
				<tr>
					<td style="text-align: center;padding: 0px">${regist["ORG_NAME"]}</td>
					<td style="text-align: center;padding: 0px">${regist["ORG_CODE"]}</td>
					...
					<td style="text-align: center;padding: 0px">${regist["ORG_ALL"]}</td>
				</tr>
			</c:forEach>
			<c:if test="${empty orgRegistList}">
			<tr>
		...
		<div style="padding-right: 40px;">
			<c:set var="pageView" value="${pdfn:getPageView(orgRegistList)}" scope="request"></c:set>
