...
<%--<script src="https://cdn.bootcss.com/bootstrap-table/1.12.1/bootstrap-table.js"></script>
    ...
    <script>
        ...
        function  toPage(page) {
            ...
            jboxStartLoading();
            jboxPostLoad("doctorListZi","<s:url value='/res/monthlyReportGlobal/doctorOutOfficeUseList'/>",$("#myOrgForm").serialize(),false);
        }
        function exportOut() {
            var data1="";
            <c:forEach items="${resDocTypeEnumList}" var="type">
            ...
            var url = "<s:url value='/res/monthlyReportGlobal/exportExcelDoctorOutOffice'/>";
            jboxTip("导出中…………");
                ...
                <form id="myOrgForm" action="<%--<s:url value='/res/monthlyReportGlobal/appUseInfo'/>--%>" method="post">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <c:forEach items="${resDocTypeEnumList}" var="type">
                                    <label><input type="checkbox" id="${type.id}"value="${type.id}"class="docType1" name="datas"  checked/>${type.name}</label>
                                </c:forEach>
                            </td>
                    ...
                    <%--<div class="queryDiv">
                        ...
                        <div class="inputDiv" style="/*min-width: 160px;max-width: 160px;*/">
                            ...
                            <c:forEach items="${resDocTypeEnumList}" var="type">
                                <input type="checkbox" id="${type.id}"value="${type.id}"class="docType" name="datas"  checked/>${type.name}
                            </c:forEach>
                        </div>
                        <div class="inputDiv" style="/*min-width: 160px;max-width: 160px;*/">
