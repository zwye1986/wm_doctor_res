...
<head>
    ...
    window._AMapSecurityConfig = {
                securityJsCode: "d3519dae924951757401a516a728a8dd",
              };
    </script>
    <script type="text/javascript" src="https://webapi.amap.com/maps?v=2.0&key=c48350620f23039d9c93be3a97d2b181"></script>
...
<div class="">
    <div class="">
        <div id="">
            <div id="mapContainer" style="width: 100%;height: 419px;">
                <input name="input_id" id="input_id" placeholder="请输入搜索地址"  maxlength="20"/>
            </div>
            <div id="panel">
            </div>
            <div style="width: 100%">
                <input name="recordFlow" hidden value="${orgAddress.recordFlow}">
                <input name="longitude" hidden value="${orgAddress.longitude}">
                <input name="latitude" hidden  value="${orgAddress.latitude}">
                <table class="xllist nofix" width="100%">
                    <tr>
                        <td style="text-align: right;width: 150px;">签到地址：</td>
                        <td style="text-align: left;"><input name="orgAddress" type="text" class="input" style="width: 80%" readonly value="${orgAddress.orgAddress}"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;width: 150px;">签到半径：</td>
                        <td style="text-align: left;"><input name="scopeLength" type="text" class="input validate[required,custom[integer]]"  value="${orgAddress.scopeLength}">米</td>
                    </tr>
                </table>
            </div>
        </div>
