...
<script type="text/javascript">
 function search(){
	...
	function exportDoctor(){
		var url = "<s:url value='/resedu/report/exportExcel'/>";
		jboxTip("导出中…………");
	...
	<div class="mainright">
		<div class="content">
			<div class="title1 clearfix">
				<form id="searchForm" method="post" action="<s:url value='/resedu/report/doctorStatistics'/>">
				...
				<table class="basic" width="100%">
					<tr>
						<th style="width: 120px;text-align: center;padding: 0;max-width: 120px;min-width: 120px;" rowspan="1">专业</th>
						<c:forEach items="${orgList}" var="org">
							<th style="width: 50px;text-align: center;padding: 0;">招录</th>
							<th style="width: 50px;text-align: center;padding: 0;">在培</th>
