       ...
       <form id="examForm">
       		<h3>一、单选题</h3>
                ...
                <span id="testResultSpan" style="display: none;">
	                ...
	                <span style="float:left;margin: 18px 20px 0 0;font-size: 15px;"><img src="<s:url value='/jsp/res/css/images/gou.png'/>"/>&nbsp;&nbsp;&nbsp;<strong class="score-num">4 题</strong>&nbsp;&nbsp;<img src="<s:url value='/jsp/res/css/images/del3.png'/>"/>&nbsp;&nbsp;&nbsp;<strong class="score-num">3 题</strong>&nbsp;&nbsp;得分：<strong class="score-num">55分</strong>&nbsp;&nbsp;<font style="color:#ff0000; padding-left:10px;">很遗憾，您没有通过此次考试！</font></span>
          		</span>
          	</form>
                ...
                <dl style="display: none;">
                    ...
                    <dd class="fl">
                    	...
                    	<input type="button" class="fb-btn fr" value="确定" onclick="checkMultiResult(this,'N');"/>
                   		<span style="display: none;"><img src="<s:url value='/jsp/res/css/images/gou.png'/>"/>&#12288;恭喜你，答对了！</span>
                    </dd>
                </dl>
