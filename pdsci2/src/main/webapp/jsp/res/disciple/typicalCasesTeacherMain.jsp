...
<head>
	...
	<script type="text/javascript">
		...
		function searchByName(){
			...
			var url ="<s:url value='/res/typicalCases/teacherMain'/>?doctorName="+encodeURIComponent(encodeURIComponent(doctorName));
			window.location.href= url;
		}
        function agreeRecordBatch(exp){
            var url = "<s:url value='/res/typicalCases/agreeRecordBatch/see?doctorFlow=${doctorFlow}'/>";
            jboxConfirm("确认审核通过所有学员所有待审核跟师医案？" , function() {
	...
	<div class="content">
		<div class="title1 clearfix">
			<div style="margin-bottom: 10px;" align="left">
				<form id="searchForm" action="<s:url value='/res/typicalCases/teacherMain'/>"
					  method="post">
			...
			<div id="base">
				<table  class="xllist">
					...
					<tr>
						...
						<th  style="text-align: center;">跟师医案</th>
					</tr>
					...
					<c:if test="${empty resStudentDiscipleTeachers}">
						<tr><td colspan="99">暂无待审核跟师医案</td></tr>
					</c:if>
				</table>
				<div>
