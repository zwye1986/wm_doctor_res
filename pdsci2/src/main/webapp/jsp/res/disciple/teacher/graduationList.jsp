...
<script type="text/javascript">
	...
	function audit(doctorFlow)
	{
		...
		var url = "<s:url value='/res/graduation/main/teacher'/>?doctorFlow="+doctorFlow;
...
<div class="mainright">
	<div class="content">
		<div width="100%" height="100%" style="margin-top: 20px">
			<form id="searchForm" action="<s:url value='/res/discipleTeacherAudit/graduationList'/>" method="post">
			...
			<table class="table" width="100%">
				...
				<c:if test="${empty list}">
					<tr><td style="text-align: center;" colspan="6">暂无待审核的结业考核情况记录表!</td></tr>
				</c:if>
			</table>
			<div>
