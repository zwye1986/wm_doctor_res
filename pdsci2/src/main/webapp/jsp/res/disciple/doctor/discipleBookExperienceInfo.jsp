    ...
    <script type="text/javascript">
        ...
        function submitNotes(flag) {
            ...
            if ("${roleScope}" == "disciple") {
                var tent = $("#auditContent").val().trim();
                if (!tent) {
        ...
        function agreeRecordBatch(exp){
            ...
            jboxConfirm("确认审核通过该学员所有待审核医籍学习体会？" , function() {
        ...
        <div style="margin-top: 10px;width: 100%;">
            <div style="width: 28%;margin-bottom: 40px; float: left">
                <div class="index_title" style="height: 50px;width: 100%;">
                    <p>
                        <span style="float: left;margin-top: 10px;">经典医籍学习体会:</span>
                        <c:if test="${roleScope eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
                            <input class="btn_blue" style="float: right" type="button" value="添加学习体会"
                                   onclick="editNotes()"/>
                        </c:if>
                    </p>
                </div>
                <div style="height: 800px;width: 100%;margin-bottom: 20px;border:1px solid #D0E3F2;overflow:auto;">
                    ...
                    <c:forEach items="${resDiscipleNoteInfoList}" var="noteInfo">
                        ...
                        <div class="noteItems" style="width: 100%;padding-bottom: 10px;padding-top: 10px;<c:if
                                test="${noteInfoWithBLOBs.recordFlow eq noteInfo.recordFlow}">background: #D0E3F2;</c:if>"
                             onclick="shouInfo('${noteInfo.recordFlow}','${noteInfo.doctorFlow}')">
                            <p>学习时间：<span
                                    name="studyStartDate">${noteInfo.studyStartDate} 至 ${noteInfo.studyEndDate}</span>&#12288;&#12288;<span
            ...
            <div style="width: 65%;margin-left: 20px;margin-bottom: 40px; float: left">
                    ...
                    <div id="operateBtn"
                        ...
                        <c:if test="${(roleScope eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR)}">
                            ...
                            <p id="editTip" style="padding-top: 3px;" class="red" style="<c:if test="${noteInfoWithBLOBs.auditStatusId eq 'Apply' or noteInfoWithBLOBs.auditStatusId eq 'UnQualified'}">display: none;</c:if>">
                                （每年撰写1篇${(empty sysCfgMap['zy_gsxd_length'])?'1000':sysCfgMap['zy_jdxx_length']}字以上中医典籍学习心得）
                            </p>
                        </c:if>
                ...
                <div style="height: 800px;width: 100%;margin-bottom: 20px;border:1px solid #D0E3F2;overflow:auto;">
                    ...
                    <form id="noteInfoForm" method="post" enctype="multipart/form-data">
                        ...
                        <div id="noteInfos"
                             style="<c:if
                                     test="${empty resDiscipleNoteInfoList or (empty noteInfoWithBLOBs)}">display: none;</c:if>margin-bottom: 20px">
                            <div style="margin-bottom: 10px">
                                <p style="margin:20px auto auto 30px">
                                    ...
                                    <input type="text" name="studyStartDate" value="${noteInfoWithBLOBs.studyStartDate}"
                                           ...
                                           readonly="readonly"/>——<input type="text" name="studyEndDate"
                                                                           value="${noteInfoWithBLOBs.studyEndDate}"
                                                                           class="inputText ctime validate[required]"
                                                                           onClick="WdatePicker({dateFmt:'yyyy年MM月dd日'})"
                                                                           readonly="readonly"/>
                                </p>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <textarea class="xltxtarea validate[required]"
                                                  ...
                                                  style="height: 250px"
                                                  name="bookContent">${noteInfoWithBLOBs.bookContent}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        心得体会（要求理论联系实际、有分析。不少于${(empty sysCfgMap['zy_gsxd_length'])?'1000':sysCfgMap['zy_jdxx_length']}字）
        ...
        <div id="addNoteInfos" style="margin-bottom: 20px">
            <div style="margin-bottom: 10px">
                <p style="margin:20px auto auto 30px">
                    ...
                    <input type="text" name="studyEndDate" class="inputText ctime validate[required]"
                           onClick="WdatePicker({dateFmt:'yyyy年MM月dd日'})" readonly="readonly"/>
                </p>
            </div>
            <table class="basic" width="90%" style="margin-left: 30px">
                ...
                <tr>
                    <td colspan="4">
                        著作名称、读书篇数
                        <textarea class="xltxtarea validate[required]" style="height: 250px" name="bookContent"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        心得体会（要求理论联系实际、有分析。不少于${(empty sysCfgMap['zy_gsxd_length'])?'1000':sysCfgMap['zy_jdxx_length']}字）
                                <textarea class="xltxtarea" id="experienceContent" style="height: 250px"
