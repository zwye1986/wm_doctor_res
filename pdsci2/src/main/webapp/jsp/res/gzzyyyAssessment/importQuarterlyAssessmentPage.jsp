...
function importUsers(){
	...
	jboxStartLoading();
	var url = "<s:url value='/res/gzzyyyAssessment/importQuarterlyAssessment'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table width="100%" class="basic">
		...
		<tr>
			<th>模板文件</th>
			<td style="padding-left:10px;"><a href="<s:url value='/jsp/res/gzzyyyAssessment/quarterAssessmentTemp.xlsx'/>">成绩导入模板.xlsx</a></td>
		</tr>
	</table>
	<br/>
