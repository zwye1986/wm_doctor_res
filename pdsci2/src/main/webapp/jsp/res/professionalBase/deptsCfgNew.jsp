...
<div style="overflow: auto;height: 350px">
	<table class="grid">
		<tr>
			...
			<th style="text-align: left;padding-left:5px;">
				<form id="searchForm" action='<s:url value="/res/ProfessionalBase/deptsCfgNew"/>'>
				<select name="resTrainingSpeId" class="select resTrainingSpeId" onchange="search()">
		...
		<tr>
			...
			<td>
				<div style="text-align: left;margin: 5px">					
					<input type="text" class="input" id="fuzzyQuery" placeholder="关键字检索" onkeyup="searchdept(this);">
				</div>
	...
	<div style="margin: 15px;text-align: center">
		<button class="btn_green" onclick="save();">保&#12288;存</button>
		<button class="btn_green" onclick="jboxClose();">关&#12288;闭</button>
	</div>
</body>
</html>