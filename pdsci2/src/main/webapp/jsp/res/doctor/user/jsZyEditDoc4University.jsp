        ...
        <div class="title1 clearfix" style="padding:0; ">
            <form id="resDoctor" style="position: relative;">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <input hidden="hidden" name="doctorTypeId" value="Graduate">
                        <input hidden="hidden" name="workOrgId" value="${workOrgId}">
                        <input hidden="hidden" name="workOrgName" value="${workOrgName}">
                        <th>
...
//								selects : ["province", "city", "area"],
                ...
                <table id="rotationInfo" style="width:100%;">
                    ...
                    <tr>
                        <c:if test="${GlobalConstant.USER_LIST_GLOBAL eq param.roleFlag||GlobalConstant.USER_LIST_UNIVERSITY eq role}">
                        ...
                        <th><font color="red">*</font><span class="trainNameSpan">对应</span>专业：</th>
                        <td>
                    ...
                    <tr>
                        <c:if test="${!empty applicationScope.sysCfgMap['res_disciple_role_flow']}">
                            ...
                            <th><c:if test="${role ne 'university'}"><font color="red">*</font></c:if>师承老师：</th>
                            <td>
                                <input id="orgSel" class="toggleView <c:if test="${role ne 'university'}">validate[required]</c:if>" type="text"
