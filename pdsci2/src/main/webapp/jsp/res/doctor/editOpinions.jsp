    ...
    <script type="text/javascript">
        function save(){
            jboxConfirm("确认保存？" , function(){
                var url = "<s:url value='/res/liveTraining/saveOpinions'/>";
...
<div class="mainright">
    <div class="content">
        <form id="addForm">
            ...
            <tr>
                <td>
                    <textarea name="opinionUserContent" style="width: 100%;height: 130px">${trainingOpinion.opinionUserContent}</textarea>
                </td>
            </tr>
        </form>
