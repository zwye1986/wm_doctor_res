...
<head>
	...
	<script type="text/javascript">
		...
		function grade(recTypeName,recTypeId,recFlow){
			jboxOpen("<s:url value='/res/teacher/grade'/>?roleFlag=${roleFlag}&recTypeId="+recTypeId+"&recFlow="+recFlow,
					recTypeName,900,500);
		}
...
<div class="mainright">
	<div class="content">
		<div class="title1 clearfix">
			<form id="searchForm" action="<s:url value="/res/doc/viewEvaluation/${roleFlag}"/>" method="post">
