    ...
    <script type="text/javascript">
        ...
        function save(){
            ...
            jboxConfirm(title, function(){
                ...
                var url = "<s:url value='/xjgl/student/course/saveStudentCourse'/>?studentPeriod=${param.period}&userFlow=${param.userFlow}&replenishFlag=${GlobalConstant.FLAG_Y}";
                jboxPostJson(url,
                ...
                <c:if test="${courseType.id == 'OptionalNeed' || courseType.id == 'Public' }">
                    <c:forEach items="${resultMap['courseTypeMajorMap'][courseType.id]}" var="courseMajorExt" varStatus="status">
                        ...
                        <tr onclick="chooseCourse('${course.courseFlow}','tr');" style="cursor: pointer;">
                            ...
                            <td><input type="checkbox" name="degreeCourseFlag" onclick="calculate();"/></td>
                            <td>
