...
<div style="text-align:center;font-weight:600;margin-bottom:20px;">南方医科大学学业奖学金申请审批表</div>
<table class="custom" style="width:100%;">
    ...
    <tr>
        <td style="font-weight:600;">导师<br>意见</td>
        ...
        <td colspan="6" style="height:250px;text-align:left;">
            <div style="width:100%;height:100%;">
                <div style="padding:20px 10px 0px 10px;line-height:35px;">
                    &#12288;&#12288;经评审，并在本单位内公示<input type="text" style="text-align:center;width:50px;border:0px;border-bottom:1px solid black;" value="${scholarship.workDay}">个工作日，无异议，本单位申报该同学获得<input type="text" style="text-align:center;width:50px;border:0px;border-bottom:1px solid black;font-size:16px;" value="${fn:substring(scholarship.applyLevel,0,1)}">等学业奖学金。现报请研究生国家奖学金评审领导小组审定。
                </div>
    ...
    <tr>
        ...
        <td colspan="6" style="height:250px;text-align:left;">
            <div style="width:100%;height:100%;">
                <div style="padding:20px 10px 0px 10px;line-height:35px;">
                    &#12288;&#12288;经审核，并在本单位公示<input type="text" style="text-align:center;width:50px;border:0px;border-bottom:1px solid black;" value="${scholarship.workDay}">个工作日，无异议，现批准该同学获得<input type="text" style="text-align:center;width:50px;border:0px;border-bottom:1px solid black;font-size:16px;" value="${fn:substring(scholarship.applyLevel,0,1)}">等学业奖学金。
                </div>
