...
<head>
    ...
    <script type="text/javascript">
        ...
        function addInfo(userFlow){
            ...
            var url = "<s:url value='/xjgl/secondaryOrg/addSecondaryAdmin?userFlow='/>"+userFlow;
            jboxOpen(url, title,600,360,true);
        }
        function resetPwd(userFlow){
            jboxConfirm("重置密码之后为：gzykdx@yjs！", function(){
                var url = "<s:url value='/xjgl/secondaryOrg/resetPwd?userFlow='/>"+userFlow;
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/xjgl/secondaryOrg/secondaryOrgList"/>" method="post">
