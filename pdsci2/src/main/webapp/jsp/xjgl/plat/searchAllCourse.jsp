...
<div class="mainright">
	<div class="content">
		<form id="myForm" action="<s:url value='/xjgl/course/manage/searchAllCourse'/>" method="post">
		...
		<c:if test="${!gzFlag}">
			<table class="basic" style="width: 100%;margin: 10px 0px;">
				<tr><td style="text-align:center;"><font color="red" size="4">需跨专业、跨层次选课的同学，请于${param.year}年9月12日12：00前至培养科登记</font></td></tr>
			</table>
		</c:if>
