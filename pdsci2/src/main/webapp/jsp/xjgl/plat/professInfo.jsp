...
function toMove(type,round){
	...
	<%--$(".cur").removeClass("cur").each(function(){--%>
	  ...
	  <%--var url="<s:url value='/xjgl/majorCourse/save'/>?courseFlow="+courseFlow+"&majorId="+majorId+"&courseTypeId="+type+"&planYear="+year;--%>
...
//		courseHash[courseFlow]=courseArrayTemp;
		<%--var url="<s:url value='/xjgl/majorCourse/delCourseMajor'/>?courseFlow="+courseFlow+"&majorId="+majorId+"&planYear="+year;--%>
		<%--jboxPost(url,null,function(resp){--%>
			<%--loadCourseList();--%>
			<%--loadCourssMajorTb(majorId);--%>
		<%--},null,true);--%>
...
function loadCourseList(){
	...
	var url = "<s:url value='/xjgl/majorCourse/searchCourseJson2'/>?majorId="+majorId+"&year="+year;
...
function loadCourssMajorTb(majorId){
	var url="<s:url value='/xjgl/majorCourse/loadCourseMajorTb'/>?majorId="+majorId+"&year="+year;
...
//	delete courseHash[courseFlow];
	<%--var url="<s:url value='/xjgl/majorCourse/save'/>?majorId="+majorId+"&courseFlow="+courseFlow+"&planYear="+year;--%>
...
//				"planYear":year,
		...
		var url = "<s:url value='/xjgl/majorCourse/doSave'/>";
