...
<head>
    ...
    <script type="text/javascript">
        function save(){
            ...
            $("#orgName").val(orgText);
            jboxPost("<s:url value='/xjgl/secondaryOrg/saveSecondaryAdmin'/>", $("#myForm").serialize(), function (resp) {
        ...
        <form id="myForm">
            ...
            <table class="basic" style="width: 100%;margin: 10px 0px;">
                <tr>
                    ...
                    <td style="width:60%;">
                        <input type="text" class="validate[required]" name="userCode" value="${sysUser.userCode}" ${!empty param.userFlow?"disabled":""} style="width:141px;"/>
                    </td>
                </tr>
                <tr>
