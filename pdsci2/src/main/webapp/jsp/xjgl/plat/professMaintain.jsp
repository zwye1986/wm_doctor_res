...
function edit(majorId){
	...
	var url = "<s:url value='/xjgl/majorCourse/edit'/>?majorId="+majorId+"&year="+year+"&editFlag=Y";
...
function add(){
	...
	var url = "<s:url value='/xjgl/majorCourse/edit'/>?year="+year;
	var iframe ="<iframe name='jbox-message-iframe' id='jbox-message-iframe' width='100%' height='"+h+"' marginheight='0' marginwidth='0' frameborder='0' scrolling='auto' src='"+url+"'></iframe>";
	jboxMessager(iframe,'专业课程维护',w,h,null,true);
}
function clearQuote(){
...
<div class="mainright">
	...
	<table style="width: 100%;margin: 10px 0px;border: none;">
		<tr>
			<td style="border: none;line-height: 260%;">
	  			<form id="recSearchForm" method="post" action="<s:url value='/xjgl/majorCourse/list'/>">
	...
	<div style="display: none;" id="quote">
		...
		function recommend(){
		 ...
		 var url = "<s:url value='/xjgl/majorCourse/saveRecommendData'/>?planYear="+year+"&targetYear=${year}";
		...
		function delRecommend(){
		 ...
		 var url = "<s:url value='/xjgl/majorCourse/delRecommendData'/>?planYear="+year;
