...
function edit(flow){
	jboxStartLoading();
	var url= "<s:url value='/xjgl/user/userCertificateInfo'/>?userFlow="+flow;
...
function certificatInfo(userFlow){
	...
	jboxOpen("<s:url value='/xjgl/user/certificateDetail?roleFlag=school&certificateType='/>"+$('#certificateType').val()+"&userFlow="+userFlow ,"证书信息",700, (window.screen.height) * 0.65);
}
//查询
function search(){
	if($("#orgName").val()!=""){
...
<div class="mainright">
	<div class="content">
		<form id="searchForm" action="<s:url value="/xjgl/user/certificate"/>" method="post">
				...
				<td style="border: none;">
					 <input id="currentPage" type="hidden" name="currentPage" value=""/>
						<div>
							...
							<div>
								&#12288;
								选择证明：<select id="certificateType" style="width:141px" name="certificateType">
									<option></option>
									<option value="1">学位证明</option>
									<option value="2">毕业证明</option>
		...
		<div class="resultDiv">
			<table class="basic" width="100%">
				...
				<td style="text-align: center;padding: 0px;width:120px;">操作</td>
			</tr>
			<c:forEach items="${eduUserList}" var="eduUser">
				...
				<tr>
					...
					<td style="text-align: center;padding: 0px;">
						<a onclick="edit('${eduUser.userFlow}');" style="cursor: pointer;color: blue;">
							<c:out value="查看"/>
						</a>
						<a onclick="certificatInfo('${eduUser.userFlow}');" style="cursor: pointer;color: blue;">
							<c:out value="查看证明"/>
						</a>
					</td>
				</tr>
