...
<div class="mainright">
    <div class="content">
        <c:if test="${param.flag eq 'xj'}">
            <table class="basic" style="width: 100%; background-color: white;">
                <tr>
                    ...
                    <div class="spreadOneThree">
                        <form id="spreadOneThreeForm">
                            <table class="basic" style="width:100%; margin-top: 3px; margin-bottom: 30px;">
                                ...
                                <tr>
                                    <th style="width:20%"><span >所属党支部：</span></th>
                                    <td colspan="3">
                    ...
                    <div class="spreadOneFive">
                        <table class="basic" style="width:100%; margin-top: 3px; margin-bottom: 30px;">
                            <tr>
                                ...
                                <th style="width:20%;"><span >实收总额：</span></th>
                                <td style="width:30%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${extInfoForm.isFeeComplete eq 'Y'}">是</c:if>
                                    <c:if test="${extInfoForm.isFeeComplete eq 'N'}">否</c:if>
                                </td>
                            </tr>
                            <tr>
                                <th><span >档案是否已到齐：</span></th>
                                <td>
                                    <c:if test="${extInfoForm.isArchivesComplete eq 'Y'}">是</c:if>
                                    <c:if test="${extInfoForm.isArchivesComplete eq 'N'}">否</c:if>
                                </td>
                                <th></th>
                                <td></td>
                            </tr>
                    ...
                    <%--<table class="basic" style="width:100%;">--%>
                        <%--<tr>--%>
                            <%--<th style="text-align:left;line-height:27px;">&#12288;就业信息--%>
                                <%--<span style="float:right;margin-right:118px;line-height:27px;color:blue;cursor:pointer;" onclick="workCheck()">查看</span>--%>
                            <%--</th>--%>
                        <%--</tr>--%>
                    <%--</table>--%>
