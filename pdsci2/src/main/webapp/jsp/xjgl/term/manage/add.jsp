	...
	<script type="text/javascript">
		...
		function add(courseFlow){
			...
			jboxConfirm('确认保存?',function(){
					var url="<s:url value='/xjgl/term/manage/saveTerm'/>";
			...
			<form  id="form" method="post">
				<table class="basic" style="width: 100%;margin: 10px 0px;">
					...
					<tr>
						...
						<td style="text-align: left;">
							<select class="validate[required]" <c:if test="${param.isEdit eq GlobalConstant.FLAG_Y}">disabled="disabled"</c:if> name="gradeTermId" style="width: 204px;" onchange="setTime(this.value)">
