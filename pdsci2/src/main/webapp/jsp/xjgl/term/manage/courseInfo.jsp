...
<script type="text/javascript">
	function submitCourse(){
		...
		var url = "<s:url value='/xjgl/student/course/submitCourse'/>?userFlow=${param.userFlow}&recordFlow=${param.recordFlow}&status="+status+"&flag=${param.flag}";
		jboxPost(url, null,
			function(resp){
				...
				<tr>
					...
					<td style="text-align: center;">
						<c:forEach items="${dictTypeEnumXjCourseTypeList}" var="courseType">
							<c:if test="${course.courseTypeId==courseType.dictId}">${courseType.dictName}</c:if>
						</c:forEach>
					</td>
				</tr>
				<tr>
