        ...
        <form>
            ...
            <table class="basic" style="width:100%; margin-top:3px; margin-bottom:30px;">
                ...
                <tr>
                    ...
                    <td>
                        <span>
                            <c:if test="${not empty paper.periodicalPicUrl}">
                                [<a href="${sysCfgMap['upload_base_url']}/${paper.periodicalPicUrl}" target="_blank">查看图片</a>]&nbsp;
                            </c:if>
                        ...
                        <div id="periodicalPicUrlDiv" hidden="hidden">
                            ...
                            <input type="button" class="search" onclick="uploadImage('periodicalPicUrl');" value="上传图片">
                ...
                <tr>
                    ...
                    <td>
                        <span>
                            <c:if test="${not empty paper.paperPicUrl}">
                                [<a href="${sysCfgMap['upload_base_url']}/${paper.paperPicUrl}" target="_blank">查看图片</a>]&nbsp;
                            </c:if>
                        ...
                        <div id="paperPicUrlDiv" hidden="hidden">
                            ...
                            <input type="button" class="search" onclick="uploadImage('paperPicUrl');" value="上传图片">
