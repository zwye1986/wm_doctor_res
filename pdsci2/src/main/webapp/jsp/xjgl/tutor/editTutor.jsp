    ...
    <script type="text/javascript">
        ...
        function delInfo(recordFlow,tabFlag){
            jboxConfirm("确认删除"+(tabFlag=="paper"?"论文":"课题")+"信息？", function(){
                var url = "<s:url value='/xjgl/tutor/delInfo?recordFlow='/>"+recordFlow+"&tabFlag="+tabFlag;
        ...
        function editInfo(obj,tabFlag){
            var url="<s:url value='/xjgl/tutor/showEditTopicOrPaper'/>?flow="+obj+"&tabFlag="+tabFlag;
        ...
        function uploadFile(name) {
            ...
            $.ajaxFileUpload({
                url: "<s:url value='/xjgl/tutor/fileUpload?tutorFlow=${tutor.doctorFlow}'/>",
                secureuri: false,
                fileElementId: name,
                dataType: 'json',
                success: function (data) {
