...
<head>
    ...
    <script type="text/javascript">
        ...
        function uploadImage(name,flag) {
            ...
            $.ajaxFileUpload({
                url: "<s:url value='/xjgl/tutor/imageUpload?tutorFlow=${tutor.doctorFlow}&identifyFlag='/>"+flag,
                secureuri: false,
                fileElementId: name,
                dataType: 'json',
        ...
        function saveTutor(obj){
            ...
            jboxPost("<s:url value='/xjgl/tutor/saveTutor'/>", form.serialize(), function (obj) {
    ...
    <form>
        ...
        <div style="line-height:20px;font-size:16px;color:grey;padding:5px 0px 5px 0px;">&#12288;&#12288;请填写本人承担的科研课题相关信息（要求本人为课题负责人），导师资格审核工作将以此信息为准。每项课题需同时提供课题相关的各类资料证明照片，包括：【1、项目合同书首页；2、课题组成员签字页；3、含项目资助经费页面；4、含项目进度内容页面（项目起始时间）；5、项目主管部门盖章页】，每张图片文件大小不能超过2M（2048K）。本年度12月31日前结题的课题经费不纳入统计范围。《国家自然科学基金资助项目》只需上传资助计划书首页即可。</div>
            ...
            <tr>
                ...
                <td>
                    <span>
                        <c:if test="${not empty topic.contractPicUrl}">
                            [<a href="${sysCfgMap['upload_base_url']}/${topic.contractPicUrl}" target="_blank">查看图片</a>]&nbsp;
                        </c:if>
                    ...
                    <div id="contractPicUrlDiv" hidden="hidden">
                        ...
                        <input type="button" class="search" onclick="uploadImage('contractPicUrl');" value="上传图片">
            ...
            <tr>
                ...
                <td>
                    <span>
                        <c:if test="${not empty topic.memberPicUrl}">
                            [<a href="${sysCfgMap['upload_base_url']}/${topic.memberPicUrl}" target="_blank">查看图片</a>]&nbsp;
                        </c:if>
                    ...
                    <div id="memberPicUrlDiv" hidden="hidden">
                        ...
                        <input type="button" class="search" onclick="uploadImage('memberPicUrl');" value="上传图片">
            ...
            <tr>
                ...
                <td>
                    <span>
                        <c:if test="${not empty topic.fundsPicUrl}">
                            [<a href="${sysCfgMap['upload_base_url']}/${topic.fundsPicUrl}" target="_blank">查看图片</a>]&nbsp;
                        </c:if>
                    ...
                    <div id="fundsPicUrlDiv" hidden="hidden">
                        ...
                        <input type="button" class="search" onclick="uploadImage('fundsPicUrl');" value="上传图片">
            ...
            <tr>
                ...
                <td>
                    <span>
                        <c:if test="${not empty topic.schedulePicUrl}">
                            [<a href="${sysCfgMap['upload_base_url']}/${topic.schedulePicUrl}" target="_blank">查看图片</a>]&nbsp;
                        </c:if>
                    ...
                    <div id="schedulePicUrlDiv" hidden="hidden">
                        ...
                        <input type="button" class="search" onclick="uploadImage('schedulePicUrl');" value="上传图片">
            ...
            <tr>
                ...
                <td>
                    <span>
                        <c:if test="${not empty topic.sealPicUrl}">
                            [<a href="${sysCfgMap['upload_base_url']}/${topic.sealPicUrl}" target="_blank">查看图片</a>]&nbsp;
                        </c:if>
                    ...
                    <div id="sealPicUrlDiv" hidden="hidden">
                        ...
                        <input type="button" class="search" onclick="uploadImage('sealPicUrl');" value="上传图片">
