...
<head>
    ...
    <script type="text/javascript">
        function save(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/xjgl/secondaryOrg/saveStudentGrade'/>";
        ...
        function chooseCourse(){
            ...
            var url = "<s:url value='/xjgl/secondaryOrg/resultSun'/>?courseCode="+courseCode+"&studentPeriod="+studentPeriod+"&sid="+sid;
        ...
        function exportExcle(){
            ...
            var studentPeriod= $("input[name='studentPeriod']").val();
            var sid= $("input[name='sid']").val();
            var url = "<s:url value='/xjgl/secondaryOrg/expExcel'/>?courseCode="+courseCode+"&studentPeriod="+studentPeriod+"&sid="+sid;
            $("#myForm").attr("action",url);
            $("#myForm").submit();
            jboxEndLoading();
        }
        ...
        <form id="myForm">
            <table class="basic" style="width: 100%;margin-bottom: 5px;margin-top: 0px;">
                <tr>
                    <td>
                        &nbsp;
                        课程名称：[${course.courseCode }]${course.courseName }
                        &#12288;
