...
<head>
    ...
    <script type="text/javascript">
        function daoRu(){
            ...
            jboxStartLoading();
            var url = "<s:url value='/xjgl/paper/importDefenceFromExcel'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function(resp){
        ...
        <tr>
            ...
            <td>
                <c:if test="${param.isReplenish ne 'Y'}">
                    <a href="<s:url value="/jsp/xjgl/defence/importDefenceTemp1.xlsx"/>">答辩申请信息模板.xls</a>
                </c:if>
                <c:if test="${param.isReplenish eq 'Y'}">
                    <a href="<s:url value="/jsp/xjgl/defence/importDefenceTemp.xlsx"/>">补授学位信息模板.xls</a>
                </c:if>
            </td>
        </tr>
    </table>
