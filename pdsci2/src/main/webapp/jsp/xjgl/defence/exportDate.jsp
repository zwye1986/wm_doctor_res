...
<head>
    ...
    <script type="text/javascript">
        ...
        function expExcel(){
            var url = "<s:url value='/xjgl/paper/expUpDate'/>";
            jboxTip("导出中…………");
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/xjgl/paper/exportDate"/>" method="post">
        ...
        <table class="xllist" style="width:100%;">
            ...
            <c:forEach items="${defenceList}" var="defence" varStatus="i">
                <tr>
                    ...
                    <td>${defence.tutorPhone}${!empty defence.tutorFlow && !empty defence.twoTutorFlow?'，':''}${defence.twoTutorPhone}</td>
                </tr>
            </c:forEach>
