...
<head>
    ...
    <script type="text/javascript">
        ...
        function save(statusId){
            ...
            jboxPostJson("<s:url value='/xjgl/paper/saveSchedule?recordFlow=${defence.recordFlow}&scheduleFlag='/>"+statusId+"&defenceBeginTime="+$(".defenceBeginTime").val()+"&defenceEndTime="+$(".defenceEndTime").val()
