...
<head>
    ...
    <script type="text/javascript">
        function editApply(recordFlow,flag){
            ...
            var url = "<s:url value='/xjgl/paper/editDefence?recordFlow='/>"+recordFlow+"&viewFlag="+flag+"&isReplenish=${isReplenish}";
            jboxOpen(url, title,800,460);
        }
        function delInfo(recordFlow){
            jboxConfirm("确认删除答辩申请？", function(){
                var url = "<s:url value='/xjgl/paper/delDefence?recordFlow='/>"+recordFlow;
        ...
        function expExcel(){
            var url = "<s:url value='/xjgl/paper/expUserExcel'/>";
            jboxTip("导出中…………");
