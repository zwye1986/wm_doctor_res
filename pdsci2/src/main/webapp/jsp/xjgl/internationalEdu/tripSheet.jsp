...
<head>
    ...
    <script type="text/javascript">
        ...
        function upFile(recordFlow){
            jboxOpen("<s:url value='/xjgl/abroadApply/showUploadFile'/>?recordFlow="+recordFlow+"&roleFlag=${param.roleFlag}","编辑",500,180);
        }
        ...
        function save(){
            ...
            jboxPostJson("<s:url value='/xjgl/abroadApply/saveTripInfo'/>", JSON.stringify(jsonArry), function (obj) {
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/xjgl/abroadApply/showTripInfo"/>" method="post">
