...
<head>
    ...
    <script type="text/javascript">
        ...
        function editInfo(recordFlow){
            jboxOpen("<s:url value='/xjgl/abroadApply/editAbroadApply'/>?recordFlow="+recordFlow+"&roleFlag=${param.roleFlag}","编辑",960,600);
        }
        function upFile(recordFlow,type){
            jboxOpen("<s:url value='/xjgl/abroadApply/showUploadFile'/>?recordFlow="+recordFlow+"&roleFlag=${param.roleFlag}&type="+type,"编辑",500,180);
        }
        ...
        function editCost(recordFlow){
            jboxOpen("<s:url value='/xjgl/abroadApply/showEditSheet'/>?recordFlow="+recordFlow+"&roleFlag=${param.roleFlag}&formType=${param.formType}","编辑",900,500);
        }
        ...
        function delTrip(recordFlow){
            var url = "<s:url value='/xjgl/abroadApply/delTrip'/>?recordFlow="+recordFlow;
        ...
        function delInfo(recordFlow){
            var url = "<s:url value='/xjgl/abroadApply/delAbroadApply'/>?recordFlow="+recordFlow;
