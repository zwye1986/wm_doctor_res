...
<head>
    ...
    <script type="text/javascript">
        function doSave(){
            ...
            var url = "<s:url value='/xjgl/partyBranch/saveVoteInfo'/>";
            ...
            <table class="xllist" style="width:100%;">
                ...
                <tr>
                    <td style="width: 45%;">
                        ...
                        <c:forEach items="${userList}" var="user">
                            <div><a style="cursor: pointer;" onclick="clickOn(this);" userFlow="${user.userFlow }" partyBranchName1="${user.partyBranchName }">
                                ${user.userName }</a></div>
                        </c:forEach>
                        </div>
                    </td>
