...
<script type="text/javascript">
	...
	function addInfoAudit(courseFlow){
		var url = "<s:url value='/xjgl/teachingGroup/gradeAuditOption?courseFlow='/>"+courseFlow+"&roleFlag=adminAudit";
	...
	function loadCourseList(){
		...
		var url = "<s:url value='/xjgl/majorCourse/searchCourseJson?planYear='/>"+$("[name='courseSession']").val();
	...
	function batchAuditOpt(){
		...
		jboxConfirm("确认一键审核通过勾选信息？", function(){
			var url = "<s:url value='/xjgl/teachingGroup/auditAll?courseCodeList='/>"+courseCodeList;
...
<div class="mainright">
	<div class="content">
		<form id="searchForm" action="<s:url value="/xjgl/teachingGroup/gradeAuditManage"/>" method="post">
