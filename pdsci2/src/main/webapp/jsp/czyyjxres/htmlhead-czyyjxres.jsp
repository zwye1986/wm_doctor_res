...
<link rel="shortcut icon" href="<s:url value='/jsp/czyyjxres/czyy.ico'/>" />
...
<c:if test="${param.font=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/czyyjxres/css/step.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/czyyjxres/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
...
<c:if test="${param.register=='true'}">
	<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/czyyjxres/css/style.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
