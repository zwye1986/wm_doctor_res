<script type="text/javascript">
    ...
    function search(){
        ...
        jboxPostLoad("listDiv","<s:url value='/czyyjxres/hospital/queryStuList?isQuery=Y'/>",$('#auditForm').serialize(),true);
    }
    ...
    function exportInfo(){
        jboxExp($('#auditForm'),"<s:url value='/czyyjxres/hospital/exportQueryStu'/>");
    }
    ...
    function auditInfo(userFlow,batchId,isHide,isForeign){
        ...
        if(isForeign =='Y'){
            jboxOpen("<s:url value='/czyyjxres/doctor/getsingupinfoaudit'/>?userFlow="+userFlow+"&batchId="+batchId+"&isHide="+isHide+"&isForeign="+isForeign,"User Infomations",1000,550);
        }
        jboxOpen("<s:url value='/czyyjxres/doctor/getsingupinfoaudit'/>?userFlow="+userFlow+"&batchId="+batchId+"&isHide="+isHide+"&isForeign="+isForeign,"用户信息",1000,550);
    }
    ...
    function exportWordInfo(){
       if($('#isAdmited').find('option:selected').text()!='已报到'){
        ...
        jboxExp($('#exportForm'),"<s:url value='/czyyjxres/hospital/chestCardExport'/>");
    }
    ...
    <div class="div_table" style="">
        <form id="auditForm">
            ...
            <table<%-- width="100%" class="grid searchTable" border="0"--%>>
                <tr>
                    <td class="td_right" style="height: 50px;">进修批次：</td>
                    ...
                    <td class="td_right" style="height: 50px;">&#12288;审核情况：</td>
                    <td class="td_left" style="height: 50px;">
                    ...
                    <td class="td_right" style="height: 50px;">&#12288;是否录取：</td>
                    <td class="td_left" style="height: 50px;">
                    ...
                    <td class="td_right" style="height: 50px;">&#12288;是否报到：</td>
                    <td class="td_left" style="height: 50px;">
