    ...
    <script type="text/javascript">
        ...
        function saveStaff(){
            ...
            jboxConfirm("确认修改?" ,  function(){
                jboxPost("<s:url value='/czyyjxres/hospital/editStudyRegist'/>",$("#editForm").serialize(),function(resp){
        ...
        <%--function changeDept(exp){--%>
            ...
            <%--jboxPost("<s:url value='/czyyjxres/hospital/changeDept'/>",{"deptId":deptId},function(data){--%>
                <%--var list=eval(data);--%>
                <%--if(list!=null)--%>
                <%--{--%>
