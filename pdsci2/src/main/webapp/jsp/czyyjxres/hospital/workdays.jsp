<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content","<s:url value='/czyyjxres/hospital/workdays'/>",{"currentPage":$('#currentPage').val()},true);
    }

    //新增、编辑
    function editWorkday(flag,recordFlow){

        jboxOpen("<s:url value='/czyyjxres/hospital/editWorkday'/>?recordFlow="+recordFlow, flag,800,500,true);
    }
    //删除
    function delWorkday(recordFlow,weekendDate){
        jboxConfirm("确定刪除吗？",function(){
            jboxPost("<s:url value='/czyyjxres/hospital/delWorkday'/>",{"recordFlow":recordFlow},function(resp){
                workdaysMaintenance();
            },null,true);
        },null);
    }
