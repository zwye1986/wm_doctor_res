<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content","<s:url value='/czyyjxres/hospital/nationalHolidays'/>",{"currentPage":$('#currentPage').val()},true);
    }

    //新增、编辑
    function editHoliday(flag,recordFlow){

        jboxOpen("<s:url value='/czyyjxres/hospital/editHoliday'/>?recordFlow="+recordFlow, flag,800,500,true);
    }
    //删除
    function delHoliday(recordFlow){
        jboxConfirm("确定刪除吗？",function(){
            jboxPost("<s:url value='/czyyjxres/hospital/delHoliday'/>",{"recordFlow":recordFlow},function(resp){
