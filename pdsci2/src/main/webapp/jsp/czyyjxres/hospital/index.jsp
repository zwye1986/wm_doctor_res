...
function toPage(page) {
	...
	window.location.href="<s:url value='/czyyjxres/hospital/home'/>?currentPage="+$("#currentPage").val();
}
/**
 * 报名审核
 */
function audit(status){
    ...
    jboxPostLoad("content","<s:url value='/czyyjxres/hospital/audit'/>",data,true);
}
/**
 * 学员录取
 */
function _recruitDoctor(status){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/czyyjxres/hospital/_recruitDoctor'/>",data,true);
}
/**
 * 学员报到
 */
function recruitDoctor(){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/czyyjxres/hospital/recruitDoctor'/>",data,true);
}
...
//    jboxTip("正在建设中...");
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/czyyjxres/hospital/graduationDoctor'/>",data,true);
}
/**
 * 外出进修登记
 */
function furtherStudyRegist(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/furtherStudyRegist?currentPage=1'/>",true);
}
...
function furtherStudyQuery(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/furtherStudyQuery?currentPage=1'/>",true);
}
/**
 * 评价指标维护
 */
function evaluationMaintenance(roleId) {
    ...
    jboxLoad("content", "<s:url value='/czyyjxres/evaluation/evaluationMaintenance?roleId='/>" + roleId, false);
}
...
function evaluationQuery() {
    jboxLoad("content", "<s:url value='/czyyjxres/evaluation/evaluationSelect'/>", true);
}
 ...
 */
 function recruitList(){
	 jboxLoad("content","<s:url value='/czyyjxres/hospital/orgRecruitInfo'/>",true);
}
/**
 * 学员查询
 */
 function queryStu(){
	 jboxLoad("content","<s:url value='/czyyjxres/hospital/queryStuMain'/>",true);
}
/**
 * 公告维护
 */
function notice(currentPage){
    ...
    jboxLoad("content","<s:url value='/czyyjxres/hospital/noticemanage?currentPage='/>"+currentPage,true);
}
/**
 * 过程
 */
function resMain(){
    window.open("<s:url value='/czyyjxres/singup/login'/>?userFlow=${sessionScope.currUser.userFlow}");
}
/**
 * 科室维护
 */
function speMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/speMaintenance?currentPage=1'/>",true);
}
/**
* 医院人员维护
*/
function staffManage(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/staffManage?currentPage=1'/>",true);
}
...
function batchSetting(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/searchSetting'/>",true);
}
/**
 * 国籍维护
 */
function nationalityMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/national?currentPage=1'/>",true);
}
...
function suggestionMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/suggestion?currentPage=1'/>",true);
}
...
function tuitionMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/tuition?currentPage=1'/>",true);
}
/**
 * 国家法定节假日维护
 */
function nationalHolidaysMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/nationalHolidays?currentPage=1'/>",true);
}
...
function workdaysMaintenance(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/workdays?currentPage=1'/>",true);
}
...
function registManage(){
    jboxLoad("content","<s:url value='/czyyjxres/hospital/registManage?currentPage=1'/>",true);
}
</script>
</head>
<body>
