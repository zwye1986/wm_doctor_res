...
<script type="text/javascript">
    ...
    //报名审核
    function search(){
        jboxPostLoad("content","<s:url value='/czyyjxres/hospital/audit'/>?isQuery=Y",$('#auditForm').serialize(),true);
    }
    //打印进修申请表
    ...
    function  exportInfo()
    {
        var url = "<s:url value='/czyyjxres/hospital/exportAuditPassed'/>";
//        jboxTip("导出中...");
        ...
        <form id="auditForm">
            ...
            <table>
                <tr>
                    ...
                    <td class="td_left">
                        <input type="text" style="width: 120px;" name="userName" value="${param.userName}" class="input" />
                    </td>
                    <td colspan="2">
