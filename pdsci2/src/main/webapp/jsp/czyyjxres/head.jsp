...
<div class="head">
   <div class="head_inner">
     <h1 class="logo">
       <a href="<s:url value='/czyyjxres/doctor/index'/>">${sysCfgMap['jx_top_name']}</a>
     </h1>
     ...
     <div class="account">
       ...
       <div class="head_right">
        <a href="<s:url value='/czyyjxres/doctor/index'/>">首页</a>&#12288;
        <c:if test='${param.notice}'>
           <a onclick="msgToPage();">公告</a>&#12288;
        </c:if>

         <a href="<s:url value='/inx/czyyjxres/logout?flag='/>${sysCfgMap['jx_templete_name']}">退出</a>
       </div>
     </div>
     </c:if>
   </div>
