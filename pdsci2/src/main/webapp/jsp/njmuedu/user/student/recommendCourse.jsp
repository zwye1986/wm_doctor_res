                 ...
                 <c:forEach items="${recommendCourse }" var="course">
               	  <li >
               	     <a href="<s:url value='/njmuedu/course/stuCourseDetail/${course.courseFlow }'/>">
                   	   		<img class="fl" src="<s:url value='${sysCfgMap["upload_base_url"]}/${course.courseImg }'/>" onerror="this.src='<s:url value="/jsp/njmuedu/css/images/loginbar.jpg"/>'"  width="93" height="65" /> 
               	     </a>
                     <p><a href="<s:url value='/njmuedu/course/stuCourseDetail/${course.courseFlow }'/>">${course.courseName } </a></p>
                     <p>
