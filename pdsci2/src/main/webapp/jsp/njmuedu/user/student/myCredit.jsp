 	  ...
 	  <input type="hidden" id="courseMajorId" name="courseMajorId" value="${param.courseMajorId }"/>
     	...
     	<div class="courseBg" >
        	<div class="title clearfix">
              	<h3 class="fl" style="border:none;"><img src="<s:url value='/jsp/njmuedu/css/images/credit.png'/>" />已获学分课程</h3>
                <div class="title-r fr">
                	 
                <%-- 	<div class="searchBox fl">
                	   <input type="text"  value="${param.courseName }" placeholder="课程搜索" onchange="changeCourseName(this);"/>
                	   <img onclick="loadCourse();" src="<s:url value='/jsp/njmuedu/css/images/search1.png'/>" style="cursor: pointer;" title="搜索"/> 
                	</div> --%>
              ...
              <div class="courseList-content allCourse">
                    <%-- <ul style="display:block;" >
                       ...
                       <c:forEach items="${courseList }" var="course">
                    	<li class="course">
                              ...
                              <c:otherwise>
                                <img src="<s:url value='/jsp/njmuedu/css/images/loginbar.jpg'/>" width="218" height="141" /> 
                              </c:otherwise>
                            </c:choose>
                            </a>
                            <dl>
                                ...
                                <dd><span class="fr"><img src="<s:url value='/jsp/njmuedu/css/images/head-icon1.jpg'/>" width="18" height="14" /><a href="">查看评分规则</a></span>学分：<c:out value="${course.courseCredit }" default="0"/>分</dd>
                            </dl>
                        </li>
                       </c:forEach>
                   </ul>--%>
                   ...
                   <div class="course_credit">
                      <dl class="fl credit_p">
                  	    	<img src="<s:url value='${sysCfgMap["upload_base_url"]}/${course.courseImg }'/>" onerror="this.src='<s:url value="/jsp/njmuedu/css/images/loginbar.jpg"/>'" width="150" height="132" /> 
                      </dl>
                      <dl class="f1 mycredit">
                         <dt>
                            <span title="${course.courseName }">${pdfn:cutString(course.courseName ,5, true, 3)}</span>&#12288;
                            <span style="font-size:13px;">总学时：<font class="red">${course.coursePeriod }</font></span>
                            <span style="font-size:13px;">学分：<font class="red">${course.courseCredit }分</font></span>
                         </dt>
                         <dd>
                        	 <%-- <em>课程简介：${pdfn:cutString(course.courseIntro,40,true,3) }</em> --%>
                        	 <span>学习章节数：${videoFinishNumMap[course.courseFlow] }/${allChapterNumMap[course.courseFlow] }</span>&#12288;&#12288;
                        	 <span>视频分数：${videoScoreMap[course.courseFlow] }</span>
                       	 </dd>
                       	 <dd>
                        	 <span>完成作业数：${workFinishNumMap[course.courseFlow] }/${workNumMap[course.courseFlow] }</span>&#12288;&#12288;
                        	 <span>作业分数：${workScoreMap[course.courseFlow] }</span>
                       	 </dd>
                       	 <dd>
                        	 <span>成绩：${courseGradeMap[course.courseFlow] }</span>
                         </dd>
                         <dt>
