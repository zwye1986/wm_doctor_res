...
<div class="right fr" style="margin-top: 10px;">
    ...
    <table style="width:372px;"  border="0" class="fl">
      ...
      <tr>
        <td colspan="2">
        	<input class="txt validate[required]" type="text" name="userCode" id="userCode" value="${user.userCode}" ${user.userCode != user.userEmail?'disabled':''} />
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><input class="txt" type="text" name="userPhone" id="userPhone" value="${user.userPhone}" onchange="checkUser();"/></td>
      </tr>
       <tr>
      ...
      <tr>
       ...
       <div class="upload-pic fr">
            ...
            <div class="clear"></div>
            <div class="pic">
       	  			<img src="${sysCfgMap['upload_base_url']}/${user.userHeadImg}" id="showImg" width="200px" height="200px" onerror="this.src='<s:url value="/jsp/njmuedu/css/images/up-pic.jpg"/>'" />
           </div>
