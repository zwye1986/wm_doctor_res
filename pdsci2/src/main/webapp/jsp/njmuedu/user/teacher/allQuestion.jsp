    	...
    	<div class="registerMsg-m-inner registerBgw">
        	<div class="registerMsg-tabs">
            	...
            	<div class="module-tabs">
                	<ul class="fl type">
                        <li <c:if test="${(param.questionStatusId eq njmuEduQuestionStatusEnumUnanswered.id) or (empty param.questionStatusId) }">class="on"</c:if>onclick="changeQuestionStatus('${njmuEduQuestionStatusEnumUnanswered.id}')">等待回复</li>
                        <li <c:if test="${param.questionStatusId eq njmuEduQuestionStatusEnumAnswered.id}">class="on"</c:if> onclick="changeQuestionStatus('${njmuEduQuestionStatusEnumAnswered.id}')">已回复</li>
                     </ul>
                                ...
                                <dl id="dl_${question.questionFlow }">
                                    <dt>
                                        <div class="fl infoT-l">
			  			                    <img class="t-face" src="${sysCfgMap['upload_base_url']}/${stuMap[question.userFlow].userHeadImg}" title="${stuMap[question.userFlow].orgName}&#10;${eduMap[question.userFlow].majorName}" onerror="this.src='<s:url value="/jsp/njmuedu/css/images/head-icon.png"/>'" />
                                        ...
                                        <div class="fr infoT-r">
                                            ...
                                            <a href="<s:url value='/njmuedu/course/chapter/${courseChapterMap[question.courseFlow][question.chapterFlow].chapterFlow }'/>" target="_blank">
                                    ...
                                    <dd>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                              ...
                                              <br/>${sessionScope.currUser.userName}
                                               ...
                                               <div class="infoT2"> 
                                              <p class="p4"><img src="<s:url value='/jsp/njmuedu/css/images/acion-off.png'/>" width="16" height="16" />${answer.answerContent }</p>
                                        ...
                                        <div class="huif clearfix">
                                            <textarea name="answerContent" class="validate[required custom[maxSize[500]]]"  placeholder="请输入您的回复"></textarea>
