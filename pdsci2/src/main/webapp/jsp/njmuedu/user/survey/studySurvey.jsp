...
<div class="module-tabs">
      <div class="title-r fr">
      	...
      	<form id="studySurveyForm">
      	   ...
      	   <img onclick="submitForm('studySurvey');" src="<s:url value='/jsp/njmuedu/css/images/search1.png'/>" style="cursor: pointer;" title="搜索"/> 
      	</form>
      	</div>
      </div>
</div> 
...
<div class="fanye">
<a href="javascript:void(0);" onclick="toNext(${flag-1});"><img src="<s:url value='/jsp/njmuedu/css/images/fanye-l.png'/>" /></a>
点击箭头可翻页
<a href="javascript:void(0);" onclick="toNext(${flag+1});"><img src="<s:url value='/jsp/njmuedu/css/images/fanye-r.png'/>" /></a>
</div>
