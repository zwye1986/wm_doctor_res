...
<div class="overview">
	<img src="<s:url value='/jsp/njmuedu/css/images/xxjd.png'/>" />课程评价
</div>
			...
			<form id="courseEvaluateForm">
          	<p>
	           <input type="text"  placeholder="专业名称" name="condition" value="${param.condition}" />
	      	   <img onclick="submitForm('courseEvaluate');" src="<s:url value='/jsp/njmuedu/css/images/search1.png'/>" style="cursor: pointer;" title="搜索"/>                  
         	</p>
	        </form>
     	</div>
      </div>
