...
$(document).ready(function(){
	loadContent('<s:url value='/njmuedu/user/userList'/>?isAdmin=Y');
   ...
   <div class="menu-warp fl">
    <ul class="menu">
      ...
      <ul class="level2" style="display:block;">
        <li><a class="hove1" href="javascript:load('<s:url value='/njmuedu/user/userList'/>?isAdmin=Y');">学生信息</a></li>
        <li><a href="javascript:load('<s:url value='/njmuedu/user/tchInfo'/>?isAdmin=Y');">教师信息</a></li>
      </ul>
      <li class="level1"><a  href="javascript:void(0);">教学概况</a>
		</li>
		<ul class="level2" style="display:block;">
			<li><a href="javascript:load('<s:url value='/njmuedu/user/courseInfo'/>?isAdmin=Y');">课程概况</a></li>
			<li><a href="javascript:load('<s:url value='/njmuedu/user/courseOrder'/>?isAdmin=Y');">课程预约</a></li>
			<li><a href="javascript:load('<s:url value='/njmuedu/user/lessionInfo'/>?isAdmin=Y');">教师授课情况</a></li>
			<li><a href="javascript:load('<s:url value='/njmuedu/user/scheduleInfo'/>?isAdmin=Y');">学生学习进度</a></li>
			...
			<li><a href="javascript:load('<s:url value='/njmuedu/user/scoreInfo'/>?isAdmin=Y')">成绩管理</a></li>
			<li><a href="javascript:load('<s:url value='/njmuedu/user/examinationInfo?isAdmin=Y'/>')">考试名单</a></li>
		</ul>
