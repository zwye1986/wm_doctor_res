<script >
$(function(){
	$("#changeCourseName").keyup(function(){   
		  if(event.keyCode == 13){
			  loadCourse();
		  }
	  });
              ...
              <div class="title clearfix">
                ...
                <div class="title-r fr">
                	...
                	<div class="searchBox fl">
                	   <input type="text"  value="${param.courseName }" placeholder="课程搜索" id="changeCourseName" onchange="changeCourseName(this);"/>
                       ...
                       <c:forEach items="${stuCourseList }" var="course">
                    	<li class="course">
                   	    	<a href="javascript:void(0);" onclick="checkRole('${course.courseFlow }');">
                   	    	    <img src="<s:url value='${sysCfgMap["upload_base_url"]}/${course.courseImg }'/>" onerror="this.src='<s:url value="/jsp/njmuedu/css/images/loginbar.jpg"/>'" width="218" height="141" /> 
                            </a>
                            <dl>
                                ...
                                <dd><span class="fr"><img src="<s:url value='/jsp/njmuedu/css/images/head-icon1.jpg'/>" width="18" height="14" />${countOneCourseMap[course.courseFlow] }</span>学分：<c:out value="${course.courseCredit }" default="0"/>分</dd>
                            </dl>
                        </li>
                       </c:forEach>
                   </ul>
