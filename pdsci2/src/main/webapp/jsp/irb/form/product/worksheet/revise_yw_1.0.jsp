...
function print(){
	var url ="<s:url value='/irb/print'/>?watermarkFlag=${GlobalConstant.FLAG_N}&userFlow=${userFlow}&irbFlow=${irbForm.irb.irbFlow}&recTypeId=${irbRecTypeEnumReviseWorksheet.id}";
	...
	<div class="title1 clearfix">
		<table width="100%" cellpadding="0" cellspacing="0" class="basic">
			<tr>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;方案修正是否影响研究的风险：<input type="checkbox" id="reviewElement11" name="reviewElement1" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement1']=='1'}">checked</c:if>><label for="reviewElement11">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;方案修正是否影响受试者的受益：<input type="checkbox" id="reviewElement21" name="reviewElement2" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='1'}">checked</c:if>><label for="reviewElement21">是</label>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;方案修正是否涉及弱势群体：<input type="checkbox" id="reviewElement31" name="reviewElement3" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement3']=='1'}">checked</c:if>><label for="reviewElement31">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;方案修正是否增加受试者参加研究的持续时间或花费：<input type="checkbox" id="reviewElement41" name="reviewElement4" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement4']=='1'}">checked</c:if>><label for="reviewElement41">是</label>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;如果研究已经开始，方案修正是否对已经纳入的受试者造成影响：<input type="checkbox" id="reviewElement51" name="reviewElement5" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement5']=='1'}">checked</c:if>><label for="reviewElement51">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;为了避免对受试者造成紧急伤害，在提交伦理委员会审查批准前对方案进行了修改并实施是合理的：
      				<input type="checkbox" id="reviewElement61" name="reviewElement6" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement6']=='1'}">checked</c:if>><label for="reviewElement61">不适用</label>
      				&#12288;<input type="checkbox" id="reviewElement62" name="reviewElement6" value="2" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement6']=='2'}">checked</c:if>><label for="reviewElement62">是</label>
      				&#12288;<input type="checkbox" id="reviewElement63" name="reviewElement6" value="3" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement6']=='3'}">checked</c:if>><label for="reviewElement63">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      				&nbsp;●&#12288;方案修正是否需要同时修改知情同意书：<input type="checkbox" id="reviewElement71" name="reviewElement7" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement7']=='1'}">checked</c:if>><label for="reviewElement71">是</label>
      				&#12288;<input type="checkbox" id="reviewElement70" name="reviewElement7" value="0" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement7']=='0'}">checked</c:if>><label for="reviewElement70">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      			&nbsp;●&#12288;修正的知情同意书是否符合完全告知、充分理解、自主选择的原则：<input type="checkbox" id="reviewElement81" name="reviewElement8" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement8']=='1'}">checked</c:if>><label for="reviewElement81">是</label>
      				&#12288;<input type="checkbox" id="reviewElement80" name="reviewElement8" value="0" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement8']=='0'}">checked</c:if>><label for="reviewElement80">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      			&nbsp;●&#12288;知情同意书的修改是否需要重新获取知情同意：<input type="checkbox" id="reviewElement91" name="reviewElement9" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement9']=='1'}">checked</c:if>><label for="reviewElement91">是</label>
      				&#12288;<input type="checkbox" id="reviewElement90" name="reviewElement9" value="0" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement9']=='0'}">checked</c:if>><label for="reviewElement90">否</label>
      			</td>
      		</tr>
		</table>
		</div>
