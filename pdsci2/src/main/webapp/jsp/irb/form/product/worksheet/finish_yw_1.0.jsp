...
function print(){
	var url ="<s:url value='/irb/print'/>?watermarkFlag=${GlobalConstant.FLAG_N}&userFlow=${userFlow}&irbFlow=${irbForm.irb.irbFlow}&recTypeId=${irbRecTypeEnumFinishWorksheet.id}";
	...
	<div class="title1 clearfix">
		<table width="100%" cellpadding="0" cellspacing="0" class="basic">
			<tr>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;严重不良事件或方案规定必须报告的重要医学事件已经及时报告：<input type="checkbox" id="reviewElement11" name="reviewElement1" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement1']=='1'}">checked</c:if>><label for="reviewElement11">不适用</label>
      				&#12288;<input type="checkbox" id="reviewElement12" name="reviewElement1" value="2" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement1']=='2'}">checked</c:if>><label for="reviewElement12">是</label>
      				&#12288;<input type="checkbox" id="reviewElement13" name="reviewElement1" value="3" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement1']=='3'}">checked</c:if>><label for="reviewElement13">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      			&nbsp;●&#12288;与研究干预相关的、非预期的严重不良事件是否影响研究的风险与受益：<input type="checkbox" id="reviewElement21" name="reviewElement2" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='1'}">checked</c:if>><label for="reviewElement21">不适用</label>
      				&#12288;<input type="checkbox" id="reviewElement22" name="reviewElement2" value="2" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='2'}">checked</c:if>><label for="reviewElement22">是</label>
      				&#12288;<input type="checkbox" id="reviewElement23" name="reviewElement2" value="3" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='3'}">checked</c:if>><label for="reviewElement23">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      				&nbsp;●&#12288;研究风险是否超过预期：<input type="checkbox" id="reviewElement31" name="reviewElement3" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement3']=='1'}">checked</c:if>><label for="reviewElement31">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;研究中是否存在影响受试者权益的问题：<input type="checkbox" id="reviewElement41" name="reviewElement4" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement4']=='1'}">checked</c:if>><label for="reviewElement41">是</label>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;是否有必要采取进一步保护受试者的措施：<input type="checkbox" id="reviewElement51" name="reviewElement5" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement5']=='1'}">checked</c:if>><label for="reviewElement51">是</label>
