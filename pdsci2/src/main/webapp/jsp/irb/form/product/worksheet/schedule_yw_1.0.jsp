...
function print(){
	var url ="<s:url value='/irb/print'/>?watermarkFlag=${GlobalConstant.FLAG_N}&userFlow=${userFlow}&irbFlow=${irbForm.irb.irbFlow}&recTypeId=${irbRecTypeEnumScheduleWorksheet.id}";
...
<body>
	...
	<div style="margin-top: 5px;text-align: center;width: 100%;">
		<font size="3"><b>年度/定期跟踪审查工作表</b></font>
	</div>
	...
	<div class="title1 clearfix">
		<table width="100%" cellpadding="0" cellspacing="0" class="basic">
			<tr>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;是否存在影响研究进行的情况：<input type="checkbox" id="reviewElement11" name="reviewElement1" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement1']=='1'}">checked</c:if>><label for="reviewElement11">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;严重不良事件或方案规定必须报告的重要医学事件已经及时报告：&#12288;<input type="checkbox" id="reviewElement21" name="reviewElement2" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='1'}">checked</c:if>><label for="reviewElement21">不适用</label>
      				<input type="checkbox" id="reviewElement22" name="reviewElement2" value="2" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='1'}">checked</c:if>><label for="reviewElement22">是</label>
      				&#12288;<input type="checkbox" id="reviewElement23" name="reviewElement2" value="3" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement2']=='0'}">checked</c:if>><label for="reviewElement23">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      				&nbsp;●&#12288;与药物相关的、非预期的、严重不良事件是否影响研究的风险与受益：<input type="checkbox" id="reviewElement31" name="reviewElement3" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement3']=='1'}">checked</c:if>><label for="reviewElement31">不适用</label>
      				&#12288;<input type="checkbox" id="reviewElement32" name="reviewElement3" value="2" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement3']=='2'}">checked</c:if>><label for="reviewElement32">是</label>
      				&#12288;<input type="checkbox" id="reviewElement33" name="reviewElement3" value="3" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement3']=='3'}">checked</c:if>><label for="reviewElement33">否</label>
      			</td>
      		</tr>
      		<tr>
      			<td>
      			&nbsp;●&#12288;研究的风险是否超过预期：<input type="checkbox" id="reviewElement41" name="reviewElement4" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement4']=='1'}">checked</c:if>><label for="reviewElement41">是</label>
      		...
      		<tr>
      			<td>
      				&nbsp;●&#12288;是否存在影响研究风险与受益的任何新信息、新进展：<input type="checkbox" id="reviewElement51" name="reviewElement5" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement5']=='1'}">checked</c:if>><label for="reviewElement51">是</label>
      		...
      		<tr>
      			<td>
      			&nbsp;●&#12288;研究中是否存在影响受试者权益的问题：<input type="checkbox" id="reviewElement61" name="reviewElement6" value="1" onclick="selectSingle(this);" <c:if test="${formDataMap['reviewElement6']=='1'}">checked</c:if>><label for="reviewElement61">是</label>
