<script type="text/javascript">
    ...
    function searchDoctor(){
        jboxPostLoad("content","<s:url value='/zseyjxres/secretaries/changeTea'/>?isQuery=Y",$('#auditForm').serialize(),true);
    }
    function registerTeacher(resumeFlow){
        jboxOpen("<s:url value='/zseyjxres/hospital/registerTeacher?deptFlow=${deptFlow}&resumeFlow='/>"+resumeFlow, "登记老师",800,500,true);
    }
    function exportInfo(){
        jboxExp($('#auditForm'),"<s:url value='/zseyjxres/secretaries/exportQueryStu'/>?isQuery=Y");
    }
</script>
<div class="main_hd">
    <h2>学员评价</h2>
