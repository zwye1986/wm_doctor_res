...
<script type="text/javascript">
	...
	function selDoc(tr,doctorFlow){
		...
		jboxLoad("rosteringHand","<s:url value='/zseyjxres/hospital/rosteringHandDept'/>?doctorFlow="+doctorFlow+"&doctorName="+encodeURI(encodeURI(doctorName)),true);
...
<div class="main_fix" style="overflow:auto; top: 0">
		...
		<div class="side" style="width: 20%;">
			<form id="doctorForm" method="post" action="<s:url value='/zseyjxres/hospital/rosteringHand'/>">
