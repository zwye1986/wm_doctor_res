...
function saveNotice(){
	if($("#editForm").validationEngine("validate")){
		...
		var requestData ={
				...
				"title":title,
				"content":content,
			    "roleFlow":"${GlobalConstant.JX_NOTICE_SYS_ID}"
		};
    ...
    <ul class="form_main">
        <c:forEach items="${infos}" var="msg">
            <li class="docDiv">
                <a>
                    <strong>
                        <a href="<s:url value='/inx/zseyjxres/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a>
					...
					<span class="editSpan" style="display:none;">
						...
						<a href="<s:url value='/inx/zseyjxres/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank" class="bl">查看</a> |
