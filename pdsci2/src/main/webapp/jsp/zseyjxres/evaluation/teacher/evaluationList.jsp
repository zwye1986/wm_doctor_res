...
<head>
    <script type="text/javascript">
        ...
        function showEvaluation(processFlow) {
            var url = "<s:url value='/zseyjxres/evaluation/showEvaluation?roleId=Teacher&processFlow='/>" + processFlow;
            var typeName = "带教评价";
            jboxOpen(url, typeName, 800, 500);
        }
        //展示查看评价窗口
        function showEvalDetail(evalRecordFlow) {
            var url = "<s:url value='/zseyjxres/evaluation/showEvalDetail?roleId=Teacher&evalRecordFlow='/>" + evalRecordFlow;
            var typeName = "带教评价查看";
            jboxOpen(url, typeName, 800, 500);
        }
    </script>
