...
<div class="infoAudit2" style="padding:0;">
		...
		<form id="payInfoForm" enctype="multipart/form-data">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="base_info">
				<tr>
					...
					<%--<th>工作服：</th>--%>
					<%--<td>--%>
						<%--<input id="coverallNum" class='input validate[custom[integer],min[0]]' <c:if test="${param.isHide eq 'Y' or flag eq 'Y'}">readonly="readonly"</c:if> type="text" name="extInfo.coverallNum" value="${extInfo.coverallNum}" placeholder="件数"  style="width: 80px;height: 22px;margin-left: 0px"/>*65元/件--%>
					<%--</td>--%>
				</tr>
				<tr>
	...
	<div class="div_table" <c:if test="${param.isHide eq 'Y' or flag eq 'Y'}">style="display: none;" </c:if>>
		...
		<div align="center" style="margin-top: 20px; margin-bottom:20px;">
			...
			<input type="button" style="width:110px;" class="btn_green" onclick="audit('${stuStatusEnumHeadPassing.id}','待科室审核');" value="转科室审核"/>
			<input type="button" style="width:110px;" class="btn_red" onclick="audit('${stuStatusEnumUnPassed.id}','审核不通过');" value="不通过"/>
			<input type="button" style="width:110px;" class="btn_green" onclick="returnInfo('${stuUser.resumeFlow}')" value="退&#12288;回"/>
			</c:if>
