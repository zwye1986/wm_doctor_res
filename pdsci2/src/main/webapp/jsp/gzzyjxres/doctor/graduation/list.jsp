...
<script type="text/javascript">
	...
	function uploadFile(){
		...
		jboxStartLoading();
		var url = "<s:url value='/gzzyjxres/doctor/uploadFile'/>";
	...
	<div class="main_hd">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="grid">
			...
			<tr>
				...
				<c:if test="${empty adminFileMap[doctor.resumeFlow]}">
					<th colspan="2">操作</th>
				</c:if>
			...
			<tr>
				...
				<td>
						...
						<c:if test="${doctor.stuStatusId eq stuStatusEnumGraduation.id and doctor.issueCertificate eq GlobalConstant.FLAG_Y}">
							<a class="btn_green" style="color: white;" href="<s:url value='/gzzyjxres/doctor/showCertificate?resumeFlow=${doctor.resumeFlow}'/>" target="_blank">打印结业证书</a>
