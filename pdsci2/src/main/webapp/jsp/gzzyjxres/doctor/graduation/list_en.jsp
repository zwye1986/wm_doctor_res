			...
			<tr>
				...
				<td>
					...
					<c:if test="${doctor.stuStatusId eq stuStatusEnumGraduation.id and doctor.issueCertificate eq GlobalConstant.FLAG_Y}">
						<a class="btn_green" style="color: white;" href="<s:url value='/gzzyjxres/doctor/showCertificate?resumeFlow=${doctor.resumeFlow}'/>" target="_blank">Print Certificate of Completion</a>
