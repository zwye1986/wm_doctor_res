    ...
    <script>
        ...
        function singup(stuBatId) {
            if (stuBatId) {
                ...
                jboxTip("当前没有可以报名的批次！");
                var url = "<s:url value='/gzzyjxres/doctor/singup'/>";
            }
...
//            jboxTip("正在建设中...");
            var url = "<s:url value='/gzzyjxres/doctor/graduationAppraisal/list'/>";
            jboxLoad("content", url, true);
        }
        ...
        function evaluation(resp) {
            var roleId = resp;
            var url = "<s:url value='/gzzyjxres/evaluation/evaluationManage?roleId='/>" + roleId;
            jboxLoad("content", url, true);
        }
        ...
        function toPage(page) {
            ...
            window.location.href = "<s:url value='/gzzyjxres/doctor/home'/>?currentPage=" + page;
        }
                        ...
                        <div class="content_main">
                            ...
                            <script>
                                ...
                                function printRecruit(resumeFlow) {
                                    jboxTip("打印中,请稍等...");
                                    var url = '<s:url value="/gzzyjxres/doctor/recruitNotice?resumeFlow="/>' + resumeFlow;
