<script>
	function search(){
		var url = "<s:url value='/gzzyjxres/doctor/singup?batchFlow='/>"+$('#batchFlow').val();
...
//            templeteName = "徐州中心医院";
//        }
			var url = '<s:url value="/gzzyjxres/hospital/printApplForm?resumeFlow="/>'+resumeFlow;
			window.location.href = url;
	}
	//打印录取通知书
	function printRecruit(resumeFlow){
		jboxTip("打印中,请稍等...");
		var url = '<s:url value="/gzzyjxres/doctor/recruitNotice?resumeFlow="/>'+resumeFlow+"&titleTypeId=${extInfo.titleTypeId}";
		window.location.href = url;
	}
</script>
