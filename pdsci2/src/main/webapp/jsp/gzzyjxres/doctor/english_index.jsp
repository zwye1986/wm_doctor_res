...
<head>
    ...
    <script>
        ...
        function singup(stuBatId) {
            if (stuBatId) {
                var url = "<s:url value='/gzzyjxres/doctor/singup_en?&batchFlow='/>" + stuBatId;
                jboxLoad("content", url, true);
            } else {
                jboxTip("There are no batches to sign up for!");
                var url = "<s:url value='/gzzyjxres/doctor/singup_en'/>";
            }
        ...
        function toPage(page) {
            ...
            window.location.href = "<s:url value='/gzzyjxres/doctor/home_en'/>?currentPage=" + page;
        }
        ...
        function graduationAppraisal() {
            var url = "<s:url value='/gzzyjxres/doctor/graduationAppraisal/list_en'/>";
            jboxLoad("content", url, true);
        }
        ...
        function printRecruit(resumeFlow) {
            ...
            var url = '<s:url value="/gzzyjxres/doctor/printInvitationLetter?resumeFlow="/>' + resumeFlow;
...
<div style="overflow:auto;" id="indexBody">
    <div class="bd_bg">
        <div class="<%--yw--%>">
            <jsp:include page="/jsp/gzzyjxres/english_head.jsp" flush="true">
    ...
    <jsp:include page="/jsp/gzzyjxres/english_foot.jsp" flush="true"/>
</div>
</body>
</html>
