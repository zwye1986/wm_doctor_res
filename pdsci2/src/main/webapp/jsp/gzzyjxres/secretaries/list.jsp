<script type="text/javascript">
    ...
    function searchDoctor(){
        jboxPostLoad("content","<s:url value='/gzzyjxres/secretaries/changeTea'/>?isQuery=Y",$('#auditForm').serialize(),true);
    }
    function registerTeacher(resumeFlow){
        jboxOpen("<s:url value='/gzzyjxres/hospital/registerTeacher?deptFlow=${deptFlow}&resumeFlow='/>"+resumeFlow, "登记老师",800,500,true);
    }
    function exportInfo(){
        jboxExp($('#auditForm'),"<s:url value='/gzzyjxres/secretaries/exportQueryStu'/>?isQuery=Y");
    }
</script>
<div class="main_hd">
    <h2>分配老师</h2>
