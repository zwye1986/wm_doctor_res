<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/tuition'/>",{"currentPage":$('#currentPage').val()},true);
    }

    //新增、编辑
    function edit(flag,recordFlow){

        jboxOpen("<s:url value='/gzzyjxres/hospital/editTuition'/>?recordFlow="+recordFlow, flag,800,500,true);
    }
    //删除
    function delTuition(recordFlow){
        jboxConfirm("确定刪除吗？",function(){
            jboxPost("<s:url value='/gzzyjxres/hospital/delTuition'/>",{"recordFlow":recordFlow},function(resp){
                tuitionMaintenance();
            },null,true);
        },null);
    }
