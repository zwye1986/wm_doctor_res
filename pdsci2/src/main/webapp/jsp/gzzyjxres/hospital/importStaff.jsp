...
<head>
	...
	<script type="text/javascript">
		function daoRu(){
			...
			var url = "<s:url value='/gzzyjxres/hospital/importStaff'/>";
			jboxSubmit(
					$('#excelForm'),
					url,
					function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	...
	<table class="grid" style="width: 90%;margin-left: 5%;">
		...
		<tr>
			<th>模板文件</th>
			<td style="text-align: left"><a href="<s:url value='/jsp/gzzyjxres/hospital/temeplete/importStaffs.xlsx'/>">医院导入模板.xlsx</a></td>
		</tr>
	</table>
</form>
