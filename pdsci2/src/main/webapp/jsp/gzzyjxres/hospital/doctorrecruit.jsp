<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function searchDoctor(){
            jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/recruitDoctor'/>?isQuery=Y",$("#searchForm").serialize() ,true);
        }
        //打印入科通知
        ...
        function getInfo(userFlow,batchId,flag,isForeign){
            ...
            jboxOpen("<s:url value='/gzzyjxres/doctor/getsingupinfoaudit'/>?userFlow="+userFlow+"&batchId="+batchId+"&flag="+flag+"&isForeign="+isForeign,"人员信息",1000,550);
        }
        //是否报到操作
...
//            dateForm.append(dateInput);
            if(admitFlag=='Y'){
                jboxOpen("<s:url value='/gzzyjxres/hospital/admitTime?resumeFlow='/>"+resumeFlow+"&statusId="+admitFlag, tip,500,300,true);
            }

            if(admitFlag=='N'){
                jboxConfirm(tip, function(){
                    jboxPost('<s:url value="/gzzyjxres/hospital/notrecruit"/>' , {"resumeFlow":resumeFlow,"statusId":admitFlag} , function(resp){
                        if(resp=="1"){
                            jboxTip("操作成功");
                        }
                        searchDoctor();
        ...
        function registerTeacher(resumeFlow,deptFlow){
            jboxOpen("<s:url value='/gzzyjxres/hospital/registerTeacher?resumeFlow='/>"+resumeFlow+"&deptFlow="+deptFlow, "登记老师",800,500,true);
        }
        //结业
        ...
        function  exportInfo()
        {
            var url = "<s:url value='/gzzyjxres/hospital/exportAdmitPassed'/>";
        ...
        function stuInfoExport(){
            ...
            jboxExp($('#searchForm'),"<s:url value='/gzzyjxres/hospital/stuChestCardExport'/>");
        }
