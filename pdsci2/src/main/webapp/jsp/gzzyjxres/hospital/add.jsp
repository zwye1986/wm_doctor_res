...
<script type="text/javascript">
	...
	function save() {
        ...
        var url = "<s:url value='/gzzyjxres/hospital/getArrangedNum'/>";
        jboxGetAsync(url,jsonData,function(resp){//同步加载
            num = resp;
        },null,false);

        jboxConfirm("当前时间段，该科室已经有"+num+"人，是否继续保存？",function(){
            var url = "<s:url value='/gzzyjxres/hospital/save'/>";
...
//            jboxTip("请先选择科室！");
		...
		var url = "<s:url value='/gzzyjxres/hospital/loadKm'/>?deptFlow=" + deptFlow;
