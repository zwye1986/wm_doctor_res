...
<script type="text/javascript">
	...
	function add(flag,arrangeFlow) {
		...
		jboxOpen("<s:url value='/gzzyjxres/hospital/add?doctorFlow='/>"+doctorFlow+"&doctorName="+encodeURI(encodeURI(doctorName))+"&arrangeFlow="+arrangeFlow,flag+"进修专业信息", 900, 300);
	}
	...
	function del(){
		if($(".arrangeList:checked").length>0){
			...
			jboxConfirm("确认删除此条记录?", function(){
				var url = "<s:url value='/gzzyjxres/hospital/del?arrangeFlows='/>"+flows;
