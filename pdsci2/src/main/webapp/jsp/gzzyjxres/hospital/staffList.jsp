...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content", "<s:url value='/gzzyjxres/hospital/staffManage'/>", $('#searchForm').serialize(), true);
    }
    ...
    function edit(flag, userFlow) {
        ...
        jboxOpen("<s:url value='/gzzyjxres/hospital/editStaff'/>?userFlow=" + userFlow + "&roleId=" + roleId, flag, 600, 350, true);
    }
    //导入
    function showImport() {
        var url = "<s:url value='/gzzyjxres/hospital/showImport'/>";
        typeName = "导入医院人员";
    ...
    function del(userFlow) {
        jboxConfirm("确定刪除吗？", function () {
            jboxPost("<s:url value='/gzzyjxres/hospital/delStaff'/>", {"userFlow": userFlow}, function (resp) {
                staffManage();
            }, null, true);
        }, null);
    }
