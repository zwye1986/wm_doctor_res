...
function toPage(page) {
	...
	window.location.href="<s:url value='/gzzyjxres/hospital/home'/>?currentPage="+$("#currentPage").val();
}
/**
 * 报名审核
 */
function audit(status){
    ...
    jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/audit'/>",data,true);
}
/**
 * 学员录取
 */
function _recruitDoctor(status){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/_recruitDoctor'/>",data,true);
}
/**
 * 学员报到
 */
function recruitDoctor(){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/recruitDoctor'/>",data,true);
}
...
//    jboxTip("正在建设中...");
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/gzzyjxres/hospital/graduationDoctor'/>",data,true);
}
/**
 * 外出进修登记
 */
function furtherStudyRegist(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/furtherStudyRegist?currentPage=1'/>",true);
}
...
function furtherStudyQuery(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/furtherStudyQuery?currentPage=1'/>",true);
}
/**
 * 评价指标维护
 */
function evaluationMaintenance(roleId) {
    ...
    jboxLoad("content", "<s:url value='/gzzyjxres/evaluation/evaluationMaintenance?roleId='/>" + roleId, false);
}
...
function evaluationQuery() {
    jboxLoad("content", "<s:url value='/gzzyjxres/evaluation/evaluationSelect'/>", true);
}
 ...
 */
 function recruitList(){
	 jboxLoad("content","<s:url value='/gzzyjxres/hospital/orgRecruitInfo'/>",true);
}
/**
 * 学员查询
 */
 function queryStu(){
	 jboxLoad("content","<s:url value='/gzzyjxres/hospital/queryStuMain'/>",true);
}
/**
 * 公告维护
 */
function notice(currentPage){
    ...
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/noticemanage?currentPage='/>"+currentPage,true);
}
/**
 * 过程
 */
...
function speMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/speMaintenance?currentPage=1'/>",true);
}
/**
* 医院人员维护
*/
function staffManage(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/staffManage?currentPage=1'/>",true);
}
...
function batchSetting(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/searchSetting'/>",true);
}
/**
 * 国籍维护
 */
function nationalityMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/national?currentPage=1'/>",true);
}

/**
 * 审核意见维护
 */
function suggestionMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/suggestion?currentPage=1'/>",true);
}

/**
 * 学费自定义维护
 */
function tuitionMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/tuition?currentPage=1'/>",true);
}
/**
 * 国家法定节假日维护
 */
function nationalHolidaysMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/nationalHolidays?currentPage=1'/>",true);
}

/**
 * 周末工作日登记
 */
function workdaysMaintenance(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/workdays?currentPage=1'/>",true);
}
...
function registManage(){
    jboxLoad("content","<s:url value='/gzzyjxres/hospital/registManage?currentPage=1'/>",true);
}
</script>
</head>
<body>
                        ...
                        <div class="content_side">
                           ...
                           <%-- <dl class="menu">
                            ...
                            <dl class="menu">
                                ...
                                <dd class="menu_item"><a onclick="speMaintenance();">外籍科室维护</a></dd>
                              <%--  <dd class="menu_item"><a onclick="staffManage();">本院人员维护</a></dd>--%>
                                ...
                                <dd class="menu_item"><a onclick="suggestionMaintenance();">审核意见维护</a></dd>
                                <dd class="menu_item"><a onclick="tuitionMaintenance();">学费管理</a></dd>
                                <dd class="menu_item"><a onclick="nationalHolidaysMaintenance();">法定节假日登记</a></dd>
                                <dd class="menu_item"><a onclick="workdaysMaintenance();">周末为工作日登记</a></dd>
                                ...
                                <div class="index_form">
                                    ...
                                    <ul class="form_main">
                                        <c:forEach items="${messages}" var="msg">
                                            <li>
                                                <a>
                                                    <strong><a href="<s:url value='/inx/gzzyjxres/noticeView'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle }</a>
