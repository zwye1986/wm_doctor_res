...
function saveForm(){
	if("${param.type}" == "GCP"){
		var url = "<s:url value='/gcp/researcher/savePatientAe'/>?formFileName=${formFileName}&patientFlow=${param.patientFlow}&orgFlow=${param.orgFlow}";
		jboxPost(
				url,
				$('#initApplicationForm').serialize(),
				function(resp){
					if(resp=='${GlobalConstant.SAVE_SUCCESSED}'){
						var url = "<s:url value='/gcp/researcher/aeList'/>?type=GCP&patientFlow=${param.patientFlow}&orgFlow=${param.orgFlow}&patientCode=${param.patientCode}&patientNamePy=${param.patientNamePy}";
...
function print(){
	var url ="<s:url value='/irb/print'/>?watermarkFlag=${GlobalConstant.FLAG_N}&irbFlow=${sessionScope.currIrb.irbFlow}&recTypeId=${irbRecTypeEnumSaeApplication.id}";
	window.location.href= url;
}
...
<body>
	...
	<div style="margin-top: 5px;text-align: center;width: 100%;">
		<font size="3" ><b>严重不良事件报告表${param.recordFlow}111</b></font>
	</div>
...
<form id="initApplicationForm" >
		...
		<table width="100%" cellpadding="0" cellspacing="0" class="basic">
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="drugName" style="width: 500px;" value="西尼必利片">
      			</td>
      		</tr>
      		<tr>
      			...
      			<td colspan="3">
	      			...
	      			&#12288;<input type="checkbox" id="drugCategory2" name="drugCategory" value="2" onclick="selectSingle(this);" checked><label for="drugCategory2">化学药品</label>
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="irbNo" style="width: 500px;" value="2014YW0129">
      			</td>
      		</tr>
      		<tr>
      			...
      			<td colspan="3">
	      			...
	      			&#12288;<input type="checkbox" id="projSubType2" name="projSubType" value="2" onclick="selectSingle(this);" checked><label for="projSubType2">Ⅱ期</label>
      		...
      		<tr>
      			<td style="text-align: left;" colspan="4">&nbsp;<input type="checkbox" id="reportType1" name="reportType" value="1" onclick="selectSingle(this);" checked><label for="reportType1">首次报告</label>
      			（日期：<input type="text" name="firstReportDate" value="2010-10-13" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />）
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="projDeclarer" style="width: 500px;" value="苏州东瑞 ">
      			</td>
      		</tr>
      		<tr>
      		...
      		<tr>
      			...
      			<td width="32%">
      				<input type="text" name="projDeclarerPhone" value="0510-85350171">
      			</td>
      			<td style="text-align: center;" width="14%">传真</td>
      			<td width="32%">
      				<input type="text" name="projDeclarerFax" value="0510-85350171">
      			</td>
      		</tr>
      		<tr>
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="applyOrgName" style="width: 500px;" value="南京妇幼保健医院">
      			</td>
      		</tr>
      		<tr>
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="patientNamePy" value="YXG">
      			</td>
      		</tr>
      		<tr>
      			<td style="text-align: left;" width="22%">受试者（药物/随机）编码</td>
      			<td colspan="3">
      				<input type="text" name="patientCode" value="023">
      			</td>
      		</tr>
      		<tr>
      			<td style="text-align: left;" width="22%">出生日期</td>
      			<td colspan="3">
      				<input type="text" name="patientBirthday" value="1986-01-19" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
      			</td>
      		</tr>
      		<tr>
      			<td style="text-align: left;" width="22%">性别</td>
      			<td colspan="3">
      				<input type="checkbox" id="patientSex1" name="patientSex" value="1" onclick="selectSingle(this);" checked><label for="patientSex1">男</label>
      		...
      		<tr>
      			...
      			<td colspan="3">
      				<input type="text" name="saeDescription" style="width: 500px;" value="COPD急性加重">
      			</td>
      		</tr>
      		<tr>
      		...
      		<tr>
      			<td style="text-align: left;" colspan="4">&nbsp;<input type="checkbox" id="aeRelations1" name="aeRelations" value="1" onclick="selectSingle(this);" checked><label for="aeRelations1">无关</label>
      		...
      		<tr>
      			<td style="text-align: left;" colspan="4">&nbsp;<input type="checkbox" id="aeMeasures1" name="aeMeasures" value="1" checked><label for="aeMeasures1">无</label>
      		...
      		<tr>
      			...
      			&#12288;<input type="checkbox" id="aeOutcome5" name="aeOutcome" value="5" onclick="selectSingle(this);" checked><label for="aeOutcome5">症状无变化</label>
      		...
      		<tr>
      			<td colspan="4">患者在2010-10-05日因再次发生气喘，咳嗽 ，咳痰。夜间能平卧，并伴有发热，体温最高达37.8度，自服阿奇霉素等未见好转（患者发生气喘前因便秘因素出现肛脱）于2010.10.08入住呼吸科，入院查电解质：钾3.9mmol/L,氯：83.8mmol/L ,血气分析：PH7.39 二氧化碳：43mmhg 氧分压100hg ，予以头孢砒肟，依诺沙星抗感染，二羟丙茶碱，地塞米松，抗感染，并补钠，补氯纠正电解质，患者症状现逐渐好转</textarea></td>
      		</tr>
      		<tr>
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" name="reportDate" value="2014-03-12" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
				</td>
			</tr>	
		</table>
</form>
