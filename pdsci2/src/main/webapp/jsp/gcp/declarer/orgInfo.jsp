...
<script type="text/javascript">
	function saveOrg() {
		var url = "<s:url value='/gcp/declarer/save'/>";
		...
		<form id="sysOrgForm">
   		<table class="basic" width="100%">
      		...
      		<tr>
                ...
                <td>机构名称：</td>
                <td colspan="3">
                     <input name="orgName" type="text" value="${sysOrg.orgName }" class="xltext" style="width: 540px;"/>
                </td>                                    
             </tr>
             <tr>
                <td>所属地区：</td>
             ...
             <tr>
                ...
                <td>
                   	...
                   	&#12288;&nbsp;邮编:  	<input name="orgZip" type="text" value="${sysOrg.orgZip }" class="xltext" style="width: 160px;"/>
                </td>
                <td>机构电话：</td>
                <td>
             ...
             <tr>
              ...
              <!-- 
             	...
             	<tr>
                   ...
                   <td colspan="3">
                   	<input class="validate[custom[url]] xltext" name="orgInfo.website" type="text" value="${orgInfoData['orgInfo.website']}" style="width: 300px;"/>
                   </td>
               </tr>
			</table>
