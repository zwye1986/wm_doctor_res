...
<head>
    <script type="text/javascript">
        ...
        function showEvaluation(processFlow, flag) {
            var url = "<s:url value='/evaluation/manage/showEvaluation?roleId=Secretary&processFlow='/>" + processFlow + "&flag=" + flag;
            var typeName = "科室评价";
            jboxOpen(url, typeName, 800, 500);
        }
        //展示查看评价窗口
        function showEvalDetail(evalRecordFlow) {
            var url = "<s:url value='/evaluation/manage/showEvalDetail?roleId=Secretary&evalRecordFlow='/>" + evalRecordFlow;
            var typeName = "科室评价查看";
            jboxOpen(url, typeName, 800, 500);
        }
    </script>
