...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveFromTitle(titleId, index) {
            ...
            var url = "<s:url value='/evaluation/manage/saveEvalConfig'/>";
        ...
        function deleteTitle(id) {
            jboxConfirm("确认删除此评分项目？", function () {
                ...
                var url = "<s:url value='/evaluation/manage/deleteTitle'/>?configFlow=" + configFlow + "&id=" + id;
        ...
        function deleteItem(id) {
            jboxConfirm("确认删除此评分指标？", function () {
                var configFlow = $("input[name='configFlow']").val();
                var url = "<s:url value='/evaluation/manage/deleteItem'/>?configFlow=" + configFlow + "&id=" + id;
                jboxPost(url, null, function (resp) {
                    if ("${GlobalConstant.DELETE_SUCCESSED}" == resp) {
                        selectEvl();
                    }
        ...
        function modifyItem(obj, itemId) {
            ...
            jboxPost("<s:url value='/evaluation/manage/modifyItem'/>", data, function (resp) {
                if ("${GlobalConstant.SAVE_SUCCESSED}" == resp) {
                    selectEvl();
                }
            }, null, true);
        ...
        function save() {
            ...
            var url = "<s:url value='/evaluation/manage/saveEvalItemList'/>";
