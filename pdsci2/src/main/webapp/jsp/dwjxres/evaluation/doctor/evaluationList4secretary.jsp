...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content", "<s:url value='/evaluation/manage/evaluationManage'/>", $('#searchForm').serialize(), true);
    }
    //展示评价窗口
    function showEvaluation(processFlow) {
        var url = "<s:url value='/evaluation/manage/showEvaluation?kaoherenRoleId=Secretary&roleId=Doctor&processFlow='/>" + processFlow;
        var typeName = "学员评价";
        jboxOpen(url, typeName, 800, 500);
    }
    //展示查看评价窗口
    function showEvalDetail(evalRecordFlow) {
        var url = "<s:url value='/evaluation/manage/showEvalDetail?roleId=Doctor&evalRecordFlow='/>" + evalRecordFlow;
        var typeName = "学员评价查看";
        jboxOpen(url, typeName, 800, 500);
    }
</script>
