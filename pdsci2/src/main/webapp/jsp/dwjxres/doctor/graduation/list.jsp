...
<script type="text/javascript">
	...
	function uploadFile(){
		...
		jboxStartLoading();
		var url = "<s:url value='/dwjxres/doctor/uploadFile'/>";
			...
			<tr>
				...
				<td>
					...
					<c:if test="${doctor.stuStatusId eq stuStatusEnumGraduation.id and doctor.issueCertificate eq GlobalConstant.FLAG_Y}">
						<a class="btn_green" style="color: white;" href="<s:url value='/dwjxres/doctor/showCertificate?resumeFlow=${doctor.resumeFlow}'/>" target="_blank">打印结业证书</a>
