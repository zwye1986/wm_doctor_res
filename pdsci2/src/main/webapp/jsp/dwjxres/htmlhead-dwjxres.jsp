...
<c:if test="${param.font=='true'}">
	<c:if test="${sysCfgMap['jx_templete_name'] eq 'xz'}">
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/xzjx/css/step.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/xzjx/css/font2.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	</c:if>
	<c:if test="${sysCfgMap['jx_templete_name'] eq 'cd'}">
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/dwjxres/css/step.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/dwjxres/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	</c:if>
</c:if>

<c:if test="${param.login=='true'}">
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/dwjxres/css/login.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>

<c:if test="${param.register=='true'}">
	<c:if test="${sysCfgMap['jx_templete_name'] eq 'xz'}">
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/inx/xzjx/css/style.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	</c:if>
	<c:if test="${sysCfgMap['jx_templete_name'] eq 'cd'}">
		<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/sczyres/css/style.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
	</c:if>
</c:if>
