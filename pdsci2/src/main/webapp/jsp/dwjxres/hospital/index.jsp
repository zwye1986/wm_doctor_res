...
function toPage(page) {
	...
	window.location.href="<s:url value='/dwjxres/hospital/home'/>?currentPage="+$("#currentPage").val();
}
/**
 * 报名审核
 */
function audit(status){
    ...
    jboxPostLoad("content","<s:url value='/dwjxres/hospital/audit'/>",data,true);
}
/**
 * 学员录取
 */
function _recruitDoctor(status){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/dwjxres/hospital/_recruitDoctor'/>",data,true);
}
/**
 * 学员报到
 */
function recruitDoctor(){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/dwjxres/hospital/recruitDoctor'/>",data,true);
}
...
function graduationDoctor(status){
    var data="status="+status+"&currentPage=1";
    jboxPostLoad("content","<s:url value='/dwjxres/hospital/graduationDoctor'/>",data,true);
}
/**
 * 外出进修登记
 */
function furtherStudyRegist(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/furtherStudyRegist?currentPage=1'/>",true);
}
...
function furtherStudyQuery(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/furtherStudyQuery?currentPage=1'/>",true);
}
/**
 * 评价指标维护
 */
function evaluationMaintenance(roleId) {
    ...
    jboxLoad("content", "<s:url value='/evaluation/manage/evaluationMaintenance?roleId='/>" + roleId, false);
}
...
function evaluationQuery() {
    jboxLoad("content", "<s:url value='/evaluation/manage/evaluationSelect'/>", true);
}
 ...
 */
 function recruitList(){
	 jboxLoad("content","<s:url value='/dwjxres/hospital/orgRecruitInfo'/>",true);
}
/**
 * 学员查询
 */
 function queryStu(){
	 jboxLoad("content","<s:url value='/dwjxres/hospital/queryStuMain'/>",true);
}
/**
 * 公告维护
 */
function notice(currentPage){
    ...
    jboxLoad("content","<s:url value='/dwjxres/hospital/noticemanage?currentPage='/>"+currentPage,true);
}
...
function speMaintenance(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/speMaintenance?currentPage=1'/>",true);
}
/**
* 医院人员维护
*/
function staffManage(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/staffManage?currentPage=1'/>",true);
}
...
function batchSetting(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/searchSetting'/>",true);
}
...
function registManage(){
    jboxLoad("content","<s:url value='/dwjxres/hospital/registManage?currentPage=1'/>",true);
}
</script>
</head>
<body>
                    ...
                    <div class="container">
                        <div class="content_side">
                            ...
                            <dl class="menu">
                                ...
                                <dd class="menu_item"><a onclick="speMaintenance();">科室维护</a></dd>
