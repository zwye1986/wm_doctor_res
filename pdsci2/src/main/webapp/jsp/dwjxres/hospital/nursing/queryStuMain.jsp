<script type="text/javascript">
    ...
    function search(){
        ...
        jboxPostLoad("listDiv","<s:url value='/dwjxres/nursing/queryNurseList?isQuery=Y'/>",$('#auditForm').serialize(),true);
    }
    ...
    function exportInfo(){
        jboxExp($('#auditForm'),"<s:url value='/dwjxres/nursing/exportQueryNurse'/>");
    }
        ...
        <form id="auditForm">
            ...
            <table width="100%" class="searchTable grid " border="0">
                ...
                <tr>
                    ...
                    <td class="td_left">
                        <select name="sexId" class="select" style="width:100px;">
                            <option value="">全部</option>
                ...
                <tr>
                    ...
                    <td class="td_left">
                        <select name="isAudit" class="select" style="width:110px;">
                            <option value="">请选择</option>
                            <option value="Y">通过</option>
                            <option value="N">不通过</option>
                            <option value="isBack">已退回</option>
                        </select>
                    </td>
                    ...
                    <td class="td_left">
                        <input type="text" name="userName"  class="input" style="width: 94px;margin: 0;"/>
                    </td>
