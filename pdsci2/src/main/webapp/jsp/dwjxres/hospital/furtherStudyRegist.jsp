...
<script type="text/javascript">
    ...
    function subStudy(){
        ...
        jboxConfirm("确认保存?" ,  function(){
            jboxPost("<s:url value='/dwjxres/hospital/editStudyRegist'/>",$("#editForm").serialize(),function(resp){
    ...
    <%--function changeDept(exp){--%>
        ...
        <%--jboxPost("<s:url value='/dwjxres/hospital/changeDept'/>",{"deptId":deptId},function(data){--%>
            <%--var list=eval(data);--%>
            <%--if(list!=null)--%>
            <%--{--%>
    ...
    function searchSuggest(resp){
        var url = "<s:url value='/dwjxres/hospital/searchSuggest'/>";
        var searchData = "";
        if(resp == "deptName"){
        ...
        jboxPost(url,searchData,function(data){
            ...
            var suggestDiv = $("#"+resp).next();
            var newPos=new Object();
            newPos.left=yParent;
            newPos.top=xParent+hParent;
            suggestDiv.show();
            suggestDiv.offset(newPos);
...
<div class="search_table">
    <form id="editForm">
        ...
        <table class="grid" width="100%;" style="position: relative;">
            <colgroup>
                <col width="25%" />
                <col width="25%" />
                <col width="25%" />
            ...
            <tr>
                <th>入院时间：<span class="red">*</span></th>
                <td  class="td_left">
