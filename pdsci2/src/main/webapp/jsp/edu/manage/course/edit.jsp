...
<script type="text/javascript">
		...
		function back(){
			var url = "<s:url value='/edu/manage/course/courseList'/>";
			window.location.href=url;
		}
		...
		<input name="courseFlow" type="hidden" value="${course.courseFlow}"/>
   		<table class="basic" style="width: 100%;">
            ...
            <tr>
            	...
            	<td>
                	<input name="coursePeriod" value="${course.coursePeriod}" class="validate[required,funcCall[checkTime]] text-input xltext" type="text" /><span style="color: red">(格式 分钟数:秒数)</span>
                </td>
            </tr>
