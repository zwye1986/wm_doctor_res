...
<script type="text/javascript">
	...
	function editCourse(courseFlow){
		var url = "<s:url value='/edu/manage/course/editCourse'/>?courseFlow=" + courseFlow;
		window.location.href=url;
	}
	function delCourse(courseFlow){
		jboxConfirm("确认删除？", function(){
			var url = "<s:url value='/edu/manage/course/delCourse'/>?courseFlow=" + courseFlow ; 
	...
	function lookChapter(courseFlow){
		var url = "<s:url value='/edu/manage/course/lookChapter'/>?courseFlow=" + courseFlow;
		window.location.href=url;
	}
</script>
</head>
...
<div class="mainright">
	<div class="content">	
		<div class="title1 clearfix">
			<form id="searchForm" action="<s:url value='/edu/manage/course/courseList'/>" method="post">
			<div style="margin: 10px;">
				...
				<select name="courseTypeId" class="xlselect" onchange="search();">
           			...
           			<c:forEach var="courseType" items="${eduCourseTypeEnumList}">
