...
<div class="right fr" style="margin-top: 10px;">
    ...
    <table style="width:390px;"  border="0" class="fl">
      ...
      <tr>
        <td colspan="2">
        	<input class="txt validate[required]" type="text" name="userCode" value="${user.userCode}" onchange="checkUser();"/>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2">
            <input onClick="WdatePicker({dateFmt:'yyyy'})" class="txt validate[required]" name="period" value="${eduUser.period}" type="text" />
        </td>
      </tr>
      ...
      <tr>
        <td colspan="2"><input class="disable txt" type="text" name="sid" value="${eduUser.sid}" disabled="disabled"/></td>
      </tr>
      <tr>
