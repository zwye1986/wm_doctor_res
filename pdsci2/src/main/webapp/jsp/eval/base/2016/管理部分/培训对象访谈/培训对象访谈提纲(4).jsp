      ...
      <form id="noteInfoForm">
        ...
        <table data-role="table" data-mode="" style="margin-top: 10px;"  class="ui-responsive table-stroke">
          ...
          <tr class="td_group">
            ...
            <td colspan="3">
              <input class="inputText" style="width:25%" type="text" name="trainingBase" value="${formDataMap['trainingBase']}" data-role="none"/>
            </td>
          </tr>
          <tr class="td_group">
            <td class="right">
          ...
          <tr class="td_group">
            ...
            <td>
              <input class="inputText" type="text" name="userAge" value="${formDataMap['userAge']}" data-role="none"/>
            </td>
            <td class="right">
              毕业院校：
            </td>
            <td>
              <input class="inputText" type="text" name="graduateInstitutions" value="${formDataMap['graduateInstitutions']}" data-role="none"/>
            </td>
          </tr>
          <tr class="td_group">
            <td class="right">
            ...
            <td class="left">
              <input class="inputText" type="text" name="graduationMajor" value="${formDataMap['graduationMajor']}" data-role="none"/>
            </td>
            <td class="right">
              培训年限：
            </td>
            <td>
              <input class="inputText" type="text" name="trainingYears" value="${formDataMap['trainingYears']}" data-role="none"/>
            </td>
          </tr> 
          <tr class="td_group">
            <td class="left" colspan="4">
              &#12288;&#12288;&#12288;现处于住院医师培训第
              <input class="inputText" type="text" name="trainingPhase" style="width: 200px;" value="${formDataMap['trainingPhase']}" data-role="none"/>
              阶段第
              <input class="inputText" type="text" name="trainingYear" style="width: 200px;" value="${formDataMap['trainingYear']}" data-role="none"/>
              年
            </td>
          </tr>
          </table>
