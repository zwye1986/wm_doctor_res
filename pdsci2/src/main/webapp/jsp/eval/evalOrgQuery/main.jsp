...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			jboxPostLoad("userList" ,"<s:url value='/eval/evalOrgQuery/list'/>" ,$("#searchForm").serialize() , true);
		}
		...
		<form  id="searchForm" method="post">
			...
			<div class="queryDiv">
				<div class="inputDiv">
					...
					<input type="text" class="qtext"  value="${pdfn:getCurrYear()-1}" name="evalYear" readonly="readonly"  onclick="WdatePicker({dateFmt:'yyyy'})" >
				</div>
				<div class="inputDiv">
