            ...
            if("Y"==isFile)
            {
                ...
                jboxPost(url,null,function(resp){
                    if(resp=="1")
                    {
                        ...
                        jboxTip("评估结果文件下载中…………");
                       // $("#searchForm").submit();
                        var downurl="<s:url value='/eval/evalOrgQuery/downFile'/>?evalYear=${param.evalYear}&orgFlow=${param.orgFlow}&cfgFlow="+cfgFlow;
                        document.getElementById("ifile").src=downurl;
                    }else{
                        jboxTip(resp);
                    }
                },null,false);
...
<form id="searchForm" method="post" action="<s:url value='/eval/evalOrgQuery/downFile'/>">
    <input type="hidden" name="cfgFlow" value="" id="cfgFlow">
    <input type="hidden" name="evalYear" value="${param.evalYear}" id="evalYear">
    <input type="hidden" name="orgFlow" value="${param.orgFlow}" id="orgFlow">
</form>

<div  style="width: 1098px;max-height:490px;overflow: auto; border: 1px solid #c5d0dc">
        <div style="width: 314px;float: left;overflow: auto;min-height:490px;max-height:490px; margin-left:0px;border-right: 1px solid #c5d0dc">
        ...
        <div id="content2" style="width: 780px;min-height:490px;max-height:490px;float: left;overflow: auto; margin-right:0px;
