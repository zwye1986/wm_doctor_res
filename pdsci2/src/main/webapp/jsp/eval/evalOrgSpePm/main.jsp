...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			jboxPostLoad("userList" ,"<s:url value='/eval/evalOrgSpePm/list'/>" ,$("#searchForm").serialize() , true);
		}
		...
		function exportOrgSpeResult()
		{
			...
			var url="<s:url value='/eval/evalOrgSpePm/exportOrgSpeResult'/>";
			jboxTip("导出中…………");
		...
		<form  id="searchForm" method="post">
			...
			<div class="queryDiv">
				<div class="inputDiv">
					...
					<input type="text" class="qtext"  value="${pdfn:getCurrYear()-1}" name="evalYear" id="evalYear" readonly="readonly"  onclick="WdatePicker({dateFmt:'yyyy'})" >
				</div>
				<div class="inputDiv">
				...
				<div class="lastDiv">
					<input type="button" value="导&#12288;出" class="searchInput" onclick="exportOrgSpeResult();"/>
				</div>
			</div>
		</form>
