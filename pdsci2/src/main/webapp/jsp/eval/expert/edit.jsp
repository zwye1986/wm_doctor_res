                ...
                <div class="tagContent selectTag" id="tagContent0">
                    <table width="800" cellpadding="0" cellspacing="0" class="basic">
                        ...
                        <tr>
                            ...
                            <th><font color="red">*</font>是否为组长：</th>
                            <td>
                                <input id="srmExpertFlagY" class="validate[required]" type="radio" name="srmExpertFlag"
                                       value="Y"
                                       <c:if test="${'Y' == user.srmExpertFlag}">checked</c:if> />
                                <label for="srmExpertFlagY">是</label>&#12288;
                                <input id="srmExpertFlagN" class="validate[required]" type="radio" name="srmExpertFlag"
                                       value="N"
