...
function daoRu(){
	...
	jboxStartLoading();
	var url = "<s:url value='/hbzy/doctorTheoryScore/importSkillScoreFromExcel'/>";
	jboxSubmit(
		$('#excelForm'),
		url,
		function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="grid" style="width: 100%;">
		...
		<tr>
			...
			<td style="text-align: left;"><a href="<s:url value='/jsp/hbzy/skillScore/importSchoolRoll.xlsx'/>">学生技能成绩导入模板.xlsx</a></td>
		</tr>
	</table>
</form>
