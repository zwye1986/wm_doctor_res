...
function toPage(page) {
	...
	jboxStartLoading();
	jboxPostLoad("doctorListZi","<s:url value='/hbzy/asseGlobal/waitAuditList'/>?roleFlag=${roleFlag}",$("#searchForm").serialize(),false);
}
...
function exportInfo()
{
	...
	var url = "<s:url value='/hbzy/asseGlobal/exportList'/>?roleFlag=${roleFlag}&auditStatusId=${jszyResAsseAuditListEnumAuditing.id}&isWaitAudit=Y";
	</c:if>
	<c:if test="${roleFlag ne GlobalConstant.USER_LIST_LOCAL}">
	var url = "<s:url value='/hbzy/asseGlobal/exportList'/>?roleFlag=${roleFlag}&auditStatusId=${jszyResAsseAuditListEnumWaitGlobalPass.id}&isWaitAudit=Y";
	</c:if>
...
function  batchApply()
{
	...
	var url = "<s:url value='/hbzy/asseGlobal/batchAuditApply?'/>"+applyFlow;
