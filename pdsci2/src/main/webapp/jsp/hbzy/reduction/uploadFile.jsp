...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveReductionAndFile() {
            ...
            var url = "<s:url value="/hbzy/reduction/saveReductionAndFile?jsonData="/>" + encodeURI(encodeURI(JSON.stringify(jsonData)));
            jboxStartLoading();
...
<body>
<div class="div_table" style="overflow: auto;max-height: 300px;">
    <form id="uploadFileForm" method="post" style="position:relative;" enctype="multipart/form-data">
        ...
        <div class="button">
            <input class="btn_brown" type="button" value="确&#12288;定" onclick="saveReductionAndFile();"/>
