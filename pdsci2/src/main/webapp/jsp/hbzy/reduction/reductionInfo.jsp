...
<script type="text/javascript">
    ...
    function uploadFile() {
        ...
        var url = "<s:url value='/hbzy/reduction/showUploadReductionFile'/>" + data;
    ...
    function reductionApply() {
        if ($("#fileTd").find("a").size() > 1) {
            ...
            jboxConfirm(msg, function (resp) {
                var url = "<s:url value='/hbzy/reduction/reductionApply'/>";
    ...
    function downloadFile(recordFlow) {
        jboxTip("下载中…………");
        var url = "<s:url value='/jsp/hbzy/reduction/省委省计生委、省中医药局管印发《湖北省住院医师规范化培训学员培训时间认定方案（试行）》的通知（苏卫科教[2015]13号）.pdf'/>" + recordFlow;
        ...
        <div style="padding-bottom: 20px;">
                <span>
                    您可以根据<a style="color: blue;" target="_blank"
                            href="<s:url value='/jsp/hbzy/reduction/文档.pdf'/>">《湖北省住院医师规范化培训学员培训时间认定方案（试行）》</a>相关要求进行培训减免申请操作！
                </span>
        </div>
