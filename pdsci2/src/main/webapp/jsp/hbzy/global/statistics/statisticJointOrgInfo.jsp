...
function searchInfo(sessionNumber,trainTypeId){
	...
	jboxLoad("content","<s:url value='/hbzy/statistic/statisticJointOrg'/>?orgLevel="+orgLevel+"&viewBox="+viewBox+""+data+"&trainTypeId="+trainTypeId+"&sessionNumber="+sessionNumber,true);
}
