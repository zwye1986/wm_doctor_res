...
function importExcel(){
	 jboxOpen("<s:url value='/hbzy/statistic/leadTo'/>","导入",500,200);
}
function deleteInfo(recordFlow){
	jboxConfirm("确认删除?",function () {
		var url = "<s:url value='/hbzy/statistic/deleteInfo?'/>"+"recordFlow="+recordFlow;
...
function editInfo(recordFlow){
	var url = "<s:url value='/hbzy/statistic/editInfo?'/>"+"recordFlow="+recordFlow;
