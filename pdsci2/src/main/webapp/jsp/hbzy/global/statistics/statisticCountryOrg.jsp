...
// 		$("select[name=trainTypeId] option[value = '${jszyTrainCategoryEnumWMFirst.id}']").hide();
// 	}
	var sum=0;
	<c:forEach items="${sysOrgList}" var="org">
...
function searchInfo(sessionNumber,trainTypeId){
	...
	jboxLoad("content","<s:url value='/hbzy/statistic/statisticCountryOrg'/>?orgLevel="+orgLevel+""+data+"&viewBox="+viewBox+"&trainTypeId="+trainTypeId+"&sessionNumber="+sessionNumber,true);
}
...
function exportExcel(){
	...
	jboxTip("导出中…………");
	var url = "<s:url value='/hbzy/statistic/exportExcel'/>?"+data+"&"+$("#searchForm").serialize();
...
<div class="main_hd">
	...
	<div style="padding-bottom: 20px;">
		<div class="search_table">
			<!--表格  -->
			<div id="tableContext" style="overflow: auto;height: auto;max-height: 450px;width: 900px;" onscroll="tableFixed(this);">
				<!--第一次 -->
								...
								<td style="width: 170px;min-width:170px;max-width:170px;" class="by">
									...
									<c:if test="${orgSpeFlagMap[flow] eq GlobalConstant.FLAG_Y}">
										...
										<div class="docNameView" style="display: none;">
											<img  style="vertical-align:middle; margin-right:10px;" src="<s:url value='/jsp/hbzy/images/gou.gif'/>"/>
										</div>
									</c:if>
									<div class="kong">
			...
			<tr >
				<td colspan="${sysOrgList.size()}">
					<label>说明：<br>
						...
						(3) <img  style="vertical-align:middle; margin-right:10px;" src="<s:url value='/jsp/hbzy/images/gou.gif'/>"/>
						代表有此专业。
					</label>
