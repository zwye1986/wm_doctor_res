...
<head>
    ...
    <script type="text/javascript">
        function daoRu() {
            ...
            jboxStartLoading();
            var url = "<s:url value='/hbzy/certificateManage/importDoctorCertificateNoFromExcel2'/>";
            jboxSubmit(
                    $('#excelForm'),
                    url,
                    function (resp) {
        ...
        <table class="grid" style="width: 100%;margin-top: 50px;">
            ...
            <tr>
                ...
                <td style="text-align: left;"><a
                        href="<s:url value='/jsp/hbzy/global/certificateManage/importSchoolRoll.xlsx'/>">证书信息导入模板.xlsx</a>
                </td>
            </tr>
        </table>
    </form>
