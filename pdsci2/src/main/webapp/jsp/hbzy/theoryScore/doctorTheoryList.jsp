...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxStartLoading();
        jboxPostLoad("doctorListZi", "<s:url value='/hbzy/doctorTheoryScore/doctorTheoryListSun'/>?" + data + "&roleFlag=${roleFlag}", $("#searchForm").serialize(), false);
    }
    function importExcel() {
        var url = "<s:url value='/hbzy/doctorTheoryScore/importSchoolRoll'/>";
    ...
    function exportExcel(){
        ...
        var url = "<s:url value='/hbzy/doctorTheoryScore/doctorTheoryListSunExport'/>?" + data + "&roleFlag=${roleFlag}";
        jboxTip("导出中…………");
    ...
    function deleteScore(scoreFlow, roleFlag,page) {
        jboxConfirm("确认删除？", function () {
            jboxPost("<s:url value='/hbzy/doctorTheoryScore/deleteScore'/>?scoreFlow=" + scoreFlow + "&roleFlag=" + roleFlag, null, function (resp) {
    ...
    function saveScore(scoreFlow, k, obj, roleFlag) {
        ...
        jboxPost("<s:url value='/hbzy/doctorTheoryScore/saveTheoryScore?roleFlag='/>" + roleFlag, data, function (resp) {
            if ("1" == resp) {
    ...
    function skillScoreDetail(doctorFlow, scoreFlow, scoreType, scoreYear) {
        var url = "<s:url value='/hbzy/doctorTheoryScore/scoreDetail?scoreFlow='/>" + scoreFlow + "&doctorFlow=" + doctorFlow + "&scoreType=" + scoreType + "&scoreYear=" + scoreYear;
    ...
    <div class="div_search">
        <form id="searchForm" style="margin-left: -30px;">
            ...
            <c:if test="${sessionScope.userListScope != GlobalConstant.USER_LIST_LOCAL}">
                <%--<div class="searchCss">
                    <label>&#12288;&#12288;基地类型：</label>
                    <select name="orgLevel" id="orgLevelId" class="select" style="width:107px;"
                            onchange="chanegOrgLevel(this);">
            ...
            <div class="searchCss">
                ...
                <input type="text" id="scoreYear" name="scoreYear" value="${lastYear}"
                       class="input" readonly="readonly" style="width: 100px;margin-left: 0px;"/>
                <%--<select class="select" style="width: 107px;" name="scoreYear">--%>
            ...
            <div class="searchCss">
                ...
                <c:if test="${roleFlag eq GlobalConstant.USER_LIST_LOCAL}">
                    <input class="btn_brown" type="button" value="导出成绩" onclick="exportExcel();"/>
                </c:if>
                <c:if test="${roleFlag eq GlobalConstant.USER_LIST_GLOBAL}">
