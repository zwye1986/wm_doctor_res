<script type="text/javascript">
    ...
    function save() {
        ...
        var url = "<s:url value='/hbzy/sysCfg/save'/>";
    ...
    function searchCfgInfo(){
        <%--var url ="<s:url value='/hbzy/doctor/accountList'/>";--%>
        var url =" <s:url value='/hbzy/base/loadScoreConf'/>";
    ...
    function setScoreConf(){
        var url="<s:url value='/hbzy/base/setScoreConf'/>";
        jboxOpen(url,"添加配置信息",width,height);
    }
    //编辑
    function editCfgInfo(cfgYear){
        var url="<s:url value='/hbzy/base/setScoreConf?cfgYear='/>"+cfgYear;
        jboxOpen(url,"编辑配置信息",width,height);
    }
    //删除
    function delCfgInfo(cfgYear){
        jboxConfirm("确认删除此条记录?", function(){
            var url="<s:url value='/hbzy/base/delScoreConf?cfgYear='/>"+cfgYear;
