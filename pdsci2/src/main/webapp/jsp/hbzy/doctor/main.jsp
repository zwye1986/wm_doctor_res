...
function doctorInfo(userFlow){
	var url = "<s:url value='/hbzy/doctor/doctorInfo?userFlow='/>" + userFlow;
...
function editDoctorRecruit(recruitFlow){
	...
	var url = "<s:url value='/hbzy/doctor/editDoctorRecruit'/>?openType=open&recruitFlow="+recruitFlow;
	var title = "新增";
	if(recruitFlow){
		title = "修改";
	}
...
function getDoctorRecruit(recruitFlow, doctorFlow){
	var url = "<s:url value='/hbzy/doctor/getDoctorRecruit?recruitFlow='/>"+recruitFlow + "&doctorFlow=" + doctorFlow;
	jboxLoad("doctorContent", url, false);
}
function backTrain(userFlow){
	var url = "<s:url value='/hbzy/doctor/backTrainInfo?currentPage=1&seeFlag=Y&userFlow='/>"+userFlow;
	jboxLoad("doctorContent", url, false);
}
