...
function submit(){
	...
	var url = "<s:url value='/hbzy/doctor/submitChangeSpe'/>";
...
function changeType(obj){
	if($(obj).val()!=undefined & $(obj).val() != ''){
		...
		var url = "<s:url value='/hbzy/doctor/changeType'/>?orgFlow=${recruit.orgFlow}&catSpeId="+$(obj).val()+"&sessionNumber=${recruit.sessionNumber}";
...
<div class="div_search">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="base_info" style="margin-top: 25px;">
		...
		<tr>
			<th>模板文件：</th>
			<td colspan="3"><a href="<s:url value='/jsp/hbzy/daochu/changeTrainSpe.docx'/>">培训专业变更申请表.docx</a></td>
		</tr>
    </table>
    </form>
