		...
		<div class="div_table">
			...
			<form id="infoForm" style="position: relative;" method="post">
				<table border="0" cellpadding="0" cellspacing="0" class="base_info">
					...
					<tr>
						<th>结业考核年份：</th>
						<td colspan="3">${doctorRecruit.graduationYear}&#12288;<font color="red">(结业考核年份=当前年级+培训年限)</font></td>
					</tr>
					<!-- 审核通过 && 非二阶段 -->
				...
				<div>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="base_info">
						...
						<tr>
							<th>诚信声明：</th>
							<td>
								<c:if test="${not empty doctorAuth}">
									[<a href="${sysCfgMap['upload_base_url']}/${doctorAuth.imageUrl}" target="_blank">查看图片</a>]
								</c:if>
								<c:if test="${empty doctorAuth}">
									暂未提交
								</c:if>
							</td>
						</tr>
