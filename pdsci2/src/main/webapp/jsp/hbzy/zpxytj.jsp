...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("content", "<s:url value='/hbzy/doctorRecruit/zpxytj'/>", $("#searchForm").serialize(), true);
    }
    ...
    function exportExcel() {
        ...
        var url = "<s:url value='/hbzy/doctorRecruit/exportZpxytj'/>";
        jboxTip("导出中…………");
    ...
    function changesDetail(orgFlow,catSpeId){
        ...
        var url = "<s:url value='/hbzy/doctorRecruit/changesDetail'/>?orgFlow="
