...
function toPage(page) {
	...
	jboxStartLoading();
	jboxPostLoad("contentDiv","<s:url value='/hbzy/manage/recruitList'/>",$("#searchForm").serialize(),false);
}
var height=(window.screen.height)*0.7;
var width=(window.screen.width)*0.7;
function auditRecruit(recruitFlow, doctorFlow){
	var url = "<s:url value='/hbzy/manage/province/doctor/auditRecruit'/>?openType=open&recruitFlow="+recruitFlow+"&doctorFlow="+doctorFlow;
...
function changeTrainSpes(trainCategoryid){
	...
	var url = "<s:url value='/hbzy/doctor/searchResOrgSpeList?orgFlow='/>"+orgFlow+"&speTypeId="+trainCategoryid;
