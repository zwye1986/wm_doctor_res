...
function shouye(page){
	...
	var url="<s:url value='/hbzy/manage/local'/>?currentPage="+page;
     ...
     <div class="content_side">
        <dl class="menu menu_first">
		  ...
		  <dd class="menu_item" id="reductionRotationOper"><a onclick="reductionRotationOper();">方案减免维护
		  	<img  id="reducationCount" style="display: none;" src="<s:url value="/jsp/hbzy/images/gantanhao.png" />"/></a>
		  </dd>
          <%--<dd class="menu_item"><a onclick="changeBaseMain();">基地变更审核--%>
          	 <%--<img  id="baseFlag" style="display: none;" src="<s:url value="/jsp/hbzy/images/gantanhao.png" />"/></a>--%>
		  <%--</dd>--%>
