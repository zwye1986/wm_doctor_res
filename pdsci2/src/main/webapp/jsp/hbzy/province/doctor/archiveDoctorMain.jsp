...
<head>
	...
	<script type="text/javascript">
		...
		function getDoctorRecruit(recruitFlow, doctorFlow, backFlag,archiveFlow){
			var url = "<s:url value='/hbzy/archive/getDoctorRecruit?info=${param.info}&openType=open&recruitFlow='/>"+recruitFlow+"&doctorFlow="+doctorFlow+"&backFlag="+backFlag+"&archiveFlow="+archiveFlow;
			jboxLoad("doctorContent", url, false);
		}
		function doctorInfo(doctorFlow,archiveFlow){
			var url = "<s:url value='/hbzy/archive/doctorInfo'/>?viewFlag=${GlobalConstant.FLAG_Y}&openType=open&userFlow=" + doctorFlow+"&hideApprove=${param.hideApprove}"+"&archiveFlow="+archiveFlow;
