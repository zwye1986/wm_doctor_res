...
<script type="text/javascript">
    ...
    function toPage(page) {
        ...
        jboxPostLoad("doctorListZi", "<s:url value='/hbzy/graduationManager/list/${roleFlag}/${pageType}/${empty tabType ? "Query" : tabType}'/>", $("#searchForm").serialize(), true);
    }
    function reload() {
    ...
    function exportExcel() {
        ...
        var url = "";
        url = "<s:url value='/hbzy/graduationManager/exportGraduationInfo/${roleFlag}/${pageType}/${empty tabType ? "Query" : tabType}'/>";
        jboxTip("导出中…………");
    ...
    function importExcel() {
        var url = "<s:url value='/jsp/hbzy/graduationManager/global/importPage.jsp'/>";
    ...
    function editInfo(recordFlow) {
        ...
        var url = "<s:url value='/hbzy/graduationManager/editInfo'/>?recordFlow="+recordFlow;
    ...
    function checkBatch(exp){
        ...
        var url = "<s:url value='/hbzy/graduationManager/modifySelected?auditStatusId=GlobalPassed&recordFlowsStr='/>" + recordFlowsStr;
    ...
    function delInfo(recordFlow) {
        ...
        jboxConfirm("确认删除？" , function(){
            jboxStartLoading();
            jboxPost("<s:url value='/hbzy/graduationManager/delInfo'/>?recordFlow="+recordFlow,
                    null,
                    function(resp){
                        jboxEndLoading();
                        jboxTip(resp);
    ...
    function createCertificate(recordFlow) {
        ...
        jboxConfirm("确认生成证书？" , function(){
            jboxPost("<s:url value='/hbzy/graduationManager/createCertificate'/>?recordFlow="+recordFlow,
                    null,
                    function(resp){
                        jboxTip(resp);
                        if(resp=="生成成功"){
