<script type="text/javascript">
    ...
    function editGraduation(recordFlow, recordStatus, auditStatusId) {
        ...
        jboxConfirm(masg,
            function () {
                jboxPost("<s:url value='/hbzy/graduationManager/checkDoctorGraduationInfo'/>", data, function (resp) {
                    jboxTip(resp);
                    toPage(1);
                }, null, true);
            }, null
                    ...
                    <c:if test="${'Query' eq pageType}">
                        ...
                        <td>
                            <a style="cursor: pointer;"
                               href="<s:url value='/hbzy/graduationManager/showCertificate?recordFlow=${graduation.recordFlow}'/>"
                               target="_blank">查看</a>
                        </td>
                    </c:if>
                </tr>
