...
<script type="text/javascript">
    var map = {
        ...
        "certificate": {
            imgs: [
                {
                    //结业证书
                    url: "<s:url value='/jsp/hbzy/graduationManager/images/certificate3.jpg'/>",
                ...
                {
                    //培训基地院长签字
                    url: "<s:url value='/jsp/hbzy/graduationManager/images/'/>" + '${info.orgCode}' + ".png",
                    args: [280, 1400, 300, 180]
                },
                {
                    //中药局红章
                    url: "<s:url value='/jsp/hbzy/graduationManager/images/seal.png'/>",
        ...
        "certificate2": {
            imgs: [
                {
                    //结业证书
                    url: "<s:url value='/jsp/hbzy/graduationManager/images/certificate4.jpg'/>",
    ...
    function down(name) {
        name = name + ".png";
        var url="<s:url value='/hbzy/graduationManager/showCertificate3' />?recordFlow=${info.recordFlow}"
