...
<script type="text/javascript">
	function importExamUser(){
		...
		jboxStartLoading();
		var url = "<s:url value='/res/njExam/importExamUserExcel'/>";
		jboxSubmit(
				$('#excelForm'),
				url,
				function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		<tr>
			<th>请选择导入</th>
			<td>
				<input type="hidden" value="${examFlow}" name="examFlow"/>
				<input id="file" type="file" name="file" onchange="checkFile(this);" class="validate[required]"/>
			</td>
		</tr>
	</table>
	<div style="text-align: center; margin-top: 10px;">
		<input type="button" onclick="importExamUser();" class="search" value="导&#12288;入"/>
