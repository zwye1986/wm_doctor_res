...
<script type="text/javascript">
	function importDocInfo(){
		...
		jboxStartLoading();
		var url = "<s:url value='/res/njExam/importDocInfoExcel'/>";
		jboxSubmit(
				$('#excelForm'),
				url,
				function(resp){
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		...
		<tr>
			<th>模板文件</th>
			<td><a href="<s:url value='/jsp/njresexam/template/examCardExcel.xlsx'/>">南京市${pdfn:getCurrYear()}年住院医师结业临床技能考核考点学员报名表模板.xlsx</a></td>
		</tr>
	</table>
	<div style="text-align: center; margin-top: 10px;">
		<input type="button" onclick="importDocInfo();" class="search" value="导&#12288;入"/>
