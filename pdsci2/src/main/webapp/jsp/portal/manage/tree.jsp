...
<SCRIPT type="text/javascript">
		...
		function beforeEditName(treeId, treeNode) {
			...
			var url = "<s:url value='/portal/manage/column/getColumnJson'/>";
		...
		function beforeRemove(treeId, treeNode) {
			...
			jboxConfirm("确认删除 " + treeNode.name + " 吗？" , function(){
				...
				var url = "<s:url value='/portal/manage/column/deleteJson'/>";
		...
		function submitForm(){
			...
			if(editForm.validationEngine("validate")){
				...
				var url = "<s:url value='/portal/manage/column/editJson'/>";
				jboxPost(url , requestData , function(resp){
					if(resp!=""&&resp!="0" ){
						...
						hideObj('#editTable');
						window.location.href = '<s:url value="/portal/manage/column/list"/>';
					}else{
		...
		$(document).ready(function(){
			var url = "<s:url value='/portal/manage/column/getAllDataJson'/>"
