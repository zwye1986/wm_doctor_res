...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			jboxPostLoad("userList" ,"<s:url value='/portal/user/userList'/>" ,$("#doctorSearchForm").serialize() , true);
		}
		...
		function add(userFlow) {
			...
			jboxOpen("<s:url value='/portal/user/edit?userFlow='/>"+ userFlow,msg, 400, 400);
		}
	</script>
</head>
<body>
