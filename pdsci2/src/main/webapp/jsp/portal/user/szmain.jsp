...
<head>
	...
	<script type="text/javascript">
		...
		function search(){
			jboxPostLoad("userList" ,"<s:url value='/portal/user/szUserList'/>" ,$("#doctorSearchForm").serialize() , true);
		}
		...
		function add(userFlow) {
			...
			jboxOpen("<s:url value='/portal/user/szEdit?userFlow='/>"+ userFlow,msg, 400, 400);
		}
	</script>
</head>
<body>
