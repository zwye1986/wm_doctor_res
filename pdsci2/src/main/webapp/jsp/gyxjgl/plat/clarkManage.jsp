...
<head>
	...
	<script type="text/javascript">
		function clarkExcel(){
			var url = "<s:url value='/gyxjgl/user/clarkExcel'/>";
			jboxTip("导出中…………");
			jboxSubmit($("#recSearchForm"), url, null, null, false);
			jboxEndLoading();
		}
		function registerOpt(){
			jboxOpen("<s:url value='/gyxjgl/user/clarkRegister'/>","登记",660,360);
		}
	</script>
</head>
<body>
			...
			<form id="recSearchForm" method="post" action="<s:url value='/gyxjgl/user/ideologyManage'/>">
				...
				<tr>
					<td style="border: none;">
						...
						课程名称：<input type="text" name="" value="" style="width:133px;"/>&#12288;
						<div style="width:100%;height:4px;"></div>
						授课老师：<input type="text" name="" value="" style="width:133px;"/>&#12288;
						<input type="button" class="search" onclick="" value="查&#12288;询" />
						<input type="button" class="search" onclick="registerOpt()" value="登&#12288;记" />
						<input type="button" class="search" onclick="clarkExcel()" value="导&#12288;出" />
					</td>
				</tr>
			</form>
		</table>
