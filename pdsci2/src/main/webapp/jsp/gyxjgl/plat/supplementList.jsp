...
<head>
    ...
    <script type="text/javascript">
        ...
        function editInfo(userFlow){
            var url =  "<s:url value='/gyxjgl/user/editSupple'/>?userFlow="+userFlow;
        ...
        function backOpt(){
            ...
            jboxConfirm("确认一键退回已选信息？", function(){
                var url = "<s:url value='/gyxjgl/user/backBatchOpt?recordLst='/>"+recordLst;
        ...
        function exportInfo() {
            var url = "<s:url value='/gyxjgl/user/exportSupplement'/>";
            jboxTip("导出中…………");
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/user/supplementList?role=xx"/>" method="post">
                ...
                <tr>
                    <td style="border: none;">
                        ...
                        <div>&#12288;
                            ...
                            <input type="button" name="" class="search" onclick="exportInfo();" value="导&#12288;出"/>
                        </div>
                    </td>
                </tr>
            </table>
