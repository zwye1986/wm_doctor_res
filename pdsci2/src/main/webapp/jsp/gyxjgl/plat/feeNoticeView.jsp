...
/*--header--*/
.header {width: 100%;}
.top {width: 100%;height:45px;background: url(<s:url value='/css/skin/${empty msg.skinColor?skinPath:msg.skinColor}/images/header.png'/>) repeat;}
.tleft {float: left;}
.tleft img {padding-left: 27px;}
...
<body>
  ...
  <div class="wrapper"> 
       <div class="notice" style="color:${msg.fontColor};">
        <h1 style="text-align:${msg.titlePosition}">${msg.titleName}</h1>
        ${msg.content}
        <span class="notice_date">
            <p>${msg.publisherName}&ensp;</p>
            <p>${pdfn:transDate(msg.publishTime)}</p>
        </span>
      </div>
  </div>
