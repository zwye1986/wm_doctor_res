...
<head>
    ...
    <script type="text/javascript">
        ...
        function addMajorCredit(recordFlow){
            var url="<s:url value='/gyxjgl/majorCourse/editMajorCredit?recordFlow='/>"+recordFlow;
...
<div class="mainright">
    <div class="content">
        <table  style="width: 100%;min-width:1080px;margin: 10px 0px;border: none;">
            <form id="searchForm" method="post" action="<s:url value='/gyxjgl/majorCourse/majorCreditList'/>">
