...
String.prototype.htmlFormart = function(){
	...
	function importCourse(){
		...
		var length=0;
		jboxStartLoading();
		var url = "<s:url value='/gyxjgl/user/importGradeFromExcel'/>";
		 jboxSubmit(
				$('#excelForm'),
				url,
				function(data){
					...
					if(data == undefined){
						...
						if(data.loseCount!="0"){
							length=230;
							$("#loseCount").html(",失败"+data.loseCount+"条记录");
						}
					}
...
<form id="excelForm" method="post" enctype="multipart/form-data">
	<table class="basic" style="width: 100%;">
		...
		<tr>
			<th>模板文件</th>
			<td><a href="<s:url value='/jsp/gyxjgl/temeplete/scoreTemp.xls'/>">成绩导入模板.xlsx</a></td>
		</tr>
	</table>
...
<div id="returnData"style="display: none;">
	...
	<div style="top:40px;left:40px;position:absolute;">
		...
		<div id="kuang" class="kuang" style="width:340px; height:130px; overflow:auto;margin-top: 5px;display: none;">
