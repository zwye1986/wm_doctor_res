...
<head>
    ...
    <script>
        function saveCredit(){
            ...
            var url="<s:url value='/gyxjgl/majorCourse/saveMajorCredit?recordFlow='/>" + recordFlow+"&trainTypeId="+trainTypeId+"&degreeCredit="+degreeCredit+"&credit="+credit+"&majorId="+majorId;
...
<div class="mainright">
    <div class="content">
        <form id="appointForm" action="<s:url value="/gyxjgl/majorCourse/saveMajorCredit"/>" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <select name="majorId" style="width:151px;" class="select validate[required]">
                            <option></option>
                            <c:forEach items="${dictTypeEnumGyMajorList}" var="status">
