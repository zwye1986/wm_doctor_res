        ...
        <c:if test="${param.role eq 'xs'&& (empty supple || supple.submitFlag ne 'Y')}">
            $(function(){
                var html = "<div>各位研究生在核准和补录信息前，请详细阅读以下事项：</div>" +
                        ...
                        "<div>&#12288;&#12288;4.核准和补录完毕后，请再次认真核对信息，确认无误填写后再提交，并打印本人签名。</div>";
...
<div class="mainright">
    <div class="content" style="padding:10px;">
        <form id="saveForm" method="post">
            ...
            <div style="margin:10px 0px 30px 150px;font-size:16px;font-weight:bold">广州医科大学研究生数据信息核准与补录表</div>
        ...
        <%--同等学力无需补录--%>
        <c:if test="${eduUser.trainTypeId ne '5' && eduUser.studyFormId ne '5'}">
