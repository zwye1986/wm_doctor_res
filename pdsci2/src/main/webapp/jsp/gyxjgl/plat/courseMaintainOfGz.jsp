...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveDegreeCourse(recordFlow,courseFlow,obj){
            ...
            var url = "<s:url value='/gyxjgl/student/course/saveDegreeCourse'/>?courseFlow="+courseFlow+"&userFlow=${eduUser.userFlow}&degreeCourseFlag="+degreeCourseFlag+"&recordFlow="+recordFlow;
...
<body>
<div class="mainright" style="height: 450px;">
    <div class="content">
        <%--<div style="width: 100%;text-align: right;"><a onclick="doClose();" style="cursor:pointer;color:blue;">关闭窗口</a></div>--%>
...
<div style="text-align: center; margin-top: 8px;">
    <input type="button" class="search" value="关&#12288;闭" onclick="doClose();"/>&emsp;&emsp;
</div>
</body>
</html>