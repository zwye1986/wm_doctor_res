                    ...
                    <div class="spreadOneOne">
                        <table class="basic" style="width:100%; margin-top: 3px; margin-bottom: 30px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR && !isFeeMaster }">
                                        <input type="text" class="inputText" style="width: 140px;text-align: left;" name="eduUser.className" value="${eduUser.className }"/>
                                    </c:if>
                                    <c:if test="${roleFlag==GlobalConstant.RES_ROLE_SCOPE_DOCTOR ||isFeeMaster }">
                            ...
                            <tr>
                                ...
                                <td id="degreeLevelFlagTd">
                                    ...
                                    <c:if test="${roleFlag==GlobalConstant.RES_ROLE_SCOPE_DOCTOR ||isFeeMaster }">
                                        <label>
                                            <c:forEach items="${dictTypeEnumGyXjDegreeLevelList}" var="level">
                                                <c:if test="${eduUser.degreeLevelId eq level.dictId}">${level.dictName}</c:if>
                                            </c:forEach>
                                        </label>
                                    </c:if>
                                </td>
                            ...
                            <tr>
                                ...
                                <th style="width:20%;"><span>条形码号：</span></th>
                                <td style="width:30%;">
                                    <c:if test="${roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
                                        <input type="text" style="width: 140px;text-align: left;" class="inputText notBlank" name="eduUser.barCode" value="${eduUser.barCode}"/>
                                    </c:if>
                                    <c:if test="${roleFlag==GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
                                        <label>${eduUser.barCode}</label>
                                    </c:if>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <td colspan="3">
                                        <c:if test="${roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR && !isFeeMaster }">
                                            <select style="width: 144px;" name="sysUser.partyBranchId" class="notBlank inputText validate[required] needFlagPB">
                                                <option/>
                                                <c:forEach items="${dictTypeEnumGyXjPartyBranchList }" var="dict">
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR && !isFeeMaster }">
                                        ...
                                        <input id="studentSourceArea" type="text" name="eduUserExtInfoForm.studentSourceArea" value="${extInfoForm.studentSourceArea}" autocomplete="off" title="关键字检索，单击选项选择信息" flow="${extInfoForm.studentSourceAreaId}" style="width:140px;text-align: left;" class="validate[required] inputText" />&#12288;
                                        ...
                                        <input type="hidden" id="studentSourceAreaId" name="eduUserExtInfoForm.studentSourceAreaId" value="${extInfoForm.studentSourceAreaId }"/>
                                    </c:if>
                                    <c:if test="${roleFlag==GlobalConstant.RES_ROLE_SCOPE_DOCTOR ||isFeeMaster }">
                                        <c:if test="${optionalFlag}">
                                            <%--<input type="text" style="width: 140px;text-align: left;" class="validate[required] inputText" name="eduUserExtInfoForm.studentSourceArea" value="${extInfoForm.studentSourceArea }">--%>
                                        ...
                                        <c:if test="${!optionalFlag}">
                                            ...
                                            <input type="hidden" name="eduUserExtInfoForm.studentSourceAreaId" value="${extInfoForm.studentSourceAreaId}">
                                        </c:if>
                                    </c:if>
                                </td>
                            </tr>
                    ...
                    <div class="spreadOneFive">
                        <table class="basic" style="width:100%; margin-top: 3px; margin-bottom: 30px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${roleFlag!=GlobalConstant.RES_ROLE_SCOPE_DOCTOR||isFeeMaster }">
                                        <select style="width: 144px;" name="eduUserExtInfoForm.paidFee" class="inputText">
                                            <option/>
