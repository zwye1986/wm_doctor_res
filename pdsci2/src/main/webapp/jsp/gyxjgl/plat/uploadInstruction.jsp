...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#applyTypeId").bind("change",function(){
			var url = "<s:url value='/gyxjgl/change/apply/uploadInstruction'/>?viewFlag=${param.viewFlag}&awardFlag=${param.awardFlag}&applyTypeId="+$(this).val();
			location.replace(url);
		});
	});
	function submitIns(){
		var url = "<s:url value='/gyxjgl/change/apply/submitInstruction?awardFlag=${param.awardFlag}'/>";
