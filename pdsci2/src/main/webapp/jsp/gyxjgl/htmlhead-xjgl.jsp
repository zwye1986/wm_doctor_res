...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/gyxjgl/css/font.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>

<c:if test="${param.register=='true'}">
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/gyxjgl/css/style.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/gyxjgl/css/login.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
</c:if>
