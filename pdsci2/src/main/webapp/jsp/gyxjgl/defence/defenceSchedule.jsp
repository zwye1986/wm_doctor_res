...
<head>
    ...
    <script type="text/javascript">
        function detailInfo(recordFlow,viewFlag){
            var url = "<s:url value='/gyxjgl/paper/editSchedule?recordFlow='/>"+recordFlow+"&viewFlag="+viewFlag;
        ...
        function expExcel(){
            var url = "<s:url value='/gyxjgl/paper/expSchedule'/>";
            jboxTip("导出中…………");
...
<div class="mainright">
    <div class="content">
        ...
        <c:if test="${param.role ne 'xs'}">
            <form id="searchForm" action="<s:url value="/gyxjgl/paper/defenceSchedule"/>" method="post">
                <div class="choseDivNewStyle">
                    <input id="currentPage" type="hidden" name="currentPage" value="1"/>
                    <input type="hidden" name="role" value="${param.role}"/>
                    <span style=""></span>学&#12288;&#12288;号：
