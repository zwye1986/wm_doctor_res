...
<head>
    ...
    <script type="text/javascript">
        ...
        function addInfo(){
            var url="<s:url value='/gyxjgl/partyBranch/addVoteInfo'/>";
//            jboxOpen(url,"编辑",650,500);
        ...
        function electorInfo(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/electorInfoList'/>?recordFlow="+recordFlow,"被投票人详情",650,430);
        }
        function voterInfo(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/voterInfoList'/>?recordFlow="+recordFlow,"投票人详情",650,430);
        }
        function showInfo(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/showVoteInfo'/>?recordFlow="+recordFlow,"详情",650,400);
        }
        function delInfo(recordFlow){
            var url = "<s:url value='/gyxjgl/partyBranch/delVoteInfo'/>?recordFlow="+recordFlow;
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/partyBranch/voteManageList"/>" method="post">
