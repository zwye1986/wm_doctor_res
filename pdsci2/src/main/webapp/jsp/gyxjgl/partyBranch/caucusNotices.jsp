...
<head>
    ...
    <script type="text/javascript">
        ...
        function addInfo(){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/editCaucusNotice'/>","编辑",900,500);
        }
        function noticeView(topicFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/noticeView'/>?recordFlow=${info.recordFlow}","专题讨论",650,430);
        }
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/partyBranch/caucusNotices"/>" method="post">
            ...
            <c:forEach items="${dataList}" var="info" varStatus="i">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<s:url value='/gyxjgl/partyBranch/noticeView'/>?recordFlow=${info.recordFlow}" style="cursor:pointer;color:blue;" target="_blank">查看</a>
                    </td>
                </tr>
            </c:forEach>
