...
<head>
    ...
    <script type="text/javascript">
        function edit(dictFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/edit?dictFlow='/>"+dictFlow,"编辑", 500,300);
        }

        function add(){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/edit?dictTypeId=${param.dictTypeId}'/>","新增", 500,300);
        }
        function search(){
            jboxStartLoading();
            $("#searchForm").submit();
        ...
        function refresh(){
            var url = "<s:url value='/gyxjgl/partyBranch/doRefresh'/>";
...
<div class="mainright">
    <div class="content">
        <div class="title1 clearfix">
            <form id="searchForm" action="<s:url value="/gyxjgl/partyBranch/dictList" />" method="post" >
