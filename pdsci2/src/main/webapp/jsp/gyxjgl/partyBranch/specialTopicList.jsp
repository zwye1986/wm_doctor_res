...
<head>
    ...
    <script type="text/javascript">
        ...
        function addInfo(){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/addSpecialTopic'/>","编辑",650,500);
        }
        function topicInfo(topicFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/specialTopicInfo'/>?topicFlow="+topicFlow,"专题讨论",650,430);
        }
        function toTopic(topicFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/specialTopicInfo'/>?topicFlow="+topicFlow+"&role=${role}","专题讨论",650,430);
        }
        function userInfo(topicFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/topicDetailInfo'/>?topicFlow="+topicFlow,"参与党员",650,430);
        }
        function delInfo(topicFlow){
            var url = "<s:url value='/gyxjgl/partyBranch/delSpecialTopic'/>?topicFlow="+topicFlow;
...
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/partyBranch/specialTopicList"/>" method="post">
