...
<head>
    ...
    <style type="text/css">
        ...
        /*--header--*/
        .header {width: 100%;}
        .top {width: 100%;height:${skinPath eq 'Blue'?'100':'45'}px;background: url(<s:url value='/css/skin/${skinPath}/images/header.png'/>) repeat;}
        .tleft {float: left;}
