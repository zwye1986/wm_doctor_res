...
<head>
    ...
    <script type="text/javascript">
        ...
        function electorInfo(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/electorInfoList'/>?recordFlow="+recordFlow+"&userFlag='Y'","被投票人详情",650,430);
        }
        function toVote(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/partyBranch/toVoteInfo'/>?voteFlow="+recordFlow,"投票",650,500);
        }
    </script>
</head>
<body>
<div class="mainright">
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/partyBranch/toVoteList"/>" method="post">
