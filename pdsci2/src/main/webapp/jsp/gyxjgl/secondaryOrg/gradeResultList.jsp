...
<head>
    ...
    <script type="text/javascript">
        ...
        function leadTo(){
            jboxOpen("<s:url value='/jsp/gyxjgl/secondaryOrg/gradeDaoRu.jsp'/>","导入",360,200);
        }
        $(document).ready(function(){
            slideInit();
        });
        function toAssHole(page){
            jboxLoad("slideDiv","<s:url value='/gyxjgl/secondaryOrg/impRecordList'/>?currentPage2="+page,false);
        }
        function slideInit(){
            $("#slideDiv").slideInit({
                width:1000,
        ...
        function impRecordList(){
            var url="<s:url value='/gyxjgl/secondaryOrg/impRecordList'/>";
        ...
        <table style="width:100%;min-width: 1080px;margin: 10px 0px;border: none;">
            <tr>
                <td style="line-height: 260%;">
                    <form id="recSearchForm" method="post" action="<s:url value='/gyxjgl/secondaryOrg/gradeResultList'/>">
