...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadCourseList(planYear){
            ...
            var url = "<s:url value='/gyxjgl/majorCourse/searchCourseJson'/>?assumeOrgFlow=${assumeOrgFlow}&planYear="+planYear;
        ...
        function exportMultiExcle(){
            ...
            var url = "<s:url value='/gyxjgl/secondaryOrg/exportMultiExcle'/>?planYear="+ planYear+"&assumeOrgFlow=${assumeOrgFlow}";
            jboxTip("导出中…………");
            jboxSubmit($("#searchForm"), url, null, null, false);
            jboxEndLoading();
        }
        ...
        function editGradeOne(courseFlow){
            jboxOpen("<s:url value='/gyxjgl/secondaryOrg/resultSunFromInfo'/>?courseFlow="+courseFlow,"成绩管理",960,600);
        }
        ...
        function editCourse(courseFlow,flag){
            ...
            jboxOpen("<s:url value='/gyxjgl/secondaryOrg/editCourse'/>?courseFlow="+courseFlow+"&flag="+flag,title,460,260);
        }
    </script>
        ...
        <table class="basic" style="width: 100%;margin: 15px 0px;border: none;">
            <tr >
                <td style="border: none;">
                    <form id="searchForm" method="post" action="<s:url value='/gyxjgl/secondaryOrg/courseMajor'/>">
                ...
                <tr onclick="toogleStudent('${eduCourse.courseFlow}');">
                    <td colspan="7" style="text-align: left;padding-left: 20px;cursor: pointer;">承担单位：${empty eduCourse.assumeOrgName?'--':eduCourse.assumeOrgName}&#12288;&#12288;课程：[${empty eduCourse.courseCode?'--':eduCourse.courseCode}]${empty eduCourse.courseName?'--':eduCourse.courseName}&#12288;&#12288;学分：${empty eduCourse.courseCredit?'--':eduCourse.courseCredit}&#12288;&#12288;总学时：${empty eduCourse.coursePeriod?'--':eduCourse.coursePeriod}&#12288;&#12288;上课人数：${empty studentList?'--':fn:length(studentList)}
                        <span style="float: right;padding-right: 10px;">
                            <a onclick="editCourse('${eduCourse.courseFlow}','1')" style="color:red;">开课申请</a>&#12288;
                            <a onclick="editCourse('${eduCourse.courseFlow}','2')" style="color:red;">课程进度</a>&#12288;
                            <a onclick="editCourse('${eduCourse.courseFlow}','3')" style="color:red;">课程评价</a>&#12288;
