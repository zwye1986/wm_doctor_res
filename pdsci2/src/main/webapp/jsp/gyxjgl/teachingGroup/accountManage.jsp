...
<script type="text/javascript">
	...
	function addInfo(userFlow){
		var url = "<s:url value='/gyxjgl/teachingGroup/addCourseGroup?userFlow='/>"+userFlow;
	...
	function exportExcel() {
		var url = "<s:url value='/gyxjgl/teachingGroup/expAccount'/>";
...
<div class="mainright">
	<div class="content">
		<form id="searchForm" action="<s:url value="/gyxjgl/teachingGroup/accountManage"/>" method="post">
			<div class="choseDivNewStyle">
				...
				<input type="button" class="search" value="导&#12288;出" onclick="exportExcel()"/>
			</div>
		</form>
		<table class="xllist" style="width:100%;">
			...
			<c:forEach items="${dataList}" var="info" varStatus="i">
				<tr>
					...
					<td>
						<a onclick="addInfo('${info.USER_FLOW}');" style="cursor:pointer;color:blue;">课程维护</a>
						<a onclick="resetPasswd('${info.USER_FLOW}');" style="cursor:pointer;color:blue;">重置密码</a>
					</td>
				</tr>
			</c:forEach>
