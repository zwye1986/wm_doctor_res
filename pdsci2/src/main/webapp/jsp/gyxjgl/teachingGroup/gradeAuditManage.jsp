...
<script type="text/javascript">
	...
	function addInfo(courseFlow){
		var url = "<s:url value='/gyxjgl/teachingGroup/gradeAuditOption?courseFlow='/>"+courseFlow;
	...
	function loadCourseList(){
		...
		var url = "<s:url value='/gyxjgl/majorCourse/searchCourseJson?planYear='/>"+$("[name='courseSession']").val();
	...
	function batchAuditOpt(){
		...
		jboxConfirm("确认一键审核通过勾选信息？", function(){
			var url = "<s:url value='/gyxjgl/teachingGroup/auditAll?courseCodeList='/>"+courseCodeList;
...
<div class="mainright">
	<div class="content">
		<form id="searchForm" action="<s:url value="/gyxjgl/teachingGroup/gradeAuditManage"/>" method="post">
		...
		<table class="xllist" style="width:100%;">
			...
			<c:forEach items="${dataList}" var="info" varStatus="i">
				<tr>
					...
					<td>
						<a onclick="addInfo('${info.COURSE_FLOW}');" style="cursor:pointer;color:blue;">查看<font color="red">(${info.DSHNUM})</font></a>
					</td>
				</tr>
			</c:forEach>
