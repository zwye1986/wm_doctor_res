...
<head>
	...
	<script type="text/javascript">
		...
		function editInfo(recordFlow){
			var url = "<s:url value='/gyxjgl/term/manage/settingAdd?sessionNumber=${param.sessionNumber}&recordFlow='/>"+recordFlow;
		...
		function delInfo(recordFlow){
			jboxConfirm("确认删除吗？" , function(){
				var url = "<s:url value='/gyxjgl/term/manage/delSetting?recordFlow='/>"+recordFlow;
...
<div class="mainright">
	<div class="content">
		<form id="myForm" action="<s:url value="/gyxjgl/term/manage/scheduleSetting?sessionNumber=${param.sessionNumber}"/>" method="post">
