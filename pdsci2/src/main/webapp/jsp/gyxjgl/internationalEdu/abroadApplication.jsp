...
//            }
            ...
            $("input[name='stuLevelId']").removeAttr("disabled");
            ...
            $("input[name='stuLevelId']").attr("disabled","disabled");
        }
    ...
    <div class="content">
        ...
        <form id="saveForm">
            ...
            <div style="min-width:800px;">
                ...
                <font style="font-weight:bold;">注：此表一式四份，由研究生本人、导师、二级机构及研究生院各留存一份。</font>
            </div>
        </form>
    </div>
</div>
