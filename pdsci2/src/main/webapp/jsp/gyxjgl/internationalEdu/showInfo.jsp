...
<head>
    ...
    <script type="text/javascript">
        ...
        function editInfo(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/abroadApply/editAbroadApply'/>?recordFlow="+recordFlow+"&roleFlag=${roleFlag}","编辑",960,600);
        }
        function showEditSheet(recordFlow,formType){
            jboxOpen("<s:url value='/gyxjgl/abroadApply/showEditSheet'/>?recordFlow="+recordFlow+"&roleFlag=${roleFlag}&formType="+formType,"编辑",960,600);
        }
        function showUploadFile(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/abroadApply/showUploadFile'/>?recordFlow="+recordFlow+"&roleFlag=${roleFlag}","编辑",500,180);
        }
        ...
        function editCost(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/abroadApply/showEditSheet'/>?recordFlow="+recordFlow+"&roleFlag=${param.roleFlag}&formType=cost","编辑",900,500);
        }
        function editProj(recordFlow){
            jboxOpen("<s:url value='/gyxjgl/abroadApply/showUploadFile'/>?recordFlow="+recordFlow+"&roleFlag=${roleFlag}&type=proj","编辑",500,180);
        }
        ...
        function saveApply(){
            ...
            var url ="<s:url value='/gyxjgl/leave/saveApply'/>";
...
<div class="mainright">
    <div class="content">
        <%--<form id="searchForm" method="post" action="<s:url value='/gyxjgl/leave/leaveInfosByStu'/>">--%>
