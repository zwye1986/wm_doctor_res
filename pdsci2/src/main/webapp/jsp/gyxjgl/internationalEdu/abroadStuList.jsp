...
<head>
    ...
    <script type="text/javascript">
        ...
        function showInfo(recordFlow){
            var url ="<s:url value='/gyxjgl/abroadApply/showInfo?recordFlow='/>"+recordFlow+"&roleFlag=${param.roleFlag}";
    ...
    <div class="content">
        <form id="searchForm" action="<s:url value="/gyxjgl/abroadApply/abroadApplyList"/>" method="post">
            <div class="choseDivNewStyle">
                ...
                二级机构：<input id="pydwOrgName" type="text" name="pydwOrgName" value="${param.pydwOrgName}" autocomplete="off" title="${param.pydwOrgName}" onmouseover="this.title = this.value" flow="${param.pydwOrgFlow}" style="width: 137px;"/>&#12288;
