...
<script type="text/javascript">
    ...
    function saveBefore(){
        ...
        jboxConfirm(title, function(){
            ...
            var requestData = {"studentCourseList":datas};
            var url = "<s:url value='/gyxjgl/student/course/saveStudentCourse'/>?studentPeriod=${param.period}&userFlow=${param.userFlow}&saveBeforeFlag=Y";
            jboxPostJson(url,
                    JSON.stringify(requestData),
                    function(resp){
                        if("${GlobalConstant.OPRE_SUCCESSED}" == resp){
            ...
            <c:forEach items="${resultMap['courseTypeMajorMap'][courseType.id]}" var="courseMajorExt" varStatus="status">
                ...
                <tr>
                    ...
                    <td style="text-align:left;">&#12288;
                        ...
                        <span style="float:right;"><a style="color:blue;cursor:pointer;" onclick="courseOutline('${course.courseFlow }','${course.courseName}')">课程大纲</a>&#12288;
                            <%--<a style="color:blue;cursor:pointer;" onclick="courseTeaching('${course.courseFlow }','${course.courseName}')">参考教材</a>&#12288;--%>
                        </span>
                    </td>
