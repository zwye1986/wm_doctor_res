...
<head>
	...
	<script type="text/javascript">
		function loadWeek(){
			...
			var url = "<s:url value='/gyxjgl/student/course/loadWeek'/>";
		...
		function searchScheduleClass(weekNumber){
			...
			var url = "<s:url value='/gyxjgl/student/course/searchScheduleClass'/>?userFlow=${param.userFlow}&classId=${param.classId}&majorId=${param.majorId}&trainTypeId=${param.trainTypeId}&year="+$('#year').val()+"&termSeason="+$('#termSeason').val()+"&weekNumber="+weekNumber;
			...
			<table class="basic" style="width: 100%;">
				<tr>
					<td>
						...
						<c:forEach items="${dictTypeEnumGyTermSeasonList}" var="term">
